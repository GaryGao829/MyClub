 ...
 *       id: 't1_1',
 *       label:'Label 1-1',
 *       start: oj.IntlConverterUtils.dateToLocalIso(new Date('2016-01-12')),
 *       end: oj.IntlConverterUtils.dateToLocalIso(new Date('2016-02-22'))
 *     }, {
 *       id: 't1_2',
 *       label:'Label 1-2',
 *       start: oj.IntlConverterUtils.dateToLocalIso(new Date('2016-03-02')),
 *       end: oj.IntlConverterUtils.dateToLocalIso(new Date('2016-05-21'))
 *     }]
 *   }, {
 *     id: 'r2',
 *     tasks: [{
 *       id: 't2_1',
 *       label:'Label 2',
 *       start: oj.IntlConverterUtils.dateToLocalIso(new Date('2016-02-01')),
 *       end: oj.IntlConverterUtils.dateToLocalIso(new Date('2016-04-10'))
 *     }]
 *   }]
 * }"/>
 * </code>
...
oj.__registerWidget('oj.ojGantt', $['oj']['dvtTimeComponent'],
{
  ...
  _GetChildStyleClasses: function()
  {
    ...
    // Zoom Icons
    styleClasses['oj-gantt-zoomin-icon'] = {'path': '_resources/zoomIn', 'property': 'CSS_URL'};
    styleClasses['oj-gantt-zoomin-icon oj-hover'] = {'path': '_resources/zoomIn_h', 'property': 'CSS_URL'};
    styleClasses['oj-gantt-zoomin-icon oj-active'] = {'path': '_resources/zoomIn_a', 'property': 'CSS_URL'};
    styleClasses['oj-gantt-zoomin-icon oj-disabled'] = {'path': '_resources/zoomIn_d', 'property': 'CSS_URL'};
    styleClasses['oj-gantt-zoomout-icon'] = {'path': '_resources/zoomOut', 'property': 'CSS_URL'};
    styleClasses['oj-gantt-zoomout-icon oj-hover'] = {'path': '_resources/zoomOut_h', 'property': 'CSS_URL'};
    styleClasses['oj-gantt-zoomout-icon oj-active'] = {'path': '_resources/zoomOut_a', 'property': 'CSS_URL'};
    styleClasses['oj-gantt-zoomout-icon oj-disabled'] = {'path': '_resources/zoomOut_d', 'property': 'CSS_URL'};
...
/**
 *
 *<p>The date/time data in the Gantt chart plays a key role, not only in the representation of events in the order in which they occurred, but also in many other places, such as the time axis and task bars etc.</p>
 *<p>The Gantt chart supports a simplified version of the ISO 8601 extended date/time format. The format is as follows: <font color="#4B8A08">YYYY-MM-DDTHH:mm:ss.sssZ</font></p>
 *<table  class="keyboard-table">
 *<thead>
 *<tr>
 *<th>Symbol</th>
