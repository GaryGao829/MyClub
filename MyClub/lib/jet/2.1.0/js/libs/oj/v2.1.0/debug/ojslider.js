...
(function () {
     ...
     *     <tr>
     *       <td>oj-slider-bar</td>
     *       <td>Styles the slider bar. The slider bar spans the full width of a horizontal slider.</td>
     *     </tr>
     *     <tr>
     *       <td>oj-slider-bar-value</td>
     *       <td>Styles the slider bar value. The slider bar value is the colored (blue by default) part of the slider bar.</td>
     *     </tr>
     *     <tr>
     ...
     *
     * <p>
     * Another consideration when altering the slider bar thickness is the definition of the click area. The slider CSS defines an expanded bar click area, so that it is not necessary to click exactly on the bar to reposition the slider thumb. This expanded click area is expecially important for thin bars. Below we show the default definition of the expanded slider bar click area:
     *
     * <pre class="prettyprint">
     * <code>
     *.oj-slider-bar:after {
     ...
     *
     * <p>
     * As the bar thickness increases, it is recommended that you decrease the additional hit area on the bar. (By half of the increase in thickness). So when we increase the bar thickness from 4px to 8px, we would want to adjust the above constants from -16px to -14px:
     *
     * <pre class="prettyprint">
     * <code>
     *.oj-slider-bar:after {
    ...
    oj.__registerWidget('oj.ojSlider', $['oj']['editableValue'], {
        ...
        _createThumbs: function () {
            var i, thumbCount,
                ...
                thumb = '',
                thumbSpanStart = '<span ',
                thumbClasses = "class='oj-slider-thumb ui-state-default' tabindex='0' role='slider'"
