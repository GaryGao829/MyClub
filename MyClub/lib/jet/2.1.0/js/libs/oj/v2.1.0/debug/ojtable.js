        ...
        if (currentRow != null)
        {
          ...
          try
          {
            if (editable && !this._hasEditableRow())
            {
              ...
              updateEditMode = this._trigger('beforeEdit', event, {'rowContext': rowContext});
            }
            else if (!editable && this._hasEditableRow())
            {
              // only trigger the beforeEditEnd if we are actually ending an edit
              ...
              updateEditMode = this._trigger('beforeEditEnd', event, {'rowContext': rowContext, 'cancelEdit': cancelled});
            }
            else
            {
