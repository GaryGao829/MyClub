    ...
    addTab : function (newTab)
    {
      ...
      if (index >= 0 && index < tabbar.children().length)
      {
        ...
        var contentAfter = this.element.children(
          this._sanitizeSelector("#" + tabAfter.attr("aria-controls")));
...
//        this._logMessage("underflow");
    ...
    _getIndexByTabOrContentId: function (idOrIndex)
    {
      ...
      if (typeof idOrIndex === 'number') {
        ...
        if (oj.DomUtils.isValidIdentifier(selector)) {
          var tabOrContent = this.element.find(this._sanitizeSelector("#" + selector));
    ...
    _getSelectedIndex: function ()
    {
      ...
      return this.tabs.index($(this._sanitizeSelector("#" + selected)));
    },
    ...
    _addFacets: function () {
      ...
      this.element.children(".oj-tabs-facet").each(
        function ()
        {
          ...
          if (navRoot.find(self._sanitizeSelector("#" + facetId)).length == 0)
          {
            //add start facet
