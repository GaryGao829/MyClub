...
(function($dvt$$1$$) {
  ...
  $DvtAxisRenderer$$.$_renderLabelsHoriz$ = function $$DvtAxisRenderer$$$$_renderLabelsHoriz$$($DvtAxisKeyboardHandler$$, $DvtAxisAutomation$$, $DvtAxisRenderer$$) {
    ...
    if ($DvtAxisAutomation$$ instanceof $dvt$$1$$.$TimeAxisInfo$ && ($labels$$3$$ = $DvtAxisAutomation$$.$getLabels$($DvtAxisKeyboardHandler$$.$getCtx$()), $context$$78_lv2Labels$$ = $DvtAxisAutomation$$.$getLabels$($DvtAxisKeyboardHandler$$.$getCtx$(), 1), $offset$$17_options$$20$$ = 0, null != $context$$78_lv2Labels$$)) {
      for ($i$$217$$ = 0;$i$$217$$ < $context$$78_lv2Labels$$.length;$i$$217$$++) {
        ...
        $isTickInside_minOverflow$$ = $DvtAxisAutomation$$.$getOptions$()._minOverflowCoord, null != $labels$$3$$[$i$$217$$] && ($offset$$17_options$$20$$ = $labels$$3$$[$i$$217$$].$measureDimensions$().$w$ / 2, $isGroupAxis_overflow1_x$$86$$ = $DvtAxisAutomation$$.$_level1Overflow$[$i$$217$$], $isHierarchical_overflow2$$ = $DvtAxisAutomation$$.$_level2Overflow$[$i$$217$$]), 0 == $isGroupAxis_overflow1_x$$86$$ && 0 == $isHierarchical_overflow2$$ ? ($isGroupAxis_overflow1_x$$86$$ = $label$$22$$.$getX$(), 
              ...
              if (null != $label$$26$$) {
                ...
                if (!$isEmptyLabel$$) {
                  ...
                  if ($DvtAxisAutomation$$) {
                    ...
                    (!$isEmptyLabel$$ && 0 == $nextLabel_prevLabelRendered$$ || 0 == $index$$107$$ && $isEmptyLabel$$ && 0 != $level$$14$$) && null != $x3_y1$$3$$ && $DvtAxisRenderer$$.$_addSeparatorLine$($DvtAxisObjPeer$$, $lineStroke$$, $maxDims_x1$$4$$, $x3_y1$$3$$, $x2$$2$$, $x3_y1$$3$$), null == $y2$$1_yCoord$$ || $eraseCornerEdge$$ || $DvtAxisRenderer$$.$_addSeparatorLine$($DvtAxisObjPeer$$, $lineStroke$$, $x2$$2$$, $y2$$1_yCoord$$, $maxDims_x1$$4$$, $y2$$1_yCoord$$)), $isEmptyLabel$$ || ($x3_y1$$3$$ = 
                    $isFirstLabel$$ && 0 == $prevLabelEmpty$$ ? 0 : $DvtAxisKeyboardHandler$$.$getBoundedCoordAt$($start$$27_x4$$ - $startOffset$$), $nextLabel_prevLabelRendered$$ = $DvtAxisKeyboardHandler$$.$getLabelAt$($index$$107$$ + 1, $level$$14$$), $y2$$1_yCoord$$ = $isLastLabel_spacing$$1$$ && $nextLabel_prevLabelRendered$$ && 0 < $nextLabel_prevLabelRendered$$.length ? $DvtAxisKeyboardHandler$$.$getEndCoord$() : $DvtAxisKeyboardHandler$$.$getBoundedCoordAt$($drawLeftLine_end$$9$$ + $DvtAxisEventManager$$), 
  ...
  $DvtAxisRenderer$$.$_getGroupAxisPreferredSize$ = function $$DvtAxisRenderer$$$$_getGroupAxisPreferredSize$$($DvtAxisObjPeer$$, $DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$, $DvtAxisAutomation$$, $DvtAxisConstants$$) {
    ...
    for (var $gap$$6_options$$23$$ = 1 < $DvtAxisObjPeer$$ ? $DvtAxisDefaults$$.$getGapSize$($DvtAxisRenderer$$, $gap$$6_options$$23$$, $gap$$6_options$$23$$.layout[$DvtAxisConstants$$ ? "hierarchicalLabelGapHeight" : "hierarchicalLabelGapWidth"]) : 0, $level$$15$$ = 0;$level$$15$$ < $DvtAxisObjPeer$$;$level$$15$$++) {
  ...
  $dvt$$1$$.$GroupAxisInfo$.prototype.$_rotateLabels$ = function $$dvt$$1$$$$GroupAxisInfo$$$$_rotateLabels$$($DvtAxisObjPeer$$, $DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$, $DvtAxisDefaults$$) {
    ...
    $DvtAxisRenderer$$.$isWrapEnabled$(this.$Options$.tickLabel.style) && this.$_sanitizeWrappedText$($DvtAxisConstants$$, $isRTL$$6_labelDims$$7$$, $DvtAxisObjPeer$$, !0, $isHierarchical$$2$$) && ($isRTL$$6_labelDims$$7$$ = this.$GuessLabelDims$($DvtAxisObjPeer$$, $DvtAxisKeyboardHandler$$, null, $DvtAxisDefaults$$));
  ...
  $dvt$$1$$.$GroupAxisInfo$.prototype.$_sanitizeWrappedText$ = function $$dvt$$1$$$$GroupAxisInfo$$$$_sanitizeWrappedText$$($DvtAxisObjPeer$$, $DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$, $DvtAxisAutomation$$, $DvtAxisConstants$$) {
    ...
    for (var $DvtAxisRenderer$$ = 0, $i$$228$$ = 0;$i$$228$$ < $DvtAxisEventManager$$.length;$i$$228$$++) {
      var $text$$45$$ = $DvtAxisEventManager$$[$i$$228$$];
      if ($text$$45$$) {
  ...
  $dvt$$1$$.$GroupAxisInfo$.prototype.$_generateLabels$ = function $$dvt$$1$$$$GroupAxisInfo$$$$_generateLabels$$($DvtAxisObjPeer$$) {
    ...
    $dvt$$1$$.$TextUtils$.$getTextStringHeight$($DvtAxisObjPeer$$, $tickLabelStyle_wrapping$$), $j$$36_label$$30$$, $firstLabel_firstLabelDim$$, $lastLabel_lastLabelDim_maxLabelDims$$, $cssStyle$$27_totalSpace$$1$$, $coord$$9_text$$48$$, $level$$23_startOverflow$$1$$ = 0;$level$$23_startOverflow$$1$$ < this.$_numLevels$;$level$$23_startOverflow$$1$$++) {
      for (var $dims$$29_levels$$1$$ = this.$_levelsArray$[$level$$23_startOverflow$$1$$], $increment$$1$$ = $autoRotate$$ ? Math.max(1, Math.floor($dvt$$1$$.$GroupAxisInfo$.$_ROTATE_THRESHOLD$ / (2 * Math.max(1, $groupWidth_labelDims$$10$$)))) : 1, $i$$231$$ = 0;$i$$231$$ < $dims$$29_levels$$1$$.length;$i$$231$$ += $increment$$1$$) {
        if ($dims$$29_levels$$1$$[$i$$231$$]) {
          if ($j$$36_label$$30$$ = this.$getLabelAt$($i$$231$$, $level$$23_startOverflow$$1$$), "" == $j$$36_label$$30$$ || !$j$$36_label$$30$$ && 0 != $j$$36_label$$30$$) {
            ...
            if ($coord$$9_text$$48$$ = this.$_getLabelCoord$($level$$23_startOverflow$$1$$, $i$$231$$), null != $coord$$9_text$$48$$) {
              $cssStyle$$27_totalSpace$$1$$ = this.$getLabelStyleAt$($i$$231$$, $level$$23_startOverflow$$1$$);
              var $bMultiline$$1$$ = !$autoRotate$$ && $tickLabelStyle_wrapping$$ && "number" != typeof $j$$36_label$$30$$ && 0 <= $j$$36_label$$30$$.indexOf(" ");
              $coord$$9_text$$48$$ = this.$CreateLabel$($DvtAxisObjPeer$$, $j$$36_label$$30$$, $coord$$9_text$$48$$, $cssStyle$$27_totalSpace$$1$$, $bMultiline$$1$$);
              ...
              $bMultiline$$1$$ && this.$_isTextWrapNeeded$($DvtAxisObjPeer$$, $j$$36_label$$30$$, $cssStyle$$27_totalSpace$$1$$, $rotationEnabled$$, $DvtAxisAutomation$$ ? $groupSpan$$1$$ : $availSize$$1$$) ? $DvtAxisAutomation$$ ? $coord$$9_text$$48$$.$wrapText$($groupSpan$$1$$, $availSize$$1$$, 1, !0) : $coord$$9_text$$48$$.$wrapText$($availSize$$1$$, $coord$$9_text$$48$$.$getLineHeight$() * this.$_maxLineWrap$, 1, !1) : $bMultiline$$1$$ && !$DvtAxisAutomation$$ && $coord$$9_text$$48$$.$setWrapEnabled$(!1);
              $coord$$9_text$$48$$.$_index$ = $i$$231$$;
              $DvtAxisKeyboardHandler$$.push($coord$$9_text$$48$$);
              $firstLabel_firstLabelDim$$ || 0 != $level$$23_startOverflow$$1$$ || ($firstLabel_firstLabelDim$$ = $coord$$9_text$$48$$);
              0 == $level$$23_startOverflow$$1$$ && ($lastLabel_lastLabelDim_maxLabelDims$$ = $coord$$9_text$$48$$);
            } else {
              $DvtAxisKeyboardHandler$$.push(null);
            }
          }
      ...
      if ($tickLabelStyle_wrapping$$ && $isHierarchical$$4$$) {
        for ($j$$36_label$$30$$ = $cssStyle$$27_totalSpace$$1$$ = 0;$j$$36_label$$30$$ < $DvtAxisKeyboardHandler$$.length;$j$$36_label$$30$$++) {
          $DvtAxisKeyboardHandler$$[$j$$36_label$$30$$] && ($dims$$29_levels$$1$$ = $DvtAxisKeyboardHandler$$[$j$$36_label$$30$$].$measureDimensions$(), $cssStyle$$27_totalSpace$$1$$ = Math.max($cssStyle$$27_totalSpace$$1$$, $DvtAxisAutomation$$ ? $dims$$29_levels$$1$$.$h$ : $dims$$29_levels$$1$$.$w$));
        }
    ...
    if ($firstLabel_firstLabelDim$$) {
      if ("tangential" == this.$Position$) {
        ...
        for ($firstLabel_firstLabelDim$$ = $firstLabel_firstLabelDim$$.$measureDimensions$(), $DvtAxisAutomation$$ && (null != this.$Options$._startOverflow && null != this.$Options$._endOverflow ? ($level$$23_startOverflow$$1$$ = this.$Options$._startOverflow, $DvtAxisConstants$$ = this.$Options$._endOverflow) : ($lastLabel_lastLabelDim_maxLabelDims$$ = $lastLabel_lastLabelDim_maxLabelDims$$.$measureDimensions$(), $level$$23_startOverflow$$1$$ = $DvtAxisConstants$$ ? $firstLabel_firstLabelDim$$.$w$ + 
        $firstLabel_firstLabelDim$$.x - this.$StartCoord$ : this.$StartCoord$ - $firstLabel_firstLabelDim$$.x, $DvtAxisConstants$$ = $DvtAxisConstants$$ ? this.$EndCoord$ - $lastLabel_lastLabelDim_maxLabelDims$$.x : $lastLabel_lastLabelDim_maxLabelDims$$.$w$ + $lastLabel_lastLabelDim_maxLabelDims$$.x - this.$EndCoord$), !$autoRotate$$ && ($level$$23_startOverflow$$1$$ > this.$_startBuffer$ || $DvtAxisConstants$$ > this.$_endBuffer$) && this.$_setOverflow$($level$$23_startOverflow$$1$$, $DvtAxisConstants$$, 
        $DvtAxisKeyboardHandler$$)), $level$$23_startOverflow$$1$$ = 0;$level$$23_startOverflow$$1$$ < this.$_numLevels$;$level$$23_startOverflow$$1$$++) {
          if ($DvtAxisKeyboardHandler$$ = this.$_labels$[$level$$23_startOverflow$$1$$], $autoRotate$$) {
            ...
            if ($DvtAxisConstants$$ = this.$GuessLabelDims$($DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$, .3, $level$$23_startOverflow$$1$$), $lastLabel_lastLabelDim_maxLabelDims$$ = this.$GuessLabelDims$($DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$, null, $level$$23_startOverflow$$1$$), this.$IsOverlapping$($lastLabel_lastLabelDim_maxLabelDims$$, 0) || (this.$_labels$[$level$$23_startOverflow$$1$$] = $DvtAxisKeyboardHandler$$), $DvtAxisAutomation$$) {
              if ($rotationEnabled$$) {
                if (this.$IsOverlapping$($DvtAxisConstants$$, 0)) {
                  ...
                  if ($groupWidth_labelDims$$10$$ = this.$GetLabelDims$($DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$), this.$IsOverlapping$($groupWidth_labelDims$$10$$, 0)) {
                    ...
                    if (this.$_labels$[$level$$23_startOverflow$$1$$] = $DvtAxisKeyboardHandler$$, $isHierarchical$$4$$) {
  ...
  $dvt$$1$$.$TimeAxisInfo$.prototype.$_formatDate$ = function $$dvt$$1$$$$TimeAxisInfo$$$$_formatDate$$($DvtAxisObjPeer$$, $DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$, $DvtAxisDefaults$$) {
    ...
    for (var $DvtAxisRenderer$$ = $dvt$$1$$.$TimeAxisInfo$.$_getDMYOrder$(this.$_locale$), $dateStr$$ = "", $i$$239$$ = 0;$i$$239$$ < $DvtAxisRenderer$$.length;$i$$239$$++) {
      $DvtAxisKeyboardHandler$$ && "D" == $DvtAxisRenderer$$[$i$$239$$] ? $dateStr$$ += $DvtAxisObjPeer$$ + " " : $DvtAxisEventManager$$ && "M" == $DvtAxisRenderer$$[$i$$239$$] ? $dateStr$$ += $DvtAxisConstants$$ + " " : $DvtAxisDefaults$$ && "Y" == $DvtAxisRenderer$$[$i$$239$$] && ($dateStr$$ += $DvtAxisAutomation$$ + " ");
    }
  ...
  $dvt$$1$$.$TimeAxisInfo$.prototype.$_skipLabelsGreedy$ = function $$dvt$$1$$$$TimeAxisInfo$$$$_skipLabelsGreedy$$($DvtAxisObjPeer$$, $DvtAxisKeyboardHandler$$, $DvtAxisEventManager$$, $DvtAxisDefaults$$) {
    ...
    for (var $DvtAxisAutomation$$ = "left" == this.$Position$ || "right" == this.$Position$, $DvtAxisConstants$$ = this.$getTickLabelHeight$(), $DvtAxisConstants$$ = $DvtAxisAutomation$$ ? .08 * $DvtAxisConstants$$ : .24 * $DvtAxisConstants$$, $DvtAxisRenderer$$ = 0, $pointA1$$3$$, $pointA2$$3$$, $label$$39$$, $availWidth$$10$$ = Math.abs(this.$_endCoord$ - this.$_startCoord$), $j$$38$$ = 0;$j$$38$$ < $DvtAxisKeyboardHandler$$.length;$j$$38$$++) {
  ...
  $dvt$$1$$.$TimeAxisInfo$.prototype.$_skipLabelsUniform$ = function $$dvt$$1$$$$TimeAxisInfo$$$$_skipLabelsUniform$$($dvt$$1$$, $DvtAxisObjPeer$$, $DvtAxisKeyboardHandler$$) {
    ...
    for (var $isVert$$5$$ = "left" == this.$Position$ || "right" == this.$Position$, $_this$$ = this, $DvtAxisRenderer$$ = ($DvtAxisEventManager$$(0) + this.$GetTickLabelGapSize$()) * ($DvtAxisDefaults$$.length - 1), $count$$14_skip$$ = 0 < $DvtAxisConstants$$ ? Math.ceil($DvtAxisRenderer$$ / $DvtAxisConstants$$) - 1 : 0, $DvtAxisRenderer$$ = !0;$DvtAxisRenderer$$;) {
      ...
      $DvtAxisRenderer$$ = this.$IsOverlapping$($DvtAxisAutomation$$, $count$$14_skip$$);
      $count$$14_skip$$++;
    }
