...
(function($dvt$$2$$) {
  ...
  function $DvtChartBoxAndWhisker$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$) {
    ...
    this.$_hoverColor$ = $dvt$$2$$.$SelectionEffectUtils$.$getHoverBorderColor$(this.$_styleOptions$.q3Color);
  ...
  $dvt$$2$$.$Chart$.prototype.$processEvent$ = function $$dvt$$2$$$$Chart$$$$processEvent$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
          ...
          if ($DvtSparkChartAutomation$$ == $dvt$$2$$.$PanZoomEvent$.$TYPE$) {
            ...
            if ($DvtSparkChartAutomation$$ == $dvt$$2$$.$MarqueeEvent$.$TYPE$) {
              ...
              if ($DvtSparkChartAutomation$$ == $dvt$$2$$.$OverviewEvent$.$TYPE$) {
                var $DvtChartRefObjUtils$$ = $DvtSparkChartEventManager$$.$getSubType$();
                if ($DvtChartRefObjUtils$$ == $dvt$$2$$.$OverviewEvent$.$SUBTYPE_PRE_RANGECHANGE$) {
                  return;
                }
                $DvtSparkChartEventManager$$ = this.$_processScrollbarEvent$($DvtSparkChartEventManager$$.$getNewStartTime$(), $DvtSparkChartEventManager$$.$getNewEndTime$(), $DvtChartRefObjUtils$$ == $dvt$$2$$.$OverviewEvent$.$SUBTYPE_SCROLL_TIME$ || $DvtChartRefObjUtils$$ == $dvt$$2$$.$OverviewEvent$.$SUBTYPE_SCROLL_END$ || $DvtChartRefObjUtils$$ == $dvt$$2$$.$OverviewEvent$.$SUBTYPE_RANGECHANGE$, $DvtSparkChartDefaults$$);
              } else {
    ...
    if ("selection" == $DvtSparkChartEventManager$$.type) {
      ...
      "drill" == $DvtSparkChartEventManager$$.type && ($DvtChartEventUtils$$.$addEventData$(this, $DvtSparkChartEventManager$$), $DvtSparkChartEventManager$$.component = this.$getOptions$()._widgetConstructor);
    }
  ...
  $DvtChartAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtChartAutomation$$$$$getDomElementForSubId$$($DvtSparkChartEventManager$$) {
    ...
    if (0 < $DvtSparkChartDefaults$$ && 0 < $DvtSparkChartAutomation$$ || 0 < $DvtChartPieLabelUtils$$) {
      ...
      if ("funnel" == this.$_options$.type) {
        ...
        $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$.substring($DvtSparkChartAutomation$$ + 1), $DvtChartRefObjUtils$$ = $DvtSparkChartEventManager$$.indexOf("["), $DvtChartAxisUtils$$ = $DvtSparkChartEventManager$$.indexOf("]"), 0 <= $DvtChartRefObjUtils$$ && 0 <= $DvtChartAxisUtils$$ && ($DvtChartPieLabelInfo$$ = $DvtSparkChartEventManager$$.substring($DvtChartRefObjUtils$$ + 1, $DvtChartAxisUtils$$));
      }
  ...
  $DvtChartEventManager$$.prototype.$GetDragDataContexts$ = function $$DvtChartEventManager$$$$$GetDragDataContexts$$() {
    ...
    return [$DvtChartDataUtils$$.$getDataContext$(this.$_chart$, $dvt$$2$$.$getSeriesIndex$(), $dvt$$2$$.$getGroupIndex$(), $dvt$$2$$.$getNestedDataItemIndex$())];
  };
  ...
  $DvtChartObjPeer$$.prototype.$getNextNavigable$ = function $$DvtChartObjPeer$$$$$getNextNavigable$$($DvtSparkChartEventManager$$) {
    ...
    $DvtChartTypeUtils$$.$isScatterBubble$($DvtSparkChartDefaults$$) ? $DvtSparkChartEventManager$$ = $dvt$$2$$.$KeyboardHandler$.$getNextAdjacentNavigable$(this, $DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$) : $DvtChartTypeUtils$$.$isLineArea$($DvtSparkChartDefaults$$) || $DvtChartTypeUtils$$.$isStacked$($DvtSparkChartDefaults$$) || $DvtChartTypeUtils$$.$isPolar$($DvtSparkChartDefaults$$) ? $DvtSparkChartEventManager$$ = this.$_findNextNavigable$($DvtSparkChartEventManager$$) : !$DvtChartTypeUtils$$.$isFunnel$($DvtSparkChartDefaults$$) || 
    $DvtSparkChartEventManager$$.keyCode != $dvt$$2$$.KeyboardEvent.$UP_ARROW$ && $DvtSparkChartEventManager$$.keyCode != $dvt$$2$$.KeyboardEvent.$DOWN_ARROW$ ? $DvtSparkChartEventManager$$ = $dvt$$2$$.$KeyboardHandler$.$getNextNavigable$(this, $DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$, !0) : (--$DvtSparkChartEventManager$$.keyCode, $DvtSparkChartEventManager$$ = $dvt$$2$$.$KeyboardHandler$.$getNextNavigable$(this, $DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$));
    return $DvtSparkChartEventManager$$;
  };
  ...
  $DvtChartSelectableWedge$$.prototype.$setStyleProperties$ = function $$DvtChartSelectableWedge$$$$$setStyleProperties$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) {
  ...
  $DvtChartSelectableRectangularPolygon$$.prototype.$setStyleProperties$ = function $$DvtChartSelectableRectangularPolygon$$$$$setStyleProperties$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) {
    this.$_fill$ = $DvtSparkChartEventManager$$;
  ...
  $DvtChartBoxAndWhisker$$.prototype.$_render$ = function $$DvtChartBoxAndWhisker$$$$$_render$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$) {
    ...
    $DvtSparkChartEventManager$$ = Math.floor(($DvtSparkChartEventManager$$ + $DvtSparkChartDefaults$$) / 2);
    $DvtSparkChartDefaults$$ = $DvtSparkChartEventManager$$ - Math.floor($DvtChartRefObjUtils$$ / 2);
    $DvtChartRefObjUtils$$ = $DvtSparkChartEventManager$$ + Math.ceil($DvtChartRefObjUtils$$ / 2);
  ...
  $DvtChartBoxAndWhisker$$.prototype.$_applyCustomStyle$ = function $$DvtChartBoxAndWhisker$$$$$_applyCustomStyle$$($dvt$$2$$, $DvtSparkChartEventManager$$) {
    $dvt$$2$$.$setStyle$(this.$_styleOptions$[$DvtSparkChartEventManager$$ + "Style"]);
    $dvt$$2$$.$setClassName$(this.$_styleOptions$[$DvtSparkChartEventManager$$ + "ClassName"]);
  };
  ...
  $DvtChartLineArea$$.prototype.$_getPointArrays$ = function $$DvtChartLineArea$$$$$_getPointArrays$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    for (var $DvtChartPolarBar$$, $DvtChartDataChangeMarker$$, $DvtChartDataCursor$$, $DvtChartDataChangeFunnelSlice$$ = !1, $DvtChartFunnelSlice$$ = 0;$DvtChartFunnelSlice$$ < $DvtSparkChartEventManager$$.length;$DvtChartFunnelSlice$$++) {
      null == $DvtSparkChartEventManager$$[$DvtChartFunnelSlice$$] ? ($DvtChartAxisUtils$$.$isMixedFrequency$(this.$_chart$) || !$DvtChartPieRenderUtils$$ || $DvtChartPieLabelUtils$$ || !$DvtChartRangeMarker$$ || $DvtChartDataCursor$$ || ($DvtChartPolarBar$$ = $DvtChartPieLabelInfo$$ ? $DvtChartRangeMarker$$.x + .5 * $DvtChartDataChangePyramidSlice$$ * $DvtChartSeriesEffectUtils$$ : $DvtChartRangeMarker$$.x + $DvtChartDataChangePyramidSlice$$ * $DvtChartSeriesEffectUtils$$, this.$_pushCoord$($DvtChartRefObjUtils$$, 
      $DvtChartPolarBar$$, $DvtChartRangeMarker$$.y)), "jet" != this.$_chart$.$getOptions$()._environment && $DvtChartAxisUtils$$.$isMixedFrequency$(this.$_chart$) || ($DvtChartRefObjUtils$$ = [], $DvtSparkChartAutomation$$.push($DvtChartRefObjUtils$$), $DvtChartRangeMarker$$ = null)) : ($DvtChartPolarBar$$ = $DvtSparkChartEventManager$$[$DvtChartFunnelSlice$$], $DvtChartDataCursor$$ = $DvtSparkChartEventManager$$[$DvtChartFunnelSlice$$].$_isY2$, $DvtChartDataChangeMarker$$ = $DvtChartPieLabelInfo$$ ? 
      $DvtChartPolarBar$$.x - $DvtChartDataChangePyramidSlice$$ / 2 * $DvtChartSeriesEffectUtils$$ : $DvtChartPolarBar$$.x, $DvtChartDataCursor$$ && ($DvtChartDataChangeFunnelSlice$$ && $DvtChartPieRenderUtils$$ && ($DvtChartDataChangeMarker$$ += $DvtChartDataChangePyramidSlice$$ * $DvtChartSeriesEffectUtils$$), $DvtChartDataChangeFunnelSlice$$ = !$DvtChartDataChangeFunnelSlice$$), "curved" == $DvtSparkChartDefaults$$ && $DvtChartDataCursor$$ && $DvtChartRefObjUtils$$.push(null, null), $DvtChartRangeMarker$$ && 
      $DvtChartPieRenderUtils$$ && this.$_pushCoord$($DvtChartRefObjUtils$$, $DvtChartDataChangeMarker$$, $DvtChartRangeMarker$$.y), this.$_bArea$ || "segmented" != $DvtSparkChartDefaults$$ && "centeredSegmented" != $DvtSparkChartDefaults$$ || ($DvtChartRefObjUtils$$ = [], $DvtSparkChartAutomation$$.push($DvtChartRefObjUtils$$)), this.$_pushCoord$($DvtChartRefObjUtils$$, $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$.y), $DvtChartRangeMarker$$ = $DvtChartPolarBar$$);
    }
  ...
  $DvtChartFunnelSlice$$.prototype.$_getPath$ = function $$DvtChartFunnelSlice$$$$$_getPath$$() {
    ...
    var $DvtChartPieRenderUtils$$ = this.$_funnelHeight$, $DvtChartDataChangePyramidSlice$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_FUNNEL_RATIO$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, $DvtChartStyleUtils$$, $DvtChartPolarBar$$, $DvtChartDataChangeMarker$$, $DvtChartDataCursor$$, $DvtChartDataChangeFunnelSlice$$, $DvtChartDataChangeRangeMarker$$, $DvtChartPie$$;
    this.$_startPercent$ < $DvtChartFunnelSlice$$.$_AREA_FRACTION$ ? ($DvtChartSeriesEffectUtils$$ = this.$_startPercent$, $DvtChartRangeMarker$$ = $DvtChartPieRenderUtils$$, $DvtChartStyleUtils$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION$, $DvtChartDataChangeMarker$$ = $DvtChartFunnelSlice$$.$_AREA_FRACTION$, $DvtChartDataChangeFunnelSlice$$ = $DvtChartAxisUtils$$ * $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION$, $DvtChartPie$$ = $DvtChartAxisUtils$$ * (1 - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION$)) : 
    this.$_startPercent$ < $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$ ? ($DvtChartSeriesEffectUtils$$ = this.$_startPercent$ - $DvtChartFunnelSlice$$.$_AREA_FRACTION$, $DvtChartRangeMarker$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION$, $DvtChartStyleUtils$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION_2$, $DvtChartDataChangeMarker$$ = $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$ - $DvtChartFunnelSlice$$.$_AREA_FRACTION$, $DvtChartDataChangeFunnelSlice$$ = $DvtChartAxisUtils$$ * 
    ($DvtChartFunnelSlice$$.$_HEIGHT_FRACTION_2$ - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION$), $DvtChartPie$$ = $DvtChartAxisUtils$$ * (1 - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION_2$)) : ($DvtChartSeriesEffectUtils$$ = this.$_startPercent$ - $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$, $DvtChartRangeMarker$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION_2$, $DvtChartStyleUtils$$ = $DvtChartDataChangePyramidSlice$$, $DvtChartDataChangeMarker$$ = 1 - $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$, 
    $DvtChartDataChangeFunnelSlice$$ = $DvtChartAxisUtils$$ * (1 - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION_2$), $DvtChartPie$$ = 0);
    this.$_startPercent$ + this.$_valuePercent$ < $DvtChartFunnelSlice$$.$_AREA_FRACTION$ ? ($DvtChartPolarBar$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION$, $DvtChartDataChangePyramidSlice$$ = this.$_startPercent$ + this.$_valuePercent$, $DvtChartDataCursor$$ = $DvtChartFunnelSlice$$.$_AREA_FRACTION$, $DvtChartDataChangeRangeMarker$$ = $DvtChartAxisUtils$$ * $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION$, $DvtChartAxisUtils$$ *= 1 - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION$) : this.$_startPercent$ + 
    this.$_valuePercent$ < $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$ ? ($DvtChartPieRenderUtils$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION$, $DvtChartPolarBar$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION_2$, $DvtChartDataChangePyramidSlice$$ = this.$_startPercent$ + this.$_valuePercent$ - $DvtChartFunnelSlice$$.$_AREA_FRACTION$, $DvtChartDataCursor$$ = $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$ - $DvtChartFunnelSlice$$.$_AREA_FRACTION$, $DvtChartDataChangeRangeMarker$$ = 
    $DvtChartAxisUtils$$ * ($DvtChartFunnelSlice$$.$_HEIGHT_FRACTION_2$ - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION$), $DvtChartAxisUtils$$ *= 1 - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION_2$) : ($DvtChartPieRenderUtils$$ = this.$_funnelHeight$ * $DvtChartFunnelSlice$$.$_LINE_FRACTION_2$, $DvtChartPolarBar$$ = $DvtChartDataChangePyramidSlice$$, $DvtChartDataChangePyramidSlice$$ = this.$_startPercent$ + this.$_valuePercent$ - $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$, $DvtChartDataCursor$$ = 1 - $DvtChartFunnelSlice$$.$_AREA_FRACTION_2$, 
    $DvtChartDataChangeRangeMarker$$ = $DvtChartAxisUtils$$ * (1 - $DvtChartFunnelSlice$$.$_HEIGHT_FRACTION_2$), $DvtChartAxisUtils$$ = 0);
    $DvtChartSeriesEffectUtils$$ = .98 * Math.asin(((Math.sqrt(($DvtChartDataChangeMarker$$ - $DvtChartSeriesEffectUtils$$) / $DvtChartDataChangeMarker$$ * $DvtChartRangeMarker$$ * $DvtChartRangeMarker$$ + $DvtChartSeriesEffectUtils$$ / $DvtChartDataChangeMarker$$ * $DvtChartStyleUtils$$ * $DvtChartStyleUtils$$) - $DvtChartStyleUtils$$) * $DvtChartDataChangeFunnelSlice$$ / ($DvtChartRangeMarker$$ - $DvtChartStyleUtils$$) + $DvtChartPie$$) / $DvtSparkChartDefaults$$);
    $DvtChartRangeMarker$$ = .98 * Math.asin(((Math.sqrt(($DvtChartDataCursor$$ - $DvtChartDataChangePyramidSlice$$) / $DvtChartDataCursor$$ * $DvtChartPieRenderUtils$$ * $DvtChartPieRenderUtils$$ + $DvtChartDataChangePyramidSlice$$ / $DvtChartDataCursor$$ * $DvtChartPolarBar$$ * $DvtChartPolarBar$$) - $DvtChartPolarBar$$) * $DvtChartDataChangeRangeMarker$$ / ($DvtChartPieRenderUtils$$ - $DvtChartPolarBar$$) + $DvtChartAxisUtils$$) / $DvtSparkChartDefaults$$);
    ...
    $DvtChartDataChangeMarker$$ = new $dvt$$2$$.$Rectangle$(Math.min($DvtSparkChartAutomation$$[0], $DvtSparkChartAutomation$$[2]), $DvtSparkChartAutomation$$[5], Math.abs($DvtSparkChartAutomation$$[0] - $DvtSparkChartAutomation$$[2]), Math.abs($DvtSparkChartAutomation$$[3] - $DvtSparkChartAutomation$$[5]));
    if (null != this.$_fillPercent$) {
      var $DvtChartTextUtils$$ = Math.max(Math.min(this.$_fillPercent$, 1), 0), $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$ ? -$DvtChartTextUtils$$ * Math.PI : $DvtChartTextUtils$$ * Math.PI;
      ...
      $DvtChartTextUtils$$ = new $dvt$$2$$.$Rectangle$(Math.min($DvtSparkChartAutomation$$[0], $DvtSparkChartAutomation$$[2]), $DvtSparkChartAutomation$$[5] + Math.abs($DvtSparkChartAutomation$$[3] - $DvtSparkChartAutomation$$[5]) * (1 - $DvtChartTextUtils$$), Math.abs($DvtSparkChartAutomation$$[0] - $DvtSparkChartAutomation$$[2]), Math.abs($DvtSparkChartAutomation$$[3] - $DvtSparkChartAutomation$$[5]) * $DvtChartTextUtils$$);
    }
    return {slice:$DvtChartPieRenderUtils$$, bar:$DvtChartStyleUtils$$, sliceBounds:$DvtChartDataChangeMarker$$, barBounds:$DvtChartStyleUtils$$ ? $DvtChartTextUtils$$ : $DvtChartDataChangeMarker$$};
  };
  $DvtChartFunnelSlice$$.prototype.$_getSliceLabel$ = function $$DvtChartFunnelSlice$$$$$_getSliceLabel$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    if ($DvtSparkChartAutomation$$ && "none" != $DvtChartStyleUtils$$.$getDataLabelPosition$(this.$_chart$, this.$_seriesIndex$, 0)) {
      var $DvtSparkChartAutomation$$ = new $dvt$$2$$.$OutputText$(this.$getCtx$(), $DvtSparkChartAutomation$$, 0, 0), $DvtChartRefObjUtils$$ = null != $DvtChartStyleUtils$$.$getPattern$(this.$_chart$, this.$_seriesIndex$, 0), $DvtChartAxisUtils$$ = [this.$_chart$.$getOptions$().styleDefaults.dataLabelStyle, new $dvt$$2$$.$CSSStyle$(this.$_chart$.$getOptions$().styleDefaults.sliceLabelStyle), new $dvt$$2$$.$CSSStyle$($DvtChartDataUtils$$.$getDataItem$(this.$_chart$, this.$_seriesIndex$, 0).labelStyle)], 
  ...
  $DvtChartPyramidSlice$$.prototype.Init = function $$DvtChartPyramidSlice$$$$Init$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$) {
    $DvtChartPyramidSlice$$.$superclass$.Init.call(this, $dvt$$2$$.$getCtx$());
    this.$_chart$ = $dvt$$2$$;
    $dvt$$2$$ = $dvt$$2$$.$getOptions$().styleDefaults;
    this.$_seriesIndex$ = $DvtSparkChartEventManager$$;
    this.$_numDrawnSeries$ = $DvtSparkChartDefaults$$;
    this.$_pyramidWidth$ = $DvtSparkChartAutomation$$;
    this.$_pyramidHeight$ = $DvtChartRefObjUtils$$;
    this.$_startPercent$ = $DvtChartAxisUtils$$;
    this.$_valuePercent$ = $DvtChartPieLabelUtils$$;
    this.$_3dRatio$ = "on" == $dvt$$2$$.threeDEffect ? 1 : 0;
    this.$_gap$ = $DvtChartPieLabelInfo$$;
    $DvtSparkChartEventManager$$ = this.$_getPath$();
    this.$_dataColor$ = $DvtChartStyleUtils$$.$getColor$(this.$_chart$, this.$_seriesIndex$, 0);
    this.$setCmds$($DvtSparkChartEventManager$$.slice);
    this.$_setColorProperties$($DvtSparkChartEventManager$$.sliceBounds);
    this.$_label$ = this.$_getSliceLabel$($DvtSparkChartEventManager$$.sliceBounds, $DvtSparkChartEventManager$$.barBounds);
    null != this.$_label$ && (this.$_label$.$setMouseEnabled$(!1), this.$addChild$(this.$_label$));
  };
  $DvtChartPyramidSlice$$.$_PYRAMID_3D_WIDTH_RATIO$ = .08;
  $DvtChartPyramidSlice$$.$_BORDER_COLOR$ = "#FFFFFF";
  $DvtChartPyramidSlice$$.$_MIN_CHARS_DATA_LABEL$ = 3;
  $DvtChartPyramidSlice$$.$_MAX_LINES_DATA_LABEL$ = 2;
  $DvtChartPyramidSlice$$.prototype.$_getPath$ = function $$DvtChartPyramidSlice$$$$$_getPath$$() {
    var $DvtSparkChartEventManager$$ = $dvt$$2$$.$Agent$.$isRightToLeft$(this.$getCtx$()), $DvtSparkChartDefaults$$ = $DvtChartDataUtils$$.$getSeriesCount$(this.$_chart$), $DvtSparkChartAutomation$$ = ($DvtSparkChartDefaults$$ - this.$_numDrawnSeries$ + 1) * this.$_gap$, $DvtChartRefObjUtils$$ = Math.sqrt(Math.pow(this.$_pyramidWidth$ - $DvtSparkChartDefaults$$ * this.$_gap$, 2) * (1 - this.$_startPercent$)), $DvtChartAxisUtils$$ = 1 <= this.$_startPercent$ + this.$_valuePercent$ ? 0 : Math.sqrt(Math.pow(this.$_pyramidWidth$ - 
    $DvtSparkChartDefaults$$ * this.$_gap$, 2) * (1 - this.$_startPercent$ - this.$_valuePercent$)), $DvtChartPieLabelUtils$$ = .98 * this.$_pyramidHeight$ * $DvtChartAxisUtils$$ / this.$_pyramidWidth$, $DvtChartPieLabelInfo$$ = .98 * this.$_pyramidHeight$ * (0 == this.$_numDrawnSeries$ ? $DvtChartRefObjUtils$$ : $DvtChartRefObjUtils$$ - this.$_gap$) / this.$_pyramidWidth$, $DvtSparkChartAutomation$$ = $DvtSparkChartEventManager$$ ? [this.$_pyramidWidth$ - $DvtSparkChartAutomation$$ - $DvtChartAxisUtils$$, 
    .5 * this.$_pyramidHeight$ - $DvtChartPieLabelUtils$$ / 2, this.$_pyramidWidth$ - $DvtSparkChartAutomation$$ - $DvtChartRefObjUtils$$, .5 * this.$_pyramidHeight$ - $DvtChartPieLabelInfo$$ / 2, this.$_pyramidWidth$ - $DvtSparkChartAutomation$$ - $DvtChartRefObjUtils$$, .5 * this.$_pyramidHeight$ + $DvtChartPieLabelInfo$$ / 2, this.$_pyramidWidth$ - $DvtSparkChartAutomation$$ - $DvtChartAxisUtils$$, .5 * this.$_pyramidHeight$ + $DvtChartPieLabelUtils$$ / 2] : [$DvtSparkChartAutomation$$ + $DvtChartAxisUtils$$, 
    .5 * this.$_pyramidHeight$ - $DvtChartPieLabelUtils$$ / 2, $DvtSparkChartAutomation$$ + $DvtChartRefObjUtils$$, .5 * this.$_pyramidHeight$ - $DvtChartPieLabelInfo$$ / 2, $DvtSparkChartAutomation$$ + $DvtChartRefObjUtils$$, .5 * this.$_pyramidHeight$ + $DvtChartPieLabelInfo$$ / 2, $DvtSparkChartAutomation$$ + $DvtChartAxisUtils$$, .5 * this.$_pyramidHeight$ + $DvtChartPieLabelUtils$$ / 2], $DvtSparkChartEventManager$$ = $dvt$$2$$.$PathUtils$.moveTo($DvtSparkChartAutomation$$[0], $DvtSparkChartAutomation$$[1]), 
    $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$ + $dvt$$2$$.$PathUtils$.lineTo($DvtSparkChartAutomation$$[6], $DvtSparkChartAutomation$$[7]), $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$ + $dvt$$2$$.$PathUtils$.lineTo($DvtSparkChartAutomation$$[0], $DvtSparkChartAutomation$$[1]), $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$ + $dvt$$2$$.$PathUtils$.lineTo($DvtSparkChartAutomation$$[2], $DvtSparkChartAutomation$$[3]), $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$ + 
    $dvt$$2$$.$PathUtils$.lineTo($DvtSparkChartAutomation$$[4], $DvtSparkChartAutomation$$[5]), $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$ + $dvt$$2$$.$PathUtils$.lineTo($DvtSparkChartAutomation$$[6], $DvtSparkChartAutomation$$[7]), $DvtChartPieLabelInfo$$ = 1E-5 > Math.abs($DvtSparkChartAutomation$$[1] - $DvtSparkChartAutomation$$[7]) ? $DvtChartPieLabelInfo$$ / 2 - 10 : Math.abs($DvtSparkChartAutomation$$[1] - $DvtSparkChartAutomation$$[7]), $DvtSparkChartDefaults$$ = new $dvt$$2$$.$Rectangle$($DvtSparkChartDefaults$$ == 
    this.$_numDrawnSeries$ + 1 ? Math.min($DvtSparkChartAutomation$$[0], $DvtSparkChartAutomation$$[2]) + .1 * ($DvtChartRefObjUtils$$ - $DvtChartAxisUtils$$) : Math.min($DvtSparkChartAutomation$$[0], $DvtSparkChartAutomation$$[2]), 1E-5 > Math.abs($DvtSparkChartAutomation$$[1] - $DvtSparkChartAutomation$$[7]) ? $DvtSparkChartAutomation$$[7] + .5 * $DvtChartPieLabelInfo$$ : $DvtSparkChartAutomation$$[7], Math.abs($DvtSparkChartAutomation$$[0] - $DvtSparkChartAutomation$$[2]), $DvtChartPieLabelInfo$$);
    return {slice:$DvtSparkChartEventManager$$, sliceBounds:$DvtSparkChartDefaults$$, barBounds:$DvtSparkChartDefaults$$};
  };
  $DvtChartPyramidSlice$$.prototype.$_getSliceLabel$ = function $$DvtChartPyramidSlice$$$$$_getSliceLabel$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    var $DvtSparkChartAutomation$$ = $DvtChartDataUtils$$.$getDataLabel$(this.$_chart$, this.$_seriesIndex$, 0);
    $DvtSparkChartAutomation$$ || ($DvtSparkChartAutomation$$ = $DvtChartDataUtils$$.$getSeriesLabel$(this.$_chart$, this.$_seriesIndex$));
    if ($DvtSparkChartAutomation$$ && "none" != $DvtChartStyleUtils$$.$getDataLabelPosition$(this.$_chart$, this.$_seriesIndex$, 0)) {
      $DvtSparkChartAutomation$$ = new $dvt$$2$$.$MultilineText$(this.$getCtx$(), $DvtSparkChartAutomation$$, 0, 0);
      $DvtSparkChartAutomation$$.$setMaxLines$($DvtChartPyramidSlice$$.$_MAX_LINES_DATA_LABEL$);
      var $DvtChartRefObjUtils$$ = null != $DvtChartStyleUtils$$.$getPattern$(this.$_chart$, this.$_seriesIndex$, 0), $DvtChartAxisUtils$$ = [this.$_chart$.$getOptions$().styleDefaults.dataLabelStyle, new $dvt$$2$$.$CSSStyle$(this.$_chart$.$getOptions$().styleDefaults.sliceLabelStyle), new $dvt$$2$$.$CSSStyle$($DvtChartDataUtils$$.$getDataItem$(this.$_chart$, this.$_seriesIndex$, 0).labelStyle)], $DvtChartAxisUtils$$ = $dvt$$2$$.$CSSStyle$.$mergeStyles$($DvtChartAxisUtils$$);
      $DvtSparkChartAutomation$$.$setCSSStyle$($DvtChartAxisUtils$$);
      if ($dvt$$2$$.$TextUtils$.$fitText$($DvtSparkChartAutomation$$, $DvtSparkChartEventManager$$.$h$ - this.$_3dRatio$ * (.8 - this.$_valuePercent$) * 50, $DvtSparkChartEventManager$$.$w$, this, $DvtChartPyramidSlice$$.$_MIN_CHARS_DATA_LABEL$)) {
        var $DvtChartPieLabelUtils$$ = $DvtSparkChartAutomation$$.$measureDimensions$(), $DvtChartPieLabelInfo$$ = this.$_getLabelPosition$($DvtSparkChartEventManager$$);
        if ($DvtChartRefObjUtils$$) {
          var $DvtChartPieRenderUtils$$ = .15 * $DvtChartPieLabelUtils$$.$h$, $DvtChartDataChangePyramidSlice$$ = $dvt$$2$$.$Agent$.$isRightToLeft$(this.$getCtx$()) ? .5 : -.5, $DvtChartPieRenderUtils$$ = $dvt$$2$$.$PathUtils$.$roundedRectangle$($DvtChartPieLabelUtils$$.x - $DvtChartPieRenderUtils$$, $DvtChartPieLabelUtils$$.y, $DvtChartPieLabelUtils$$.$w$ + 2 * $DvtChartPieRenderUtils$$, $DvtChartPieLabelUtils$$.$h$, 2, 2, 2, 2), $DvtChartPieRenderUtils$$ = new $dvt$$2$$.$Path$(this.$getCtx$(), 
          $DvtChartPieRenderUtils$$);
        ...
        $DvtChartRefObjUtils$$ = $DvtChartRefObjUtils$$ ? "#000000" : $DvtSparkChartDefaults$$.$containsPoint$($DvtSparkChartEventManager$$.x, $DvtSparkChartEventManager$$.y + ($DvtSparkChartEventManager$$.$h$ - $DvtChartPieLabelUtils$$.$w$) / 2) ? $dvt$$2$$.$ColorUtils$.$getContrastingTextColor$(this.$_dataColor$) : $dvt$$2$$.$ColorUtils$.$getContrastingTextColor$(null);
        $DvtChartAxisUtils$$.$getStyle$("color") && !$dvt$$2$$.$Agent$.$isHighContrast$() || $DvtSparkChartAutomation$$.$setCSSStyle$($DvtChartAxisUtils$$.$setStyle$("color", $DvtChartRefObjUtils$$));
        $DvtSparkChartAutomation$$.$setMatrix$(this.$_getLabelPosition$($DvtSparkChartEventManager$$));
        $DvtSparkChartAutomation$$.$alignCenter$();
        $DvtSparkChartAutomation$$.$alignMiddle$();
  ...
  $DvtChartPyramidSlice$$.prototype.$_getLabelPosition$ = function $$DvtChartPyramidSlice$$$$$_getLabelPosition$$($DvtSparkChartEventManager$$) {
    var $DvtSparkChartDefaults$$ = $DvtSparkChartEventManager$$.$h$ * this.$_pyramidWidth$ / this.$_pyramidHeight$ * $DvtChartPyramidSlice$$.$_PYRAMID_3D_WIDTH_RATIO$ / 2 * this.$_3dRatio$, $DvtSparkChartAutomation$$ = new $dvt$$2$$.$Matrix$;
    $dvt$$2$$.$Agent$.$isRightToLeft$(this.$getCtx$()) ? ($DvtSparkChartAutomation$$.rotate(Math.PI / 2), $DvtSparkChartAutomation$$.translate($DvtSparkChartEventManager$$.x + $DvtSparkChartEventManager$$.$w$ / 2 - $DvtSparkChartDefaults$$, $DvtSparkChartEventManager$$.y - $DvtSparkChartEventManager$$.$h$ / 2)) : ($DvtSparkChartAutomation$$.rotate(3 * Math.PI / 2), $DvtSparkChartAutomation$$.translate($DvtSparkChartEventManager$$.x + $DvtSparkChartEventManager$$.$w$ / 2 + $DvtSparkChartDefaults$$, 
    $DvtSparkChartEventManager$$.y - $DvtSparkChartEventManager$$.$h$ / 2));
    return $DvtSparkChartAutomation$$;
  };
  $DvtChartPyramidSlice$$.prototype.$_setColorProperties$ = function $$DvtChartPyramidSlice$$$$$_setColorProperties$$($DvtSparkChartEventManager$$) {
    $DvtSparkChartEventManager$$ = $DvtChartSeriesEffectUtils$$.$getPyramidSliceFill$(this.$_chart$, this.$_seriesIndex$, this.$_dataColor$, $DvtSparkChartEventManager$$);
    var $DvtSparkChartDefaults$$ = $DvtChartStyleUtils$$.$getBorderColor$(this.$_chart$, this.$_seriesIndex$, 0);
    null == $DvtSparkChartDefaults$$ && 0 < this.$_3dRatio$ && ($DvtSparkChartDefaults$$ = $DvtChartPyramidSlice$$.$_BORDER_COLOR$);
    var $DvtSparkChartAutomation$$ = $DvtChartStyleUtils$$.$getBorderWidth$(this.$_chart$, this.$_seriesIndex$, 0);
    this.$setFill$($DvtSparkChartEventManager$$);
    ...
    $DvtSparkChartDefaults$$ && this.$setSolidStroke$($DvtSparkChartDefaults$$, null, $DvtSparkChartAutomation$$);
    this.$OriginalStroke$ = this.$getStroke$();
    this.$_chart$.$isSelectionSupported$() && ($DvtSparkChartEventManager$$ = $dvt$$2$$.$SelectionEffectUtils$.$getHoverBorderColor$(this.$_dataColor$), $DvtSparkChartDefaults$$ = $DvtChartStyleUtils$$.$getSelectedInnerColor$(this.$_chart$), $DvtSparkChartAutomation$$ = $DvtChartStyleUtils$$.$getSelectedOuterColor$(this.$_chart$) ? $DvtChartStyleUtils$$.$getSelectedOuterColor$(this.$_chart$) : this.$_dataColor$, this.$setHoverStroke$(new $dvt$$2$$.$SolidStroke$($DvtSparkChartEventManager$$, 1, 2)), 
    this.$setSelectedStroke$(new $dvt$$2$$.$SolidStroke$($DvtSparkChartDefaults$$, 1, 1.5), new $dvt$$2$$.$SolidStroke$($DvtSparkChartAutomation$$, 1, 4.5)), this.$setSelectedHoverStroke$(new $dvt$$2$$.$SolidStroke$($DvtSparkChartDefaults$$, 1, 1.5), new $dvt$$2$$.$SolidStroke$($DvtSparkChartEventManager$$, 1, 4.5)), this.setCursor("pointer"));
  };
  ...
  $DvtChartPyramidSlice$$.prototype.$setSelected$ = function $$DvtChartPyramidSlice$$$$$setSelected$$($dvt$$2$$) {
    ...
    var $DvtSparkChartEventManager$$ = this.$getDimensions$(), $DvtSparkChartDefaults$$ = $DvtSparkChartEventManager$$.$w$;
    $dvt$$2$$ ? (this.$setScaleX$(($DvtSparkChartDefaults$$ - 3) / $DvtSparkChartDefaults$$), this.$setTranslateX$(Math.ceil(1.5) + 3 / $DvtSparkChartDefaults$$ * $DvtSparkChartEventManager$$.x)) : (this.$setScaleX$(1), this.$setTranslateX$(0));
  };
  ...
  $DvtChartPie$$.prototype.$_createSlices$ = function $$DvtChartPie$$$$$_createSlices$$() {
    ...
    0 < $DvtChartRefObjUtils$$ && ($DvtSparkChartAutomation$$ = new $DvtChartPieSlice$$(this), "ascending" == this.$chart$.$getOptions$().sorting ? $DvtSparkChartEventManager$$.unshift($DvtSparkChartAutomation$$) : $DvtSparkChartEventManager$$.push($DvtSparkChartAutomation$$));
  ...
  $DvtChartPie$$.$_layoutSlices$ = function $$DvtChartPie$$$$_layoutSlices$$($dvt$$2$$, $DvtSparkChartEventManager$$) {
    ...
    for ($DvtSparkChartDefaults$$ = 0;$DvtSparkChartDefaults$$ < $DvtChartPieLabelUtils$$;$DvtSparkChartDefaults$$++) {
      $DvtSparkChartAutomation$$ = $dvt$$2$$[$DvtSparkChartDefaults$$], $DvtChartRefObjUtils$$ = $DvtSparkChartAutomation$$.getValue(), $DvtChartRefObjUtils$$ = 0 == $DvtChartPieLabelInfo$$ ? 0 : Math.abs($DvtChartRefObjUtils$$) / $DvtChartPieLabelInfo$$ * 100, $DvtChartAxisUtils$$ = 3.6 * $DvtChartRefObjUtils$$, $DvtChartRefObjUtils$$ = $DvtSparkChartEventManager$$ - $DvtChartAxisUtils$$, 0 > $DvtChartRefObjUtils$$ && ($DvtChartRefObjUtils$$ += 360), $DvtSparkChartAutomation$$.$setAngleStart$($DvtChartRefObjUtils$$), 
      $DvtSparkChartAutomation$$.$setAngleExtent$($DvtChartAxisUtils$$), $DvtSparkChartEventManager$$ = $DvtSparkChartAutomation$$.$getAngleStart$();
    }
  };
  ...
  $DvtChartAnimOnDisplay$$.$_animBubbleScatterFunnelPyramid$ = function $$DvtChartAnimOnDisplay$$$$_animBubbleScatterFunnelPyramid$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    if ($DvtChartAxisUtils$$) {
      for (var $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$ = 0;$DvtChartPieRenderUtils$$ < $DvtChartAxisUtils$$;$DvtChartPieRenderUtils$$++) {
        $DvtChartPieLabelUtils$$ = $DvtChartRefObjUtils$$[$DvtChartPieRenderUtils$$], $DvtChartPieLabelUtils$$ = $DvtChartPieLabelUtils$$.$getDisplayables$()[0], $DvtChartPieLabelUtils$$ instanceof $dvt$$2$$.$SimpleMarker$ ? $DvtChartPieLabelInfo$$ = new $dvt$$2$$.$AnimPopIn$($DvtSparkChartEventManager$$.$getCtx$(), $DvtChartPieLabelUtils$$, !0, $DvtSparkChartDefaults$$) : $DvtChartPieLabelUtils$$ instanceof $DvtChartFunnelSlice$$ ? $DvtChartPieLabelInfo$$ = $DvtChartAnimOnDisplay$$.$_getFunnelPlayable$($DvtSparkChartEventManager$$, 
        $DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$) : $DvtChartPieLabelUtils$$ instanceof $DvtChartPyramidSlice$$ && ($DvtChartPieLabelInfo$$ = $DvtChartAnimOnDisplay$$.$_getPyramidPlayable$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$)), $DvtChartPieLabelInfo$$ && $DvtSparkChartAutomation$$.push($DvtChartPieLabelInfo$$);
      }
    }
  };
  ...
  $DvtChartAnimOnDisplay$$.$_getFunnelPlayable$ = function $$DvtChartAnimOnDisplay$$$$_getFunnelPlayable$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    var $DvtChartRefObjUtils$$ = $DvtSparkChartDefaults$$.$getAnimationParams$(), $DvtChartAxisUtils$$ = $DvtChartRefObjUtils$$.slice(0), $DvtChartPieLabelUtils$$ = $DvtChartRefObjUtils$$.slice(0);
    $DvtChartRefObjUtils$$[0] = 0;
    $DvtChartRefObjUtils$$[2] = 0;
    $DvtChartAxisUtils$$[2] = 0;
    $DvtSparkChartDefaults$$.$setAnimationParams$($DvtChartRefObjUtils$$);
    $DvtChartRefObjUtils$$ = new $dvt$$2$$.$CustomAnimation$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$ / 2);
    $DvtChartRefObjUtils$$.$_animator$.$addProp$($dvt$$2$$.$Animator$.$TYPE_NUMBER_ARRAY$, $DvtSparkChartDefaults$$, $DvtSparkChartDefaults$$.$getAnimationParams$, $DvtSparkChartDefaults$$.$setAnimationParams$, $DvtChartAxisUtils$$);
    ...
    return new $dvt$$2$$.$SequentialPlayable$($DvtSparkChartEventManager$$, [$DvtChartRefObjUtils$$, $DvtSparkChartAutomation$$]);
  };
  $DvtChartAnimOnDisplay$$.$_getPyramidPlayable$ = function $$DvtChartAnimOnDisplay$$$$_getPyramidPlayable$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    $DvtSparkChartEventManager$$ = $DvtSparkChartEventManager$$.$getCtx$();
    var $DvtChartRefObjUtils$$ = $DvtSparkChartDefaults$$.$getAnimationParams$(), $DvtChartAxisUtils$$ = $DvtChartRefObjUtils$$.slice(0), $DvtChartPieLabelUtils$$ = $DvtChartRefObjUtils$$.slice(0);
    $DvtChartRefObjUtils$$[0] = 0;
    $DvtSparkChartDefaults$$.$setAnimationParams$($DvtChartRefObjUtils$$);
  ...
  $DvtChartDataChangeBar$$.prototype.$animateUpdate$ = function $$DvtChartDataChangeBar$$$$$animateUpdate$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    if (!$dvt$$2$$.$ArrayUtils$.$equals$($DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$) || !$DvtChartPieRenderUtils$$.$equals$($DvtChartDataChangePyramidSlice$$)) {
      var $DvtChartSeriesEffectUtils$$ = this.$_peer$.$getSeriesIndex$(), $DvtChartRangeMarker$$ = $DvtSparkChartDefaults$$.$_peer$.$getSeriesIndex$(), $DvtChartPolarBar$$ = this.$_peer$.$getGroupIndex$(), $DvtChartDataChangeMarker$$ = $DvtSparkChartDefaults$$.$_peer$.$getGroupIndex$();
      "none" !== $DvtChartStyleUtils$$.$getAnimationIndicators$($DvtChartRefObjUtils$$) && (this.$_indicator$ = $DvtChartDataChangeUtils$$.$makeIndicator$($DvtSparkChartAutomation$$, $DvtChartRangeMarker$$, $DvtChartDataChangeMarker$$, $DvtChartRefObjUtils$$, $DvtChartSeriesEffectUtils$$, $DvtChartPolarBar$$));
  ...
  $DvtChartDataChangeLineArea$$.prototype.$animateUpdate$ = function $$DvtChartDataChangeLineArea$$$$$animateUpdate$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    var $DvtChartDataChangeMarker$$, $DvtChartRangeMarker$$ = $DvtSparkChartDefaults$$.$_getAnimationParams$(this.$_shape$), $DvtChartPolarBar$$ = this.$_getAnimationParams$($DvtSparkChartDefaults$$.$_shape$);
    $DvtChartDataChangeLineArea$$.$_matchGroupIndices$($DvtChartRangeMarker$$, $DvtChartPolarBar$$);
    $dvt$$2$$.$ArrayUtils$.$equals$($DvtChartRangeMarker$$, $DvtChartPolarBar$$) || (this.$_setAnimationParams$($DvtChartRangeMarker$$), $DvtChartDataChangeMarker$$ = new $dvt$$2$$.$CustomAnimation$(this.$_context$, this, this.$_updateDuration$), $DvtChartDataChangeMarker$$.$_animator$.$addProp$($dvt$$2$$.$Animator$.$TYPE_NUMBER_ARRAY$, this, this.$_getAnimationParams$, this.$_setAnimationParams$, $DvtChartPolarBar$$));
    ...
    if ($DvtChartSeriesEffectUtils$$ || $DvtChartDataChangeMarker$$) {
      $DvtChartRefObjUtils$$ = new $dvt$$2$$.$ParallelPlayable$(this.$_context$, $DvtChartSeriesEffectUtils$$, $DvtChartDataChangeMarker$$), $DvtChartRefObjUtils$$.$setOnEnd$(this.$_onAnimationEnd$, this), $DvtSparkChartEventManager$$.add($DvtChartRefObjUtils$$, 1);
    }
  };
  ...
  $DvtChartDataChangePyramidSlice$$.prototype.$animateUpdate$ = function $$DvtChartDataChangePyramidSlice$$$$$animateUpdate$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    var $DvtSparkChartAutomation$$ = this.$_shape$, $DvtChartRefObjUtils$$ = $DvtSparkChartDefaults$$.$_shape$.$getAnimationParams$(), $DvtChartAxisUtils$$ = $DvtSparkChartAutomation$$.$getAnimationParams$(), $DvtChartPieLabelUtils$$ = $DvtSparkChartDefaults$$.$_shape$.$getFill$().clone(), $DvtChartPieLabelInfo$$ = this.$_shape$.$getFill$();
    $dvt$$2$$.$ArrayUtils$.$equals$($DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) && $DvtChartPieLabelUtils$$.$equals$($DvtChartPieLabelInfo$$) || ($DvtSparkChartAutomation$$.$setAnimationParams$($DvtChartRefObjUtils$$), this.$_shape$.$setFill$($DvtChartPieLabelUtils$$), $DvtChartRefObjUtils$$ = new $dvt$$2$$.$CustomAnimation$($DvtSparkChartAutomation$$.$getCtx$(), this, this.$_updateDuration$), $DvtChartRefObjUtils$$.$_animator$.$addProp$($dvt$$2$$.$Animator$.$TYPE_NUMBER_ARRAY$, $DvtSparkChartAutomation$$, 
    $DvtSparkChartAutomation$$.$getAnimationParams$, $DvtSparkChartAutomation$$.$setAnimationParams$, $DvtChartAxisUtils$$), this.$_indicator$ && $DvtChartRefObjUtils$$.$setOnEnd$(this.$_onEndAnimation$, this), $DvtSparkChartEventManager$$.add($DvtChartRefObjUtils$$, 1));
  };
  ...
  $DvtChartAxisUtils$$.$getGroupWidthRatios$ = function $$DvtChartAxisUtils$$$$getGroupWidthRatios$$($DvtSparkChartEventManager$$) {
    ...
    var $DvtChartDataChangeMarker$$ = $DvtSparkChartEventManager$$ * $DvtSparkChartAutomation$$ / (1 - $DvtSparkChartAutomation$$), $DvtSparkChartAutomation$$ = $dvt$$2$$.$ArrayUtils$.map($DvtChartPieRenderUtils$$, function($dvt$$2$$) {
      return $dvt$$2$$ + $DvtChartDataChangeMarker$$ / $DvtChartRefObjUtils$$;
    });
    $DvtSparkChartDefaults$$._averageGroupZ = ($DvtSparkChartEventManager$$ + $DvtChartDataChangeMarker$$) / $DvtChartRefObjUtils$$;
    return $DvtSparkChartAutomation$$;
  };
  ...
  $DvtChartDataUtils$$.$processDataObject$ = function $$DvtChartDataUtils$$$$processDataObject$$($DvtSparkChartEventManager$$) {
    if ($DvtChartDataUtils$$.$hasData$($DvtSparkChartEventManager$$)) {
      ...
      for (var $DvtChartRangeMarker$$ = 0, $DvtChartPolarBar$$ = $DvtSparkChartEventManager$$.$SeriesStyleArray$, $DvtChartDataChangeMarker$$ = 0;$DvtChartDataChangeMarker$$ < $DvtChartPieLabelUtils$$;$DvtChartDataChangeMarker$$++) {
        var $DvtChartDataCursor$$ = $DvtChartDataUtils$$.$getSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$);
        !$DvtChartSeriesEffectUtils$$ && null != $DvtChartDataCursor$$ && 0 > $dvt$$2$$.$ArrayUtils$.$getIndex$($DvtChartPolarBar$$, $DvtChartDataCursor$$) && ($DvtChartPolarBar$$.push($DvtChartDataCursor$$), "boxPlot" == $DvtChartStyleUtils$$.$getSeriesType$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$) && $DvtChartPolarBar$$.push($DvtChartDataCursor$$));
        var $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.$getSeriesItem$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$);
        $DvtChartDataChangeFunnelSlice$$.items && $DvtChartDataChangeFunnelSlice$$.items.length > $DvtChartRangeMarker$$ && ($DvtChartRangeMarker$$ = $DvtChartDataChangeFunnelSlice$$.items.length);
        if ("hidden" == $DvtChartDataChangeFunnelSlice$$.visibility) {
          var $DvtChartFunnelSlice$$ = $DvtChartStyleUtils$$.$getHiddenCategories$($DvtSparkChartEventManager$$);
          0 > $dvt$$2$$.$ArrayUtils$.$getIndex$($DvtChartFunnelSlice$$, $DvtChartDataCursor$$) && $DvtChartFunnelSlice$$.push($DvtChartDataCursor$$);
        }
        $DvtChartDataChangeFunnelSlice$$.visibility = null;
        "on" == $DvtChartDataChangeFunnelSlice$$.assignedToY2 && $DvtSparkChartAutomation$$.$putToCache$("hasY2Assignment", !0);
        if ($DvtChartDataChangeFunnelSlice$$ && $DvtChartDataChangeFunnelSlice$$.items) {
          for (var $DvtChartFunnelSlice$$ = $DvtChartDataChangeFunnelSlice$$.items, $DvtChartDataChangeRangeMarker$$, $DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartFunnelSlice$$.length;$DvtChartDataCursor$$++) {
            $DvtChartFunnelSlice$$[$DvtChartDataCursor$$] && ($DvtChartDataChangeRangeMarker$$ = $DvtChartFunnelSlice$$[$DvtChartDataCursor$$], "object" != typeof $DvtChartDataChangeRangeMarker$$ ? $DvtChartDataChangeRangeMarker$$ = Number($DvtChartDataChangeRangeMarker$$) : (!$DvtChartDataChangePyramidSlice$$ && $DvtChartDataChangeRangeMarker$$.x && ($DvtChartDataChangeRangeMarker$$.x = Number($DvtChartDataChangeRangeMarker$$.x)), $DvtChartDataChangeRangeMarker$$.y && ($DvtChartDataChangeRangeMarker$$.y = 
            Number($DvtChartDataChangeRangeMarker$$.y)), $DvtChartDataChangeRangeMarker$$.z && ($DvtChartDataChangeRangeMarker$$.z = Number($DvtChartDataChangeRangeMarker$$.z), $DvtChartPieRenderUtils$$ && 1 != $DvtChartDataChangeRangeMarker$$.z && $DvtSparkChartAutomation$$.$putToCache$("_hasVaryingBarWidth", !0)), $DvtChartDataChangeRangeMarker$$.value && ($DvtChartDataChangeRangeMarker$$.value = Number($DvtChartDataChangeRangeMarker$$.value)), $DvtChartDataChangeRangeMarker$$.targetValue && ($DvtChartDataChangeRangeMarker$$.targetValue = 
      ...
      if ($DvtChartPieLabelInfo$$ && $DvtChartDataUtils$$.$hasVolumeSeries$($DvtSparkChartEventManager$$) && !$DvtChartTypeUtils$$.$isOverview$($DvtSparkChartEventManager$$)) {
        ...
        $DvtChartDataChangeMarker$$.categories = $DvtChartDataUtils$$.$getCategories$($DvtSparkChartEventManager$$, 0);
        $DvtChartDataChangeMarker$$.id = "_volume";
        $DvtChartDataChangeMarker$$._selectable = "off";
        $DvtChartDataChangeMarker$$.items = [];
        for ($DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartDataChangeFunnelSlice$$.items.length;$DvtChartDataCursor$$++) {
          $DvtSparkChartAutomation$$ = {}, $DvtSparkChartAutomation$$.color = $DvtChartStyleUtils$$.$getStockVolumeColor$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$), $DvtSparkChartAutomation$$.x = $DvtChartDataChangeFunnelSlice$$.items[$DvtChartDataCursor$$].x, $DvtSparkChartAutomation$$.value = $DvtChartDataChangeFunnelSlice$$.items[$DvtChartDataCursor$$].volume, $DvtChartDataChangeMarker$$.items.push($DvtSparkChartAutomation$$);
        }
        $DvtSparkChartDefaults$$.series.push($DvtChartDataChangeMarker$$);
      }
      $DvtChartDataChangeFunnelSlice$$ = $DvtChartRefObjUtils$$.$getRefObjs$($DvtSparkChartEventManager$$);
      for ($DvtChartDataChangeMarker$$ = 0;$DvtChartDataChangeMarker$$ < $DvtChartDataChangeFunnelSlice$$.length;$DvtChartDataChangeMarker$$++) {
        if ($DvtChartFunnelSlice$$ = $DvtChartDataChangeFunnelSlice$$[$DvtChartDataChangeMarker$$].items) {
          for ($DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartFunnelSlice$$.length;$DvtChartDataCursor$$++) {
            if ($DvtChartDataChangeRangeMarker$$ = $DvtChartFunnelSlice$$[$DvtChartDataCursor$$]) {
              "object" != typeof $DvtChartDataChangeRangeMarker$$ ? $DvtChartFunnelSlice$$[$DvtChartDataCursor$$] = Number($DvtChartDataChangeRangeMarker$$) : (!$DvtChartAxisUtils$$.$isMixedFrequency$($DvtSparkChartEventManager$$) && $DvtChartDataChangeRangeMarker$$.x && ($DvtChartDataChangeRangeMarker$$.x = Number($DvtChartDataChangeRangeMarker$$.x)), $DvtChartDataChangeRangeMarker$$.max && ($DvtChartDataChangeRangeMarker$$.max = Number($DvtChartDataChangeRangeMarker$$.max)), $DvtChartDataChangeRangeMarker$$.min && 
      ...
      for ($DvtChartDataChangeMarker$$ = 0;$DvtChartDataChangeMarker$$ < $DvtChartRangeMarker$$ - $DvtChartDataCursor$$;$DvtChartDataChangeMarker$$++) {
        $DvtChartDataChangeFunnelSlice$$ = $dvt$$2$$.$Bundle$.$getTranslation$($DvtSparkChartDefaults$$, "labelDefaultGroupName", $dvt$$2$$.$Bundle$.$CHART_PREFIX$, "DEFAULT_GROUP_NAME", $DvtSparkChartDefaults$$.groups.length + 1), $DvtSparkChartDefaults$$.groups.push($DvtChartDataChangeFunnelSlice$$);
      }
      ...
      $DvtChartDataChangeFunnelSlice$$ = $DvtSparkChartDefaults$$.sorting;
      $DvtChartDataChangeFunnelSlice$$ = "on" == $DvtChartDataChangeFunnelSlice$$ ? "descending" : "ascending" != $DvtChartDataChangeFunnelSlice$$ && "descending" != $DvtChartDataChangeFunnelSlice$$ ? "off" : $DvtChartDataChangeFunnelSlice$$;
      if ($DvtChartTypeUtils$$.$isBLAC$($DvtSparkChartEventManager$$) && $DvtChartAxisUtils$$.$hasGroupAxis$($DvtSparkChartEventManager$$) && "off" != $DvtChartDataChangeFunnelSlice$$ && 1 == $DvtChartDataUtils$$.$getNumLevels$($DvtSparkChartEventManager$$)) {
        for (var $DvtChartRangeMarker$$ = $DvtChartDataUtils$$.$getGroups$($DvtSparkChartEventManager$$), $DvtChartPie$$ = {}, $DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartRangeMarker$$.length;$DvtChartDataCursor$$++) {
          for ($DvtChartDataChangeMarker$$ = $DvtSparkChartAutomation$$ = 0;$DvtChartDataChangeMarker$$ <= $DvtChartPieLabelUtils$$;$DvtChartDataChangeMarker$$++) {
            $DvtChartStyleUtils$$.$isSeriesRendered$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$) && !$DvtChartDataUtils$$.$isAssignedToY2$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$) && ($DvtChartPieLabelInfo$$ = $DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$, $DvtChartDataCursor$$), $DvtSparkChartAutomation$$ += null == $DvtChartPieLabelInfo$$ || isNaN($DvtChartPieLabelInfo$$) ? 0 : $DvtChartPieLabelInfo$$);
          }
          $DvtChartPie$$[$DvtChartRangeMarker$$[$DvtChartDataCursor$$]] = {index:$DvtChartDataCursor$$, total:$DvtSparkChartAutomation$$, group:$DvtSparkChartDefaults$$.groups[$DvtChartDataCursor$$]};
        }
        "ascending" == $DvtChartDataChangeFunnelSlice$$ ? $DvtChartRangeMarker$$.sort(function($dvt$$2$$, $DvtSparkChartEventManager$$) {
          return $DvtChartPie$$[$dvt$$2$$].total - $DvtChartPie$$[$DvtSparkChartEventManager$$].total;
        }) : $DvtChartRangeMarker$$.sort(function($dvt$$2$$, $DvtSparkChartEventManager$$) {
          return $DvtChartPie$$[$DvtSparkChartEventManager$$].total - $DvtChartPie$$[$dvt$$2$$].total;
        });
        for ($DvtChartDataChangeMarker$$ = 0;$DvtChartDataChangeMarker$$ < $DvtChartPieLabelUtils$$;$DvtChartDataChangeMarker$$++) {
          ...
          for ($DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartRangeMarker$$.length;$DvtChartDataCursor$$++) {
            $DvtChartDataChangeFunnelSlice$$.push($DvtChartDataUtils$$.$getDataItem$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$, $DvtChartPie$$[$DvtChartRangeMarker$$[$DvtChartDataCursor$$]].index));
          }
          $DvtSparkChartDefaults$$.series[$DvtChartDataChangeMarker$$].items = $DvtChartDataChangeFunnelSlice$$;
        }
        $DvtChartPieLabelUtils$$ = [];
        for ($DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartRangeMarker$$.length;$DvtChartDataCursor$$++) {
          $DvtChartPieLabelUtils$$.push($DvtChartPie$$[$DvtChartRangeMarker$$[$DvtChartDataCursor$$]].group);
        }
      ...
      $DvtSparkChartDefaults$$.viewportEndGroup)), $dvt$$2$$ = $DvtChartRefObjUtils$$.$getRefObjs$($dvt$$2$$), $DvtSparkChartDefaults$$ = 0;$DvtSparkChartDefaults$$ < $dvt$$2$$.length;$DvtSparkChartDefaults$$++) {
        if ($DvtChartPieLabelUtils$$ = $dvt$$2$$[$DvtSparkChartDefaults$$].items) {
          for ($DvtChartPieRenderUtils$$ = 0;$DvtChartPieRenderUtils$$ < $DvtChartPieLabelUtils$$.length;$DvtChartPieRenderUtils$$++) {
            null != $DvtChartPieLabelUtils$$[$DvtChartPieRenderUtils$$].x && ($DvtChartPieLabelUtils$$[$DvtChartPieRenderUtils$$].x = $DvtChartDataUtils$$.$_sanitizeDateTime$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$[$DvtChartPieRenderUtils$$].x));
          }
        }
      }
    }
  ...
  $DvtChartDataUtils$$.$isEqualId$ = function $$DvtChartDataUtils$$$$isEqualId$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    return $DvtSparkChartEventManager$$ == $DvtSparkChartDefaults$$ || $dvt$$2$$.$ArrayUtils$.isArray($DvtSparkChartEventManager$$) && $dvt$$2$$.$ArrayUtils$.isArray($DvtSparkChartDefaults$$) && $dvt$$2$$.$ArrayUtils$.$equals$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) ? !0 : !1;
  };
  ...
  $DvtChartDataUtils$$.$getCumulativeValue$ = function $$DvtChartDataUtils$$$$getCumulativeValue$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    if ($DvtChartTypeUtils$$.$isStacked$($dvt$$2$$)) {
      for (var $DvtChartPieLabelUtils$$ = $DvtChartStyleUtils$$.$getSeriesType$($dvt$$2$$, $DvtSparkChartEventManager$$), $DvtChartPieLabelInfo$$ = $DvtChartDataUtils$$.$isAssignedToY2$($dvt$$2$$, $DvtSparkChartEventManager$$), $DvtChartAxisUtils$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$), $DvtChartPieRenderUtils$$ = "bar" == $DvtChartPieLabelUtils$$ ? 0 > $DvtChartAxisUtils$$ : $DvtChartDataUtils$$.$isSeriesNegative$($dvt$$2$$, $DvtSparkChartEventManager$$), 
      $DvtChartAxisUtils$$ = 0, $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.$getStackCategory$($dvt$$2$$, $DvtSparkChartEventManager$$), $DvtChartSeriesEffectUtils$$ = 0;$DvtChartSeriesEffectUtils$$ <= $DvtSparkChartEventManager$$;$DvtChartSeriesEffectUtils$$++) {
        if (($DvtSparkChartAutomation$$ || $DvtChartStyleUtils$$.$isDataItemRendered$($dvt$$2$$, $DvtChartSeriesEffectUtils$$, $DvtSparkChartDefaults$$)) && $DvtChartPieLabelUtils$$ == $DvtChartStyleUtils$$.$getSeriesType$($dvt$$2$$, $DvtChartSeriesEffectUtils$$) && $DvtChartPieLabelInfo$$ == $DvtChartDataUtils$$.$isAssignedToY2$($dvt$$2$$, $DvtChartSeriesEffectUtils$$) && $DvtChartDataUtils$$.$getStackCategory$($dvt$$2$$, $DvtChartSeriesEffectUtils$$) == $DvtChartDataChangePyramidSlice$$) {
          var $DvtChartRangeMarker$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtChartSeriesEffectUtils$$, $DvtSparkChartDefaults$$), $DvtChartPolarBar$$ = "bar" == $DvtChartPieLabelUtils$$ ? 0 > $DvtChartRangeMarker$$ : $DvtChartDataUtils$$.$isSeriesNegative$($dvt$$2$$, $DvtChartSeriesEffectUtils$$);
          if ($DvtChartPieRenderUtils$$ && $DvtChartPolarBar$$ || !$DvtChartPieRenderUtils$$ && !$DvtChartPolarBar$$) {
            $DvtChartAxisUtils$$ += null == $DvtChartRangeMarker$$ || isNaN($DvtChartRangeMarker$$) ? 0 : $DvtChartRangeMarker$$;
          }
        }
      }
    } else {
      $DvtChartAxisUtils$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
    }
  ...
  $DvtChartDataUtils$$.$_getViewportEdgeYValues$ = function $$DvtChartDataUtils$$$$_getViewportEdgeYValues$$($dvt$$2$$, $DvtSparkChartEventManager$$) {
    ...
    $DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, $DvtChartDataChangeMarker$$, $DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtSparkChartDefaults$$.length;$DvtChartDataCursor$$++) {
      if ($DvtSparkChartAutomation$$ || $DvtChartStyleUtils$$.$isDataItemRendered$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtChartDataCursor$$)) {
        ...
        $DvtChartDataUtils$$.$_computeYAlongLine$($DvtChartPieLabelInfo$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$, $DvtChartPieLabelUtils$$)), null != $DvtChartRefObjUtils$$ && $DvtChartRefObjUtils$$ > $DvtChartSeriesEffectUtils$$ && $DvtChartRefObjUtils$$ < $DvtChartPieRenderUtils$$ && ($DvtChartDataChangeMarker$$ = $DvtChartDataUtils$$.$_computeYAlongLine$($DvtChartPieLabelInfo$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, 
    ...
    return {min:$DvtChartPolarBar$$, max:$DvtChartDataChangeMarker$$};
  };
  $DvtChartDataUtils$$.$getMinMaxValue$ = function $$DvtChartDataUtils$$$$getMinMaxValue$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    for (var $DvtChartDataChangePyramidSlice$$ = "y" == $DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$ = !$DvtSparkChartDefaults$$ && $DvtChartDataChangePyramidSlice$$ && $DvtChartTypeUtils$$.$isBLAC$($dvt$$2$$), $DvtChartSeriesEffectUtils$$ = "withoutRescale" == $DvtChartEventUtils$$.$getHideAndShowBehavior$($dvt$$2$$) || "x" == $DvtSparkChartEventManager$$ && $DvtChartAxisUtils$$.$hasTimeAxis$($dvt$$2$$), $DvtChartRangeMarker$$ = -Infinity, $DvtChartPolarBar$$ = Infinity, $DvtChartDataChangeMarker$$ = 
    $DvtChartDataUtils$$.$getSeriesCount$($dvt$$2$$), $DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartDataChangeMarker$$;$DvtChartDataCursor$$++) {
      var $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.$getSeriesItem$($dvt$$2$$, $DvtChartDataCursor$$), $DvtChartFunnelSlice$$ = $DvtChartStyleUtils$$.$getSeriesType$($dvt$$2$$, $DvtChartDataCursor$$), $DvtChartDataChangeRangeMarker$$ = $DvtChartDataChangePyramidSlice$$ && ($DvtChartStyleUtils$$.$isRangeSeries$($dvt$$2$$, $DvtChartDataCursor$$) || "candlestick" == $DvtChartFunnelSlice$$ || "boxPlot" == $DvtChartFunnelSlice$$);
      if ($DvtChartSeriesEffectUtils$$ || $DvtChartStyleUtils$$.$isSeriesRendered$($dvt$$2$$, $DvtChartDataCursor$$)) {
        if ($DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$isAssignedToY2$($dvt$$2$$, $DvtChartDataCursor$$), !$DvtChartDataChangePyramidSlice$$ || $DvtChartPieRenderUtils$$ == $DvtChartFunnelSlice$$) {
          var $DvtChartPie$$ = $DvtChartDataChangeFunnelSlice$$.items;
          if ($DvtChartPie$$) {
            for (var $DvtChartTextUtils$$ = 0;$DvtChartTextUtils$$ < $DvtChartPie$$.length;$DvtChartTextUtils$$++) {
              if ($DvtChartSeriesEffectUtils$$ || $DvtChartStyleUtils$$.$isDataItemRendered$($dvt$$2$$, $DvtChartDataCursor$$, $DvtChartTextUtils$$)) {
                if ("object" != typeof $DvtChartPie$$[$DvtChartTextUtils$$] && ($DvtChartPie$$[$DvtChartTextUtils$$] = {y:$DvtChartPie$$[$DvtChartTextUtils$$]}), $DvtChartDataChangeFunnelSlice$$ = $DvtChartPie$$[$DvtChartTextUtils$$], $DvtChartFunnelSlice$$ = null, $DvtChartDataChangePyramidSlice$$ ? $DvtChartDataChangeRangeMarker$$ || ($DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$getCumulativeValue$($dvt$$2$$, $DvtChartDataCursor$$, $DvtChartTextUtils$$, $DvtChartSeriesEffectUtils$$)) : "x" == 
                $DvtSparkChartEventManager$$ && $DvtChartAxisUtils$$.$hasTimeAxis$($dvt$$2$$) && !$DvtChartAxisUtils$$.$isMixedFrequency$($dvt$$2$$) ? ($DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$getGroupLabel$($dvt$$2$$, $DvtChartTextUtils$$), null != $DvtChartDataChangeFunnelSlice$$ && ($DvtChartDataChangeFunnelSlice$$.x = $DvtChartFunnelSlice$$)) : null != $DvtChartDataChangeFunnelSlice$$ && ($DvtChartFunnelSlice$$ = $DvtChartDataChangeFunnelSlice$$[$DvtSparkChartEventManager$$]), !("z" == 
                $DvtSparkChartEventManager$$ && 0 >= $DvtChartFunnelSlice$$ || $DvtChartPieLabelUtils$$ && !$DvtChartDataUtils$$.$isXInViewport$($dvt$$2$$, $DvtChartDataCursor$$, $DvtChartTextUtils$$))) {
                  if (!($DvtChartDataChangeRangeMarker$$ || null == $DvtChartFunnelSlice$$ || "number" != typeof $DvtChartFunnelSlice$$ || $DvtChartPieLabelInfo$$ && 0 >= $DvtChartFunnelSlice$$)) {
                    var $DvtChartOverview$$ = 0;
                    $DvtChartTypeUtils$$.$isBubble$($dvt$$2$$) && !$DvtSparkChartDefaults$$ && "z" != $DvtSparkChartEventManager$$ && ($DvtChartOverview$$ = $DvtChartMarkerUtils$$.$getBubbleAxisRadius$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtChartDataChangeFunnelSlice$$.markerSize));
                    $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartPieLabelInfo$$ ? $DvtChartFunnelSlice$$ * Math.pow(10, $DvtChartOverview$$) : $DvtChartFunnelSlice$$ + $DvtChartOverview$$);
                    $DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartPieLabelInfo$$ ? $DvtChartFunnelSlice$$ / Math.pow(10, $DvtChartOverview$$) : $DvtChartFunnelSlice$$ - $DvtChartOverview$$);
                  }
                  $DvtChartDataChangeRangeMarker$$ && ($DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.$getHighValue$($dvt$$2$$, $DvtChartDataCursor$$, $DvtChartTextUtils$$), $DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$getLowValue$($dvt$$2$$, $DvtChartDataCursor$$, $DvtChartTextUtils$$), $DvtChartPieLabelInfo$$ && (0 >= $DvtChartDataChangeFunnelSlice$$ || 0 >= $DvtChartFunnelSlice$$) || ($DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartDataChangeFunnelSlice$$, $DvtChartFunnelSlice$$), 
                  $DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartDataChangeFunnelSlice$$, $DvtChartFunnelSlice$$)));
                }
              }
            }
            $DvtChartPieLabelUtils$$ && ($DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.$_getViewportEdgeYValues$($dvt$$2$$, $DvtChartDataCursor$$), null != $DvtChartDataChangeFunnelSlice$$.min && ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartDataChangeFunnelSlice$$.min), $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartDataChangeFunnelSlice$$.min)), null != $DvtChartDataChangeFunnelSlice$$.max && ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartDataChangeFunnelSlice$$.max), 
            $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartDataChangeFunnelSlice$$.max)));
          }
        }
      }
    }
        ...
        if ($DvtChartDataChangePyramidSlice$$ = $DvtSparkChartDefaults$$[$DvtSparkChartEventManager$$], $DvtChartPieRenderUtils$$ = $DvtChartDataChangePyramidSlice$$.items, $DvtChartPieLabelInfo$$ = "withRescale" == $DvtChartEventUtils$$.$getHideAndShowBehavior$($dvt$$2$$) && "hidden" == $DvtChartDataChangePyramidSlice$$.visibility, !$DvtChartPieLabelInfo$$) {
          if ($DvtChartPieRenderUtils$$ && !$DvtChartPieLabelInfo$$) {
            for ($DvtChartDataChangePyramidSlice$$ = 0;$DvtChartDataChangePyramidSlice$$ < $DvtChartPieRenderUtils$$.length;$DvtChartDataChangePyramidSlice$$++) {
              null == $DvtChartPieRenderUtils$$[$DvtChartDataChangePyramidSlice$$] || $DvtChartPieLabelUtils$$ && !$DvtChartDataUtils$$.$isRefObjInViewport$($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$) || ($DvtChartFunnelSlice$$ = $DvtChartRefObjUtils$$.$getLowValue$($DvtChartPieRenderUtils$$[$DvtChartDataChangePyramidSlice$$]), $DvtChartDataChangeFunnelSlice$$ = $DvtChartRefObjUtils$$.$getHighValue$($DvtChartPieRenderUtils$$[$DvtChartDataChangePyramidSlice$$]), $DvtChartPieLabelInfo$$ = 
              isNaN($DvtChartPieRenderUtils$$[$DvtChartDataChangePyramidSlice$$]) ? $DvtChartPieRenderUtils$$[$DvtChartDataChangePyramidSlice$$].value : $DvtChartPieRenderUtils$$[$DvtChartDataChangePyramidSlice$$], null != $DvtChartFunnelSlice$$ && isFinite($DvtChartFunnelSlice$$) && ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartFunnelSlice$$), $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartFunnelSlice$$)), null != $DvtChartDataChangeFunnelSlice$$ && isFinite($DvtChartDataChangeFunnelSlice$$) && 
              ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartDataChangeFunnelSlice$$), $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartDataChangeFunnelSlice$$)), null != $DvtChartPieLabelInfo$$ && isFinite($DvtChartPieLabelInfo$$) && ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartPieLabelInfo$$), $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartPieLabelInfo$$)));
            }
          } else {
            $DvtChartFunnelSlice$$ = $DvtChartRefObjUtils$$.$getLowValue$($DvtChartDataChangePyramidSlice$$), $DvtChartDataChangeFunnelSlice$$ = $DvtChartRefObjUtils$$.$getHighValue$($DvtChartDataChangePyramidSlice$$), $DvtChartPieLabelInfo$$ = $DvtChartDataChangePyramidSlice$$.value, null != $DvtChartFunnelSlice$$ && isFinite($DvtChartFunnelSlice$$) && ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartFunnelSlice$$), $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartFunnelSlice$$)), 
            null != $DvtChartDataChangeFunnelSlice$$ && isFinite($DvtChartDataChangeFunnelSlice$$) && ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartDataChangeFunnelSlice$$), $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartDataChangeFunnelSlice$$)), null != $DvtChartPieLabelInfo$$ && isFinite($DvtChartPieLabelInfo$$) && ($DvtChartPolarBar$$ = Math.min($DvtChartPolarBar$$, $DvtChartPieLabelInfo$$), $DvtChartRangeMarker$$ = Math.max($DvtChartRangeMarker$$, $DvtChartPieLabelInfo$$))
            ;
          }
        }
      }
  ...
  $DvtChartDataUtils$$.$getBarInfo$ = function $$DvtChartDataUtils$$$$getBarInfo$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    $DvtChartDataCursor$$ ? $DvtSparkChartEventManager$$.$y2Axis$ : $DvtSparkChartEventManager$$.$yAxis$, $DvtChartPieRenderUtils$$ = $DvtChartDataChangeMarker$$.$getBaselineCoord$(), $DvtChartDataChangeFunnelSlice$$;
    if ($DvtChartDataChangePyramidSlice$$) {
      var $DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$getLowValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$);
      $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.$getHighValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$);
      if (null == $DvtChartFunnelSlice$$ || isNaN($DvtChartFunnelSlice$$) || null == $DvtChartDataChangeFunnelSlice$$ || isNaN($DvtChartDataChangeFunnelSlice$$)) {
        return null;
      }
      $DvtChartRangeMarker$$ = $DvtChartDataChangeMarker$$.$getBoundedCoordAt$($DvtChartFunnelSlice$$);
      $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataChangeMarker$$.$getBoundedCoordAt$($DvtChartDataChangeFunnelSlice$$);
    } else {
      $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$);
      $DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$getCumulativeValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$);
      if (null == $DvtChartDataChangeFunnelSlice$$ || isNaN($DvtChartDataChangeFunnelSlice$$)) {
        return null;
      }
      $DvtChartRangeMarker$$ = $DvtChartDataChangeMarker$$.$getBoundedCoordAt$($DvtChartFunnelSlice$$);
      $DvtChartDataChangeFunnelSlice$$ = $DvtChartPieLabelUtils$$ ? $DvtChartDataChangeMarker$$.$getBoundedCoordAt$($DvtChartFunnelSlice$$ - $DvtChartDataChangeFunnelSlice$$) : $DvtChartPieRenderUtils$$;
    }
    if ($DvtChartRangeMarker$$ == $DvtChartDataChangeFunnelSlice$$ && null == $DvtChartDataChangeMarker$$.$getCoordAt$($DvtChartFunnelSlice$$)) {
      return null;
    }
    $DvtChartDataChangeMarker$$ = $DvtChartDataUtils$$.$getStackCategory$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
    ...
    $DvtSparkChartAutomation$$ = $DvtChartPieLabelUtils$$ ? $DvtChartStyleUtils$$.$getBarStackWidth$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$, $DvtSparkChartAutomation$$, $DvtChartDataCursor$$) : $DvtSparkChartDefaults$$;
    ...
    $DvtChartSeriesEffectUtils$$ = $DvtChartSeriesEffectUtils$$[$DvtChartDataCursor$$ ? "y2" : "y"][$DvtChartDataChangeMarker$$] + .5 * ($DvtSparkChartAutomation$$ - $DvtSparkChartDefaults$$);
    ...
    $DvtSparkChartEventManager$$ = $DvtChartPlotAreaRenderer$$.$convertAxisCoord$($DvtSparkChartEventManager$$, new $dvt$$2$$.$Point$(($DvtChartAxisUtils$$ + $DvtChartPieLabelInfo$$) / 2, $DvtChartDataChangePyramidSlice$$ ? ($DvtChartRangeMarker$$ + $DvtChartDataChangeFunnelSlice$$) / 2 : $DvtChartRangeMarker$$), $DvtChartRefObjUtils$$);
    return {$x1$:$DvtChartAxisUtils$$, $x2$:$DvtChartPieLabelInfo$$, $axisCoord$:$DvtChartPieRenderUtils$$, $baseCoord$:$DvtChartDataChangeFunnelSlice$$, $yCoord$:$DvtChartRangeMarker$$, $dataPos$:$DvtSparkChartEventManager$$, $barWidth$:$DvtSparkChartDefaults$$};
  };
  ...
  $DvtChartDataUtils$$.$getDataContext$ = function $$DvtChartDataUtils$$$$getDataContext$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    var $DvtChartAxisUtils$$ = $DvtChartDataUtils$$.$getDataItem$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), $DvtChartPieLabelUtils$$ = $DvtChartDataUtils$$.$getNestedDataItem$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$), $DvtChartPieLabelInfo$$ = $DvtSparkChartEventManager$$.$_rawOptions$, $DvtChartPieRenderUtils$$ = $DvtChartTypeUtils$$.$isPie$($DvtSparkChartEventManager$$) && (null == $DvtSparkChartDefaults$$ || 
    0 > $DvtSparkChartDefaults$$), $DvtChartDataChangePyramidSlice$$ = $DvtSparkChartEventManager$$.$getOptions$(), $DvtChartSeriesEffectUtils$$;
    $DvtChartPieRenderUtils$$ ? ($DvtSparkChartDefaults$$ = $dvt$$2$$.$Bundle$.$getTranslatedString$($dvt$$2$$.$Bundle$.$CHART_PREFIX$, "LABEL_OTHER", null), $DvtChartSeriesEffectUtils$$ = {id:$DvtSparkChartDefaults$$, series:$DvtSparkChartDefaults$$, value:$DvtChartPieUtils$$.$getOtherValue$($DvtSparkChartEventManager$$), color:$DvtChartDataChangePyramidSlice$$.styleDefaults.otherColor}) : $DvtChartPieLabelUtils$$ ? ($DvtChartAxisUtils$$ = $DvtChartPieLabelInfo$$.series[$DvtSparkChartDefaults$$].items[$DvtSparkChartAutomation$$], 
    $DvtChartSeriesEffectUtils$$ = {id:$DvtChartDataUtils$$.$getNestedDataItemId$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$), series:$DvtChartDataUtils$$.$getSeries$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$), data:[$DvtChartAxisUtils$$, $DvtChartAxisUtils$$.items[$DvtChartRefObjUtils$$]], seriesData:$DvtChartPieLabelInfo$$.series[$DvtSparkChartDefaults$$], value:$DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, 
    $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$), y:$DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$), color:$DvtChartStyleUtils$$.$getMarkerColor$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$)}) : $DvtChartAxisUtils$$ && ($DvtChartSeriesEffectUtils$$ = {id:$DvtChartDataUtils$$.$getDataItemId$($DvtSparkChartEventManager$$, 
    $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), series:$DvtChartDataUtils$$.$getSeries$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$), data:$DvtChartPieLabelInfo$$.series[$DvtSparkChartDefaults$$].items[$DvtSparkChartAutomation$$], seriesData:$DvtChartPieLabelInfo$$.series[$DvtSparkChartDefaults$$], value:$DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), targetValue:$DvtChartDataUtils$$.$getTargetValue$($DvtSparkChartEventManager$$, 
    $DvtSparkChartDefaults$$), x:$DvtChartDataUtils$$.$getXValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), y:$DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), z:$DvtChartDataUtils$$.$getZValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), low:$DvtChartDataUtils$$.$getLowValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), 
    high:$DvtChartDataUtils$$.$getHighValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), open:$DvtChartAxisUtils$$.open, close:$DvtChartAxisUtils$$.close, volume:$DvtChartAxisUtils$$.volume, color:$DvtChartStyleUtils$$.$getColor$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$)});
    $DvtChartSeriesEffectUtils$$ && ($DvtChartSeriesEffectUtils$$.component = $DvtChartDataChangePyramidSlice$$._widgetConstructor, $DvtChartSeriesEffectUtils$$.group = $DvtChartDataUtils$$.$getGroup$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$), $DvtChartSeriesEffectUtils$$.groupData = $DvtChartDataUtils$$.$_getGroupsDataArray$($DvtSparkChartEventManager$$)[$DvtSparkChartAutomation$$], $DvtChartSeriesEffectUtils$$.totalValue = $DvtChartTypeUtils$$.$isPie$($DvtSparkChartEventManager$$) && 
    $DvtSparkChartEventManager$$.$pieChart$ ? $DvtSparkChartEventManager$$.$pieChart$.$getTotalValue$() : null);
    ...
    if ($DvtSparkChartDefaults$$) {
      for (var $DvtSparkChartAutomation$$ = $dvt$$2$$.$getChartObjPeers$(), $DvtChartRefObjUtils$$ = [], $DvtChartAxisUtils$$ = 0;$DvtChartAxisUtils$$ < $DvtSparkChartEventManager$$.length;$DvtChartAxisUtils$$++) {
        for (var $DvtChartPieLabelUtils$$ = 0;$DvtChartPieLabelUtils$$ < $DvtSparkChartAutomation$$.length;$DvtChartPieLabelUtils$$++) {
          ...
          $DvtSparkChartEventManager$$[$DvtChartAxisUtils$$].group);
  ...
  $DvtChartSeriesEffectUtils$$.$getRectangleFill$ = function $$DvtChartSeriesEffectUtils$$$$getRectangleFill$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    -.04, -.05)], $DvtSparkChartDefaults$$ = [0, 1]) : ($DvtSparkChartEventManager$$ = [$dvt$$2$$.$ColorUtils$.$getPastel$($DvtSparkChartDefaults$$, .15), $dvt$$2$$.$ColorUtils$.$getPastel$($DvtSparkChartDefaults$$, .45), $dvt$$2$$.$ColorUtils$.$getPastel$($DvtSparkChartDefaults$$, .25), $DvtSparkChartDefaults$$, $dvt$$2$$.$ColorUtils$.$getPastel$($DvtSparkChartDefaults$$, .15), $dvt$$2$$.$ColorUtils$.$getDarker$($DvtSparkChartDefaults$$, .9)], $DvtSparkChartDefaults$$ = [0, .15, .3, .65, .85, 1]), 
    new $dvt$$2$$.$LinearGradientFill$($DvtSparkChartAutomation$$, $DvtSparkChartEventManager$$, null, $DvtSparkChartDefaults$$)) : new $dvt$$2$$.$SolidFill$($DvtSparkChartDefaults$$);
  };
  $DvtChartSeriesEffectUtils$$.$getAreaFill$ = function $$DvtChartSeriesEffectUtils$$$$getAreaFill$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    [$dvt$$2$$.$ColorUtils$.$getDarker$($DvtChartRefObjUtils$$, .5), $DvtChartRefObjUtils$$, $dvt$$2$$.$ColorUtils$.$getPastel$($DvtChartRefObjUtils$$, .5)] : [$dvt$$2$$.$ColorUtils$.$getPastel$($DvtChartRefObjUtils$$, .5), $DvtChartRefObjUtils$$, $dvt$$2$$.$ColorUtils$.$getDarker$($DvtChartRefObjUtils$$, .7)], $DvtChartRefObjUtils$$ = [0, .5, 1]), new $dvt$$2$$.$LinearGradientFill$($DvtChartAxisUtils$$, $DvtSparkChartAutomation$$, null, $DvtChartRefObjUtils$$)) : new $dvt$$2$$.$SolidFill$($DvtChartRefObjUtils$$);
  };
  $DvtChartSeriesEffectUtils$$.$getMarkerFill$ = function $$DvtChartSeriesEffectUtils$$$$getMarkerFill$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    if ($DvtChartTypeUtils$$.$isBubble$($DvtSparkChartEventManager$$) && "gradient" == $DvtChartStyleUtils$$.$getSeriesEffect$($DvtSparkChartEventManager$$)) {
      ...
      if ("human" == $DvtChartStyleUtils$$.$getMarkerShape$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$)) {
        return $DvtSparkChartEventManager$$ = [$dvt$$2$$.$ColorUtils$.$getPastel$($DvtChartAxisUtils$$, .2), $dvt$$2$$.$ColorUtils$.$getPastel$($DvtChartAxisUtils$$, .1), $DvtChartAxisUtils$$, $dvt$$2$$.$ColorUtils$.$getDarker$($DvtChartAxisUtils$$, .8)], new $dvt$$2$$.$LinearGradientFill$(315, $DvtSparkChartEventManager$$, null, [0, .3, .7, 1]);
      }
      $DvtSparkChartEventManager$$ = [$dvt$$2$$.$ColorUtils$.$getPastel$($DvtChartAxisUtils$$, .15), $DvtChartAxisUtils$$, $dvt$$2$$.$ColorUtils$.$getDarker$($DvtChartAxisUtils$$, .9), $dvt$$2$$.$ColorUtils$.$getDarker$($DvtChartAxisUtils$$, .8)];
      return new $dvt$$2$$.$RadialGradientFill$($DvtSparkChartEventManager$$, null, [0, .5, .75, 1]);
    }
    return new $dvt$$2$$.$SolidFill$($DvtChartAxisUtils$$);
  };
  $DvtChartSeriesEffectUtils$$.$getFunnelSliceFill$ = function $$DvtChartSeriesEffectUtils$$$$getFunnelSliceFill$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) {
    ...
    return $DvtSparkChartDefaults$$ && !$DvtChartAxisUtils$$ ? ($DvtChartRefObjUtils$$ = new $dvt$$2$$.$PatternFill$($DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), "vertical" == $DvtSparkChartEventManager$$.$getOptions$().orientation && ($dvt$$2$$.$Agent$.$isRightToLeft$($DvtSparkChartEventManager$$.$getCtx$()) ? $DvtChartRefObjUtils$$.$setMatrix$(new $dvt$$2$$.$Matrix$(0, -1, 1, 0)) : $DvtChartRefObjUtils$$.$setMatrix$(new $dvt$$2$$.$Matrix$(0, 1, -1, 0))), $DvtChartRefObjUtils$$) : "gradient" == 
    $DvtChartPieLabelUtils$$ ? ("on" == $DvtSparkChartEventManager$$.$getOptions$().styleDefaults.threeDEffect ? ($DvtSparkChartEventManager$$ = [$dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, 0, -.1), $dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, 0, .12), $DvtSparkChartAutomation$$], $DvtSparkChartAutomation$$ = [0, .65, 1]) : ($DvtSparkChartEventManager$$ = [$dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, -.09, .04), $dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, 
    -.04, -.05)], $DvtSparkChartAutomation$$ = [0, 1]), new $dvt$$2$$.$LinearGradientFill$(90, $DvtSparkChartEventManager$$, null, $DvtSparkChartAutomation$$, [$DvtChartRefObjUtils$$.x, $DvtChartRefObjUtils$$.y, $DvtChartRefObjUtils$$.$w$, $DvtChartRefObjUtils$$.$h$])) : new $dvt$$2$$.$SolidFill$($DvtSparkChartAutomation$$);
  };
  $DvtChartSeriesEffectUtils$$.$getPyramidSliceFill$ = function $$DvtChartSeriesEffectUtils$$$$getPyramidSliceFill$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    $DvtSparkChartDefaults$$ = $DvtChartStyleUtils$$.$getPattern$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, 0);
    var $DvtChartAxisUtils$$ = $DvtChartStyleUtils$$.$getSeriesEffect$($DvtSparkChartEventManager$$);
    return $DvtSparkChartDefaults$$ ? ($DvtChartRefObjUtils$$ = new $dvt$$2$$.$PatternFill$($DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), $dvt$$2$$.$Agent$.$isRightToLeft$($DvtSparkChartEventManager$$.$getCtx$()) ? $DvtChartRefObjUtils$$.$setMatrix$(new $dvt$$2$$.$Matrix$(0, -1, 1, 0)) : $DvtChartRefObjUtils$$.$setMatrix$(new $dvt$$2$$.$Matrix$(0, 1, -1, 0)), $DvtChartRefObjUtils$$) : "gradient" == $DvtChartAxisUtils$$ ? ("on" == $DvtSparkChartEventManager$$.$getOptions$().styleDefaults.threeDEffect ? 
    ($DvtSparkChartEventManager$$ = [$dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, 0, -.1), $dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, 0, .12), $DvtSparkChartAutomation$$], $DvtSparkChartAutomation$$ = [0, .65, 1]) : ($DvtSparkChartEventManager$$ = [$dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, -.09, .04), $dvt$$2$$.$ColorUtils$.$adjustHSL$($DvtSparkChartAutomation$$, -.04, -.05)], $DvtSparkChartAutomation$$ = [0, 1]), new $dvt$$2$$.$LinearGradientFill$(90, 
    $DvtSparkChartEventManager$$, null, $DvtSparkChartAutomation$$, [$DvtChartRefObjUtils$$.x, $DvtChartRefObjUtils$$.y, $DvtChartRefObjUtils$$.$w$, $DvtChartRefObjUtils$$.$h$])) : new $dvt$$2$$.$SolidFill$($DvtSparkChartAutomation$$);
  };
  ...
  $DvtChartStyleUtils$$.$getColor$ = function $$DvtChartStyleUtils$$$$getColor$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    var $DvtSparkChartAutomation$$ = $DvtChartStyleUtils$$.$getSeriesType$($dvt$$2$$, $DvtSparkChartEventManager$$);
    if ("boxPlot" == $DvtSparkChartAutomation$$) {
      return $DvtChartStyleUtils$$.$getBoxPlotStyleOptions$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$).q3Color;
    }
    var $DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getDataItem$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
    if ($DvtChartRefObjUtils$$ && $DvtChartRefObjUtils$$.color || ($DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getSeriesItem$($dvt$$2$$, $DvtSparkChartEventManager$$)) && $DvtChartRefObjUtils$$.color) {
      return $DvtChartRefObjUtils$$.color;
    }
    if ("candlestick" == $DvtSparkChartAutomation$$) {
  ...
  $DvtChartStyleUtils$$.$getMarkerColor$ = function $$DvtChartStyleUtils$$$$getMarkerColor$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    if (!$DvtChartStyleUtils$$.$isMarkerDisplayed$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$)) {
      return $DvtChartStyleUtils$$.$getColor$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
    }
    if (($DvtSparkChartAutomation$$ = $DvtChartDataUtils$$.$getNestedDataItem$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$)) && $DvtSparkChartAutomation$$.color || ($DvtSparkChartAutomation$$ = $DvtChartDataUtils$$.$getDataItem$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$)) && $DvtSparkChartAutomation$$.color) {
      return $DvtSparkChartAutomation$$.color;
    }
    if (($DvtSparkChartAutomation$$ = $DvtChartDataUtils$$.$getSeriesItem$($dvt$$2$$, $DvtSparkChartEventManager$$)) && $DvtSparkChartAutomation$$.markerColor) {
      return $DvtSparkChartAutomation$$.markerColor;
    }
    $DvtSparkChartAutomation$$ = $dvt$$2$$.$getOptions$();
    var $DvtChartRefObjUtils$$ = $DvtSparkChartAutomation$$.styleDefaults.markerColor;
    return $DvtChartRefObjUtils$$ ? $DvtChartRefObjUtils$$ : "boxPlot" == $DvtChartStyleUtils$$.$getSeriesType$($dvt$$2$$, $DvtSparkChartEventManager$$) ? $DvtSparkChartAutomation$$.styleDefaults.boxPlot._markerColor : $DvtChartStyleUtils$$.$getColor$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
  };
    ...
    if ($DvtSparkChartDefaults$$) {
      ...
      for ($DvtChartPolarBar$$ = 0;$DvtChartPolarBar$$ < $DvtChartDataUtils$$.$getSeriesCount$($dvt$$2$$);$DvtChartPolarBar$$++) {
        if ($DvtChartRangeMarker$$ = $DvtChartStyleUtils$$.$getSeriesType$($dvt$$2$$, $DvtChartPolarBar$$), ("bar" == $DvtChartRangeMarker$$ || "candlestick" == $DvtChartRangeMarker$$ || "boxPlot" == $DvtChartRangeMarker$$) && $DvtChartStyleUtils$$.$isSeriesRendered$($dvt$$2$$, $DvtChartPolarBar$$)) {
          var $DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$isAssignedToY2$($dvt$$2$$, $DvtChartPolarBar$$), $DvtChartDataChangeMarker$$ = $DvtChartDataUtils$$.$getStackCategory$($dvt$$2$$, $DvtChartPolarBar$$);
          $DvtChartRangeMarker$$ = $DvtChartStyleUtils$$.$getBarWidth$($dvt$$2$$, $DvtChartPolarBar$$, $DvtSparkChartEventManager$$);
          $DvtChartRefObjUtils$$ ? $DvtSparkChartAutomation$$ ? $DvtChartPieRenderUtils$$[$DvtChartDataChangeMarker$$] = -.5 * $DvtChartRangeMarker$$ : ($DvtChartPieRenderUtils$$[$DvtChartDataChangeMarker$$] = $DvtChartSeriesEffectUtils$$, $DvtChartSeriesEffectUtils$$ += $DvtChartRangeMarker$$) : $DvtSparkChartAutomation$$ ? $DvtChartPieLabelInfo$$[$DvtChartDataChangeMarker$$] = -.5 * $DvtChartRangeMarker$$ : ($DvtChartPieLabelInfo$$[$DvtChartDataChangeMarker$$] = $DvtChartDataChangePyramidSlice$$, 
          $DvtChartDataChangePyramidSlice$$ += $DvtChartRangeMarker$$);
        }
      }
    }
    for ($DvtChartDataChangeMarker$$ in $DvtChartPieLabelInfo$$) {
      $DvtChartPieLabelInfo$$[$DvtChartDataChangeMarker$$] -= $DvtChartPieLabelUtils$$ || $DvtSparkChartDefaults$$ ? $DvtChartDataChangePyramidSlice$$ / 2 : ($DvtChartDataChangePyramidSlice$$ + $DvtChartSeriesEffectUtils$$) / 2;
    }
    for ($DvtChartDataChangeMarker$$ in $DvtChartPieRenderUtils$$) {
      $DvtChartPieRenderUtils$$[$DvtChartDataChangeMarker$$] -= $DvtChartPieLabelUtils$$ || $DvtSparkChartDefaults$$ ? $DvtChartSeriesEffectUtils$$ / 2 : ($DvtChartDataChangePyramidSlice$$ + $DvtChartSeriesEffectUtils$$) / 2 - $DvtChartDataChangePyramidSlice$$;
    }
  ...
  $DvtChartStyleUtils$$.$getBoxPlotStyleOptions$ = function $$DvtChartStyleUtils$$$$getBoxPlotStyleOptions$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    var $DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getDataItem$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$), $DvtChartAxisUtils$$ = $DvtChartRefObjUtils$$ && $DvtChartRefObjUtils$$.boxPlot ? $DvtChartRefObjUtils$$.boxPlot : {}, $DvtChartPieLabelUtils$$ = ($DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getSeriesItem$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$)) && $DvtChartRefObjUtils$$.boxPlot ? $DvtChartRefObjUtils$$.boxPlot : {}, $DvtChartRefObjUtils$$ = 
    $DvtSparkChartEventManager$$.$getOptions$().styleDefaults, $DvtChartAxisUtils$$ = $dvt$$2$$.$JsonUtils$.$merge$($DvtChartAxisUtils$$, $dvt$$2$$.$JsonUtils$.$merge$($DvtChartPieLabelUtils$$, $DvtChartRefObjUtils$$.boxPlot));
    $DvtChartAxisUtils$$.borderColor = $DvtChartStyleUtils$$.$getBorderColor$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$);
    $DvtChartAxisUtils$$.borderWidth = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$);
    $DvtSparkChartAutomation$$ = $DvtChartRefObjUtils$$.colors;
    $DvtSparkChartDefaults$$ = $DvtChartDataUtils$$.$getSeriesStyleIndex$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
    $DvtChartAxisUtils$$.q2Color || ($DvtChartAxisUtils$$.q2Color = $DvtSparkChartAutomation$$[$DvtSparkChartDefaults$$ % $DvtSparkChartAutomation$$.length]);
    $DvtChartAxisUtils$$.q3Color || ($DvtChartAxisUtils$$.q3Color = $DvtSparkChartAutomation$$[($DvtSparkChartDefaults$$ + 1) % $DvtSparkChartAutomation$$.length]);
    "pattern" == $DvtChartStyleUtils$$.$getSeriesEffect$($DvtSparkChartEventManager$$) && ($DvtSparkChartEventManager$$ = $DvtChartRefObjUtils$$.patterns, $DvtChartAxisUtils$$._q2Pattern = $DvtSparkChartEventManager$$[$DvtSparkChartDefaults$$ % $DvtSparkChartEventManager$$.length], $DvtChartAxisUtils$$._q3Pattern = $DvtSparkChartEventManager$$[($DvtSparkChartDefaults$$ + 1) % $DvtSparkChartEventManager$$.length], $DvtChartAxisUtils$$.borderColor || ($DvtChartAxisUtils$$.borderColor = $DvtChartAxisUtils$$.q3Color));
    return $DvtChartAxisUtils$$;
  };
  ...
  $DvtChartTooltipUtils$$.$_addValueDatatip$ = function $$DvtChartTooltipUtils$$$$_addValueDatatip$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) {
    ...
    $DvtSparkChartEventManager$$, "z", "Z", $DvtChartPieRenderUtils$$, $DvtChartAxisUtils$$))) : $DvtChartTypeUtils$$.$isPie$($DvtSparkChartEventManager$$) ? $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "value", "VALUE", $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$) : $DvtChartTypeUtils$$.$isFunnel$($DvtSparkChartEventManager$$) ? ($dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "value", "VALUE", $DvtChartPieLabelUtils$$, 
    $DvtChartAxisUtils$$), $DvtChartPieRenderUtils$$ = $DvtChartDataUtils$$.$getTargetValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$), null != $DvtChartPieRenderUtils$$ && ($dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "targetValue", "TARGET_VALUE", $DvtChartPieRenderUtils$$, $DvtChartAxisUtils$$))) : "boxPlot" != $DvtChartStyleUtils$$.$getSeriesType$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) || $DvtChartRefObjUtils$$ ? 
    $DvtChartTypeUtils$$.$isBLAC$($DvtSparkChartEventManager$$) && ($DvtSparkChartDefaults$$ = $DvtChartDataUtils$$.$isAssignedToY2$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) ? "y2" : "y", null == $DvtChartDataChangePyramidSlice$$ && null == $DvtChartSeriesEffectUtils$$ || $DvtChartRefObjUtils$$ ? null == $DvtChartPieRenderUtils$$ || $DvtChartRefObjUtils$$ ? $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, "VALUE", 
    $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$) : ($dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, "Y", $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$), $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "z", "Z", $DvtChartPieRenderUtils$$, $DvtChartAxisUtils$$)) : ($dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "high", "HIGH", $DvtChartSeriesEffectUtils$$, 
    $DvtChartAxisUtils$$), $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "low", "LOW", $DvtChartDataChangePyramidSlice$$, $DvtChartAxisUtils$$), null != $DvtChartPieRenderUtils$$ && ($dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "z", "Z", $DvtChartPieRenderUtils$$, $DvtChartAxisUtils$$)))) : ($DvtChartPieLabelUtils$$ = $DvtChartDataUtils$$.$getDataItem$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, 
    $DvtSparkChartAutomation$$), $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "high", "HIGH", $DvtChartSeriesEffectUtils$$, $DvtChartAxisUtils$$), $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "q3", "Q3", $DvtChartPieLabelUtils$$.q3, $DvtChartAxisUtils$$), $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "q2", "Q2", $DvtChartPieLabelUtils$$.q2, $DvtChartAxisUtils$$), 
    $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "q1", "Q1", $DvtChartPieLabelUtils$$.q1, $DvtChartAxisUtils$$), $dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "low", "LOW", $DvtChartDataChangePyramidSlice$$, $DvtChartAxisUtils$$), null != $DvtChartPieRenderUtils$$ && ($dvt$$2$$ = $DvtChartTooltipUtils$$.$_addDatatipRow$($dvt$$2$$, $DvtSparkChartEventManager$$, "z", "Z", $DvtChartPieRenderUtils$$, $DvtChartAxisUtils$$)));
    return $dvt$$2$$;
  };
  ...
  $DvtChartMarkerUtils$$.$calcBubbleSizes$ = function $$DvtChartMarkerUtils$$$$calcBubbleSizes$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    $DvtChartDataChangePyramidSlice$$ = "withoutRescale" == $DvtChartEventUtils$$.$getHideAndShowBehavior$($DvtSparkChartEventManager$$), $DvtChartSeriesEffectUtils$$ = 0;$DvtChartSeriesEffectUtils$$ < $DvtChartPieRenderUtils$$;$DvtChartSeriesEffectUtils$$++) {
      if ($DvtChartDataChangePyramidSlice$$ || $DvtChartStyleUtils$$.$isSeriesRendered$($DvtSparkChartEventManager$$, $DvtChartSeriesEffectUtils$$)) {
        for (var $DvtChartRangeMarker$$ = $DvtChartDataUtils$$.$getSeriesItem$($DvtSparkChartEventManager$$, $DvtChartSeriesEffectUtils$$), $DvtChartPolarBar$$ = $DvtChartRangeMarker$$.items ? $DvtChartRangeMarker$$.items.length : 0, $DvtChartDataChangeMarker$$ = 0;$DvtChartDataChangeMarker$$ < $DvtChartPolarBar$$;$DvtChartDataChangeMarker$$++) {
          var $DvtChartDataCursor$$ = $DvtChartRangeMarker$$.items[$DvtChartDataChangeMarker$$];
  ...
  $DvtChartPieRenderUtils$$.$getGradientColors$ = function $$DvtChartPieRenderUtils$$$$getGradientColors$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    if ($DvtSparkChartAutomation$$ && $DvtSparkChartAutomation$$ != $dvt$$2$$.$CSSStyle$.$SKIN_SKYROS$) {
      ...
      var $DvtChartRefObjUtils$$ = $dvt$$2$$.$ColorUtils$.$getRGB$($dvt$$2$$.$ColorUtils$.$getPastel$($DvtSparkChartEventManager$$, .05)), $DvtChartAxisUtils$$ = $dvt$$2$$.$ColorUtils$.$getRGB$($dvt$$2$$.$ColorUtils$.$getPastel$($DvtSparkChartEventManager$$, .15));
  ...
  $DvtChartPieRenderUtils$$.$createTopSurface$ = function $$DvtChartPieRenderUtils$$$$createTopSurface$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    $DvtChartPieLabelUtils$$ = $DvtChartStyleUtils$$.$getSelectedOuterColor$($DvtSparkChartAutomation$$.$chart$), $DvtChartPieLabelInfo$$ = new $dvt$$2$$.$SolidStroke$($DvtSparkChartEventManager$$.$getStrokeColor$(), null, $DvtSparkChartEventManager$$.$getBorderWidth$()), $DvtChartDataChangePyramidSlice$$ = $DvtSparkChartEventManager$$.$getSeriesIndex$();
    $DvtChartRefObjUtils$$.$setStyleProperties$($DvtSparkChartDefaults$$, $DvtChartPieLabelInfo$$, $DvtSparkChartEventManager$$.$getFillColor$(), $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$);
    $DvtChartRefObjUtils$$.$setStyle$($DvtChartStyleUtils$$.$getStyle$($DvtSparkChartAutomation$$.$chart$, $DvtChartDataChangePyramidSlice$$, 0));
    $DvtChartRefObjUtils$$.$setClassName$($DvtChartStyleUtils$$.$getClassName$($DvtSparkChartAutomation$$.$chart$, $DvtChartDataChangePyramidSlice$$, 0));
  ...
  $DvtChartPieLabelUtils$$.$_layoutInsideLabels$ = function $$DvtChartPieLabelUtils$$$$_layoutInsideLabels$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    for (var $DvtSparkChartAutomation$$ = $DvtSparkChartEventManager$$.$_slices$, $DvtChartRefObjUtils$$ = 0;$DvtChartRefObjUtils$$ < $DvtSparkChartAutomation$$.length;$DvtChartRefObjUtils$$++) {
      ...
      if ("none" != $DvtChartPieLabelInfo$$ && "outsideSlice" != $DvtChartPieLabelInfo$$ && !$DvtChartPieLabelUtils$$.$_skipSliceLabel$($DvtSparkChartEventManager$$, $DvtChartAxisUtils$$)) {
        var $DvtChartDataChangePyramidSlice$$ = $DvtChartAxisUtils$$.$getAngleStart$() + $DvtChartAxisUtils$$.$getAngleExtent$() / 2, $DvtChartSeriesEffectUtils$$ = $DvtChartAxisUtils$$.$getInnerRadius$(), $DvtChartRangeMarker$$ = $DvtChartAxisUtils$$.$getCenter$(), $DvtChartStyleUtils$$ = 0, $DvtChartPolarBar$$ = 0, $DvtChartDataChangeMarker$$ = $DvtChartPieLabelUtils$$.$_createLabel$($DvtChartAxisUtils$$, !0);
        ...
        $DvtChartDataChangeMarker$$.$setX$($DvtChartStyleUtils$$);
        $DvtChartDataChangeMarker$$.$setY$($DvtChartPolarBar$$);
        $DvtChartDataChangeMarker$$.$alignMiddle$();
        $DvtChartDataChangeMarker$$.$alignCenter$();
        for (var $DvtChartDataChangePyramidSlice$$ = $dvt$$2$$.$TextUtils$.$guessTextDimensions$($DvtChartDataChangeMarker$$), $DvtChartRangeMarker$$ = $DvtChartSeriesEffectUtils$$ = $DvtChartStyleUtils$$, $DvtChartDataCursor$$ = $DvtChartPolarBar$$ - $DvtChartDataChangePyramidSlice$$.$h$ / 2, $DvtChartPolarBar$$ = $DvtChartPolarBar$$ + $DvtChartDataChangePyramidSlice$$.$h$ / 2;$DvtChartAxisUtils$$.contains($DvtChartSeriesEffectUtils$$, $DvtChartDataCursor$$) && $DvtChartAxisUtils$$.contains($DvtChartSeriesEffectUtils$$, 
        $DvtChartPolarBar$$);) {
          $DvtChartSeriesEffectUtils$$--;
        }
        ...
        $DvtChartStyleUtils$$ < $DvtChartDataChangePyramidSlice$$.$w$ && ($DvtChartDataChangeMarker$$.$setX$(($DvtChartSeriesEffectUtils$$ + $DvtChartRangeMarker$$) / 2), $DvtChartStyleUtils$$ = $DvtChartRangeMarker$$ - $DvtChartSeriesEffectUtils$$);
        $DvtSparkChartDefaults$$ && "center" != $DvtChartPieLabelInfo$$ ? $DvtChartDataChangeMarker$$.$getDimensions$().$w$ < $DvtChartStyleUtils$$ ? $DvtChartAxisUtils$$.$setSliceLabel$($DvtChartDataChangeMarker$$) : $DvtChartAxisUtils$$.$setSliceLabel$(null) : ($DvtChartPieLabelInfo$$ = $DvtSparkChartEventManager$$.$getCtx$().$_stage$, $DvtChartPolarBar$$ = $DvtChartPieLabelUtils$$.$_isTextLabel$($DvtSparkChartEventManager$$, $DvtChartAxisUtils$$) ? null : $DvtChartDataChangeMarker$$.$getTextString$().length, 
        $dvt$$2$$.$TextUtils$.$fitText$($DvtChartDataChangeMarker$$, $DvtChartStyleUtils$$, $DvtChartDataChangePyramidSlice$$.$h$, $DvtChartPieLabelInfo$$, $DvtChartPolarBar$$) && ($DvtChartPieLabelInfo$$.removeChild($DvtChartDataChangeMarker$$), $DvtChartAxisUtils$$.$setSliceLabel$($DvtChartDataChangeMarker$$)));
  ...
  $DvtChartPieLabelUtils$$.$_generateInitialLayout$ = function $$DvtChartPieLabelUtils$$$$_generateInitialLayout$$($dvt$$2$$) {
    for (var $DvtSparkChartEventManager$$ = Array(2), $DvtSparkChartDefaults$$ = [], $DvtSparkChartAutomation$$ = [], $DvtChartRefObjUtils$$ = $dvt$$2$$.$_slices$, $DvtChartAxisUtils$$ = $dvt$$2$$.$_frame$, $DvtChartPieLabelInfo$$ = 0;$DvtChartPieLabelInfo$$ < $DvtChartRefObjUtils$$.length;$DvtChartPieLabelInfo$$++) {
      ...
      if (null == $DvtChartDataChangePyramidSlice$$.$_sliceLabel$ && "none" != $DvtChartSeriesEffectUtils$$ && "center" != $DvtChartSeriesEffectUtils$$ && !$DvtChartPieLabelUtils$$.$_skipSliceLabel$($dvt$$2$$, $DvtChartDataChangePyramidSlice$$)) {
        ...
        var $DvtChartDataChangeMarker$$ = $DvtChartPieLabelUtils$$.$_adjustForDepth$($DvtChartRangeMarker$$, $dvt$$2$$.getDepth());
        $DvtChartStyleUtils$$.y += $DvtChartDataChangeMarker$$;
        1 == $DvtChartRefObjUtils$$.length && ($DvtChartStyleUtils$$.x -= $DvtChartPolarBar$$.x / 2);
        $DvtChartStyleUtils$$.y < $DvtChartAxisUtils$$.y || $DvtChartStyleUtils$$.y + $DvtChartPolarBar$$.y > $DvtChartAxisUtils$$.y + $DvtChartAxisUtils$$.$h$ || (90 <= $DvtChartRangeMarker$$ && 270 > $DvtChartRangeMarker$$ ? ($DvtChartSeriesEffectUtils$$.$alignRight$(), $DvtChartDataChangeMarker$$ = $DvtChartRangeMarker$$ - 90, $DvtChartPieLabelUtils$$.$_createLabelInfo$($DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$, 
        $DvtChartStyleUtils$$, $DvtSparkChartDefaults$$)) : ($DvtChartDataChangeMarker$$ = 90 >= $DvtChartRangeMarker$$ ? Math.abs(90 - $DvtChartRangeMarker$$) : 180 - ($DvtChartRangeMarker$$ - 270), $DvtChartPieLabelUtils$$.$_createLabelInfo$($DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$, $DvtChartStyleUtils$$, $DvtSparkChartAutomation$$)));
      }
    }
  ...
  $DvtChartPieLabelUtils$$.$_createLabelInfo$ = function $$DvtChartPieLabelUtils$$$$_createLabelInfo$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$) {
    for (var $DvtChartPieRenderUtils$$ = -1, $DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$ = 0;$DvtChartSeriesEffectUtils$$ < $DvtChartPieLabelUtils$$.length;$DvtChartSeriesEffectUtils$$++) {
      if ($DvtChartDataChangePyramidSlice$$ = $DvtChartPieLabelUtils$$[$DvtChartSeriesEffectUtils$$], $DvtChartDataChangePyramidSlice$$.$getPosition$() > $DvtSparkChartAutomation$$) {
        $DvtChartPieRenderUtils$$ = $DvtChartSeriesEffectUtils$$;
        break;
      }
    }
    -1 == $DvtChartPieRenderUtils$$ && ($DvtChartPieRenderUtils$$ = $DvtChartPieLabelUtils$$.length);
    $DvtChartDataChangePyramidSlice$$ = new $DvtChartPieLabelInfo$$;
    $DvtChartDataChangePyramidSlice$$.setPosition($DvtSparkChartAutomation$$);
    $DvtChartDataChangePyramidSlice$$.$setAngle$($DvtSparkChartDefaults$$);
    $DvtChartDataChangePyramidSlice$$.$setSliceLabel$($DvtSparkChartEventManager$$);
    $DvtChartDataChangePyramidSlice$$.$setSlice$($dvt$$2$$);
    $DvtChartDataChangePyramidSlice$$.$setWidth$($DvtChartRefObjUtils$$.x);
    $DvtChartDataChangePyramidSlice$$.$setHeight$($DvtChartRefObjUtils$$.y);
    $DvtChartDataChangePyramidSlice$$.$setX$($DvtChartAxisUtils$$.x);
    $DvtChartDataChangePyramidSlice$$.$setY$($DvtChartAxisUtils$$.y);
    $DvtChartPieLabelUtils$$.splice($DvtChartPieRenderUtils$$, 0, $DvtChartDataChangePyramidSlice$$);
  };
  ...
  $DvtChartAxisRenderer$$.$_renderCartesian$ = function $$DvtChartAxisRenderer$$$$_renderCartesian$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    var $DvtChartDataChangeMarker$$ = $DvtChartAxisUtils$$.$getTickLabelGapSize$($DvtSparkChartEventManager$$, "y"), $DvtChartDataCursor$$ = $DvtChartAxisUtils$$.$getTickLabelGapSize$($DvtSparkChartEventManager$$, "y2");
    $DvtChartPieLabelInfo$$ && $DvtChartDataChangePyramidSlice$$ == $DvtChartSeriesEffectUtils$$ ? ($DvtChartPieLabelUtils$$ ? ($DvtChartDataChangePyramidSlice$$ = Math.max($DvtChartRangeMarker$$.$dim$.$h$ + $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$.$dim$.$h$ + $DvtChartDataCursor$$), $DvtChartRangeMarker$$.$dim$.$h$ = $DvtChartDataChangePyramidSlice$$ - $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$.$dim$.$h$ = $DvtChartDataChangePyramidSlice$$ - $DvtChartDataCursor$$) : ($DvtChartDataChangePyramidSlice$$ = 
    Math.max($DvtChartRangeMarker$$.$dim$.$w$ + $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$.$dim$.$w$ + $DvtChartDataCursor$$), $DvtChartRangeMarker$$.$dim$.$w$ = $DvtChartDataChangePyramidSlice$$ - $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$.$dim$.$w$ = $DvtChartDataChangePyramidSlice$$ - $DvtChartDataCursor$$), $DvtChartAxisRenderer$$.$_positionAxis$($DvtSparkChartAutomation$$.clone(), $DvtChartRangeMarker$$, $DvtChartDataChangeMarker$$)) : $DvtChartAxisRenderer$$.$_positionAxis$($DvtSparkChartAutomation$$, 
    $DvtChartRangeMarker$$, $DvtChartDataChangeMarker$$);
  ...
  $DvtChartAxisRenderer$$.$_createXAxis$ = function $$DvtChartAxisRenderer$$$$_createXAxis$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    var $DvtChartDataChangePyramidSlice$$ = "top" == $DvtChartPieLabelInfo$$ || "bottom" == $DvtChartPieLabelInfo$$, $DvtChartSeriesEffectUtils$$ = $DvtChartAxisUtils$$.$isGridShifted$($DvtSparkChartEventManager$$);
    "tangential" == $DvtChartPieLabelInfo$$ && $DvtChartAxisUtils$$.$hasGroupAxis$($DvtSparkChartEventManager$$) ? $DvtChartSeriesEffectUtils$$ ? ($DvtChartPieRenderUtils$$.startGroupOffset = .5, $DvtChartPieRenderUtils$$.endGroupOffset = .5) : $DvtChartPieRenderUtils$$.endGroupOffset = 1 : ($DvtChartPieLabelInfo$$ = $DvtChartAxisUtils$$.$getAxisOffset$($DvtSparkChartEventManager$$), $DvtChartPieRenderUtils$$.startGroupOffset = $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$.endGroupOffset = $DvtChartPieLabelInfo$$, 
    ...
    "y") && ($DvtChartPieRenderUtils$$[($DvtChartDataChangePyramidSlice$$ ? "start" : "end") + "GroupOffset"] += .04 * $DvtChartPieLabelInfo$$), $DvtChartAxisUtils$$.$isAxisRendered$($DvtSparkChartEventManager$$, "y2") && $DvtChartAxisUtils$$.$isTickLabelInside$($DvtSparkChartEventManager$$, "y2") && ($DvtChartPieRenderUtils$$[($DvtChartDataChangePyramidSlice$$ ? "end" : "start") + "GroupOffset"] += .04 * $DvtChartPieLabelInfo$$)));
    $DvtChartPieRenderUtils$$.leftBuffer = $DvtChartDataChangePyramidSlice$$ ? $DvtSparkChartAutomation$$.x - $DvtChartRefObjUtils$$.x : 0;
    $DvtChartPieRenderUtils$$.rightBuffer = $DvtChartDataChangePyramidSlice$$ ? $DvtChartRefObjUtils$$.$w$ + $DvtChartRefObjUtils$$.x - ($DvtSparkChartAutomation$$.$w$ + $DvtSparkChartAutomation$$.x) : 0;
    $DvtChartPieRenderUtils$$._renderGridAtLabels = !$DvtChartSeriesEffectUtils$$ || $DvtChartAxisUtils$$.$hasTimeAxis$($DvtSparkChartEventManager$$);
    $DvtChartDataChangePyramidSlice$$ = new $DvtChartAxis$$($DvtSparkChartEventManager$$.$getCtx$(), $DvtSparkChartEventManager$$.$processEvent$, $DvtSparkChartEventManager$$);
    $DvtSparkChartDefaults$$.$addChild$($DvtChartDataChangePyramidSlice$$);
    $DvtSparkChartEventManager$$ = $DvtChartAxisRenderer$$.$_getPreferredSize$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$.$xAxis$, $DvtChartPieRenderUtils$$, "x", $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$);
    ...
    return {axis:$DvtChartDataChangePyramidSlice$$, options:$DvtChartPieRenderUtils$$, $dim$:$DvtSparkChartEventManager$$};
  };
  $DvtChartAxisRenderer$$.$_createYAxis$ = function $$DvtChartAxisRenderer$$$$_createYAxis$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    $DvtSparkChartDefaults$$ = $DvtChartAxisRenderer$$.$_getPreferredSize$($DvtSparkChartEventManager$$, $DvtChartPieRenderUtils$$, $DvtSparkChartEventManager$$.$yAxis$, $DvtChartPieLabelInfo$$, "y", $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$);
  ...
  $DvtChartAxisRenderer$$.$_createY2Axis$ = function $$DvtChartAxisRenderer$$$$_createY2Axis$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    if ($DvtChartTypeUtils$$.$hasY2Data$($DvtSparkChartEventManager$$)) {
      ...
      var $DvtChartPieRenderUtils$$ = new $DvtChartAxis$$($DvtSparkChartEventManager$$.$getCtx$(), $DvtSparkChartEventManager$$.$processEvent$, $DvtSparkChartEventManager$$);
      $DvtSparkChartDefaults$$.$addChild$($DvtChartPieRenderUtils$$);
      $DvtSparkChartDefaults$$ = $DvtChartAxisRenderer$$.$_getPreferredSize$($DvtSparkChartEventManager$$, $DvtChartPieRenderUtils$$, $DvtSparkChartEventManager$$.$y2Axis$, $DvtChartPieLabelInfo$$, "y2", $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$);
  ...
  $DvtChartAxisRenderer$$.$_adjustYAxisForLabels$ = function $$DvtChartAxisRenderer$$$$_adjustYAxisForLabels$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    if ($DvtChartAxisUtils$$.$isYAdjustmentNeeded$($DvtSparkChartAutomation$$)) {
      var $DvtChartPieLabelInfo$$ = $DvtChartPieLabelUtils$$.styleDefaults.dataLabelStyle, $DvtChartPieRenderUtils$$ = $DvtChartPieLabelUtils$$.styleDefaults.stackLabelStyle, $DvtChartPieLabelUtils$$ = $DvtSparkChartEventManager$$.$getInfo$(), $DvtChartDataChangePyramidSlice$$ = $DvtChartStyleUtils$$.$isStackLabelRendered$($DvtSparkChartAutomation$$), $DvtChartPieLabelInfo$$ = $dvt$$2$$.$TextUtils$.$getTextStringHeight$($DvtSparkChartAutomation$$.$getCtx$(), $DvtChartDataChangePyramidSlice$$ ? $DvtChartPieRenderUtils$$ : 
      $DvtChartPieLabelInfo$$), $DvtChartPieRenderUtils$$ = 0;
      ...
      1 - $DvtChartStyleUtils$$.$getSplitterPosition$($DvtSparkChartAutomation$$)), $DvtChartPieRenderUtils$$ = Math.abs($DvtChartPieLabelUtils$$.$MaxValue$ - $DvtChartPieLabelUtils$$.$MinValue$) / (Math.abs($DvtChartPieLabelUtils$$.$getEndCoord$() - $DvtChartPieLabelUtils$$.$getStartCoord$()) * $DvtSparkChartEventManager$$) * $DvtChartPieLabelInfo$$);
      $DvtChartTypeUtils$$.$isHorizontal$($DvtSparkChartAutomation$$) && ($DvtChartPieRenderUtils$$ *= 4);
      $DvtChartPieLabelUtils$$.$DataMin$ - $DvtChartPieLabelUtils$$.$GlobalMin$ < $DvtChartPieRenderUtils$$ && 0 > $DvtChartPieLabelUtils$$.$DataMin$ && ($DvtSparkChartDefaults$$.dataMin -= $DvtChartPieRenderUtils$$);
      $DvtChartPieLabelUtils$$.$GlobalMax$ - $DvtChartPieLabelUtils$$.$DataMax$ < $DvtChartPieRenderUtils$$ && 0 < $DvtChartPieLabelUtils$$.$DataMax$ && ($DvtSparkChartDefaults$$.dataMax += $DvtChartPieRenderUtils$$);
    }
  };
  $DvtChartAxisRenderer$$.$_getPreferredSize$ = function $$DvtChartAxisRenderer$$$$_getPreferredSize$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$) {
    var $DvtChartDataChangePyramidSlice$$ = $DvtChartRefObjUtils$$.isStandalone, $DvtChartSeriesEffectUtils$$ = $DvtChartRefObjUtils$$.position, $DvtChartRangeMarker$$ = "top" == $DvtChartSeriesEffectUtils$$ || "bottom" == $DvtChartSeriesEffectUtils$$, $DvtChartPolarBar$$ = $DvtChartAxisUtils$$.$getTickLabelGapSize$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$), $DvtChartDataChangeMarker$$ = $DvtChartRefObjUtils$$.maxSize, $DvtChartDataCursor$$ = $DvtChartRefObjUtils$$.size;
    $DvtChartPieLabelUtils$$ = $DvtChartPieLabelInfo$$.$w$;
    var $DvtChartDataChangeFunnelSlice$$ = $DvtChartPieLabelInfo$$.$h$;
    if ("radial" == $DvtChartSeriesEffectUtils$$ || "tangential" == $DvtChartSeriesEffectUtils$$) {
      $DvtChartDataChangeFunnelSlice$$ = $DvtChartPieLabelUtils$$ = 0;
    } else {
      if ("off" == $DvtChartRefObjUtils$$.rendered) {
        $DvtChartRangeMarker$$ ? $DvtChartDataChangeFunnelSlice$$ = 0 : $DvtChartPieLabelUtils$$ = 0;
      } else {
        if ($DvtChartDataChangePyramidSlice$$) {
          $DvtChartRangeMarker$$ ? $DvtChartDataChangeFunnelSlice$$ = $DvtChartPieLabelInfo$$.$h$ - $DvtChartPolarBar$$ : $DvtChartPieLabelUtils$$ = $DvtChartPieLabelInfo$$.$w$ - $DvtChartPolarBar$$;
        } else {
          if (null != $DvtChartDataCursor$$) {
            $DvtChartRangeMarker$$ ? $DvtChartDataChangeFunnelSlice$$ = $DvtChartStyleUtils$$.$getSizeInPixels$($DvtChartDataCursor$$, $DvtChartPieRenderUtils$$.$h$) - $DvtChartPolarBar$$ : $DvtChartPieLabelUtils$$ = $DvtChartStyleUtils$$.$getSizeInPixels$($DvtChartDataCursor$$, $DvtChartPieRenderUtils$$.$w$) - $DvtChartPolarBar$$;
          } else {
            if ($DvtSparkChartEventManager$$.$getOptions$()._duringAnimation) {
              $DvtChartRangeMarker$$ ? ($DvtChartPieLabelInfo$$ = $dvt$$2$$.$Agent$.$isRightToLeft$($DvtSparkChartEventManager$$.$getCtx$()), $DvtChartRefObjUtils$$._startOverflow = $DvtChartPieLabelInfo$$ ? $DvtSparkChartAutomation$$.$getRightOverflow$() : $DvtSparkChartAutomation$$.$getLeftOverflow$(), $DvtChartRefObjUtils$$._endOverflow = $DvtChartPieLabelInfo$$ ? $DvtSparkChartAutomation$$.$getLeftOverflow$() : $DvtSparkChartAutomation$$.$getRightOverflow$(), $DvtChartDataChangeFunnelSlice$$ = 
              $DvtSparkChartAutomation$$.getHeight()) : $DvtChartPieLabelUtils$$ = $DvtSparkChartAutomation$$.getWidth();
            } else {
              return $DvtChartRangeMarker$$ ? $DvtSparkChartDefaults$$.$getPreferredSize$($DvtChartRefObjUtils$$, $DvtChartPieLabelInfo$$.$w$, $DvtChartStyleUtils$$.$getSizeInPixels$($DvtChartDataChangeMarker$$, $DvtChartPieRenderUtils$$.$h$) - $DvtChartPolarBar$$) : $DvtSparkChartDefaults$$.$getPreferredSize$($DvtChartRefObjUtils$$, $DvtChartStyleUtils$$.$getSizeInPixels$($DvtChartDataChangeMarker$$, $DvtChartPieRenderUtils$$.$w$) - $DvtChartPolarBar$$, $DvtChartPieLabelInfo$$.$h$);
            }
          }
        }
      }
    }
    $DvtChartAxisUtils$$.$isYAdjustmentNeeded$($DvtSparkChartEventManager$$) && $DvtSparkChartDefaults$$.$getPreferredSize$($DvtChartRefObjUtils$$, $DvtChartPieLabelUtils$$, $DvtChartDataChangeFunnelSlice$$);
    return new $dvt$$2$$.$Dimension$($DvtChartPieLabelUtils$$, $DvtChartDataChangeFunnelSlice$$);
  };
  $DvtChartAxisRenderer$$.$_addAxisGaps$ = function $$DvtChartAxisRenderer$$$$_addAxisGaps$$($dvt$$2$$, $DvtSparkChartEventManager$$) {
    var $DvtSparkChartDefaults$$ = $DvtChartTypeUtils$$.$isHorizontal$($dvt$$2$$), $DvtSparkChartAutomation$$ = $DvtChartAxisUtils$$.$getYAxisPosition$($dvt$$2$$), $DvtChartRefObjUtils$$ = $DvtChartAxisUtils$$.$getY2AxisPosition$($dvt$$2$$), $DvtChartPieLabelUtils$$ = $DvtChartAxisUtils$$.$isAxisRendered$($dvt$$2$$, "x"), $DvtChartPieLabelInfo$$ = $DvtChartAxisUtils$$.$isAxisRendered$($dvt$$2$$, "y"), $DvtChartPieRenderUtils$$ = $DvtChartAxisUtils$$.$isAxisRendered$($dvt$$2$$, "y2"), $DvtChartDataChangePyramidSlice$$ = 
    $dvt$$2$$.$getOptions$().layout.verticalAxisGap, $DvtChartDataChangePyramidSlice$$ = $DvtSparkChartDefaults$$ ? $DvtChartDataChangePyramidSlice$$ * $DvtChartAxisUtils$$.$getGapScalingFactor$($dvt$$2$$, "x") : $DvtChartDataChangePyramidSlice$$ * Math.max($DvtChartAxisUtils$$.$getGapScalingFactor$($dvt$$2$$, "y"), $DvtChartAxisUtils$$.$getGapScalingFactor$($dvt$$2$$, "y2")), $DvtChartDataChangePyramidSlice$$ = Math.ceil($DvtChartDataChangePyramidSlice$$);
    (!$DvtSparkChartDefaults$$ || "top" == $DvtSparkChartAutomation$$ && $DvtChartPieLabelInfo$$ || "top" == $DvtChartRefObjUtils$$ && $DvtChartPieRenderUtils$$) && $DvtSparkChartDefaults$$ || ($DvtSparkChartEventManager$$.y += $DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$.$h$ -= $DvtChartDataChangePyramidSlice$$);
    (!$DvtSparkChartDefaults$$ || "bottom" == $DvtSparkChartAutomation$$ && $DvtChartPieLabelInfo$$ || "bottom" == $DvtChartRefObjUtils$$ && $DvtChartPieRenderUtils$$) && ($DvtSparkChartDefaults$$ || $DvtChartPieLabelUtils$$) || ($DvtSparkChartEventManager$$.$h$ -= $DvtChartDataChangePyramidSlice$$);
  };
  ...
  $DvtChartLegendRenderer$$.$render$ = function $$DvtChartLegendRenderer$$$$render$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    if (!("off" == $DvtChartRefObjUtils$$.legend.rendered || "auto" == $DvtChartRefObjUtils$$.legend.rendered && $DvtSparkChartEventManager$$.$_optionsCache$.$getFromCache$("hasLargeSeriesCount"))) {
      ...
      if (0 != $DvtChartPieLabelUtils$$.sections.length) {
        var $DvtChartPieRenderUtils$$ = $dvt$$2$$.$Legend$.newInstance($DvtSparkChartEventManager$$.$getCtx$(), $DvtSparkChartEventManager$$.$processEvent$, $DvtSparkChartEventManager$$);
        null != $DvtSparkChartEventManager$$.getId() && $DvtChartPieRenderUtils$$.setId($DvtSparkChartEventManager$$.getId() + "legend");
        $DvtSparkChartDefaults$$.$addChild$($DvtChartPieRenderUtils$$);
        var $DvtChartDataChangePyramidSlice$$;
        if (null != $DvtChartPieLabelUtils$$.size) {
          $DvtChartDataChangePyramidSlice$$ = $DvtChartPieLabelInfo$$ ? new $dvt$$2$$.$Dimension$($DvtSparkChartAutomation$$.$w$, $DvtChartStyleUtils$$.$getSizeInPixels$($DvtChartPieLabelUtils$$.size, $DvtSparkChartAutomation$$.$h$)) : new $dvt$$2$$.$Dimension$($DvtChartStyleUtils$$.$getSizeInPixels$($DvtChartPieLabelUtils$$.size, $DvtSparkChartAutomation$$.$w$), $DvtSparkChartAutomation$$.$h$);
        } else {
          $DvtChartDataChangePyramidSlice$$ = $DvtChartPieLabelInfo$$ ? $DvtSparkChartAutomation$$.$w$ : $DvtChartStyleUtils$$.$getSizeInPixels$($DvtChartPieLabelUtils$$.maxSize, $DvtSparkChartAutomation$$.$w$);
          ...
          $DvtChartDataChangePyramidSlice$$ = $DvtChartPieRenderUtils$$.$getPreferredSize$($DvtChartPieLabelUtils$$, $DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$);
        }
        $DvtChartPieRenderUtils$$.$render$($DvtChartPieLabelUtils$$, $DvtChartDataChangePyramidSlice$$.$w$, $DvtChartDataChangePyramidSlice$$.$h$);
        ...
        $dvt$$2$$.$LayoutUtils$.position($DvtSparkChartAutomation$$, $DvtChartAxisUtils$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$.$w$, $DvtChartDataChangePyramidSlice$$.$h$, $DvtChartPieLabelUtils$$);
        $DvtSparkChartAutomation$$ = $DvtChartPieRenderUtils$$.$_bounds$;
        $DvtChartPieLabelInfo$$ = $DvtChartPieRenderUtils$$.$localToStage$(new $dvt$$2$$.$Point$($DvtSparkChartAutomation$$.x, $DvtSparkChartAutomation$$.y));
        $DvtChartTypeUtils$$.$isOverview$($DvtSparkChartEventManager$$) || ($DvtChartDataChangePyramidSlice$$ = $dvt$$2$$.$Agent$.$isRightToLeft$($DvtSparkChartEventManager$$.$getCtx$()), "end" == $DvtChartAxisUtils$$ ? $DvtChartDataChangePyramidSlice$$ ? $DvtChartRefObjUtils$$._minOverflowCoord = $DvtChartPieLabelInfo$$.x + $DvtSparkChartAutomation$$.$w$ + $DvtChartPieLabelUtils$$ / 2 : $DvtChartRefObjUtils$$._maxOverflowCoord = $DvtChartPieLabelInfo$$.x - $DvtChartPieLabelUtils$$ / 2 : "start" == 
        $DvtChartAxisUtils$$ && ($DvtChartDataChangePyramidSlice$$ ? $DvtChartRefObjUtils$$._maxOverflowCoord = $DvtChartPieLabelInfo$$.x - $DvtChartPieLabelUtils$$ / 2 : $DvtChartRefObjUtils$$._minOverflowCoord = $DvtChartPieLabelInfo$$.x + $DvtSparkChartAutomation$$.$w$ + $DvtChartPieLabelUtils$$ / 2));
        ...
        $DvtSparkChartEventManager$$.$legend$ = $DvtChartPieRenderUtils$$;
      }
    }
  };
  ...
  $DvtChartLegendRenderer$$.$_getSeriesItems$ = function $$DvtChartLegendRenderer$$$$_getSeriesItems$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    if ("pie" == $DvtSparkChartEventManager$$.$getType$()) {
      for (var $DvtChartPieLabelUtils$$ = $DvtChartPieUtils$$.$getRenderedSeriesIndices$($DvtSparkChartEventManager$$), $DvtChartPieLabelInfo$$ = 0;$DvtChartPieLabelInfo$$ < $DvtChartPieLabelUtils$$.length;$DvtChartPieLabelInfo$$++) {
        $DvtChartAxisUtils$$ = $DvtChartPieLabelUtils$$[$DvtChartPieLabelInfo$$], ($DvtChartRefObjUtils$$ = $DvtChartLegendRenderer$$.$_createLegendItem$($DvtSparkChartEventManager$$, $DvtChartAxisUtils$$)) && $DvtSparkChartAutomation$$.push($DvtChartRefObjUtils$$);
      }
      ...
      var $DvtChartPieLabelUtils$$ = {}, $DvtChartPieLabelInfo$$ = {}, $DvtChartPieRenderUtils$$ = $DvtChartDataUtils$$.$getSeriesCount$($DvtSparkChartEventManager$$);
      for ($DvtChartAxisUtils$$ = 0;$DvtChartAxisUtils$$ < $DvtChartPieRenderUtils$$;$DvtChartAxisUtils$$++) {
        if ($DvtChartRefObjUtils$$ = $DvtChartLegendRenderer$$.$_createLegendItem$($DvtSparkChartEventManager$$, $DvtChartAxisUtils$$)) {
          var $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.$getStackCategory$($DvtSparkChartEventManager$$, $DvtChartAxisUtils$$);
          $DvtChartDataUtils$$.$isAssignedToY2$($DvtSparkChartEventManager$$, $DvtChartAxisUtils$$) ? $DvtChartPieLabelInfo$$[$DvtChartDataChangePyramidSlice$$] ? $DvtChartPieLabelInfo$$[$DvtChartDataChangePyramidSlice$$].push($DvtChartRefObjUtils$$) : $DvtChartPieLabelInfo$$[$DvtChartDataChangePyramidSlice$$] = [$DvtChartRefObjUtils$$] : $DvtChartPieLabelUtils$$[$DvtChartDataChangePyramidSlice$$] ? $DvtChartPieLabelUtils$$[$DvtChartDataChangePyramidSlice$$].push($DvtChartRefObjUtils$$) : $DvtChartPieLabelUtils$$[$DvtChartDataChangePyramidSlice$$] = 
          [$DvtChartRefObjUtils$$];
        }
      }
      $DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getStackCategories$($DvtSparkChartEventManager$$, null, !0);
      $DvtChartAxisUtils$$ = $DvtChartTypeUtils$$.$isStacked$($DvtSparkChartEventManager$$) && $DvtChartTypeUtils$$.$isVertical$($DvtSparkChartEventManager$$) && $DvtSparkChartDefaults$$;
      $DvtSparkChartAutomation$$ = $DvtChartLegendRenderer$$.$_getSeriesItemsForAxis$($DvtChartPieLabelUtils$$, $DvtChartRefObjUtils$$.y, $DvtChartAxisUtils$$, $DvtSparkChartAutomation$$);
      $DvtSparkChartAutomation$$ = $DvtChartLegendRenderer$$.$_getSeriesItemsForAxis$($DvtChartPieLabelInfo$$, $DvtChartRefObjUtils$$.y2, $DvtChartAxisUtils$$, $DvtSparkChartAutomation$$);
    }
    return $DvtSparkChartAutomation$$;
  };
  ...
  $DvtChartLegendRenderer$$.$_createLegendItem$ = function $$DvtChartLegendRenderer$$$$_createLegendItem$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    var $DvtChartPieRenderUtils$$ = $DvtChartDataUtils$$.$getSeriesLabel$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
    if ("on" != $DvtChartPieLabelInfo$$ && (!$DvtChartPieRenderUtils$$ || 0 >= $dvt$$2$$.$StringUtils$.trim($DvtChartPieRenderUtils$$).length)) {
      return null;
    }
    $DvtChartPieLabelInfo$$ = {id:$DvtChartDataUtils$$.$getSeries$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$), text:$DvtChartPieRenderUtils$$, categories:$DvtChartDataUtils$$.$getCategories$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$), categoryVisibility:$DvtChartStyleUtils$$.$isSeriesRendered$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) ? "visible" : "hidden", _dataContext:$DvtChartDataUtils$$.$getDataContext$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, 
    -1)};
  ...
  $DvtChartPlotAreaRenderer$$.$_renderGridlines$ = function $$DvtChartPlotAreaRenderer$$$$_renderGridlines$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$) {
    var $DvtChartPieRenderUtils$$ = $DvtSparkChartAutomation$$.lineColor, $DvtChartDataChangePyramidSlice$$ = new $dvt$$2$$.$SolidStroke$($DvtChartPieRenderUtils$$, 1, $DvtSparkChartAutomation$$.lineWidth);
    $DvtSparkChartAutomation$$.lineStyle && $DvtChartDataChangePyramidSlice$$.$setStyle$($dvt$$2$$.$Stroke$.$convertTypeString$($DvtSparkChartAutomation$$.lineStyle));
    var $DvtChartSeriesEffectUtils$$ = $DvtChartDataChangePyramidSlice$$.clone();
    "inherit" != $DvtSparkChartAutomation$$.baselineColor && ($DvtChartPieRenderUtils$$ = "auto" == $DvtSparkChartAutomation$$.baselineColor ? $dvt$$2$$.$ColorUtils$.$getDarker$($DvtChartPieRenderUtils$$, .4) : $DvtSparkChartAutomation$$.baselineColor, $DvtChartSeriesEffectUtils$$.$setColor$($DvtChartPieRenderUtils$$));
  ...
  $DvtChartPlotAreaRenderer$$.$_renderGridline$ = function $$DvtChartPlotAreaRenderer$$$$_renderGridline$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$) {
    ...
    var $DvtChartDataChangePyramidSlice$$ = !$dvt$$2$$.$Agent$.$isTouchDevice$() || 1 < $dvt$$2$$.$Agent$.$getDevicePixelRatio$();
    "radial" == $DvtSparkChartAutomation$$ ? ($DvtChartAxisUtils$$.$isGridPolygonal$($DvtSparkChartEventManager$$) ? ($DvtChartRefObjUtils$$ = $dvt$$2$$.$PolygonUtils$.$getRegularPolygonPoints$(0, 0, $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartEventManager$$), $DvtChartRefObjUtils$$), $DvtChartPieRenderUtils$$ = new $dvt$$2$$.$Polygon$($DvtChartPieRenderUtils$$, $DvtChartRefObjUtils$$)) : $DvtChartPieRenderUtils$$ = new $dvt$$2$$.$Circle$($DvtChartPieRenderUtils$$, 0, 0, $DvtChartRefObjUtils$$), 
    $DvtChartPieRenderUtils$$.$setInvisibleFill$(), $DvtChartPieRenderUtils$$.$setTranslate$($DvtChartPieLabelInfo$$.x + $DvtChartPieLabelInfo$$.$w$ / 2, $DvtChartPieLabelInfo$$.y + $DvtChartPieLabelInfo$$.$h$ / 2)) : "tangential" == $DvtSparkChartAutomation$$ ? ($DvtChartPieRenderUtils$$ = new $dvt$$2$$.$Line$($DvtChartPieRenderUtils$$, 0, 0, $DvtSparkChartEventManager$$.$getRadius$() * Math.sin($DvtChartRefObjUtils$$), -$DvtSparkChartEventManager$$.$getRadius$() * Math.cos($DvtChartRefObjUtils$$)), 
    .01 > $DvtChartRefObjUtils$$ % Math.PI / 2 && $DvtChartDataChangePyramidSlice$$ && $DvtChartPieRenderUtils$$.$setPixelHinting$(), $DvtChartPieRenderUtils$$.$setTranslate$($DvtChartPieLabelInfo$$.x + $DvtChartPieLabelInfo$$.$w$ / 2, $DvtChartPieLabelInfo$$.y + $DvtChartPieLabelInfo$$.$h$ / 2)) : ($DvtChartPieRenderUtils$$ = "top" == $DvtSparkChartAutomation$$ || "bottom" == $DvtSparkChartAutomation$$ ? new $dvt$$2$$.$Line$($DvtChartPieRenderUtils$$, $DvtChartRefObjUtils$$, $DvtChartPieLabelInfo$$.y, 
    $DvtChartRefObjUtils$$, $DvtChartPieLabelInfo$$.y + $DvtChartPieLabelInfo$$.$h$) : new $dvt$$2$$.$Line$($DvtChartPieRenderUtils$$, $DvtChartPieLabelInfo$$.x, $DvtChartRefObjUtils$$, $DvtChartPieLabelInfo$$.x + $DvtChartPieLabelInfo$$.$w$, $DvtChartRefObjUtils$$), $DvtChartDataChangePyramidSlice$$ && $DvtChartPieRenderUtils$$.$setPixelHinting$());
    $DvtChartPieRenderUtils$$.$setStroke$($DvtChartPieLabelUtils$$);
  ...
  $DvtChartPlotAreaRenderer$$.$_renderDataLabel$ = function $$DvtChartPlotAreaRenderer$$$$_renderDataLabel$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$) {
    if (!$DvtChartTypeUtils$$.$isOverview$($DvtSparkChartEventManager$$)) {
      var $DvtChartSeriesEffectUtils$$ = $DvtChartDataUtils$$.$getDataLabel$($DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$);
      if (null != $DvtChartSeriesEffectUtils$$) {
        var $DvtChartRangeMarker$$ = $DvtChartStyleUtils$$.$getDataLabelPosition$($DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$);
        if ("none" != $DvtChartRangeMarker$$) {
          $DvtChartSeriesEffectUtils$$ = new $dvt$$2$$.$OutputText$($DvtSparkChartEventManager$$.$getCtx$(), $DvtChartSeriesEffectUtils$$, 0, 0);
          $DvtChartSeriesEffectUtils$$.$setMouseEnabled$(!1);
          $DvtChartPieLabelUtils$$ = $DvtChartDataChangePyramidSlice$$ ? $DvtSparkChartEventManager$$.$getOptions$().styleDefaults.stackLabelStyle : $DvtChartStyleUtils$$.$getDataLabelStyle$($DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, $DvtChartRangeMarker$$, $DvtChartPieRenderUtils$$);
          $DvtChartSeriesEffectUtils$$.$setCSSStyle$($DvtChartPieLabelUtils$$);
          $DvtChartSeriesEffectUtils$$.$setY$($DvtSparkChartAutomation$$.y + $DvtSparkChartAutomation$$.$h$ / 2);
          $DvtChartSeriesEffectUtils$$.$setX$($DvtSparkChartAutomation$$.x + $DvtSparkChartAutomation$$.$w$ / 2);
          $DvtChartSeriesEffectUtils$$.$alignCenter$();
          $DvtChartSeriesEffectUtils$$.$alignMiddle$();
          $DvtChartPieLabelUtils$$ = $DvtChartSeriesEffectUtils$$.$measureDimensions$();
          if ("left" == $DvtChartRangeMarker$$) {
            $DvtChartSeriesEffectUtils$$.$setX$($DvtSparkChartAutomation$$.x - $DvtChartPieLabelUtils$$.$w$ / 2 - $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$);
          } else {
            if ("right" == $DvtChartRangeMarker$$) {
              $DvtChartSeriesEffectUtils$$.$setX$($DvtSparkChartAutomation$$.x + $DvtSparkChartAutomation$$.$w$ + $DvtChartPieLabelUtils$$.$w$ / 2 + $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$);
            } else {
              if ("top" == $DvtChartRangeMarker$$) {
                $DvtChartSeriesEffectUtils$$.$setY$($DvtSparkChartAutomation$$.y - $DvtChartPieLabelUtils$$.$h$ / 2);
              } else {
                if ("bottom" == $DvtChartRangeMarker$$) {
                  $DvtChartSeriesEffectUtils$$.$setY$($DvtSparkChartAutomation$$.y + $DvtSparkChartAutomation$$.$h$ + $DvtChartPieLabelUtils$$.$h$ / 2 + $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$ / 2);
                } else {
                  if ("bar" == $DvtChartStyleUtils$$.$getSeriesType$($DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$)) {
                    ...
                    "inLeft" == $DvtChartRangeMarker$$ ? $DvtChartSeriesEffectUtils$$.$setX$($DvtSparkChartAutomation$$.x + $DvtChartPieLabelUtils$$.$w$ / 2 + $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$) : "inRight" == $DvtChartRangeMarker$$ ? $DvtChartSeriesEffectUtils$$.$setX$($DvtSparkChartAutomation$$.x + $DvtSparkChartAutomation$$.$w$ - $DvtChartPieLabelUtils$$.$w$ / 2 - $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$) : "inTop" == $DvtChartRangeMarker$$ ? $DvtChartSeriesEffectUtils$$.$setY$($DvtSparkChartAutomation$$.y + 
                    $DvtChartPieLabelUtils$$.$h$ / 2 + $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$) : "inBottom" == $DvtChartRangeMarker$$ && $DvtChartSeriesEffectUtils$$.$setY$($DvtSparkChartAutomation$$.y + $DvtSparkChartAutomation$$.$h$ - $DvtChartPieLabelUtils$$.$h$ / 2 - $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$ / 2);
                  } else {
                    if ($DvtChartTypeUtils$$.$isBubble$($DvtSparkChartEventManager$$) && ($DvtSparkChartAutomation$$.x += $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $DvtSparkChartAutomation$$.y += $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $DvtSparkChartAutomation$$.$h$ -= 2 * $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $DvtSparkChartAutomation$$.$w$ -= 2 * $DvtChartPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $DvtChartRangeMarker$$ = $DvtChartSeriesEffectUtils$$.$getOptimalFontSize$($DvtSparkChartAutomation$$), 
                    $DvtChartSeriesEffectUtils$$.$setFontSize$($DvtChartRangeMarker$$), !$dvt$$2$$.$TextUtils$.$fitText$($DvtChartSeriesEffectUtils$$, $DvtSparkChartAutomation$$.$w$, $DvtSparkChartAutomation$$.$h$, $DvtSparkChartDefaults$$, $DvtChartPlotAreaRenderer$$.$_MIN_CHARS_DATA_LABEL$))) {
                      return;
                    }
                  }
                  null != $DvtChartStyleUtils$$.$getPattern$($DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) && ($DvtChartPieLabelUtils$$ = $DvtChartSeriesEffectUtils$$.$getDimensions$(), $DvtSparkChartAutomation$$ = .15 * $DvtChartPieLabelUtils$$.$h$, $DvtSparkChartAutomation$$ = $dvt$$2$$.$PathUtils$.$roundedRectangle$($DvtChartPieLabelUtils$$.x - $DvtSparkChartAutomation$$, $DvtChartPieLabelUtils$$.y, $DvtChartPieLabelUtils$$.$w$ + 2 * $DvtSparkChartAutomation$$, $DvtChartPieLabelUtils$$.$h$, 
                  2, 2, 2, 2), $DvtSparkChartAutomation$$ = new $dvt$$2$$.$Path$($DvtSparkChartEventManager$$.$getCtx$(), $DvtSparkChartAutomation$$), $DvtSparkChartAutomation$$.$setSolidFill$("#FFFFFF", .9), $DvtSparkChartDefaults$$.$addChild$($DvtSparkChartAutomation$$));
                }
              }
            }
          }
          $DvtChartStyleUtils$$.$optimizeMarkerStroke$($DvtSparkChartEventManager$$) && $DvtChartSeriesEffectUtils$$.$setSolidStroke$("none");
          $DvtSparkChartDefaults$$.$addChild$($DvtChartSeriesEffectUtils$$);
          $DvtSparkChartEventManager$$.$addDataLabel$($DvtChartSeriesEffectUtils$$);
        }
      }
    }
  };
  ...
  $DvtChartPlotAreaRenderer$$.$_renderScatterBubble$ = function $$DvtChartPlotAreaRenderer$$$$_renderScatterBubble$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    ...
    var $DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$getMarkerBorderColor$($DvtSparkChartEventManager$$), $DvtChartDataChangePyramidSlice$$ = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$), $DvtChartPieRenderUtils$$ = new $dvt$$2$$.$SolidStroke$($DvtChartPieRenderUtils$$, null, $DvtChartDataChangePyramidSlice$$), $DvtChartDataChangePyramidSlice$$ = [];
    if ($DvtChartAxisUtils$$) {
      for ($DvtChartRefObjUtils$$ = ($DvtChartPieLabelInfo$$ = $DvtChartStyleUtils$$.$optimizeMarkerStroke$($DvtSparkChartEventManager$$)) ? $DvtChartPieRenderUtils$$.$getColor$() : null, $DvtChartPieLabelInfo$$ = $DvtChartPieLabelInfo$$ ? $DvtChartPieRenderUtils$$.getWidth() : null, $DvtChartPieLabelUtils$$ = 0;$DvtChartPieLabelUtils$$ < $DvtChartAxisUtils$$.length;$DvtChartPieLabelUtils$$++) {
        ...
        $DvtChartDataChangePyramidSlice$$.push($DvtChartSeriesEffectUtils$$);
      }
    } else {
      for ($DvtChartPieLabelUtils$$ = 0;$DvtChartPieLabelUtils$$ < $DvtChartPieLabelInfo$$;$DvtChartPieLabelUtils$$++) {
        $DvtChartAxisUtils$$ = $DvtChartPlotAreaRenderer$$.$_getMarkersForSeries$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartRefObjUtils$$, $DvtChartPieRenderUtils$$), $DvtChartDataChangePyramidSlice$$ = $DvtChartDataChangePyramidSlice$$.concat($DvtChartAxisUtils$$);
      }
      $DvtChartMarkerUtils$$.$sortMarkers$($DvtChartDataChangePyramidSlice$$);
    }
    $DvtChartTypeUtils$$.$isBubble$($DvtSparkChartEventManager$$) ? $DvtChartPlotAreaRenderer$$.$_addMarkersToContainer$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$, $DvtChartDataChangePyramidSlice$$, $DvtChartPieRenderUtils$$) : $DvtChartPlotAreaRenderer$$.$_addMarkersToContainer$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangePyramidSlice$$, $DvtChartPieRenderUtils$$);
  };
  ...
  $DvtChartPlotAreaRenderer$$.$_getMarkerInfo$ = function $$DvtChartPlotAreaRenderer$$$$_getMarkerInfo$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartPieLabelUtils$$) {
    var $DvtChartPieLabelInfo$$ = $DvtSparkChartEventManager$$.$getOptions$(), $DvtChartPieRenderUtils$$ = $DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$);
    if (null == $DvtChartPieRenderUtils$$ || isNaN($DvtChartPieRenderUtils$$) || $DvtChartPlotAreaRenderer$$.$_isDataItemFiltered$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$)) {
      return null;
    }
    var $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartEventManager$$), $DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$isMarkerDisplayed$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$);
    if (!$DvtChartPieRenderUtils$$ && (null == $DvtChartRefObjUtils$$ || 0 > $DvtChartRefObjUtils$$)) {
      if ("jet" != $DvtChartPieLabelInfo$$._environment && $DvtChartAxisUtils$$.$isMixedFrequency$($DvtSparkChartEventManager$$)) {
        2 > $DvtChartDataChangePyramidSlice$$ && ($DvtChartPieRenderUtils$$ = !0);
      } else {
        var $DvtChartSeriesEffectUtils$$ = $DvtChartDataChangePyramidSlice$$ - 1, $DvtChartRangeMarker$$ = $DvtChartTypeUtils$$.$isPolar$($DvtSparkChartEventManager$$), $DvtChartDataChangePyramidSlice$$ = $DvtChartRangeMarker$$ && 0 < $DvtChartSeriesEffectUtils$$ && $DvtSparkChartAutomation$$ == $DvtChartSeriesEffectUtils$$ ? 0 : $DvtSparkChartAutomation$$ + 1, $DvtChartSeriesEffectUtils$$ = $DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartRangeMarker$$ && 
        0 < $DvtChartSeriesEffectUtils$$ && 0 == $DvtSparkChartAutomation$$ ? $DvtChartSeriesEffectUtils$$ : $DvtSparkChartAutomation$$ - 1), $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.getValue($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangePyramidSlice$$);
        null != $DvtChartSeriesEffectUtils$$ && !isNaN($DvtChartSeriesEffectUtils$$) || null != $DvtChartDataChangePyramidSlice$$ && !isNaN($DvtChartDataChangePyramidSlice$$) || ($DvtChartPieRenderUtils$$ = !0);
      }
    }
    if (!$DvtChartPieRenderUtils$$ && ($DvtChartTypeUtils$$.$isSpark$($DvtSparkChartEventManager$$) || ($DvtChartPieLabelInfo$$._duringAnimation || $DvtChartTypeUtils$$.$isOverview$($DvtSparkChartEventManager$$)) && !$DvtChartDataUtils$$.$isDataSelected$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$))) {
      return null;
    }
    ...
    $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.$getMarkerPosition$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartPieLabelUtils$$);
    ...
    $DvtChartPieLabelUtils$$ && $DvtChartDataChangePyramidSlice$$ && $DvtSparkChartEventManager$$ && ($DvtChartPieLabelInfo$$ = $DvtChartPieLabelUtils$$.$intersects$(new $dvt$$2$$.$Rectangle$($DvtChartDataChangePyramidSlice$$.x - $DvtSparkChartEventManager$$ / 2, $DvtChartDataChangePyramidSlice$$.y - $DvtSparkChartEventManager$$ / 2, $DvtSparkChartEventManager$$, $DvtSparkChartEventManager$$)));
    return $DvtChartDataChangePyramidSlice$$ && $DvtChartPieLabelInfo$$ ? {$seriesIndex$:$DvtSparkChartDefaults$$, $groupIndex$:$DvtSparkChartAutomation$$, $itemIndex$:$DvtChartRefObjUtils$$, x:$DvtChartDataChangePyramidSlice$$.x, y:$DvtChartDataChangePyramidSlice$$.y, size:$DvtSparkChartEventManager$$, $markerDisplayed$:$DvtChartPieRenderUtils$$} : null;
  };
  ...
  $DvtChartPlotAreaRenderer$$.$_getMarkersForSeries$ = function $$DvtChartPlotAreaRenderer$$$$_getMarkersForSeries$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    for (var $DvtChartRefObjUtils$$ = [], $DvtChartPieLabelUtils$$ = $DvtChartDataUtils$$.$getGroupCount$($dvt$$2$$), $DvtChartPieLabelInfo$$ = 0;$DvtChartPieLabelInfo$$ < $DvtChartPieLabelUtils$$;$DvtChartPieLabelInfo$$++) {
      var $DvtChartPieRenderUtils$$ = $DvtChartPlotAreaRenderer$$.$_getMarkerInfo$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtChartPieLabelInfo$$, null, $DvtSparkChartDefaults$$);
      $DvtChartPieRenderUtils$$ && ($DvtChartPieRenderUtils$$ = $DvtChartPlotAreaRenderer$$.$_createMarker$($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartAxisUtils$$, $DvtSparkChartAutomation$$), null != $DvtChartPieRenderUtils$$ && $DvtChartRefObjUtils$$.push($DvtChartPieRenderUtils$$));
    }
    return $DvtChartRefObjUtils$$;
  };
  $DvtChartPlotAreaRenderer$$.$_createMarker$ = function $$DvtChartPlotAreaRenderer$$$$_createMarker$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$) {
    var $DvtChartAxisUtils$$ = $dvt$$2$$.$Agent$.$isTouchDevice$(), $DvtChartPieLabelUtils$$ = $DvtSparkChartEventManager$$.$getCtx$(), $DvtChartPieLabelInfo$$ = $DvtChartStyleUtils$$.$optimizeMarkerStroke$($DvtSparkChartEventManager$$), $DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$optimizeMarkerFill$($DvtSparkChartEventManager$$), $DvtChartDataChangePyramidSlice$$ = $DvtSparkChartDefaults$$.$seriesIndex$, $DvtChartRangeMarker$$ = $DvtSparkChartDefaults$$.$groupIndex$, $DvtChartPolarBar$$ = 
    $DvtSparkChartDefaults$$.$itemIndex$, $DvtChartDataChangeMarker$$ = $DvtChartStyleUtils$$.$getMarkerColor$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$), $DvtChartDataCursor$$ = $DvtChartStyleUtils$$.$getMarkerShape$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$), $DvtChartDataChangeFunnelSlice$$ = $DvtSparkChartDefaults$$.$markerDisplayed$;
    null == $DvtChartDataChangeFunnelSlice$$ && ($DvtChartDataChangeFunnelSlice$$ = $DvtChartStyleUtils$$.$isMarkerDisplayed$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$));
    $DvtChartDataChangeFunnelSlice$$ ? (($DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$getImageSource$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, "source")) ? ($DvtSparkChartAutomation$$ = $DvtChartStyleUtils$$.$getImageSource$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, "sourceSelected"), $DvtChartRefObjUtils$$ = $DvtChartStyleUtils$$.$getImageSource$($DvtSparkChartEventManager$$, 
    $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, "sourceHover"), $DvtChartDataChangeMarker$$ = $DvtChartStyleUtils$$.$getImageSource$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, "sourceHoverSelected"), $DvtChartPieLabelUtils$$ = new $dvt$$2$$.$ImageMarker$($DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$.x, $DvtSparkChartDefaults$$.y, $DvtSparkChartDefaults$$.size, $DvtSparkChartDefaults$$.size, 
    null, $DvtChartPieRenderUtils$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartDataChangeMarker$$)) : ($DvtChartPieLabelUtils$$ = new $dvt$$2$$.$SimpleMarker$($DvtChartPieLabelUtils$$, $DvtChartDataCursor$$, $DvtSparkChartEventManager$$.$getSkin$(), $DvtSparkChartDefaults$$.x, $DvtSparkChartDefaults$$.y, $DvtSparkChartDefaults$$.size, $DvtSparkChartDefaults$$.size, null, null, !0), $DvtChartPieLabelUtils$$.$setFill$($DvtChartSeriesEffectUtils$$.$getMarkerFill$($DvtSparkChartEventManager$$, 
    $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$)), $DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$getMarkerBorderColor$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$), $DvtChartDataCursor$$ = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$), $DvtChartPieRenderUtils$$ == $DvtSparkChartAutomation$$ && 
    $DvtChartDataCursor$$ == $DvtChartRefObjUtils$$ || $DvtChartPieLabelUtils$$.$setSolidStroke$($DvtChartPieRenderUtils$$, null, $DvtChartDataCursor$$), $DvtChartPieLabelUtils$$.$setDataColor$($DvtChartDataChangeMarker$$, !0), $DvtSparkChartAutomation$$ = $dvt$$2$$.$SelectionEffectUtils$.$getHoverBorderColor$($DvtChartDataChangeMarker$$), $DvtChartRefObjUtils$$ = $DvtChartStyleUtils$$.$getSelectedInnerColor$($DvtSparkChartEventManager$$), $DvtChartDataChangeMarker$$ = $DvtChartStyleUtils$$.$getSelectedOuterColor$($DvtSparkChartEventManager$$), 
    $DvtChartPieLabelUtils$$.$setHoverStroke$(new $dvt$$2$$.$SolidStroke$($DvtChartRefObjUtils$$, 1, 1), new $dvt$$2$$.$SolidStroke$($DvtSparkChartAutomation$$, 1, 3.5)), $DvtChartPieLabelUtils$$.$setSelectedStroke$(new $dvt$$2$$.$SolidStroke$($DvtChartRefObjUtils$$, 1, 1.5), new $dvt$$2$$.$SolidStroke$($DvtChartDataChangeMarker$$, 1, 4.5)), $DvtChartPieLabelUtils$$.$setSelectedHoverStroke$(new $dvt$$2$$.$SolidStroke$($DvtChartRefObjUtils$$, 1, 1.5), new $dvt$$2$$.$SolidStroke$($DvtSparkChartAutomation$$, 
    1, 4.5)), $DvtChartPieLabelUtils$$.$setClassName$($DvtChartStyleUtils$$.$getMarkerClassName$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$)), $DvtChartPieLabelUtils$$.$setStyle$($DvtChartStyleUtils$$.$getMarkerStyle$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$))), $DvtChartStyleUtils$$.$isSelectable$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$) && 
    $DvtChartPieLabelUtils$$.setCursor("pointer"), $DvtChartAxisUtils$$ && $DvtSparkChartDefaults$$.size < $DvtChartPlotAreaRenderer$$.$_MIN_TOUCH_MARKER_SIZE$ && $DvtChartPlotAreaRenderer$$.$_addMarkerHitArea$($DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$.x, $DvtSparkChartDefaults$$.y, $DvtChartPieLabelInfo$$)) : ($DvtChartStyleUtils$$.$isSelectable$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$) ? ($DvtChartPieLabelUtils$$ = new $DvtChartLineMarker$$($DvtChartPieLabelUtils$$, 
    $DvtChartDataCursor$$, $DvtSparkChartDefaults$$.x, $DvtSparkChartDefaults$$.y, $DvtSparkChartDefaults$$.size, $DvtChartPieLabelInfo$$), $DvtChartPieLabelUtils$$.setCursor("pointer"), $DvtChartAxisUtils$$ && $DvtChartPlotAreaRenderer$$.$_addMarkerHitArea$($DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$.x, $DvtSparkChartDefaults$$.y, $DvtChartPieLabelInfo$$)) : ($DvtChartAxisUtils$$ && ($DvtSparkChartDefaults$$.size = $DvtChartPlotAreaRenderer$$.$_MIN_TOUCH_MARKER_SIZE$), $DvtChartPieLabelUtils$$ = 
    new $DvtChartLineMarker$$($DvtChartPieLabelUtils$$, $dvt$$2$$.$SimpleMarker$.$SQUARE$, $DvtSparkChartDefaults$$.x, $DvtSparkChartDefaults$$.y, $DvtSparkChartDefaults$$.size, $DvtChartPieLabelInfo$$)), null != $DvtChartPieLabelUtils$$ && ($DvtChartPieRenderUtils$$ || $DvtChartPieLabelUtils$$.$setInvisibleFill$(), $DvtChartPieLabelUtils$$.$setDataColor$($DvtChartDataChangeMarker$$)));
    null != $DvtChartPieLabelUtils$$ && $DvtChartObjPeer$$.$associate$($DvtChartPieLabelUtils$$, $DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, $DvtSparkChartDefaults$$);
    return $DvtChartPieLabelUtils$$;
  };
  ...
  $DvtChartPlotAreaRenderer$$.$_getRangeMarkersForSeries$ = function $$DvtChartPlotAreaRenderer$$$$_getRangeMarkersForSeries$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    for (var $DvtChartRefObjUtils$$ = $dvt$$2$$.$Agent$.$isTouchDevice$(), $DvtChartAxisUtils$$ = $DvtSparkChartEventManager$$.$getCtx$(), $DvtChartPieLabelUtils$$ = $DvtSparkChartEventManager$$.$xAxis$, $DvtChartPieLabelInfo$$ = $DvtChartDataUtils$$.$isAssignedToY2$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) ? $DvtSparkChartEventManager$$.$y2Axis$ : $DvtSparkChartEventManager$$.$yAxis$, $DvtChartPieRenderUtils$$ = $DvtSparkChartEventManager$$.$getOptions$(), $DvtChartDataChangePyramidSlice$$ = 
    $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartEventManager$$), $DvtChartPolarBar$$ = [], $DvtChartDataChangeMarker$$ = 0;$DvtChartDataChangeMarker$$ < $DvtChartDataChangePyramidSlice$$;$DvtChartDataChangeMarker$$++) {
      if (!$DvtChartPlotAreaRenderer$$.$_isDataItemFiltered$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$) && $DvtChartStyleUtils$$.$isDataItemRendered$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$)) {
        var $DvtChartDataCursor$$ = $DvtChartPieLabelUtils$$.$getCoordAt$($DvtChartDataUtils$$.$getXValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$)), $DvtChartDataChangeFunnelSlice$$ = $DvtChartPieLabelInfo$$.$getUnboundedCoordAt$($DvtChartDataUtils$$.$getLowValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$)), $DvtChartFunnelSlice$$ = $DvtChartPieLabelInfo$$.$getUnboundedCoordAt$($DvtChartDataUtils$$.$getHighValue$($DvtSparkChartEventManager$$, 
        $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$));
        if (null != $DvtChartDataCursor$$ && null != $DvtChartDataChangeFunnelSlice$$ && null != $DvtChartFunnelSlice$$) {
          var $DvtChartDataChangeRangeMarker$$ = $DvtChartStyleUtils$$.$isMarkerDisplayed$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$);
          if (!$DvtChartDataChangeRangeMarker$$) {
            var $DvtChartPie$$ = $DvtChartDataChangePyramidSlice$$ - 1, $DvtChartTextUtils$$ = $DvtChartTypeUtils$$.$isPolar$($DvtSparkChartEventManager$$), $DvtChartOverview$$ = $DvtChartTextUtils$$ && 0 < $DvtChartPie$$ && 0 == $DvtChartDataChangeMarker$$ ? $DvtChartPie$$ : $DvtChartDataChangeMarker$$ - 1, $DvtChartDataChangeLineArea$$ = $DvtChartTextUtils$$ && 0 < $DvtChartPie$$ && $DvtChartDataChangeMarker$$ == $DvtChartPie$$ ? 0 : $DvtChartDataChangeMarker$$ + 1, $DvtChartPie$$ = $DvtChartDataUtils$$.$getLowValue$($DvtSparkChartEventManager$$, 
            $DvtSparkChartDefaults$$, $DvtChartOverview$$), $DvtChartTextUtils$$ = $DvtChartDataUtils$$.$getHighValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartOverview$$), $DvtChartDataChangeLineArea$$ = $DvtChartDataUtils$$.$getLowValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeLineArea$$), $DvtChartOverview$$ = $DvtChartDataUtils$$.$getHighValue$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartOverview$$);
            null == $DvtChartPie$$ && null == $DvtChartTextUtils$$ && null == $DvtChartDataChangeLineArea$$ && null == $DvtChartOverview$$ && ($DvtChartDataChangeRangeMarker$$ = !0);
          }
          if (!($DvtChartPieRenderUtils$$._duringAnimation || $DvtChartTypeUtils$$.$isOverview$($DvtSparkChartEventManager$$) || $DvtChartTypeUtils$$.$isSpark$($DvtSparkChartEventManager$$)) || $DvtChartDataChangeRangeMarker$$ || $DvtChartDataUtils$$.$isDataSelected$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$)) {
            var $DvtChartDataChangeFunnelSlice$$ = $DvtChartPlotAreaRenderer$$.$convertAxisCoord$($DvtSparkChartEventManager$$, new $dvt$$2$$.$Point$($DvtChartDataCursor$$, $DvtChartDataChangeFunnelSlice$$), $DvtSparkChartAutomation$$), $DvtChartOverview$$ = $DvtChartPlotAreaRenderer$$.$convertAxisCoord$($DvtSparkChartEventManager$$, new $dvt$$2$$.$Point$($DvtChartDataCursor$$, $DvtChartFunnelSlice$$), $DvtSparkChartAutomation$$), $DvtChartDataCursor$$ = new $dvt$$2$$.$Point$(($DvtChartDataChangeFunnelSlice$$.x + 
            $DvtChartOverview$$.x) / 2, ($DvtChartDataChangeFunnelSlice$$.y + $DvtChartOverview$$.y) / 2), $DvtChartFunnelSlice$$ = $DvtChartStyleUtils$$.$getMarkerSize$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$), $DvtChartDataChangeRangeMarker$$ = new $DvtChartRangeMarker$$($DvtChartAxisUtils$$, $DvtChartDataChangeFunnelSlice$$.x, $DvtChartDataChangeFunnelSlice$$.y, $DvtChartOverview$$.x, $DvtChartOverview$$.y, $DvtChartFunnelSlice$$, !$DvtChartDataChangeRangeMarker$$), 
            $DvtChartPie$$ = $DvtChartSeriesEffectUtils$$.$getMarkerFill$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$), $DvtChartTextUtils$$ = $DvtChartStyleUtils$$.$getMarkerBorderColor$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$), $DvtChartDataChangeLineArea$$ = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$), $DvtChartTextUtils$$ = new $dvt$$2$$.$SolidStroke$($DvtChartTextUtils$$, 
            null, $DvtChartDataChangeLineArea$$), $DvtChartDataChangeLineArea$$ = $DvtChartStyleUtils$$.$getMarkerColor$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$), $DvtChartPyramidSlice$$ = $DvtChartStyleUtils$$.$getSelectedInnerColor$($DvtSparkChartEventManager$$), $DvtChartDataChangeBoxAndWhisker$$ = $DvtChartStyleUtils$$.$getSelectedOuterColor$($DvtSparkChartEventManager$$);
            $DvtChartDataChangeRangeMarker$$.$setStyleProperties$($DvtChartPie$$, $DvtChartTextUtils$$, $DvtChartDataChangeLineArea$$, $DvtChartPyramidSlice$$, $DvtChartDataChangeBoxAndWhisker$$);
            $DvtChartStyleUtils$$.$isSelectable$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$) && $DvtChartDataChangeRangeMarker$$.setCursor("pointer");
            $DvtChartDataChangeFunnelSlice$$ = new $dvt$$2$$.$Line$($DvtChartAxisUtils$$, $DvtChartDataChangeFunnelSlice$$.x, $DvtChartDataChangeFunnelSlice$$.y, $DvtChartOverview$$.x, $DvtChartOverview$$.y);
            $DvtChartDataChangeFunnelSlice$$.$setSolidStroke$("rgba(0,0,0,0)", null, $DvtChartRefObjUtils$$ ? Math.max($DvtChartFunnelSlice$$, $DvtChartPlotAreaRenderer$$.$_MIN_TOUCH_MARKER_SIZE$) : $DvtChartFunnelSlice$$);
            $DvtChartDataChangeRangeMarker$$.$addChild$($DvtChartDataChangeFunnelSlice$$);
            $DvtChartPolarBar$$.push($DvtChartDataChangeRangeMarker$$);
            $DvtChartObjPeer$$.$associate$($DvtChartDataChangeRangeMarker$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeMarker$$, null, $DvtChartDataCursor$$);
          }
        }
      }
    }
  ...
  $DvtChartPlotAreaRenderer$$.$_renderBars$ = function $$DvtChartPlotAreaRenderer$$$$_renderBars$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    for (var $DvtChartRefObjUtils$$ = $DvtChartTypeUtils$$.$isHorizontal$($DvtSparkChartEventManager$$), $DvtChartAxisUtils$$ = $DvtChartTypeUtils$$.$isPolar$($DvtSparkChartEventManager$$), $DvtChartPieLabelUtils$$ = $DvtChartTypeUtils$$.$isStock$($DvtSparkChartEventManager$$), $DvtChartPieLabelInfo$$ = "pixel" == $DvtChartStyleUtils$$.$getBarSpacing$($DvtSparkChartEventManager$$), $DvtChartPieRenderUtils$$ = $dvt$$2$$.$Agent$.$isRightToLeft$($DvtSparkChartEventManager$$.$getCtx$()), $DvtChartDataChangePyramidSlice$$ = 
    $DvtChartStyleUtils$$.$isStackLabelRendered$($DvtSparkChartEventManager$$), $DvtChartRangeMarker$$ = $DvtChartTypeUtils$$.$isStacked$($DvtSparkChartEventManager$$), $DvtChartDataChangeMarker$$ = 0;$DvtChartDataChangeMarker$$ < $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartEventManager$$);$DvtChartDataChangeMarker$$++) {
      for (var $DvtChartDataCursor$$ = 0;$DvtChartDataCursor$$ < $DvtChartDataUtils$$.$getSeriesCount$($DvtSparkChartEventManager$$);$DvtChartDataCursor$$++) {
        if ($DvtChartDataUtils$$.$isBLACItemInViewport$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$) && "bar" == $DvtChartStyleUtils$$.$getSeriesType$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$)) {
          var $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.$getBarInfo$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$, $DvtSparkChartAutomation$$);
          if (null != $DvtChartDataChangeFunnelSlice$$) {
            var $DvtChartFunnelSlice$$ = $DvtChartDataChangeFunnelSlice$$.$yCoord$, $DvtChartDataChangeRangeMarker$$ = $DvtChartDataChangeFunnelSlice$$.$baseCoord$, $DvtChartPie$$ = $DvtChartDataChangeFunnelSlice$$.$axisCoord$, $DvtChartTextUtils$$ = $DvtChartDataChangeFunnelSlice$$.$x1$, $DvtChartOverview$$ = $DvtChartDataChangeFunnelSlice$$.$x2$, $DvtChartDataChangeLineArea$$ = $DvtChartDataChangeFunnelSlice$$.$barWidth$, $DvtChartPyramidSlice$$ = !1;
            if (1 > Math.abs($DvtChartFunnelSlice$$ - $DvtChartDataChangeRangeMarker$$)) {
              if ($DvtChartStyleUtils$$.$isRangeSeries$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$)) {
                $DvtChartFunnelSlice$$--;
              } else {
                if (!$DvtChartRangeMarker$$ || $DvtChartDataUtils$$.$isOutermostBar$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$)) {
                  $DvtChartPyramidSlice$$ = !0, $DvtChartFunnelSlice$$ = $DvtChartFunnelSlice$$ > $DvtChartDataChangeRangeMarker$$ || $DvtChartRefObjUtils$$ && !$DvtChartPieRenderUtils$$ && $DvtChartFunnelSlice$$ == $DvtChartDataChangeRangeMarker$$ ? $DvtChartDataChangeRangeMarker$$ + 3 : $DvtChartDataChangeRangeMarker$$ - 3;
                }
              }
            }
            $DvtChartFunnelSlice$$ = $DvtChartAxisUtils$$ ? new $DvtChartPolarBar$$($DvtSparkChartEventManager$$, $DvtChartPie$$, $DvtChartDataChangeRangeMarker$$, $DvtChartFunnelSlice$$, $DvtChartTextUtils$$, $DvtChartOverview$$, $DvtSparkChartAutomation$$) : new $DvtChartBar$$($DvtSparkChartEventManager$$, $DvtChartPie$$, $DvtChartDataChangeRangeMarker$$, $DvtChartFunnelSlice$$, $DvtChartTextUtils$$, $DvtChartOverview$$);
            $DvtSparkChartDefaults$$.$addChild$($DvtChartFunnelSlice$$);
            $DvtChartStyleUtils$$.$isSelectable$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$) && $DvtChartFunnelSlice$$.setCursor("pointer");
            $DvtChartDataChangeRangeMarker$$ = null;
            $DvtChartPyramidSlice$$ ? $DvtChartDataChangeLineArea$$ = $dvt$$2$$.$SolidFill$.$invisibleFill$() : ($DvtChartDataChangeLineArea$$ = $DvtChartSeriesEffectUtils$$.$getBarFill$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$, $DvtChartDataChangeLineArea$$), $DvtChartPyramidSlice$$ = $DvtChartStyleUtils$$.$getBorderColor$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$), $DvtChartPie$$ = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$, 
            $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$), $DvtChartPyramidSlice$$ && ($DvtChartDataChangeRangeMarker$$ = new $dvt$$2$$.$SolidStroke$($DvtChartPyramidSlice$$, null, $DvtChartPie$$)));
            $DvtChartPyramidSlice$$ = $DvtChartStyleUtils$$.$getColor$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$);
            $DvtChartPie$$ = $DvtChartStyleUtils$$.$getSelectedInnerColor$($DvtSparkChartEventManager$$);
            $DvtChartTextUtils$$ = $DvtChartStyleUtils$$.$getSelectedOuterColor$($DvtSparkChartEventManager$$);
            $DvtChartFunnelSlice$$.$setStyleProperties$($DvtChartDataChangeLineArea$$, $DvtChartDataChangeRangeMarker$$, $DvtChartPyramidSlice$$, $DvtChartPie$$, $DvtChartTextUtils$$);
            $DvtChartFunnelSlice$$.$setClassName$($DvtChartStyleUtils$$.$getClassName$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$));
            $DvtChartFunnelSlice$$.$setStyle$($DvtChartStyleUtils$$.$getStyle$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$));
            $DvtChartPieLabelInfo$$ && $DvtChartFunnelSlice$$.$setPixelHinting$();
            $DvtChartObjPeer$$.$associate$($DvtChartFunnelSlice$$, $DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$, null, $DvtChartDataChangeFunnelSlice$$.$dataPos$);
            $DvtChartStyleUtils$$.$isRangeSeries$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$) ? ($DvtChartPlotAreaRenderer$$.$_renderDataLabel$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartFunnelSlice$$.$getBoundingBox$(), $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$, null, $DvtChartPyramidSlice$$, "low"), $DvtChartPlotAreaRenderer$$.$_renderDataLabel$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartFunnelSlice$$.$getBoundingBox$(), $DvtChartDataCursor$$, 
            $DvtChartDataChangeMarker$$, null, $DvtChartPyramidSlice$$, "high")) : $DvtChartPlotAreaRenderer$$.$_renderDataLabel$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartFunnelSlice$$.$getBoundingBox$(), $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$, null, $DvtChartPyramidSlice$$);
            $DvtChartDataChangeFunnelSlice$$ = [];
            $DvtChartDataChangeFunnelSlice$$.push($DvtChartFunnelSlice$$);
            $DvtChartPieLabelUtils$$ && 0 != $DvtChartDataCursor$$ || $DvtSparkChartEventManager$$.$_currentMarkers$.push($DvtChartDataChangeFunnelSlice$$);
            $DvtChartDataChangePyramidSlice$$ && $DvtChartDataUtils$$.$isOutermostBar$($DvtSparkChartEventManager$$, $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$) && $DvtChartPlotAreaRenderer$$.$_renderDataLabel$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartFunnelSlice$$.$getBoundingBox$(), $DvtChartDataCursor$$, $DvtChartDataChangeMarker$$, null, null, null, !0);
          }
        }
      }
    }
    ...
    if ("candlestick" == $DvtChartStyleUtils$$.$getSeriesType$($DvtSparkChartEventManager$$, 0)) {
      for (var $DvtChartPieLabelUtils$$ = 0;$DvtChartPieLabelUtils$$ < $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartEventManager$$);$DvtChartPieLabelUtils$$++) {
        if ($DvtChartDataUtils$$.$isBLACItemInViewport$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$)) {
          var $DvtChartPieLabelInfo$$ = $DvtChartDataUtils$$.$getXValue$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$), $DvtChartPieRenderUtils$$ = $DvtChartDataUtils$$.$getDataItem$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$), $DvtChartDataChangePyramidSlice$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, $DvtChartDataChangeMarker$$ = null;
          $DvtChartPieRenderUtils$$ && ($DvtChartDataChangePyramidSlice$$ = $DvtChartPieRenderUtils$$.open, $DvtChartRangeMarker$$ = $DvtChartPieRenderUtils$$.close, $DvtChartPolarBar$$ = $DvtChartPieRenderUtils$$.low, $DvtChartDataChangeMarker$$ = $DvtChartPieRenderUtils$$.high);
          var $DvtChartDataCursor$$ = null != $DvtChartPolarBar$$ && null != $DvtChartDataChangeMarker$$;
          if (null != $DvtChartDataChangePyramidSlice$$ && null != $DvtChartRangeMarker$$) {
            var $DvtChartPieLabelInfo$$ = $DvtChartRefObjUtils$$.$getUnboundedCoordAt$($DvtChartPieLabelInfo$$), $DvtChartDataChangeFunnelSlice$$ = $DvtChartStyleUtils$$.$getBarWidth$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$), $DvtChartPieRenderUtils$$ = $DvtChartAxisUtils$$.$getBoundedCoordAt$($DvtChartDataChangePyramidSlice$$), $DvtChartFunnelSlice$$ = $DvtChartAxisUtils$$.$getBoundedCoordAt$($DvtChartRangeMarker$$), $DvtChartDataChangeRangeMarker$$, $DvtChartPie$$ = null;
            $DvtChartDataCursor$$ && ($DvtChartDataChangeRangeMarker$$ = $DvtChartAxisUtils$$.$getBoundedCoordAt$($DvtChartPolarBar$$), $DvtChartPie$$ = $DvtChartAxisUtils$$.$getBoundedCoordAt$($DvtChartDataChangeMarker$$));
            $DvtChartDataChangeMarker$$ = new $DvtChartCandlestick$$($DvtSparkChartEventManager$$.$getCtx$(), $DvtChartPieLabelInfo$$, $DvtChartDataChangeFunnelSlice$$, $DvtChartPieRenderUtils$$, $DvtChartFunnelSlice$$, $DvtChartDataChangeRangeMarker$$, $DvtChartPie$$);
            $DvtSparkChartDefaults$$.$addChild$($DvtChartDataChangeMarker$$);
            $DvtChartStyleUtils$$.$isSelectable$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$) && $DvtChartDataChangeMarker$$.setCursor("pointer");
            var $DvtChartDataCursor$$ = $DvtChartSeriesEffectUtils$$.$getBarFill$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$, $DvtChartDataChangeFunnelSlice$$), $DvtChartDataChangeFunnelSlice$$ = null, $DvtChartPie$$ = $DvtChartStyleUtils$$.$getBorderColor$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$), $DvtChartTextUtils$$ = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$);
            $DvtChartPie$$ ? $DvtChartDataChangeFunnelSlice$$ = new $dvt$$2$$.$SolidStroke$($DvtChartPie$$, null, $DvtChartTextUtils$$) : $DvtChartDataCursor$$ instanceof $dvt$$2$$.$PatternFill$ && ($DvtChartDataChangeFunnelSlice$$ = new $dvt$$2$$.$SolidStroke$($DvtChartDataCursor$$.$getColor$(), null, $DvtChartTextUtils$$));
            var $DvtChartPie$$ = $DvtChartStyleUtils$$.$getColor$($DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$), $DvtChartTextUtils$$ = $DvtChartStyleUtils$$.$getSelectedInnerColor$($DvtSparkChartEventManager$$), $DvtChartOverview$$ = $DvtChartStyleUtils$$.$getSelectedOuterColor$($DvtSparkChartEventManager$$), $DvtChartDataChangeLineArea$$ = $DvtSparkChartAutomation$$.styleDefaults.stockRangeColor;
            $DvtChartDataChangeMarker$$.$setChangeStyle$($DvtChartDataCursor$$, $DvtChartDataChangeFunnelSlice$$, $DvtChartPie$$, $DvtChartTextUtils$$, $DvtChartOverview$$);
            $DvtChartDataChangeMarker$$.$setRangeStyle$(new $dvt$$2$$.$SolidFill$($DvtChartDataChangeLineArea$$), $DvtChartDataChangeFunnelSlice$$, $DvtChartDataChangeLineArea$$, $DvtChartOverview$$);
            $DvtChartPieLabelInfo$$ = new $dvt$$2$$.$Point$($DvtChartPieLabelInfo$$, ($DvtChartPieRenderUtils$$ + $DvtChartFunnelSlice$$) / 2);
            $DvtChartObjPeer$$.$associate$($DvtChartDataChangeMarker$$, $DvtSparkChartEventManager$$, 0, $DvtChartPieLabelUtils$$, null, $DvtChartPieLabelInfo$$);
            $DvtChartPieLabelInfo$$ = [];
            $DvtChartPieLabelInfo$$.push($DvtChartDataChangeMarker$$.$_changeShape$);
    ...
    for (var $DvtChartRefObjUtils$$ = $DvtSparkChartEventManager$$.$xAxis$, $DvtChartAxisUtils$$ = 0;$DvtChartAxisUtils$$ < $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartEventManager$$);$DvtChartAxisUtils$$++) {
      for (var $DvtChartPieLabelUtils$$ = 0;$DvtChartPieLabelUtils$$ < $DvtChartDataUtils$$.$getSeriesCount$($DvtSparkChartEventManager$$);$DvtChartPieLabelUtils$$++) {
        if ($DvtChartDataUtils$$.$isBLACItemInViewport$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$) && "boxPlot" == $DvtChartStyleUtils$$.$getSeriesType$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$)) {
          var $DvtChartPieLabelInfo$$ = $DvtChartDataUtils$$.$getXValue$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$), $DvtChartPieRenderUtils$$ = $DvtChartDataUtils$$.$getDataItem$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$), $DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, $DvtChartPolarBar$$, $DvtChartDataChangeMarker$$ = null;
          $DvtChartPieRenderUtils$$ && ($DvtChartDataChangePyramidSlice$$ = $DvtChartPieRenderUtils$$.low, $DvtChartSeriesEffectUtils$$ = $DvtChartPieRenderUtils$$.q1, $DvtChartRangeMarker$$ = $DvtChartPieRenderUtils$$.q2, $DvtChartPolarBar$$ = $DvtChartPieRenderUtils$$.q3, $DvtChartDataChangeMarker$$ = $DvtChartPieRenderUtils$$.high);
          if (null != $DvtChartDataChangePyramidSlice$$ && null != $DvtChartSeriesEffectUtils$$ && null != $DvtChartRangeMarker$$ && null != $DvtChartPolarBar$$ && null != $DvtChartDataChangeMarker$$) {
            var $DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$getBarWidth$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$), $DvtChartDataCursor$$ = $DvtChartStyleUtils$$.$getBarCategoryOffsetMap$($DvtSparkChartEventManager$$, $DvtChartAxisUtils$$, !1), $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataUtils$$.$isAssignedToY2$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$), $DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$getStackCategory$($DvtSparkChartEventManager$$, 
            $DvtChartPieLabelUtils$$), $DvtChartDataCursor$$ = $DvtChartDataCursor$$[$DvtChartDataChangeFunnelSlice$$ ? "y2" : "y"][$DvtChartFunnelSlice$$] + $DvtChartPieRenderUtils$$ / 2;
            ...
            var $DvtChartPieLabelInfo$$ = $DvtChartRefObjUtils$$.$getUnboundedCoordAt$($DvtChartPieLabelInfo$$) + $DvtChartDataCursor$$, $DvtChartDataChangeRangeMarker$$ = $DvtChartDataChangeFunnelSlice$$ ? $DvtSparkChartEventManager$$.$y2Axis$ : $DvtSparkChartEventManager$$.$yAxis$;
            lowCoord = $DvtChartDataChangeRangeMarker$$.$getBoundedCoordAt$($DvtChartDataChangePyramidSlice$$);
            $DvtChartDataCursor$$ = $DvtChartDataChangeRangeMarker$$.$getBoundedCoordAt$($DvtChartSeriesEffectUtils$$);
            $DvtChartDataChangeFunnelSlice$$ = $DvtChartDataChangeRangeMarker$$.$getBoundedCoordAt$($DvtChartRangeMarker$$);
            $DvtChartFunnelSlice$$ = $DvtChartDataChangeRangeMarker$$.$getBoundedCoordAt$($DvtChartPolarBar$$);
            highCoord = $DvtChartDataChangeRangeMarker$$.$getBoundedCoordAt$($DvtChartDataChangeMarker$$);
            $DvtChartDataChangeMarker$$ = $DvtChartStyleUtils$$.$getBoxPlotStyleOptions$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$);
            $DvtChartDataChangeMarker$$ = new $DvtChartBoxAndWhisker$$($DvtSparkChartEventManager$$, $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$, lowCoord, $DvtChartDataCursor$$, $DvtChartDataChangeFunnelSlice$$, $DvtChartFunnelSlice$$, highCoord, $DvtChartDataChangeMarker$$);
            $DvtSparkChartDefaults$$.$addChild$($DvtChartDataChangeMarker$$);
            $DvtChartStyleUtils$$.$isSelectable$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$) && $DvtChartDataChangeMarker$$.setCursor("pointer");
            $DvtChartPieRenderUtils$$ = $DvtChartPlotAreaRenderer$$.$convertAxisCoord$($DvtSparkChartEventManager$$, new $dvt$$2$$.$Point$($DvtChartPieLabelInfo$$, $DvtChartDataChangeFunnelSlice$$), $DvtSparkChartAutomation$$);
            $DvtChartObjPeer$$.$associate$($DvtChartDataChangeMarker$$, $DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartAxisUtils$$, null, $DvtChartPieRenderUtils$$);
            ...
            $DvtSparkChartEventManager$$.$_currentMarkers$.push([$DvtChartDataChangeMarker$$.$_medianLine$]);
          }
        }
      }
    }
  ...
  $DvtChartPlotAreaRenderer$$.$_renderBoxPlotMarkers$ = function $$DvtChartPlotAreaRenderer$$$$_renderBoxPlotMarkers$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$) {
    for (var $DvtChartPieLabelInfo$$ = $DvtChartStyleUtils$$.$getMarkerBorderColor$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$), $DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$), $DvtChartDataChangePyramidSlice$$ = new $dvt$$2$$.$SolidStroke$($DvtChartPieLabelInfo$$, null, $DvtChartPieRenderUtils$$), $DvtChartSeriesEffectUtils$$ = [], $DvtChartRangeMarker$$ = $DvtChartDataUtils$$.$getNestedDataItemCount$($DvtSparkChartEventManager$$, 
    $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$), $DvtChartPolarBar$$ = 0;$DvtChartPolarBar$$ < $DvtChartRangeMarker$$;$DvtChartPolarBar$$++) {
      var $DvtChartDataChangeMarker$$ = $DvtChartPlotAreaRenderer$$.$_getMarkerInfo$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartPolarBar$$, $DvtChartAxisUtils$$);
      $DvtChartDataChangeMarker$$ && ($DvtChartTypeUtils$$.$isHorizontal$($DvtSparkChartEventManager$$) ? $DvtChartDataChangeMarker$$.y = $DvtChartPieLabelUtils$$ : $DvtChartDataChangeMarker$$.x = $DvtChartPieLabelUtils$$, $DvtChartDataChangeMarker$$ = $DvtChartPlotAreaRenderer$$.$_createMarker$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$, $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$), null != $DvtChartDataChangeMarker$$ && $DvtChartSeriesEffectUtils$$.push($DvtChartDataChangeMarker$$));
    }
    $DvtChartPlotAreaRenderer$$.$_addMarkersToContainer$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartSeriesEffectUtils$$, $DvtChartDataChangePyramidSlice$$);
  };
  ...
  $DvtChartPlotAreaRenderer$$.$_renderAreas$ = function $$DvtChartPlotAreaRenderer$$$$_renderAreas$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    for (var $DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getSeriesCount$($dvt$$2$$), $DvtChartAxisUtils$$ = $DvtSparkChartAutomation$$ ? "lineWithArea" : "area", $DvtChartPieLabelUtils$$ = [], $DvtChartPieLabelInfo$$ = [], $DvtChartPieRenderUtils$$ = 0;$DvtChartPieRenderUtils$$ < $DvtChartRefObjUtils$$;$DvtChartPieRenderUtils$$++) {
      $DvtChartStyleUtils$$.$isSeriesRendered$($dvt$$2$$, $DvtChartPieRenderUtils$$) && $DvtChartStyleUtils$$.$getSeriesType$($dvt$$2$$, $DvtChartPieRenderUtils$$) == $DvtChartAxisUtils$$ && ($DvtChartDataUtils$$.$isAssignedToY2$($dvt$$2$$, $DvtChartPieRenderUtils$$) ? $DvtChartPieLabelInfo$$.push($DvtChartPieRenderUtils$$) : $DvtChartPieLabelUtils$$.push($DvtChartPieRenderUtils$$));
    }
  ...
  $DvtChartPlotAreaRenderer$$.$_renderAreasForAxis$ = function $$DvtChartPlotAreaRenderer$$$$_renderAreasForAxis$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$) {
    for (var $DvtChartPieLabelInfo$$ = $DvtChartTypeUtils$$.$isStacked$($DvtSparkChartEventManager$$), $DvtChartPieRenderUtils$$ = $DvtChartTypeUtils$$.$isPolar$($DvtSparkChartEventManager$$), $DvtChartDataChangePyramidSlice$$ = $DvtChartPlotAreaRenderer$$.$createClippedGroup$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartAxisUtils$$), $DvtChartRangeMarker$$ = {}, $DvtChartPolarBar$$ = {}, $DvtChartDataChangeMarker$$ = {}, $DvtChartDataCursor$$ = {}, $DvtChartDataChangeFunnelSlice$$ = 
    [], $DvtChartFunnelSlice$$ = $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartEventManager$$), $DvtChartDataChangeRangeMarker$$ = 0;$DvtChartDataChangeRangeMarker$$ < $DvtChartFunnelSlice$$;$DvtChartDataChangeRangeMarker$$++) {
      $DvtChartDataChangeFunnelSlice$$.push(new $DvtChartCoord$$(null, $DvtChartRefObjUtils$$, $DvtChartRefObjUtils$$, $DvtChartDataChangeRangeMarker$$, $DvtChartDataUtils$$.$getGroup$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$), !0));
    }
    for ($DvtChartFunnelSlice$$ = 0;$DvtChartFunnelSlice$$ < $DvtSparkChartAutomation$$.length;$DvtChartFunnelSlice$$++) {
      var $DvtChartDataChangeRangeMarker$$ = $DvtSparkChartAutomation$$[$DvtChartFunnelSlice$$], $DvtChartPie$$ = $DvtChartDataUtils$$.$getStackCategory$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$), $DvtChartTextUtils$$ = $DvtChartDataUtils$$.$isSeriesNegative$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$), $DvtChartOverview$$ = $DvtChartRangeMarker$$[$DvtChartPie$$], $DvtChartDataChangeLineArea$$ = $DvtChartPolarBar$$[$DvtChartPie$$], $DvtChartPyramidSlice$$ = 
      $DvtChartDataChangeMarker$$[$DvtChartPie$$], $DvtChartDataChangeBoxAndWhisker$$ = $DvtChartDataCursor$$[$DvtChartPie$$];
      if ("none" == $DvtChartStyleUtils$$.$getLineType$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$)) {
        $DvtChartPlotAreaRenderer$$.$_renderMarkersForSeries$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeRangeMarker$$, $DvtChartAxisUtils$$);
      } else {
        var $DvtChartLineMarker$$ = $DvtChartSeriesEffectUtils$$.$getAreaFill$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$), $DvtChartTooltipUtils$$ = $DvtChartStyleUtils$$.$getBorderColor$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$), $DvtChartDataChangeBar$$ = $DvtChartStyleUtils$$.$getBorderWidth$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$), $DvtChartAnimOnDisplay$$ = $DvtChartStyleUtils$$.$getAreaClassName$($DvtSparkChartEventManager$$, 
        $DvtChartDataChangeRangeMarker$$), $DvtChartDataChangeAbstract$$ = $DvtChartStyleUtils$$.$getAreaStyle$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$), $DvtChartDataChange$$ = $DvtChartTooltipUtils$$ ? new $dvt$$2$$.$SolidStroke$($DvtChartTooltipUtils$$, null, $DvtChartDataChangeBar$$) : null, $DvtChartDataChangeBar$$ = $DvtChartStyleUtils$$.$getLineType$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$);
        $DvtChartPieRenderUtils$$ || $DvtChartPlotAreaRenderer$$.$_filterPointsForSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$);
        var $DvtChartCandlestick$$;
        $DvtChartStyleUtils$$.$isRangeSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$) ? ($DvtChartCandlestick$$ = $DvtChartPlotAreaRenderer$$.$_getCoordsForSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$, "high"), $DvtChartOverview$$ = $DvtChartPlotAreaRenderer$$.$_getCoordsForSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$, "low"), $DvtChartDataChangeLineArea$$ = $DvtChartDataChangeBar$$) : $DvtChartTextUtils$$ ? ($DvtChartCandlestick$$ = 
        $DvtChartPlotAreaRenderer$$.$_getAreaCoordsForSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$, $DvtChartPyramidSlice$$ ? $DvtChartPyramidSlice$$ : $DvtChartDataChangeFunnelSlice$$), $DvtChartOverview$$ = $DvtChartPyramidSlice$$ ? $DvtChartPyramidSlice$$ : [], $DvtChartDataChangeLineArea$$ = $DvtChartDataChangeBoxAndWhisker$$) : ($DvtChartCandlestick$$ = $DvtChartPlotAreaRenderer$$.$_getAreaCoordsForSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$, 
        $DvtChartOverview$$ ? $DvtChartOverview$$ : $DvtChartDataChangeFunnelSlice$$), $DvtChartOverview$$ = $DvtChartOverview$$ ? $DvtChartOverview$$ : []);
        $DvtChartLineMarker$$ = new $DvtChartLineArea$$($DvtSparkChartEventManager$$, !0, $DvtChartAxisUtils$$, $DvtChartRefObjUtils$$, $DvtChartDataChangeAbstract$$, $DvtChartAnimOnDisplay$$, $DvtChartLineMarker$$, $DvtChartDataChange$$, $DvtChartDataChangeBar$$, $DvtChartCandlestick$$, $DvtChartDataChangeLineArea$$, $DvtChartOverview$$);
        $DvtChartDataChangePyramidSlice$$.$addChild$($DvtChartLineMarker$$);
        $DvtSparkChartEventManager$$.$_currentAreas$.push($DvtChartLineMarker$$);
        $DvtChartObjPeer$$.$associate$($DvtChartLineMarker$$, $DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$);
        $DvtChartTextUtils$$ ? ($DvtChartDataChangeMarker$$[$DvtChartPie$$] = $DvtChartCandlestick$$, $DvtChartDataCursor$$[$DvtChartPie$$] = $DvtChartDataChangeBar$$) : ($DvtChartRangeMarker$$[$DvtChartPie$$] = $DvtChartCandlestick$$, $DvtChartPolarBar$$[$DvtChartPie$$] = $DvtChartDataChangeBar$$);
        $DvtChartPieLabelInfo$$ || (($DvtChartPieLabelUtils$$ || 0 < $DvtChartStyleUtils$$.$getDataItemGaps$($DvtSparkChartEventManager$$) && !$DvtChartTooltipUtils$$) && $DvtChartPlotAreaRenderer$$.$_renderLinesForSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartDataChangeRangeMarker$$, $DvtChartAxisUtils$$, !$DvtChartPieLabelUtils$$), $DvtChartPieLabelUtils$$ || $DvtChartPlotAreaRenderer$$.$_renderMarkersForSeries$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, 
        $DvtChartDataChangeRangeMarker$$, $DvtChartAxisUtils$$), $DvtChartFunnelSlice$$ + 1 < $DvtSparkChartAutomation$$.length && ($DvtChartDataChangePyramidSlice$$ = $DvtChartPlotAreaRenderer$$.$createClippedGroup$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartAxisUtils$$)));
      }
    }
    for ($DvtChartFunnelSlice$$ = 0;$DvtChartFunnelSlice$$ < $DvtSparkChartAutomation$$.length;$DvtChartFunnelSlice$$++) {
      $DvtChartDataChangeRangeMarker$$ = $DvtSparkChartAutomation$$[$DvtChartFunnelSlice$$], "none" != $DvtChartStyleUtils$$.$getLineType$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$) && ($DvtChartRefObjUtils$$ = $DvtChartStyleUtils$$.$getBorderColor$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$) || $DvtChartStyleUtils$$.$getBorderColor$($DvtSparkChartEventManager$$, $DvtChartDataChangeRangeMarker$$ + 1), $DvtChartPieLabelInfo$$ && ($DvtChartPieLabelUtils$$ || 
      0 < $DvtChartStyleUtils$$.$getDataItemGaps$($DvtSparkChartEventManager$$) && !$DvtChartRefObjUtils$$) && $DvtChartPlotAreaRenderer$$.$_renderLinesForSeries$($DvtSparkChartEventManager$$, $DvtChartDataChangePyramidSlice$$, $DvtChartDataChangeRangeMarker$$, $DvtChartAxisUtils$$, !$DvtChartPieLabelUtils$$), ($DvtChartPieLabelInfo$$ || $DvtChartPieLabelUtils$$) && $DvtChartPlotAreaRenderer$$.$_renderMarkersForSeries$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtChartDataChangeRangeMarker$$, 
      $DvtChartAxisUtils$$));
    }
  };
  ...
  $DvtChartPlotAreaRenderer$$.$_renderLinesForSeries$ = function $$DvtChartPlotAreaRenderer$$$$_renderLinesForSeries$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) {
    function $DvtChartPieLabelUtils$$($dvt$$2$$) {
      ...
      $dvt$$2$$ = new $DvtChartLineArea$$($DvtSparkChartEventManager$$, !1, $DvtChartRefObjUtils$$, $DvtChartSeriesEffectUtils$$, $DvtChartDataChangeMarker$$, $DvtChartPolarBar$$, null, $DvtChartPieLabelInfo$$, $DvtChartRangeMarker$$, $dvt$$2$$);
    ...
    if ($DvtChartAxisUtils$$) {
      ...
      var $DvtChartPieRenderUtils$$ = $DvtChartStyleUtils$$.$getLineWidth$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$), $DvtChartDataChangePyramidSlice$$ = $dvt$$2$$.$Stroke$.$convertTypeString$($DvtChartStyleUtils$$.$getLineStyle$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$));
      $DvtChartPieLabelInfo$$ = new $dvt$$2$$.$SolidStroke$($DvtChartAxisUtils$$, 1, $DvtChartPieRenderUtils$$);
      $DvtChartPieLabelInfo$$.$setStyle$($DvtChartDataChangePyramidSlice$$);
    }
    var $DvtChartSeriesEffectUtils$$ = $DvtChartDataUtils$$.$isAssignedToY2$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$) ? $DvtSparkChartEventManager$$.$y2Axis$.$getBaselineCoord$() : $DvtSparkChartEventManager$$.$yAxis$.$getBaselineCoord$(), $DvtChartRangeMarker$$ = $DvtChartStyleUtils$$.$getLineType$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$), $DvtChartPolarBar$$ = $DvtChartStyleUtils$$.$getClassName$($DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$), $DvtChartDataChangeMarker$$ = 
  ...
  $DvtChartPlotAreaRenderer$$.$_filterScatterBubble$ = function $$DvtChartPlotAreaRenderer$$$$_filterScatterBubble$$($DvtSparkChartEventManager$$) {
    ...
    for (var $DvtSparkChartDefaults$$ = new $dvt$$2$$.$PixelMap$(25, new $dvt$$2$$.$PixelMap$(5, new $dvt$$2$$.$PixelMap$)), $DvtSparkChartAutomation$$ = [], $DvtChartPieRenderUtils$$ = $DvtChartAxisUtils$$.length - 1;0 <= $DvtChartPieRenderUtils$$;$DvtChartPieRenderUtils$$--) {
      if ($DvtChartRefObjUtils$$ = $DvtChartAxisUtils$$[$DvtChartPieRenderUtils$$], !$DvtChartMarkerUtils$$.$checkPixelMap$($DvtSparkChartDefaults$$, $DvtChartRefObjUtils$$.x, $DvtChartRefObjUtils$$.y, $DvtChartRefObjUtils$$.size)) {
        var $DvtChartDataChangePyramidSlice$$ = $DvtChartStyleUtils$$.$getColor$($DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$.$seriesIndex$, $DvtChartRefObjUtils$$.$groupIndex$), $DvtChartDataChangePyramidSlice$$ = $DvtChartStyleUtils$$.$isMarkerDisplayed$($DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$) ? $dvt$$2$$.$ColorUtils$.$getAlpha$($DvtChartDataChangePyramidSlice$$) : 0;
        0 < $DvtChartDataChangePyramidSlice$$ && ($DvtChartMarkerUtils$$.$updatePixelMap$($DvtSparkChartDefaults$$, $DvtChartRefObjUtils$$.x, $DvtChartRefObjUtils$$.y, $DvtChartRefObjUtils$$.size, $DvtChartDataChangePyramidSlice$$), $DvtSparkChartAutomation$$.push($DvtChartRefObjUtils$$));
      }
    }
  ...
  $DvtChartPlotAreaRenderer$$.$_filterPointsForSeries$ = function $$DvtChartPlotAreaRenderer$$$$_filterPointsForSeries$$($dvt$$2$$, $DvtSparkChartEventManager$$) {
    ...
    if (2 >= $DvtSparkChartDefaults$$) {
      for ($DvtChartRefObjUtils$$ = 0;$DvtChartRefObjUtils$$ < $DvtSparkChartAutomation$$.length;$DvtChartRefObjUtils$$++) {
        ($DvtChartDataChangePyramidSlice$$ = $DvtSparkChartAutomation$$[$DvtChartRefObjUtils$$]) && ($DvtChartDataChangePyramidSlice$$._filtered = !1);
      }
    } else {
      for (var $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, $DvtChartPieRenderUtils$$, $DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$ = !1, $DvtChartRefObjUtils$$ = 0;$DvtChartRefObjUtils$$ < $DvtSparkChartAutomation$$.length;$DvtChartRefObjUtils$$ += $DvtSparkChartDefaults$$) {
        $DvtChartAxisUtils$$ = -1;
        ...
        for (var $DvtChartStyleUtils$$ = $DvtChartRefObjUtils$$;$DvtChartStyleUtils$$ < Math.min($DvtChartRefObjUtils$$ + $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$.length);$DvtChartStyleUtils$$++) {
          $DvtChartSeriesEffectUtils$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtChartStyleUtils$$), $DvtChartDataChangePyramidSlice$$ = $DvtSparkChartAutomation$$[$DvtChartStyleUtils$$], null != $DvtChartSeriesEffectUtils$$ && null != $DvtChartDataChangePyramidSlice$$ && ($DvtChartSeriesEffectUtils$$ > $DvtChartPieLabelUtils$$ && ($DvtChartAxisUtils$$ = $DvtChartStyleUtils$$, $DvtChartPieLabelUtils$$ = $DvtChartSeriesEffectUtils$$), $DvtChartSeriesEffectUtils$$ < 
          $DvtChartPieRenderUtils$$ && ($DvtChartPieLabelInfo$$ = $DvtChartStyleUtils$$, $DvtChartPieRenderUtils$$ = $DvtChartSeriesEffectUtils$$), $DvtChartRangeMarker$$ = $DvtChartDataChangePyramidSlice$$._filtered = !0);
        }
        for ($DvtChartStyleUtils$$ = $DvtChartRefObjUtils$$;$DvtChartStyleUtils$$ < Math.min($DvtChartRefObjUtils$$ + $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$.length);$DvtChartStyleUtils$$++) {
          $DvtChartDataChangePyramidSlice$$ = $DvtSparkChartAutomation$$[$DvtChartStyleUtils$$], null == $DvtChartDataChangePyramidSlice$$ || $DvtChartStyleUtils$$ != $DvtChartAxisUtils$$ && $DvtChartStyleUtils$$ != $DvtChartPieLabelInfo$$ || ($DvtChartDataChangePyramidSlice$$._filtered = !1);
        }
      }
  ...
  $DvtChartPlotAreaRenderer$$.$_getCoordsForSeries$ = function $$DvtChartPlotAreaRenderer$$$$_getCoordsForSeries$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    for (var $DvtChartAxisUtils$$ = [], $DvtChartPieLabelUtils$$ = 0;$DvtChartPieLabelUtils$$ < $DvtChartDataUtils$$.$getGroupCount$($dvt$$2$$);$DvtChartPieLabelUtils$$++) {
      var $DvtChartPieLabelInfo$$ = $DvtChartDataUtils$$.$getGroup$($dvt$$2$$, $DvtChartPieLabelUtils$$), $DvtChartPieRenderUtils$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$), $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.$getXValue$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$), $DvtChartSeriesEffectUtils$$ = null;
      ...
      $DvtChartPieLabelUtils$$));
      null == $DvtChartSeriesEffectUtils$$ || isNaN($DvtChartSeriesEffectUtils$$) || !$DvtChartDataUtils$$.$isBLACItemInViewport$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtChartPieLabelUtils$$) ? $DvtChartAxisUtils$$.push(new $DvtChartCoord$$(null, null, null, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, !1)) : ($DvtChartTypeUtils$$.$isPolar$($dvt$$2$$) && ($DvtChartSeriesEffectUtils$$ = Math.max($DvtChartSeriesEffectUtils$$, $DvtChartRefObjUtils$$.$getInfo$().$MinValue$)), $DvtChartPieRenderUtils$$ = 
      $DvtSparkChartAutomation$$.$getUnboundedCoordAt$($DvtChartDataChangePyramidSlice$$), $DvtChartSeriesEffectUtils$$ = $DvtChartRefObjUtils$$.$getUnboundedCoordAt$($DvtChartSeriesEffectUtils$$), null == $DvtChartPieRenderUtils$$ || null == $DvtChartSeriesEffectUtils$$ ? $DvtChartAxisUtils$$.push(new $DvtChartCoord$$(null, null, null, $DvtChartPieLabelUtils$$, $DvtChartPieLabelInfo$$, !1)) : ($DvtChartPieLabelInfo$$ = new $DvtChartCoord$$($DvtChartPieRenderUtils$$, $DvtChartSeriesEffectUtils$$, 
  ...
  $DvtChartFunnelRenderer$$.$_renderFunnelSlices$ = function $$DvtChartFunnelRenderer$$$$_renderFunnelSlices$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    ...
    $DvtSparkChartDefaults$$.$w$), $DvtChartAxisUtils$$ = 0, $DvtChartPieLabelUtils$$ = 0, $DvtChartPieLabelInfo$$ = 0, $DvtChartPieRenderUtils$$ = 0;$DvtChartPieRenderUtils$$ < $DvtChartRefObjUtils$$;$DvtChartPieRenderUtils$$++) {
      if ($DvtChartStyleUtils$$.$isDataItemRendered$($dvt$$2$$, $DvtChartPieRenderUtils$$)) {
        var $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.$getTargetValue$($dvt$$2$$, $DvtChartPieRenderUtils$$);
        null == $DvtChartDataChangePyramidSlice$$ && ($DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartFunnelRenderer$$.$_GROUP_INDEX$));
        0 >= $DvtChartDataChangePyramidSlice$$ || ($DvtChartAxisUtils$$ += $DvtChartDataChangePyramidSlice$$);
      }
    }
    if (0 == $DvtChartAxisUtils$$) {
      return !1;
    }
    for ($DvtChartPieRenderUtils$$ = $DvtChartRefObjUtils$$ - 1;0 <= $DvtChartPieRenderUtils$$;$DvtChartPieRenderUtils$$--) {
      $DvtChartStyleUtils$$.$isDataItemRendered$($dvt$$2$$, $DvtChartPieRenderUtils$$) && ($DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartFunnelRenderer$$.$_GROUP_INDEX$), $DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getTargetValue$($dvt$$2$$, $DvtChartPieRenderUtils$$), 0 >= $DvtChartDataChangePyramidSlice$$ && null == $DvtChartRefObjUtils$$ || null != $DvtChartRefObjUtils$$ && 0 >= $DvtChartRefObjUtils$$ || (null != $DvtChartRefObjUtils$$ ? 
      ($DvtChartPieLabelInfo$$ += $DvtChartRefObjUtils$$ / $DvtChartAxisUtils$$, $DvtChartRefObjUtils$$ = new $DvtChartFunnelSlice$$($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$.$w$, $DvtSparkChartDefaults$$.$h$, 1 - $DvtChartPieLabelInfo$$, $DvtChartRefObjUtils$$ / $DvtChartAxisUtils$$, $DvtChartDataChangePyramidSlice$$ / $DvtChartRefObjUtils$$, $DvtSparkChartAutomation$$)) : ($DvtChartPieLabelInfo$$ += $DvtChartDataChangePyramidSlice$$ / $DvtChartAxisUtils$$, 
      $DvtChartRefObjUtils$$ = new $DvtChartFunnelSlice$$($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$.$w$, $DvtSparkChartDefaults$$.$h$, 1 - $DvtChartPieLabelInfo$$, $DvtChartDataChangePyramidSlice$$ / $DvtChartAxisUtils$$, null, $DvtSparkChartAutomation$$)), $DvtChartPieLabelUtils$$++, $DvtSparkChartEventManager$$.$addChild$($DvtChartRefObjUtils$$), $DvtChartObjPeer$$.$associate$($DvtChartRefObjUtils$$, $dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartFunnelRenderer$$.$_GROUP_INDEX$)))
      ;
    }
    return !0;
  };
  ...
  $DvtChartPyramidRenderer$$.$_DEFAULT_3D_GAP_RATIO$ = 1 / 36;
  $DvtChartPyramidRenderer$$.$_DEFAULT_2D_GAP_RATIO$ = 1 / 70;
  $DvtChartPyramidRenderer$$.$_MAX_WIDTH_FOR_GAPS$ = .25;
  ...
  $DvtChartPyramidRenderer$$.$render$ = function $$DvtChartPyramidRenderer$$$$render$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$) {
    ...
    $DvtSparkChartDefaults$$.$addChild$($DvtChartRefObjUtils$$);
    $DvtSparkChartEventManager$$.$setPlotArea$($DvtChartRefObjUtils$$);
    var $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$ = new $dvt$$2$$.$Matrix$;
    $DvtChartAxisUtils$$ = $dvt$$2$$.$Agent$.$isRightToLeft$($DvtSparkChartEventManager$$.$getCtx$()) ? -1 : 1;
    $DvtChartPieLabelUtils$$.translate(-$DvtSparkChartAutomation$$.$h$ / 2, -$DvtSparkChartAutomation$$.$w$ / 2);
    $DvtChartPieLabelUtils$$.rotate($DvtChartAxisUtils$$ * Math.PI / 2);
    $DvtChartPieLabelUtils$$.translate($DvtSparkChartAutomation$$.x + $DvtSparkChartAutomation$$.$w$ / 2, $DvtSparkChartAutomation$$.y + $DvtSparkChartAutomation$$.$h$ / 2);
    $DvtChartAxisUtils$$ = new $dvt$$2$$.$Rectangle$(0, 0, $DvtSparkChartAutomation$$.$h$, $DvtSparkChartAutomation$$.$w$);
    $DvtChartRefObjUtils$$.$setMatrix$($DvtChartPieLabelUtils$$);
    $DvtChartPyramidRenderer$$.$_renderPyramidSlices$($DvtSparkChartEventManager$$, $DvtChartRefObjUtils$$, $DvtChartAxisUtils$$) || $DvtChartRenderer$$.$renderEmptyText$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$);
    $DvtSparkChartDefaults$$ = $DvtChartDataUtils$$.$getInitialSelection$($DvtSparkChartEventManager$$);
    $DvtChartEventUtils$$.$setInitialSelection$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$);
    $DvtSparkChartEventManager$$.$highlight$($DvtChartStyleUtils$$.$getHighlightedCategories$($DvtSparkChartEventManager$$));
  };
  $DvtChartPyramidRenderer$$.$_renderPyramidSlices$ = function $$DvtChartPyramidRenderer$$$$_renderPyramidSlices$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$) {
    for (var $DvtSparkChartAutomation$$ = $dvt$$2$$.$getOptions$(), $DvtChartRefObjUtils$$ = $DvtChartDataUtils$$.$getSeriesCount$($dvt$$2$$), $DvtSparkChartAutomation$$ = $DvtChartStyleUtils$$.$getDataItemGaps$($dvt$$2$$) * Math.min($DvtChartPyramidRenderer$$.$_MAX_WIDTH_FOR_GAPS$ * $DvtSparkChartDefaults$$.$w$ / ($DvtChartRefObjUtils$$ - 1), ("on" == $DvtSparkChartAutomation$$.styleDefaults.threeDEffect ? $DvtChartPyramidRenderer$$.$_DEFAULT_3D_GAP_RATIO$ : $DvtChartPyramidRenderer$$.$_DEFAULT_2D_GAP_RATIO$) * 
    $DvtSparkChartDefaults$$.$w$), $DvtChartAxisUtils$$ = 0, $DvtChartPieLabelUtils$$ = 0, $DvtChartPieLabelInfo$$ = 0, $DvtChartPieRenderUtils$$ = 0;$DvtChartPieRenderUtils$$ < $DvtChartRefObjUtils$$;$DvtChartPieRenderUtils$$++) {
      if ($DvtChartStyleUtils$$.$isDataItemRendered$($dvt$$2$$, $DvtChartPieRenderUtils$$)) {
        var $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartPyramidRenderer$$.$_GROUP_INDEX$);
        0 >= $DvtChartDataChangePyramidSlice$$ || ($DvtChartAxisUtils$$ += $DvtChartDataChangePyramidSlice$$);
      }
    }
    if (0 == $DvtChartAxisUtils$$) {
    ...
    for ($DvtChartPieRenderUtils$$ = 0;$DvtChartPieRenderUtils$$ < $DvtChartRefObjUtils$$;$DvtChartPieRenderUtils$$++) {
      if ($DvtChartStyleUtils$$.$isDataItemRendered$($dvt$$2$$, $DvtChartPieRenderUtils$$)) {
        var $DvtChartDataChangePyramidSlice$$ = $DvtChartDataUtils$$.getValue($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartPyramidRenderer$$.$_GROUP_INDEX$), $DvtChartSeriesEffectUtils$$ = new $DvtChartPyramidSlice$$($dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartPieLabelUtils$$, $DvtSparkChartDefaults$$.$w$, $DvtSparkChartDefaults$$.$h$, $DvtChartPieLabelInfo$$, $DvtChartDataChangePyramidSlice$$ / $DvtChartAxisUtils$$, $DvtSparkChartAutomation$$), $DvtChartPieLabelInfo$$ = $DvtChartPieLabelInfo$$ + 
        $DvtChartDataChangePyramidSlice$$ / $DvtChartAxisUtils$$;
        $DvtChartPieLabelUtils$$++;
        $DvtSparkChartEventManager$$.$addChild$($DvtChartSeriesEffectUtils$$);
        $DvtChartObjPeer$$.$associate$($DvtChartSeriesEffectUtils$$, $dvt$$2$$, $DvtChartPieRenderUtils$$, $DvtChartPyramidRenderer$$.$_GROUP_INDEX$);
      }
    }
    return !0;
  };
  ...
  $DvtChartRefObjRenderer$$.$_renderObjectsForAxis$ = function $$DvtChartRefObjRenderer$$$$_renderObjectsForAxis$$($dvt$$2$$, $DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartAxisUtils$$, $DvtChartPieLabelUtils$$) {
    if ($DvtChartPieLabelUtils$$ && $DvtChartAxisUtils$$) {
      for (var $DvtChartPieLabelInfo$$ = 0;$DvtChartPieLabelInfo$$ < $DvtChartPieLabelUtils$$.length;$DvtChartPieLabelInfo$$++) {
        var $DvtChartPieRenderUtils$$ = $DvtChartPieLabelUtils$$[$DvtChartPieLabelInfo$$];
        if ($DvtChartRefObjUtils$$.$isObjectRendered$($dvt$$2$$, $DvtChartPieRenderUtils$$) && $DvtChartPieRenderUtils$$ && $DvtChartRefObjUtils$$.$getLocation$($DvtChartPieRenderUtils$$) == $DvtSparkChartAutomation$$) {
          var $DvtChartDataChangePyramidSlice$$, $DvtChartSeriesEffectUtils$$ = $DvtChartRefObjUtils$$.$getType$($DvtChartPieRenderUtils$$);
          "area" == $DvtChartSeriesEffectUtils$$ ? $DvtChartDataChangePyramidSlice$$ = $DvtChartRefObjRenderer$$.$_createReferenceArea$($DvtChartPieRenderUtils$$, $dvt$$2$$, $DvtSparkChartDefaults$$, $DvtChartAxisUtils$$) : "line" == $DvtChartSeriesEffectUtils$$ && ($DvtChartDataChangePyramidSlice$$ = $DvtChartRefObjRenderer$$.$_createReferenceLine$($DvtChartPieRenderUtils$$, $dvt$$2$$, $DvtSparkChartDefaults$$, $DvtChartAxisUtils$$));
          null != $DvtChartDataChangePyramidSlice$$ && ($DvtChartPieRenderUtils$$ = new $DvtChartRefObjPeer$$($dvt$$2$$, [$DvtChartDataChangePyramidSlice$$], $DvtChartPieRenderUtils$$, $DvtChartPieLabelInfo$$, $DvtChartAxisUtils$$ == $dvt$$2$$.$xAxis$ ? "xAxis" : $DvtChartAxisUtils$$ == $dvt$$2$$.$yAxis$ ? "yAxis" : "y2Axis"), $dvt$$2$$.$registerObject$($DvtChartPieRenderUtils$$), $dvt$$2$$.$getEventManager$().$associate$($DvtChartDataChangePyramidSlice$$, $DvtChartPieRenderUtils$$), $DvtSparkChartEventManager$$.$addChild$($DvtChartDataChangePyramidSlice$$));
        }
      }
    }
  };
  $DvtChartRefObjRenderer$$.$_createReferenceArea$ = function $$DvtChartRefObjRenderer$$$$_createReferenceArea$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartPieLabelUtils$$) {
    var $DvtChartPieLabelInfo$$ = $DvtSparkChartDefaults$$.$getCtx$(), $DvtChartPieRenderUtils$$ = $DvtChartPieLabelUtils$$.$getPosition$(), $DvtChartDataChangePyramidSlice$$ = "top" == $DvtChartPieRenderUtils$$ || "bottom" == $DvtChartPieRenderUtils$$, $DvtChartSeriesEffectUtils$$ = "radial" == $DvtChartPieRenderUtils$$, $DvtChartPieRenderUtils$$ = $DvtChartRefObjUtils$$.$getColor$($DvtSparkChartEventManager$$), $DvtChartRangeMarker$$ = $DvtChartRefObjUtils$$.$getLineType$($DvtSparkChartEventManager$$), 
    ...
    if (null == $DvtSparkChartEventManager$$.items || $DvtChartPieLabelUtils$$ != $DvtSparkChartDefaults$$.$yAxis$ && $DvtChartPieLabelUtils$$ != $DvtSparkChartDefaults$$.$y2Axis$) {
      ...
      $DvtChartTypeUtils$$.$isPolar$($DvtSparkChartDefaults$$) ? ($DvtChartDataChangePyramidSlice$$ = $DvtSparkChartAutomation$$.x + $DvtSparkChartAutomation$$.$w$ / 2, $DvtSparkChartEventManager$$ = $DvtSparkChartAutomation$$.y + $DvtSparkChartAutomation$$.$h$ / 2, $DvtChartSeriesEffectUtils$$ ? $DvtChartAxisUtils$$.$isGridPolygonal$($DvtSparkChartDefaults$$) ? ($DvtSparkChartAutomation$$ = $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartDefaults$$), $DvtSparkChartDefaults$$ = $dvt$$2$$.$PolygonUtils$.$getRegularPolygonPoints$($DvtChartDataChangePyramidSlice$$, 
      $DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$, $DvtChartPieLabelUtils$$, 1), $DvtSparkChartAutomation$$ = $dvt$$2$$.$PolygonUtils$.$getRegularPolygonPoints$($DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$, $DvtChartRangeMarker$$, 0), $DvtSparkChartAutomation$$ = $dvt$$2$$.$PathUtils$.$polyline$($DvtSparkChartDefaults$$) + $dvt$$2$$.$PathUtils$.$polyline$($DvtSparkChartAutomation$$) + $dvt$$2$$.$PathUtils$.closePath()) : $DvtSparkChartAutomation$$ = 
      $dvt$$2$$.$PathUtils$.moveTo($DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$ - $DvtChartPieLabelUtils$$) + $dvt$$2$$.$PathUtils$.arcTo($DvtChartPieLabelUtils$$, $DvtChartPieLabelUtils$$, Math.PI, 1, $DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$ + $DvtChartPieLabelUtils$$) + $dvt$$2$$.$PathUtils$.arcTo($DvtChartPieLabelUtils$$, $DvtChartPieLabelUtils$$, Math.PI, 1, $DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$ - $DvtChartPieLabelUtils$$) + 
      $dvt$$2$$.$PathUtils$.moveTo($DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$ - $DvtChartRangeMarker$$) + $dvt$$2$$.$PathUtils$.arcTo($DvtChartRangeMarker$$, $DvtChartRangeMarker$$, Math.PI, 0, $DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$ + $DvtChartRangeMarker$$) + $dvt$$2$$.$PathUtils$.arcTo($DvtChartRangeMarker$$, $DvtChartRangeMarker$$, Math.PI, 0, $DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$ - $DvtChartRangeMarker$$) + $dvt$$2$$.$PathUtils$.closePath() : 
      ($DvtSparkChartDefaults$$ = $DvtSparkChartDefaults$$.$getRadius$(), $DvtChartSeriesEffectUtils$$ = $DvtChartPlotAreaRenderer$$.$polarToCartesian$($DvtSparkChartDefaults$$, $DvtChartRangeMarker$$, $DvtSparkChartAutomation$$), $DvtSparkChartAutomation$$ = $DvtChartPlotAreaRenderer$$.$polarToCartesian$($DvtSparkChartDefaults$$, $DvtChartPieLabelUtils$$, $DvtSparkChartAutomation$$), $DvtSparkChartAutomation$$ = $dvt$$2$$.$PathUtils$.moveTo($DvtChartDataChangePyramidSlice$$, $DvtSparkChartEventManager$$) + 
      $dvt$$2$$.$PathUtils$.lineTo($DvtChartSeriesEffectUtils$$.x, $DvtChartSeriesEffectUtils$$.y) + $dvt$$2$$.$PathUtils$.arcTo($DvtSparkChartDefaults$$, $DvtSparkChartDefaults$$, $DvtChartPieLabelUtils$$ - $DvtChartRangeMarker$$, $dvt$$2$$.$Agent$.$isRightToLeft$($DvtChartPieLabelInfo$$) ? 0 : 1, $DvtSparkChartAutomation$$.x, $DvtSparkChartAutomation$$.y) + $dvt$$2$$.$PathUtils$.lineTo($DvtSparkChartAutomation$$.x, $DvtSparkChartAutomation$$.y) + $dvt$$2$$.$PathUtils$.closePath()), $DvtSparkChartAutomation$$ = 
      new $dvt$$2$$.$Path$($DvtChartPieLabelInfo$$, $DvtSparkChartAutomation$$)) : $DvtSparkChartAutomation$$ = new $dvt$$2$$.$Polygon$($DvtChartPieLabelInfo$$, $DvtChartDataChangePyramidSlice$$ ? [$DvtChartRangeMarker$$, 0, $DvtChartPieLabelUtils$$, 0, $DvtChartPieLabelUtils$$, $DvtSparkChartAutomation$$.$h$, $DvtChartRangeMarker$$, $DvtSparkChartAutomation$$.$h$] : [0, $DvtChartRangeMarker$$, 0, $DvtChartPieLabelUtils$$, $DvtSparkChartAutomation$$.$w$, $DvtChartPieLabelUtils$$, $DvtSparkChartAutomation$$.$w$, 
      $DvtChartRangeMarker$$]);
      $DvtSparkChartAutomation$$.$setSolidFill$($DvtChartPieRenderUtils$$);
      ...
      for ($DvtSparkChartEventManager$$ = 0;$DvtSparkChartEventManager$$ < $DvtChartPieLabelInfo$$.length;$DvtSparkChartEventManager$$++) {
        var $DvtChartDataChangeMarker$$ = $DvtChartPieLabelInfo$$[$DvtSparkChartEventManager$$], $DvtChartDataCursor$$ = $DvtChartRefObjUtils$$.$getLowValue$($DvtChartDataChangeMarker$$), $DvtChartDataChangeMarker$$ = $DvtChartRefObjUtils$$.$getHighValue$($DvtChartDataChangeMarker$$);
        if (null == $DvtChartDataCursor$$ || null == $DvtChartDataChangeMarker$$) {
          $DvtChartSeriesEffectUtils$$.push(new $DvtChartCoord$$), $DvtChartDataChangePyramidSlice$$.push(new $DvtChartCoord$$);
        } else {
          var $DvtChartDataCursor$$ = $DvtChartPieLabelUtils$$.$getUnboundedCoordAt$($DvtChartDataCursor$$), $DvtChartDataChangeMarker$$ = $DvtChartPieLabelUtils$$.$getUnboundedCoordAt$($DvtChartDataChangeMarker$$), $DvtChartDataChangeFunnelSlice$$ = $DvtSparkChartDefaults$$.$xAxis$.$getUnboundedCoordAt$($DvtChartRefObjUtils$$.$getXValue$($DvtSparkChartDefaults$$, $DvtChartPieLabelInfo$$, $DvtSparkChartEventManager$$));
          $DvtChartSeriesEffectUtils$$.push(new $DvtChartCoord$$($DvtChartDataChangeFunnelSlice$$, $DvtChartDataChangeMarker$$, $DvtChartDataChangeMarker$$));
          $DvtChartDataChangePyramidSlice$$.push(new $DvtChartCoord$$($DvtChartDataChangeFunnelSlice$$, $DvtChartDataCursor$$, $DvtChartDataCursor$$));
        }
      }
      $DvtSparkChartAutomation$$ = new $DvtChartLineArea$$($DvtSparkChartDefaults$$, !0, $DvtSparkChartAutomation$$, null, $DvtChartStyleUtils$$, $DvtChartPolarBar$$, new $dvt$$2$$.$SolidFill$($DvtChartPieRenderUtils$$), null, $DvtChartRangeMarker$$, $DvtChartSeriesEffectUtils$$, $DvtChartRangeMarker$$, $DvtChartDataChangePyramidSlice$$);
    }
    return $DvtSparkChartAutomation$$;
  };
  $DvtChartRefObjRenderer$$.$_createReferenceLine$ = function $$DvtChartRefObjRenderer$$$$_createReferenceLine$$($DvtSparkChartEventManager$$, $DvtSparkChartDefaults$$, $DvtSparkChartAutomation$$, $DvtChartPieLabelUtils$$) {
    var $DvtChartPieLabelInfo$$ = $DvtChartPieLabelUtils$$.$getPosition$(), $DvtChartPieRenderUtils$$ = "top" == $DvtChartPieLabelInfo$$ || "bottom" == $DvtChartPieLabelInfo$$, $DvtChartDataChangePyramidSlice$$ = "radial" == $DvtChartPieLabelInfo$$, $DvtChartSeriesEffectUtils$$ = "tangential" == $DvtChartPieLabelInfo$$, $DvtChartPieLabelInfo$$ = $DvtChartRefObjUtils$$.$getLineWidth$($DvtSparkChartEventManager$$), $DvtChartRangeMarker$$ = $DvtChartRefObjUtils$$.$getLineType$($DvtSparkChartEventManager$$), 
    ...
    var $DvtChartDataChangeMarker$$ = $DvtSparkChartDefaults$$.$getCtx$();
    if (null == $DvtSparkChartEventManager$$.items || $DvtChartPieLabelUtils$$ != $DvtSparkChartDefaults$$.$yAxis$ && $DvtChartPieLabelUtils$$ != $DvtSparkChartDefaults$$.$y2Axis$) {
      if ($DvtSparkChartEventManager$$.value) {
        ...
        $DvtChartDataChangePyramidSlice$$ ? ($DvtChartAxisUtils$$.$isGridPolygonal$($DvtSparkChartDefaults$$) ? ($DvtChartDataChangePyramidSlice$$ = $dvt$$2$$.$PolygonUtils$.$getRegularPolygonPoints$($DvtChartPieLabelUtils$$, $DvtChartRangeMarker$$, $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartDefaults$$), $DvtSparkChartEventManager$$), $DvtSparkChartDefaults$$ = new $dvt$$2$$.$Polygon$($DvtChartDataChangeMarker$$, $DvtChartDataChangePyramidSlice$$)) : $DvtSparkChartDefaults$$ = new $dvt$$2$$.$Circle$($DvtChartDataChangeMarker$$, 
        $DvtChartPieLabelUtils$$, $DvtChartRangeMarker$$, $DvtSparkChartEventManager$$), $DvtSparkChartDefaults$$.$setFill$(null)) : $DvtChartSeriesEffectUtils$$ ? ($DvtSparkChartDefaults$$ = $DvtChartPlotAreaRenderer$$.$polarToCartesian$($DvtSparkChartDefaults$$.$getRadius$(), $DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$), $DvtSparkChartDefaults$$ = new $dvt$$2$$.$Line$($DvtChartDataChangeMarker$$, $DvtChartPieLabelUtils$$, $DvtChartRangeMarker$$, $DvtSparkChartDefaults$$.x, $DvtSparkChartDefaults$$.y)) : 
        ($DvtSparkChartDefaults$$ = $DvtChartPieRenderUtils$$ ? new $dvt$$2$$.$Line$($DvtChartDataChangeMarker$$, $DvtSparkChartEventManager$$, 0, $DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$.$h$) : new $dvt$$2$$.$Line$($DvtChartDataChangeMarker$$, 0, $DvtSparkChartEventManager$$, $DvtSparkChartAutomation$$.$w$, $DvtSparkChartEventManager$$), $DvtSparkChartDefaults$$.$setPixelHinting$());
      ...
      $DvtChartPieRenderUtils$$ = $DvtSparkChartEventManager$$.items;
      $DvtChartDataChangePyramidSlice$$ = [];
      if ($DvtSparkChartDefaults$$.$xAxis$.$isGroupAxis$()) {
        for (;$DvtChartPieRenderUtils$$.length < $DvtChartDataUtils$$.$getGroupCount$($DvtSparkChartDefaults$$);) {
          $DvtChartPieRenderUtils$$.push(null);
        }
      }
      $DvtChartDataChangePyramidSlice$$ = [];
      for ($DvtChartSeriesEffectUtils$$ = 0;$DvtChartSeriesEffectUtils$$ < $DvtChartPieRenderUtils$$.length;$DvtChartSeriesEffectUtils$$++) {
        $DvtChartDataChangeMarker$$ = $DvtChartPieRenderUtils$$[$DvtChartSeriesEffectUtils$$], $DvtSparkChartEventManager$$ = null, null != $DvtChartDataChangeMarker$$ && ("object" != typeof $DvtChartDataChangeMarker$$ ? $DvtSparkChartEventManager$$ = $DvtChartDataChangeMarker$$ : null != $DvtChartDataChangeMarker$$.value && ($DvtSparkChartEventManager$$ = $DvtChartDataChangeMarker$$.value)), null == $DvtSparkChartEventManager$$ ? $DvtChartDataChangePyramidSlice$$.push(new $DvtChartCoord$$) : ($DvtChartDataChangeMarker$$ = 
        $DvtChartPieLabelUtils$$.$getUnboundedCoordAt$($DvtSparkChartEventManager$$), $DvtSparkChartEventManager$$ = $DvtSparkChartDefaults$$.$xAxis$.$getUnboundedCoordAt$($DvtChartRefObjUtils$$.$getXValue$($DvtSparkChartDefaults$$, $DvtChartPieRenderUtils$$, $DvtChartSeriesEffectUtils$$)), $DvtChartDataChangePyramidSlice$$.push(new $DvtChartCoord$$($DvtSparkChartEventManager$$, $DvtChartDataChangeMarker$$, $DvtChartDataChangeMarker$$)));
      }
      $DvtSparkChartDefaults$$ = new $DvtChartLineArea$$($DvtSparkChartDefaults$$, !1, $DvtSparkChartAutomation$$, null, $DvtChartStyleUtils$$, $DvtChartPolarBar$$, null, $DvtChartPieLabelInfo$$, $DvtChartRangeMarker$$, $DvtChartDataChangePyramidSlice$$);
    }
    return $DvtSparkChartDefaults$$;
  };
  ...
  $DvtSparkChartRenderer$$.$_convertOptionsObj$ = function $$DvtSparkChartRenderer$$$$_convertOptionsObj$$($DvtSparkChartEventManager$$) {
    ...
    var $DvtChartRefObjUtils$$ = "floatingBar" == $DvtSparkChartDefaults$$.type, $DvtChartAxisUtils$$ = [], $DvtChartPieLabelUtils$$ = -1, $DvtChartPieLabelInfo$$ = -1, $DvtChartPieRenderUtils$$ = -Infinity, $DvtChartDataChangePyramidSlice$$ = Infinity;
    ...
    for (var $DvtChartSeriesEffectUtils$$ = 0;$DvtChartSeriesEffectUtils$$ < $DvtSparkChartEventManager$$.length;$DvtChartSeriesEffectUtils$$++) {
      ...
      $DvtChartPieRenderUtils$$ < $DvtChartRangeMarker$$ && ($DvtChartPieRenderUtils$$ = $DvtChartRangeMarker$$, $DvtChartPieLabelUtils$$ = $DvtChartSeriesEffectUtils$$);
      ...
      $DvtChartDataChangePyramidSlice$$ > $DvtChartStyleUtils$$ && ($DvtChartDataChangePyramidSlice$$ = $DvtChartStyleUtils$$, $DvtChartPieLabelInfo$$ = $DvtChartSeriesEffectUtils$$);
    }
    ...
    $DvtChartAxisUtils$$ = $DvtChartPieRenderUtils$$ != $DvtChartDataChangePyramidSlice$$ ? .1 * ($DvtChartPieRenderUtils$$ - $DvtChartDataChangePyramidSlice$$) : .1 * Math.abs($DvtChartPieRenderUtils$$);
    $DvtSparkChartAutomation$$.yAxis.min = $DvtChartRefObjUtils$$ && 0 <= $DvtChartDataChangePyramidSlice$$ ? 0 : $DvtChartDataChangePyramidSlice$$ - $DvtChartAxisUtils$$;
    $DvtSparkChartAutomation$$.yAxis.max = $DvtChartRefObjUtils$$ && 0 >= $DvtChartPieRenderUtils$$ ? 0 : $DvtChartPieRenderUtils$$ + $DvtChartAxisUtils$$;
