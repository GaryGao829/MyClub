...
(function($dvt$$5$$) {
  ...
  $dvt$$5$$.$NBox$.prototype.$render$ = function $$dvt$$5$$$$NBox$$$$render$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    this.$_container$ ? "none" != $DvtNBoxDrawer$$ && $DvtNBoxAutomation$$ && ((this.$Animation$ = $dvt$$5$$.$BlackBoxAnimationHandler$.$getCombinedAnimation$(this.$getCtx$(), $DvtNBoxDrawer$$, this.$_container$, $DvtNBoxKeyboardHandler$$, $DvtNBoxNodeOverflow$$, $DvtNBoxCell$$)) ? $DvtNBoxEventManager$$ = !0 : (this.$_deleteContainer$ = new $dvt$$5$$.$Container$(this.$getCtx$(), "DeleteContainer"), this.$addChild$(this.$_deleteContainer$), $DvtNBoxDrawer$$ = new $DvtNBoxDataAnimationHandler$$(this.$getCtx$(), 
    this.$_deleteContainer$, $DvtNBoxCategoryRolloverHandler$$, this), $DvtNBoxCategoryNode$$ = $DvtNBoxRenderer$$.$getNodeOrderFunction$(this), $DvtNBoxDrawer$$.$constructAnimation$([$DvtNBoxCategoryRolloverHandler$$], [this]), this.$Animation$ = $DvtNBoxDrawer$$.$getAnimation$(), $dvt$$5$$.$Playable$.$appendOnEnd$(this.$Animation$, $DvtNBoxCategoryNode$$, this))) : "none" !== $DvtNBoxCategoryNode$$ && (this.$Animation$ = $dvt$$5$$.$BlackBoxAnimationHandler$.$getInAnimation$(this.$getCtx$(), $DvtNBoxCategoryNode$$, 
  ...
  $dvt$$5$$.$NBox$.prototype.$__getDragTransferable$ = function $$dvt$$5$$$$NBox$$$$__getDragTransferable$$($DvtNBoxAutomation$$) {
    ...
    for (var $DvtNBoxKeyboardHandler$$ = {}, $DvtNBoxEventManager$$ = this.$_selectionHandler$.getSelection(), $DvtNBoxDataAnimationHandler$$ = 0;$DvtNBoxDataAnimationHandler$$ < $DvtNBoxEventManager$$.length;$DvtNBoxDataAnimationHandler$$++) {
      ...
      if ($DvtNBoxDrawer$$ instanceof $DvtNBoxNode$$) {
        $DvtNBoxDrawer$$ = $DvtNBoxDrawer$$.getData()[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxAutomation$$.push($DvtNBoxDrawer$$), $DvtNBoxKeyboardHandler$$[$DvtNBoxDrawer$$] = !0;
      } else {
        if ($DvtNBoxDrawer$$ instanceof $DvtNBoxCategoryNode$$) {
          for (var $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDrawer$$.getData().nodeIndices, $DvtNBoxCell$$ = 0;$DvtNBoxCell$$ < $DvtNBoxCategoryRolloverHandler$$.length;$DvtNBoxCell$$++) {
            var $DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNode$(this, $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxCell$$])[$dvt$$5$$.$NBoxConstants$.ID];
            $DvtNBoxAutomation$$.push($DvtNBoxNodeOverflow$$);
            $DvtNBoxKeyboardHandler$$[$DvtNBoxNodeOverflow$$] = !0;
          }
          $DvtNBoxKeyboardHandler$$[$DvtNBoxDrawer$$.getData()[$dvt$$5$$.$NBoxConstants$.ID]] = !0;
        }
      }
    }
        ...
        if (!isNaN($DvtNBoxDataUtils$$.$getNodeIndex$(this, $DvtNBoxDrawer$$))) {
          ...
          if ($DvtNBoxDataUtils$$.$getGrouping$(this) && $DvtNBoxDataUtils$$.$getCategoryNode$(this, $DvtNBoxDrawer$$)) {
            ...
            for ($DvtNBoxCell$$ = 0;$DvtNBoxCell$$ < $DvtNBoxCategoryRolloverHandler$$.length;$DvtNBoxCell$$++) {
              $DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNode$(this, $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxCell$$])[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxKeyboardHandler$$[$DvtNBoxNodeOverflow$$] || ($DvtNBoxAutomation$$.push($DvtNBoxNodeOverflow$$), $DvtNBoxKeyboardHandler$$[$DvtNBoxNodeOverflow$$] = !0);
            }
  ...
  $dvt$$5$$.$NBox$.prototype.$_processHighlighting$ = function $$dvt$$5$$$$NBox$$$$_processHighlighting$$($DvtNBoxAutomation$$) {
    ...
    if ($DvtNBoxDataAnimationHandler$$) {
      for (var $DvtNBoxCategoryRolloverHandler$$ = 0;$DvtNBoxCategoryRolloverHandler$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxCategoryRolloverHandler$$++) {
        $DvtNBoxEventManager$$[$DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryRolloverHandler$$][$dvt$$5$$.$NBoxConstants$.ID]] = !0;
      }
    }
  ...
  $DvtNBoxCell$$.prototype.contains = function $$DvtNBoxCell$$$$contains$($dvt$$5$$, $DvtNBoxAutomation$$) {
    ...
    return $DvtNBoxEventManager$$ <= $dvt$$5$$ && $dvt$$5$$ <= $DvtNBoxDrawer$$ && $DvtNBoxDataAnimationHandler$$ <= $DvtNBoxAutomation$$ && $DvtNBoxAutomation$$ <= $DvtNBoxKeyboardHandler$$;
  };
  ...
  $DvtNBoxCell$$.prototype.$_getFirstNavigableChild$ = function $$DvtNBoxCell$$$$$_getFirstNavigableChild$$($DvtNBoxAutomation$$) {
    ...
    if ($DvtNBoxDrawer$$ && $DvtNBoxEventManager$$ == this.getData()[$dvt$$5$$.$NBoxConstants$.$ROW$] && $DvtNBoxDataAnimationHandler$$ == this.getData()[$dvt$$5$$.$NBoxConstants$.$COLUMN$]) {
  ...
  $DvtNBoxNodeOverflow$$.prototype.$render$ = function $$DvtNBoxNodeOverflow$$$$$render$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    var $DvtNBoxNodeRenderer$$ = new $dvt$$5$$.$Container$($DvtNBoxNodeOverflow$$), $DvtNBoxCategoryNodeRenderer$$ = new $dvt$$5$$.$Container$($DvtNBoxNodeOverflow$$), $DvtNBoxDrawerRenderer$$ = new $dvt$$5$$.$Container$($DvtNBoxNodeOverflow$$), $DvtNBoxStyleUtils$$ = new $dvt$$5$$.$Container$($DvtNBoxNodeOverflow$$);
    $DvtNBoxNodeRenderer$$.$addChild$($DvtNBoxNode$$);
    $DvtNBoxCategoryNodeRenderer$$.$addChild$($DvtNBoxDefaults$$);
    $DvtNBoxDrawerRenderer$$.$addChild$($DvtNBoxRenderer$$);
    $DvtNBoxStyleUtils$$.$addChild$($DvtNBoxCellRenderer$$);
    $DvtNBoxNodeRenderer$$.$addChild$(new $dvt$$5$$.Image($DvtNBoxNodeOverflow$$, $DvtNBoxDataAnimationHandler$$._resources.overflow_ena.src, $DvtNBoxCategoryNode$$, $DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$));
    $DvtNBoxCategoryNodeRenderer$$.$addChild$(new $dvt$$5$$.Image($DvtNBoxNodeOverflow$$, $DvtNBoxDataAnimationHandler$$._resources.overflow_ovr.src, $DvtNBoxCategoryNode$$, $DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$));
    $DvtNBoxDrawerRenderer$$.$addChild$(new $dvt$$5$$.Image($DvtNBoxNodeOverflow$$, $DvtNBoxDataAnimationHandler$$._resources.overflow_dwn.src, $DvtNBoxCategoryNode$$, $DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$));
    $DvtNBoxStyleUtils$$.$addChild$(new $dvt$$5$$.Image($DvtNBoxNodeOverflow$$, $DvtNBoxDataAnimationHandler$$._resources.overflow_dis.src, $DvtNBoxCategoryNode$$, $DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$));
    this.$_button$ = new $dvt$$5$$.$Button$($DvtNBoxNodeOverflow$$, $DvtNBoxNodeRenderer$$, $DvtNBoxCategoryNodeRenderer$$, $DvtNBoxDrawerRenderer$$, $DvtNBoxStyleUtils$$, null, this.$HandleClick$, this);
  ...
  $DvtNBoxCategoryNode$$.prototype.$getCategories$ = function $$DvtNBoxCategoryNode$$$$$getCategories$$() {
    ...
    if (!$DvtNBoxAutomation$$) {
      for (var $DvtNBoxKeyboardHandler$$ = function $$DvtNBoxKeyboardHandler$$$($dvt$$5$$, $DvtNBoxAutomation$$) {
        ...
        var $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getNode$(this.$_nbox$, $DvtNBoxEventManager$$[$DvtNBoxDataAnimationHandler$$])[$dvt$$5$$.$NBoxConstants$.$CATEGORIES$];
        if (!$DvtNBoxDrawer$$) {
          $DvtNBoxAutomation$$ = [];
          break;
        }
  ...
  $DvtNBoxRenderer$$.$_renderLegend$ = function $$DvtNBoxRenderer$$$$_renderLegend$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    if ($DvtNBoxDataAnimationHandler$$ && $DvtNBoxDataAnimationHandler$$.sections) {
      var $DvtNBoxDrawer$$ = $DvtNBoxAutomation$$.$getOptions$(), $DvtNBoxCategoryRolloverHandler$$ = $dvt$$5$$.$Agent$.$isRightToLeft$($DvtNBoxAutomation$$.$getCtx$()), $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$PanelDrawer$($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxAutomation$$.$processEvent$, $DvtNBoxAutomation$$, "pd1");
      ...
      $DvtNBoxCategoryRolloverHandler$$ && $DvtNBoxCategoryNode$$.$setDiscloseDirection$($dvt$$5$$.$PanelDrawer$.$DIR_RIGHT$);
      $DvtNBoxCategoryNode$$.$renderComponent$();
      "disclosed" == $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$LEGEND_DISCLOSURE$] && ($DvtNBoxCategoryNode$$.$setDisplayedPanelId$("legend"), $DvtNBoxCategoryNode$$.$setDisclosed$(!0, !0));
  ...
  $DvtNBoxRenderer$$.$_renderCells$ = function $$DvtNBoxRenderer$$$$_renderCells$$($dvt$$5$$, $DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    for (var $DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getRowCount$($dvt$$5$$), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataUtils$$.$getColumnCount$($dvt$$5$$), $DvtNBoxDrawer$$ = 0;$DvtNBoxDrawer$$ < $DvtNBoxEventManager$$;$DvtNBoxDrawer$$++) {
      for (var $DvtNBoxCategoryRolloverHandler$$ = 0;$DvtNBoxCategoryRolloverHandler$$ < $DvtNBoxDataAnimationHandler$$;$DvtNBoxCategoryRolloverHandler$$++) {
        var $DvtNBoxCategoryNode$$ = $DvtNBoxDataUtils$$.$getCell$($dvt$$5$$, $DvtNBoxDrawer$$ * $DvtNBoxDataAnimationHandler$$ + $DvtNBoxCategoryRolloverHandler$$);
  ...
  $DvtNBoxRenderer$$.$_calculateCellCounts$ = function $$DvtNBoxRenderer$$$$_calculateCellCounts$$($DvtNBoxAutomation$$) {
    ...
    if ($DvtNBoxDrawer$$) {
      for (var $DvtNBoxEventManager$$ = [], $DvtNBoxCategoryNode$$ = 0;$DvtNBoxCategoryNode$$ < $DvtNBoxDrawer$$.length;$DvtNBoxCategoryNode$$++) {
        $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxDrawer$$[$DvtNBoxCategoryNode$$][$dvt$$5$$.$NBoxConstants$.ID]] = !0;
      }
    }
    ...
    for ($DvtNBoxCategoryNode$$ = 0;$DvtNBoxCategoryNode$$ < $DvtNBoxDataAnimationHandler$$;$DvtNBoxCategoryNode$$++) {
      if ($DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxCategoryNode$$), !$DvtNBoxDataUtils$$.$isNodeHidden$($DvtNBoxAutomation$$, $DvtNBoxDrawer$$)) {
        ...
        $DvtNBoxEventManager$$ && $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.ID]] && $DvtNBoxEventManager$$[$DvtNBoxCell$$]++;
      }
    }
    $DvtNBoxCategoryRolloverHandler$$ = {};
  ...
  $DvtNBoxRenderer$$.$calculateNodeOrders$ = function $$DvtNBoxRenderer$$$$calculateNodeOrders$$($DvtNBoxAutomation$$) {
    ...
    if ($DvtNBoxEventManager$$) {
      for (var $DvtNBoxDrawer$$ = 0;$DvtNBoxDrawer$$ < $DvtNBoxEventManager$$.length;$DvtNBoxDrawer$$++) {
        $DvtNBoxDataAnimationHandler$$[$DvtNBoxEventManager$$[$DvtNBoxDrawer$$][$dvt$$5$$.$NBoxConstants$.ID]] = !0;
      }
    }
    ...
    for ($DvtNBoxCategoryRolloverHandler$$ = 0;$DvtNBoxCategoryRolloverHandler$$ < $DvtNBoxKeyboardHandler$$.length;$DvtNBoxCategoryRolloverHandler$$++) {
      for (var $DvtNBoxCell$$ = 0;$DvtNBoxCell$$ < $DvtNBoxDrawer$$;$DvtNBoxCell$$++) {
        ...
        if (!$DvtNBoxDataUtils$$.$isNodeHidden$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$) && ("normal" == $DvtNBoxKeyboardHandler$$[$DvtNBoxCategoryRolloverHandler$$] || "highlighted-selected" == $DvtNBoxKeyboardHandler$$[$DvtNBoxCategoryRolloverHandler$$] && $DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]] && $DvtNBoxCategoryNode$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]] || "highlighted-unselected" == $DvtNBoxKeyboardHandler$$[$DvtNBoxCategoryRolloverHandler$$] && 
        $DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]] && !$DvtNBoxCategoryNode$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]] || "unhighlighted-selected" == $DvtNBoxKeyboardHandler$$[$DvtNBoxCategoryRolloverHandler$$] && !$DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]] && $DvtNBoxCategoryNode$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]] || "unhighlighted-unselected" == $DvtNBoxKeyboardHandler$$[$DvtNBoxCategoryRolloverHandler$$] && 
        !$DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]] && !$DvtNBoxCategoryNode$$[$DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.ID]])) {
  ...
  $DvtNBoxRenderer$$.$_renderIndividualNodes$ = function $$DvtNBoxRenderer$$$$_renderIndividualNodes$$($DvtNBoxAutomation$$) {
        ...
        if ($nodes$$13$$ && $nodes$$13$$.length) {
          ...
          if (!(0 == $cellRows_gridXOrigin_prevNode$$ || 0 == $cellColumns_overflowContainer$$ || 1 == $cellRows_gridXOrigin_prevNode$$ && 1 == $cellColumns_overflowContainer$$ && $cellIndex$$5_cellLayout$$1$$.overflow)) {
            for (var $maxNodes$$ = $cellRows_gridXOrigin_prevNode$$ * $cellColumns_overflowContainer$$ - ($cellIndex$$5_cellLayout$$1$$.overflow ? 1 : 0), $n$$18$$ = 0;$n$$18$$ < $nodes$$13$$.length;$n$$18$$++) {
              var $node$$258$$ = $nodes$$13$$[$n$$18$$];
              if (0 > $maxNodes$$ || $n$$18$$ < $maxNodes$$) {
                var $cellContainer$$1$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $cell$$12$$).$getChildContainer$(), $scrolling$$ = $cellContainer$$1$$ instanceof $dvt$$5$$.$SimpleScrollableContainer$, $nodeContainer$$ = new $DvtNBoxNode$$($DvtNBoxAutomation$$, $node$$258$$), $cellRows_gridXOrigin_prevNode$$ = $cell$$12$$.__childArea.x + ($cell$$12$$.__childArea.$w$ - $cellIndex$$5_cellLayout$$1$$.cellColumns * $DvtNBoxDefaults$$ + $DvtNBoxKeyboardHandler$$) / 2, $gridYOrigin$$ = 
                ...
                $DvtNBoxDrawer$$ && !$DvtNBoxCategoryRolloverHandler$$[$node$$258$$[$dvt$$5$$.$NBoxConstants$.ID]] && $nodeContainer$$.$setAlpha$($DvtNBoxDataAnimationHandler$$);
                if ($cellRows_gridXOrigin_prevNode$$ = 0 < $n$$18$$ ? $nodes$$13$$[$n$$18$$ - 1] : null) {
                  $node$$258$$.__prev = $cellRows_gridXOrigin_prevNode$$, $cellRows_gridXOrigin_prevNode$$.__next = $node$$258$$;
                }
              }
            }
          }
    ...
    for ($r$$32$$ = 0;$r$$32$$ < $DvtNBoxDrawerRenderer$$;$r$$32$$++) {
      for ($c$$21$$ = 0;$c$$21$$ < $columnCount$$4$$;$c$$21$$++) {
        ...
        $DvtNBoxCategoryRolloverHandler$$, $cellColumns_overflowContainer$$, "overflow"), $cellRows_gridXOrigin_prevNode$$ = $DvtNBoxCategoryRolloverHandler$$.__childArea.x + ($DvtNBoxCategoryRolloverHandler$$.__childArea.$w$ - $cellIndex$$5_cellLayout$$1$$.cellColumns * $DvtNBoxDefaults$$ + $DvtNBoxKeyboardHandler$$) / 2, $gridYOrigin$$ = $DvtNBoxCategoryRolloverHandler$$.__childArea.y, $gridColumn$$ = $cellIndex$$5_cellLayout$$1$$.cellColumns - 1, $DvtNBoxEventManager$$ && ($gridColumn$$ = 0), 
        $gridRow$$ = $cellIndex$$5_cellLayout$$1$$.cellRows - 1, $cellColumns_overflowContainer$$.$setTranslate$($cellRows_gridXOrigin_prevNode$$ + $DvtNBoxDefaults$$ * $gridColumn$$, $gridYOrigin$$ + $DvtNBoxCategoryNodeRenderer$$ * $gridRow$$), $cellColumns_overflowContainer$$.$render$($cell$$12$$.$getChildContainer$(), $DvtNBoxDefaults$$ - $DvtNBoxKeyboardHandler$$, $DvtNBoxCategoryNodeRenderer$$ - $DvtNBoxKeyboardHandler$$)))), $DvtNBoxDataUtils$$.$isCellMaximized$($DvtNBoxAutomation$$, $DvtNBoxDrawer$$) && 
  ...
  $DvtNBoxRenderer$$.$_renderCategoryNodes$ = function $$DvtNBoxRenderer$$$$_renderCategoryNodes$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    var $DvtNBoxDataAnimationHandler$$ = {}, $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getNodeCount$($DvtNBoxAutomation$$), $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDataUtils$$.$getGroupBehavior$($DvtNBoxAutomation$$), $DvtNBoxCell$$ = $dvt$$5$$.$Agent$.$isRightToLeft$($DvtNBoxAutomation$$.$getCtx$()), $DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getHighlightedItems$($DvtNBoxAutomation$$), $DvtNBoxNode$$ = {};
    if ($DvtNBoxNodeOverflow$$) {
    ...
    for ($DvtNBoxDefaults$$ = 0;$DvtNBoxDefaults$$ < $DvtNBoxDrawer$$;$DvtNBoxDefaults$$++) {
      if ($DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$), !$DvtNBoxDataUtils$$.$isNodeHidden$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$)) {
        ...
        if ($DvtNBoxCategoryRolloverHandler$$ == $dvt$$5$$.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$) {
        ...
        $DvtNBoxCategoryNodeRenderer$$ || ($DvtNBoxCategoryNodeRenderer$$ = {}, $DvtNBoxCategoryNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.ID] = $DvtNBoxNodeRenderer$$, $DvtNBoxCategoryRolloverHandler$$ == $dvt$$5$$.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$ && ($DvtNBoxCategoryNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$CELL$] = $DvtNBoxDataUtils$$.$getCellIndex$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$)), $DvtNBoxCategoryNodeRenderer$$.nodeIndices = [], $DvtNBoxCategoryNodeRenderer$$.highlightedCount = 
        0, $DvtNBoxCellRenderer$$[$DvtNBoxNodeRenderer$$] = $DvtNBoxCategoryNodeRenderer$$);
    ...
    if ($DvtNBoxCategoryRolloverHandler$$ == $dvt$$5$$.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$) {
      var $DvtNBoxDefaults$$ = {}, $DvtNBoxDrawerRenderer$$;
      for ($DvtNBoxDrawerRenderer$$ in $DvtNBoxDataAnimationHandler$$) {
        $DvtNBoxDefaults$$[$DvtNBoxDrawerRenderer$$] = $DvtNBoxRenderer$$.$_processOtherThreshold$($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$[$DvtNBoxDrawerRenderer$$]);
      }
    } else {
    ...
    if ($DvtNBoxCategoryRolloverHandler$$ == $dvt$$5$$.$NBoxConstants$.$GROUP_BEHAVIOR_ACROSS_CELLS$) {
      $DvtNBoxDrawerRenderer$$ = [];
      for ($DvtNBoxCategoryNodeRenderer$$ in $DvtNBoxDataAnimationHandler$$) {
        $DvtNBoxDrawerRenderer$$.push($DvtNBoxCategoryNodeRenderer$$);
      }
      $DvtNBoxDrawerRenderer$$.sort(function($dvt$$5$$, $DvtNBoxAutomation$$) {
      ...
      for ($DvtNBoxDefaults$$ = 0;$DvtNBoxDefaults$$ < $DvtNBoxDrawerRenderer$$.length;$DvtNBoxDefaults$$++) {
        $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDrawerRenderer$$[$DvtNBoxDefaults$$];
        $DvtNBoxCellRenderer$$ = $DvtNBoxNode$$ = 0;
        $DvtNBoxDrawer$$ = $DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryNodeRenderer$$].nodeIndices.length;
        for ($DvtNBoxNodeRenderer$$ = 0;$DvtNBoxNodeRenderer$$ < $DvtNBoxDrawer$$;$DvtNBoxNodeRenderer$$++) {
        ...
        $DvtNBoxCellRenderer$$ /= $DvtNBoxDrawer$$;
        $DvtNBoxDrawer$$ = $DvtNBoxCategoryNode$$.newInstance($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryNodeRenderer$$]);
        $DvtNBoxDrawer$$.$setTranslate$($DvtNBoxEventManager$$.x + ($DvtNBoxCell$$ ? 1 - $DvtNBoxNode$$ : $DvtNBoxNode$$) * $DvtNBoxEventManager$$.$w$, $DvtNBoxEventManager$$.y + (1 - $DvtNBoxCellRenderer$$) * $DvtNBoxEventManager$$.$h$);
      ...
      if ($DvtNBoxCategoryRolloverHandler$$ == $dvt$$5$$.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$) {
        ...
        for ($DvtNBoxDefaults$$ = 0;$DvtNBoxDefaults$$ < $DvtNBoxKeyboardHandler$$;$DvtNBoxDefaults$$++) {
          $DvtNBoxDataAnimationHandler$$[$DvtNBoxDefaults$$] && !$DvtNBoxDataUtils$$.$isCellMinimized$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$) && ($DvtNBoxCategoryRolloverHandler$$ = Math.min($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxEventManager$$[$DvtNBoxDefaults$$].scale));
        }
        for ($DvtNBoxDefaults$$ = 0;$DvtNBoxDefaults$$ < $DvtNBoxKeyboardHandler$$;$DvtNBoxDefaults$$++) {
          if ($DvtNBoxDataAnimationHandler$$[$DvtNBoxDefaults$$] && !$DvtNBoxDataUtils$$.$isCellMinimized$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$)) {
            for ($DvtNBoxCategoryNodeRenderer$$ in $DvtNBoxNodeOverflow$$ = $DvtNBoxEventManager$$[$DvtNBoxDefaults$$].positions, $DvtNBoxDrawerRenderer$$ = $DvtNBoxEventManager$$[$DvtNBoxDefaults$$].center, $DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$), $DvtNBoxNode$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $DvtNBoxCell$$).$getChildContainer$(), $DvtNBoxCellRenderer$$ = $DvtNBoxNode$$ instanceof $dvt$$5$$.$SimpleScrollableContainer$, 
            $DvtNBoxNodeOverflow$$) {
              $DvtNBoxDrawer$$ = $DvtNBoxCategoryNode$$.newInstance($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$[$DvtNBoxDefaults$$][$DvtNBoxCategoryNodeRenderer$$]), $DvtNBoxDrawer$$.$setTranslate$($DvtNBoxCell$$.__childArea.x + $DvtNBoxCell$$.__childArea.$w$ / 2 + $DvtNBoxCategoryRolloverHandler$$ * ($DvtNBoxNodeOverflow$$[$DvtNBoxCategoryNodeRenderer$$].x - $DvtNBoxDrawerRenderer$$.x), ($DvtNBoxCellRenderer$$ ? 0 : $DvtNBoxCell$$.__childArea.y) + $DvtNBoxCell$$.__childArea.$h$ / 2 + $DvtNBoxCategoryRolloverHandler$$ * 
              ($DvtNBoxNodeOverflow$$[$DvtNBoxCategoryNodeRenderer$$].y - $DvtNBoxDrawerRenderer$$.y)), $DvtNBoxDrawer$$.$render$($DvtNBoxCellRenderer$$ ? $DvtNBoxNode$$.$_container$ : $DvtNBoxNode$$, $DvtNBoxCategoryRolloverHandler$$, 3);
            }
          }
        }
      }
    ...
    if ($DvtNBoxAutomation$$.$isSelectionSupported$()) {
      ...
      if ($DvtNBoxDataAnimationHandler$$) {
        for (var $DvtNBoxDrawer$$ = 0;$DvtNBoxDrawer$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxDrawer$$++) {
          $DvtNBoxEventManager$$.push($DvtNBoxDataAnimationHandler$$[$DvtNBoxDrawer$$]), $DvtNBoxKeyboardHandler$$[$DvtNBoxDataAnimationHandler$$[$DvtNBoxDrawer$$]] = !0;
        }
        ...
        if ($DvtNBoxDataUtils$$.$getGrouping$($DvtNBoxAutomation$$)) {
          for ($DvtNBoxDrawer$$ = 0;$DvtNBoxDrawer$$ < $DvtNBoxCategoryRolloverHandler$$.length;$DvtNBoxDrawer$$++) {
            if ($DvtNBoxCategoryRolloverHandler$$[$DvtNBoxDrawer$$] instanceof $DvtNBoxCategoryNode$$) {
              ...
              $DvtNBoxCell$$ && $DvtNBoxEventManager$$.push($DvtNBoxCategoryRolloverHandler$$[$DvtNBoxDrawer$$].getId());
            }
          }
        }
      }
  ...
  $DvtNBoxRenderer$$.$_forceLayoutGroups$ = function $$DvtNBoxRenderer$$$$_forceLayoutGroups$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    for (var $DvtNBoxCategoryRolloverHandler$$ = {}, $DvtNBoxCell$$ = 2 * Math.PI / $DvtNBoxDataAnimationHandler$$.length, $DvtNBoxNodeOverflow$$ = 0;$DvtNBoxNodeOverflow$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxNodeOverflow$$++) {
      $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeOverflow$$]] = $dvt$$5$$.$VectorUtils$.$createVector$($DvtNBoxNodeOverflow$$ * Math.cos($DvtNBoxCell$$ * $DvtNBoxNodeOverflow$$), $DvtNBoxNodeOverflow$$ * Math.sin($DvtNBoxCell$$ * $DvtNBoxNodeOverflow$$));
    }
    for (var $DvtNBoxCell$$ = 1, $DvtNBoxNode$$ = -.25 * $DvtNBoxEventManager$$ / Math.max($DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$), $DvtNBoxDefaults$$ = -.25 * $DvtNBoxKeyboardHandler$$ / Math.max($DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$);.005 < $DvtNBoxCell$$;) {
      for (var $DvtNBoxRenderer$$ = {}, $DvtNBoxNodeOverflow$$ = 0;$DvtNBoxNodeOverflow$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxNodeOverflow$$++) {
        ...
        $DvtNBoxDrawer$$ = $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxCellRenderer$$];
        var $DvtNBoxDataUtils$$ = $DvtNBoxAutomation$$[$DvtNBoxCellRenderer$$].nodeIndices.length;
        $DvtNBoxRenderer$$[$DvtNBoxCellRenderer$$] = $dvt$$5$$.$VectorUtils$.$createVector$($DvtNBoxCell$$ * $DvtNBoxNode$$ * $DvtNBoxDrawer$$.x, $DvtNBoxCell$$ * $DvtNBoxDefaults$$ * $DvtNBoxDrawer$$.y);
        for (var $DvtNBoxNodeRenderer$$ = 0;$DvtNBoxNodeRenderer$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxNodeRenderer$$++) {
          if ($DvtNBoxNodeOverflow$$ != $DvtNBoxNodeRenderer$$) {
            for (var $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeRenderer$$], $DvtNBoxDrawerRenderer$$ = $DvtNBoxAutomation$$[$DvtNBoxCategoryNodeRenderer$$].nodeIndices.length, $DvtNBoxCategoryNodeRenderer$$ = $dvt$$5$$.$VectorUtils$.$subtractVectors$($DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxCategoryNodeRenderer$$]), $DvtNBoxStyleUtils$$ = $dvt$$5$$.$VectorUtils$.$getMagnitude$($DvtNBoxCategoryNodeRenderer$$), $angle$$36_minimumDistance$$ = Math.atan2($DvtNBoxCategoryNodeRenderer$$.y, 
            $DvtNBoxCategoryNodeRenderer$$.x);0 > $angle$$36_minimumDistance$$;) {
              $angle$$36_minimumDistance$$ += Math.PI / 2;
            }
            for (;$angle$$36_minimumDistance$$ >= Math.PI / 2;) {
              $angle$$36_minimumDistance$$ -= Math.PI / 2;
            }
            $angle$$36_minimumDistance$$ = $angle$$36_minimumDistance$$ < Math.PI / 4 ? .5 * (Math.sqrt($DvtNBoxDataUtils$$) + Math.sqrt($DvtNBoxDrawerRenderer$$)) / Math.cos($angle$$36_minimumDistance$$) : .5 * (Math.sqrt($DvtNBoxDataUtils$$) + Math.sqrt($DvtNBoxDrawerRenderer$$)) / Math.sin($angle$$36_minimumDistance$$);
            $DvtNBoxStyleUtils$$ < $angle$$36_minimumDistance$$ && ($DvtNBoxRenderer$$[$DvtNBoxCellRenderer$$] = $dvt$$5$$.$VectorUtils$.$addVectors$($DvtNBoxRenderer$$[$DvtNBoxCellRenderer$$], $dvt$$5$$.$VectorUtils$.$scaleVector$($DvtNBoxCategoryNodeRenderer$$, ($angle$$36_minimumDistance$$ - $DvtNBoxStyleUtils$$) / $DvtNBoxStyleUtils$$ * ($DvtNBoxDrawerRenderer$$ / ($DvtNBoxDataUtils$$ + $DvtNBoxDrawerRenderer$$)) * (1 - $DvtNBoxCell$$))));
          }
        }
      }
      for ($DvtNBoxNodeOverflow$$ = 0;$DvtNBoxNodeOverflow$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxNodeOverflow$$++) {
        $DvtNBoxCellRenderer$$ = $DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeOverflow$$], $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxCellRenderer$$] = $dvt$$5$$.$VectorUtils$.$addVectors$($DvtNBoxCategoryRolloverHandler$$[$DvtNBoxCellRenderer$$], $DvtNBoxRenderer$$[$DvtNBoxCellRenderer$$]);
      }
      $DvtNBoxCell$$ *= .98;
    }
    ...
    for ($DvtNBoxNodeOverflow$$ = 0;$DvtNBoxNodeOverflow$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxNodeOverflow$$++) {
      $DvtNBoxDrawer$$ = $DvtNBoxDataAnimationHandler$$[$DvtNBoxNodeOverflow$$], $DvtNBoxCellRenderer$$ = Math.sqrt($DvtNBoxAutomation$$[$DvtNBoxDrawer$$].nodeIndices.length), $DvtNBoxDrawer$$ = $DvtNBoxCategoryRolloverHandler$$[$DvtNBoxDrawer$$], $DvtNBoxCell$$ = Math.min($DvtNBoxCell$$, $DvtNBoxDrawer$$.x - $DvtNBoxCellRenderer$$ / 2), $DvtNBoxNode$$ = Math.max($DvtNBoxNode$$, $DvtNBoxDrawer$$.x + $DvtNBoxCellRenderer$$ / 2), $DvtNBoxDefaults$$ = Math.min($DvtNBoxDefaults$$, $DvtNBoxDrawer$$.y - 
      $DvtNBoxCellRenderer$$ / 2), $DvtNBoxRenderer$$ = Math.max($DvtNBoxRenderer$$, $DvtNBoxDrawer$$.y + $DvtNBoxCellRenderer$$ / 2);
    }
    return {scale:Math.min($DvtNBoxKeyboardHandler$$ / ($DvtNBoxNode$$ - $DvtNBoxCell$$), $DvtNBoxEventManager$$ / ($DvtNBoxRenderer$$ - $DvtNBoxDefaults$$)), center:new $dvt$$5$$.$Point$(($DvtNBoxCell$$ + $DvtNBoxNode$$) / 2, ($DvtNBoxDefaults$$ + $DvtNBoxRenderer$$) / 2), positions:$DvtNBoxCategoryRolloverHandler$$};
  };
  ...
  $DvtNBoxRenderer$$.$_animateCells$ = function $$DvtNBoxRenderer$$$$_animateCells$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    if ($DvtNBoxDataAnimationHandler$$ == $DvtNBoxDrawer$$ && $DvtNBoxCategoryRolloverHandler$$ == $DvtNBoxCategoryNode$$) {
      ...
      for ($DvtNBoxRenderer$$ = 0;$DvtNBoxRenderer$$ < $DvtNBoxDrawer$$;$DvtNBoxRenderer$$++) {
        if ($DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDataUtils$$.$getRow$($DvtNBoxKeyboardHandler$$, $DvtNBoxRenderer$$)[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getRow$($DvtNBoxEventManager$$, $DvtNBoxRenderer$$)[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxCategoryRolloverHandler$$ != $DvtNBoxCell$$) {
          $DvtNBoxDataAnimationHandler$$ = !1;
          break;
        }
      }
      if ($DvtNBoxDataAnimationHandler$$) {
        for ($DvtNBoxRenderer$$ = 0;$DvtNBoxRenderer$$ < $DvtNBoxCategoryNode$$;$DvtNBoxRenderer$$++) {
          if ($DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getColumn$($DvtNBoxKeyboardHandler$$, $DvtNBoxRenderer$$)[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDataUtils$$.$getColumn$($DvtNBoxEventManager$$, $DvtNBoxRenderer$$)[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxDrawer$$ != $DvtNBoxCategoryRolloverHandler$$) {
            $DvtNBoxDataAnimationHandler$$ = !1;
            break;
          }
        }
  ...
  $DvtNBoxRenderer$$.$_animateNodes$ = function $$DvtNBoxRenderer$$$$_animateNodes$$($dvt$$5$$, $DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    $dvt$$5$$.$constructAnimation$($DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$);
    $DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getDrawer$($DvtNBoxAutomation$$);
    $DvtNBoxDataUtils$$.$getDrawer$($DvtNBoxKeyboardHandler$$) || ($DvtNBoxDataAnimationHandler$$ = $DvtNBoxRenderer$$.$_getSortedGroups$($DvtNBoxAutomation$$), $DvtNBoxDrawer$$ = $DvtNBoxRenderer$$.$_getSortedGroups$($DvtNBoxKeyboardHandler$$), $DvtNBoxEventManager$$ && ($DvtNBoxDataUtils$$.$getMaximizedCellIndex$($DvtNBoxAutomation$$) != $DvtNBoxDataUtils$$.$getMaximizedCellIndex$($DvtNBoxKeyboardHandler$$) ? ($DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataAnimationHandler$$.filter(function($dvt$$5$$) {
      return $dvt$$5$$.getData().cell != $DvtNBoxDataUtils$$.$getMaximizedCellIndex$($DvtNBoxAutomation$$);
    }), $DvtNBoxDrawer$$ = $DvtNBoxDrawer$$.filter(function($dvt$$5$$) {
      return $dvt$$5$$.getData().cell != $DvtNBoxDataUtils$$.$getMaximizedCellIndex$($DvtNBoxAutomation$$);
    })) : $DvtNBoxDrawer$$ = $DvtNBoxDataAnimationHandler$$ = null), $dvt$$5$$.$constructAnimation$($DvtNBoxDataAnimationHandler$$, $DvtNBoxDrawer$$));
  };
  ...
  $DvtNBoxRenderer$$.$getNodeOrderFunction$ = function $$DvtNBoxRenderer$$$$getNodeOrderFunction$$($DvtNBoxAutomation$$) {
    ...
    if ($DvtNBoxEventManager$$) {
      ...
      for ($DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getRowCount$($DvtNBoxAutomation$$) * $DvtNBoxDataUtils$$.$getColumnCount$($DvtNBoxAutomation$$), $DvtNBoxDataAnimationHandler$$ = 0;$DvtNBoxDataAnimationHandler$$ < $DvtNBoxEventManager$$;$DvtNBoxDataAnimationHandler$$++) {
        ...
        $DvtNBoxCategoryRolloverHandler$$ instanceof $dvt$$5$$.$SimpleScrollableContainer$ && ($DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxCategoryRolloverHandler$$.$_container$);
  ...
  $DvtNBoxCellRenderer$$.$render$ = function $$DvtNBoxCellRenderer$$$$render$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    var $DvtNBoxDrawer$$ = $DvtNBoxAutomation$$.$getOptions$(), $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDrawer$$.__layout.cellGap, $DvtNBoxCategoryNode$$ = $DvtNBoxDrawer$$.__layout.cellStartGap, $DvtNBoxCell$$ = $DvtNBoxDrawer$$.__layout.cellEndGap, $DvtNBoxNodeOverflow$$ = $DvtNBoxDrawer$$.__layout.cellTopGap, $DvtNBoxDrawer$$ = $DvtNBoxDrawer$$.__layout.cellBottomGap, $DvtNBoxNode$$ = $DvtNBoxCellRenderer$$.$getCellLayout$($DvtNBoxAutomation$$), $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getRowIndex$($DvtNBoxAutomation$$, 
    $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$ROW$]), $DvtNBoxRenderer$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$]), $DvtNBoxNodeRenderer$$ = $DvtNBoxCellRenderer$$.$getCellDimensions$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$, $DvtNBoxRenderer$$, $DvtNBoxDataAnimationHandler$$);
    $DvtNBoxEventManager$$.$setTranslate$($DvtNBoxNodeRenderer$$.x + $DvtNBoxCategoryRolloverHandler$$ / 2, $DvtNBoxNodeRenderer$$.y + $DvtNBoxCategoryRolloverHandler$$ / 2);
    $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDefaults$$ * $DvtNBoxDataUtils$$.$getColumnCount$($DvtNBoxAutomation$$) + $DvtNBoxRenderer$$;
    $DvtNBoxCategoryRolloverHandler$$ = new $dvt$$5$$.Rect($DvtNBoxAutomation$$.$getCtx$(), 0, 0, Math.max($DvtNBoxNodeRenderer$$.$w$ - $DvtNBoxCategoryRolloverHandler$$, 0), Math.max($DvtNBoxNodeRenderer$$.$h$ - $DvtNBoxCategoryRolloverHandler$$, 0));
    ...
    $DvtNBoxCellRenderer$$.$_applyStyleToRect$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxDefaults$$);
    $DvtNBoxDefaults$$ = $DvtNBoxStyleUtils$$.$getCellStyleObject$($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$);
    $DvtNBoxCategoryRolloverHandler$$.$setStyle$($DvtNBoxDefaults$$);
    $DvtNBoxDefaults$$ = $DvtNBoxStyleUtils$$.$getCellClassName$($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$);
    $DvtNBoxCategoryRolloverHandler$$.$setClassName$($DvtNBoxDefaults$$);
    ...
    $DvtNBoxDefaults$$ = new $dvt$$5$$.$KeyboardFocusEffect$($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxEventManager$$, new $dvt$$5$$.$Rectangle$(-1, -1, $DvtNBoxCategoryRolloverHandler$$.getWidth() + 2, $DvtNBoxCategoryRolloverHandler$$.getHeight() + 2));
    ...
    $DvtNBoxDefaults$$ = $DvtNBoxDefaults$$ ? new $dvt$$5$$.$SimpleScrollableContainer$($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxCategoryRolloverHandler$$.getWidth(), $DvtNBoxCategoryRolloverHandler$$.getHeight() - $DvtNBoxDataAnimationHandler$$) : new $dvt$$5$$.$Container$($DvtNBoxAutomation$$.$getCtx$());
  ...
  $DvtNBoxCellRenderer$$.$renderHeader$ = function $$DvtNBoxCellRenderer$$$$renderHeader$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    var $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $dvt$$5$$.$NBoxConstants$.$LABEL$);
    $DvtNBoxDrawer$$ && ($DvtNBoxDrawer$$.getParent().removeChild($DvtNBoxDrawer$$), $DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, null, $dvt$$5$$.$NBoxConstants$.$LABEL$));
    ...
    if ($DvtNBoxKeyboardHandler$$) {
      var $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxAutomation$$.$getOptions$(), $DvtNBoxDrawer$$ = $DvtNBoxCategoryRolloverHandler$$.__layout.countLabelGap, $DvtNBoxCategoryNode$$ = $DvtNBoxCategoryRolloverHandler$$.__layout.cellCloseGap, $DvtNBoxCell$$ = $DvtNBoxCategoryRolloverHandler$$.__layout.cellStartGap, $DvtNBoxNodeOverflow$$ = $DvtNBoxCategoryRolloverHandler$$.__layout.cellEndGap, $DvtNBoxNode$$ = $DvtNBoxCategoryRolloverHandler$$.__layout.cellTopGap, $DvtNBoxDefaults$$ = $DvtNBoxCellRenderer$$.$getCellLayout$($DvtNBoxAutomation$$), 
      $DvtNBoxNodeRenderer$$ = $DvtNBoxRenderer$$.$getCellCounts$($DvtNBoxAutomation$$), $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, "background"), $DvtNBoxDrawerRenderer$$ = $DvtNBoxDataUtils$$.$getRowIndex$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$ROW$]), $c$$25_cellIndex$$7$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$]), 
      $c$$25_cellIndex$$7$$ = $DvtNBoxDrawerRenderer$$ * $DvtNBoxDataUtils$$.$getColumnCount$($DvtNBoxAutomation$$) + $c$$25_cellIndex$$7$$, $DvtNBoxDrawerRenderer$$ = $dvt$$5$$.$Agent$.$isRightToLeft$($DvtNBoxAutomation$$.$getCtx$()), $cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$ = 0;
      if ($DvtNBoxDataUtils$$.$isCellMaximized$($DvtNBoxAutomation$$, $c$$25_cellIndex$$7$$)) {
        ...
        $DvtNBoxCategoryNodeRenderer$$.getWidth() - $DvtNBoxCell$$ - $DvtNBoxNodeOverflow$$ > $closeWidth_halign$$14$$ && ($cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$ = $DvtNBoxCategoryRolloverHandler$$._resources.close_ovr, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxCategoryRolloverHandler$$._resources.close_dwn, $closeEna_closeEnaImg_countLabelY$$ = new $dvt$$5$$.Image($DvtNBoxAutomation$$.$getCtx$(), $closeEna_closeEnaImg_countLabelY$$.src, 0, 0, $closeEna_closeEnaImg_countLabelY$$.width, 
        ...
        0, $DvtNBoxCategoryRolloverHandler$$.width, $DvtNBoxCategoryRolloverHandler$$.height), $DvtNBoxCategoryRolloverHandler$$ = new $dvt$$5$$.$Button$($DvtNBoxAutomation$$.$getCtx$(), $closeEna_closeEnaImg_countLabelY$$, $cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$, $DvtNBoxCategoryRolloverHandler$$, null, null, $DvtNBoxEventManager$$.$handleDoubleClick$, $DvtNBoxEventManager$$), $cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$ = $DvtNBoxDrawerRenderer$$ ? Math.min(($DvtNBoxCategoryNodeRenderer$$.getWidth() - 
        $closeWidth_halign$$14$$) / 2, $DvtNBoxNodeOverflow$$) : Math.max(($DvtNBoxCategoryNodeRenderer$$.getWidth() - $closeWidth_halign$$14$$) / 2, $DvtNBoxCategoryNodeRenderer$$.getWidth() - $DvtNBoxNodeOverflow$$ - $closeWidth_halign$$14$$), $DvtNBoxCategoryRolloverHandler$$.$setTranslate$($cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$, $DvtNBoxNode$$), $DvtNBoxEventManager$$.$addChild$($DvtNBoxCategoryRolloverHandler$$), $cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$ = 
        $closeWidth_halign$$14$$ + $DvtNBoxCategoryNode$$, $DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxCategoryRolloverHandler$$, "closeButton"));
      }
      if ($DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$LABEL$]) {
        var $DvtNBoxCategoryNode$$ = $DvtNBoxDefaults$$.labelHeight, $skipLabel$$ = !1, $closeWidth_halign$$14$$ = $DvtNBoxStyleUtils$$.$getLabelHalign$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$), $countLabelWidthWithGap$$ = $DvtNBoxCategoryRolloverHandler$$ = 0, $DvtNBoxDefaults$$ = null, $closeEna_closeEnaImg_countLabelY$$ = $DvtNBoxCategoryRolloverHandler$$ = 0, $countText$$ = null, $showCount$$ = $DvtNBoxStyleUtils$$.$getCellShowCount$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$);
        ...
        $DvtNBoxCategoryNodeRenderer$$.getWidth() - 2 * $DvtNBoxNode$$, $DvtNBoxEventManager$$) ? ($DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxDefaults$$, "countLabel"), $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDefaults$$.$getDimensions$().$w$, $countLabelWidthWithGap$$ = $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxDrawer$$, $closeEna_closeEnaImg_countLabelY$$ = $DvtNBoxCategoryNodeRenderer$$.getHeight() / 2, $DvtNBoxCategoryRolloverHandler$$ = 
        $DvtNBoxNode$$ + $DvtNBoxCategoryNode$$ / 2) : $skipLabel$$ = !0), $DvtNBoxDataAnimationHandler$$ = 0, $skipLabel$$ || ($DvtNBoxNodeRenderer$$ = $DvtNBoxRenderer$$.$createText$($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$LABEL$], $DvtNBoxStyleUtils$$.$getCellLabelStyle$($DvtNBoxAutomation$$, $c$$25_cellIndex$$7$$), $dvt$$5$$.$OutputText$.$H_ALIGN_CENTER$, $dvt$$5$$.$OutputText$.$V_ALIGN_MIDDLE$), $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxNodeRenderer$$, 
        $DvtNBoxCategoryNodeRenderer$$.getHeight() - $DvtNBoxCell$$ - $DvtNBoxNodeOverflow$$ - $countLabelWidthWithGap$$, $DvtNBoxCategoryNodeRenderer$$.getWidth() - 2 * $DvtNBoxNode$$, $DvtNBoxEventManager$$) && ($DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxNodeRenderer$$, $dvt$$5$$.$NBoxConstants$.$LABEL$), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxNodeRenderer$$.$getDimensions$().$w$, $DvtNBoxRenderer$$.$positionText$($DvtNBoxNodeRenderer$$, $DvtNBoxNode$$ + 
        $DvtNBoxCategoryNode$$ / 2, ($DvtNBoxCategoryNodeRenderer$$.getHeight() + $countLabelWidthWithGap$$) / 2, $DvtNBoxDrawerRenderer$$ ? Math.PI / 2 : -Math.PI / 2), $DvtNBoxDataAnimationHandler$$ = ($DvtNBoxDataAnimationHandler$$ + $DvtNBoxDrawer$$) / 2)), $DvtNBoxDefaults$$ && $DvtNBoxRenderer$$.$positionText$($DvtNBoxDefaults$$, $DvtNBoxCategoryRolloverHandler$$, $closeEna_closeEnaImg_countLabelY$$ - $DvtNBoxDataAnimationHandler$$, $DvtNBoxDrawerRenderer$$ ? Math.PI / 2 : -Math.PI / 2)) : 
        ($countText$$ && ($DvtNBoxDefaults$$ = $DvtNBoxRenderer$$.$createText$($DvtNBoxAutomation$$.$getCtx$(), $countText$$, $DvtNBoxStyleUtils$$.$getCellCountLabelStyle$($DvtNBoxAutomation$$), $closeWidth_halign$$14$$, $dvt$$5$$.$OutputText$.$V_ALIGN_MIDDLE$), $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxDefaults$$, $DvtNBoxCategoryNodeRenderer$$.getWidth() - $DvtNBoxCell$$ - $DvtNBoxNodeOverflow$$ - $cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$, $DvtNBoxCategoryNodeRenderer$$.getHeight() - 
        2 * $DvtNBoxNode$$, $DvtNBoxEventManager$$) ? ($DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxDefaults$$, "countLabel"), $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDefaults$$.$getDimensions$().$w$, $countLabelWidthWithGap$$ = $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$ = $closeWidth_halign$$14$$ == $dvt$$5$$.$OutputText$.$H_ALIGN_CENTER$ ? $DvtNBoxCategoryNodeRenderer$$.getWidth() / 2 : $closeWidth_halign$$14$$ == 
        $dvt$$5$$.$OutputText$.$H_ALIGN_RIGHT$ ? $DvtNBoxCategoryNodeRenderer$$.getWidth() - $DvtNBoxNodeOverflow$$ : $DvtNBoxCell$$, $closeEna_closeEnaImg_countLabelY$$ = $DvtNBoxNode$$ + $DvtNBoxCategoryNode$$ / 2, $DvtNBoxRenderer$$.$positionText$($DvtNBoxDefaults$$, $DvtNBoxCategoryRolloverHandler$$, $closeEna_closeEnaImg_countLabelY$$)) : $skipLabel$$ = !0), $DvtNBoxDataAnimationHandler$$ = 0, $skipLabel$$ || ($DvtNBoxNodeRenderer$$ = $DvtNBoxRenderer$$.$createText$($DvtNBoxAutomation$$.$getCtx$(), 
        $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$LABEL$], $DvtNBoxStyleUtils$$.$getCellLabelStyle$($DvtNBoxAutomation$$, $c$$25_cellIndex$$7$$), $closeWidth_halign$$14$$, $dvt$$5$$.$OutputText$.$V_ALIGN_MIDDLE$), $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxNodeRenderer$$, $DvtNBoxCategoryNodeRenderer$$.getWidth() - $DvtNBoxCell$$ - $DvtNBoxNodeOverflow$$ - $cellCloseWidthWithGap_closeButtonX_closeOvr_closeOvrImg$$ - $countLabelWidthWithGap$$, $DvtNBoxCategoryNodeRenderer$$.getHeight() - 2 * 
        $DvtNBoxNode$$, $DvtNBoxEventManager$$) && ($DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxNodeRenderer$$, $dvt$$5$$.$NBoxConstants$.$LABEL$), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxNodeRenderer$$.$getDimensions$().$w$, $closeWidth_halign$$14$$ == $dvt$$5$$.$OutputText$.$H_ALIGN_CENTER$ ? ($DvtNBoxCell$$ = ($DvtNBoxCategoryNodeRenderer$$.getWidth() - ($DvtNBoxDrawerRenderer$$ ? -1 : 1) * $countLabelWidthWithGap$$) / 2, $DvtNBoxDataAnimationHandler$$ = 
        ($DvtNBoxDrawerRenderer$$ ? -1 : 1) * ($DvtNBoxDataAnimationHandler$$ + $DvtNBoxDrawer$$) / 2) : $closeWidth_halign$$14$$ == $dvt$$5$$.$OutputText$.$H_ALIGN_RIGHT$ ? ($DvtNBoxCell$$ = $DvtNBoxCategoryNodeRenderer$$.getWidth() - $DvtNBoxNodeOverflow$$ - ($DvtNBoxDrawerRenderer$$ ? 0 : 1) * $countLabelWidthWithGap$$, $DvtNBoxDataAnimationHandler$$ = ($DvtNBoxDrawerRenderer$$ ? -1 : 0) * ($DvtNBoxDataAnimationHandler$$ + $DvtNBoxDrawer$$)) : ($DvtNBoxCell$$ += ($DvtNBoxDrawerRenderer$$ ? 1 : 
        0) * $countLabelWidthWithGap$$, $DvtNBoxDataAnimationHandler$$ = ($DvtNBoxDrawerRenderer$$ ? 0 : 1) * ($DvtNBoxDataAnimationHandler$$ + $DvtNBoxDrawer$$)), $DvtNBoxRenderer$$.$positionText$($DvtNBoxNodeRenderer$$, $DvtNBoxCell$$, $DvtNBoxNode$$ + $DvtNBoxCategoryNode$$ / 2))), $DvtNBoxDefaults$$ && $DvtNBoxDataAnimationHandler$$ && $DvtNBoxRenderer$$.$positionText$($DvtNBoxDefaults$$, $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxDataAnimationHandler$$, $closeEna_closeEnaImg_countLabelY$$));
      }
    }
  ...
  $DvtNBoxCellRenderer$$.$renderBodyCountLabels$ = function $$DvtNBoxCellRenderer$$$$renderBodyCountLabels$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    for (var $maximizedLabels$$ = [], $minimizedLabels$$ = [], $DvtNBoxDrawerRenderer$$ = 0;$DvtNBoxDrawerRenderer$$ < $DvtNBoxNodeRenderer$$.length;$DvtNBoxDrawerRenderer$$++) {
      $DvtNBoxNodeOverflow$$ = $DvtNBoxNodeRenderer$$[$DvtNBoxDrawerRenderer$$], $DvtNBoxNodeOverflow$$ = $DvtNBoxCategoryRolloverHandler$$.total[$DvtNBoxNodeOverflow$$], $maximizedLabels$$[$DvtNBoxDrawerRenderer$$] = $DvtNBoxRenderer$$.$createText$($DvtNBoxAutomation$$.$getCtx$(), "" + $DvtNBoxNodeOverflow$$, $DvtNBoxStyleUtils$$.$getCellBodyCountLabelStyle$($DvtNBoxAutomation$$), $dvt$$5$$.$OutputText$.$H_ALIGN_CENTER$, $dvt$$5$$.$OutputText$.$V_ALIGN_MIDDLE$);
    }
    for ($DvtNBoxDrawerRenderer$$ = 0;$DvtNBoxDrawerRenderer$$ < $DvtNBoxCategoryNodeRenderer$$.length;$DvtNBoxDrawerRenderer$$++) {
      $DvtNBoxNodeOverflow$$ = $DvtNBoxCategoryNodeRenderer$$[$DvtNBoxDrawerRenderer$$], $DvtNBoxNodeOverflow$$ = $DvtNBoxCategoryRolloverHandler$$.total[$DvtNBoxNodeOverflow$$], $minimizedLabels$$[$DvtNBoxDrawerRenderer$$] = $DvtNBoxRenderer$$.$createText$($DvtNBoxAutomation$$.$getCtx$(), "" + $DvtNBoxNodeOverflow$$, $DvtNBoxStyleUtils$$.$getCellBodyCountLabelStyle$($DvtNBoxAutomation$$), $dvt$$5$$.$OutputText$.$H_ALIGN_CENTER$, $dvt$$5$$.$OutputText$.$V_ALIGN_MIDDLE$);
    }
    $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxCellRenderer$$.$getBodyCountLabelsFontSize$($DvtNBoxAutomation$$, $DvtNBoxNodeRenderer$$, $maximizedLabels$$);
    if ($DvtNBoxCategoryRolloverHandler$$ <= $DvtNBoxCategoryNode$$ || $DvtNBoxDefaults$$ && !$DvtNBoxNode$$) {
      $DvtNBoxCell$$ = !0;
    }
    ...
    if ($DvtNBoxCell$$) {
      for ($DvtNBoxDrawerRenderer$$ = 0;$DvtNBoxDrawerRenderer$$ < $DvtNBoxKeyboardHandler$$.length;$DvtNBoxDrawerRenderer$$++) {
        $DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$[$DvtNBoxDrawerRenderer$$]), $DvtNBoxNode$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$, $dvt$$5$$.$NBoxConstants$.$LABEL$), $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$, "countLabel"), $DvtNBoxCategoryNode$$ = $DvtNBoxNodeOverflow$$.__childArea, $DvtNBoxCategoryRolloverHandler$$ = !1, $DvtNBoxNode$$ && 
        ($DvtNBoxNode$$.getParent().removeChild($DvtNBoxNode$$), $DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$, null, $dvt$$5$$.$NBoxConstants$.$LABEL$), $DvtNBoxCategoryRolloverHandler$$ = !0), $DvtNBoxDefaults$$ && ($DvtNBoxDefaults$$.getParent().removeChild($DvtNBoxDefaults$$), $DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$, null, "countLabel"), $DvtNBoxCategoryRolloverHandler$$ = !0), $DvtNBoxCategoryRolloverHandler$$ && ($DvtNBoxCellRenderer$$.$_isLabelVertical$($DvtNBoxAutomation$$, 
        $DvtNBoxNodeOverflow$$) ? ($DvtNBoxCategoryNode$$.x -= $DvtNBoxDrawer$$.headerSize - $DvtNBoxDataAnimationHandler$$, $DvtNBoxCategoryNode$$.$w$ += $DvtNBoxDrawer$$.headerSize - $DvtNBoxDataAnimationHandler$$) : ($DvtNBoxCategoryNode$$.y -= $DvtNBoxDrawer$$.headerSize - $DvtNBoxEventManager$$, $DvtNBoxCategoryNode$$.$h$ += $DvtNBoxDrawer$$.headerSize - $DvtNBoxEventManager$$), $DvtNBoxNodeOverflow$$.__childArea = $DvtNBoxCategoryNode$$);
      }
      $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxCellRenderer$$.$getBodyCountLabelsFontSize$($DvtNBoxAutomation$$, $DvtNBoxNodeRenderer$$, $maximizedLabels$$);
    ...
    for ($DvtNBoxDrawerRenderer$$ = 0;$DvtNBoxDrawerRenderer$$ < $DvtNBoxNodeRenderer$$.length;$DvtNBoxDrawerRenderer$$++) {
      $DvtNBoxNodeOverflow$$ = $DvtNBoxNodeRenderer$$[$DvtNBoxDrawerRenderer$$], $DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$), $DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$), $DvtNBoxCategoryNode$$ = $DvtNBoxNodeOverflow$$.__childArea, $maximizedLabels$$[$DvtNBoxDrawerRenderer$$].$setFontSize$($DvtNBoxCategoryRolloverHandler$$), $dvt$$5$$.$TextUtils$.$fitText$($maximizedLabels$$[$DvtNBoxDrawerRenderer$$], 
  ...
  $DvtNBoxCellRenderer$$.$getBodyCountLabelsFontSize$ = function $$DvtNBoxCellRenderer$$$$getBodyCountLabelsFontSize$$($dvt$$5$$, $DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    for (var $DvtNBoxEventManager$$ = Number.MAX_VALUE, $DvtNBoxDataAnimationHandler$$ = 0;$DvtNBoxDataAnimationHandler$$ < $DvtNBoxAutomation$$.length;$DvtNBoxDataAnimationHandler$$++) {
      var $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getCell$($dvt$$5$$, $DvtNBoxAutomation$$[$DvtNBoxDataAnimationHandler$$]).__childArea, $DvtNBoxEventManager$$ = Math.min($DvtNBoxEventManager$$, $DvtNBoxKeyboardHandler$$[$DvtNBoxDataAnimationHandler$$].$getOptimalFontSize$($DvtNBoxDrawer$$))
    }
    return $DvtNBoxEventManager$$;
  };
  ...
  $DvtNBoxCellRenderer$$.$getCellDimensions$ = function $$DvtNBoxCellRenderer$$$$getCellDimensions$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    ...
    $DvtNBoxDefaults$$ && ($DvtNBoxDrawerRenderer$$ = $DvtNBoxDataUtils$$.$getRowIndex$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$), $DvtNBoxDefaults$$ = Math.min($DvtNBoxDataAnimationHandler$$.$h$ / (3 * ($DvtNBoxCell$$ - 1)), $DvtNBoxCategoryRolloverHandler$$), $DvtNBoxKeyboardHandler$$ < $DvtNBoxDrawerRenderer$$ ? ($DvtNBoxDrawerRenderer$$ = $DvtNBoxDataAnimationHandler$$.y + $DvtNBoxDataAnimationHandler$$.$h$ - ($DvtNBoxKeyboardHandler$$ + 1) * $DvtNBoxDefaults$$, $DvtNBoxNodeOverflow$$ = $DvtNBoxDefaults$$, 
    $DvtNBoxStyleUtils$$ = !1) : $DvtNBoxKeyboardHandler$$ == $DvtNBoxDrawerRenderer$$ ? ($DvtNBoxDrawerRenderer$$ = $DvtNBoxDataAnimationHandler$$.y + ($DvtNBoxCell$$ - $DvtNBoxKeyboardHandler$$ - 1) * $DvtNBoxDefaults$$, $DvtNBoxNodeOverflow$$ = $DvtNBoxDataAnimationHandler$$.$h$ - ($DvtNBoxCell$$ - 1) * $DvtNBoxDefaults$$) : ($DvtNBoxDrawerRenderer$$ = $DvtNBoxDataAnimationHandler$$.y + ($DvtNBoxCell$$ - $DvtNBoxKeyboardHandler$$ - 1) * $DvtNBoxDefaults$$, $DvtNBoxNodeOverflow$$ = $DvtNBoxDefaults$$, 
    $DvtNBoxStyleUtils$$ = !1));
    $DvtNBoxNodeRenderer$$ && $DvtNBoxStyleUtils$$ && ($DvtNBoxAutomation$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($DvtNBoxAutomation$$, $DvtNBoxNodeRenderer$$), $DvtNBoxKeyboardHandler$$ = Math.min($DvtNBoxDataAnimationHandler$$.$w$ / (3 * ($DvtNBoxDrawer$$ - 1)), $DvtNBoxCategoryRolloverHandler$$), $DvtNBoxEventManager$$ < $DvtNBoxAutomation$$ ? ($DvtNBoxNode$$ = $DvtNBoxKeyboardHandler$$, $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataAnimationHandler$$.x + ($DvtNBoxCategoryNode$$ ? $DvtNBoxDataAnimationHandler$$.$w$ - 
    $DvtNBoxKeyboardHandler$$ : 0) + ($DvtNBoxCategoryNode$$ ? -1 : 1) * $DvtNBoxEventManager$$ * $DvtNBoxKeyboardHandler$$) : $DvtNBoxEventManager$$ == $DvtNBoxAutomation$$ ? ($DvtNBoxNode$$ = $DvtNBoxDataAnimationHandler$$.$w$ - ($DvtNBoxDrawer$$ - 1) * $DvtNBoxKeyboardHandler$$, $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataAnimationHandler$$.x + ($DvtNBoxCategoryNode$$ ? $DvtNBoxDataAnimationHandler$$.$w$ - $DvtNBoxNode$$ : 0) + ($DvtNBoxCategoryNode$$ ? -1 : 1) * $DvtNBoxEventManager$$ * $DvtNBoxKeyboardHandler$$) : 
    ($DvtNBoxNode$$ = $DvtNBoxKeyboardHandler$$, $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataAnimationHandler$$.x + ($DvtNBoxCategoryNode$$ ? -$DvtNBoxKeyboardHandler$$ : $DvtNBoxDataAnimationHandler$$.$w$) + ($DvtNBoxCategoryNode$$ ? 1 : -1) * ($DvtNBoxDrawer$$ - $DvtNBoxEventManager$$) * $DvtNBoxKeyboardHandler$$));
  ...
  $DvtNBoxCellRenderer$$.$animateUpdate$ = function $$DvtNBoxCellRenderer$$$$animateUpdate$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    var $DvtNBoxDrawer$$ = $DvtNBoxAutomation$$.$_oldNBox$, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxAutomation$$.$_newNBox$, $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$CustomAnimation$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxEventManager$$, $DvtNBoxAutomation$$.$getAnimationDuration$()), $DvtNBoxCell$$ = $DvtNBoxEventManager$$.$getChildContainer$(), $DvtNBoxNodeOverflow$$ = $DvtNBoxCell$$.$getMatrix$();
    ...
    var $DvtNBoxNodeRenderer$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxDrawer$$, $DvtNBoxKeyboardHandler$$.getData(), "background"), $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxEventManager$$.getData(), "background"), $DvtNBoxDrawerRenderer$$ = $dvt$$5$$.$Agent$.$isRightToLeft$($DvtNBoxCategoryRolloverHandler$$.$getCtx$()) ? 0 : $DvtNBoxCategoryNodeRenderer$$.getWidth() - $DvtNBoxNodeRenderer$$.getWidth();
    ...
    $DvtNBoxEventManager$$.$isShowingKeyboardFocusEffect$() && ($DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxEventManager$$.getData(), "focusEffect").$getEffect$()) && ($DvtNBoxCategoryNode$$.$_animator$.$addProp$($dvt$$5$$.$Animator$.$TYPE_NUMBER$, $DvtNBoxCategoryNodeRenderer$$, $DvtNBoxCategoryNodeRenderer$$.getWidth, $DvtNBoxCategoryNodeRenderer$$.$setWidth$, $DvtNBoxCategoryNodeRenderer$$.getWidth()), $DvtNBoxCategoryNodeRenderer$$.$setWidth$($DvtNBoxNodeRenderer$$.getWidth() + 
    ...
    $DvtNBoxKeyboardHandler$$ ? $DvtNBoxDrawer$$ ? ($DvtNBoxCategoryNode$$.$_animator$.$addProp$($dvt$$5$$.$Animator$.$TYPE_MATRIX$, $DvtNBoxDrawer$$, $DvtNBoxDrawer$$.$getMatrix$, $DvtNBoxDrawer$$.$setMatrix$, $DvtNBoxDrawer$$.$getMatrix$()), $DvtNBoxDrawer$$.$setMatrix$($DvtNBoxKeyboardHandler$$.$getMatrix$())) : ($DvtNBoxDrawer$$ = $DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxKeyboardHandler$$), $DvtNBoxKeyboardHandler$$.$setTranslate$($DvtNBoxKeyboardHandler$$.$getTranslateX$() + $DvtNBoxDrawerRenderer$$ + 
    $DvtNBoxNode$$, $DvtNBoxKeyboardHandler$$.$getTranslateY$() + $DvtNBoxDefaults$$), $DvtNBoxAutomation$$.add(new $dvt$$5$$.$AnimFadeOut$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$()), $DvtNBoxDataAnimationHandler$$.$UPDATE$), $DvtNBoxCategoryNode$$.$_animator$.$addProp$($dvt$$5$$.$Animator$.$TYPE_MATRIX$, $DvtNBoxKeyboardHandler$$, $DvtNBoxKeyboardHandler$$.$getMatrix$, $DvtNBoxKeyboardHandler$$.$setMatrix$, $DvtNBoxKeyboardHandler$$.$getMatrix$()), 
    $DvtNBoxKeyboardHandler$$.$setMatrix$($DvtNBoxDrawer$$), $DvtNBoxCategoryRolloverHandler$$.$_deleteContainer$.$addChild$($DvtNBoxKeyboardHandler$$)) : $DvtNBoxDrawer$$ && ($DvtNBoxAutomation$$.add(new $dvt$$5$$.$AnimFadeIn$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxDrawer$$, $DvtNBoxAutomation$$.$getAnimationDuration$()), $DvtNBoxDataAnimationHandler$$.$UPDATE$), $DvtNBoxCategoryNode$$.$_animator$.$addProp$($dvt$$5$$.$Animator$.$TYPE_MATRIX$, $DvtNBoxDrawer$$, $DvtNBoxDrawer$$.$getMatrix$, 
    $DvtNBoxDrawer$$.$setMatrix$, $DvtNBoxDrawer$$.$getMatrix$()), $DvtNBoxDrawer$$.$setTranslate$($DvtNBoxDrawer$$.$getTranslateX$() - $DvtNBoxDrawerRenderer$$, $DvtNBoxDrawer$$.$getTranslateY$()), $DvtNBoxDrawer$$.$setAlpha$(0));
  ...
  $DvtNBoxCellRenderer$$.$animateInsert$ = function $$DvtNBoxCellRenderer$$$$animateInsert$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    $DvtNBoxDrawer$$ && $dvt$$5$$.$Playable$.$appendOnEnd$($DvtNBoxEventManager$$, function() {
  ...
  $DvtNBoxNodeRenderer$$.$calculateNodeLayout$ = function $$DvtNBoxNodeRenderer$$$$calculateNodeLayout$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    $DvtNBoxNode$$ = $DvtNBoxNodeRenderer$$.$_calculateSimpleNodeLayout$($DvtNBoxAutomation$$), $DvtNBoxDefaults$$ = $DvtNBoxNode$$.nodeHeight, $DvtNBoxRenderer$$ = $DvtNBoxNode$$.indicatorSectionWidth, $DvtNBoxCellRenderer$$ = $DvtNBoxNode$$.iconSectionWidth, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxRenderer$$ || $DvtNBoxCellRenderer$$ ? $DvtNBoxDrawer$$ : $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, 0), $DvtNBoxDrawerRenderer$$ = 
    $DvtNBoxDataUtils$$.$getIndicatorIcon$($DvtNBoxAutomation$$, $DvtNBoxCategoryNodeRenderer$$), $icon$$40_widestLabel$$ = $DvtNBoxDataUtils$$.$getIcon$($DvtNBoxAutomation$$, $DvtNBoxCategoryNodeRenderer$$), $labelSectionWidth_rowCount$$9$$ = 0, $DvtNBoxDrawer$$ = [], $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = 0, $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ = 0, $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ = 
    $DvtNBoxDataUtils$$.$getMaximizedRow$($DvtNBoxAutomation$$), $cellArea_ci$$3_maximizedColumn$$7$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$($DvtNBoxAutomation$$), $labelSectionWidth_rowCount$$9$$ = $DvtNBoxDataUtils$$.$getRowCount$($DvtNBoxAutomation$$), $columnCount$$9_label$$63_secondaryLabel$$ = $DvtNBoxDataUtils$$.$getColumnCount$($DvtNBoxAutomation$$), $nodeCount$$8_r$$35$$ = 0;$nodeCount$$8_r$$35$$ < $labelSectionWidth_rowCount$$9$$;$nodeCount$$8_r$$35$$++) {
      for (var $c$$26_nodeCellIndex$$ = 0;$c$$26_nodeCellIndex$$ < $columnCount$$9_label$$63_secondaryLabel$$;$c$$26_nodeCellIndex$$++) {
        $DvtNBoxDrawer$$.push({cellRows:0, cellColumns:0, overflow:!1});
      }
    }
    for (var $maximizedCellIndex$$1_nodeCounts$$ = [], $nodeCount$$8_r$$35$$ = $DvtNBoxDataUtils$$.$getNodeCount$($DvtNBoxAutomation$$), $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = 0;$cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ < $nodeCount$$8_r$$35$$;$cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$++) {
      var $cellIndex$$9_n$$22$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$);
    ...
    if ($cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ && $cellArea_ci$$3_maximizedColumn$$7$$) {
      $maximizedCellIndex$$1_nodeCounts$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($DvtNBoxAutomation$$, $cellArea_ci$$3_maximizedColumn$$7$$) + $columnCount$$9_label$$63_secondaryLabel$$ * $DvtNBoxDataUtils$$.$getRowIndex$($DvtNBoxAutomation$$, $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$);
      ...
      $labelSectionWidth_rowCount$$9$$ = Math.min($labelSectionWidth_rowCount$$9$$, $cellArea_ci$$3_maximizedColumn$$7$$.$w$ - $DvtNBoxRenderer$$ - $DvtNBoxCellRenderer$$));
      ...
      $DvtNBoxCategoryNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$LABEL$] && ($DvtNBoxDataAnimationHandler$$ = new $dvt$$5$$.$Container$, $DvtNBoxNodeOverflow$$ = !1, $columnCount$$9_label$$63_secondaryLabel$$ = $DvtNBoxDataUtils$$.$getNodeLabel$($DvtNBoxAutomation$$, $DvtNBoxCategoryNodeRenderer$$), $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = $dvt$$5$$.$TextUtils$.$guessTextDimensions$($columnCount$$9_label$$63_secondaryLabel$$).$h$, $dvt$$5$$.$TextUtils$.$fitText$($columnCount$$9_label$$63_secondaryLabel$$, 
      $labelSectionWidth_rowCount$$9$$ - $DvtNBoxCategoryRolloverHandler$$ - $DvtNBoxCategoryNode$$, $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$, $DvtNBoxDataAnimationHandler$$) && ($DvtNBoxNodeOverflow$$ = !0), $DvtNBoxCategoryNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$SECONDARY_LABEL$] && ($columnCount$$9_label$$63_secondaryLabel$$ = $DvtNBoxDataUtils$$.$getNodeSecondaryLabel$($DvtNBoxAutomation$$, $DvtNBoxCategoryNodeRenderer$$), $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = 
      $dvt$$5$$.$TextUtils$.$guessTextDimensions$($columnCount$$9_label$$63_secondaryLabel$$).$h$, $dvt$$5$$.$TextUtils$.$fitText$($columnCount$$9_label$$63_secondaryLabel$$, $labelSectionWidth_rowCount$$9$$ - $DvtNBoxCategoryRolloverHandler$$ - $DvtNBoxCategoryNode$$, $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$, $DvtNBoxDataAnimationHandler$$) && ($DvtNBoxNodeOverflow$$ = !0)), $DvtNBoxNodeOverflow$$ || ($labelSectionWidth_rowCount$$9$$ = 0, $DvtNBoxCategoryNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] && 
      ($DvtNBoxDrawerRenderer$$ && !$DvtNBoxStyleUtils$$.$getNodeIndicatorColor$($DvtNBoxAutomation$$, $DvtNBoxCategoryNodeRenderer$$) || $icon$$40_widestLabel$$ && !$icon$$40_widestLabel$$[$dvt$$5$$.$NBoxConstants$.$SOURCE$] || ($labelSectionWidth_rowCount$$9$$ = Math.max(0, Math.min($DvtNBoxCell$$, $cellArea_ci$$3_maximizedColumn$$7$$.$w$ - $DvtNBoxRenderer$$ - $DvtNBoxCellRenderer$$))))));
      ...
      if ($cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$) {
        ...
        if ($cellArea_ci$$3_maximizedColumn$$7$$) {
          for ($cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($DvtNBoxAutomation$$, $cellArea_ci$$3_maximizedColumn$$7$$), $nodeCount$$8_r$$35$$ = 0;$nodeCount$$8_r$$35$$ < $labelSectionWidth_rowCount$$9$$;$nodeCount$$8_r$$35$$++) {
            $DvtNBoxCell$$.push($cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ + $nodeCount$$8_r$$35$$ * $columnCount$$9_label$$63_secondaryLabel$$);
          }
        } else {
          for ($cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = 0;$cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ < $DvtNBoxDrawer$$.length;$cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$++) {
            $DvtNBoxCell$$.push($cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$);
          }
        }
      }
      if (null != $DvtNBoxNode$$.labelSectionWidth) {
        $labelSectionWidth_rowCount$$9$$ = $DvtNBoxNode$$.labelSectionWidth, $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxAutomation$$, $DvtNBoxCell$$[0]), $cellArea_ci$$3_maximizedColumn$$7$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$.__childArea, $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = Math.floor(($cellArea_ci$$3_maximizedColumn$$7$$.$h$ + 
        ...
        if ("ifRequired" != $DvtNBoxEventManager$$.labelTruncation) {
          ...
          ($DvtNBoxDefaults$$ + $DvtNBoxDataAnimationHandler$$)), $DvtNBoxDrawerRenderer$$ = Math.floor(($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $DvtNBoxDataAnimationHandler$$) / ($DvtNBoxRenderer$$ + $DvtNBoxCellRenderer$$ + $DvtNBoxEventManager$$.__layout.minimumLabelWidth + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCategoryNode$$ + $DvtNBoxDataAnimationHandler$$)), $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ * $DvtNBoxDrawerRenderer$$ < 
          $maximizedCellIndex$$1_nodeCounts$$[$DvtNBoxCategoryNodeRenderer$$]) {
            $labelSectionWidth_rowCount$$9$$ = Math.floor(Math.min($DvtNBoxEventManager$$.__layout.maximumLabelWidth + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCategoryNode$$, ($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $DvtNBoxDataAnimationHandler$$) / $DvtNBoxDrawerRenderer$$ - ($DvtNBoxRenderer$$ + $DvtNBoxCellRenderer$$ + $DvtNBoxDataAnimationHandler$$))), $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$, 
            $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ = $DvtNBoxDrawerRenderer$$;
          } else {
            $DvtNBoxNodeOverflow$$ = $DvtNBoxDrawerRenderer$$;
            for ($labelSectionWidth_rowCount$$9$$ = Math.floor(Math.min($DvtNBoxEventManager$$.__layout.maximumLabelWidth + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCategoryNode$$, ($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $DvtNBoxDataAnimationHandler$$) / $DvtNBoxNodeOverflow$$ - ($DvtNBoxRenderer$$ + $DvtNBoxCellRenderer$$ + $DvtNBoxDataAnimationHandler$$)));$labelSectionWidth_rowCount$$9$$ < $DvtNBoxEventManager$$.__layout.maximumLabelWidth + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCategoryNode$$;) {
              if (($DvtNBoxNodeOverflow$$ - 1) * $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ >= $maximizedCellIndex$$1_nodeCounts$$[$DvtNBoxCategoryNodeRenderer$$]) {
                $DvtNBoxNodeOverflow$$--, $labelSectionWidth_rowCount$$9$$ = Math.floor(Math.min($DvtNBoxEventManager$$.__layout.maximumLabelWidth + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCategoryNode$$, ($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $DvtNBoxDataAnimationHandler$$) / $DvtNBoxNodeOverflow$$ - ($DvtNBoxRenderer$$ + $DvtNBoxCellRenderer$$ + $DvtNBoxDataAnimationHandler$$)));
              } else {
                break;
              }
            }
            $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$;
          ...
          ($DvtNBoxDefaults$$ + $DvtNBoxDataAnimationHandler$$)), $DvtNBoxDrawerRenderer$$ = Math.floor(($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $DvtNBoxDataAnimationHandler$$) / ($DvtNBoxRenderer$$ + $DvtNBoxCellRenderer$$ + $DvtNBoxEventManager$$.__layout.minimumLabelWidth + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCategoryNode$$ + $DvtNBoxDataAnimationHandler$$)), $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$, 
          $startIndex$$9$$ = $icon$$40_widestLabel$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ = 0;$cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ <= $DvtNBoxDrawerRenderer$$;) {
            ...
            for (var $maxNodes$$1$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ * $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$, $nodeArray$$ = [], $nodeCount$$8_r$$35$$ = 0;$nodeCount$$8_r$$35$$ < $labelSectionWidth_rowCount$$9$$;$nodeCount$$8_r$$35$$++) {
              for ($c$$26_nodeCellIndex$$ = 0;$c$$26_nodeCellIndex$$ < $columnCount$$9_label$$63_secondaryLabel$$;$c$$26_nodeCellIndex$$++) {
                if ($cellIndex$$9_n$$22$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($DvtNBoxAutomation$$, $c$$26_nodeCellIndex$$) + $columnCount$$9_label$$63_secondaryLabel$$ * $DvtNBoxDataUtils$$.$getRowIndex$($DvtNBoxAutomation$$, $nodeCount$$8_r$$35$$), ($DvtNBoxNode$$ = $DvtNBoxKeyboardHandler$$[$cellIndex$$9_n$$22$$]) && $DvtNBoxNode$$.length) {
      ...
      for ($cellArea_ci$$3_maximizedColumn$$7$$ = 0;$cellArea_ci$$3_maximizedColumn$$7$$ < $DvtNBoxCell$$.length;$cellArea_ci$$3_maximizedColumn$$7$$++) {
        $cellIndex$$9_n$$22$$ = $DvtNBoxCell$$[$cellArea_ci$$3_maximizedColumn$$7$$], $DvtNBoxCategoryNode$$ = !1, $maximizedCellIndex$$1_nodeCounts$$[$cellIndex$$9_n$$22$$] > $cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$ * $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ && ($DvtNBoxCategoryNode$$ = !0), $DvtNBoxDrawer$$[$cellIndex$$9_n$$22$$] = {cellRows:$cellRows$$1_i$$544_labelHeight$$9_secondaryLabelHeight$$, cellColumns:$cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$, 
        overflow:$DvtNBoxCategoryNode$$};
      }
    }
    $DvtNBoxDefaults$$ = {nodeHeight:$DvtNBoxDefaults$$, indicatorSectionWidth:$DvtNBoxRenderer$$, iconSectionWidth:$DvtNBoxCellRenderer$$, iconWidth:$iconWidth$$9$$, labelSectionWidth:$labelSectionWidth_rowCount$$9$$, cellLayouts:$DvtNBoxDrawer$$};
  ...
  $DvtNBoxNodeRenderer$$.$calculateNodeDrawerLayout$ = function $$DvtNBoxNodeRenderer$$$$calculateNodeDrawerLayout$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    $indicatorSectionWidth$$1$$ = $DvtNBoxCategoryNodeRenderer$$.indicatorSectionWidth, $iconSectionWidth$$1$$ = $DvtNBoxCategoryNodeRenderer$$.iconSectionWidth, $DvtNBoxCategoryRolloverHandler$$ = $indicatorSectionWidth$$1$$ || $iconSectionWidth$$1$$ ? $DvtNBoxCategoryRolloverHandler$$ : $DvtNBoxCategoryNode$$;
    ...
    null == $DvtNBoxCategoryNodeRenderer$$ && ($DvtNBoxCategoryNodeRenderer$$ = "ifRequired" != $DvtNBoxDataAnimationHandler$$.labelTruncation ? $DvtNBoxNode$$ + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCell$$ : Math.max($DvtNBoxNode$$, $DvtNBoxNodeRenderer$$.$_getMaxLabelWidth$($DvtNBoxAutomation$$, $DvtNBoxEventManager$$)) + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCell$$, $DvtNBoxCategoryNodeRenderer$$ = Math.min($DvtNBoxCategoryNodeRenderer$$, $DvtNBoxKeyboardHandler$$.$w$ - $indicatorSectionWidth$$1$$ - 
    $iconSectionWidth$$1$$));
    $DvtNBoxEventManager$$ = Math.floor(($DvtNBoxKeyboardHandler$$.$w$ + $DvtNBoxDrawer$$) / ($indicatorSectionWidth$$1$$ + $iconSectionWidth$$1$$ + $DvtNBoxCategoryNodeRenderer$$ + $DvtNBoxDrawer$$));
    if ($DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.$LABEL$]) {
      var $DvtNBoxDrawer$$ = new $dvt$$5$$.$Container$, $DvtNBoxNode$$ = !1, $DvtNBoxCategoryNode$$ = $DvtNBoxDataUtils$$.$getNodeLabel$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$), $labelHeight$$10_secondaryLabelHeight$$1$$ = $dvt$$5$$.$TextUtils$.$guessTextDimensions$($DvtNBoxCategoryNode$$).$h$;
      $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxCategoryNode$$, $DvtNBoxCategoryNodeRenderer$$ - $DvtNBoxCategoryRolloverHandler$$ - $DvtNBoxCell$$, $labelHeight$$10_secondaryLabelHeight$$1$$, $DvtNBoxDrawer$$) && ($DvtNBoxNode$$ = !0);
      $DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.$SECONDARY_LABEL$] && ($DvtNBoxCategoryNode$$ = $DvtNBoxDataUtils$$.$getNodeSecondaryLabel$($DvtNBoxAutomation$$, $DvtNBoxDefaults$$), $labelHeight$$10_secondaryLabelHeight$$1$$ = $dvt$$5$$.$TextUtils$.$guessTextDimensions$($DvtNBoxCategoryNode$$).$h$, $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxCategoryNode$$, $DvtNBoxCategoryNodeRenderer$$ - $DvtNBoxCategoryRolloverHandler$$ - $DvtNBoxCell$$, $labelHeight$$10_secondaryLabelHeight$$1$$, $DvtNBoxDrawer$$) && 
      ($DvtNBoxNode$$ = !0));
  ...
  $DvtNBoxNodeRenderer$$.$_calculateSimpleNodeLayout$ = function $$DvtNBoxNodeRenderer$$$$_calculateSimpleNodeLayout$$($DvtNBoxAutomation$$) {
    ...
    $DvtNBoxCell$$), $DvtNBoxAutomation$$ = $dvt$$5$$.$TextUtils$.$guessTextDimensions$($DvtNBoxAutomation$$).$h$, $DvtNBoxKeyboardHandler$$ = Math.max($DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$ + $DvtNBoxAutomation$$ + 2 * $DvtNBoxDrawer$$ + $DvtNBoxCategoryRolloverHandler$$))) : ($DvtNBoxDefaults$$ = 0, $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] && ($DvtNBoxRenderer$$ && !$DvtNBoxStyleUtils$$.$getNodeIndicatorColor$($DvtNBoxAutomation$$, $DvtNBoxCell$$) || $DvtNBoxNodeRenderer$$ && 
    ...
    $DvtNBoxNodeRenderer$$ && ($DvtNBoxNode$$ = Math.max($DvtNBoxKeyboardHandler$$, $dvt$$5$$.$Agent$.$isTouchDevice$() ? $DvtNBoxNodeRenderer$$.preferredSizeTouch : $DvtNBoxNodeRenderer$$.preferredSize), $DvtNBoxDrawer$$ = ($DvtNBoxNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$SOURCE$] ? $DvtNBoxNodeRenderer$$.sourcePaddingRatio : $DvtNBoxNodeRenderer$$.shapePaddingRatio) * $DvtNBoxNode$$, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$HEIGHT$] ? $DvtNBoxNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$HEIGHT$] : 
    $DvtNBoxNode$$ - 2 * $DvtNBoxDrawer$$, $DvtNBoxNode$$ = ($DvtNBoxNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$WIDTH$] ? $DvtNBoxNodeRenderer$$[$dvt$$5$$.$NBoxConstants$.$WIDTH$] : $DvtNBoxNode$$ - 2 * $DvtNBoxDrawer$$) + 2 * $DvtNBoxDrawer$$, $DvtNBoxKeyboardHandler$$ = Math.max($DvtNBoxKeyboardHandler$$, $DvtNBoxCategoryRolloverHandler$$ + 2 * $DvtNBoxDrawer$$));
  ...
  $DvtNBoxNodeRenderer$$.$_renderNodeBackground$ = function $$DvtNBoxNodeRenderer$$$$_renderNodeBackground$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    ...
    var $DvtNBoxCategoryNode$$ = $DvtNBoxStyleUtils$$.$getNodeHoverColor$($DvtNBoxAutomation$$), $DvtNBoxCell$$ = $DvtNBoxStyleUtils$$.$getNodeSelectionColor$($DvtNBoxAutomation$$), $DvtNBoxNodeOverflow$$ = new $dvt$$5$$.Rect($DvtNBoxAutomation$$.$getCtx$(), 0, 0, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$);
    ...
    $DvtNBoxDrawer$$ = new $dvt$$5$$.Rect($DvtNBoxAutomation$$.$getCtx$(), 0, 0, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$);
  ...
  $DvtNBoxNodeRenderer$$.$_renderNodeIndicator$ = function $$DvtNBoxNodeRenderer$$$$_renderNodeIndicator$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    var $DvtNBoxDrawer$$ = $DvtNBoxStyleUtils$$.$getNodeColor$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$), $DvtNBoxCategoryRolloverHandler$$ = $dvt$$5$$.$ColorUtils$.$getContrastingTextColor$($DvtNBoxDrawer$$), $DvtNBoxCategoryNode$$ = $dvt$$5$$.$Agent$.$isRightToLeft$($DvtNBoxAutomation$$.$getCtx$()) ? $DvtNBoxDataAnimationHandler$$.labelSectionWidth + $DvtNBoxDataAnimationHandler$$.iconSectionWidth : 0, $DvtNBoxCell$$ = $DvtNBoxStyleUtils$$.$getNodeIndicatorColor$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$);
    if ($DvtNBoxCell$$) {
      var $DvtNBoxCategoryRolloverHandler$$ = $dvt$$5$$.$ColorUtils$.$getContrastingTextColor$($DvtNBoxCell$$), $DvtNBoxNodeOverflow$$ = new $dvt$$5$$.Rect($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxCategoryNode$$, 0, $DvtNBoxDataAnimationHandler$$.indicatorSectionWidth, $DvtNBoxDataAnimationHandler$$.nodeHeight);
    ...
    if ($DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getIndicatorIcon$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$)) {
      var $DvtNBoxNodeOverflow$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$WIDTH$], $DvtNBoxNode$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$HEIGHT$], $DvtNBoxDefaults$$ = $DvtNBoxCategoryNode$$ + $DvtNBoxDataAnimationHandler$$.indicatorSectionWidth / 2, $DvtNBoxRenderer$$ = $DvtNBoxDataAnimationHandler$$.nodeHeight / 2, $DvtNBoxCategoryNode$$ = $DvtNBoxNodeOverflow$$, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] ? $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] : 
      $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxCellRenderer$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$BORDER_COLOR$], $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$BORDER_WIDTH$], $DvtNBoxDrawerRenderer$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$BORDER_RADIUS$], $indicatorIconPattern$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$];
      ...
      "none" != $indicatorIconPattern$$ ? $DvtNBoxNodeOverflow$$.$setFill$(new $dvt$$5$$.$PatternFill$($indicatorIconPattern$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxDrawer$$)) : $DvtNBoxNodeOverflow$$.$setSolidFill$($DvtNBoxCategoryRolloverHandler$$);
  ...
  $DvtNBoxNodeRenderer$$.$_renderNodeIcon$ = function $$DvtNBoxNodeRenderer$$$$_renderNodeIcon$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    ...
    if ($DvtNBoxCell$$) {
      ...
      2, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] ? $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] : $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxRenderer$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$BORDER_COLOR$], $DvtNBoxCellRenderer$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$BORDER_WIDTH$], $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$BORDER_RADIUS$], $DvtNBoxDrawerRenderer$$ = $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$];
      ...
      "none" != $DvtNBoxDrawerRenderer$$ ? $DvtNBoxNode$$.$setFill$(new $dvt$$5$$.$PatternFill$($DvtNBoxDrawerRenderer$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxDrawer$$)) : $DvtNBoxNode$$.$setSolidFill$($DvtNBoxCategoryRolloverHandler$$);
  ...
  $DvtNBoxNodeRenderer$$.$_renderNodeLabels$ = function $$DvtNBoxNodeRenderer$$$$_renderNodeLabels$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    ...
    if ($DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$LABEL$]) {
      ...
      $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxNode$$, $DvtNBoxDataAnimationHandler$$.labelSectionWidth - $DvtNBoxCategoryNode$$ - $DvtNBoxDrawer$$, $DvtNBoxDefaults$$, $DvtNBoxEventManager$$) && ($DvtNBoxRenderer$$.$positionText$($DvtNBoxNode$$, $DvtNBoxNodeOverflow$$, $DvtNBoxDataAnimationHandler$$.nodeHeight / 2), $DvtNBoxNode$$.$getCSSStyle$() && $DvtNBoxNode$$.$getCSSStyle$().$getStyle$("color") ? $DvtNBoxNode$$.$setSolidFill$($DvtNBoxNode$$.$getCSSStyle$().$getStyle$("color")) : $DvtNBoxNode$$.$setSolidFill$($DvtNBoxCell$$), 
      $DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxNode$$, $dvt$$5$$.$NBoxConstants$.$LABEL$));
      if ($DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$SECONDARY_LABEL$]) {
        ...
        $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxCellRenderer$$, $DvtNBoxDataAnimationHandler$$.labelSectionWidth - $DvtNBoxCategoryNode$$ - $DvtNBoxDrawer$$, $DvtNBoxNodeRenderer$$, $DvtNBoxEventManager$$) && ($DvtNBoxEventManager$$ = ($DvtNBoxDataAnimationHandler$$.nodeHeight - $DvtNBoxDefaults$$ - $DvtNBoxNodeRenderer$$ - $DvtNBoxCategoryRolloverHandler$$) / 2, $DvtNBoxRenderer$$.$positionText$($DvtNBoxNode$$, $DvtNBoxNodeOverflow$$, $DvtNBoxEventManager$$ + $DvtNBoxDefaults$$ / 2), $DvtNBoxRenderer$$.$positionText$($DvtNBoxCellRenderer$$, 
        $DvtNBoxNodeOverflow$$, $DvtNBoxEventManager$$ + $DvtNBoxDefaults$$ + $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxNodeRenderer$$ / 2), $DvtNBoxCellRenderer$$.$getCSSStyle$() && $DvtNBoxCellRenderer$$.$getCSSStyle$().$getStyle$("color") ? $DvtNBoxCellRenderer$$.$setSolidFill$($DvtNBoxCellRenderer$$.$getCSSStyle$().$getStyle$("color")) : $DvtNBoxCellRenderer$$.$setSolidFill$($DvtNBoxCell$$), $DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxCellRenderer$$, 
        $dvt$$5$$.$NBoxConstants$.$SECONDARY_LABEL$));
      }
    }
  };
  ...
  $DvtNBoxNodeRenderer$$.$_clipIfNecessary$ = function $$DvtNBoxNodeRenderer$$$$_clipIfNecessary$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    if ($DvtNBoxAutomation$$ = $DvtNBoxAutomation$$ < $DvtNBoxNodeRenderer$$.$_MIN_CORNER_RADIUS$ ? 0 : $DvtNBoxAutomation$$) {
      ...
      var $DvtNBoxDrawer$$ = new $dvt$$5$$.$ClipPath$;
  ...
  $DvtNBoxNodeRenderer$$.$animateUpdate$ = function $$DvtNBoxNodeRenderer$$$$animateUpdate$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    var $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getNodeScrollableContainer$($DvtNBoxDrawer$$, $DvtNBoxKeyboardHandler$$), $DvtNBoxCellRenderer$$ = $DvtNBoxDataUtils$$.$getNodeScrollableContainer$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxEventManager$$);
    if ($DvtNBoxDefaults$$ || $DvtNBoxCellRenderer$$) {
      ...
      if ($DvtNBoxDefaults$$) {
        ...
        var $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getCellIndex$($DvtNBoxDrawer$$, $DvtNBoxKeyboardHandler$$.getData()), $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxDrawer$$, $DvtNBoxDefaults$$), $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxDrawer$$, $DvtNBoxDefaults$$, "background"), $DvtNBoxDrawerRenderer$$ = $DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxDefaults$$), $DvtNBoxDefaults$$ = new $dvt$$5$$.$Rectangle$($DvtNBoxDrawerRenderer$$.$_tx$, $DvtNBoxDrawerRenderer$$.$_ty$, 
        $DvtNBoxDefaults$$.getWidth(), $DvtNBoxDefaults$$.getHeight());
        $DvtNBoxCategoryNodeRenderer$$ = $DvtNBoxCategoryNodeRenderer$$.$getUnion$($DvtNBoxDefaults$$);
      }
      $DvtNBoxCellRenderer$$ && ($DvtNBoxDefaults$$ = $DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxCellRenderer$$), $DvtNBoxCellRenderer$$ = new $dvt$$5$$.$Rectangle$($DvtNBoxDefaults$$.$_tx$, $DvtNBoxDefaults$$.$_ty$, $DvtNBoxCellRenderer$$.getWidth(), $DvtNBoxCellRenderer$$.getHeight()), $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getCellIndex$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxEventManager$$.getData()), $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxCategoryRolloverHandler$$, 
      $DvtNBoxDefaults$$), $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxDefaults$$, "background"), $DvtNBoxDrawerRenderer$$ = $DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxDefaults$$), $DvtNBoxDefaults$$ = new $dvt$$5$$.$Rectangle$($DvtNBoxDrawerRenderer$$.$_tx$, $DvtNBoxDrawerRenderer$$.$_ty$, $DvtNBoxDefaults$$.getWidth(), $DvtNBoxDefaults$$.getHeight()), $DvtNBoxCellRenderer$$ = $DvtNBoxCellRenderer$$.$getUnion$($DvtNBoxDefaults$$), $DvtNBoxCategoryNodeRenderer$$ = 
      $DvtNBoxCategoryNodeRenderer$$ ? $DvtNBoxCategoryNodeRenderer$$.$getUnion$($DvtNBoxCellRenderer$$) : $DvtNBoxCellRenderer$$);
    ...
    $DvtNBoxCell$$ = new $dvt$$5$$.$CustomAnimation$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxEventManager$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
    ...
    $DvtNBoxNodeRenderer$$.$_animateFill$($DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $dvt$$5$$.$NBoxConstants$.$LABEL$);
    $DvtNBoxNodeRenderer$$.$_animateFill$($DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $dvt$$5$$.$NBoxConstants$.$SECONDARY_LABEL$);
    $DvtNBoxNodeRenderer$$.$_animateFill$($DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $dvt$$5$$.$NBoxConstants$.$INDICATOR$);
    $DvtNBoxNodeRenderer$$.$_animateFill$($DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON$);
    $DvtNBoxNodeRenderer$$.$_animateFill$($DvtNBoxCell$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $dvt$$5$$.$NBoxConstants$.$ICON$);
    $DvtNBoxAutomation$$.add($DvtNBoxCell$$, $DvtNBoxDataAnimationHandler$$.$UPDATE$);
  };
  ...
  $DvtNBoxNodeRenderer$$.$animateDelete$ = function $$DvtNBoxNodeRenderer$$$$animateDelete$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    if ($DvtNBoxCategoryNode$$) {
      var $DvtNBoxCell$$ = $DvtNBoxKeyboardHandler$$.getData(), $DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNodeIndex$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.ID]);
      if (!isNaN($DvtNBoxNodeOverflow$$) && ($DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxNodeOverflow$$), !$DvtNBoxDataUtils$$.$isNodeHidden$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxNodeOverflow$$))) {
        if ($DvtNBoxEventManager$$ = $DvtNBoxDataAnimationHandler$$.$UPDATE$, $DvtNBoxDataUtils$$.$getGrouping$($DvtNBoxCategoryRolloverHandler$$)) {
          ...
          if ($DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$ROW$] != $DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.$ROW$] || $DvtNBoxCell$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$] != $DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$]) {
            ...
            $DvtNBoxKeyboardHandler$$.$setMatrix$($DvtNBoxDrawer$$);
            $DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getCellByRowColumn$($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.$ROW$], $DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$]);
            ...
            $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$CustomAnimation$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxNodeOverflow$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
            ...
            $DvtNBoxAutomation$$.add(new $dvt$$5$$.$AnimMoveBy$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, new $dvt$$5$$.$Point$($DvtNBoxEventManager$$.$w$ / 2, $DvtNBoxEventManager$$.$h$ / 2), $DvtNBoxAutomation$$.$getAnimationDuration$()), $DvtNBoxDataAnimationHandler$$.$INSERT$);
            $DvtNBoxAutomation$$.add(new $dvt$$5$$.$AnimFadeOut$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$()), $DvtNBoxDataAnimationHandler$$.$INSERT$);
            return;
          }
        }
      }
      ...
      if ($DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNodeScrollableContainer$($DvtNBoxDrawer$$, $DvtNBoxKeyboardHandler$$)) {
        $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$ClipPath$, $DvtNBoxDrawer$$ = $DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxNodeOverflow$$), $DvtNBoxNodeOverflow$$ = new $dvt$$5$$.$Rectangle$($DvtNBoxDrawer$$.$_tx$, $DvtNBoxDrawer$$.$_ty$, $DvtNBoxNodeOverflow$$.$_width$, $DvtNBoxNodeOverflow$$.$_height$), $DvtNBoxCategoryNode$$.$addRect$($DvtNBoxNodeOverflow$$.x, $DvtNBoxNodeOverflow$$.y, $DvtNBoxNodeOverflow$$.$w$, $DvtNBoxNodeOverflow$$.$h$), $DvtNBoxKeyboardHandler$$.$setClipPath$($DvtNBoxCategoryNode$$)
        ;
      }
      $DvtNBoxAutomation$$.add(new $dvt$$5$$.$AnimFadeOut$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$()), $DvtNBoxEventManager$$);
      $DvtNBoxCategoryRolloverHandler$$.$_deleteContainer$.$addChild$($DvtNBoxKeyboardHandler$$);
    }
  };
  $DvtNBoxNodeRenderer$$.$animateInsert$ = function $$DvtNBoxNodeRenderer$$$$animateInsert$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    if ($DvtNBoxCategoryNode$$) {
      var $DvtNBoxCell$$ = $DvtNBoxKeyboardHandler$$.getData()[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getNodeIndex$($DvtNBoxDrawer$$, $DvtNBoxCell$$);
      if (!isNaN($DvtNBoxCell$$) && ($DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxDrawer$$, $DvtNBoxCell$$), !$DvtNBoxDataUtils$$.$isNodeHidden$($DvtNBoxDrawer$$, $DvtNBoxCell$$) && ($DvtNBoxEventManager$$ = $DvtNBoxDataAnimationHandler$$.$UPDATE$, $DvtNBoxDataUtils$$.$getGrouping$($DvtNBoxDrawer$$)))) {
        ...
        $DvtNBoxDataUtils$$.$getGroupBehavior$($DvtNBoxDrawer$$) == $dvt$$5$$.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$ && ($DvtNBoxNodeOverflow$$ = $DvtNBoxNodeOverflow$$[$DvtNBoxDataUtils$$.$getCellIndex$($DvtNBoxDrawer$$, $DvtNBoxCell$$)]);
        if ($DvtNBoxCell$$ = $DvtNBoxNodeOverflow$$[$DvtNBoxDataUtils$$.$getNodeGroupId$($DvtNBoxCell$$)]) {
          if ($DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxDrawer$$, $DvtNBoxCell$$)) {
            var $DvtNBoxNode$$ = $DvtNBoxKeyboardHandler$$.$getMatrix$(), $DvtNBoxDefaults$$ = $DvtNBoxKeyboardHandler$$.getParent(), $DvtNBoxDrawer$$ = $DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxKeyboardHandler$$), $DvtNBoxCell$$ = $DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxCell$$), $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$Point$(($DvtNBoxCategoryNode$$.indicatorSectionWidth + $DvtNBoxCategoryNode$$.iconSectionWidth + $DvtNBoxCategoryNode$$.labelSectionWidth) / 2, $DvtNBoxCategoryNode$$.nodeHeight / 
            2);
            ...
            $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$AnimMoveTo$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, new $dvt$$5$$.$Point$($DvtNBoxDrawer$$.$_tx$, $DvtNBoxDrawer$$.$_ty$), $DvtNBoxAutomation$$.$getAnimationDuration$());
            $dvt$$5$$.$Playable$.$appendOnEnd$($DvtNBoxCategoryNode$$, function() {
      ...
      $DvtNBoxCategoryRolloverHandler$$ = new $dvt$$5$$.$CustomAnimation$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
      $DvtNBoxCategoryRolloverHandler$$.$_animator$.$addProp$($dvt$$5$$.$Animator$.$TYPE_NUMBER$, $DvtNBoxKeyboardHandler$$, $DvtNBoxKeyboardHandler$$.$getAlpha$, $DvtNBoxKeyboardHandler$$.$setAlpha$, $DvtNBoxKeyboardHandler$$.$getAlpha$());
  ...
  $DvtNBoxCategoryNodeRenderer$$.$render$ = function $$DvtNBoxCategoryNodeRenderer$$$$render$$($dvt$$5$$, $DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$) {
    ...
    var $DvtNBoxDrawer$$ = $DvtNBoxCategoryNodeRenderer$$.$_renderNodeIndicator$($dvt$$5$$, $DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$);
    $DvtNBoxCategoryNodeRenderer$$.$_renderNodeCount$($dvt$$5$$, $DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDrawer$$, $DvtNBoxDataAnimationHandler$$);
  ...
  $DvtNBoxCategoryNodeRenderer$$.$_renderNodeBackground$ = function $$DvtNBoxCategoryNodeRenderer$$$$_renderNodeBackground$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$, $DvtNBoxDrawer$$) {
    ...
    $DvtNBoxDataAnimationHandler$$ = $DvtNBoxStyleUtils$$.$getNodeBorderRadius$($DvtNBoxAutomation$$);
    var $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxStyleUtils$$.$getNodeHoverColor$($DvtNBoxAutomation$$), $DvtNBoxCategoryNode$$ = $DvtNBoxStyleUtils$$.$getNodeSelectionColor$($DvtNBoxAutomation$$), $DvtNBoxCell$$ = new $dvt$$5$$.Rect($DvtNBoxAutomation$$.$getCtx$(), -$DvtNBoxDrawer$$ / 2, -$DvtNBoxDrawer$$ / 2, $DvtNBoxDrawer$$, $DvtNBoxDrawer$$);
    ...
    $DvtNBoxCell$$.$setHoverStroke$(new $dvt$$5$$.$SolidStroke$($DvtNBoxCategoryRolloverHandler$$, null, 2), new $dvt$$5$$.$SolidStroke$($DvtNBoxCategoryNode$$, null, 4));
    $DvtNBoxCell$$.$setSelectedStroke$(new $dvt$$5$$.$SolidStroke$($DvtNBoxCategoryNode$$, null, 4), null);
    $DvtNBoxCell$$.$setSelectedHoverStroke$(new $dvt$$5$$.$SolidStroke$($DvtNBoxCategoryRolloverHandler$$, null, 2), new $dvt$$5$$.$SolidStroke$($DvtNBoxCategoryNode$$, null, 6));
    $DvtNBoxEventManager$$.$addChild$($DvtNBoxCell$$);
    $DvtNBoxEventManager$$.$setSelectionShape$($DvtNBoxCell$$);
    $DvtNBoxDrawer$$ = new $dvt$$5$$.Rect($DvtNBoxAutomation$$.$getCtx$(), -$DvtNBoxDrawer$$ / 2, -$DvtNBoxDrawer$$ / 2, $DvtNBoxDrawer$$, $DvtNBoxDrawer$$);
    $DvtNBoxDataAnimationHandler$$ && ($DvtNBoxDrawer$$.$setRx$($DvtNBoxDataAnimationHandler$$), $DvtNBoxDrawer$$.$setRy$($DvtNBoxDataAnimationHandler$$));
  ...
  $DvtNBoxCategoryNodeRenderer$$.$_renderNodeIndicator$ = function $$DvtNBoxCategoryNodeRenderer$$$$_renderNodeIndicator$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$, $DvtNBoxDrawer$$) {
    var $DvtNBoxCategoryRolloverHandler$$ = !1, $DvtNBoxCategoryNode$$ = $DvtNBoxAutomation$$.$getOptions$().__layout.markerGap, $DvtNBoxCell$$ = $dvt$$5$$.$Agent$.$isRightToLeft$($DvtNBoxAutomation$$.$getCtx$()), $DvtNBoxNodeOverflow$$ = $DvtNBoxDataAnimationHandler$$ * Math.sqrt($DvtNBoxKeyboardHandler$$.nodeIndices.length) - $DvtNBoxDrawer$$;
    ...
    ($DvtNBoxDrawer$$ = $DvtNBoxStyleUtils$$.$getStyledCategoryIndicatorIcon$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$)) && ($DvtNBoxRenderer$$ = Math.min($DvtNBoxDefaults$$ / ($DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$WIDTH$] + 2 * $DvtNBoxCategoryNode$$), $DvtNBoxNodeOverflow$$ / ($DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$HEIGHT$] + 2 * $DvtNBoxCategoryNode$$)));
    if ($DvtNBoxCategoryNode$$ = $DvtNBoxStyleUtils$$.$getCategoryNodeIndicatorColor$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$)) {
      $DvtNBoxNode$$ = $dvt$$5$$.$ColorUtils$.$getContrastingTextColor$($DvtNBoxCategoryNode$$), $DvtNBoxCategoryRolloverHandler$$ = new $dvt$$5$$.Rect($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxCellRenderer$$, -$DvtNBoxNodeOverflow$$ / 2, $DvtNBoxDefaults$$, $DvtNBoxNodeOverflow$$), $DvtNBoxCategoryRolloverHandler$$.$setSolidFill$($DvtNBoxCategoryNode$$), $DvtNBoxEventManager$$.$addChild$($DvtNBoxCategoryRolloverHandler$$), $DvtNBoxCategoryRolloverHandler$$ = !0;
    }
    $DvtNBoxDrawer$$ && ($DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] ? $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] : $DvtNBoxNode$$, $DvtNBoxCell$$ = new $dvt$$5$$.$SimpleMarker$($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$SHAPE$], $dvt$$5$$.$CSSStyle$.$SKIN_ALTA$, ($DvtNBoxCell$$ ? 1 : -1) * ($DvtNBoxNodeOverflow$$ - $DvtNBoxDefaults$$) / 2, 0, $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$WIDTH$] * $DvtNBoxRenderer$$, 
    $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$HEIGHT$] * $DvtNBoxRenderer$$, $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$BORDER_RADIUS$]), $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$BORDER_WIDTH$] && $DvtNBoxCell$$.$setSolidStroke$($DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$BORDER_COLOR$], null, $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$BORDER_WIDTH$]), $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$] && "none" != $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$] ? $DvtNBoxCell$$.$setFill$(new $dvt$$5$$.$PatternFill$($DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$], 
    $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxDataAnimationHandler$$)) : $DvtNBoxCell$$.$setSolidFill$($DvtNBoxCategoryRolloverHandler$$), $DvtNBoxEventManager$$.$addChild$($DvtNBoxCell$$), $DvtNBoxDataUtils$$.$setDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxCell$$, $dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON$), $DvtNBoxCategoryRolloverHandler$$ = !0);
    return $DvtNBoxCategoryRolloverHandler$$;
  };
  $DvtNBoxCategoryNodeRenderer$$.$_renderNodeCount$ = function $$DvtNBoxCategoryNodeRenderer$$$$_renderNodeCount$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$, $DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$) {
    ...
    $DvtNBoxCategoryRolloverHandler$$ = $dvt$$5$$.$ColorUtils$.$getContrastingTextColor$($DvtNBoxCategoryRolloverHandler$$);
    $DvtNBoxNodeOverflow$$ = new $dvt$$5$$.$Rectangle$(0, 0, $DvtNBoxDrawer$$ - 2 * $DvtNBoxCategoryNode$$, $DvtNBoxDataAnimationHandler$$ - 2 * $DvtNBoxCategoryNode$$);
    ...
    $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxDefaults$$, $DvtNBoxDrawer$$ - 2 * $DvtNBoxCategoryNode$$, $DvtNBoxDataAnimationHandler$$ - 2 * $DvtNBoxCategoryNode$$, $DvtNBoxEventManager$$) && ($DvtNBoxRenderer$$.$positionText$($DvtNBoxDefaults$$, $DvtNBoxCell$$, 0), $DvtNBoxDefaults$$.$setSolidFill$($DvtNBoxCategoryRolloverHandler$$));
  };
  $DvtNBoxCategoryNodeRenderer$$.$animateUpdate$ = function $$DvtNBoxCategoryNodeRenderer$$$$animateUpdate$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    $DvtNBoxKeyboardHandler$$ = new $dvt$$5$$.$AnimMoveTo$($DvtNBoxEventManager$$.$getCtx$(), $DvtNBoxEventManager$$, new $dvt$$5$$.$Point$($DvtNBoxCategoryRolloverHandler$$.$_tx$, $DvtNBoxCategoryRolloverHandler$$.$_ty$), $DvtNBoxAutomation$$.$getAnimationDuration$());
  ...
  $DvtNBoxCategoryNodeRenderer$$.$animateDelete$ = function $$DvtNBoxCategoryNodeRenderer$$$$animateDelete$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    $DvtNBoxDrawer$$ = new $dvt$$5$$.$AnimScaleTo$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, new $dvt$$5$$.$Point$(.01, .01), $DvtNBoxAutomation$$.$getAnimationDuration$());
    $DvtNBoxAutomation$$.add($DvtNBoxDrawer$$, $DvtNBoxEventManager$$);
    $DvtNBoxDrawer$$ = new $dvt$$5$$.$AnimFadeOut$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
    $DvtNBoxAutomation$$.add($DvtNBoxDrawer$$, $DvtNBoxEventManager$$);
    $DvtNBoxKeyboardHandler$$.$setMatrix$($DvtNBoxRenderer$$.$getGlobalMatrix$($DvtNBoxKeyboardHandler$$));
    $DvtNBoxCategoryRolloverHandler$$.$_deleteContainer$.$addChild$($DvtNBoxKeyboardHandler$$);
  };
  $DvtNBoxCategoryNodeRenderer$$.$animateInsert$ = function $$DvtNBoxCategoryNodeRenderer$$$$animateInsert$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    $DvtNBoxDrawer$$ = new $dvt$$5$$.$AnimScaleTo$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, new $dvt$$5$$.$Point$(1, 1), $DvtNBoxAutomation$$.$getAnimationDuration$());
    $DvtNBoxAutomation$$.add($DvtNBoxDrawer$$, $DvtNBoxEventManager$$);
    $DvtNBoxCategoryRolloverHandler$$ = new $dvt$$5$$.$CustomAnimation$($DvtNBoxCategoryRolloverHandler$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
    $DvtNBoxCategoryRolloverHandler$$.$_animator$.$addProp$($dvt$$5$$.$Animator$.$TYPE_NUMBER$, $DvtNBoxKeyboardHandler$$, $DvtNBoxKeyboardHandler$$.$getAlpha$, $DvtNBoxKeyboardHandler$$.$setAlpha$, $DvtNBoxKeyboardHandler$$.$getAlpha$());
    $DvtNBoxAutomation$$.add($DvtNBoxCategoryRolloverHandler$$, $DvtNBoxEventManager$$);
  ...
  $DvtNBoxCategoryNodeRenderer$$.$isGroupingEqual$ = function $$DvtNBoxCategoryNodeRenderer$$$$isGroupingEqual$$($dvt$$5$$, $DvtNBoxAutomation$$) {
    var $DvtNBoxKeyboardHandler$$ = $DvtNBoxDataUtils$$.$getGroupBehavior$($dvt$$5$$), $DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getGroupBehavior$($DvtNBoxAutomation$$), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataUtils$$.$getNodeCount$($dvt$$5$$), $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getNodeCount$($DvtNBoxAutomation$$), $DvtNBoxCategoryRolloverHandler$$ = !1;
    if ($DvtNBoxKeyboardHandler$$ == $DvtNBoxEventManager$$ && $DvtNBoxDataAnimationHandler$$ == $DvtNBoxDrawer$$) {
      for ($DvtNBoxCategoryRolloverHandler$$ = !0, $DvtNBoxKeyboardHandler$$ = 0;$DvtNBoxKeyboardHandler$$ < $DvtNBoxDataAnimationHandler$$;$DvtNBoxKeyboardHandler$$++) {
        if ($DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getNodeGroupId$($DvtNBoxDataUtils$$.$getNode$($dvt$$5$$, $DvtNBoxKeyboardHandler$$)), $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getNodeGroupId$($DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$)), $DvtNBoxEventManager$$ != $DvtNBoxDrawer$$) {
  ...
  $DvtNBoxCategoryNodeRenderer$$.$isMaximizeEqual$ = function $$DvtNBoxCategoryNodeRenderer$$$$isMaximizeEqual$$($dvt$$5$$, $DvtNBoxAutomation$$) {
    var $DvtNBoxKeyboardHandler$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$($dvt$$5$$), $DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$($dvt$$5$$), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$($DvtNBoxAutomation$$), $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$($DvtNBoxAutomation$$);
  ...
  $DvtNBoxDrawerRenderer$$.$_renderHeader$ = function $$DvtNBoxDrawerRenderer$$$$_renderHeader$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    if ($DvtNBoxKeyboardHandler$$.$w$ > $closeWidth$$1$$) {
      ...
      $closeButton$$3_closeOvr$$1_closeOvrImg$$1_contrastColor$$5$$.$setTranslate$($DvtNBoxNodeRenderer$$ ? Math.min(($DvtNBoxKeyboardHandler$$.$w$ - $closeWidth$$1$$) / 2, $DvtNBoxDrawer$$) : Math.max(($DvtNBoxKeyboardHandler$$.$w$ - $closeWidth$$1$$) / 2, $DvtNBoxKeyboardHandler$$.$w$ - $DvtNBoxDrawer$$ - $closeWidth$$1$$), $DvtNBoxNode$$ / 2 - $DvtNBoxDataAnimationHandler$$ / 2);
    ...
    $DvtNBoxCell$$ = 0;
    $dvt$$5$$.$TextUtils$.$fitText$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$.$w$ - $DvtNBoxCategoryRolloverHandler$$ - $DvtNBoxCategoryNode$$ - $DvtNBoxDefaults$$ - 2 * $DvtNBoxDrawer$$ - $closeWidth$$1$$, $DvtNBoxNode$$, $DvtNBoxEventManager$$) && ($DvtNBoxRenderer$$.$positionText$($DvtNBoxAutomation$$, $DvtNBoxNodeRenderer$$ ? $DvtNBoxKeyboardHandler$$.$w$ - $DvtNBoxCategoryRolloverHandler$$ : $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxNode$$ / 2), $DvtNBoxCell$$ = $DvtNBoxAutomation$$.$measureDimensions$().$w$ + 
    $DvtNBoxCategoryNode$$);
    $countIndicatorPath_countIndicatorShape$$ && $countIndicatorPath_countIndicatorShape$$.$setTranslate$($DvtNBoxNodeRenderer$$ ? $DvtNBoxKeyboardHandler$$.$w$ - $DvtNBoxCategoryRolloverHandler$$ - $DvtNBoxDefaults$$ - $DvtNBoxCell$$ : $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxCell$$, ($DvtNBoxNode$$ - $DvtNBoxNodeOverflow$$) / 2);
  };
  $DvtNBoxDrawerRenderer$$.$_renderBody$ = function $$DvtNBoxDrawerRenderer$$$$_renderBody$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    var $DvtNBoxDataAnimationHandler$$ = $DvtNBoxAutomation$$.$getOptions$(), $DvtNBoxDrawer$$ = $DvtNBoxDataAnimationHandler$$.__layout.gridGap, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDataAnimationHandler$$.__layout.drawerHeaderHeight, $DvtNBoxCategoryNode$$ = $DvtNBoxKeyboardHandler$$.__drawerBounds, $DvtNBoxDataAnimationHandler$$ = $dvt$$5$$.$Agent$.$isRightToLeft$($DvtNBoxAutomation$$.$getCtx$()), $DvtNBoxCell$$ = $DvtNBoxStyleUtils$$.$getDrawerBorderRadius$($DvtNBoxAutomation$$), $DvtNBoxNodeOverflow$$ = 
    ...
    $DvtNBoxKeyboardHandler$$.__childArea = new $dvt$$5$$.$Rectangle$($DvtNBoxDrawer$$, $DvtNBoxCategoryRolloverHandler$$ + $DvtNBoxDrawer$$, Math.max($DvtNBoxCategoryNode$$.$w$ - 2 * $DvtNBoxDrawer$$, 0), Math.max($DvtNBoxCategoryNode$$.$h$ - $DvtNBoxCategoryRolloverHandler$$ - 2 * $DvtNBoxDrawer$$, 0));
    $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$SimpleScrollableContainer$($DvtNBoxAutomation$$.$getCtx$(), $DvtNBoxCategoryNode$$.$w$, $DvtNBoxCategoryNode$$.$h$ - $DvtNBoxCategoryRolloverHandler$$);
    ...
    if ($DvtNBoxCategoryRolloverHandler$$) {
      for ($DvtNBoxNodeOverflow$$ = 0;$DvtNBoxNodeOverflow$$ < $DvtNBoxCategoryRolloverHandler$$.length;$DvtNBoxNodeOverflow$$++) {
        $DvtNBoxCategoryNode$$[$DvtNBoxCategoryRolloverHandler$$[$DvtNBoxNodeOverflow$$][$dvt$$5$$.$NBoxConstants$.ID]] = !0;
      }
    }
    for (var $DvtNBoxNodeOverflow$$ = $DvtNBoxDrawerRenderer$$.$calculateNodeOrders$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$), $DvtNBoxCell$$ = $DvtNBoxNodeRenderer$$.$calculateNodeDrawerLayout$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxNodeOverflow$$), $DvtNBoxDefaults$$ = $DvtNBoxCell$$.indicatorSectionWidth + $DvtNBoxCell$$.iconSectionWidth + $DvtNBoxCell$$.labelSectionWidth + $DvtNBoxDrawer$$, $DvtNBoxCellRenderer$$ = $DvtNBoxCell$$.nodeHeight + $DvtNBoxDrawer$$, $DvtNBoxCategoryNodeRenderer$$ = 
    $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$).$getChildContainer$(), $n$$24$$ = 0;$n$$24$$ < $DvtNBoxNodeOverflow$$.length;$n$$24$$++) {
      var $node$$275$$ = $DvtNBoxNodeOverflow$$[$n$$24$$];
      if (0 != $DvtNBoxCell$$.drawerLayout[$dvt$$5$$.$NBoxConstants$.$COLUMNS$] && 0 != $DvtNBoxCell$$.drawerLayout[$dvt$$5$$.$NBoxConstants$.$ROWS$]) {
        var $nodeContainer$$11_prevNode$$1$$ = new $DvtNBoxNode$$($DvtNBoxAutomation$$, $node$$275$$), $gridXOrigin$$1$$ = $DvtNBoxKeyboardHandler$$.__childArea.x + ($DvtNBoxKeyboardHandler$$.__childArea.$w$ - $DvtNBoxCell$$.drawerLayout[$dvt$$5$$.$NBoxConstants$.$COLUMNS$] * $DvtNBoxDefaults$$ + $DvtNBoxDrawer$$) / 2, $gridYOrigin$$1$$ = $DvtNBoxDrawer$$, $gridColumn$$1$$ = $n$$24$$ % $DvtNBoxCell$$.drawerLayout[$dvt$$5$$.$NBoxConstants$.$COLUMNS$];
        ...
        $DvtNBoxCategoryRolloverHandler$$ && !$DvtNBoxCategoryNode$$[$node$$275$$[$dvt$$5$$.$NBoxConstants$.ID]] && $nodeContainer$$11_prevNode$$1$$.$setAlpha$($DvtNBoxEventManager$$);
        if ($nodeContainer$$11_prevNode$$1$$ = 0 < $n$$24$$ ? $DvtNBoxNodeOverflow$$[$n$$24$$ - 1] : null) {
          $node$$275$$.__prev = $nodeContainer$$11_prevNode$$1$$, $nodeContainer$$11_prevNode$$1$$.__next = $node$$275$$;
        }
      }
    }
  ...
  $DvtNBoxDrawerRenderer$$.$calculateNodeOrders$ = function $$DvtNBoxDrawerRenderer$$$$calculateNodeOrders$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    if ($DvtNBoxDataAnimationHandler$$) {
      for (var $DvtNBoxCategoryRolloverHandler$$ = 0;$DvtNBoxCategoryRolloverHandler$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxCategoryRolloverHandler$$++) {
        $DvtNBoxDrawer$$[$DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryRolloverHandler$$][$dvt$$5$$.$NBoxConstants$.ID]] = !0;
      }
    }
    ...
    for (var $DvtNBoxDataAnimationHandler$$ = [], $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDataUtils$$.$getCategoryNode$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.ID]), $DvtNBoxCategoryNode$$ = $DvtNBoxCategoryRolloverHandler$$.nodeIndices.length, $DvtNBoxNodeOverflow$$ = 0;$DvtNBoxNodeOverflow$$ < $DvtNBoxEventManager$$.length;$DvtNBoxNodeOverflow$$++) {
      for (var $DvtNBoxNode$$ = 0;$DvtNBoxNode$$ < $DvtNBoxCategoryNode$$;$DvtNBoxNode$$++) {
        var $DvtNBoxDefaults$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxCategoryRolloverHandler$$.nodeIndices[$DvtNBoxNode$$]);
        ("normal" == $DvtNBoxEventManager$$[$DvtNBoxNodeOverflow$$] || "highlighted-selected" == $DvtNBoxEventManager$$[$DvtNBoxNodeOverflow$$] && $DvtNBoxDrawer$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]] && $DvtNBoxCell$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]] || "highlighted-unselected" == $DvtNBoxEventManager$$[$DvtNBoxNodeOverflow$$] && $DvtNBoxDrawer$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]] && !$DvtNBoxCell$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]] || 
        "unhighlighted-selected" == $DvtNBoxEventManager$$[$DvtNBoxNodeOverflow$$] && !$DvtNBoxDrawer$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]] && $DvtNBoxCell$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]] || "unhighlighted-unselected" == $DvtNBoxEventManager$$[$DvtNBoxNodeOverflow$$] && !$DvtNBoxDrawer$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]] && !$DvtNBoxCell$$[$DvtNBoxDefaults$$[$dvt$$5$$.$NBoxConstants$.ID]]) && $DvtNBoxDataAnimationHandler$$.push($DvtNBoxDefaults$$);
      }
    }
    return $DvtNBoxDataAnimationHandler$$;
  };
  $DvtNBoxDrawerRenderer$$.$getDrawerBounds$ = function $$DvtNBoxDrawerRenderer$$$$getDrawerBounds$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    $DvtNBoxDataUtils$$.$getRowIndex$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$ROW$]), $DvtNBoxKeyboardHandler$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$]), $DvtNBoxAutomation$$ = $DvtNBoxCellRenderer$$.$getCellDimensions$($DvtNBoxAutomation$$, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$), $DvtNBoxCategoryRolloverHandler$$ = new $dvt$$5$$.$Rectangle$($DvtNBoxAutomation$$.x + 
  ...
  $DvtNBoxDrawerRenderer$$.$animateDelete$ = function $$DvtNBoxDrawerRenderer$$$$animateDelete$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    var $DvtNBoxEventManager$$ = $DvtNBoxDataAnimationHandler$$.$UPDATE$, $DvtNBoxDrawer$$ = $DvtNBoxAutomation$$.$_newNBox$, $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxKeyboardHandler$$.getData().__drawerBounds, $DvtNBoxCategoryNode$$ = $DvtNBoxKeyboardHandler$$.getData()[$dvt$$5$$.$NBoxConstants$.ID], $DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getCategoryNode$($DvtNBoxDrawer$$, $DvtNBoxCategoryNode$$);
    if ($DvtNBoxCell$$) {
    ...
    $DvtNBoxDrawer$$ = new $dvt$$5$$.$AnimFadeOut$($DvtNBoxDrawer$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
    $DvtNBoxAutomation$$.add($DvtNBoxDrawer$$, $DvtNBoxEventManager$$);
  };
  $DvtNBoxDrawerRenderer$$.$animateInsert$ = function $$DvtNBoxDrawerRenderer$$$$animateInsert$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    if ($DvtNBoxCell$$) {
      ...
      if ($DvtNBoxCell$$ = $DvtNBoxDataUtils$$.$getDisplayable$($DvtNBoxDrawer$$, $DvtNBoxCell$$)) {
        ...
        $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$Matrix$($DvtNBoxNodeOverflow$$, 0, 0, $DvtNBoxCategoryRolloverHandler$$, $DvtNBoxCell$$.$_tx$ - $DvtNBoxCategoryNode$$ / 2, $DvtNBoxCell$$.$_ty$ - $DvtNBoxCategoryNode$$ / 2);
        $DvtNBoxNodeOverflow$$ = new $dvt$$5$$.$CustomAnimation$($DvtNBoxDrawer$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
    ...
    $DvtNBoxKeyboardHandler$$.$setAlpha$(0);
    $DvtNBoxDrawer$$ = new $dvt$$5$$.$AnimFadeIn$($DvtNBoxDrawer$$.$getCtx$(), $DvtNBoxKeyboardHandler$$, $DvtNBoxAutomation$$.$getAnimationDuration$());
    $DvtNBoxAutomation$$.add($DvtNBoxDrawer$$, $DvtNBoxEventManager$$);
  };
  ...
  $DvtNBoxDataUtils$$.$processDataObject$ = function $$DvtNBoxDataUtils$$$$processDataObject$$($DvtNBoxAutomation$$) {
    ...
    if ($DvtNBoxEventManager$$) {
      for (var $DvtNBoxDrawer$$ = 0;$DvtNBoxDrawer$$ < $DvtNBoxEventManager$$.length;$DvtNBoxDrawer$$++) {
        var $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxEventManager$$[$DvtNBoxDrawer$$], $DvtNBoxCategoryNode$$ = $DvtNBoxCategoryRolloverHandler$$[$dvt$$5$$.$NBoxConstants$.$ROW$];
        $DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryNode$$] || ($DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryNode$$] = {});
        var $DvtNBoxCell$$ = $DvtNBoxCategoryRolloverHandler$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$];
    ...
    for (var $DvtNBoxCategoryRolloverHandler$$ = [], $DvtNBoxDrawer$$ = {}, $DvtNBoxEventManager$$ = {}, $DvtNBoxNodeOverflow$$ = 0;$DvtNBoxNodeOverflow$$ < $DvtNBoxDataUtils$$.$getRowCount$($DvtNBoxAutomation$$);$DvtNBoxNodeOverflow$$++) {
      $DvtNBoxCategoryNode$$ = $DvtNBoxDataUtils$$.$getRow$($DvtNBoxAutomation$$, $DvtNBoxNodeOverflow$$), $DvtNBoxDrawer$$[$DvtNBoxCategoryNode$$[$dvt$$5$$.$NBoxConstants$.ID]] = $DvtNBoxNodeOverflow$$;
    }
    ...
    $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$CELLS$] = $DvtNBoxCategoryRolloverHandler$$;
    $DvtNBoxDataAnimationHandler$$ = {};
    $DvtNBoxCategoryNode$$ = !1;
    for ($DvtNBoxCell$$ = 0;$DvtNBoxCell$$ < $DvtNBoxDataUtils$$.$getNodeCount$($DvtNBoxAutomation$$);$DvtNBoxCell$$++) {
      $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxCell$$), $DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryRolloverHandler$$[$dvt$$5$$.$NBoxConstants$.ID]] = $DvtNBoxCell$$, !$DvtNBoxCategoryNode$$ && ($DvtNBoxCategoryRolloverHandler$$[$dvt$$5$$.$NBoxConstants$.$GROUP_CATEGORY$] || $DvtNBoxCategoryRolloverHandler$$._groupCategories || $DvtNBoxCategoryRolloverHandler$$._groupLabels) && ($DvtNBoxCategoryNode$$ = !0);
    }
    ...
    if ($DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$MAXIMIZED_ROW$] && isNaN($DvtNBoxDrawer$$[$DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$MAXIMIZED_ROW$]]) || $DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$MAXIMIZED_COLUMN$] && isNaN($DvtNBoxEventManager$$[$DvtNBoxKeyboardHandler$$[$dvt$$5$$.$NBoxConstants$.$MAXIMIZED_COLUMN$]])) {
  ...
  $DvtNBoxDataUtils$$.$isCellMinimized$ = function $$DvtNBoxDataUtils$$$$isCellMinimized$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    var $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$), $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$ROW$], $DvtNBoxDrawer$$ = $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$];
  ...
  $DvtNBoxDataUtils$$.$isCellMaximized$ = function $$DvtNBoxDataUtils$$$$isCellMaximized$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    var $DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$($DvtNBoxAutomation$$), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$($DvtNBoxAutomation$$), $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getCell$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$), $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$COLUMN$];
    return $DvtNBoxEventManager$$ == $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$ROW$] && $DvtNBoxDataAnimationHandler$$ == $DvtNBoxCategoryRolloverHandler$$;
  };
  ...
  $DvtNBoxDataUtils$$.$isDrawerSelected$ = function $$DvtNBoxDataUtils$$$$isDrawerSelected$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    if ($DvtNBoxDataAnimationHandler$$) {
      ...
      for (var $DvtNBoxDataAnimationHandler$$ = $DvtNBoxKeyboardHandler$$.getData().nodeIndices, $DvtNBoxEventManager$$ = !0, $DvtNBoxCategoryRolloverHandler$$ = 0;$DvtNBoxCategoryRolloverHandler$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxCategoryRolloverHandler$$++) {
        ...
        if (!$DvtNBoxDrawer$$[$DvtNBoxCategoryNode$$[$dvt$$5$$.$NBoxConstants$.ID]]) {
          $DvtNBoxEventManager$$ = !1;
          break;
        }
      }
  ...
  $DvtNBoxStyleUtils$$.$getCellStyle$ = function $$DvtNBoxStyleUtils$$$$getCellStyle$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    var $DvtNBoxEventManager$$ = $DvtNBoxAutomation$$.$getOptions$(), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxStyleUtils$$.$_getCellStyleKey$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$), $DvtNBoxDrawer$$ = $DvtNBoxStyleUtils$$.$_getCellStyleOption$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxDataAnimationHandler$$), $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxEventManager$$[$dvt$$5$$.$NBoxConstants$.$STYLE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$CELL_DEFAULTS$]["_" + $DvtNBoxDataAnimationHandler$$], 
    $DvtNBoxCategoryNode$$ = new $dvt$$5$$.$CSSStyle$;
    $dvt$$5$$.$ArrayUtils$.forEach($DvtNBoxStyleUtils$$.$_getCellStyleProperties$(), function($dvt$$5$$) {
      var $DvtNBoxAutomation$$ = $DvtNBoxDrawer$$ && null != $DvtNBoxDrawer$$[$dvt$$5$$] ? $DvtNBoxDrawer$$[$dvt$$5$$] : $DvtNBoxCategoryRolloverHandler$$.$getStyle$($dvt$$5$$);
      $DvtNBoxCategoryNode$$.$setStyle$($dvt$$5$$, $DvtNBoxAutomation$$);
    });
  ...
  $DvtNBoxStyleUtils$$.$getCellStyleObject$ = function $$DvtNBoxStyleUtils$$$$getCellStyleObject$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    $DvtNBoxDataAnimationHandler$$ && $dvt$$5$$.$ArrayUtils$.forEach($DvtNBoxStyleUtils$$.$_getCellStyleProperties$(), function($dvt$$5$$) {
      delete $DvtNBoxDataAnimationHandler$$[$dvt$$5$$];
    });
    return $DvtNBoxDataAnimationHandler$$;
  };
  $DvtNBoxStyleUtils$$.$_getCellStyleKey$ = function $$DvtNBoxStyleUtils$$$$_getCellStyleKey$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    var $DvtNBoxEventManager$$ = $dvt$$5$$.$NBoxConstants$.STYLE, $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$($DvtNBoxAutomation$$), $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$($DvtNBoxAutomation$$);
  ...
  $DvtNBoxStyleUtils$$.$_getCellStyleOption$ = function $$DvtNBoxStyleUtils$$$$_getCellStyleOption$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$, $DvtNBoxEventManager$$) {
    ...
    $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataAnimationHandler$$[$dvt$$5$$.$NBoxConstants$.$STYLE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$CELL_DEFAULTS$][$DvtNBoxEventManager$$];
    !$DvtNBoxDataAnimationHandler$$ || $DvtNBoxDataAnimationHandler$$ instanceof Object || ($DvtNBoxDataAnimationHandler$$ = $dvt$$5$$.$CSSStyle$.$cssStringToObject$($DvtNBoxDataAnimationHandler$$));
    ($DvtNBoxEventManager$$ = $DvtNBoxAutomation$$[$DvtNBoxEventManager$$]) ? ($DvtNBoxEventManager$$ instanceof Object || ($DvtNBoxEventManager$$ = $dvt$$5$$.$CSSStyle$.$cssStringToObject$($DvtNBoxEventManager$$)), $DvtNBoxEventManager$$ = $dvt$$5$$.$JsonUtils$.$merge$($DvtNBoxEventManager$$, $DvtNBoxDataAnimationHandler$$)) : $DvtNBoxDataAnimationHandler$$ && ($DvtNBoxEventManager$$ = $dvt$$5$$.$JsonUtils$.clone($DvtNBoxDataAnimationHandler$$));
    return $DvtNBoxEventManager$$;
  };
  $DvtNBoxStyleUtils$$.$_getCellStyleProperties$ = function $$DvtNBoxStyleUtils$$$$_getCellStyleProperties$$() {
    return [$dvt$$5$$.$CSSStyle$.$BACKGROUND$, $dvt$$5$$.$CSSStyle$.$BACKGROUND_COLOR$, $dvt$$5$$.$CSSStyle$.$BORDER_STYLE$, $dvt$$5$$.$CSSStyle$.$BORDER_COLOR$, $dvt$$5$$.$CSSStyle$.$BORDER_WIDTH$];
  };
  $DvtNBoxStyleUtils$$.$getCellClassName$ = function $$DvtNBoxStyleUtils$$$$getCellClassName$$($dvt$$5$$, $DvtNBoxAutomation$$) {
    var $DvtNBoxKeyboardHandler$$ = "className", $DvtNBoxEventManager$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$($dvt$$5$$), $DvtNBoxDataAnimationHandler$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$($dvt$$5$$);
    $DvtNBoxDataUtils$$.$isCellMinimized$($dvt$$5$$, $DvtNBoxAutomation$$) ? $DvtNBoxKeyboardHandler$$ = "minimizedClassName" : !$DvtNBoxEventManager$$ && !$DvtNBoxDataAnimationHandler$$ || $DvtNBoxDataUtils$$.$isCellMinimized$($dvt$$5$$, $DvtNBoxAutomation$$) || ($DvtNBoxKeyboardHandler$$ = "maximizedClassName");
    return $DvtNBoxDataUtils$$.$getCell$($dvt$$5$$, $DvtNBoxAutomation$$)[$DvtNBoxKeyboardHandler$$];
  };
  ...
  $DvtNBoxStyleUtils$$.$getCategoryNodeColor$ = function $$DvtNBoxStyleUtils$$$$getCategoryNodeColor$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    for (var $DvtNBoxDrawer$$ = 1;$DvtNBoxDrawer$$ < $DvtNBoxEventManager$$.length;$DvtNBoxDrawer$$++) {
      ...
      if ($DvtNBoxDataAnimationHandler$$ != $DvtNBoxCategoryRolloverHandler$$[$dvt$$5$$.$NBoxConstants$.$COLOR$]) {
        return $DvtNBoxAutomation$$.$getOptions$()[$dvt$$5$$.$NBoxConstants$.$STYLE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$NODE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$COLOR$];
      }
    }
    return $DvtNBoxDataAnimationHandler$$;
  ...
  $DvtNBoxStyleUtils$$.$getCategoryNodeIndicatorColor$ = function $$DvtNBoxStyleUtils$$$$getCategoryNodeIndicatorColor$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    for (var $DvtNBoxDrawer$$ = 1;$DvtNBoxDrawer$$ < $DvtNBoxEventManager$$.length;$DvtNBoxDrawer$$++) {
      var $DvtNBoxCategoryRolloverHandler$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxEventManager$$[$DvtNBoxDrawer$$]);
      if ($DvtNBoxDataAnimationHandler$$ != $DvtNBoxCategoryRolloverHandler$$[$dvt$$5$$.$NBoxConstants$.$INDICATOR_COLOR$]) {
        return $DvtNBoxAutomation$$.$getOptions$()[$dvt$$5$$.$NBoxConstants$.$STYLE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$NODE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$INDICATOR_COLOR$];
      }
    }
    return $DvtNBoxDataAnimationHandler$$;
  ...
  $DvtNBoxStyleUtils$$.$getStyledCategoryIndicatorIcon$ = function $$DvtNBoxStyleUtils$$$$getStyledCategoryIndicatorIcon$$($DvtNBoxAutomation$$, $DvtNBoxKeyboardHandler$$) {
    ...
    var $DvtNBoxEventManager$$ = {}, $DvtNBoxDataAnimationHandler$$ = $DvtNBoxKeyboardHandler$$.nodeIndices, $DvtNBoxDrawer$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$[0])[$dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON$];
    if (!$DvtNBoxDrawer$$) {
      return null;
    }
    ...
    if (!$DvtNBoxDataUtils$$.$getGroupAttributes$($DvtNBoxAutomation$$) || -1 != $DvtNBoxDataUtils$$.$getGroupAttributes$($DvtNBoxAutomation$$).indexOf("indicatorIconShape")) {
      for (var $DvtNBoxCategoryNode$$ = $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$SHAPE$], $DvtNBoxCell$$ = 1;$DvtNBoxCell$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxCell$$++) {
        ...
        $DvtNBoxNodeOverflow$$ && $DvtNBoxCategoryNode$$ != $DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.$SHAPE$] && ($DvtNBoxCategoryRolloverHandler$$ = !1);
      }
      $DvtNBoxEventManager$$[$dvt$$5$$.$NBoxConstants$.$SHAPE$] = $DvtNBoxCategoryRolloverHandler$$ ? $DvtNBoxCategoryNode$$ : $DvtNBoxAutomation$$.$getOptions$()[$dvt$$5$$.$NBoxConstants$.$STYLE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$NODE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$SHAPE$];
    }
    ...
    if (!$DvtNBoxDataUtils$$.$getGroupAttributes$($DvtNBoxAutomation$$) || -1 != $DvtNBoxDataUtils$$.$getGroupAttributes$($DvtNBoxAutomation$$).indexOf("indicatorIconColor")) {
      $DvtNBoxCategoryNode$$ = $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$COLOR$];
      for ($DvtNBoxCell$$ = 1;$DvtNBoxCell$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxCell$$++) {
        ($DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$[$DvtNBoxCell$$])[$dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON$]) && $DvtNBoxCategoryNode$$ != $DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] && ($DvtNBoxCategoryRolloverHandler$$ = !1);
      }
      $DvtNBoxEventManager$$[$dvt$$5$$.$NBoxConstants$.$COLOR$] = $DvtNBoxCategoryRolloverHandler$$ ? $DvtNBoxCategoryNode$$ : $DvtNBoxAutomation$$.$getOptions$()[$dvt$$5$$.$NBoxConstants$.$STYLE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$NODE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$COLOR$];
    }
    $DvtNBoxCategoryRolloverHandler$$ = !0;
    if (!$DvtNBoxDataUtils$$.$getGroupAttributes$($DvtNBoxAutomation$$) || -1 != $DvtNBoxDataUtils$$.$getGroupAttributes$($DvtNBoxAutomation$$).indexOf("indicatorIconPattern")) {
      $DvtNBoxDrawer$$ = $DvtNBoxDrawer$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$];
      for ($DvtNBoxCategoryNode$$ = 1;$DvtNBoxCategoryNode$$ < $DvtNBoxDataAnimationHandler$$.length;$DvtNBoxCategoryNode$$++) {
        ($DvtNBoxNodeOverflow$$ = $DvtNBoxDataUtils$$.$getNode$($DvtNBoxAutomation$$, $DvtNBoxDataAnimationHandler$$[$DvtNBoxCategoryNode$$])[$dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON$]) && $DvtNBoxDrawer$$ != $DvtNBoxNodeOverflow$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$] && ($DvtNBoxCategoryRolloverHandler$$ = !1);
      }
      $DvtNBoxEventManager$$[$dvt$$5$$.$NBoxConstants$.$PATTERN$] = $DvtNBoxCategoryRolloverHandler$$ ? $DvtNBoxDrawer$$ : $DvtNBoxAutomation$$.$getOptions$()[$dvt$$5$$.$NBoxConstants$.$STYLE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$NODE_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$INDICATOR_ICON_DEFAULTS$][$dvt$$5$$.$NBoxConstants$.$PATTERN$];
    }
