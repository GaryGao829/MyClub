...
(function($dvt$$6$$) {
  ...
  $dvt$$6$$.$OverviewUtils$.$getDatePosition$ = function $$dvt$$6$$$$OverviewUtils$$$getDatePosition$$($dvt$$6$$, $DvtOverviewEventManager$$, $DvtOverviewParser$$, $width$$87$$) {
    $DvtOverviewParser$$ = ($DvtOverviewParser$$ - $dvt$$6$$) * $width$$87$$;
    $dvt$$6$$ = $DvtOverviewEventManager$$ - $dvt$$6$$;
    return 0 == $DvtOverviewParser$$ || 0 == $dvt$$6$$ ? 0 : $DvtOverviewParser$$ / $dvt$$6$$;
  };
  $dvt$$6$$.$OverviewUtils$.$getPositionDate$ = function $$dvt$$6$$$$OverviewUtils$$$getPositionDate$$($dvt$$6$$, $DvtOverviewEventManager$$, $DvtOverviewParser$$, $width$$88$$) {
    $DvtOverviewEventManager$$ = $DvtOverviewParser$$ * ($DvtOverviewEventManager$$ - $dvt$$6$$);
    return 0 == $DvtOverviewEventManager$$ || 0 == $width$$88$$ ? $dvt$$6$$ : $DvtOverviewEventManager$$ / $width$$88$$ + $dvt$$6$$;
  };
  ...
  $dvt$$6$$.$Overview$.prototype.Init = function $$dvt$$6$$$$Overview$$$Init$($DvtOverviewParser$$, $callback$$135$$, $callbackObj$$60$$) {
    $dvt$$6$$.$Overview$.$superclass$.Init.call(this, $DvtOverviewParser$$);
    this.$_callback$ = $callback$$135$$;
  ...
  $dvt$$6$$.$Overview$.prototype.$createGrippy$ = function $$dvt$$6$$$$Overview$$$$createGrippy$$($DvtOverviewEventManager$$) {
    var $DvtOverviewParser$$ = new $dvt$$6$$.$Container$(this.$getCtx$(), "grpy"), $color$$59$$ = this.$_handleTextureColor$;
    if (this.$isVertical$()) {
      var $startx$$1$$ = 8 + $DvtOverviewEventManager$$;
      $DvtOverviewEventManager$$ = 3;
      for (var $i$$554$$ = 0;9 > $i$$554$$;$i$$554$$++) {
        var $dot$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), $startx$$1$$ + 2 * $i$$554$$, $DvtOverviewEventManager$$, $startx$$1$$ + 2 * $i$$554$$ + 1, $DvtOverviewEventManager$$, "dot1" + $i$$554$$);
        $dot$$.$setSolidStroke$($color$$59$$);
        $DvtOverviewParser$$.$addChild$($dot$$);
        $DvtOverviewEventManager$$ += 2;
        $dot$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), $startx$$1$$ + 1 + 2 * $i$$554$$, $DvtOverviewEventManager$$, $startx$$1$$ + 1 + 2 * $i$$554$$ + 1, $DvtOverviewEventManager$$, "dot2" + $i$$554$$);
        $dot$$.$setSolidStroke$($color$$59$$);
        $DvtOverviewParser$$.$addChild$($dot$$);
        $DvtOverviewEventManager$$ += 2;
        $dot$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), $startx$$1$$ + 2 * $i$$554$$, $DvtOverviewEventManager$$, $startx$$1$$ + 2 * $i$$554$$ + 1, $DvtOverviewEventManager$$, "dot3" + $i$$554$$);
        $dot$$.$setSolidStroke$($color$$59$$);
        $DvtOverviewParser$$.$addChild$($dot$$);
        $DvtOverviewEventManager$$ = 3;
      }
      ...
      for ($i$$554$$ = 0;9 > $i$$554$$;$i$$554$$++) {
        $dot$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), $startx$$1$$, $DvtOverviewEventManager$$ + 2 * $i$$554$$, $startx$$1$$, $DvtOverviewEventManager$$ + 2 * $i$$554$$ + 1, "dot1" + $i$$554$$), $dot$$.$setSolidStroke$($color$$59$$), $DvtOverviewParser$$.$addChild$($dot$$), $startx$$1$$ += 2, $dot$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), $startx$$1$$, $DvtOverviewEventManager$$ + 1 + 2 * $i$$554$$, $startx$$1$$, $DvtOverviewEventManager$$ + 1 + 2 * $i$$554$$ + 1, "dot2" + $i$$554$$), $dot$$.$setSolidStroke$($color$$59$$), 
        $DvtOverviewParser$$.$addChild$($dot$$), $startx$$1$$ += 2, $dot$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), $startx$$1$$, $DvtOverviewEventManager$$ + 2 * $i$$554$$, $startx$$1$$, $DvtOverviewEventManager$$ + 2 * $i$$554$$ + 1, "dot3" + $i$$554$$), $dot$$.$setSolidStroke$($color$$59$$), $DvtOverviewParser$$.$addChild$($dot$$), $startx$$1$$ = 3;
      }
  ...
  $dvt$$6$$.$Overview$.prototype.$updateTimeAxis$ = function $$dvt$$6$$$$Overview$$$$updateTimeAxis$$($DvtOverviewEventManager$$, $DvtOverviewParser$$) {
    if (null != this.$_ticks$) {
      for (var $vertical$$2$$ = this.$isVertical$(), $size$$32$$ = this.$getOverviewSize$(), $i$$555$$ = 0;$i$$555$$ < this.$_ticks$.length;$i$$555$$++) {
        var $child$$60_label$$69$$ = this.$_ticks$[$i$$555$$], $time_pos$$ = this.$getDatePosition$(parseInt($child$$60_label$$69$$.time, 10)), $child$$60_label$$69$$ = $child$$60_label$$69$$.label, $maxWidth$$15$$ = 0, $maxWidth$$15$$ = $i$$555$$ + 1 < this.$_ticks$.length ? this.$getDatePosition$(parseInt(this.$_ticks$[$i$$555$$ + 1].time, 10)) - $time_pos$$ : $size$$32$$ - $time_pos$$;
        ...
        this.$addTick$($time_pos$$, $DvtOverviewEventManager$$, $DvtOverviewParser$$, "tick" + $i$$555$$);
        this.$addLabel$($time_pos$$, $child$$60_label$$69$$, $DvtOverviewEventManager$$, $DvtOverviewParser$$, $maxWidth$$15$$, "label" + $i$$555$$);
      }
    }
  };
  $dvt$$6$$.$Overview$.prototype.$addTick$ = function $$dvt$$6$$$$Overview$$$$addTick$$($DvtOverviewEventManager$$, $DvtOverviewParser$$, $height$$83$$, $id$$152$$) {
    $DvtOverviewEventManager$$ = this.$isVertical$() ? new $dvt$$6$$.$Line$(this.$getCtx$(), 0, $DvtOverviewEventManager$$, $DvtOverviewParser$$, $DvtOverviewEventManager$$, $id$$152$$) : new $dvt$$6$$.$Line$(this.$getCtx$(), $DvtOverviewEventManager$$, 0, $DvtOverviewEventManager$$, $height$$83$$, $id$$152$$);
  ...
  $dvt$$6$$.$Overview$.prototype.$addLabel$ = function $$dvt$$6$$$$Overview$$$$addLabel$$($DvtOverviewEventManager$$, $DvtOverviewParser$$, $padding$$27_width$$98$$, $height$$84_y$$153$$, $maxWidth$$16$$, $id$$153$$, $dim$$53_labelStyle$$19$$) {
    $dim$$53_labelStyle$$19$$ = $dim$$53_labelStyle$$19$$ || new $dvt$$6$$.$CSSStyle$("font-weight:bold");
    this.$isVertical$() ? ($DvtOverviewParser$$ = new $dvt$$6$$.$OutputText$(this.$getCtx$(), $DvtOverviewParser$$, 4, $DvtOverviewEventManager$$, $id$$153$$), $DvtOverviewParser$$.$setCSSStyle$($dim$$53_labelStyle$$19$$), this.$isRTL$() && (this.$addChild$($DvtOverviewParser$$), $dim$$53_labelStyle$$19$$ = $DvtOverviewParser$$.$getDimensions$(), this.removeChild($DvtOverviewParser$$), $DvtOverviewParser$$.$setX$(Math.max(4, this.$Width$ - $dim$$53_labelStyle$$19$$.$w$ - 4)))) : ($height$$84_y$$153$$ = 
    this.$isOverviewAbove$() ? 2 : $height$$84_y$$153$$ - this.$getTimeAxisHeight$() + 2, $padding$$27_width$$98$$ = $dvt$$6$$.$Overview$.$_DEFAULT_AXIS_LABEL_PADDING$, $DvtOverviewParser$$ = new $dvt$$6$$.$OutputText$(this.$getCtx$(), $DvtOverviewParser$$, $DvtOverviewEventManager$$ + $padding$$27_width$$98$$, $height$$84_y$$153$$, $id$$153$$), $DvtOverviewParser$$.$setCSSStyle$($dim$$53_labelStyle$$19$$), this.$isHorizontalRTL$() && (this.$addChild$($DvtOverviewParser$$), $dim$$53_labelStyle$$19$$ = 
    $DvtOverviewParser$$.$getDimensions$(), this.removeChild($DvtOverviewParser$$), $DvtOverviewParser$$.$setX$($DvtOverviewEventManager$$ - Math.min($dim$$53_labelStyle$$19$$.$w$, $maxWidth$$16$$) - $padding$$27_width$$98$$)));
  ...
  $dvt$$6$$.$Overview$.prototype.$updateCurrentTime$ = function $$dvt$$6$$$$Overview$$$$updateCurrentTime$$($DvtOverviewEventManager$$, $DvtOverviewParser$$) {
    if (null != this.$_currentTime$ && !isNaN(this.$_currentTime$)) {
      var $line$$17_time_pos$$1$$ = this.$getDatePosition$(this.$_currentTime$);
      this.$isVertical$() ? $line$$17_time_pos$$1$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), 0, $line$$17_time_pos$$1$$, $DvtOverviewEventManager$$, $line$$17_time_pos$$1$$, "ocd") : (this.$isRTL$() && ($line$$17_time_pos$$1$$ = $DvtOverviewEventManager$$ - $line$$17_time_pos$$1$$), $line$$17_time_pos$$1$$ = new $dvt$$6$$.$Line$(this.$getCtx$(), $line$$17_time_pos$$1$$, 0, $line$$17_time_pos$$1$$, $DvtOverviewParser$$, "ocd"));
      $line$$17_time_pos$$1$$.$setSolidStroke$(this.$_currentTimeIndicatorColor$);
      $line$$17_time_pos$$1$$.$setPixelHinting$();
      this.$addChild$($line$$17_time_pos$$1$$);
    }
  };
  ...
  $dvt$$6$$.$Overview$.prototype.$animateSlidingWindow$ = function $$dvt$$6$$$$Overview$$$$animateSlidingWindow$$($DvtOverviewEventManager$$) {
    ...
    if ($DvtOverviewEventManager$$ != this.$getSlidingWindowPos$($DvtOverviewParser$$)) {
      ...
      var $animator$$108_minPos$$ = this.$_leftMargin$, $maxPos$$ = this.$getMaximumPosition$(), $rightStart$$2_slidingWindowSize$$ = this.$getSlidingWindowSize$($DvtOverviewParser$$);
      $DvtOverviewEventManager$$ = Math.max($animator$$108_minPos$$, Math.min($maxPos$$ - $rightStart$$2_slidingWindowSize$$, $DvtOverviewEventManager$$));
      $animator$$108_minPos$$ = this.$isAnimationOnClick$() ? new $dvt$$6$$.$Animator$(this.$getCtx$(), .5, 0, $dvt$$6$$.$Easing$.$linear$) : null;
      this.$animateProperty$($animator$$108_minPos$$, $DvtOverviewParser$$, $posGetter$$, $posSetter$$, $DvtOverviewEventManager$$);
      this.$animateProperty$($animator$$108_minPos$$, $leftBackgroundHandle$$1_leftHandle$$2_rightBackgroundGetter$$, $leftHandlePos1Getter$$, $leftHandlePos1Setter$$, $DvtOverviewEventManager$$);
      this.$animateProperty$($animator$$108_minPos$$, $leftBackgroundHandle$$1_leftHandle$$2_rightBackgroundGetter$$, $leftHandlePos2Getter$$, $leftHandlePos2Setter$$, $DvtOverviewEventManager$$);
      this.$animateProperty$($animator$$108_minPos$$, $leftBackgroundHandleGetter_rightBackgroundSetter_rightHandle$$3$$, $rightHandlePos1Getter$$, $rightHandlePos1Setter$$, $DvtOverviewEventManager$$ + $rightStart$$2_slidingWindowSize$$);
      this.$animateProperty$($animator$$108_minPos$$, $leftBackgroundHandleGetter_rightBackgroundSetter_rightHandle$$3$$, $rightHandlePos2Getter$$, $rightHandlePos2Setter$$, $DvtOverviewEventManager$$ + $rightStart$$2_slidingWindowSize$$);
      this.$animateProperty$($animator$$108_minPos$$, $leftBackgroundHandleSetter_leftTopBar$$1_rightBackgroundPosGetter$$, $leftTopBarPosGetter$$, $leftTopBarPosSetter$$, $DvtOverviewEventManager$$ + 1);
      this.$animateProperty$($animator$$108_minPos$$, $rightBackgroundHandle$$2_rightBackgroundPosSetter_rightTopBar$$1$$, $rightTopBarPosGetter$$, $rightTopBarPosSetter$$, $DvtOverviewEventManager$$ + $rightStart$$2_slidingWindowSize$$ - 1);
      this.$animateProperty$($animator$$108_minPos$$, $bottomBar$$1_rightBackgroundHandleGetter_timelineSize$$, $bottomBarPos1Getter$$, $bottomBarPos1Setter$$, $DvtOverviewEventManager$$);
      this.$animateProperty$($animator$$108_minPos$$, $rightBackgroundHandleSetter_topBar$$1$$, $topBarPos1Getter$$, $topBarPos1Setter$$, $DvtOverviewEventManager$$);
      this.$animateProperty$($animator$$108_minPos$$, $bottomBar$$1_rightBackgroundHandleGetter_timelineSize$$, $bottomBarPos2Getter$$, $bottomBarPos2Setter$$, $DvtOverviewEventManager$$ + $rightStart$$2_slidingWindowSize$$);
      this.$animateProperty$($animator$$108_minPos$$, $rightBackgroundHandleSetter_topBar$$1$$, $topBarPos2Getter$$, $topBarPos2Setter$$, $DvtOverviewEventManager$$ + $rightStart$$2_slidingWindowSize$$);
      this.$isLeftAndRightFilterRendered$() && ($DvtOverviewParser$$ = this.$getLeftBackground$(), this.$animateProperty$($animator$$108_minPos$$, $DvtOverviewParser$$, $DvtOverviewParser$$.getWidth, $DvtOverviewParser$$.$setWidth$, $DvtOverviewEventManager$$), $rightStart$$2_slidingWindowSize$$ = $DvtOverviewEventManager$$ + $rightStart$$2_slidingWindowSize$$, $DvtOverviewParser$$ = this.$getRightBackground$(), $leftBackgroundHandle$$1_leftHandle$$2_rightBackgroundGetter$$ = $DvtOverviewParser$$.getWidth, 
      $leftBackgroundHandleGetter_rightBackgroundSetter_rightHandle$$3$$ = $DvtOverviewParser$$.$setWidth$, $leftBackgroundHandleSetter_leftTopBar$$1_rightBackgroundPosGetter$$ = $DvtOverviewParser$$.$getX$, $rightBackgroundHandle$$2_rightBackgroundPosSetter_rightTopBar$$1$$ = $DvtOverviewParser$$.$setX$, $bottomBar$$1_rightBackgroundHandleGetter_timelineSize$$ = this.$isVertical$() ? this.$Height$ : this.$Width$, this.$animateProperty$($animator$$108_minPos$$, $DvtOverviewParser$$, $leftBackgroundHandle$$1_leftHandle$$2_rightBackgroundGetter$$, 
      $leftBackgroundHandleGetter_rightBackgroundSetter_rightHandle$$3$$, $bottomBar$$1_rightBackgroundHandleGetter_timelineSize$$ - $rightStart$$2_slidingWindowSize$$), this.$animateProperty$($animator$$108_minPos$$, $DvtOverviewParser$$, $leftBackgroundHandleSetter_leftTopBar$$1_rightBackgroundPosGetter$$, $rightBackgroundHandle$$2_rightBackgroundPosSetter_rightTopBar$$1$$, $rightStart$$2_slidingWindowSize$$), $dvt$$6$$.$OverviewUtils$.$supportsTouch$() && !this.$isFeatureOff$() && ($DvtOverviewParser$$ = 
      ...
      $bottomBar$$1_rightBackgroundHandleGetter_timelineSize$$ = $rightBackgroundHandle$$2_rightBackgroundPosSetter_rightTopBar$$1$$.$getX$, $rightBackgroundHandleSetter_topBar$$1$$ = $rightBackgroundHandle$$2_rightBackgroundPosSetter_rightTopBar$$1$$.$setX$, this.$animateProperty$($animator$$108_minPos$$, $leftBackgroundHandle$$1_leftHandle$$2_rightBackgroundGetter$$, $leftBackgroundHandleGetter_rightBackgroundSetter_rightHandle$$3$$, $leftBackgroundHandleSetter_leftTopBar$$1_rightBackgroundPosGetter$$, 
      $DvtOverviewEventManager$$ - $DvtOverviewParser$$), this.$animateProperty$($animator$$108_minPos$$, $rightBackgroundHandle$$2_rightBackgroundPosSetter_rightTopBar$$1$$, $bottomBar$$1_rightBackgroundHandleGetter_timelineSize$$, $rightBackgroundHandleSetter_topBar$$1$$, $rightStart$$2_slidingWindowSize$$)));
      null != $animator$$108_minPos$$ && $animator$$108_minPos$$.play();
    }
  };
  $dvt$$6$$.$Overview$.prototype.$animateProperty$ = function $$dvt$$6$$$$Overview$$$$animateProperty$$($DvtOverviewEventManager$$, $DvtOverviewParser$$, $getter$$, $setter$$, $value$$191$$) {
    null != $DvtOverviewEventManager$$ ? $DvtOverviewEventManager$$.$addProp$($dvt$$6$$.$Animator$.$TYPE_NUMBER$, $DvtOverviewParser$$, $getter$$, $setter$$, $value$$191$$) : $setter$$.call($DvtOverviewParser$$, $value$$191$$);
  };
  ...
  $dvt$$6$$.$Overview$.prototype.$HandleShapeClick$ = function $$dvt$$6$$$$Overview$$$$HandleShapeClick$$($DvtOverviewEventManager$$, $DvtOverviewParser$$, $evt$$47_pageY$$3_pos$$59$$) {
    ...
    if ($drawable$$4_newStartTime_size$$34$$ && "window" != $drawable$$4_newStartTime_size$$34$$.getId() && !this.$isHandle$($drawable$$4_newStartTime_size$$34$$)) {
      if ("bg" == $drawable$$4_newStartTime_size$$34$$.getId() || "label" == $drawable$$4_newStartTime_size$$34$$.getId().substr(0, 5) || "ocd" == $drawable$$4_newStartTime_size$$34$$.getId() || "lbg" == $drawable$$4_newStartTime_size$$34$$.getId() || "rbg" == $drawable$$4_newStartTime_size$$34$$.getId()) {
        ...
        void 0 == $evt$$47_pageY$$3_pos$$59$$ && ($evt$$47_pageY$$3_pos$$59$$ = $DvtOverviewEventManager$$.pageY);
        $DvtOverviewEventManager$$ = this.$getCtx$().$pageToStageCoords$($DvtOverviewParser$$, $evt$$47_pageY$$3_pos$$59$$);
        $DvtOverviewEventManager$$ = this.$stageToLocal$($DvtOverviewEventManager$$);
        this.$isVertical$() ? ($evt$$47_pageY$$3_pos$$59$$ = $DvtOverviewEventManager$$.y, $drawable$$4_newStartTime_size$$34$$ = this.$Height$) : ($evt$$47_pageY$$3_pos$$59$$ = $DvtOverviewEventManager$$.x, $drawable$$4_newStartTime_size$$34$$ = this.$Width$);
        $DvtOverviewEventManager$$ = this.$getSlidingWindow$();
        $DvtOverviewParser$$ = $evt$$47_pageY$$3_pos$$59$$ - this.$getRectSize$($DvtOverviewEventManager$$) / 2;
        this.$animateSlidingWindow$($DvtOverviewParser$$);
        this.$isHorizontalRTL$() && ($evt$$47_pageY$$3_pos$$59$$ = this.$Width$ - $evt$$47_pageY$$3_pos$$59$$);
        var $time$$7$$ = this.$getPositionDate$($evt$$47_pageY$$3_pos$$59$$);
        $evt$$47_pageY$$3_pos$$59$$ = new $dvt$$6$$.$OverviewEvent$($dvt$$6$$.$OverviewEvent$.$SUBTYPE_SCROLL_TIME$);
        $evt$$47_pageY$$3_pos$$59$$.setTime($time$$7$$);
        ...
        $evt$$47_pageY$$3_pos$$59$$.$setNewStartTime$($drawable$$4_newStartTime_size$$34$$);
        $evt$$47_pageY$$3_pos$$59$$.$setNewEndTime$($DvtOverviewEventManager$$);
        this.dispatchEvent($evt$$47_pageY$$3_pos$$59$$);
      } else {
  ...
  $dvt$$6$$.$Overview$.prototype.$fireScrollEvent$ = function $$dvt$$6$$$$Overview$$$$fireScrollEvent$$($DvtOverviewEventManager$$, $DvtOverviewParser$$, $deltaY$$9$$) {
    var $newEndTime$$1_slidingWindow$$17$$ = this.$getSlidingWindow$(), $pos$$63$$ = this.$getSlidingWindowPos$($newEndTime$$1_slidingWindow$$17$$), $newStartTime$$1_scrollTo_size$$35$$ = this.$getRectSize$($newEndTime$$1_slidingWindow$$17$$), $minPos$$1$$ = this.$_leftMargin$, $maxPos$$1$$ = this.$getMaximumPosition$();
    $DvtOverviewParser$$ = this.$isVertical$() ? $deltaY$$9$$ : $DvtOverviewParser$$;
    $pos$$63$$ + $DvtOverviewParser$$ <= $minPos$$1$$ ? (this.$setSlidingWindowPos$($newEndTime$$1_slidingWindow$$17$$, $minPos$$1$$), $newStartTime$$1_scrollTo_size$$35$$ = this.$isHorizontalRTL$() ? $dvt$$6$$.$OverviewEvent$.$END_POS$ : $dvt$$6$$.$OverviewEvent$.$START_POS$) : $pos$$63$$ + $newStartTime$$1_scrollTo_size$$35$$ + $DvtOverviewParser$$ >= $maxPos$$1$$ ? (this.$setSlidingWindowPos$($newEndTime$$1_slidingWindow$$17$$, $maxPos$$1$$ - $newStartTime$$1_scrollTo_size$$35$$), $newStartTime$$1_scrollTo_size$$35$$ = 
    this.$isHorizontalRTL$() ? $dvt$$6$$.$OverviewEvent$.$START_POS$ : $dvt$$6$$.$OverviewEvent$.$END_POS$) : (this.$setSlidingWindowPos$($newEndTime$$1_slidingWindow$$17$$, $pos$$63$$ + $DvtOverviewParser$$), $newStartTime$$1_scrollTo_size$$35$$ = this.$isHorizontalRTL$() ? ($maxPos$$1$$ - $newStartTime$$1_scrollTo_size$$35$$ - $pos$$63$$ - this.$_leftMargin$) * this.$_increment$ : ($pos$$63$$ - this.$_leftMargin$) * this.$_increment$);
    this.$ScrollTimeAxis$();
    ...
    this.$isHorizontalRTL$() ? ($newStartTime$$1_scrollTo_size$$35$$ = this.$getPositionDate$(this.$Width$ - ($pos$$63$$ + this.$getRectSize$($newEndTime$$1_slidingWindow$$17$$))), $newEndTime$$1_slidingWindow$$17$$ = this.$getPositionDate$(this.$Width$ - $pos$$63$$)) : ($newStartTime$$1_scrollTo_size$$35$$ = this.$getPositionDate$($pos$$63$$), $newEndTime$$1_slidingWindow$$17$$ = this.$getPositionDate$($pos$$63$$ + this.$getRectSize$($newEndTime$$1_slidingWindow$$17$$)));
