...
(function($dvt$$7$$) {
  ...
  $dvt$$7$$.$ComboBox$.prototype.$createDropdown$ = function $$dvt$$7$$$$ComboBox$$$$createDropdown$$() {
    function $DvtControlPanelEventManager$$($dvt$$7$$) {
      return {$HandleClick$:function($dvt$$7$$) {
        $thisRef$$37$$.$HandleDropdownItemClick$($dvt$$7$$);
    ...
    $dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelEvent$$, $dvt$$7$$.$ControlPanel$.$CP_PADDING_RIGHT$, 0), $bgAlpha_interItemPadding$$ = $dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelEvent$$, $dvt$$7$$.$ControlPanel$.$CP_PADDING_INNER$, 0), $currY$$11$$ = $DvtPanControl$$, $context$$272$$ = this.$getCtx$(), $dim$$55$$, $itemSprite$$2$$, $item$$41$$, $DvtPanControl$$ = new $dvt$$7$$.$Container$($context$$272$$, "__dd"), $thisRef$$37$$ = this, $i$$559$$ = 0;$i$$559$$ < this.$_items$.length;$i$$559$$++) {
      $item$$41$$ = this.$_items$[$i$$559$$], $dim$$55$$ = $dvt$$7$$.$ButtonLAFUtils$.$_getDimForced$($context$$272$$, $item$$41$$), $itemSprite$$2$$ = new $dvt$$7$$.$Container$($context$$272$$, "__it" + $i$$559$$), $itemSprite$$2$$.$setTranslate$($DropdownItemSprite$$, $currY$$11$$), $itemSprite$$2$$.$addChild$($item$$41$$), $item$$41$$.$setMouseEnabled$(!0), $item$$41$$.setCursor("pointer"), $currY$$11$$ += $dim$$55$$.$h$ + $bgAlpha_interItemPadding$$, this.$_eventManager$ && this.$_eventManager$.$associate$($item$$41$$, 
      $DvtControlPanelEventManager$$(this.$_tooltips$[$i$$559$$])), $DvtPanControl$$.$addChild$($itemSprite$$2$$);
    }
    $DvtControlPanelEvent$$ = $dvt$$7$$.$ButtonLAFUtils$.$drawDropdownShape$($context$$272$$, this.$_maxItemDim$.$w$ + $DropdownItemSprite$$ + $bgColor$$10_rightPadding$$, $currY$$11$$ + $DvtControlPanelDefaults$$ - $bgAlpha_interItemPadding$$, $DvtControlPanelEvent$$);
  ...
  $dvt$$7$$.$ControlPanel$.prototype.$_createHBarBackground$ = function $$dvt$$7$$$$ControlPanel$$$$_createHBarBackground$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$) {
    ...
    if (0 < $DvtPanControl$$ || $panelDrawerStyle$$) {
      ...
      $panelDrawerStyle$$ ? ($DvtControlPanelEvent$$ = 0 < $DvtPanControl$$ && null != $DvtControlPanelEvent$$ ? $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_BOTTOM$ : $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_LEFT$, $buttonWidth$$5_viewFrame$$ = $dvt$$7$$.$ControlPanelLAFUtils$.$makeViewOpenShapeHelperOpenSide$($context$$286$$, $r$$38_viewShape$$, $DvtControlPanelDefaults$$, $backgroundHeight$$1$$, $DvtControlPanelEvent$$, $panelWidth$$1$$), $r$$38_viewShape$$ = $dvt$$7$$.$ControlPanelLAFUtils$.$makeViewOpenShapeHelperOpenSide$($context$$286$$, 
      $r$$38_viewShape$$, $DvtControlPanelDefaults$$, $backgroundHeight$$1$$, $DvtControlPanelEvent$$, $panelWidth$$1$$)) : ($buttonWidth$$5_viewFrame$$ = $dvt$$7$$.$ControlPanelLAFUtils$.$createEmptyViewOpenShape$($context$$286$$, $DvtControlPanelDefaults$$, this.$getViewPanelHeight$(), !$DropdownItemSprite$$, this.$_styleMap$), $r$$38_viewShape$$ = $dvt$$7$$.$ControlPanelLAFUtils$.$createEmptyViewOpenShape$($context$$286$$, $DvtControlPanelDefaults$$, this.$getViewPanelHeight$(), !$DropdownItemSprite$$, 
      this.$_styleMap$));
  ...
  $dvt$$7$$.$ControlPanel$.prototype.$transitionExpand$ = function $$dvt$$7$$$$ControlPanel$$$$transitionExpand$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$) {
    ...
    if ($DvtPanControl$$ && 0 != $DvtPanControl$$.$w$) {
      var $DvtControlPanelDefaults$$ = $DvtControlPanelEvent$$.$getDimensions$(), $animator$$110$$ = new $dvt$$7$$.$Animator$(this.$getCtx$(), .25);
      $DvtControlPanelEventManager$$.$setAlpha$(1);
      $DvtControlPanelEvent$$.$setAlpha$(0);
      $animator$$110$$.$addProp$($dvt$$7$$.$Animator$.$TYPE_NUMBER$, $DvtControlPanelEventManager$$, $DvtControlPanelEventManager$$.$getAlpha$, $DvtControlPanelEventManager$$.$setAlpha$, 0);
      $animator$$110$$.$addProp$($dvt$$7$$.$Animator$.$TYPE_NUMBER$, $DvtControlPanelEvent$$, $DvtControlPanelEvent$$.$getAlpha$, $DvtControlPanelEvent$$.$setAlpha$, 1);
      $DvtControlPanelEvent$$.$setScaleX$($DvtPanControl$$.$w$ / $DvtControlPanelDefaults$$.$w$);
      $animator$$110$$.$addProp$($dvt$$7$$.$Animator$.$TYPE_NUMBER$, $DvtControlPanelEvent$$, $DvtControlPanelEvent$$.$getScaleX$, $DvtControlPanelEvent$$.$setScaleX$, 1);
      if ($dvt$$7$$.$Agent$.$isRightToLeft$(this.$getCtx$())) {
        ...
        $animator$$110$$.$addProp$($dvt$$7$$.$Animator$.$TYPE_NUMBER$, $DvtControlPanelEvent$$, $DvtControlPanelEvent$$.$getTranslateX$, $DvtControlPanelEvent$$.$setTranslateX$, $DvtControlPanelEventManager$$.$getTranslateX$() + $DropdownItemSprite$$ - $dimWidth$$);
      }
      $DvtControlPanelEvent$$.$setScaleY$($DvtPanControl$$.$h$ / $DvtControlPanelDefaults$$.$h$);
      $animator$$110$$.$addProp$($dvt$$7$$.$Animator$.$TYPE_NUMBER$, $DvtControlPanelEvent$$, $DvtControlPanelEvent$$.$getScaleY$, $DvtControlPanelEvent$$.$setScaleY$, 1);
      $animator$$110$$.$setOnEnd$(function() {
  ...
  $dvt$$7$$.$ControlPanelLAFUtils$.$makeViewOpenShapeHelper$ = function $$dvt$$7$$$$ControlPanelLAFUtils$$$makeViewOpenShapeHelper$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$) {
    var $x$$176$$ = $DvtPanControl$$ + $DvtControlPanelEvent$$, $y$$156$$ = $DropdownItemSprite$$ + $DvtControlPanelEvent$$, $cmds$$17$$ = $dvt$$7$$.$PathUtils$.moveTo($x$$176$$ + $DvtControlPanelEvent$$, $y$$156$$ + $DvtControlPanelEvent$$), $cmds$$17$$ = $cmds$$17$$ + $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ - $DvtPanControl$$, $y$$156$$ + $DvtControlPanelEvent$$), $x$$176$$ = $x$$176$$ - $DvtPanControl$$, $cmds$$17$$ = $cmds$$17$$ + $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ - $DvtControlPanelEvent$$, 
    $y$$156$$ + $DvtControlPanelEvent$$), $cmds$$17$$ = $cmds$$17$$ + $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ - $DvtControlPanelEvent$$, $y$$156$$ - $DropdownItemSprite$$), $y$$156$$ = $y$$156$$ - $DropdownItemSprite$$;
    $DvtControlPanelDefaults$$ ? ($cmds$$17$$ += $dvt$$7$$.$PathUtils$.$quadTo$(-$DvtControlPanelEvent$$ + $x$$176$$, -$dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $y$$156$$, -$dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $x$$176$$, -$dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $y$$156$$) + $dvt$$7$$.$PathUtils$.$quadTo$(-$dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $x$$176$$, -$DvtControlPanelEvent$$ + 
    $y$$156$$, $x$$176$$, -$DvtControlPanelEvent$$ + $y$$156$$) + $dvt$$7$$.$PathUtils$.lineTo($x$$176$$, -$DvtControlPanelEvent$$ + $y$$156$$), $cmds$$17$$ += $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ + $DvtPanControl$$ + $DvtControlPanelEvent$$, -$DvtControlPanelEvent$$ + $y$$156$$), $cmds$$17$$ += $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ + $DvtPanControl$$ + $DvtControlPanelEvent$$, $y$$156$$ + $DropdownItemSprite$$)) : ($cmds$$17$$ += $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ - $DvtControlPanelEvent$$, 
    -$DvtControlPanelEvent$$ + $y$$156$$), $cmds$$17$$ += $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ + $DvtPanControl$$, -$DvtControlPanelEvent$$ + $y$$156$$), $x$$176$$ += $DvtPanControl$$, $cmds$$17$$ += $dvt$$7$$.$PathUtils$.$quadTo$($dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $x$$176$$, -$DvtControlPanelEvent$$ + $y$$156$$, $dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $x$$176$$, -$dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + 
    $y$$156$$) + $dvt$$7$$.$PathUtils$.$quadTo$($DvtControlPanelEvent$$ + $x$$176$$, -$dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $y$$156$$, $DvtControlPanelEvent$$ + $x$$176$$, $y$$156$$) + $dvt$$7$$.$PathUtils$.lineTo($x$$176$$ + $DvtControlPanelEvent$$, $y$$156$$ + $DropdownItemSprite$$));
    $cmds$$17$$ += $dvt$$7$$.$PathUtils$.closePath();
    return new $dvt$$7$$.$Path$($DvtControlPanelEventManager$$, $cmds$$17$$);
  };
  ...
  $dvt$$7$$.$ControlPanelLAFUtils$.$makeZoomShapeHelper$ = function $$dvt$$7$$$$ControlPanelLAFUtils$$$makeZoomShapeHelper$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$) {
    ...
    var $x$$177$$ = $DvtPanControl$$ + $DvtControlPanelEvent$$, $y$$157$$ = $DropdownItemSprite$$, $cmds$$18$$ = $dvt$$7$$.$PathUtils$.moveTo($x$$177$$ + $DvtControlPanelEvent$$, $y$$157$$), $cmds$$18$$ = $DvtControlPanelDefaults$$ ? $cmds$$18$$ + ($dvt$$7$$.$PathUtils$.$quadTo$($DvtControlPanelEvent$$ + $x$$177$$, $dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $y$$157$$, $dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $x$$177$$, $dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * 
    $DvtControlPanelEvent$$ + $y$$157$$) + $dvt$$7$$.$PathUtils$.$quadTo$($dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $x$$177$$, $DvtControlPanelEvent$$ + $y$$157$$, $x$$177$$, $DvtControlPanelEvent$$ + $y$$157$$) + $dvt$$7$$.$PathUtils$.lineTo($x$$177$$, $DvtControlPanelEvent$$ + $y$$157$$)) : $cmds$$18$$ + $dvt$$7$$.$PathUtils$.lineTo($x$$177$$ + $DvtControlPanelEvent$$, $y$$157$$ + $DvtControlPanelEvent$$), $cmds$$18$$ = $cmds$$18$$ + $dvt$$7$$.$PathUtils$.lineTo($x$$177$$ - 
    $DvtPanControl$$, $DvtControlPanelEvent$$ + $y$$157$$), $x$$177$$ = $x$$177$$ - $DvtPanControl$$, $cmds$$18$$ = $cmds$$18$$ + ($dvt$$7$$.$PathUtils$.$quadTo$(-$dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $x$$177$$, $DvtControlPanelEvent$$ + $y$$157$$, -$dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $x$$177$$, $dvt$$7$$.$ControlPanelLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $y$$157$$) + $dvt$$7$$.$PathUtils$.$quadTo$(-$DvtControlPanelEvent$$ + 
    $x$$177$$, $dvt$$7$$.$ControlPanelLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $y$$157$$, -$DvtControlPanelEvent$$ + $x$$177$$, $y$$157$$) + $dvt$$7$$.$PathUtils$.lineTo(-$DvtControlPanelEvent$$ + $x$$177$$, $y$$157$$) + $dvt$$7$$.$PathUtils$.lineTo(-$DvtControlPanelEvent$$ + $x$$177$$, $y$$157$$ - $DropdownItemSprite$$)), $y$$157$$ = $y$$157$$ - $DropdownItemSprite$$, $cmds$$18$$ = $cmds$$18$$ + ($dvt$$7$$.$PathUtils$.lineTo($x$$177$$ + $DvtPanControl$$ + $DvtControlPanelEvent$$, $y$$157$$) + 
    $dvt$$7$$.$PathUtils$.lineTo($x$$177$$ + $DvtPanControl$$ + $DvtControlPanelEvent$$, $y$$157$$ + $DropdownItemSprite$$) + $dvt$$7$$.$PathUtils$.closePath());
    return new $dvt$$7$$.$Path$($DvtControlPanelEventManager$$, $cmds$$18$$);
  };
  ...
  $dvt$$7$$.$ControlPanelLAFUtils$.$GetShapePathCommands$ = function $$dvt$$7$$$$ControlPanelLAFUtils$$$GetShapePathCommands$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $openSideSize$$4$$) {
    ...
    $DvtControlPanelDefaults$$ != $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_TOP$ || $DvtControlPanelEventManager$$ || ($arPoints$$13$$ = ["M", $DvtControlPanelEvent$$, 0, "L", $DvtControlPanelEvent$$, $DvtPanControl$$ - $DropdownItemSprite$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, $DvtControlPanelEvent$$ - $DropdownItemSprite$$, $DvtPanControl$$, "L", 0, $DvtPanControl$$, "L", 0, 0]);
    $DvtControlPanelDefaults$$ == $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_TOP$ && $DvtControlPanelEventManager$$ ? $arPoints$$13$$ = ["M", $DvtControlPanelEvent$$, 0, "L", $DvtControlPanelEvent$$, $DvtPanControl$$, "L", $DropdownItemSprite$$, $DvtPanControl$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, 0, $DvtPanControl$$ - $DropdownItemSprite$$, "L", 0, 0] : $DvtControlPanelDefaults$$ != $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_RIGHT$ || $DvtControlPanelEventManager$$ ? $DvtControlPanelDefaults$$ == 
    $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_RIGHT$ && $DvtControlPanelEventManager$$ ? $arPoints$$13$$ = ["M", 0, 0, "L", $DvtControlPanelEvent$$, 0, "L", $DvtControlPanelEvent$$, $DvtPanControl$$, "L", $DropdownItemSprite$$, $DvtPanControl$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, 0, $DvtPanControl$$ - $DropdownItemSprite$$, "L", 0, $openSideSize$$4$$] : $DvtControlPanelDefaults$$ != $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_LEFT$ || $DvtControlPanelEventManager$$ ? $DvtControlPanelDefaults$$ == 
    $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_LEFT$ && $DvtControlPanelEventManager$$ ? $arPoints$$13$$ = ["M", $DvtControlPanelEvent$$, $DvtPanControl$$, "L", $DropdownItemSprite$$, $DvtPanControl$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, 0, $DvtPanControl$$ - $DropdownItemSprite$$, "L", 0, $DropdownItemSprite$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, $DropdownItemSprite$$, 0, "L", $DvtControlPanelEvent$$, 0] : $DvtControlPanelDefaults$$ != $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_BOTTOM$ || 
    $DvtControlPanelEventManager$$ ? $DvtControlPanelDefaults$$ == $dvt$$7$$.$ControlPanelLAFUtils$.$OPEN_BOTTOM$ && $DvtControlPanelEventManager$$ && ($arPoints$$13$$ = ["M", $DvtControlPanelEvent$$, $DvtPanControl$$, "L", $DvtControlPanelEvent$$, 0, "L", $DropdownItemSprite$$, 0, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 0, 0, $DropdownItemSprite$$, "L", 0, $DvtPanControl$$ - $DropdownItemSprite$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 0, $DropdownItemSprite$$, 
    $DvtPanControl$$, "L", $DvtControlPanelEvent$$ - $openSideSize$$4$$, $DvtPanControl$$]) : $arPoints$$13$$ = ["M", 0, $DvtPanControl$$, "L", 0, 0, "L", $DvtControlPanelEvent$$ - $DropdownItemSprite$$, 0, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, $DvtControlPanelEvent$$, $DropdownItemSprite$$, "L", $DvtControlPanelEvent$$, $DvtPanControl$$ - $DropdownItemSprite$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, $DvtControlPanelEvent$$ - $DropdownItemSprite$$, $DvtPanControl$$, 
    "L", $openSideSize$$4$$, $DvtPanControl$$] : $arPoints$$13$$ = ["M", 0, 0, "L", $DvtControlPanelEvent$$ - $DropdownItemSprite$$, 0, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, $DvtControlPanelEvent$$, $DropdownItemSprite$$, "L", $DvtControlPanelEvent$$, $DvtPanControl$$ - $DropdownItemSprite$$, "A", $DropdownItemSprite$$, $DropdownItemSprite$$, 0, 0, 1, $DvtControlPanelEvent$$ - $DropdownItemSprite$$, $DvtPanControl$$, "L", 0, $DvtPanControl$$] : $arPoints$$13$$ = ["M", $DvtControlPanelEvent$$, 
  ...
  $dvt$$7$$.$PanZoomComponent$.prototype.Init = function $$dvt$$7$$$$PanZoomComponent$$$Init$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$) {
    ...
    this.$_bSupportsVectorEffects$ = !$dvt$$7$$.$Agent$.$isEnvironmentBatik$();
  ...
  $dvt$$7$$.$PanZoomCanvas$.prototype.$panBy$ = function $$dvt$$7$$$$PanZoomCanvas$$$$panBy$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$) {
    if (this.$_bPanningEnabled$) {
      ...
      $DvtControlPanelEvent$$ = function $$DvtControlPanelEvent$$$() {
        $thisRef$$38$$.$FirePanEvent$($dvt$$7$$.$PanEvent$.$SUBTYPE_PANNING$, $newX$$5$$, $newY$$6$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $DvtPanControl$$);
      };
      $deltaY$$15_fireEndEventFunc$$ = function $$deltaY$$15_fireEndEventFunc$$$() {
        $thisRef$$38$$.$FirePanEvent$($dvt$$7$$.$PanEvent$.$SUBTYPE_PANNED$, $newX$$5$$, $newY$$6$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $DvtPanControl$$);
      };
    ...
    if (this.$_bZoomingEnabled$) {
      ...
      if ($dvt$$7$$.$PanZoomCanvas$.$RoundFloatForCompare$($DvtControlPanelDefaults$$) != $dvt$$7$$.$PanZoomCanvas$.$RoundFloatForCompare$($newZoom$$4$$)) {
        ...
        var $thisRef$$39$$ = this, $deltaZoom_fireStartEventFunc$$1$$ = function $$deltaZoom_fireStartEventFunc$$1$$$() {
          $thisRef$$39$$.$FireZoomEvent$($dvt$$7$$.$ZoomEvent$.$SUBTYPE_ZOOMING$, $newZoom$$4$$, $DvtControlPanelDefaults$$, $DropdownItemSprite$$, null, $DvtControlPanelEvent$$, $DvtPanControl$$, $xDiff$$, $yDiff$$);
        }, $fireEndEventFunc$$1$$ = function $$fireEndEventFunc$$1$$$() {
          $thisRef$$39$$.$FireZoomEvent$($dvt$$7$$.$ZoomEvent$.$SUBTYPE_ZOOMED$, $thisRef$$39$$.$getZoom$(), $DvtControlPanelDefaults$$, $DropdownItemSprite$$, null, $DvtControlPanelEvent$$, $DvtPanControl$$, $xDiff$$, $yDiff$$);
        };
      ...
      try {
        ...
        if ($bounds$$111$$ = this.$FireZoomEvent$($dvt$$7$$.$ZoomEvent$.$SUBTYPE_ZOOM_TO_FIT_CALC_BOUNDS$, null, null, $DvtControlPanelEventManager$$, $bounds$$111$$).$_zoomToFitBounds$) {
          var $dz$$6$$ = Math.min((this.$_ww$ - 2 * this.$_zoomToFitPadding$) / $bounds$$111$$.$w$, (this.$_hh$ - 2 * this.$_zoomToFitPadding$) / $bounds$$111$$.$h$), $dz$$6$$ = this.$ConstrainZoom$($dz$$6$$), $dx$$18$$ = this.$_ww$ / 2 - ($bounds$$111$$.x + $bounds$$111$$.$w$ / 2) * $dz$$6$$, $dy$$20$$ = this.$_hh$ / 2 - ($bounds$$111$$.y + $bounds$$111$$.$h$ / 2) * $dz$$6$$, $thisRef$$40$$ = this, $fireStartEventFunc$$2$$ = function $$fireStartEventFunc$$2$$$() {
            $thisRef$$40$$.$FireZoomEvent$($dvt$$7$$.$ZoomEvent$.$SUBTYPE_ZOOM_TO_FIT_BEGIN$, null, null, $DvtControlPanelEventManager$$, $bounds$$111$$);
          }, $fireEndEventFunc$$2$$ = function $$fireEndEventFunc$$2$$$() {
            $thisRef$$40$$.$FireZoomEvent$($dvt$$7$$.$ZoomEvent$.$SUBTYPE_ZOOM_TO_FIT_END$, null, null, $DvtControlPanelEventManager$$, $bounds$$111$$);
          };
  ...
  $dvt$$7$$.$PanZoomCanvas$.prototype.$FirePanEvent$ = function $$dvt$$7$$$$PanZoomCanvas$$$$FirePanEvent$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $animator$$125$$) {
    $DvtControlPanelEventManager$$ = new $dvt$$7$$.$PanEvent$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $animator$$125$$);
    this.$FireListener$($DvtControlPanelEventManager$$);
  };
  ...
  $dvt$$7$$.$CollapsiblePanel$ = function $$dvt$$7$$$$CollapsiblePanel$$($dvt$$7$$, $DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $disclosed$$1$$, $isFixed$$) {
    this.Init($dvt$$7$$, $DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $disclosed$$1$$, $isFixed$$);
  };
  ...
  $dvt$$7$$.$CollapsiblePanel$.prototype.Init = function $$dvt$$7$$$$CollapsiblePanel$$$Init$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$, $styleMap$$61$$, $disclosed$$2$$, $isFixed$$1$$) {
  ...
  $dvt$$7$$.$ButtonLAFUtils$.$createLayoutItemButtonState$ = function $$dvt$$7$$$$ButtonLAFUtils$$$createLayoutItemButtonState$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$) {
    var $r$$51$$ = $dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelDefaults$$, "buttonRadius", 0), $w$$34$$ = $dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelDefaults$$, $dvt$$7$$.$ControlPanel$.$CP_BUTTON_WIDTH$, 0), $h$$27$$ = $dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelDefaults$$, $dvt$$7$$.$ControlPanel$.$CP_BUTTON_WIDTH$, 0), $shape$$67$$ = $dvt$$7$$.$ButtonLAFUtils$.$_createBaseButtonShape$($DvtControlPanelEventManager$$, $r$$51$$, $w$$34$$, $h$$27$$, $DvtControlPanelDefaults$$);
    $dvt$$7$$.$ButtonLAFUtils$.$_setButtonColors$($DvtPanControl$$, $shape$$67$$, $w$$34$$, $h$$27$$ + 2 * $r$$51$$, $DvtControlPanelDefaults$$, !0);
    $DvtControlPanelEvent$$ = $dvt$$7$$.$ButtonLAFUtils$.$_getLayoutURI$($DvtControlPanelEventManager$$, $DvtPanControl$$, $DvtControlPanelEvent$$);
    ($DvtControlPanelEventManager$$ = $dvt$$7$$.$ButtonLAFUtils$.$_loadIcon$($DvtControlPanelEventManager$$, $DropdownItemSprite$$[$DvtControlPanelEvent$$], $w$$34$$, $h$$27$$)) && $shape$$67$$.$addChild$($DvtControlPanelEventManager$$);
    return $shape$$67$$;
  };
  ...
  $dvt$$7$$.$ButtonLAFUtils$.$_setCloseButtonColors$ = function $$dvt$$7$$$$ButtonLAFUtils$$$_setCloseButtonColors$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$) {
    if ($dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelDefaults$$, $dvt$$7$$.$ControlPanel$.$CP_PANEL_DRAWER_STYLES$, null)) {
      ...
      var $borderColor$$43_stroke$$85$$, $fillType$$11$$ = $dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelDefaults$$, $dvt$$7$$.$CSSStyle$.$FILL_TYPE$, null);
      $borderColor$$43_stroke$$85$$ = $dvt$$7$$.$StyleUtils$.$getStyle$($DvtControlPanelDefaults$$, $dvt$$7$$.$CSSStyle$.$BORDER_COLOR$, null);
      if ("solid" == $fillType$$11$$) {
        ...
        $borderColor$$43_stroke$$85$$ = new $dvt$$7$$.$SolidStroke$($borderColor$$43_stroke$$85$$, $strokeAlpha$$2$$);
      } else {
        ...
        $borderColor$$43_stroke$$85$$ = new $dvt$$7$$.$SolidStroke$($borderColor$$43_stroke$$85$$, 1, .8);
      }
  ...
  $dvt$$7$$.$ButtonLAFUtils$.$_createBaseButtonShape$ = function $$dvt$$7$$$$ButtonLAFUtils$$$_createBaseButtonShape$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$, $DvtControlPanelDefaults$$) {
    ...
    var $y$$159$$ = $DropdownItemSprite$$ + $DvtControlPanelEvent$$, $cmds$$21$$ = $dvt$$7$$.$PathUtils$.moveTo($DvtControlPanelDefaults$$ + $DvtControlPanelEvent$$, $y$$159$$) + $dvt$$7$$.$PathUtils$.$quadTo$($DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $y$$159$$, $dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + 
    $y$$159$$) + $dvt$$7$$.$PathUtils$.$quadTo$($dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $DvtControlPanelEvent$$ + $y$$159$$, $DvtControlPanelDefaults$$, $DvtControlPanelEvent$$ + $y$$159$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$, $y$$159$$ + $DvtControlPanelEvent$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ - $DvtPanControl$$, $DvtControlPanelEvent$$ + $y$$159$$);
    $DvtControlPanelDefaults$$ -= $DvtPanControl$$;
    $cmds$$21$$ += $dvt$$7$$.$PathUtils$.$quadTo$(-$dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $DvtControlPanelEvent$$ + $y$$159$$, -$dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $y$$159$$) + $dvt$$7$$.$PathUtils$.$quadTo$(-$DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + 
    $y$$159$$, -$DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $y$$159$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ - $DvtControlPanelEvent$$, $y$$159$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ - $DvtControlPanelEvent$$, $y$$159$$ - $DropdownItemSprite$$);
    $y$$159$$ -= $DropdownItemSprite$$;
    $cmds$$21$$ += $dvt$$7$$.$PathUtils$.$quadTo$(-$DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, -$dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $y$$159$$, -$dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, -$dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $y$$159$$) + $dvt$$7$$.$PathUtils$.$quadTo$(-$dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, -$DvtControlPanelEvent$$ + 
    $y$$159$$, $DvtControlPanelDefaults$$, -$DvtControlPanelEvent$$ + $y$$159$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$, -$DvtControlPanelEvent$$ + $y$$159$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ + $DvtPanControl$$, -$DvtControlPanelEvent$$ + $y$$159$$);
    $DvtControlPanelDefaults$$ += $DvtPanControl$$;
    $cmds$$21$$ += $dvt$$7$$.$PathUtils$.$quadTo$($dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, -$DvtControlPanelEvent$$ + $y$$159$$, $dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, -$dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DvtControlPanelEvent$$ + $y$$159$$) + $dvt$$7$$.$PathUtils$.$quadTo$($DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, -$dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DvtControlPanelEvent$$ + 
    $y$$159$$, $DvtControlPanelEvent$$ + $DvtControlPanelDefaults$$, $y$$159$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ + $DvtControlPanelEvent$$, $y$$159$$ + $DropdownItemSprite$$) + $dvt$$7$$.$PathUtils$.closePath();
    return new $dvt$$7$$.$Path$($DvtControlPanelEventManager$$, $cmds$$21$$);
  };
  $dvt$$7$$.$ButtonLAFUtils$.$drawDropdownShape$ = function $$dvt$$7$$$$ButtonLAFUtils$$$drawDropdownShape$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$, $DvtPanControl$$, $DropdownItemSprite$$) {
    ...
    var $DvtControlPanelDefaults$$ = $DvtControlPanelEvent$$ + $DropdownItemSprite$$, $y$$160$$ = $DvtPanControl$$, $cmds$$22$$ = $dvt$$7$$.$PathUtils$.moveTo($DvtControlPanelDefaults$$ + $DropdownItemSprite$$, $y$$160$$) + $dvt$$7$$.$PathUtils$.$quadTo$($DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DropdownItemSprite$$ + $y$$160$$, $dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * 
    $DropdownItemSprite$$ + $y$$160$$) + $dvt$$7$$.$PathUtils$.$quadTo$($dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $DropdownItemSprite$$ + $y$$160$$, $DvtControlPanelDefaults$$, $DropdownItemSprite$$ + $y$$160$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$, $DropdownItemSprite$$ + $y$$160$$) + $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ - $DvtControlPanelEvent$$, $DropdownItemSprite$$ + $y$$160$$), $DvtControlPanelDefaults$$ = 
    $DvtControlPanelDefaults$$ - $DvtControlPanelEvent$$, $cmds$$22$$ = $cmds$$22$$ + ($dvt$$7$$.$PathUtils$.$quadTo$(-$dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * $DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $DropdownItemSprite$$ + $y$$160$$, -$dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$SIN_PI_4$ * $DropdownItemSprite$$ + $y$$160$$) + $dvt$$7$$.$PathUtils$.$quadTo$(-$DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $dvt$$7$$.$ButtonLAFUtils$.$TAN_PI_8$ * 
    $DropdownItemSprite$$ + $y$$160$$, -$DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $y$$160$$) + $dvt$$7$$.$PathUtils$.lineTo(-$DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $y$$160$$) + $dvt$$7$$.$PathUtils$.lineTo(-$DropdownItemSprite$$ + $DvtControlPanelDefaults$$, $y$$160$$ - $DvtPanControl$$)), $y$$160$$ = $y$$160$$ - $DvtPanControl$$, $cmds$$22$$ = $cmds$$22$$ + ($dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ + $DvtControlPanelEvent$$ + $DropdownItemSprite$$, $y$$160$$) + 
    $dvt$$7$$.$PathUtils$.lineTo($DvtControlPanelDefaults$$ + $DvtControlPanelEvent$$ + $DropdownItemSprite$$, $y$$160$$ + $DvtPanControl$$) + $dvt$$7$$.$PathUtils$.closePath());
    return new $dvt$$7$$.$Path$($DvtControlPanelEventManager$$, $cmds$$22$$);
  };
  ...
  $dvt$$7$$.$ButtonLAFUtils$.$parseStyle$ = function $$dvt$$7$$$$ButtonLAFUtils$$$parseStyle$$($DvtControlPanelEventManager$$, $DvtControlPanelEvent$$) {
    ...
    var $DropdownItemSprite$$ = new $dvt$$7$$.$SolidStroke$($DropdownItemSprite$$), $fill$$59_fill_colors$$13_midColor$$11$$;
    if ("solid" == $DvtPanControl$$) {
      $fill$$59_fill_colors$$13_midColor$$11$$ = new $dvt$$7$$.$SolidFill$($DvtControlPanelDefaults$$);
    } else {
      ...
      if ($background$$16$$ && 0 <= $background$$16$$.indexOf("linear-gradient")) {
        ...
        $fill$$59_fill_colors$$13_midColor$$11$$ = $DvtControlPanelDefaults$$, $endColor$$16_fill_alphas$$13$$ = $dvt$$7$$.$ButtonLAFUtils$.$DEFAULT_END_COLOR$, $fill$$59_fill_colors$$13_midColor$$11$$ != $dvt$$7$$.$ButtonLAFUtils$.$DEFAULT_MID_COLOR$ && ($endColor$$16_fill_alphas$$13$$ = $dvt$$7$$.$ColorUtils$.$inferColor$($dvt$$7$$.$ButtonLAFUtils$.$DEFAULT_MID_COLOR$, $dvt$$7$$.$ButtonLAFUtils$.$DEFAULT_END_COLOR$, $fill$$59_fill_colors$$13_midColor$$11$$)), $fill$$59_fill_colors$$13_midColor$$11$$ = 
      ...
      $fill$$59_fill_colors$$13_midColor$$11$$ = new $dvt$$7$$.$LinearGradientFill$($degree$$3$$, $fill$$59_fill_colors$$13_midColor$$11$$, $endColor$$16_fill_alphas$$13$$, $fill_ratios$$13$$);
    }
