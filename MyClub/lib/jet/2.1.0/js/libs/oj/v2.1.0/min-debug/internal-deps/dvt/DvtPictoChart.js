...
(function($dvt$$8$$) {
  ...
  function $DvtPictoChartImageMarker$$($dvt$$8$$, $DvtPictoChartShapeMarker$$, $DvtPictoChartKeyboardHandler$$, $DvtPictoChartItem$$, $DvtPictoChartDefaults$$, $DvtPictoChartEventManager$$, $DvtPictoChartAutomation$$, $DvtPictoChartRenderer$$, $sourceHoverSelected$$1$$, $id$$163$$) {
    $DvtPictoChartImageMarker$$.$superclass$.Init.call(this, $dvt$$8$$.$getCtx$(), $DvtPictoChartShapeMarker$$, $DvtPictoChartKeyboardHandler$$, $DvtPictoChartItem$$, $DvtPictoChartDefaults$$, null, $DvtPictoChartEventManager$$, $DvtPictoChartAutomation$$, $DvtPictoChartRenderer$$, $sourceHoverSelected$$1$$, $id$$163$$);
    this.$_picto$ = $dvt$$8$$;
  }
  ...
  $dvt$$8$$.$PictoChart$.prototype.$_getAnimationOnDisplay$ = function $$dvt$$8$$$$PictoChart$$$$_getAnimationOnDisplay$$() {
    ...
    if ("popIn" == $DvtPictoChartShapeMarker$$) {
      ...
      if ("none" != $DvtPictoChartShapeMarker$$) {
        for ($DvtPictoChartShapeMarker$$ = 0;$DvtPictoChartShapeMarker$$ < this.$_markers$.length;$DvtPictoChartShapeMarker$$++) {
          var $DvtPictoChartEventManager$$ = this.$_markers$[$DvtPictoChartShapeMarker$$], $DvtPictoChartAutomation$$ = new $dvt$$8$$.$CustomAnimation$($DvtPictoChartItem$$, $DvtPictoChartEventManager$$, $DvtPictoChartKeyboardHandler$$), $startState$$10$$, $endState$$22$$;
          $DvtPictoChartRenderer$$.$isVertical$(this) ? ($startState$$10$$ = $DvtPictoChartRenderer$$.$isOriginRight$(this) ? this.$Width$ : 0, $endState$$22$$ = $DvtPictoChartEventManager$$.$getCx$(), $DvtPictoChartEventManager$$.$setCx$($startState$$10$$), $DvtPictoChartAutomation$$.$_animator$.$addProp$($dvt$$8$$.$Animator$.$TYPE_NUMBER$, $DvtPictoChartEventManager$$, $DvtPictoChartEventManager$$.$getCx$, $DvtPictoChartEventManager$$.$setCx$, $endState$$22$$)) : ($startState$$10$$ = $DvtPictoChartRenderer$$.$isOriginBottom$(this) ? 
          this.$Height$ : 0, $endState$$22$$ = $DvtPictoChartEventManager$$.$getCy$(), $DvtPictoChartEventManager$$.$setCy$($startState$$10$$), $DvtPictoChartAutomation$$.$_animator$.$addProp$($dvt$$8$$.$Animator$.$TYPE_NUMBER$, $DvtPictoChartEventManager$$, $DvtPictoChartEventManager$$.$getCy$, $DvtPictoChartEventManager$$.$setCy$, $endState$$22$$));
  ...
  $DvtPictoChartRenderer$$.$render$ = function $$DvtPictoChartRenderer$$$$render$$($DvtPictoChartKeyboardHandler$$, $DvtPictoChartItem$$, $DvtPictoChartDefaults$$, $DvtPictoChartEventManager$$) {
    var $DvtPictoChartAutomation$$ = $DvtPictoChartKeyboardHandler$$.$getCtx$(), $background$$17_gapRatio$$2$$ = new $dvt$$8$$.Rect($DvtPictoChartAutomation$$, $DvtPictoChartDefaults$$.x, $DvtPictoChartDefaults$$.y, $DvtPictoChartDefaults$$.$w$, $DvtPictoChartDefaults$$.$h$);
    $background$$17_gapRatio$$2$$.$setInvisibleFill$();
    $DvtPictoChartItem$$.$addChild$($background$$17_gapRatio$$2$$);
    ...
    if ($DvtPictoChartEventManager$$.items) {
      ...
      for (var $background$$17_gapRatio$$2$$ = $DvtPictoChartKeyboardHandler$$.$getOptions$()._gapRatio, $isVert$$12$$ = $DvtPictoChartRenderer$$.$isVertical$($DvtPictoChartKeyboardHandler$$), $isOriginBottom$$1$$ = $DvtPictoChartRenderer$$.$isOriginBottom$($DvtPictoChartKeyboardHandler$$), $isOriginRight$$1$$ = $DvtPictoChartRenderer$$.$isOriginRight$($DvtPictoChartKeyboardHandler$$), $cellMap$$1$$ = new $dvt$$8$$.$Map2D$, $prevColSpan$$ = 0, $prevRowSpan$$ = 0, $remainder$$ = 0, $i$$566$$ = 0;$i$$566$$ < 
      $DvtPictoChartEventManager$$.items.length;$i$$566$$++) {
        for (var $item$$46$$ = $DvtPictoChartEventManager$$.items[$i$$566$$], $colSpan$$1$$ = $item$$46$$.$getColSpan$(), $rowSpan$$1$$ = $item$$46$$.$getRowSpan$(), $w$$36$$ = $colSpan$$1$$ * $DvtPictoChartEventManager$$.$colWidth$, $h$$31$$ = $rowSpan$$1$$ * $DvtPictoChartEventManager$$.$rowHeight$, $count$$26$$ = $item$$46$$.getCount(), $index$$183$$ = 0, $isFirstMarker$$ = !0, $cell$$28$$;0 < $count$$26$$;) {
          ...
          var $x$$181_xOffset$$4$$ = $cell$$28$$.$col$ * $DvtPictoChartEventManager$$.$colWidth$ + $w$$36$$ / 2, $y$$161_yOffset$$6$$ = $cell$$28$$.$row$ * $DvtPictoChartEventManager$$.$rowHeight$ + $h$$31$$ / 2, $x$$181_xOffset$$4$$ = $DvtPictoChartDefaults$$.x + ($isOriginRight$$1$$ ? $DvtPictoChartDefaults$$.$w$ - $x$$181_xOffset$$4$$ : $x$$181_xOffset$$4$$), $y$$161_yOffset$$6$$ = $DvtPictoChartDefaults$$.y + ($isOriginBottom$$1$$ ? $DvtPictoChartDefaults$$.$h$ - $y$$161_yOffset$$6$$ : $y$$161_yOffset$$6$$), 
          $fraction$$1$$ = Math.min(1 - $remainder$$, $count$$26$$), $rectX$$, $rectY$$, $rectW$$1$$, $rectH$$1$$;
          $isVert$$12$$ ? ($rectX$$ = $x$$181_xOffset$$4$$ - $w$$36$$ / 2, $rectY$$ = $isOriginBottom$$1$$ ? $y$$161_yOffset$$6$$ + $h$$31$$ * (.5 - $fraction$$1$$ - $remainder$$) : $y$$161_yOffset$$6$$ + $h$$31$$ * ($remainder$$ - .5), $rectW$$1$$ = $w$$36$$, $rectH$$1$$ = $h$$31$$ * $fraction$$1$$) : ($rectX$$ = $isOriginRight$$1$$ ? $x$$181_xOffset$$4$$ + $w$$36$$ * (.5 - $fraction$$1$$ - $remainder$$) : $x$$181_xOffset$$4$$ + $w$$36$$ * ($remainder$$ - .5), $rectY$$ = $y$$161_yOffset$$6$$ - $h$$31$$ / 
          2, $rectW$$1$$ = $w$$36$$ * $fraction$$1$$, $rectH$$1$$ = $h$$31$$);
          var $marker$$15_markerId$$;
          1 == $fraction$$1$$ ? ($marker$$15_markerId$$ = $item$$46$$.getId() + "_" + $index$$183$$, $index$$183$$++) : $marker$$15_markerId$$ = Math.random();
          if ($item$$46$$.$getSource$()) {
            $marker$$15_markerId$$ = new $DvtPictoChartImageMarker$$($DvtPictoChartKeyboardHandler$$, $x$$181_xOffset$$4$$, $y$$161_yOffset$$6$$, $w$$36$$, $h$$31$$, $item$$46$$.$getSource$(), $item$$46$$.$getSourceSelected$(), $item$$46$$.$getSourceHover$(), $item$$46$$.$getSourceHoverSelected$(), $marker$$15_markerId$$ + "_I");
          } else {
            ...
            $item$$46$$.$addChild$($clipPath$$14_hitArea$$3$$);
            $marker$$15_markerId$$ = new $DvtPictoChartShapeMarker$$($DvtPictoChartKeyboardHandler$$, $item$$46$$.$getShape$(), $x$$181_xOffset$$4$$, $y$$161_yOffset$$6$$, $w$$36$$ - $DvtPictoChartEventManager$$.$colWidth$ * $background$$17_gapRatio$$2$$, $h$$31$$ - $DvtPictoChartEventManager$$.$rowHeight$ * $background$$17_gapRatio$$2$$, $marker$$15_markerId$$ + "_S");
            $marker$$15_markerId$$.$setSolidFill$($item$$46$$.$getColor$());
            $marker$$15_markerId$$.$setSolidStroke$($item$$46$$.$getBorderColor$(), null, $item$$46$$.$getBorderWidth$());
            $marker$$15_markerId$$.$setDataColor$($item$$46$$.$getColor$());
            $marker$$15_markerId$$.$setClassName$($item$$46$$.$getClassName$());
            $marker$$15_markerId$$.$setStyle$($item$$46$$.$getStyle$());
          }
          1 > $fraction$$1$$ && ($clipPath$$14_hitArea$$3$$ = new $dvt$$8$$.$ClipPath$, $clipPath$$14_hitArea$$3$$.$addRect$($rectX$$, $rectY$$, $rectW$$1$$, $rectH$$1$$), $marker$$15_markerId$$.$setClipPath$($clipPath$$14_hitArea$$3$$));
          $isFirstMarker$$ && ($item$$46$$.$setKeyboardTooltipLocation$(new $dvt$$8$$.$Point$($x$$181_xOffset$$4$$, $y$$161_yOffset$$6$$)), $isFirstMarker$$ = !1);
          $item$$46$$.$addChild$($marker$$15_markerId$$);
          $DvtPictoChartKeyboardHandler$$.$registerMarker$($marker$$15_markerId$$);
          $count$$26$$ -= $fraction$$1$$;
          $remainder$$ = ($remainder$$ + $fraction$$1$$) % 1;
        }
        $DvtPictoChartItem$$.$addChild$($item$$46$$);
        $item$$46$$.$updateAriaAttributes$();
  ...
  $DvtPictoChartRenderer$$.$getInfo$ = function $$DvtPictoChartRenderer$$$$getInfo$$($DvtPictoChartShapeMarker$$, $DvtPictoChartKeyboardHandler$$, $DvtPictoChartImageMarker$$) {
    ...
    for (var $DvtPictoChartAutomation$$ = $dvt$$8$$.$ArrayUtils$.$createBooleanMap$($DvtPictoChartDefaults$$.hiddenCategories), $items$$29$$ = [], $numCells$$ = 0, $maxColSpan$$ = 1, $maxRowSpan$$ = 1, $colCount$$1_i$$567$$ = 0;$colCount$$1_i$$567$$ < $DvtPictoChartEventManager$$.length;$colCount$$1_i$$567$$++) {
      if (null != $DvtPictoChartEventManager$$[$colCount$$1_i$$567$$]) {
        var $item$$47$$ = new $DvtPictoChartItem$$($DvtPictoChartShapeMarker$$, $DvtPictoChartEventManager$$[$colCount$$1_i$$567$$]);
        if (!$DvtPictoChartAutomation$$ || !$dvt$$8$$.$ArrayUtils$.$hasAnyMapItem$($DvtPictoChartAutomation$$, $item$$47$$.$getCategories$())) {
          var $colSpan$$2$$ = $item$$47$$.$getColSpan$(), $rowSpan$$2$$ = $item$$47$$.$getRowSpan$();
          $colSpan$$2$$ > $maxColSpan$$ && ($maxColSpan$$ = $colSpan$$2$$);
          $rowSpan$$2$$ > $maxRowSpan$$ && ($maxRowSpan$$ = $rowSpan$$2$$);
          $numCells$$ += $colSpan$$2$$ * $rowSpan$$2$$ * $item$$47$$.getCount();
          $items$$29$$.push($item$$47$$);
        }
      }
    }
    if (0 == $numCells$$) {
    ...
    $colCount$$1_i$$567$$ = $DvtPictoChartDefaults$$.columnCount;
    $DvtPictoChartDefaults$$ = $DvtPictoChartDefaults$$.rowCount;
    $colCount$$1_i$$567$$ || $DvtPictoChartDefaults$$ || ($DvtPictoChartKeyboardHandler$$ && $DvtPictoChartImageMarker$$ ? $DvtPictoChartShapeMarker$$ ? $DvtPictoChartDefaults$$ = $DvtPictoChartRenderer$$.$_ceil$(Math.sqrt($numCells$$ * $DvtPictoChartImageMarker$$ / $DvtPictoChartKeyboardHandler$$), $maxRowSpan$$) : $colCount$$1_i$$567$$ = $DvtPictoChartRenderer$$.$_ceil$(Math.sqrt($numCells$$ * $DvtPictoChartKeyboardHandler$$ / $DvtPictoChartImageMarker$$), $maxColSpan$$) : $DvtPictoChartKeyboardHandler$$ ? 
    $colCount$$1_i$$567$$ = Math.max(Math.floor($DvtPictoChartKeyboardHandler$$ / $DvtPictoChartEventManager$$), 1) : $DvtPictoChartImageMarker$$ ? $DvtPictoChartDefaults$$ = Math.max(Math.floor($DvtPictoChartImageMarker$$ / $DvtPictoChartAutomation$$), 1) : $DvtPictoChartShapeMarker$$ ? $DvtPictoChartDefaults$$ = $DvtPictoChartRenderer$$.$_ceil$(Math.sqrt($numCells$$), $maxRowSpan$$) : $colCount$$1_i$$567$$ = $DvtPictoChartRenderer$$.$_ceil$(Math.sqrt($numCells$$), $maxColSpan$$));
    $colCount$$1_i$$567$$ ? $DvtPictoChartDefaults$$ || ($DvtPictoChartDefaults$$ = $DvtPictoChartRenderer$$.$_ceil$($numCells$$ / $colCount$$1_i$$567$$, $maxRowSpan$$)) : $colCount$$1_i$$567$$ = $DvtPictoChartRenderer$$.$_ceil$($numCells$$ / $DvtPictoChartDefaults$$, $maxColSpan$$);
    $DvtPictoChartKeyboardHandler$$ && $DvtPictoChartImageMarker$$ && ($DvtPictoChartEventManager$$ || ($DvtPictoChartEventManager$$ = $DvtPictoChartAutomation$$ ? $DvtPictoChartAutomation$$ : Math.min($DvtPictoChartKeyboardHandler$$ / $colCount$$1_i$$567$$, $DvtPictoChartImageMarker$$ / $DvtPictoChartDefaults$$)), $DvtPictoChartAutomation$$ || ($DvtPictoChartAutomation$$ = $DvtPictoChartEventManager$$));
    return 0 >= $colCount$$1_i$$567$$ || 0 >= $DvtPictoChartDefaults$$ || 0 >= $DvtPictoChartEventManager$$ || 0 >= $DvtPictoChartAutomation$$ ? {} : {items:$items$$29$$, $colCount$:$colCount$$1_i$$567$$, $rowCount$:$DvtPictoChartDefaults$$, $colWidth$:$DvtPictoChartEventManager$$, $rowHeight$:$DvtPictoChartAutomation$$};
  };
