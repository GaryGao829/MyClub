...
(function($dvt$$9$$) {
  ...
  $DvtBreadcrumbsRenderer$$.$render$ = function $$DvtBreadcrumbsRenderer$$$$render$$($DvtTrainEvent$$, $DvtAccordionDefaults$$, $DvtPanelDrawerKeyboardHandler$$) {
    for (var $DvtPanelDrawerEventManager$$ = $DvtTrainEvent$$.$getCtx$(), $DvtPanelDrawerTab$$ = $DvtTrainEvent$$.$__getData$().items ? $DvtTrainEvent$$.$__getData$().items : [], $DvtBreadcrumbsEventManager$$ = $DvtTrainEvent$$.$_options$, $DvtBreadcrumbsDefaults$$ = $DvtTrainEvent$$.$getEventManager$(), $labels$$23$$ = [], $peers$$9$$ = [], $i$$571$$ = 0;$i$$571$$ < $DvtPanelDrawerTab$$.length;$i$$571$$++) {
      var $dataItem$$52_peer$$31$$ = $DvtPanelDrawerTab$$[$i$$571$$];
      if ($dataItem$$52_peer$$31$$) {
        var $label$$71$$ = $DvtBreadcrumbsRenderer$$.$_createLabel$($DvtPanelDrawerEventManager$$, $dataItem$$52_peer$$31$$.label ? $dataItem$$52_peer$$31$$.label : "", $DvtBreadcrumbsEventManager$$, $i$$571$$ < $DvtPanelDrawerTab$$.length - 1);
        $labels$$23$$.push($label$$71$$);
        $dataItem$$52_peer$$31$$ = new $DvtBreadcrumbsPeer$$($dataItem$$52_peer$$31$$.id, $label$$71$$);
        $DvtBreadcrumbsDefaults$$.$associate$($label$$71$$, $dataItem$$52_peer$$31$$);
        $peers$$9$$.push($dataItem$$52_peer$$31$$);
        $i$$571$$ < $DvtPanelDrawerTab$$.length - 1 && $dataItem$$52_peer$$31$$.$setDrillable$(!0);
      }
    }
  ...
  $DvtBreadcrumbsRenderer$$.$_positionLabels$ = function $$DvtBreadcrumbsRenderer$$$$_positionLabels$$($DvtTrainEvent$$, $DvtAccordionDefaults$$, $DvtPanelDrawerKeyboardHandler$$, $DvtPanelDrawerEventManager$$, $DvtPanelDrawerTab$$) {
    for (var $DvtBreadcrumbsPeer$$ = $DvtTrainEvent$$.$_options$, $DvtBreadcrumbsEventManager$$ = $DvtTrainEvent$$.$getEventManager$(), $DvtBreadcrumbsDefaults$$ = [], $maxHeight$$11$$ = 0, $i$$572$$ = 0;$i$$572$$ < $DvtPanelDrawerEventManager$$.length;$i$$572$$++) {
      $DvtAccordionDefaults$$.$addChild$($DvtPanelDrawerEventManager$$[$i$$572$$]);
      var $dims$$48_separator$$1$$ = $DvtPanelDrawerEventManager$$[$i$$572$$].$getDimensions$();
      $DvtBreadcrumbsDefaults$$[$i$$572$$] = $dims$$48_separator$$1$$;
      $maxHeight$$11$$ = Math.max($dims$$48_separator$$1$$.$h$, $maxHeight$$11$$);
      $DvtAccordionDefaults$$.removeChild($DvtPanelDrawerEventManager$$[$i$$572$$]);
    }
    for (var $x$$182$$ = 0, $i$$572$$ = 0;$i$$572$$ < $DvtPanelDrawerEventManager$$.length;$i$$572$$++) {
      $DvtAccordionDefaults$$.$addChild$($DvtPanelDrawerEventManager$$[$i$$572$$]);
      $dims$$48_separator$$1$$ = $DvtBreadcrumbsDefaults$$[$i$$572$$];
      $DvtPanelDrawerEventManager$$[$i$$572$$].$setTranslate$($x$$182$$, .5 * ($maxHeight$$11$$ - $dims$$48_separator$$1$$.$h$));
      if ($dvt$$9$$.$Agent$.$isTouchDevice$()) {
        var $rect$$32_sepDims_separatorWidth$$ = new $dvt$$9$$.Rect($DvtAccordionDefaults$$.$getCtx$(), -$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, -$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$48_separator$$1$$.$w$ + 2 * $DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$48_separator$$1$$.$h$ + 2 * $DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$);
        $rect$$32_sepDims_separatorWidth$$.$setInvisibleFill$();
        $DvtPanelDrawerEventManager$$[$i$$572$$].$addChild$($rect$$32_sepDims_separatorWidth$$);
        $i$$572$$ < $DvtPanelDrawerTab$$.length && $DvtBreadcrumbsEventManager$$.$associate$($rect$$32_sepDims_separatorWidth$$, $DvtPanelDrawerTab$$[$i$$572$$]);
      }
      if ($x$$182$$ + $dims$$48_separator$$1$$.$w$ > $DvtPanelDrawerKeyboardHandler$$) {
        $DvtTrainEvent$$ = $DvtBreadcrumbsRenderer$$.$_getLabelTextString$($DvtPanelDrawerEventManager$$[$i$$572$$]);
        $DvtBreadcrumbsRenderer$$.$_truncateLabels$($DvtPanelDrawerEventManager$$[$i$$572$$], $DvtPanelDrawerKeyboardHandler$$ - $x$$182$$);
        $i$$572$$ < $DvtPanelDrawerTab$$.length ? $DvtPanelDrawerTab$$[$i$$572$$].$setTooltip$($DvtTrainEvent$$) : $DvtBreadcrumbsEventManager$$.$associate$($DvtPanelDrawerEventManager$$[$i$$572$$], new $dvt$$9$$.$SimpleObjPeer$($DvtTrainEvent$$));
        break;
      } else {
        $x$$182$$ += $dims$$48_separator$$1$$.$w$ + $DvtBreadcrumbsPeer$$.$__labelGap$;
      }
      if ($i$$572$$ < $DvtPanelDrawerEventManager$$.length - 1) {
        $dims$$48_separator$$1$$ = $DvtBreadcrumbsRenderer$$.$_newSeparator$($DvtTrainEvent$$);
        $DvtAccordionDefaults$$.$addChild$($dims$$48_separator$$1$$);
        $rect$$32_sepDims_separatorWidth$$ = $dims$$48_separator$$1$$.$getDimensions$();
        $dims$$48_separator$$1$$.$setTranslate$($x$$182$$, .5 * ($maxHeight$$11$$ - $rect$$32_sepDims_separatorWidth$$.$h$));
        $rect$$32_sepDims_separatorWidth$$ = $rect$$32_sepDims_separatorWidth$$.$w$;
        if ($x$$182$$ + $rect$$32_sepDims_separatorWidth$$ > $DvtPanelDrawerKeyboardHandler$$) {
          $DvtAccordionDefaults$$.removeChild($dims$$48_separator$$1$$);
          break;
        }
        $x$$182$$ += $rect$$32_sepDims_separatorWidth$$ + $DvtBreadcrumbsPeer$$.$__labelGap$;
      }
    }
  };
  $DvtBreadcrumbsRenderer$$.$_positionLabelsBidi$ = function $$DvtBreadcrumbsRenderer$$$$_positionLabelsBidi$$($DvtTrainEvent$$, $DvtAccordionDefaults$$, $DvtPanelDrawerKeyboardHandler$$, $DvtPanelDrawerEventManager$$, $DvtPanelDrawerTab$$) {
    for (var $DvtBreadcrumbsPeer$$ = $DvtTrainEvent$$.$_options$, $DvtBreadcrumbsEventManager$$ = $DvtTrainEvent$$.$getEventManager$(), $DvtBreadcrumbsDefaults$$ = 0;$DvtBreadcrumbsDefaults$$ < $DvtPanelDrawerEventManager$$.length;$DvtBreadcrumbsDefaults$$++) {
      ...
      var $dims$$49_separator$$2$$ = $DvtPanelDrawerEventManager$$[$DvtBreadcrumbsDefaults$$].$getDimensions$();
      if ($dvt$$9$$.$Agent$.$isTouchDevice$()) {
        var $rect$$33_separatorWidth$$1$$ = new $dvt$$9$$.Rect($DvtAccordionDefaults$$.$getCtx$(), -$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, -$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$49_separator$$2$$.$w$ + 2 * $DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$49_separator$$2$$.$h$ + 2 * $DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$);
      ...
      if (0 > $DvtPanelDrawerKeyboardHandler$$ - $dims$$49_separator$$2$$.$w$) {
        ...
        $DvtPanelDrawerEventManager$$[$DvtBreadcrumbsDefaults$$].$setTranslateX$($DvtPanelDrawerKeyboardHandler$$ - $dims$$49_separator$$2$$.$w$), $DvtPanelDrawerKeyboardHandler$$ -= $dims$$49_separator$$2$$.$w$ + $DvtBreadcrumbsPeer$$.$__labelGap$;
      }
      if ($DvtBreadcrumbsDefaults$$ < $DvtPanelDrawerEventManager$$.length - 1) {
        if ($dims$$49_separator$$2$$ = $DvtBreadcrumbsRenderer$$.$_newSeparator$($DvtTrainEvent$$), $DvtAccordionDefaults$$.$addChild$($dims$$49_separator$$2$$), $rect$$33_separatorWidth$$1$$ = $dims$$49_separator$$2$$.$getDimensions$().$w$, 0 > $DvtPanelDrawerKeyboardHandler$$ - $rect$$33_separatorWidth$$1$$) {
          $DvtAccordionDefaults$$.removeChild($dims$$49_separator$$2$$);
          break;
        } else {
          $dims$$49_separator$$2$$.$setTranslateX$($DvtPanelDrawerKeyboardHandler$$ - $rect$$33_separatorWidth$$1$$), $DvtPanelDrawerKeyboardHandler$$ -= $rect$$33_separatorWidth$$1$$ + $DvtBreadcrumbsPeer$$.$__labelGap$;
        }
      }
    }
  };
