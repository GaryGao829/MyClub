...
(function($dvt$$10$$) {
  ...
  function $DvtTagCloudItem$$($dvt$$10$$, $DvtTagCloudKeyboardHandler$$, $DvtTagCloudEventManager$$, $DvtTagCloudLayoutUtils$$, $DvtTagCloudDefaults$$, $DvtTagCloudObjPeer$$, $DvtTagCloudItem$$, $DvtTagCloudAutomation$$, $DvtTagCloudRenderer$$) {
    this.Init($dvt$$10$$, $DvtTagCloudKeyboardHandler$$, $DvtTagCloudEventManager$$, $DvtTagCloudLayoutUtils$$, $DvtTagCloudDefaults$$, $DvtTagCloudObjPeer$$, $DvtTagCloudItem$$, $DvtTagCloudAutomation$$, $DvtTagCloudRenderer$$);
  }
  ...
  $DvtTagCloudItem$$.prototype.Init = function $$DvtTagCloudItem$$$$Init$($dvt$$10$$, $DvtTagCloudKeyboardHandler$$, $DvtTagCloudEventManager$$, $DvtTagCloudLayoutUtils$$, $DvtTagCloudDefaults$$, $DvtTagCloudObjPeer$$, $DvtTagCloudAutomation$$, $DvtTagCloudRenderer$$, $DvtTagCloudStyleUtils$$) {
    $DvtTagCloudItem$$.$superclass$.Init.call(this, $DvtTagCloudKeyboardHandler$$, $DvtTagCloudEventManager$$, $DvtTagCloudLayoutUtils$$, $DvtTagCloudDefaults$$, $DvtTagCloudObjPeer$$, $DvtTagCloudStyleUtils$$);
    this.$_tagCloud$ = $dvt$$10$$;
    this.$alignAuto$();
    this.$TextInstance$.$setStyle$($DvtTagCloudAutomation$$);
    this.$TextInstance$.$setClassName$($DvtTagCloudRenderer$$);
  ...
  $DvtTagCloudRenderer$$.$_renderItems$ = function $$DvtTagCloudRenderer$$$$_renderItems$$($DvtTagCloudKeyboardHandler$$, $DvtTagCloudEventManager$$, $DvtTagCloudDefaults$$) {
    for (var $DvtTagCloudAutomation$$ = $DvtTagCloudKeyboardHandler$$.$getOptions$(), $DvtTagCloudRenderer$$ = [], $DvtTagCloudStyleUtils$$ = $DvtTagCloudAutomation$$.items, $fontSizeFunction_minValue$$12$$ = Number.MAX_VALUE, $categoryMap$$2_maxValue$$13$$ = -Number.MAX_VALUE, $i$$587$$ = 0;$i$$587$$ < $DvtTagCloudStyleUtils$$.length;$i$$587$$++) {
      $fontSizeFunction_minValue$$12$$ = Math.min($fontSizeFunction_minValue$$12$$, $DvtTagCloudStyleUtils$$[$i$$587$$].value), $categoryMap$$2_maxValue$$13$$ = Math.max($categoryMap$$2_maxValue$$13$$, $DvtTagCloudStyleUtils$$[$i$$587$$].value);
    }
    ...
    for ($i$$587$$ = 0;$i$$587$$ < $DvtTagCloudStyleUtils$$.length;$i$$587$$++) {
      var $data$$109$$ = $DvtTagCloudStyleUtils$$[$i$$587$$];
      $data$$109$$.categories || ($data$$109$$.categories = [$data$$109$$.label]);
      if (!$categoryMap$$2_maxValue$$13$$ || !$dvt$$10$$.$ArrayUtils$.$hasAnyMapItem$($categoryMap$$2_maxValue$$13$$, $data$$109$$.categories)) {
        var $item$$49_style$$102$$ = $DvtTagCloudAutomation$$.styleDefaults.style.clone(), $color$$70_peer$$36$$ = $data$$109$$.color, $itemStyle$$2$$ = $data$$109$$.style;
        if ($itemStyle$$2$$) {
          $itemStyle$$2$$ instanceof Object || ($itemStyle$$2$$ = $dvt$$10$$.$CSSStyle$.$cssStringToObject$($itemStyle$$2$$));
          $itemStyle$$2$$.color && ($color$$70_peer$$36$$ = $itemStyle$$2$$.color, delete $itemStyle$$2$$.color);
          for (var $textProperties$$ = $dvt$$10$$.$CSSStyle$.$getTextMeasurementProperties$(), $index$$193$$ = 0;$index$$193$$ < $textProperties$$.length;$index$$193$$++) {
            $itemStyle$$2$$[$textProperties$$[$index$$193$$]] && ($item$$49_style$$102$$.$setStyle$($textProperties$$[$index$$193$$], $itemStyle$$2$$[$textProperties$$[$index$$193$$]]), delete $itemStyle$$2$$[$textProperties$$[$index$$193$$]]);
          }
        }
        $color$$70_peer$$36$$ && $item$$49_style$$102$$.$setStyle$($dvt$$10$$.$CSSStyle$.$COLOR$, $color$$70_peer$$36$$);
        $item$$49_style$$102$$.$setStyle$($dvt$$10$$.$CSSStyle$.$FONT_SIZE$, $fontSizeFunction_minValue$$12$$.call(null, $data$$109$$.value).toString());
        $item$$49_style$$102$$ = new $DvtTagCloudItem$$($DvtTagCloudKeyboardHandler$$, $DvtTagCloudKeyboardHandler$$.$getCtx$(), $data$$109$$.label, 0, 0, $item$$49_style$$102$$, $itemStyle$$2$$, $data$$109$$.className, $data$$109$$.id);
        $color$$70_peer$$36$$ = new $DvtTagCloudObjPeer$$($DvtTagCloudKeyboardHandler$$, $item$$49_style$$102$$, $data$$109$$);
        $DvtTagCloudKeyboardHandler$$.$EventManager$.$associate$($item$$49_style$$102$$, $color$$70_peer$$36$$);
        $DvtTagCloudKeyboardHandler$$.$registerObject$($color$$70_peer$$36$$, $i$$587$$);
        "none" !== $DvtTagCloudAutomation$$.selectionMode && $color$$70_peer$$36$$.$setSelectable$(!0);
        ($color$$70_peer$$36$$.$isSelectable$() || $data$$109$$.url || $color$$70_peer$$36$$.$getAction$()) && $item$$49_style$$102$$.setCursor("pointer");
        $DvtTagCloudRenderer$$.push($item$$49_style$$102$$);
        $DvtTagCloudEventManager$$.$addChild$($item$$49_style$$102$$);
      }
    }
  ...
  $DvtTagCloudLayoutUtils$$.$cloudLayout$ = function $$DvtTagCloudLayoutUtils$$$$cloudLayout$$($DvtTagCloudKeyboardHandler$$, $DvtTagCloudEventManager$$) {
    ...
    for (var $DvtTagCloudItem$$ = 2 * Math.PI / 180, $DvtTagCloudAutomation$$ = null, $DvtTagCloudRenderer$$ = 0, $DvtTagCloudStyleUtils$$ = [], $sinCache$$ = [], $i$$588$$ = 0;$i$$588$$ < $DvtTagCloudEventManager$$.length;$i$$588$$++) {
      for (var $placed$$ = !1, $step$$4$$ = 0, $stepIncrement$$ = 4, $tag$$2$$ = $DvtTagCloudEventManager$$[$i$$588$$], $dims$$54$$ = $tag$$2$$.$getDimensions$(), $DvtTagCloudRenderer$$ = Math.max($DvtTagCloudRenderer$$, parseFloat($tag$$2$$.$getCSSStyle$().$getStyle$($dvt$$10$$.$CSSStyle$.$FONT_SIZE$))), $lastCollisionIndex$$ = -1;!$placed$$;) {
        var $j$$81_lookup$$ = $step$$4$$ % 180;
        void 0 === $DvtTagCloudStyleUtils$$[$j$$81_lookup$$] && ($DvtTagCloudStyleUtils$$[$j$$81_lookup$$] = Math.cos($step$$4$$ * $DvtTagCloudItem$$));
        void 0 === $sinCache$$[$j$$81_lookup$$] && ($sinCache$$[$j$$81_lookup$$] = Math.sin($step$$4$$ * $DvtTagCloudItem$$));
        var $x$$190$$ = $DvtTagCloudDefaults$$ * $step$$4$$ * $DvtTagCloudStyleUtils$$[$j$$81_lookup$$], $y$$167$$ = $DvtTagCloudObjPeer$$ * $step$$4$$ * $sinCache$$[$j$$81_lookup$$], $rect$$37$$ = new $dvt$$10$$.$Rectangle$($x$$190$$, $y$$167$$, $dims$$54$$.$w$, $dims$$54$$.$h$), $placed$$ = !0;
        -1 != $lastCollisionIndex$$ && $DvtTagCloudLayoutUtils$$[$lastCollisionIndex$$].$intersects$($rect$$37$$) && ($placed$$ = !1);
        if ($placed$$) {
          for ($j$$81_lookup$$ = 0;$j$$81_lookup$$ < $i$$588$$;$j$$81_lookup$$++) {
            if ($DvtTagCloudLayoutUtils$$[$j$$81_lookup$$].$intersects$($rect$$37$$)) {
        ...
        $placed$$ && ($DvtTagCloudAutomation$$ = $DvtTagCloudAutomation$$ ? $DvtTagCloudAutomation$$.$getUnion$($rect$$37$$) : $rect$$37$$, $lastCollisionIndex$$ = -1, $DvtTagCloudLayoutUtils$$[$i$$588$$] = $rect$$37$$, $tag$$2$$.$setX$($x$$190$$), $tag$$2$$.$setY$(-$dims$$54$$.y + $y$$167$$));
  ...
  $DvtTagCloudLayoutUtils$$.$rectangleLayout$ = function $$DvtTagCloudLayoutUtils$$$$rectangleLayout$$($DvtTagCloudKeyboardHandler$$, $DvtTagCloudEventManager$$, $DvtTagCloudDefaults$$) {
    for (var $DvtTagCloudObjPeer$$ = [], $DvtTagCloudItem$$ = 0, $DvtTagCloudAutomation$$ = 0, $DvtTagCloudRenderer$$ = 0, $DvtTagCloudStyleUtils$$ = 0;$DvtTagCloudStyleUtils$$ < $DvtTagCloudEventManager$$.length;$DvtTagCloudStyleUtils$$++) {
      var $lineWidth$$7_maxScale_tag$$3$$ = $DvtTagCloudEventManager$$[$DvtTagCloudStyleUtils$$], $dims$$55_lineStart$$ = $lineWidth$$7_maxScale_tag$$3$$.$getDimensions$(), $DvtTagCloudItem$$ = Math.max($DvtTagCloudItem$$, $dims$$55_lineStart$$.$w$), $DvtTagCloudAutomation$$ = Math.max($DvtTagCloudAutomation$$, $dims$$55_lineStart$$.$h$), $DvtTagCloudRenderer$$ = Math.max($DvtTagCloudRenderer$$, parseFloat($lineWidth$$7_maxScale_tag$$3$$.$getCSSStyle$().$getStyle$($dvt$$10$$.$CSSStyle$.$FONT_SIZE$)));
      $DvtTagCloudObjPeer$$.push(new $dvt$$10$$.$Dimension$($dims$$55_lineStart$$.$w$, $dims$$55_lineStart$$.$h$));
    }
    ...
    for ($DvtTagCloudStyleUtils$$ = 0;$DvtTagCloudStyleUtils$$ < $DvtTagCloudRenderer$$.length - 1;$DvtTagCloudStyleUtils$$++) {
      var $dims$$55_lineStart$$ = $DvtTagCloudRenderer$$[$DvtTagCloudStyleUtils$$], $lineEnd$$ = $DvtTagCloudRenderer$$[$DvtTagCloudStyleUtils$$ + 1], $hPadding$$1$$ = 0, $bottomY$$1_maxLineHeight$$ = 0, $justified$$ = !0;
      if (1 < $lineEnd$$ - $dims$$55_lineStart$$) {
        for (var $lineWidth$$7_maxScale_tag$$3$$ = 0, $flowPadding_j$$82$$ = $dims$$55_lineStart$$;$flowPadding_j$$82$$ < $lineEnd$$;$flowPadding_j$$82$$++) {
          $lineWidth$$7_maxScale_tag$$3$$ += $DvtTagCloudObjPeer$$[$flowPadding_j$$82$$].$w$ * $DvtTagCloudItem$$, $bottomY$$1_maxLineHeight$$ = Math.max($bottomY$$1_maxLineHeight$$, $DvtTagCloudObjPeer$$[$flowPadding_j$$82$$].$h$ * $DvtTagCloudItem$$);
        }
        $hPadding$$1$$ = ($DvtTagCloudKeyboardHandler$$.$w$ - 10 - $lineWidth$$7_maxScale_tag$$3$$) / ($lineEnd$$ - $dims$$55_lineStart$$ - 1);
        $DvtTagCloudStyleUtils$$ == $DvtTagCloudRenderer$$.length - 2 && ($flowPadding_j$$82$$ = .5 * $bottomY$$1_maxLineHeight$$, $flowPadding_j$$82$$ < $hPadding$$1$$ && $lineWidth$$7_maxScale_tag$$3$$ + ($lineEnd$$ - $dims$$55_lineStart$$) * $flowPadding_j$$82$$ < .9 * ($DvtTagCloudKeyboardHandler$$.$w$ - 10) && ($hPadding$$1$$ = $flowPadding_j$$82$$, $justified$$ = !1));
      }
      for (var $bottomY$$1_maxLineHeight$$ = 5 + ($DvtTagCloudStyleUtils$$ + 1) * ($DvtTagCloudAutomation$$ * $DvtTagCloudItem$$ + 2) - 2, $curX$$2$$ = $DvtTagCloudDefaults$$ ? $DvtTagCloudKeyboardHandler$$.$w$ - 5 : 5, $flowPadding_j$$82$$ = $dims$$55_lineStart$$;$flowPadding_j$$82$$ < $lineEnd$$;$flowPadding_j$$82$$++) {
        var $lineWidth$$7_maxScale_tag$$3$$ = $DvtTagCloudEventManager$$[$flowPadding_j$$82$$], $fontSize$$9$$ = parseFloat($lineWidth$$7_maxScale_tag$$3$$.$getCSSStyle$().$getStyle$($dvt$$10$$.$CSSStyle$.$FONT_SIZE$));
        ...
        $justified$$ && $flowPadding_j$$82$$ == $lineEnd$$ - 1 && $flowPadding_j$$82$$ != $dims$$55_lineStart$$ ? $DvtTagCloudDefaults$$ ? ($lineWidth$$7_maxScale_tag$$3$$.$alignLeft$(), $lineWidth$$7_maxScale_tag$$3$$.$setX$($DvtTagCloudKeyboardHandler$$.x + 5)) : ($lineWidth$$7_maxScale_tag$$3$$.$alignRight$(), $lineWidth$$7_maxScale_tag$$3$$.$setX$($DvtTagCloudKeyboardHandler$$.x + $DvtTagCloudKeyboardHandler$$.$w$ - 5)) : ($lineWidth$$7_maxScale_tag$$3$$.$setX$($DvtTagCloudKeyboardHandler$$.x + 
        $curX$$2$$), $DvtTagCloudDefaults$$ ? ($lineWidth$$7_maxScale_tag$$3$$.$alignRight$(), $curX$$2$$ -= $DvtTagCloudObjPeer$$[$flowPadding_j$$82$$].$w$ * $DvtTagCloudItem$$ + $hPadding$$1$$) : ($lineWidth$$7_maxScale_tag$$3$$.$alignLeft$(), $curX$$2$$ += $DvtTagCloudObjPeer$$[$flowPadding_j$$82$$].$w$ * $DvtTagCloudItem$$ + $hPadding$$1$$));
      }
    }
  };
