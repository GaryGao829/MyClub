...
(function($dvt$$11$$) {
  ...
  function $DvtMapLinkPeer$$($dvt$$11$$, $DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$, $DvtMapCustomAreaLayer$$) {
    this.Init($dvt$$11$$, $DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$, $DvtMapCustomAreaLayer$$);
  }
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$_createLayers$ = function $$dvt$$11$$$$ThematicMap$$$$_createLayers$$() {
    ...
    this.$_linkLayers$ = new $dvt$$11$$.$Container$(this.$getCtx$());
  };
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$PreRender$ = function $$dvt$$11$$$$ThematicMap$$$$PreRender$$() {
    ...
    !this.$_isResize$ && this.$_pzcContainer$ && (this.$_layers$ = [], this.$_drilledRowKeys$ = [], this.$_initDrilled$ = {}, this.$_drillDataLayer$ = {}, this.$_childToParent$ = {}, this.$_drilled$ = [], this.removeChild(this.$_legendPanel$), this.$_legendData$ = this.$_legend$ = this.$_legendPanel$ = null, this.$setDisplayedControls$($dvt$$11$$.$ControlPanel$.$CONTROLS_ALL$), this.$_panning$ = this.$_zooming$ = !0, this.$_oldPzc$ = this.$_pzc$, this.$_createLayers$(), this.$_showPopupBehaviors$ = 
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$_render$ = function $$dvt$$11$$$$ThematicMap$$$$_render$$($dvt$$11$$, $DvtThematicMapControlPanel$$) {
    ...
    $dvt$$11$$.$addChild$(this.$_linkLayers$);
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$_setInitialKeyboardFocus$ = function $$dvt$$11$$$$ThematicMap$$$$_setInitialKeyboardFocus$$() {
    if (this.$_keyboardHandler$) {
      var $dvt$$11$$ = this.$getNavigableAreas$();
      0 == $dvt$$11$$.length && ($dvt$$11$$ = this.$getNavigableMarkers$());
      0 == $dvt$$11$$.length && ($dvt$$11$$ = this.$getNavigableLinks$());
      this.$EventManager$.$setInitialFocus$($dvt$$11$$[0]);
    }
  };
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$_updateAnimator$ = function $$dvt$$11$$$$ThematicMap$$$$_updateAnimator$$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$) {
    ...
    if ($DvtThematicMapEventManager$$) {
      ...
      $DvtThematicMapEventManager$$.$addProp$($dvt$$11$$.$Animator$.$TYPE_MATRIX$, this.$_linkLayers$, this.$_linkLayers$.$getMatrix$, this.$_linkLayers$.$setMatrix$, $DvtThematicMapKeyboardHandler$$);
    }
  };
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$getNavigableMarkers$ = function $$dvt$$11$$$$ThematicMap$$$$getNavigableMarkers$$() {
    var $dvt$$11$$ = [];
    if (this.$_topLayer$) {
      for (var $DvtThematicMapControlPanel$$ = 0;$DvtThematicMapControlPanel$$ < this.$_layers$.length;$DvtThematicMapControlPanel$$++) {
        ...
        if (this.$_topLayer$.$LayerName$ == this.$_layers$[$DvtThematicMapControlPanel$$].$LayerName$ || !(this.$_layers$[$DvtThematicMapControlPanel$$] instanceof $DvtMapAreaLayer$$)) {
          for (var $DvtThematicMapEventManager$$ in $DvtThematicMapJsonParser$$) {
            $dvt$$11$$ = $dvt$$11$$.concat($DvtThematicMapJsonParser$$[$DvtThematicMapEventManager$$].$_markerObjs$);
          }
        }
      }
    }
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$getNavigableLinks$ = function $$dvt$$11$$$$ThematicMap$$$$getNavigableLinks$$() {
    var $dvt$$11$$ = [];
    if (this.$_topLayer$) {
      for (var $DvtThematicMapControlPanel$$ = 0;$DvtThematicMapControlPanel$$ < this.$_layers$.length;$DvtThematicMapControlPanel$$++) {
        var $DvtThematicMapJsonParser$$ = this.$_layers$[$DvtThematicMapControlPanel$$].$DataLayers$;
        if (this.$_topLayer$.$LayerName$ == this.$_layers$[$DvtThematicMapControlPanel$$].$LayerName$ || !(this.$_layers$[$DvtThematicMapControlPanel$$] instanceof $DvtMapAreaLayer$$)) {
          for (var $DvtThematicMapEventManager$$ in $DvtThematicMapJsonParser$$) {
            $dvt$$11$$ = $dvt$$11$$.concat($DvtThematicMapJsonParser$$[$DvtThematicMapEventManager$$].$_linkObjs$);
          }
        }
      }
    }
  ...
  $dvt$$11$$.$ThematicMap$.prototype.$highlight$ = function $$dvt$$11$$$$ThematicMap$$$$highlight$$($DvtThematicMapControlPanel$$) {
    ...
    $dvt$$11$$.$CategoryRolloverHandler$.$highlight$($DvtThematicMapControlPanel$$, this.$getNavigableAreas$().concat(this.$getNavigableMarkers$()).concat(this.$getNavigableLinks$()), "any" == this.$Options$.highlightMatch);
  };
  ...
  $dvt$$11$$.$Obj$.$createSubclass$($DvtMapObjPeer$$, $dvt$$11$$.$Obj$, "DvtMapObjPeer");
  ...
  $DvtMapObjPeer$$.prototype.Init = function $$DvtMapObjPeer$$$$Init$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$) {
    ...
    this.$Displayable$ && (this.$Displayable$.$setStyle$($DvtThematicMapControlPanel$$.style).$setClassName$($DvtThematicMapControlPanel$$.className), $DvtThematicMapControlPanel$$.destination ? (this.$Displayable$.$setAriaRole$("link"), this.$_linkCallback$ = $dvt$$11$$.$ToolkitUtils$.$getLinkCallback$("_blank", $DvtThematicMapControlPanel$$.destination)) : this.$Displayable$.$setAriaRole$("img"));
  ...
  $DvtMapObjPeer$$.prototype.$_setCenter$ = function $$DvtMapObjPeer$$$$$_setCenter$$($dvt$$11$$) {
    this.$_center$ = $dvt$$11$$;
    this.$__recenter$();
  };
  ...
  $DvtMapObjPeer$$.prototype.$getCategories$ = function $$DvtMapObjPeer$$$$$getCategories$$() {
    var $dvt$$11$$ = this.$_data$.categories;
    return $dvt$$11$$ ? $dvt$$11$$ : [];
  };
  ...
  $DvtMapObjPeer$$.prototype.$getNextNavigable$ = function $$DvtMapObjPeer$$$$$getNextNavigable$$($DvtThematicMapControlPanel$$) {
    if ($DvtThematicMapControlPanel$$.type == $dvt$$11$$.MouseEvent.$CLICK$ || $DvtThematicMapControlPanel$$.keyCode == $dvt$$11$$.KeyboardEvent.$SPACE$ && $DvtThematicMapControlPanel$$.ctrlKey) {
      return this;
    }
    if (($DvtThematicMapControlPanel$$.keyCode == $dvt$$11$$.KeyboardEvent.$OPEN_ANGLED_BRACKET$ || $dvt$$11$$.KeyboardEvent.$CLOSE_ANGLED_BRACKET$) && $DvtThematicMapControlPanel$$.altKey) {
    ...
    return $dvt$$11$$.$KeyboardHandler$.$getNextAdjacentNavigable$(this, $DvtThematicMapControlPanel$$, this.$GetNavigables$());
  };
  ...
  $DvtMapObjPeer$$.prototype.$HandleZoomEvent$ = function $$DvtMapObjPeer$$$$$HandleZoomEvent$$($dvt$$11$$) {
    this.$Displayable$.getParent() && (this.Zoom = $dvt$$11$$.$_a$, this.$__recenter$());
  };
  ...
  $dvt$$11$$.$Obj$.$createSubclass$($DvtMapAreaPeer$$, $DvtMapObjPeer$$, "DvtMapAreaPeer");
  ...
  $dvt$$11$$.$Obj$.$createSubclass$($DvtMapLinkPeer$$, $DvtMapObjPeer$$, "DvtMapLinkPeer");
  $DvtMapLinkPeer$$.prototype.Init = function $$DvtMapLinkPeer$$$$Init$($dvt$$11$$, $DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$, $DvtMapCustomAreaLayer$$) {
    $DvtMapLinkPeer$$.$superclass$.Init.call(this, $dvt$$11$$, $DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$);
  ...
  $DvtMapLinkPeer$$.prototype.$getNextNavigable$ = function $$DvtMapLinkPeer$$$$$getNextNavigable$$($DvtThematicMapControlPanel$$) {
    ...
    return $DvtThematicMapControlPanel$$.type == $dvt$$11$$.MouseEvent.$CLICK$ || $DvtThematicMapControlPanel$$.keyCode == $dvt$$11$$.KeyboardEvent.$SPACE$ && $DvtThematicMapControlPanel$$.ctrlKey ? this : $DvtThematicMapJsonParser$$.$_linkNavType$ === $DvtThematicMapKeyboardHandler$$.$LINK_NODE_NAV$ ? $DvtThematicMapControlPanel$$.keyCode === $dvt$$11$$.KeyboardEvent.$UP_ARROW$ ? ($DvtThematicMapControlPanel$$ = $DvtThematicMapJsonParser$$.$_linkMarker$.getId(), $DvtThematicMapControlPanel$$ = this.$getDataLayer$().$getNavigableLinksForNodeId$($DvtThematicMapControlPanel$$), 
    $DvtThematicMapJsonParser$$ = $DvtThematicMapControlPanel$$.indexOf(this), $DvtThematicMapJsonParser$$++, $DvtThematicMapJsonParser$$ === $DvtThematicMapControlPanel$$.length && ($DvtThematicMapJsonParser$$ = 0), $DvtThematicMapControlPanel$$[$DvtThematicMapJsonParser$$]) : $DvtThematicMapControlPanel$$.keyCode === $dvt$$11$$.KeyboardEvent.$DOWN_ARROW$ ? ($DvtThematicMapControlPanel$$ = $DvtThematicMapJsonParser$$.$_linkMarker$.getId(), $DvtThematicMapControlPanel$$ = this.$getDataLayer$().$getNavigableLinksForNodeId$($DvtThematicMapControlPanel$$), 
    $DvtThematicMapJsonParser$$ = $DvtThematicMapControlPanel$$.indexOf(this), $DvtThematicMapJsonParser$$--, -1 === $DvtThematicMapJsonParser$$ && ($DvtThematicMapJsonParser$$ = $DvtThematicMapControlPanel$$.length - 1), $DvtThematicMapControlPanel$$[$DvtThematicMapJsonParser$$]) : $DvtThematicMapControlPanel$$.keyCode === $dvt$$11$$.KeyboardEvent.$LEFT_ARROW$ ? this.$_startPt$.x <= this.$_endPt$.x ? this.$_startMarker$ : this.$_endMarker$ : $DvtThematicMapControlPanel$$.keyCode === $dvt$$11$$.KeyboardEvent.$RIGHT_ARROW$ ? 
    this.$_startPt$.x >= this.$_endPt$.x ? this.$_startMarker$ : this.$_endMarker$ : this : $dvt$$11$$.$KeyboardHandler$.$getNextAdjacentNavigable$(this, $DvtThematicMapControlPanel$$, this.$GetNavigables$());
  };
  ...
  $DvtMapLinkPeer$$.prototype.$__recenter$ = function $$DvtMapLinkPeer$$$$$__recenter$$() {
    if (this.$Displayable$.getParent()) {
      var $DvtThematicMapControlPanel$$ = new $dvt$$11$$.$Point$(this.$_startPt$.x * this.Zoom, this.$_startPt$.y * this.Zoom), $DvtThematicMapEventManager$$ = new $dvt$$11$$.$Point$(this.$_endPt$.x * this.Zoom, this.$_endPt$.y * this.Zoom), $DvtThematicMapControlPanel$$ = $DvtThematicMapJsonParser$$.$calcCurve$(this.$_dataLayer$, this.$_startPt$, this.$_endPt$, $DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$);
  ...
  $DvtMapLinkPeer$$.prototype.$animateUpdate$ = function $$DvtMapLinkPeer$$$$$animateUpdate$$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$) {
    var $DvtThematicMapEventManager$$ = new $dvt$$11$$.$CustomAnimation$(this.$_view$.$getCtx$(), this.$Displayable$, this.$getDataLayer$().$getAnimationDuration$()), $DvtThematicMapKeyboardHandler$$ = $DvtThematicMapJsonParser$$.$getDisplayable$(), $DvtMapDataLayer$$ = $DvtThematicMapKeyboardHandler$$.$getStroke$(), $DvtMapCustomAreaLayer$$ = this.$Displayable$.$getStroke$();
    $DvtMapCustomAreaLayer$$.$getColor$() != $DvtMapDataLayer$$.$getColor$() && (this.$Displayable$.$setStroke$($DvtMapDataLayer$$), $DvtThematicMapEventManager$$.$_animator$.$addProp$($dvt$$11$$.$Animator$.$TYPE_STROKE$, this.$Displayable$, this.$Displayable$.$getStroke$, this.$Displayable$.$setStroke$, $DvtMapCustomAreaLayer$$));
    var $DvtMapDataLayer$$ = $DvtThematicMapJsonParser$$.$_endPt$, $DvtMapCustomAreaLayer$$ = this.$_endPt$, $DvtMapAreaLayer$$ = !0;
    $DvtThematicMapJsonParser$$.$_startPt$.$equals$(this.$_startPt$) && $DvtMapDataLayer$$.$equals$($DvtMapCustomAreaLayer$$) || ($DvtMapAreaLayer$$ = !1, this.$Displayable$.$setAlpha$(0), $DvtThematicMapEventManager$$.$_animator$.$addProp$($dvt$$11$$.$Animator$.$TYPE_NUMBER$, this.$Displayable$, this.$Displayable$.$getAlpha$, this.$Displayable$.$setAlpha$, 1), $DvtThematicMapEventManager$$.$_animator$.$addProp$($dvt$$11$$.$Animator$.$TYPE_NUMBER$, $DvtThematicMapKeyboardHandler$$, $DvtThematicMapKeyboardHandler$$.$getAlpha$, 
    $DvtThematicMapKeyboardHandler$$.$setAlpha$, 0));
    ...
    if (this.$_oldDataLayer$) {
      ...
      if ("auto" == $DvtThematicMapEventManager$$) {
        ...
        if ($dvt$$11$$.$BlackBoxAnimationHandler$.isSupported($DvtThematicMapEventManager$$)) {
          ...
          for (var $DvtMapLinkPeer$$ = $DvtThematicMapControlPanel$$.$getNonScaledContainers$(), $DvtMapDataLayer$$ = 0;$DvtMapDataLayer$$ < $DvtMapLinkPeer$$.length;$DvtMapDataLayer$$++) {
            $DvtMapLayer$$ = new $dvt$$11$$.Rect(this.$_tmap$.$getCtx$(), 0, 0, this.$_tmap$.getWidth(), this.$_tmap$.getHeight()), $DvtMapLayer$$.$setFill$(null), $DvtMapLinkPeer$$[$DvtMapDataLayer$$].$addChild$($DvtMapLayer$$);
          }
          $DvtMapCustomAreaLayer$$ = $dvt$$11$$.$BlackBoxAnimationHandler$.$getCombinedAnimation$(this.$_tmap$.$getCtx$(), $DvtThematicMapEventManager$$, $DvtMapAreaLayer$$, $DvtMapLinkPeer$$, $DvtMapCustomAreaLayer$$, $DvtThematicMapKeyboardHandler$$);
          $DvtMapAreaLayer$$ = new $dvt$$11$$.$Rectangle$(0, 0, this.$_tmap$.getWidth() / this.$PzcMatrix$.$_a$, this.$_tmap$.getHeight() / this.$PzcMatrix$.$_a$);
          $DvtMapLinkPeer$$ = this.$_oldDataLayer$.$getScaledContainers$();
          for ($DvtMapDataLayer$$ = 0;$DvtMapDataLayer$$ < $DvtMapLinkPeer$$.length;$DvtMapDataLayer$$++) {
            $DvtMapLayer$$ = new $dvt$$11$$.Rect(this.$_tmap$.$getCtx$(), 0, 0, this.$_tmap$.getWidth() / this.$PzcMatrix$.$_a$, this.$_tmap$.getHeight() / this.$PzcMatrix$.$_a$), $DvtMapLayer$$.$setFill$(null), $DvtMapLinkPeer$$[$DvtMapDataLayer$$].$addChild$($DvtMapLayer$$);
          }
          ...
          $DvtMapDataLayer$$ = $dvt$$11$$.$BlackBoxAnimationHandler$.$getCombinedAnimation$(this.$_tmap$.$getCtx$(), $DvtThematicMapEventManager$$, $DvtMapLinkPeer$$, $DvtMapArea$$, $DvtMapAreaLayer$$, $DvtThematicMapKeyboardHandler$$);
      ...
      if (this.$_animation$) {
        ...
        var $DvtMapAreaPeer$$ = this;
        this.$_animation$.$setOnEnd$(function() {
          $DvtMapAreaPeer$$.$OnAnimationEnd$($DvtThematicMapControlPanel$$);
        }, this);
  ...
  $DvtMapDataLayer$$.prototype.Init = function $$DvtMapDataLayer$$$$Init$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$) {
    ...
    this.$_dataLinkLayer$ = new $dvt$$11$$.$Container$(this.$_tmap$.$getCtx$());
  ...
  $DvtMapDataLayer$$.prototype.$getNonScaledContainers$ = function $$DvtMapDataLayer$$$$$getNonScaledContainers$$() {
    var $dvt$$11$$ = [this.$_dataLabelLayer$, this.$_dataLinkLayer$];
  ...
  $DvtMapDataLayer$$.prototype.$addMarkerObject$ = function $$DvtMapDataLayer$$$$$addMarkerObject$$($dvt$$11$$) {
    this.$_dataMarkerCollection$.push($dvt$$11$$);
    if ($dvt$$11$$) {
      this.$_markerObjs$.push($dvt$$11$$);
  ...
  $DvtMapDataLayer$$.prototype.$addLinkObject$ = function $$DvtMapDataLayer$$$$$addLinkObject$$($dvt$$11$$) {
    this.$_dataLinkCollection$.push($dvt$$11$$);
    $dvt$$11$$ && (this.$_linkObjs$.push($dvt$$11$$), this.$_eventHandler$.$associate$($dvt$$11$$.$getDisplayable$(), $dvt$$11$$));
  };
  $DvtMapDataLayer$$.prototype.$trackLink$ = function $$DvtMapDataLayer$$$$$trackLink$$($dvt$$11$$, $DvtThematicMapControlPanel$$) {
    var $DvtThematicMapJsonParser$$ = $DvtMapDataLayer$$.$_getLinkKey$($dvt$$11$$, $DvtThematicMapControlPanel$$);
  ...
  $DvtMapDataLayer$$.$_getLinkKey$ = function $$DvtMapDataLayer$$$$_getLinkKey$$($dvt$$11$$, $DvtThematicMapControlPanel$$) {
    return $dvt$$11$$.x < $DvtThematicMapControlPanel$$.x ? $dvt$$11$$.x.toString() + $dvt$$11$$.y.toString() + $DvtThematicMapControlPanel$$.x.toString() + $DvtThematicMapControlPanel$$.y.toString() : $DvtThematicMapControlPanel$$.x.toString() + $DvtThematicMapControlPanel$$.y.toString() + $dvt$$11$$.x.toString() + $dvt$$11$$.y.toString();
  };
  ...
  $DvtMapDataLayer$$.prototype.$discloseAreas$ = function $$DvtMapDataLayer$$$$$discloseAreas$$($dvt$$11$$, $DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$) {
    ...
    for ($DvtMapDataLayer$$ = 0;$DvtMapDataLayer$$ < this.$_markerObjs$.length;$DvtMapDataLayer$$++) {
      for ($DvtThematicMapKeyboardHandler$$ = 0;$DvtThematicMapKeyboardHandler$$ < $dvt$$11$$.length;$DvtThematicMapKeyboardHandler$$++) {
        $DvtThematicMapJsonParser$$ = this.$_markerObjs$[$DvtMapDataLayer$$].$getLocation$(), $DvtMapCustomAreaLayer$$ = this.$_markerObjs$[$DvtMapDataLayer$$].$getDisplayable$(), null != $DvtThematicMapJsonParser$$ ? $DvtThematicMapJsonParser$$ == $dvt$$11$$[$DvtThematicMapKeyboardHandler$$] && (this.$_dataPointLayer$.$addChild$($DvtMapCustomAreaLayer$$), $DvtThematicMapControlPanel$$.push($DvtMapCustomAreaLayer$$)) : (this.$_dataPointLayer$.$addChild$($DvtMapCustomAreaLayer$$), $DvtThematicMapControlPanel$$.push($DvtMapCustomAreaLayer$$))
        ;
      }
    }
  ...
  $DvtMapDataLayer$$.prototype.$drill$ = function $$DvtMapDataLayer$$$$$drill$$($dvt$$11$$, $DvtThematicMapControlPanel$$) {
    ...
    for ($DvtThematicMapJsonParser$$ = 0;$DvtThematicMapJsonParser$$ < this.$_markerObjs$.length;$DvtThematicMapJsonParser$$++) {
      if (this.$_markerObjs$[$DvtThematicMapJsonParser$$].$getLocation$() == $dvt$$11$$) {
  ...
  $DvtMapDataLayer$$.prototype.$getNavigableLinksForNodeId$ = function $$DvtMapDataLayer$$$$$getNavigableLinksForNodeId$$($dvt$$11$$) {
    for (var $DvtThematicMapControlPanel$$ = [], $DvtThematicMapJsonParser$$ = 0;$DvtThematicMapJsonParser$$ < this.$_dataLinkCollection$.length;$DvtThematicMapJsonParser$$++) {
      ...
      $DvtThematicMapKeyboardHandler$$ && $DvtThematicMapKeyboardHandler$$.getId() === $dvt$$11$$ ? $DvtThematicMapControlPanel$$.push($DvtThematicMapEventManager$$) : $DvtMapDataLayer$$ && $DvtMapDataLayer$$.getId() === $dvt$$11$$ && $DvtThematicMapControlPanel$$.push($DvtThematicMapEventManager$$);
    }
    return $DvtThematicMapControlPanel$$;
  };
  ...
  $DvtThematicMapKeyboardHandler$$.prototype.$processKeyDown$ = function $$DvtThematicMapKeyboardHandler$$$$$processKeyDown$$($DvtThematicMapControlPanel$$) {
    ...
    if ($DvtThematicMapJsonParser$$ == $dvt$$11$$.KeyboardEvent.$CLOSE_BRACKET$) {
      ...
      0 < $DvtThematicMapJsonParser$$.length && ($DvtThematicMapEventManager$$ = $dvt$$11$$.$KeyboardHandler$.$getNextAdjacentNavigable$($DvtThematicMapEventManager$$, $DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$));
      this.$_eventManager$.$SetClickInfo$($DvtThematicMapEventManager$$);
    } else {
      if ($DvtThematicMapJsonParser$$ == $dvt$$11$$.KeyboardEvent.$OPEN_BRACKET$) {
        this.$_linkNavType$ = $DvtThematicMapKeyboardHandler$$.$LINK_NAV$;
        $DvtThematicMapJsonParser$$ = [];
  ...
  $DvtThematicMapKeyboardHandler$$.prototype.$isNavigationEvent$ = function $$DvtThematicMapKeyboardHandler$$$$$isNavigationEvent$$($DvtThematicMapControlPanel$$) {
    ...
    switch($DvtThematicMapControlPanel$$.keyCode) {
      case $dvt$$11$$.KeyboardEvent.$OPEN_BRACKET$:
      ;
      case $dvt$$11$$.KeyboardEvent.$CLOSE_BRACKET$:
        $DvtThematicMapJsonParser$$ = !0;
        break;
      case $dvt$$11$$.KeyboardEvent.$OPEN_ANGLED_BRACKET$:
      ;
      case $dvt$$11$$.KeyboardEvent.$CLOSE_ANGLED_BRACKET$:
  ...
  $DvtThematicMapKeyboardHandler$$.$getFirstNavigableLink$ = function $$DvtThematicMapKeyboardHandler$$$$getFirstNavigableLink$$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$) {
    ...
    for (var $DvtThematicMapKeyboardHandler$$ = $DvtThematicMapControlPanel$$.$getCenter$(), $DvtMapDataLayer$$ = 0;$DvtMapDataLayer$$ < $DvtThematicMapEventManager$$.length;$DvtMapDataLayer$$++) {
      ...
      if ($DvtThematicMapJsonParser$$ == $dvt$$11$$.KeyboardEvent.$OPEN_ANGLED_BRACKET$ && $DvtMapAreaLayer$$.x <= $DvtThematicMapKeyboardHandler$$.x || $DvtThematicMapJsonParser$$ == $dvt$$11$$.KeyboardEvent.$CLOSE_ANGLED_BRACKET$ && $DvtMapAreaLayer$$.x >= $DvtThematicMapKeyboardHandler$$.x) {
        break;
      }
    }
  ...
  $DvtThematicMapJsonParser$$.prototype.$ParseDataLayers$ = function $$DvtThematicMapJsonParser$$$$$ParseDataLayers$$($DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapCustomAreaLayer$$) {
    if ($DvtThematicMapControlPanel$$) {
      for (var $DvtMapLinkPeer$$ = 0;$DvtMapLinkPeer$$ < $DvtThematicMapControlPanel$$.length;$DvtMapLinkPeer$$++) {
        var $DvtMapArea$$ = this.$_tmap$.$Defaults$.$calcDataLayerOptions$($DvtThematicMapControlPanel$$[$DvtMapLinkPeer$$]);
        ...
        var $DvtMapAreaPeer$$ = new $DvtMapDataLayer$$(this.$_tmap$, $DvtThematicMapEventManager$$, $DvtMapArea$$.id, this.$_tmap$.$getEventManager$(), $DvtMapArea$$);
        $DvtMapCustomAreaLayer$$ = $DvtMapArea$$.selectionMode;
        "single" == $DvtMapCustomAreaLayer$$ ? $DvtMapAreaPeer$$.$setSelectionMode$($dvt$$11$$.$SelectionHandler$.$TYPE_SINGLE$) : "multiple" == $DvtMapCustomAreaLayer$$ && $DvtMapAreaPeer$$.$setSelectionMode$($dvt$$11$$.$SelectionHandler$.$TYPE_MULTIPLE$);
        $DvtMapAreaPeer$$.$setAnimation$($DvtMapArea$$.animationOnDataChange);
        $DvtMapAreaPeer$$.$setAnimationDuration$(this.$_tmap$.$getAnimationDuration$());
        var $DvtMapObjPeer$$ = null;
        $DvtThematicMapEventManager$$ instanceof $DvtMapAreaLayer$$ && ($DvtMapObjPeer$$ = $DvtMapArea$$.isolatedItem);
        var $DvtThematicMapAutomation$$ = $DvtMapArea$$.disclosedItems, $DvtMapLabel$$ = [], $DvtCustomDataItem$$;
        $DvtMapCustomAreaLayer$$ = $DvtThematicMapEventManager$$ instanceof $DvtMapAreaLayer$$;
        var $DvtThematicMapCategoryWrapper$$;
        $DvtMapArea$$.popups && ($DvtThematicMapCategoryWrapper$$ = this.$_getShowPopupBehaviors$($DvtMapArea$$.popups));
        var $DvtBaseMapManager$$ = this.$_tmap$.$getOptions$().hiddenCategories, $DvtDrillablePath$$ = $DvtMapArea$$.areas;
        if ($DvtDrillablePath$$) {
          for (var $DvtThematicMapProjections$$ = 0;$DvtThematicMapProjections$$ < $DvtDrillablePath$$.length;$DvtThematicMapProjections$$++) {
            if ($DvtBaseMapManager$$ && $dvt$$11$$.$ArrayUtils$.$hasAnyItem$($DvtBaseMapManager$$, $DvtDrillablePath$$[$DvtThematicMapProjections$$].categories)) {
              $DvtMapAreaPeer$$.$addAreaObject$(null);
            } else {
              var $DvtThematicMapDefaults$$ = $DvtDrillablePath$$[$DvtThematicMapProjections$$].location;
              if ($DvtMapObjPeer$$) {
                if ($DvtMapObjPeer$$ != $DvtDrillablePath$$[$DvtThematicMapProjections$$].id) {
                  continue;
                } else {
                  $DvtCustomDataItem$$ = $DvtThematicMapDefaults$$;
                }
              }
              $DvtThematicMapAutomation$$ && -1 != $dvt$$11$$.$ArrayUtils$.$getIndex$($DvtThematicMapAutomation$$, $DvtDrillablePath$$[$DvtThematicMapProjections$$].id) && $DvtMapLabel$$.push($DvtThematicMapDefaults$$);
              if ($DvtThematicMapDefaults$$ = this.$_createArea$($DvtThematicMapEventManager$$, $DvtMapAreaPeer$$, $DvtDrillablePath$$[$DvtThematicMapProjections$$])) {
                $DvtThematicMapCategoryWrapper$$ && $DvtThematicMapDefaults$$.$setShowPopupBehaviors$($DvtThematicMapCategoryWrapper$$), $DvtMapAreaPeer$$.$addAreaObject$($DvtThematicMapDefaults$$);
              }
            }
          }
        }
        var $DvtDrillablePath$$ = $DvtMapArea$$.renderer, $markers$$12$$ = $DvtMapArea$$.markers;
        if ($markers$$12$$ && !$DvtDrillablePath$$) {
          for ($DvtThematicMapJsonParser$$.$_calcBubbleSizes$(this.$_tmap$, $markers$$12$$), $DvtThematicMapProjections$$ = 0;$DvtThematicMapProjections$$ < $markers$$12$$.length;$DvtThematicMapProjections$$++) {
            if ($DvtBaseMapManager$$ && $dvt$$11$$.$ArrayUtils$.$hasAnyItem$($DvtBaseMapManager$$, $markers$$12$$[$DvtThematicMapProjections$$].categories)) {
              $DvtMapAreaPeer$$.$addMarkerObject$(null);
            } else {
              $DvtThematicMapDefaults$$ = $markers$$12$$[$DvtThematicMapProjections$$].location;
              if ($DvtMapObjPeer$$) {
                if ($DvtMapObjPeer$$ != $markers$$12$$[$DvtThematicMapProjections$$].id) {
                  continue;
                } else {
                  $DvtCustomDataItem$$ = $DvtThematicMapDefaults$$;
                }
              }
              if ($DvtThematicMapDefaults$$ = this.$_createMarker$($DvtThematicMapEventManager$$, $DvtMapAreaPeer$$, $markers$$12$$[$DvtThematicMapProjections$$], $DvtMapCustomAreaLayer$$)) {
                $DvtThematicMapCategoryWrapper$$ && $DvtThematicMapDefaults$$.$setShowPopupBehaviors$($DvtThematicMapCategoryWrapper$$), $DvtMapAreaPeer$$.$addMarkerObject$($DvtThematicMapDefaults$$);
              }
            }
          }
        }
        var $images$$22_links$$11$$ = $DvtMapArea$$.images;
        if ($images$$22_links$$11$$) {
          for ($DvtThematicMapProjections$$ = 0;$DvtThematicMapProjections$$ < $images$$22_links$$11$$.length;$DvtThematicMapProjections$$++) {
            $DvtThematicMapDefaults$$ = $images$$22_links$$11$$[$DvtThematicMapProjections$$].location;
            if ($DvtMapObjPeer$$) {
              if ($DvtMapObjPeer$$ != $images$$22_links$$11$$[$DvtThematicMapProjections$$].id) {
                continue;
              } else {
                $DvtCustomDataItem$$ = $DvtThematicMapDefaults$$;
              }
            }
            if ($DvtThematicMapDefaults$$ = this.$_createImage$($DvtThematicMapEventManager$$, $DvtMapAreaPeer$$, $images$$22_links$$11$$[$DvtThematicMapProjections$$], $DvtMapCustomAreaLayer$$)) {
              $DvtThematicMapCategoryWrapper$$ && $DvtThematicMapDefaults$$.$setShowPopupBehaviors$($DvtThematicMapCategoryWrapper$$), $DvtMapAreaPeer$$.$addMarkerObject$($DvtThematicMapDefaults$$);
            }
          }
        }
        if ($images$$22_links$$11$$ = $DvtMapArea$$.links) {
          for ($DvtThematicMapProjections$$ = 0;$DvtThematicMapProjections$$ < $images$$22_links$$11$$.length;$DvtThematicMapProjections$$++) {
            $DvtBaseMapManager$$ && $dvt$$11$$.$ArrayUtils$.$hasAnyItem$($DvtBaseMapManager$$, $images$$22_links$$11$$[$DvtThematicMapProjections$$].categories) ? $DvtMapAreaPeer$$.$addAreaObject$(null) : ($DvtThematicMapDefaults$$ = this.$_createLink$($DvtMapAreaPeer$$, $images$$22_links$$11$$[$DvtThematicMapProjections$$])) && $DvtMapAreaPeer$$.$addLinkObject$($DvtThematicMapDefaults$$);
          }
        }
        if ($DvtDrillablePath$$) {
          for ($DvtThematicMapProjections$$ = 0;$DvtThematicMapProjections$$ < $markers$$12$$.length;$DvtThematicMapProjections$$++) {
            $DvtThematicMapDefaults$$ = $markers$$12$$[$DvtThematicMapProjections$$].location;
            if ($DvtMapObjPeer$$) {
              if ($DvtMapObjPeer$$ != $markers$$12$$[$DvtThematicMapProjections$$].id) {
                continue;
            ...
            $DvtThematicMapAutomation$$ && -1 != $dvt$$11$$.$ArrayUtils$.$getIndex$($DvtThematicMapAutomation$$, $markers$$12$$[$DvtThematicMapProjections$$].id) && $DvtMapLabel$$.push($DvtThematicMapDefaults$$);
            $DvtBaseMapManager$$ = this.$_tmap$.$getOptions$()._contextHandler(this.$_tmap$.$getElem$(), null, $markers$$12$$[$DvtThematicMapProjections$$], {hovered:!1, selected:!1, focused:!1}, null);
            $DvtBaseMapManager$$ = $DvtDrillablePath$$($DvtBaseMapManager$$);
            $DvtThematicMapDefaults$$ = this.$_createCustomDataItem$($DvtThematicMapEventManager$$, $DvtMapAreaPeer$$, $markers$$12$$[$DvtThematicMapProjections$$], $DvtBaseMapManager$$, $DvtMapCustomAreaLayer$$);
            $DvtThematicMapCategoryWrapper$$ && $DvtThematicMapDefaults$$.$setShowPopupBehaviors$($DvtThematicMapCategoryWrapper$$);
            $DvtThematicMapDefaults$$ && $DvtMapAreaPeer$$.$addMarkerObject$($DvtThematicMapDefaults$$);
          }
        }
        $DvtCustomDataItem$$ && $DvtThematicMapEventManager$$.$setIsolatedArea$($DvtCustomDataItem$$);
        ($DvtMapArea$$ = $DvtMapArea$$.selection) && 0 < $DvtMapArea$$.length && $DvtMapAreaPeer$$.$setInitialSelections$($DvtMapArea$$);
        $DvtMapLabel$$ && 0 < $DvtMapLabel$$.length && this.$_tmap$.$addDrilledLayer$($DvtThematicMapEventManager$$.$LayerName$, [$DvtMapAreaPeer$$.$getClientId$(), $DvtMapLabel$$]);
        $DvtThematicMapKeyboardHandler$$ ? $DvtThematicMapEventManager$$.$updateDataLayer$($DvtMapAreaPeer$$, this.$_tmap$.$_panZoomCanvas$.$_contentPane$.$getMatrix$(), $DvtThematicMapKeyboardHandler$$) : $DvtThematicMapEventManager$$.$addDataLayer$($DvtMapAreaPeer$$);
      }
    }
  };
  ...
  $DvtThematicMapJsonParser$$.prototype.$_createMarker$ = function $$DvtThematicMapJsonParser$$$$$_createMarker$$($DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$) {
    ...
    $DvtMapAreaLayer$$ = ($DvtMapAreaLayer$$ = this.$_tmap$.$getOptions$().mapProvider) && null != $DvtMapAreaLayer$$.geo ? new $dvt$$11$$.$Point$($DvtThematicMapKeyboardHandler$$.x, -$DvtThematicMapKeyboardHandler$$.y) : $DvtThematicMapJsonParser$$.$getCenter$($DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$.location, $DvtThematicMapKeyboardHandler$$.x, $DvtThematicMapKeyboardHandler$$.y);
    if (!$DvtMapAreaLayer$$ || 0 === $DvtMapCustomAreaLayer$$) {
      return null;
    }
    var $DvtMapLayer$$ = this.$_tmap$.$_styleDefaults$.dataMarkerDefaults, $DvtMapArea$$ = new $dvt$$11$$.$CSSStyle$($DvtMapLayer$$.labelStyle);
    $DvtMapArea$$.$parseInlineStyle$($DvtThematicMapKeyboardHandler$$.labelStyle);
    $DvtThematicMapKeyboardHandler$$ = $dvt$$11$$.$JsonUtils$.$merge$($DvtThematicMapKeyboardHandler$$, $DvtMapLayer$$);
    $DvtThematicMapKeyboardHandler$$.labelStyle = $DvtMapArea$$.toString();
    if (null != $DvtMapCustomAreaLayer$$) {
      ...
      $DvtMapArea$$ = $DvtThematicMapKeyboardHandler$$.height;
      null == $DvtMapArea$$ && ($DvtMapArea$$ = this.$_tmap$.$getOptions$().styleDefaults.dataMarkerDefaults.height);
      $DvtMapLayer$$ *= $DvtMapLinkPeer$$;
      $DvtMapCustomAreaLayer$$ *= $DvtMapArea$$;
    }
    $DvtMapArea$$ = $DvtThematicMapKeyboardHandler$$.borderRadius;
    $DvtThematicMapKeyboardHandler$$.source ? $DvtMapLayer$$ = new $dvt$$11$$.$ImageMarker$(this.$_tmap$.$getCtx$(), $DvtMapAreaLayer$$.x, $DvtMapAreaLayer$$.y, $DvtMapLayer$$, $DvtMapCustomAreaLayer$$, $DvtMapArea$$, $DvtThematicMapKeyboardHandler$$.source, $DvtThematicMapKeyboardHandler$$.sourceSelected, $DvtThematicMapKeyboardHandler$$.sourceHover, $DvtThematicMapKeyboardHandler$$.sourceHoverSelected) : ($DvtMapLinkPeer$$ = $DvtThematicMapKeyboardHandler$$.shape ? $DvtThematicMapKeyboardHandler$$.shape : 
    this.$_tmap$.$getOptions$().styleDefaults.dataMarkerDefaults.shape, $DvtMapLayer$$ = new $dvt$$11$$.$SimpleMarker$(this.$_tmap$.$getCtx$(), $DvtMapLinkPeer$$, this.$_tmap$.$_skinName$, $DvtMapAreaLayer$$.x, $DvtMapAreaLayer$$.y, $DvtMapLayer$$, $DvtMapCustomAreaLayer$$, $DvtMapArea$$));
  ...
  $DvtThematicMapJsonParser$$.prototype.$_createImage$ = function $$DvtThematicMapJsonParser$$$$$_createImage$$($DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$) {
    ...
    var $DvtMapAreaLayer$$ = new $dvt$$11$$.Image(this.$_tmap$.$getCtx$(), $DvtThematicMapKeyboardHandler$$.url), $DvtMapLayer$$ = $DvtThematicMapKeyboardHandler$$.width, $DvtMapArea$$ = $DvtThematicMapKeyboardHandler$$.height;
    null != $DvtMapLayer$$ && null != $DvtMapArea$$ && ($DvtMapAreaLayer$$.$setX$($DvtMapCustomAreaLayer$$.x - $DvtMapLayer$$ / 2), $DvtMapAreaLayer$$.$setY$($DvtMapCustomAreaLayer$$.y - $DvtMapArea$$ / 2), $DvtMapAreaLayer$$.$setWidth$($DvtMapLayer$$), $DvtMapAreaLayer$$.$setHeight$($DvtMapArea$$));
    $DvtMapDataLayer$$ && $DvtThematicMapControlPanel$$.$setLabelRendered$($DvtThematicMapKeyboardHandler$$.location, !1);
    ...
    $DvtMapLayer$$ && $DvtMapArea$$ || $dvt$$11$$.$ImageLoader$.$loadImage$(this.$_tmap$.$getCtx$(), $DvtThematicMapKeyboardHandler$$.url, function($dvt$$11$$) {
      $dvt$$11$$ && $dvt$$11$$.width && $dvt$$11$$.height && ($DvtMapAreaLayer$$.$setWidth$($dvt$$11$$.width), $DvtMapAreaLayer$$.$setHeight$($dvt$$11$$.height), $DvtMapAreaLayer$$.$setX$($DvtMapCustomAreaLayer$$.x - $dvt$$11$$.width / 2), $DvtMapAreaLayer$$.$setY$($DvtMapCustomAreaLayer$$.y - $dvt$$11$$.height / 2), $DvtMapLinkPeer$$.$__recenter$());
    });
  ...
  $DvtThematicMapJsonParser$$.prototype.$_createLink$ = function $$DvtThematicMapJsonParser$$$$$_createLink$$($DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$) {
    ...
    if ($DvtThematicMapKeyboardHandler$$.id) {
      for (var $DvtMapLayer$$ = $DvtThematicMapControlPanel$$.$_dataMarkerCollection$, $DvtMapArea$$ = 0;$DvtMapArea$$ < $DvtMapLayer$$.length;$DvtMapArea$$++) {
        var $DvtMapAreaPeer$$ = $DvtMapLayer$$[$DvtMapArea$$];
        if ($DvtMapAreaPeer$$.getId() == $DvtThematicMapKeyboardHandler$$.id) {
          $DvtMapAreaLayer$$ = $DvtMapAreaPeer$$;
          $DvtMapCustomAreaLayer$$ = $DvtMapAreaPeer$$.$getCenter$();
          break;
        }
      }
    } else {
    ...
    if ($DvtMapDataLayer$$.id) {
      for ($DvtMapLayer$$ = $DvtThematicMapControlPanel$$.$_dataMarkerCollection$, $DvtMapArea$$ = 0;$DvtMapArea$$ < $DvtMapLayer$$.length;$DvtMapArea$$++) {
        if ($DvtMapAreaPeer$$ = $DvtMapLayer$$[$DvtMapArea$$], $DvtMapAreaPeer$$.getId() == $DvtMapDataLayer$$.id) {
          $DvtThematicMapAutomation$$ = $DvtMapAreaPeer$$;
          $DvtMapObjPeer$$ = $DvtMapAreaPeer$$.$getCenter$();
          break;
        }
      }
    } else {
    ...
    $DvtThematicMapKeyboardHandler$$ = new $dvt$$11$$.$Path$(this.$_tmap$.$getCtx$(), $DvtThematicMapJsonParser$$.$calcCurve$($DvtThematicMapControlPanel$$, $DvtMapCustomAreaLayer$$, $DvtMapObjPeer$$, $DvtMapCustomAreaLayer$$, $DvtMapObjPeer$$));
    $DvtThematicMapKeyboardHandler$$.$setFill$(null);
    var $DvtMapLayer$$ = this.$_tmap$.$_styleDefaults$.linkDefaults, $DvtMapLabel$$ = $DvtThematicMapEventManager$$.color;
    $DvtMapLabel$$ || ($DvtMapLabel$$ = $DvtMapLayer$$.color);
    ($DvtMapDataLayer$$ = $DvtThematicMapEventManager$$.width) || ($DvtMapDataLayer$$ = $DvtMapLayer$$.width);
    $DvtMapArea$$ = new $dvt$$11$$.$SolidStroke$($DvtMapLabel$$, 1, $DvtMapDataLayer$$);
    $DvtMapArea$$.$setFixedWidth$(!0);
    $DvtThematicMapKeyboardHandler$$.$setStroke$($DvtMapArea$$);
    var $DvtMapAreaPeer$$ = $DvtMapLayer$$._hoverColor, $DvtCustomDataItem$$ = $DvtMapLayer$$._selectedColor, $DvtMapLayer$$ = new $dvt$$11$$.$SolidStroke$($DvtMapAreaPeer$$, 1, $DvtMapDataLayer$$), $DvtMapArea$$ = new $dvt$$11$$.$SolidStroke$($DvtMapLabel$$, 1, $DvtMapDataLayer$$ + 2), $DvtMapLabel$$ = new $dvt$$11$$.$SolidStroke$($DvtMapLabel$$, 1, $DvtMapDataLayer$$), $DvtThematicMapCategoryWrapper$$ = new $dvt$$11$$.$SolidStroke$($DvtCustomDataItem$$, 1, $DvtMapDataLayer$$ + 2), $DvtMapAreaPeer$$ = 
    new $dvt$$11$$.$SolidStroke$($DvtMapAreaPeer$$, 1, $DvtMapDataLayer$$), $DvtMapDataLayer$$ = new $dvt$$11$$.$SolidStroke$($DvtCustomDataItem$$, 1, $DvtMapDataLayer$$ + 2);
    $DvtThematicMapKeyboardHandler$$.$setHoverStroke$($DvtMapLayer$$, $DvtMapArea$$).$setSelectedStroke$($DvtMapLabel$$, $DvtThematicMapCategoryWrapper$$).$setSelectedHoverStroke$($DvtMapAreaPeer$$, $DvtMapDataLayer$$);
  ...
  $DvtThematicMapJsonParser$$.prototype.$_getPtFromLocation$ = function $$DvtThematicMapJsonParser$$$$$_getPtFromLocation$$($DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$) {
    ...
    return $DvtThematicMapKeyboardHandler$$ && null != $DvtThematicMapKeyboardHandler$$.geo ? new $dvt$$11$$.$Point$($DvtThematicMapEventManager$$.x, -$DvtThematicMapEventManager$$.y) : $DvtThematicMapJsonParser$$.$getCenter$($DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$.location, $DvtThematicMapEventManager$$.x, $DvtThematicMapEventManager$$.y);
  };
  $DvtThematicMapJsonParser$$.prototype.$_createLabel$ = function $$DvtThematicMapJsonParser$$$$$_createLabel$$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$) {
    ...
    if ($DvtMapAreaLayer$$) {
      var $DvtMapArea$$ = this.$_tmap$.$getCtx$(), $DvtMapArea$$ = $DvtThematicMapKeyboardHandler$$ ? new $DvtMapLabel$$($DvtMapArea$$, $DvtMapAreaLayer$$, $DvtThematicMapControlPanel$$.$getLabelInfoForArea$ ? $DvtThematicMapControlPanel$$.$getLabelInfoForArea$($DvtMapCustomAreaLayer$$) : null, $DvtMapLayer$$, $DvtThematicMapJsonParser$$.$_dataLabelLayer$, this.$_tmap$.$_bSupportsVectorEffects$) : new $dvt$$11$$.$OutputText$($DvtMapArea$$, $DvtMapAreaLayer$$, 0, 0);
      ...
      $DvtMapArea$$.$setCSSStyle$($DvtThematicMapJsonParser$$);
      $DvtMapArea$$ instanceof $DvtMapLabel$$ && ($dvt$$11$$.$Agent$.$isHighContrast$() || !$DvtThematicMapControlPanel$$) && ($DvtThematicMapControlPanel$$ = $dvt$$11$$.$ColorUtils$.$getContrastingTextColor$($DvtThematicMapEventManager$$.color));
      $DvtThematicMapControlPanel$$ && $DvtMapArea$$.$setSolidFill$($DvtThematicMapControlPanel$$);
    }
    return $DvtMapArea$$;
  };
  ...
  $DvtThematicMapJsonParser$$.$getCenter$ = function $$DvtThematicMapJsonParser$$$$getCenter$$($dvt$$11$$, $DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$) {
    var $DvtThematicMapKeyboardHandler$$ = $dvt$$11$$.$_tmap$.$_mapName$;
    return $DvtThematicMapControlPanel$$ ? (($dvt$$11$$ = $DvtBaseMapManager$$.$getAreaCenter$($DvtThematicMapKeyboardHandler$$, $dvt$$11$$.$_parentLayer$.$LayerName$, $DvtThematicMapControlPanel$$)) || ($dvt$$11$$ = $DvtBaseMapManager$$.$getCityCoordinates$($DvtThematicMapKeyboardHandler$$, $DvtThematicMapControlPanel$$)), $dvt$$11$$) : $DvtThematicMapProjections$$.$project$($DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$);
  };
  ...
  $DvtThematicMapJsonParser$$.$calcCurve$ = function $$DvtThematicMapJsonParser$$$$calcCurve$$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtThematicMapEventManager$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$) {
    ...
    var $DvtMapLayer$$ = $DvtThematicMapControlPanel$$.$_tmap$, $DvtMapArea$$ = $dvt$$11$$.$PathUtils$.moveTo($DvtMapCustomAreaLayer$$, $DvtMapAreaLayer$$);
    ...
    if (0 === $DvtThematicMapKeyboardHandler$$ - $DvtMapCustomAreaLayer$$ || 0 === $DvtMapDataLayer$$ - $DvtMapAreaLayer$$) {
      ...
      $DvtThematicMapEventManager$$, $DvtMapLinkPeer$$ = $DvtThematicMapKeyboardHandler$$ > $DvtMapCustomAreaLayer$$ ? $DvtThematicMapKeyboardHandler$$ - $DvtMapLayer$$ : $DvtThematicMapKeyboardHandler$$ + $DvtMapLayer$$, $DvtMapCustomAreaLayer$$ = $DvtThematicMapJsonParser$$), $DvtMapArea$$ += $dvt$$11$$.$PathUtils$.$cubicTo$($DvtThematicMapControlPanel$$, $DvtThematicMapJsonParser$$, $DvtMapLinkPeer$$, $DvtMapCustomAreaLayer$$, $DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$)) : $DvtMapArea$$ += 
      $dvt$$11$$.$PathUtils$.lineTo($DvtThematicMapKeyboardHandler$$, $DvtMapDataLayer$$);
    } else {
      ...
      var $DvtMapAreaPeer$$ = 0 < $DvtThematicMapKeyboardHandler$$ - $DvtMapCustomAreaLayer$$, $DvtMapLayer$$ = $DvtMapCustomAreaLayer$$ + ($DvtMapAreaPeer$$ ? 1 : -1) * $DvtMapLinkPeer$$, $DvtMapAreaPeer$$ = $DvtThematicMapKeyboardHandler$$ + ($DvtMapAreaPeer$$ ? -1 : 1) * $DvtMapLinkPeer$$;
      ...
      $DvtMapLinkPeer$$ = $DvtMapAreaPeer$$ + $DvtMapLinkPeer$$;
      $DvtMapArea$$ += $dvt$$11$$.$PathUtils$.$cubicTo$($DvtThematicMapControlPanel$$, $DvtThematicMapEventManager$$ * ($DvtThematicMapControlPanel$$ - $DvtMapLayer$$) + ($DvtThematicMapJsonParser$$ * ($DvtMapLayer$$ - $DvtMapCustomAreaLayer$$) + $DvtMapAreaLayer$$), $DvtMapLinkPeer$$, $DvtThematicMapEventManager$$ * ($DvtMapLinkPeer$$ - $DvtMapAreaPeer$$) + ($DvtThematicMapJsonParser$$ * ($DvtMapAreaPeer$$ - $DvtThematicMapKeyboardHandler$$) + $DvtMapDataLayer$$), $DvtThematicMapKeyboardHandler$$, 
      $DvtMapDataLayer$$);
    }
    return $DvtMapArea$$;
  };
