...
(function($dvt$$15$$) {
  ...
  function $DvtSunburstEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    $DvtTreeEventManager$$.call(this, $dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
  }
  function $DvtSunburstNode$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    this.Init($dvt$$15$$, $DvtSunburstDefaults$$);
  ...
  function $DvtTreemapEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    $DvtTreeEventManager$$.call(this, $dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
  }
  function $DvtTreemapKeyboardHandler$$($dvt$$15$$) {
    this.Init($dvt$$15$$);
  }
  function $DvtTreemapLayoutSliceAndDice$$($dvt$$15$$) {
    this.Init();
    this.$_isHoriz$ = $dvt$$15$$;
  }
  ...
  function $DvtTreemapNode$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    ...
    this.$_headerLabelStyle$ = $DvtTreemapKeyboardHandler$$.labelStyle ? new $dvt$$15$$.$CSSStyle$($DvtTreemapKeyboardHandler$$.labelStyle) : null;
    ...
    "auto" == this.$_isolate$ && (this.$_isolate$ = $dvt$$15$$.$Agent$.$isTouchDevice$() ? "off" : "on");
    this.$_bIsolated$ = null != $DvtSunburstNode$$.isolatedNode && $DvtSunburstNode$$.isolatedNode == this.getId();
  }
  function $DvtTreeAutomation$$($dvt$$15$$) {
    this.$_treeView$ = $dvt$$15$$;
    this.$_root$ = $dvt$$15$$.$_root$;
  }
  function $DvtTreeDefaults$$() {
  }
  function $DvtTreeKeyboardHandler$$($dvt$$15$$) {
    this.Init($dvt$$15$$);
  }
  ...
  function $DvtTreePeer$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$) {
  ...
  function $DvtTreeEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    this.Init($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
    this.$_view$ = $dvt$$15$$;
  }
  function $DvtTreeAnimationHandler$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    this.Init($dvt$$15$$, $DvtSunburstDefaults$$);
  }
  function $DvtTreeView$$() {
  }
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeView$$, $dvt$$15$$.$BaseComponent$);
  $DvtTreeView$$.prototype.Init = function $$DvtTreeView$$$$Init$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    ...
    this.$_dragSource$ = new $dvt$$15$$.$DragSource$($DvtSunburstDefaults$$);
  ...
  $DvtTreeView$$.prototype.$SetOptions$ = function $$DvtTreeView$$$$$SetOptions$$($DvtSunburstDefaults$$) {
    $DvtSunburstDefaults$$ ? (this.$Options$ = this.$Defaults$.$calcOptions$($DvtSunburstDefaults$$), $dvt$$15$$.$Agent$.$isEnvironmentBrowser$() || (this.$Options$.animationOnDisplay = "none", this.$Options$.animationOnDataChange = "none")) : this.$Options$ || (this.$Options$ = this.$GetDefaults$());
  };
  $DvtTreeView$$.prototype.$render$ = function $$DvtTreeView$$$$$render$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    ...
    $DvtSunburstNode$$ = new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$);
    this.$Layout$($DvtSunburstNode$$);
    $DvtSunburstEventManager$$ = new $dvt$$15$$.$Container$(this.$getCtx$());
    ...
    var $DvtTreemapEventManager$$ = new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$);
    $DvtSunburstNode$$ = !1;
    this.$_container$ ? $DvtSunburstDefaults$$ && $DvtTreemapDefaults$$ && ($dvt$$15$$.$BlackBoxAnimationHandler$.isSupported($DvtSunburstDefaults$$) ? (this.$Animation$ = $dvt$$15$$.$BlackBoxAnimationHandler$.$getCombinedAnimation$(this.$getCtx$(), $DvtSunburstDefaults$$, this.$_container$, $DvtSunburstEventManager$$, $DvtTreemapEventManager$$, this.$AnimationDuration$), $DvtSunburstNode$$ = !0) : this.$_oldRoot$ && "auto" == $DvtSunburstDefaults$$ && (this.$_deleteContainer$ = this.$GetDeleteContainer$(), 
  ...
  $DvtTreeView$$.prototype.$RenderBackground$ = function $$DvtTreeView$$$$$RenderBackground$$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = new $dvt$$15$$.Rect(this.$getCtx$(), 0, 0, this.$Width$, this.$Height$);
    $DvtSunburstEventManager$$.$setInvisibleFill$();
    $DvtSunburstDefaults$$.$addChild$($DvtSunburstEventManager$$);
  };
  $DvtTreeView$$.prototype.$LayoutBreadcrumbs$ = function $$DvtTreeView$$$$$LayoutBreadcrumbs$$($dvt$$15$$) {
    if (0 < this.$_ancestors$.length) {
      ...
      this.$_breadcrumbs$ = $DvtTreeBreadcrumbsRenderer$$.$render$(this, $dvt$$15$$, this.$_ancestors$, $DvtSunburstDefaults$$);
  ...
  $DvtTreeView$$.prototype.$RenderBreadcrumbs$ = function $$DvtTreeView$$$$$RenderBreadcrumbs$$($dvt$$15$$) {
    this.$_breadcrumbs$ && $dvt$$15$$.$addChild$(this.$_breadcrumbs$);
  };
  $DvtTreeView$$.prototype.$LayoutLegend$ = function $$DvtTreeView$$$$$LayoutLegend$$($dvt$$15$$) {
    this.$_legend$ = $DvtTreeLegendRenderer$$.$render$(this, $dvt$$15$$, this.$_legendSource$);
  };
  $DvtTreeView$$.prototype.$RenderLegend$ = function $$DvtTreeView$$$$$RenderLegend$$($dvt$$15$$) {
    this.$_legend$ && ($dvt$$15$$.$addChild$(this.$_legend$), this.$_legend$ = null);
  };
  $DvtTreeView$$.prototype.$RenderEmptyText$ = function $$DvtTreeView$$$$$RenderEmptyText$$($DvtSunburstDefaults$$) {
    ...
    $DvtSunburstNode$$ || ($DvtSunburstNode$$ = $dvt$$15$$.$Bundle$.$getTranslation$($DvtSunburstEventManager$$, "labelNoData", $dvt$$15$$.$Bundle$.$UTIL_PREFIX$, "NO_DATA"));
    $dvt$$15$$.$TextUtils$.$renderEmptyText$($DvtSunburstDefaults$$, $DvtSunburstNode$$, new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$), this.$getEventManager$(), $DvtSunburstEventManager$$._statusMessageStyle);
  };
  ...
  $DvtTreeView$$.prototype.$GetDisplayAnimation$ = function $$DvtTreeView$$$$$GetDisplayAnimation$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    ...
    return $dvt$$15$$.$BlackBoxAnimationHandler$.isSupported($DvtSunburstNode$$) ? $dvt$$15$$.$BlackBoxAnimationHandler$.$getInAnimation$(this.$getCtx$(), $DvtSunburstNode$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, this.$AnimationDuration$) : null;
  };
  ...
  $DvtTreeView$$.prototype.$GetDeleteContainer$ = function $$DvtTreeView$$$$$GetDeleteContainer$$() {
    return new $dvt$$15$$.$Container$(this.$getCtx$());
  };
  $DvtTreeView$$.prototype.$CreateKeyboardHandler$ = function $$DvtTreeView$$$$$CreateKeyboardHandler$$($dvt$$15$$) {
    return new $DvtTreeKeyboardHandler$$($dvt$$15$$);
  };
  $DvtTreeView$$.prototype.$CreateEventManager$ = function $$DvtTreeView$$$$$CreateEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    return new $DvtTreeEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
  };
  $DvtTreeView$$.prototype.$GetInitialFocusedItem$ = function $$DvtTreeView$$$$$GetInitialFocusedItem$$($dvt$$15$$) {
    if ($dvt$$15$$ && $dvt$$15$$.$_bArtificialRoot$) {
      var $DvtSunburstDefaults$$ = $dvt$$15$$.$getChildNodes$();
  ...
  $DvtTreeView$$.prototype.$highlight$ = function $$DvtTreeView$$$$$highlight$$($DvtSunburstDefaults$$) {
    this.$getOptions$().highlightedCategories = $dvt$$15$$.$JsonUtils$.clone($DvtSunburstDefaults$$);
    $dvt$$15$$.$CategoryRolloverHandler$.$highlight$($DvtSunburstDefaults$$, $DvtTreeUtils$$.$getAllNodes$(this.$_root$), "any" == this.$getOptions$().highlightMatch);
  };
  $DvtTreeView$$.prototype.select = function $$DvtTreeView$$$$select$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = this.$getOptions$();
    $DvtSunburstEventManager$$.selection = $dvt$$15$$.$JsonUtils$.clone($DvtSunburstDefaults$$);
  ...
  $DvtTreeView$$.prototype.$ApplyParsedProperties$ = function $$DvtTreeView$$$$$ApplyParsedProperties$$($DvtSunburstDefaults$$) {
    ...
    this.$AnimationDuration$ = $dvt$$15$$.$StyleUtils$.$getTimeMilliseconds$($DvtSunburstEventManager$$.animationDuration) / 1E3;
    (this.$_nodeSelection$ = "none" == $DvtSunburstEventManager$$.selectionMode ? null : "single" == $DvtSunburstEventManager$$.selectionMode ? $dvt$$15$$.$SelectionHandler$.$TYPE_SINGLE$ : $dvt$$15$$.$SelectionHandler$.$TYPE_MULTIPLE$) ? (this.$_selectionHandler$ = new $dvt$$15$$.$SelectionHandler$(this.$_nodeSelection$), this.$_initialSelection$ = $DvtSunburstEventManager$$.selection) : this.$_selectionHandler$ = null;
    ...
    if ($DvtSunburstEventManager$$.attributeGroups) {
      ...
      for (var $DvtSunburstNode$$ = 0;$DvtSunburstNode$$ < $DvtSunburstEventManager$$.attributeGroups.length;$DvtSunburstNode$$++) {
        ...
        if ("continuous" == $DvtTreemapDefaults$$.attributeType) {
          $DvtTreeUtils$$.$calcContinuousAttrGroupsExtents$($DvtTreemapDefaults$$, $DvtSunburstDefaults$$), $DvtTreemapEventManager$$ = new $dvt$$15$$.$ContinuousAttrGroups$($DvtTreemapDefaults$$.min, $DvtTreemapDefaults$$.max, $DvtTreemapDefaults$$.minLabel, $DvtTreemapDefaults$$.maxLabel, $DvtTreemapDefaults$$.colors);
        } else {
          for (var $DvtTreemapEventManager$$ = new $dvt$$15$$.$DiscreteAttrGroups$, $DvtTreemapKeyboardHandler$$ = 0;$DvtTreemapKeyboardHandler$$ < $DvtTreemapDefaults$$.groups.length;$DvtTreemapKeyboardHandler$$++) {
    ...
    ($DvtSunburstDefaults$$ = $DvtSunburstEventManager$$._contextMenus) && 0 < $DvtSunburstDefaults$$.length && ($DvtSunburstDefaults$$ = new $dvt$$15$$.$ContextMenuHandler$(this.$getCtx$(), $DvtSunburstDefaults$$), this.$EventManager$.$setContextMenuHandler$($DvtSunburstDefaults$$));
  ...
  $DvtTreeView$$.prototype.$ReselectNodes$ = function $$DvtTreeView$$$$$ReselectNodes$$() {
    for (var $dvt$$15$$ = this.$_selectionHandler$ ? this.$_selectionHandler$.getSelection() : [], $DvtSunburstDefaults$$ = 0;$DvtSunburstDefaults$$ < $dvt$$15$$.length;$DvtSunburstDefaults$$++) {
      $dvt$$15$$[$DvtSunburstDefaults$$].$setSelected$(!0);
    }
  };
  $DvtTreeView$$.prototype.$_processInitialSelections$ = function $$DvtTreeView$$$$$_processInitialSelections$$() {
    if (this.$_selectionHandler$ && this.$_initialSelection$) {
      var $dvt$$15$$ = $DvtTreeUtils$$.$getAllNodes$(this.$_root$);
      this.$_selectionHandler$.$processInitialSelections$(this.$_initialSelection$, $dvt$$15$$);
  ...
  $DvtTreeView$$.prototype.$_processInitialHighlighting$ = function $$DvtTreeView$$$$$_processInitialHighlighting$$() {
    var $dvt$$15$$ = this.$getOptions$().highlightedCategories;
    $dvt$$15$$ && 0 < $dvt$$15$$.length && this.$highlight$($dvt$$15$$);
  };
  $DvtTreeView$$.prototype.$_processInitialFocus$ = function $$DvtTreeView$$$$$_processInitialFocus$$($dvt$$15$$) {
    ...
    $dvt$$15$$ && this.$__setNavigableIdToFocus$(null);
    ...
    $dvt$$15$$ && this.$setFocused$(this.$isFocused$());
  };
  $DvtTreeView$$.prototype.$setFocused$ = function $$DvtTreeView$$$$$setFocused$$($dvt$$15$$) {
    this.$_hasFocus$ = $dvt$$15$$;
    this.$EventManager$.$setFocused$($dvt$$15$$);
  };
  $DvtTreeView$$.prototype.$isFocused$ = function $$DvtTreeView$$$$$isFocused$$() {
    return this.$_hasFocus$;
  };
  $DvtTreeView$$.prototype.$__getTemplate$ = function $$DvtTreeView$$$$$__getTemplate$$($dvt$$15$$) {
    return this.$_templates$ ? this.$_templates$[$dvt$$15$$] : null;
  };
  $DvtTreeView$$.prototype.$__isDragAvailable$ = function $$DvtTreeView$$$$$__isDragAvailable$$($dvt$$15$$) {
    return this.$_selectionHandler$ ? $dvt$$15$$[0] : null;
  };
  $DvtTreeView$$.prototype.$__getDragTransferable$ = function $$DvtTreeView$$$$$__getDragTransferable$$($dvt$$15$$) {
    $dvt$$15$$.$isSelected$() || (this.$_selectionHandler$.$processClick$($dvt$$15$$, !1), this.$EventManager$.$fireSelectionEvent$());
    $dvt$$15$$ = [];
    for (var $DvtSunburstDefaults$$ = this.$_selectionHandler$.getSelection(), $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $DvtSunburstDefaults$$.length;$DvtSunburstEventManager$$++) {
      $dvt$$15$$.push($DvtSunburstDefaults$$[$DvtSunburstEventManager$$].getId());
    }
    return $dvt$$15$$;
  };
  $DvtTreeView$$.prototype.$__getDragFeedback$ = function $$DvtTreeView$$$$$__getDragFeedback$$() {
    for (var $dvt$$15$$ = [], $DvtSunburstDefaults$$ = this.$_selectionHandler$.getSelection(), $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $DvtSunburstDefaults$$.length;$DvtSunburstEventManager$$++) {
      $dvt$$15$$.push($DvtSunburstDefaults$$[$DvtSunburstEventManager$$].$getDisplayable$());
    }
    return $dvt$$15$$;
  };
  $DvtTreeView$$.prototype.$__processBreadcrumbsEvent$ = function $$DvtTreeView$$$$$__processBreadcrumbsEvent$$($DvtSunburstDefaults$$) {
    $DvtSunburstDefaults$$ instanceof $dvt$$15$$.$BreadcrumbsDrillEvent$ && this.$__drill$($DvtSunburstDefaults$$.getId(), !1);
  };
  $DvtTreeView$$.prototype.$__drill$ = function $$DvtTreeView$$$$$__drill$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    $DvtSunburstEventManager$$ && this.$_root$ && $DvtSunburstDefaults$$ == this.$_root$.getId() && 0 < this.$_ancestors$.length ? (this.$__setNavigableIdToFocus$($DvtSunburstDefaults$$), this.dispatchEvent($dvt$$15$$.$EventFactory$.$newDrillEvent$(this.$_ancestors$[0].id))) : $DvtSunburstEventManager$$ || this.dispatchEvent($dvt$$15$$.$EventFactory$.$newDrillEvent$($DvtSunburstDefaults$$));
    this.$getCtx$().$getTooltipManager$().$hideTooltip$();
  };
  $DvtTreeView$$.prototype.$getLogicalObject$ = function $$DvtTreeView$$$$$getLogicalObject$$($dvt$$15$$) {
    return this.$EventManager$.$GetLogicalObject$($dvt$$15$$);
  };
  $DvtTreeView$$.prototype.$__setNavigableIdToFocus$ = function $$DvtTreeView$$$$$__setNavigableIdToFocus$$($dvt$$15$$) {
    this.$_navigableIdToFocus$ = $dvt$$15$$;
  };
  ...
  $DvtTreeView$$.prototype.$_processNodes$ = function $$DvtTreeView$$$$$_processNodes$$() {
    ...
    for (var $DvtSunburstEventManager$$ = [], $DvtSunburstNode$$ = $dvt$$15$$.$ArrayUtils$.$createBooleanMap$($DvtSunburstDefaults$$.hiddenCategories), $DvtTreemapDefaults$$ = 0;$DvtTreemapDefaults$$ < $DvtSunburstDefaults$$.nodes.length;$DvtTreemapDefaults$$++) {
  ...
  $DvtTreeView$$.prototype.$_processNode$ = function $$DvtTreeView$$$$$_processNode$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    if ($DvtTreeUtils$$.$isHiddenNode$($dvt$$15$$, $DvtSunburstDefaults$$)) {
      return null;
    }
    ...
    if ($DvtSunburstEventManager$$.$isDisclosed$()) {
      for (var $DvtSunburstNode$$ = [], $DvtTreemapDefaults$$ = $DvtSunburstDefaults$$.nodes ? $DvtSunburstDefaults$$.nodes : [], $DvtTreemapEventManager$$ = 0;$DvtTreemapEventManager$$ < $DvtTreemapDefaults$$.length;$DvtTreemapEventManager$$++) {
        ...
        ($DvtTreemapKeyboardHandler$$ = this.$_processNode$($dvt$$15$$, $DvtTreemapKeyboardHandler$$)) && $DvtSunburstNode$$.push($DvtTreemapKeyboardHandler$$);
      }
  ...
  $DvtTreeView$$.prototype.$UpdateAriaNavigation$ = function $$DvtTreeView$$$$$UpdateAriaNavigation$$($DvtSunburstDefaults$$) {
    if ($dvt$$15$$.$Agent$.$isTouchDevice$() || $dvt$$15$$.$Agent$.$isEnvironmentTest$()) {
  ...
  $DvtTreeView$$.prototype.$isDragAvailable$ = function $$DvtTreeView$$$$$isDragAvailable$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    return this.$_dragSource$.$isDragAvailable$($DvtSunburstEventManager$$);
  };
  $DvtTreeView$$.prototype.$getDragTransferable$ = function $$DvtTreeView$$$$$getDragTransferable$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return this.$_dragSource$.$getDragTransferable$($dvt$$15$$, $DvtSunburstDefaults$$);
  };
  $DvtTreeView$$.prototype.$getDragOverFeedback$ = function $$DvtTreeView$$$$$getDragOverFeedback$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return this.$_dragSource$.$getDragOverFeedback$($dvt$$15$$, $DvtSunburstDefaults$$);
  };
  $DvtTreeView$$.prototype.$getDragOffset$ = function $$DvtTreeView$$$$$getDragOffset$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return this.$_dragSource$.$getDragOffset$($dvt$$15$$, $DvtSunburstDefaults$$);
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeAnimationHandler$$, $dvt$$15$$.$DataAnimationHandler$);
  $DvtTreeAnimationHandler$$.prototype.$animate$ = function $$DvtTreeAnimationHandler$$$$$animate$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    this.$_bDrill$ = !1;
    this.$_oldRoot$ = $dvt$$15$$;
    this.$_oldAncestors$ = $DvtSunburstEventManager$$;
    $DvtTreeAnimationHandler$$.$_isAncestor$($DvtSunburstNode$$, $dvt$$15$$) || $DvtTreeAnimationHandler$$.$_isAncestor$($DvtSunburstEventManager$$, $DvtSunburstDefaults$$) ? (this.$_bDrill$ = !0, $DvtSunburstEventManager$$ = $dvt$$15$$.$getDescendantNodes$(), $DvtSunburstNode$$ = $DvtSunburstDefaults$$.$getDescendantNodes$(), $DvtSunburstEventManager$$.push($dvt$$15$$), $DvtSunburstNode$$.push($DvtSunburstDefaults$$), this.$constructAnimation$($DvtSunburstEventManager$$, $DvtSunburstNode$$)) : this.$constructAnimation$([$dvt$$15$$], 
    [$DvtSunburstDefaults$$]);
  };
  $DvtTreeAnimationHandler$$.prototype.$isAncestorInsert$ = function $$DvtTreeAnimationHandler$$$$$isAncestorInsert$$($dvt$$15$$) {
    return this.$_bDrill$ ? this.$_oldRoot$.getId() == $dvt$$15$$.getId() || $DvtTreeAnimationHandler$$.$_isAncestor$(this.$_oldAncestors$, $dvt$$15$$) : !1;
  };
  $DvtTreeAnimationHandler$$.$_isAncestor$ = function $$DvtTreeAnimationHandler$$$$_isAncestor$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    if (!$DvtSunburstDefaults$$ || !$dvt$$15$$) {
      return !1;
    }
    for (var $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $dvt$$15$$.length;$DvtSunburstEventManager$$++) {
      if ($dvt$$15$$[$DvtSunburstEventManager$$].id == $DvtSunburstDefaults$$.getId()) {
        return !0;
      }
    }
    return !1;
  };
  $dvt$$15$$.$Obj$.$createSubclass$(function($dvt$$15$$) {
    this.$_view$ = $dvt$$15$$;
  }, $dvt$$15$$.$DropTarget$);
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeEventManager$$, $dvt$$15$$.$EventManager$);
  $DvtTreeEventManager$$.prototype.$OnDblClickInternal$ = function $$DvtTreeEventManager$$$$$OnDblClickInternal$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = this.$GetLogicalObject$($dvt$$15$$.target);
    $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$.$isSelectable$ && $DvtSunburstDefaults$$.$isSelectable$() && this.$_processDrill$($DvtSunburstDefaults$$, $dvt$$15$$.shiftKey);
  };
  $DvtTreeEventManager$$.prototype.$OnClick$ = function $$DvtTreeEventManager$$$$$OnClick$$($dvt$$15$$) {
    $DvtTreeEventManager$$.$superclass$.$OnClick$.call(this, $dvt$$15$$);
    var $DvtSunburstDefaults$$ = this.$GetLogicalObject$($dvt$$15$$.target);
    this.$_processNodeLabel$($DvtSunburstDefaults$$);
    !$DvtSunburstDefaults$$ || $DvtSunburstDefaults$$.$isSelectable$ && $DvtSunburstDefaults$$.$isSelectable$() || this.$_processDrill$($DvtSunburstDefaults$$, $dvt$$15$$.shiftKey);
  };
  $DvtTreeEventManager$$.prototype.$OnMouseOver$ = function $$DvtTreeEventManager$$$$$OnMouseOver$$($dvt$$15$$) {
    $DvtTreeEventManager$$.$superclass$.$OnMouseOver$.call(this, $dvt$$15$$);
    ($dvt$$15$$ = this.$GetLogicalObject$($dvt$$15$$.target)) && $dvt$$15$$.$handleMouseOver$ && $dvt$$15$$.$handleMouseOver$();
  };
  $DvtTreeEventManager$$.prototype.$OnMouseOut$ = function $$DvtTreeEventManager$$$$$OnMouseOut$$($dvt$$15$$) {
    $DvtTreeEventManager$$.$superclass$.$OnMouseOut$.call(this, $dvt$$15$$);
    var $DvtSunburstDefaults$$ = this.$GetLogicalObject$($dvt$$15$$.target);
    $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$.$handleMouseOut$ && ($dvt$$15$$ = ($dvt$$15$$ = this.$GetLogicalObject$($dvt$$15$$.relatedTarget)) && $dvt$$15$$.getId ? $dvt$$15$$.getId() : null, null != $DvtSunburstDefaults$$.getId() && $dvt$$15$$ == $DvtSunburstDefaults$$.getId() || $DvtSunburstDefaults$$.$handleMouseOut$());
  };
  $DvtTreeEventManager$$.prototype.$ProcessKeyboardEvent$ = function $$DvtTreeEventManager$$$$$ProcessKeyboardEvent$$($DvtSunburstDefaults$$) {
    ...
    $DvtSunburstDefaults$$.keyCode != $dvt$$15$$.KeyboardEvent.$ENTER$ || $DvtSunburstDefaults$$.ctrlKey ? $DvtSunburstEventManager$$ = $DvtTreeEventManager$$.$superclass$.$ProcessKeyboardEvent$.call(this, $DvtSunburstDefaults$$) : ($DvtSunburstEventManager$$ = this.$getFocus$(), $DvtSunburstEventManager$$.$isDrillReplaceEnabled$ && $DvtSunburstEventManager$$.$isDrillReplaceEnabled$() && ($DvtSunburstDefaults$$.shiftKey && ($DvtSunburstEventManager$$ = this.$_view$.$_root$), this.$_view$.$__drill$($DvtSunburstEventManager$$.getId(), 
    $DvtSunburstDefaults$$.shiftKey)), $dvt$$15$$.$EventManager$.$consumeEvent$($DvtSunburstDefaults$$), $DvtSunburstEventManager$$ = !0);
    return $DvtSunburstEventManager$$;
  };
  $DvtTreeEventManager$$.prototype.$HandleTouchClickInternal$ = function $$DvtTreeEventManager$$$$$HandleTouchClickInternal$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = this.$GetLogicalObject$($dvt$$15$$.target);
    this.$_processNodeLabel$($DvtSunburstDefaults$$);
  ...
  $DvtTreeEventManager$$.prototype.$HandleTouchDblClickInternal$ = function $$DvtTreeEventManager$$$$$HandleTouchDblClickInternal$$($dvt$$15$$) {
    ($dvt$$15$$ = this.$GetLogicalObject$($dvt$$15$$.target)) && $dvt$$15$$.$isSelectable$ && $dvt$$15$$.$isSelectable$() && this.$_processDrill$($dvt$$15$$, !1);
  };
  $DvtTreeEventManager$$.prototype.$_processNodeLabel$ = function $$DvtTreeEventManager$$$$$_processNodeLabel$$($dvt$$15$$) {
    $dvt$$15$$ && $dvt$$15$$ instanceof $DvtTreePeer$$ && $dvt$$15$$.$isDrillable$() && this.$_view$.$__drill$($dvt$$15$$.getId(), !1);
  };
  $DvtTreeEventManager$$.prototype.$_processDrill$ = function $$DvtTreeEventManager$$$$$_processDrill$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    $dvt$$15$$.$isDrillReplaceEnabled$ && $dvt$$15$$.$isDrillReplaceEnabled$() && this.$_view$.$__drill$($dvt$$15$$.getId(), $DvtSunburstDefaults$$);
  };
  $DvtTreeEventManager$$.prototype.$ProcessRolloverEvent$ = function $$DvtTreeEventManager$$$$$ProcessRolloverEvent$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    ...
    if ("dim" == $DvtSunburstDefaults$$.hoverBehavior) {
      ...
      $DvtSunburstNode$$ = $dvt$$15$$.$EventFactory$.$newCategoryHighlightEvent$($DvtSunburstDefaults$$.highlightedCategories, $DvtSunburstNode$$);
      $DvtSunburstEventManager$$ = $DvtTreeUtils$$.$getAllNodes$(this.$_view$.$_root$);
      var $DvtTreemapDefaults$$ = $dvt$$15$$.$StyleUtils$.$getTimeMilliseconds$($DvtSunburstDefaults$$.hoverBehaviorDelay);
  ...
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeNode$$, $dvt$$15$$.$Obj$);
  ...
  $DvtTreeNode$$.$__NODE_SELECTED_SHADOW$ = new $dvt$$15$$.$Shadow$("#000000", 2, 5, 5, 45, .5);
  $DvtTreeNode$$.prototype.Init = function $$DvtTreeNode$$$$Init$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    ...
    this.$_labelStyle$ = "string" == typeof $DvtSunburstEventManager$$.labelStyle ? new $dvt$$15$$.$CSSStyle$($DvtSunburstEventManager$$.labelStyle) : $DvtSunburstEventManager$$.labelStyle;
  ...
  $DvtTreeNode$$.prototype.$setChildNodes$ = function $$DvtTreeNode$$$$$setChildNodes$$($dvt$$15$$) {
    if (null != $dvt$$15$$) {
      for (var $DvtSunburstDefaults$$ = 0;$DvtSunburstDefaults$$ < $dvt$$15$$.length;$DvtSunburstDefaults$$++) {
        $dvt$$15$$[$DvtSunburstDefaults$$].$_parent$ = this;
      }
    }
    this.$_children$ = $dvt$$15$$;
  };
  ...
  $DvtTreeNode$$.prototype.$getDescendantNodes$ = function $$DvtTreeNode$$$$$getDescendantNodes$$() {
    var $dvt$$15$$ = [], $DvtSunburstDefaults$$, $DvtSunburstEventManager$$;
    if (!this.$hasChildren$()) {
      return $dvt$$15$$;
    }
    for (var $DvtSunburstNode$$ = 0;$DvtSunburstNode$$ < this.$_children$.length;$DvtSunburstNode$$++) {
      $DvtSunburstEventManager$$ = this.$_children$[$DvtSunburstNode$$], $DvtSunburstDefaults$$ = $DvtSunburstEventManager$$.$getDescendantNodes$(), $dvt$$15$$.push($DvtSunburstEventManager$$), $dvt$$15$$ = $dvt$$15$$.concat($DvtSunburstDefaults$$);
    }
    return $dvt$$15$$;
  };
  $DvtTreeNode$$.prototype.$SetLastVisitedChild$ = function $$DvtTreeNode$$$$$SetLastVisitedChild$$($dvt$$15$$) {
    this.$_lastVisitedChild$ = $dvt$$15$$;
  };
  $DvtTreeNode$$.prototype.$MarkAsLastVisitedChild$ = function $$DvtTreeNode$$$$$MarkAsLastVisitedChild$$() {
    var $dvt$$15$$ = this.$_parent$;
    $dvt$$15$$ && $dvt$$15$$.$SetLastVisitedChild$(this);
  };
  $DvtTreeNode$$.prototype.$isDescendantOf$ = function $$DvtTreeNode$$$$$isDescendantOf$$($dvt$$15$$) {
    return $dvt$$15$$ && this.$_parent$ ? this.$_parent$ == $dvt$$15$$ ? !0 : this.$_parent$.$isDescendantOf$($dvt$$15$$) : !1;
  };
  $DvtTreeNode$$.prototype.$GetNodesAtDepth$ = function $$DvtTreeNode$$$$$GetNodesAtDepth$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    ...
    if ($dvt$$15$$.$hasChildren$()) {
      for (var $DvtSunburstNode$$ = $dvt$$15$$.$getChildNodes$(), $DvtTreemapDefaults$$, $DvtTreemapEventManager$$ = 0;$DvtTreemapEventManager$$ < $DvtSunburstNode$$.length;$DvtTreemapEventManager$$++) {
  ...
  $DvtTreeNode$$.$getNodeById$ = function $$DvtTreeNode$$$$getNodeById$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    if ($dvt$$15$$.getId() == $DvtSunburstDefaults$$) {
      return $dvt$$15$$;
    }
    for (var $DvtSunburstEventManager$$ = null, $DvtSunburstNode$$ = $dvt$$15$$.$getChildNodes$(), $DvtTreemapDefaults$$ = $DvtSunburstNode$$.length, $DvtSunburstEventManager$$ = null, $DvtTreemapEventManager$$ = 0;$DvtTreemapEventManager$$ < $DvtTreemapDefaults$$;$DvtTreemapEventManager$$++) {
  ...
  $DvtTreeNode$$.prototype.$getCategories$ = function $$DvtTreeNode$$$$$getCategories$$() {
    ...
    var $dvt$$15$$ = this.$getOptions$().categories;
    $dvt$$15$$ || ($dvt$$15$$ = ($dvt$$15$$ = ($dvt$$15$$ = this.$_parent$) ? $dvt$$15$$.$getCategories$() : null) ? $dvt$$15$$.slice() : [], $dvt$$15$$.push(this.getId()));
    return $dvt$$15$$;
  };
  ...
  $DvtTreeNode$$.prototype.$getDatatip$ = function $$DvtTreeNode$$$$$getDatatip$$() {
    var $dvt$$15$$ = this.$_view$.$getOptions$().tooltip;
    return ($dvt$$15$$ = $dvt$$15$$ ? $dvt$$15$$.renderer : null) ? this.$_view$.$getCtx$().$getTooltipManager$().$getCustomTooltip$($dvt$$15$$, this.$getDataContext$()) : this.$_shortDesc$;
  };
  ...
  $DvtTreeNode$$.prototype.$setAlpha$ = function $$DvtTreeNode$$$$$setAlpha$$($dvt$$15$$) {
    this.$_alpha$ = $dvt$$15$$;
    this.$_shape$ && this.$_shape$.$setAlpha$(this.$_alpha$);
  };
  $DvtTreeNode$$.prototype.$setDisclosed$ = function $$DvtTreeNode$$$$$setDisclosed$$($dvt$$15$$) {
    this.$getOptions$()._expanded = $dvt$$15$$;
  };
  ...
  $DvtTreeNode$$.prototype.$getShowPopupBehaviors$ = function $$DvtTreeNode$$$$$getShowPopupBehaviors$$() {
    ...
    return $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$[this.$_stampId$] ? $dvt$$15$$.$ShowPopupBehavior$.$createBehaviors$($DvtSunburstDefaults$$[this.$_stampId$]) : null;
  };
  $DvtTreeNode$$.prototype.$render$ = function $$DvtTreeNode$$$$$render$$() {
  };
  $DvtTreeNode$$.prototype.$renderChildren$ = function $$DvtTreeNode$$$$$renderChildren$$($dvt$$15$$) {
    ...
    if (null != $DvtSunburstDefaults$$) {
      for (var $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $DvtSunburstDefaults$$.length;$DvtSunburstEventManager$$++) {
        $DvtSunburstDefaults$$[$DvtSunburstEventManager$$].$render$($dvt$$15$$);
      }
    }
  };
  $DvtTreeNode$$.prototype.$processAttrGroups$ = function $$DvtTreeNode$$$$$processAttrGroups$$($dvt$$15$$) {
    if ($dvt$$15$$ = $dvt$$15$$.get(this.$getOptions$()._cv)) {
      this.$_color$ = $dvt$$15$$;
    }
  };
  ...
  $DvtTreeNode$$.prototype.$getKeyboardBoundingBox$ = function $$DvtTreeNode$$$$$getKeyboardBoundingBox$$() {
    return new $dvt$$15$$.$Rectangle$(0, 0, 0, 0);
  };
  ...
  $DvtTreeNode$$.prototype.$setSelected$ = function $$DvtTreeNode$$$$$setSelected$$($dvt$$15$$) {
    this.$_selected$ = $dvt$$15$$;
  ...
  $DvtTreeNode$$.prototype.$highlight$ = function $$DvtTreeNode$$$$$highlight$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    this.$setAlpha$($DvtSunburstDefaults$$);
  };
  $DvtTreeNode$$.prototype.$isDragAvailable$ = function $$DvtTreeNode$$$$$isDragAvailable$$($dvt$$15$$) {
    return this.$_view$.$__isDragAvailable$($dvt$$15$$);
  };
  ...
  $DvtTreeNode$$.prototype.$animateUpdate$ = function $$DvtTreeNode$$$$$animateUpdate$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    ...
    $dvt$$15$$.$ArrayUtils$.$equals$($DvtTreemapDefaults$$, $DvtSunburstNode$$) || ($DvtTreemapEventManager$$ = new $dvt$$15$$.$CustomAnimation$(this.$_view$.$getCtx$(), this, this.$_view$.$AnimationDuration$), $DvtTreemapEventManager$$.$_animator$.$addProp$($dvt$$15$$.$Animator$.$TYPE_NUMBER_ARRAY$, this, this.$GetAnimationParams$, this.$SetAnimationParams$, $DvtSunburstNode$$), $DvtSunburstDefaults$$.add($DvtTreemapEventManager$$, $DvtTreeNode$$.$_ANIMATION_UPDATE_PRIORITY$), $DvtSunburstNode$$ = 
    this.$_size$ != $DvtSunburstEventManager$$.$_size$, $DvtTreemapEventManager$$ = $dvt$$15$$.$ColorUtils$.$getRGBA$(this.$_color$) != $dvt$$15$$.$ColorUtils$.$getRGBA$($DvtSunburstEventManager$$.$_color$), this.$SetAnimationParams$($DvtTreemapDefaults$$), ($DvtTreemapDefaults$$ = this.$_view$.$getOptions$().animationUpdateColor) && ($DvtSunburstNode$$ || $DvtTreemapEventManager$$) && (this.$_color$ = $DvtTreemapDefaults$$));
  };
  $DvtTreeNode$$.prototype.$animateInsert$ = function $$DvtTreeNode$$$$$animateInsert$$($DvtSunburstDefaults$$) {
    if (!$DvtSunburstDefaults$$.$_bDrill$ || !$DvtSunburstDefaults$$.$isAncestorInsert$(this)) {
      this.$setAlpha$(0);
      var $DvtSunburstEventManager$$ = new $dvt$$15$$.$AnimFadeIn$(this.$_view$.$getCtx$(), this, this.$_view$.$AnimationDuration$);
  ...
  $DvtTreeNode$$.prototype.$animateDelete$ = function $$DvtTreeNode$$$$$animateDelete$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    ...
    var $DvtSunburstNode$$ = new $dvt$$15$$.$AnimFadeOut$(this.$_view$.$getCtx$(), this, this.$_view$.$AnimationDuration$);
  ...
  $DvtTreeNode$$.prototype.$GetDepth$ = function $$DvtTreeNode$$$$$GetDepth$$() {
    for (var $dvt$$15$$ = 0, $DvtSunburstDefaults$$ = this.$_parent$;$DvtSunburstDefaults$$;) {
      $dvt$$15$$++, $DvtSunburstDefaults$$ = $DvtSunburstDefaults$$.$_parent$;
    }
    return $dvt$$15$$;
  };
  $DvtTreeNode$$.prototype.$GetFill$ = function $$DvtTreeNode$$$$$GetFill$$() {
    return this.$_pattern$ ? new $dvt$$15$$.$PatternFill$(this.$_pattern$, this.$_color$) : new $dvt$$15$$.$SolidFill$(this.$_color$);
  };
  $DvtTreeNode$$.$GetNodeTextColor$ = function $$DvtTreeNode$$$$GetNodeTextColor$$($DvtSunburstDefaults$$) {
    return $DvtSunburstDefaults$$.$_pattern$ ? "#000000" : $dvt$$15$$.$ColorUtils$.$getContrastingTextColor$($DvtSunburstDefaults$$.$_color$);
  };
  $DvtTreeNode$$.prototype.$ApplyLabelTextStyle$ = function $$DvtTreeNode$$$$$ApplyLabelTextStyle$$($DvtSunburstDefaults$$) {
    ...
    $DvtSunburstDefaults$$.$setCSSStyle$($dvt$$15$$.$CSSStyle$.$mergeStyles$($DvtSunburstNode$$));
    $dvt$$15$$.$Agent$.$isHighContrast$() && $DvtSunburstDefaults$$.$setSolidFill$($DvtSunburstEventManager$$);
  };
  $DvtTreeNode$$.prototype.$GetTextSize$ = function $$DvtTreeNode$$$$$GetTextSize$$() {
    var $dvt$$15$$ = $DvtTreeNode$$.$_DEFAULT_TEXT_SIZE$, $DvtSunburstDefaults$$ = this.$_view$.$getOptions$().nodeDefaults.labelStyle.$getFontSize$();
    $DvtSunburstDefaults$$ && ($dvt$$15$$ = parseFloat($DvtSunburstDefaults$$));
    return $dvt$$15$$;
  };
  ...
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreePeer$$, $dvt$$15$$.$SimpleObjPeer$);
  ...
  $DvtTreePeer$$.prototype.$setDrillable$ = function $$DvtTreePeer$$$$$setDrillable$$($dvt$$15$$) {
    this.$_bDrillable$ = $dvt$$15$$;
  };
  ...
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeBreadcrumbsRenderer$$, $dvt$$15$$.$Obj$);
  ...
  $DvtTreeBreadcrumbsRenderer$$.$render$ = function $$DvtTreeBreadcrumbsRenderer$$$$render$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$) {
    ...
    $DvtTreemapLayoutSliceAndDice$$.push(new $dvt$$15$$.$CSSStyle$($DvtTreeBreadcrumbsRenderer$$.$_ENABLED_INLINE_STYLE$));
    $DvtTreemapLayoutSliceAndDice$$.push($DvtTreemapKeyboardHandler$$._drillTextStyle);
    var $DvtTreemapLayoutSliceAndDice$$ = $dvt$$15$$.$CSSStyle$.$mergeStyles$($DvtTreemapLayoutSliceAndDice$$).toString(), $DvtTreemapLayoutSquarifying$$ = $DvtTreemapLayoutSliceAndDice$$ + "text-decoration: underline;", $DvtTreemapNode$$ = [];
    $DvtTreemapNode$$.push($DvtTreemapKeyboardHandler$$._currentTextStyle);
    $DvtTreemapKeyboardHandler$$ = $dvt$$15$$.$CSSStyle$.$mergeStyles$($DvtTreemapNode$$).toString();
    $DvtTreemapEventManager$$ = new $dvt$$15$$.$Breadcrumbs$($DvtTreemapEventManager$$, $DvtSunburstDefaults$$.$__processBreadcrumbsEvent$, $DvtSunburstDefaults$$, {$labelStyle$:$DvtTreemapLayoutSliceAndDice$$, $labelStyleOver$:$DvtTreemapLayoutSquarifying$$, $labelStyleDown$:$DvtTreemapLayoutSquarifying$$, $disabledLabelStyle$:$DvtTreemapKeyboardHandler$$});
  ...
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeLegendRenderer$$, $dvt$$15$$.$Obj$);
  ...
  $DvtTreeLegendRenderer$$.$render$ = function $$DvtTreeLegendRenderer$$$$render$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    ...
    if (null != $DvtTreemapEventManager$$ || null != $DvtTreemapKeyboardHandler$$ || null != $DvtSunburstNode$$) {
      var $DvtTreemapLayoutSliceAndDice$$ = $DvtSunburstDefaults$$.$getCtx$(), $DvtTreemapLayoutSquarifying$$ = $DvtSunburstDefaults$$.$getEventManager$(), $DvtTreemapNode$$ = new $dvt$$15$$.$Container$($DvtTreemapLayoutSliceAndDice$$);
      $DvtSunburstDefaults$$.$addChild$($DvtTreemapNode$$);
      var $DvtTreemapLayoutBase$$ = $DvtTreeLegendRenderer$$.$_renderLabels$($DvtTreemapLayoutSliceAndDice$$, $DvtSunburstDefaults$$, $DvtTreemapNode$$, $DvtSunburstEventManager$$.$w$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$, $DvtSunburstNode$$), $DvtTreeAutomation$$ = $dvt$$15$$.$CSSStyle$.$afterSkinAlta$($DvtSunburstDefaults$$.$getOptions$().skin) ? null : "#000000", $DvtTreeDefaults$$ = [];
      $DvtTreeDefaults$$.push($DvtTreemapDefaults$$.styleDefaults._labelStyle);
      var $DvtTreeAutomation$$ = {borderColor:$DvtTreeAutomation$$, $labelStyle$:$dvt$$15$$.$CSSStyle$.$mergeStyles$($DvtTreeDefaults$$)}, $DvtTreemapDefaults$$ = $dvt$$15$$.$LegendAttrGroupsRenderer$.$renderAttrGroups$($DvtTreemapLayoutSliceAndDice$$, $DvtTreemapLayoutSquarifying$$, $DvtTreemapNode$$, $DvtSunburstEventManager$$.$w$, $DvtSunburstEventManager$$.$h$, $DvtSunburstNode$$, $DvtTreeAutomation$$), $DvtTreeDefaults$$ = $DvtTreemapLayoutBase$$ ? $DvtTreemapLayoutBase$$.$getDimensions$() : 
  ...
  $DvtTreeLegendRenderer$$.$_renderLabels$ = function $$DvtTreeLegendRenderer$$$$_renderLabels$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$) {
    var $DvtTreemapLayoutSliceAndDice$$ = $dvt$$15$$.$Agent$.$isRightToLeft$($DvtSunburstDefaults$$), $DvtTreemapLayoutSquarifying$$ = $DvtSunburstEventManager$$.$getEventManager$(), $DvtTreemapNode$$ = $DvtSunburstEventManager$$.$getOptions$().styleDefaults, $DvtTreemapLayoutBase$$ = null;
    if ($DvtTreemapEventManager$$ || $DvtTreemapKeyboardHandler$$) {
      $DvtTreemapLayoutBase$$ = new $dvt$$15$$.$Container$($DvtSunburstDefaults$$);
      ...
      $DvtSunburstNode$$ = $dvt$$15$$.$CSSStyle$.$mergeStyles$($DvtTreeAutomation$$);
      $DvtTreeAutomation$$ = [];
      $DvtTreeAutomation$$.push($DvtTreemapNode$$._attributeValueTextStyle);
      var $DvtTreemapNode$$ = $dvt$$15$$.$CSSStyle$.$mergeStyles$($DvtTreeAutomation$$), $DvtTreeDefaults$$, $DvtTreeNode$$, $DvtTreeKeyboardHandler$$, $DvtTreeBreadcrumbsRenderer$$, $DvtTreeAutomation$$ = 0;
      $DvtTreemapEventManager$$ && ($DvtTreeDefaults$$ = $dvt$$15$$.$Bundle$.$getTranslation$($DvtSunburstEventManager$$.$getOptions$(), "labelSize", $DvtSunburstEventManager$$.$getBundlePrefix$(), "SIZE"), $DvtTreeDefaults$$ = new $dvt$$15$$.$OutputText$($DvtSunburstDefaults$$, $DvtTreeDefaults$$, 0, 0), $DvtTreeDefaults$$.$setCSSStyle$($DvtSunburstNode$$), $DvtTreemapLayoutBase$$.$addChild$($DvtTreeDefaults$$), $DvtTreeKeyboardHandler$$ = $DvtTreeDefaults$$.$measureDimensions$().$w$, $DvtTreeNode$$ = 
      new $dvt$$15$$.$OutputText$($DvtSunburstDefaults$$, $DvtTreemapEventManager$$, 0, 0), $DvtTreeNode$$.$setCSSStyle$($DvtTreemapNode$$), $DvtTreemapLayoutBase$$.$addChild$($DvtTreeNode$$), $DvtTreeBreadcrumbsRenderer$$ = $DvtTreeNode$$.$measureDimensions$().$w$, $DvtTreeAutomation$$ = $DvtTreeKeyboardHandler$$ + $DvtTreeBreadcrumbsRenderer$$ + $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$);
      var $DvtTreeView$$, $DvtTreeAnimationHandler$$, $DvtTreePeer$$, $DvtTreeUtils$$, $DvtTreeEventManager$$ = 0;
      $DvtTreemapKeyboardHandler$$ && ($DvtTreeView$$ = $dvt$$15$$.$Bundle$.$getTranslation$($DvtSunburstEventManager$$.$getOptions$(), "labelColor", $DvtSunburstEventManager$$.$getBundlePrefix$(), "COLOR"), $DvtTreeView$$ = new $dvt$$15$$.$OutputText$($DvtSunburstDefaults$$, $DvtTreeView$$, 0, 0), $DvtTreeView$$.$setCSSStyle$($DvtSunburstNode$$), $DvtTreemapLayoutBase$$.$addChild$($DvtTreeView$$), $DvtTreePeer$$ = $DvtTreeView$$.$measureDimensions$().$w$, $DvtTreeAnimationHandler$$ = new $dvt$$15$$.$OutputText$($DvtSunburstDefaults$$, 
      $DvtTreemapKeyboardHandler$$, 0, 0), $DvtTreeAnimationHandler$$.$setCSSStyle$($DvtTreemapNode$$), $DvtTreemapLayoutBase$$.$addChild$($DvtTreeAnimationHandler$$), $DvtTreeUtils$$ = $DvtTreeAnimationHandler$$.$measureDimensions$().$w$, $DvtTreeEventManager$$ = $DvtTreePeer$$ + $DvtTreeUtils$$ + $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$);
      $DvtTreemapDefaults$$ -= $DvtTreeLegendRenderer$$.$_LEGEND_SECTION_GAP$;
      $DvtTreeAutomation$$ + $DvtTreeEventManager$$ > $DvtTreemapDefaults$$ && ($DvtSunburstDefaults$$ = $DvtTreemapDefaults$$ / 2, $DvtTreeAutomation$$ > $DvtSunburstDefaults$$ && $DvtTreeEventManager$$ > $DvtSunburstDefaults$$ ? ($dvt$$15$$.$TextUtils$.$fitText$($DvtTreeNode$$, $DvtSunburstDefaults$$ - $DvtTreeKeyboardHandler$$ - $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, Infinity, $DvtTreemapLayoutBase$$) ? ($DvtTreeBreadcrumbsRenderer$$ = $DvtTreeNode$$.$measureDimensions$().$w$, $DvtTreemapLayoutSquarifying$$.$associate$($DvtTreeNode$$, 
      new $dvt$$15$$.$SimpleObjPeer$($DvtTreemapEventManager$$))) : ($DvtTreemapLayoutBase$$.removeChild($DvtTreeDefaults$$), $DvtTreemapLayoutBase$$.removeChild($DvtTreeNode$$), $DvtTreeNode$$ = null, $DvtTreeBreadcrumbsRenderer$$ = 0), $dvt$$15$$.$TextUtils$.$fitText$($DvtTreeAnimationHandler$$, $DvtSunburstDefaults$$ - $DvtTreePeer$$ - $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, Infinity, $DvtTreemapLayoutBase$$) ? ($DvtTreeUtils$$ = $DvtTreeAnimationHandler$$.$measureDimensions$().$w$, $DvtTreemapLayoutSquarifying$$.$associate$($DvtTreeAnimationHandler$$, 
      new $dvt$$15$$.$SimpleObjPeer$($DvtTreemapKeyboardHandler$$))) : ($DvtTreemapLayoutBase$$.removeChild($DvtTreeView$$), $DvtTreemapLayoutBase$$.removeChild($DvtTreeAnimationHandler$$), $DvtTreeAnimationHandler$$ = null, $DvtTreeUtils$$ = 0)) : $DvtTreeAutomation$$ > $DvtTreeEventManager$$ ? $dvt$$15$$.$TextUtils$.$fitText$($DvtTreeNode$$, $DvtTreemapDefaults$$ - $DvtTreeEventManager$$ - $DvtTreeKeyboardHandler$$ - $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, Infinity, $DvtTreemapLayoutBase$$) ? 
      ($DvtTreeBreadcrumbsRenderer$$ = $DvtTreeNode$$.$measureDimensions$().$w$, $DvtTreemapLayoutSquarifying$$.$associate$($DvtTreeNode$$, new $dvt$$15$$.$SimpleObjPeer$($DvtTreemapEventManager$$))) : ($DvtTreemapLayoutBase$$.removeChild($DvtTreeDefaults$$), $DvtTreemapLayoutBase$$.removeChild($DvtTreeNode$$), $DvtTreeNode$$ = null, $DvtTreeBreadcrumbsRenderer$$ = 0) : $dvt$$15$$.$TextUtils$.$fitText$($DvtTreeAnimationHandler$$, $DvtTreemapDefaults$$ - $DvtTreeAutomation$$ - $DvtTreePeer$$ - $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, 
      Infinity, $DvtTreemapLayoutBase$$) ? ($DvtTreeUtils$$ = $DvtTreeAnimationHandler$$.$measureDimensions$().$w$, $DvtTreemapLayoutSquarifying$$.$associate$($DvtTreeAnimationHandler$$, new $dvt$$15$$.$SimpleObjPeer$($DvtTreemapKeyboardHandler$$))) : ($DvtTreemapLayoutBase$$.removeChild($DvtTreeView$$), $DvtTreemapLayoutBase$$.removeChild($DvtTreeAnimationHandler$$), $DvtTreeAnimationHandler$$ = null, $DvtTreeUtils$$ = 0));
      $DvtTreemapDefaults$$ = 0;
      $DvtTreemapLayoutSliceAndDice$$ ? ($DvtTreeAnimationHandler$$ && ($DvtTreeAnimationHandler$$.$setX$($DvtTreemapDefaults$$), $DvtTreemapDefaults$$ += $DvtTreeUtils$$ + $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, $DvtTreeView$$.$setX$($DvtTreemapDefaults$$), $DvtTreemapDefaults$$ += $DvtTreePeer$$ + $DvtTreeLegendRenderer$$.$_LEGEND_SECTION_GAP$), $DvtTreeNode$$ && ($DvtTreeNode$$.$setX$($DvtTreemapDefaults$$), $DvtTreemapDefaults$$ += $DvtTreeBreadcrumbsRenderer$$ + $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, 
      $DvtTreeDefaults$$.$setX$($DvtTreemapDefaults$$))) : ($DvtTreeNode$$ && ($DvtTreeDefaults$$.$setX$($DvtTreemapDefaults$$), $DvtTreemapDefaults$$ += $DvtTreeKeyboardHandler$$ + $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, $DvtTreeNode$$.$setX$($DvtTreemapDefaults$$), $DvtTreemapDefaults$$ += $DvtTreeBreadcrumbsRenderer$$ + $DvtTreeLegendRenderer$$.$_LEGEND_SECTION_GAP$), $DvtTreeAnimationHandler$$ && ($DvtTreeView$$.$setX$($DvtTreemapDefaults$$), $DvtTreemapDefaults$$ += $DvtTreePeer$$ + $DvtTreeLegendRenderer$$.$_LEGEND_LABEL_GAP$, 
      $DvtTreeAnimationHandler$$.$setX$($DvtTreemapDefaults$$)));
    }
    return $DvtTreemapLayoutBase$$;
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeKeyboardHandler$$, $dvt$$15$$.$KeyboardHandler$);
  $DvtTreeKeyboardHandler$$.prototype.$isSelectionEvent$ = function $$DvtTreeKeyboardHandler$$$$$isSelectionEvent$$($dvt$$15$$) {
    return this.$isNavigationEvent$($dvt$$15$$) && !$dvt$$15$$.ctrlKey;
  };
  $DvtTreeKeyboardHandler$$.prototype.$isMultiSelectEvent$ = function $$DvtTreeKeyboardHandler$$$$$isMultiSelectEvent$$($DvtSunburstDefaults$$) {
    return $DvtSunburstDefaults$$.keyCode == $dvt$$15$$.KeyboardEvent.$SPACE$ && $DvtSunburstDefaults$$.ctrlKey;
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeDefaults$$, $dvt$$15$$.$BaseComponentDefaults$);
  $DvtTreeDefaults$$.$VERSION_1$ = {skin:$dvt$$15$$.$CSSStyle$.$SKIN_ALTA$, animationDuration:500, animationOnDataChange:"none", animationOnDisplay:"none", highlightMatch:"all", hoverBehavior:"none", hoverBehaviorDelay:200, nodeDefaults:{labelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_11$)}, selectionMode:"multiple", sorting:"off", _statusMessageStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA$), styleDefaults:{_attributeTypeTextStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_BOLD_12$ + 
  "color:#4F4F4F"), _attributeValueTextStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$), _currentTextStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$), _drillTextStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$), _labelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA$)}, touchResponse:"auto", _resources:{}};
  $DvtTreeDefaults$$.prototype.Init = function $$DvtTreeDefaults$$$$Init$($DvtSunburstDefaults$$) {
    $DvtSunburstDefaults$$ = {skyros:$dvt$$15$$.$JsonUtils$.$merge$($DvtSunburstDefaults$$.skyros, $DvtTreeDefaults$$.$VERSION_1$), alta:$dvt$$15$$.$JsonUtils$.$merge$($DvtSunburstDefaults$$.alta, {}), next:$dvt$$15$$.$JsonUtils$.$merge$($DvtSunburstDefaults$$.next, {})};
    $DvtTreeDefaults$$.$superclass$.Init.call(this, $DvtSunburstDefaults$$);
  };
  var $DvtTreeUtils$$ = {};
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeUtils$$, $dvt$$15$$.$Obj$);
  $DvtTreeUtils$$.$calcMaxDepth$ = function $$DvtTreeUtils$$$$calcMaxDepth$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $DvtSunburstDefaults$$, $DvtSunburstNode$$ = $dvt$$15$$.$getChildNodes$();
    if ($DvtSunburstNode$$) {
  ...
  $DvtTreeUtils$$.$calcNodeCount$ = function $$DvtTreeUtils$$$$calcNodeCount$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = 1;
    if ($dvt$$15$$ = $dvt$$15$$.$getChildNodes$()) {
      for (var $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $dvt$$15$$.length;$DvtSunburstEventManager$$++) {
        $DvtSunburstDefaults$$ += $DvtTreeUtils$$.$calcNodeCount$($dvt$$15$$[$DvtSunburstEventManager$$]);
      }
    }
    return $DvtSunburstDefaults$$;
  };
  $DvtTreeUtils$$.$getAllNodes$ = function $$DvtTreeUtils$$$$getAllNodes$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = [];
    $DvtTreeUtils$$.$_addNodesToArray$($dvt$$15$$, $DvtSunburstDefaults$$);
    return $DvtSunburstDefaults$$;
  };
  $DvtTreeUtils$$.$getAllVisibleNodes$ = function $$DvtTreeUtils$$$$getAllVisibleNodes$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = [];
    $DvtTreeUtils$$.$_addNodesToArray$($dvt$$15$$, $DvtSunburstDefaults$$, !1, !0);
    return $DvtSunburstDefaults$$;
  };
  $DvtTreeUtils$$.$getLeafNodes$ = function $$DvtTreeUtils$$$$getLeafNodes$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = [];
    $DvtTreeUtils$$.$_addNodesToArray$($dvt$$15$$, $DvtSunburstDefaults$$, !0);
    return $DvtSunburstDefaults$$;
  };
  $DvtTreeUtils$$.$isHiddenNode$ = function $$DvtTreeUtils$$$$isHiddenNode$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    return $dvt$$15$$.$ArrayUtils$.$hasAnyMapItem$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$.categories);
  };
  $DvtTreeUtils$$.$calcContinuousAttrGroupsExtents$ = function $$DvtTreeUtils$$$$calcContinuousAttrGroupsExtents$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $dvt$$15$$.S;
    if (null != $DvtSunburstEventManager$$ && (null == $dvt$$15$$.min || null == $dvt$$15$$.max)) {
      ...
      null == $dvt$$15$$.min && ($dvt$$15$$.min = $DvtSunburstNode$$);
      null == $dvt$$15$$.max && ($dvt$$15$$.max = $DvtTreemapDefaults$$);
    }
  };
  $DvtTreeUtils$$.$processContinuousAttrGroups$ = function $$DvtTreeUtils$$$$processContinuousAttrGroups$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    for (var $DvtSunburstNode$$ = 0;$DvtSunburstNode$$ < $DvtSunburstDefaults$$.length;$DvtSunburstNode$$++) {
      ...
      if ($DvtTreemapEventManager$$ instanceof $dvt$$15$$.$ContinuousAttrGroups$ && null != $DvtTreemapDefaults$$) {
  ...
  $DvtTreeUtils$$.$_addNodesToArray$ = function $$DvtTreeUtils$$$$_addNodesToArray$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    if ($dvt$$15$$) {
      var $DvtTreemapDefaults$$ = $dvt$$15$$.$getChildNodes$(), $DvtTreemapEventManager$$ = $DvtTreemapDefaults$$ ? $DvtTreemapDefaults$$.length : 0;
      $DvtSunburstEventManager$$ && 0 != $DvtTreemapEventManager$$ || $DvtSunburstNode$$ && !$dvt$$15$$.$getDisplayable$() || $DvtSunburstDefaults$$.push($dvt$$15$$);
      for ($dvt$$15$$ = 0;$dvt$$15$$ < $DvtTreemapEventManager$$;$dvt$$15$$++) {
        $DvtTreeUtils$$.$_addNodesToArray$($DvtTreemapDefaults$$[$dvt$$15$$], $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
      }
    }
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreeAutomation$$, $dvt$$15$$.$Automation$);
  ...
  $DvtTreeAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtTreeAutomation$$$$$GetSubIdForDomElement$$($DvtSunburstDefaults$$) {
    ...
    if (!$DvtSunburstEventManager$$) {
      return $DvtSunburstDefaults$$.getParent() instanceof $dvt$$15$$.$Button$ && ($DvtSunburstDefaults$$ = $DvtSunburstDefaults$$.getParent()), $DvtSunburstEventManager$$ = $DvtSunburstDefaults$$.getParent(), $DvtSunburstEventManager$$ instanceof $dvt$$15$$.$Breadcrumbs$ ? $DvtTreeAutomation$$.$BREADCRUMBS_PREFIX$ + "[" + $DvtSunburstEventManager$$.$getCrumbIndex$($DvtSunburstDefaults$$) + "]" : null;
    }
  ...
  $DvtTreeAutomation$$.prototype.$_getIndicesFromNode$ = function $$DvtTreeAutomation$$$$$_getIndicesFromNode$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    if ($DvtSunburstDefaults$$ && 0 < $DvtSunburstDefaults$$.length) {
      for (var $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $DvtSunburstDefaults$$.length;$DvtSunburstEventManager$$++) {
        if ($DvtSunburstDefaults$$[$DvtSunburstEventManager$$] == $dvt$$15$$) {
          return "[" + $DvtSunburstEventManager$$ + "]";
        }
        var $DvtSunburstNode$$ = this.$_getIndicesFromNode$($dvt$$15$$, $DvtSunburstDefaults$$[$DvtSunburstEventManager$$].$getChildNodes$());
        if ($DvtSunburstNode$$) {
  ...
  $DvtTreeAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtTreeAutomation$$$$$getDomElementForSubId$$($DvtSunburstDefaults$$) {
    return $DvtSunburstDefaults$$ ? $DvtSunburstDefaults$$ == $dvt$$15$$.$Automation$.$TOOLTIP_SUBID$ ? this.$GetTooltipElement$(this.$_treeView$) : 0 == $DvtSunburstDefaults$$.indexOf($DvtTreeAutomation$$.$BREADCRUMBS_PREFIX$) ? ($DvtSunburstDefaults$$ = this.$_root$.$_view$.$getBreadcrumbs$().$getCrumb$($DvtSunburstDefaults$$.substring($DvtSunburstDefaults$$.indexOf("[") + 1, $DvtSunburstDefaults$$.indexOf("]")))) ? $DvtSunburstDefaults$$.$getElem$() : null : this.$_root$.$_bArtificialRoot$ || 
  ...
  $DvtTreeAutomation$$.prototype.$_getNodeFromSubId$ = function $$DvtTreeAutomation$$$$$_getNodeFromSubId$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    ...
    if (0 <= $DvtSunburstEventManager$$ && 0 <= $DvtSunburstNode$$) {
      ...
      return ($DvtSunburstEventManager$$ = $DvtTreeAutomation$$.$_getNodeByIndex$($dvt$$15$$.$getChildNodes$(), $DvtSunburstEventManager$$)) && 0 <= $DvtSunburstNode$$ && 0 <= $DvtTreemapDefaults$$ ? this.$_getNodeFromSubId$($DvtSunburstEventManager$$, $DvtSunburstDefaults$$) : $DvtSunburstEventManager$$;
    }
  };
  $DvtTreeAutomation$$.prototype.$_getNodeFromPath$ = function $$DvtTreeAutomation$$$$$_getNodeFromPath$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $DvtSunburstDefaults$$.shift(), $DvtSunburstEventManager$$ = $DvtTreeAutomation$$.$_getNodeByIndex$($dvt$$15$$.$getChildNodes$(), $DvtSunburstEventManager$$);
  ...
  $DvtTreeAutomation$$.prototype.$getNode$ = function $$DvtTreeAutomation$$$$$getNode$$($dvt$$15$$) {
    this.$_root$.$_bArtificialRoot$ || 0 != $dvt$$15$$[0] || $dvt$$15$$.shift();
    $dvt$$15$$ = 0 == $dvt$$15$$.length ? this.$_root$ : this.$_getNodeFromPath$(this.$_root$, $dvt$$15$$);
    return {color:$dvt$$15$$.$getColor$(), label:$dvt$$15$$.$getLabel$(), selected:void 0 == $dvt$$15$$.$isSelected$() ? !1 : $dvt$$15$$.$isSelected$(), size:$dvt$$15$$.$getSize$(), tooltip:$dvt$$15$$.$getShortDesc$()};
  };
  $DvtTreeAutomation$$.$_getNodeByIndex$ = function $$DvtTreeAutomation$$$$_getNodeByIndex$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    for (var $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $dvt$$15$$.length;$DvtSunburstEventManager$$++) {
      if ($DvtSunburstDefaults$$ == $dvt$$15$$[$DvtSunburstEventManager$$].$getIndex$()) {
        return $dvt$$15$$[$DvtSunburstEventManager$$];
      }
    }
    return null;
  };
  $dvt$$15$$.$Treemap$ = function $$dvt$$15$$$$Treemap$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    this.Init($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$);
  };
  $dvt$$15$$.$Obj$.$createSubclass$($dvt$$15$$.$Treemap$, $DvtTreeView$$);
  $dvt$$15$$.$Treemap$.$_BUFFER_SPACE$ = 7;
  $dvt$$15$$.$Treemap$.$_MIN_BUFFER_SPACE$ = 1;
  $dvt$$15$$.$Treemap$.$_BACKGROUND_FILL_COLOR$ = "#EBEFF5";
  $dvt$$15$$.$Treemap$.$_BACKGROUND_BORDER_COLOR$ = "#DBE0EA";
  $dvt$$15$$.$Treemap$.$_BACKGROUND_INLINE_DEFAULT$ = "background-color:" + $dvt$$15$$.$Treemap$.$_BACKGROUND_FILL_COLOR$ + ";border-color:" + $dvt$$15$$.$Treemap$.$_BACKGROUND_BORDER_COLOR$ + ";border-width:2px";
  $dvt$$15$$.$Treemap$.newInstance = function $$dvt$$15$$$$Treemap$$newInstance$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    return new $dvt$$15$$.$Treemap$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
  };
  $dvt$$15$$.$Treemap$.prototype.Init = function $$dvt$$15$$$$Treemap$$$Init$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    $dvt$$15$$.$Treemap$.$superclass$.Init.call(this, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
    this.$Defaults$ = new $DvtTreemapDefaults$$;
    this.setId("treemap1000" + Math.floor(1E9 * Math.random()));
  };
  $dvt$$15$$.$Treemap$.prototype.$ApplyParsedProperties$ = function $$dvt$$15$$$$Treemap$$$$ApplyParsedProperties$$($DvtSunburstDefaults$$) {
    $dvt$$15$$.$Treemap$.$superclass$.$ApplyParsedProperties$.call(this, $DvtSunburstDefaults$$);
  ...
  $dvt$$15$$.$Treemap$.prototype.$Layout$ = function $$dvt$$15$$$$Treemap$$$$Layout$$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = "jet" != this.$getOptions$()._environment ? $dvt$$15$$.$Treemap$.$_BUFFER_SPACE$ : $dvt$$15$$.$Treemap$.$_MIN_BUFFER_SPACE$, $DvtSunburstEventManager$$ = Math.max(Math.ceil($DvtSunburstEventManager$$ * Math.min($DvtSunburstDefaults$$.$w$, $DvtSunburstDefaults$$.$h$) / 400), $dvt$$15$$.$Treemap$.$_MIN_BUFFER_SPACE$);
  ...
  $dvt$$15$$.$Treemap$.prototype.$Render$ = function $$dvt$$15$$$$Treemap$$$$Render$$($DvtSunburstDefaults$$) {
  ...
  $dvt$$15$$.$Treemap$.prototype.$OnAnimationEnd$ = function $$dvt$$15$$$$Treemap$$$$OnAnimationEnd$$() {
    this.$AnimationStopped$ || (this.$_container$.$removeChildren$(), this.$Layout$(new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$)), this.$Render$(this.$_container$), this.$ReselectNodes$());
    $dvt$$15$$.$Treemap$.$superclass$.$OnAnimationEnd$.call(this);
  };
  $dvt$$15$$.$Treemap$.prototype.$ReselectNodes$ = function $$dvt$$15$$$$Treemap$$$$ReselectNodes$$() {
    for (var $dvt$$15$$ = this.$_selectionHandler$ ? this.$_selectionHandler$.getSelection() : [], $DvtSunburstDefaults$$ = 0;$DvtSunburstDefaults$$ < $dvt$$15$$.length;$DvtSunburstDefaults$$++) {
      if (0 < this.$_isolatedNodes$.length) {
        var $DvtSunburstEventManager$$ = this.$_isolatedNodes$[this.$_isolatedNodes$.length - 1];
        ($dvt$$15$$[$DvtSunburstDefaults$$] == $DvtSunburstEventManager$$ || $dvt$$15$$[$DvtSunburstDefaults$$].$isDescendantOf$($DvtSunburstEventManager$$)) && $dvt$$15$$[$DvtSunburstDefaults$$].$setSelected$(!0);
      } else {
        $dvt$$15$$[$DvtSunburstDefaults$$].$setSelected$(!0);
      }
    }
  };
  $dvt$$15$$.$Treemap$.prototype.$CreateKeyboardHandler$ = function $$dvt$$15$$$$Treemap$$$$CreateKeyboardHandler$$($dvt$$15$$) {
    return new $DvtTreemapKeyboardHandler$$($dvt$$15$$);
  };
  $dvt$$15$$.$Treemap$.prototype.$CreateEventManager$ = function $$dvt$$15$$$$Treemap$$$$CreateEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    return new $DvtTreemapEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
  };
  $dvt$$15$$.$Treemap$.prototype.$GetInitialFocusedItem$ = function $$dvt$$15$$$$Treemap$$$$GetInitialFocusedItem$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = this.$__getLastIsolatedNode$();
    return $DvtSunburstDefaults$$ ? this.$__getDefaultNavigable$($DvtTreeUtils$$.$getLeafNodes$($DvtSunburstDefaults$$)) : $dvt$$15$$ ? this.$__getDefaultNavigable$($DvtTreeUtils$$.$getLeafNodes$($dvt$$15$$)) : null;
  };
  $dvt$$15$$.$Treemap$.prototype.$__showHoverEffect$ = function $$dvt$$15$$$$Treemap$$$$__showHoverEffect$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    this.$_hoverEffect$.$setPoints$($dvt$$15$$);
    this.$_hoverEffect$.$setStroke$($DvtSunburstDefaults$$);
    this.$_hoverEffect$.$setVisible$(!0);
  };
  $dvt$$15$$.$Treemap$.prototype.$__hideHoverEffect$ = function $$dvt$$15$$$$Treemap$$$$__hideHoverEffect$$() {
    this.$_hoverEffect$.$setVisible$(!1);
  };
  $dvt$$15$$.$Treemap$.prototype.$__moveToSelectedLayer$ = function $$dvt$$15$$$$Treemap$$$$__moveToSelectedLayer$$($dvt$$15$$) {
    for (var $DvtSunburstDefaults$$ = 0, $DvtSunburstEventManager$$ = this.$_selectedLayer$.$getNumChildren$(), $DvtSunburstNode$$ = 0;$DvtSunburstNode$$ < $DvtSunburstEventManager$$;$DvtSunburstNode$$++) {
      ...
      $dvt$$15$$.zIndex > $DvtTreemapDefaults$$.zIndex && ($DvtSunburstDefaults$$ = $DvtSunburstNode$$ + 1);
    }
    $DvtSunburstDefaults$$ < $DvtSunburstEventManager$$ ? this.$_selectedLayer$.$addChildAt$($dvt$$15$$, $DvtSunburstDefaults$$) : this.$_selectedLayer$.$addChild$($dvt$$15$$);
  };
  $dvt$$15$$.$Treemap$.prototype.$__isolate$ = function $$dvt$$15$$$$Treemap$$$$__isolate$$($DvtSunburstDefaults$$) {
    ...
    this.dispatchEvent($dvt$$15$$.$EventFactory$.$newTreemapIsolateEvent$($DvtSunburstDefaults$$.getId()));
    this.$_isolateRestoreLayout$ = !0;
    this.$Layout$(new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$));
  ...
  $dvt$$15$$.$Treemap$.prototype.$__restore$ = function $$dvt$$15$$$$Treemap$$$$__restore$$() {
    ...
    this.dispatchEvent($dvt$$15$$.$EventFactory$.$newTreemapIsolateEvent$());
    this.$_isolateRestoreLayout$ = !0;
    this.$Layout$(new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$));
    this.$_isolateRestoreLayout$ = !1;
    this.$_renderIsolateRestore$($DvtSunburstDefaults$$);
  };
  $dvt$$15$$.$Treemap$.prototype.$__getLastIsolatedNode$ = function $$dvt$$15$$$$Treemap$$$$__getLastIsolatedNode$$() {
    return this.$_isolatedNodes$ && 0 < this.$_isolatedNodes$.length ? this.$_isolatedNodes$[this.$_isolatedNodes$.length - 1] : null;
  };
  $dvt$$15$$.$Treemap$.prototype.$_renderIsolateRestore$ = function $$dvt$$15$$$$Treemap$$$$_renderIsolateRestore$$($DvtSunburstDefaults$$) {
    if ("none" != this.$getOptions$().animationOnDataChange) {
      ...
      this.$Animation$ = new $dvt$$15$$.$ParallelPlayable$(this.$getCtx$(), $DvtSunburstDefaults$$);
  ...
  $dvt$$15$$.$Treemap$.prototype.$_processInitialIsolate$ = function $$dvt$$15$$$$Treemap$$$$_processInitialIsolate$$($dvt$$15$$) {
    if ($dvt$$15$$ && this.$_root$) {
      var $DvtSunburstDefaults$$ = this.$_root$.$getDescendantNodes$();
      $DvtSunburstDefaults$$.push(this.$_root$);
      for (var $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $DvtSunburstDefaults$$.length;$DvtSunburstEventManager$$++) {
        if ($DvtSunburstDefaults$$[$DvtSunburstEventManager$$].getId() == $dvt$$15$$) {
  ...
  $dvt$$15$$.$Treemap$.prototype.$__getDefaultNavigable$ = function $$dvt$$15$$$$Treemap$$$$__getDefaultNavigable$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = this.$getEventManager$().$KeyboardHandler$;
    return $DvtSunburstDefaults$$ ? $DvtSunburstDefaults$$.$getDefaultNavigable$($dvt$$15$$) : $dvt$$15$$ && 0 < $dvt$$15$$.length ? $dvt$$15$$[0] : null;
  };
  $dvt$$15$$.$Treemap$.prototype.$GetComponentDescription$ = function $$dvt$$15$$$$Treemap$$$$GetComponentDescription$$() {
    return $dvt$$15$$.$Bundle$.$getTranslation$(this.$getOptions$(), "componentName", $dvt$$15$$.$Bundle$.$UTIL_PREFIX$, "TREEMAP");
  };
  $dvt$$15$$.$Treemap$.prototype.$getBundlePrefix$ = function $$dvt$$15$$$$Treemap$$$$getBundlePrefix$$() {
    return $dvt$$15$$.$Bundle$.$TREEMAP_PREFIX$;
  };
  $dvt$$15$$.$Treemap$.prototype.$CreateNode$ = function $$dvt$$15$$$$Treemap$$$$CreateNode$$($dvt$$15$$) {
    return new $DvtTreemapNode$$(this, $dvt$$15$$);
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreemapNode$$, $DvtTreeNode$$);
  ...
  $DvtTreemapNode$$.prototype.$render$ = function $$DvtTreemapNode$$$$$render$$($DvtSunburstDefaults$$) {
    if (this.$_hasLayout$) {
      ...
      var $DvtSunburstEventManager$$;
      this.$hasChildren$() ? (this.$_childNodeGroup$ = new $dvt$$15$$.$Container$(this.$_view$.$getCtx$()), this.$_shape$.$addChild$(this.$_childNodeGroup$), this.$renderChildren$(this.$_childNodeGroup$)) : $DvtSunburstEventManager$$ = this.$GetTemplate$();
      if ($DvtSunburstEventManager$$) {
        ...
        this.$_text$ = this.$_createTextNode$(this.$_shape$), null != this.$_text$ && this.$_pattern$ && this.$_textStyle$ != $DvtTreemapNode$$.$TEXT_STYLE_HEADER$ && ($DvtSunburstNode$$ = this.$_text$.$measureDimensions$(), this.$_textBackground$ = new $dvt$$15$$.Rect(this.$_view$.$getCtx$(), $DvtSunburstNode$$.x, $DvtSunburstNode$$.y, $DvtSunburstNode$$.$w$, $DvtSunburstNode$$.$h$), this.$_textBackground$.$setSolidFill$("#FFFFFF"), this.$_textBackground$.$setMouseEnabled$(!1), this.$_shape$.$addChild$(this.$_textBackground$), 
  ...
  $DvtTreemapNode$$.prototype.$setSelected$ = function $$DvtTreemapNode$$$$$setSelected$$($DvtSunburstDefaults$$) {
    ...
    if (this.$_shape$) {
      ...
      if (this.$isSelected$()) {
        ...
        $dvt$$15$$.$Agent$.$isPlatformWebkit$() && ($DvtTreemapDefaults$$ -= $DvtTreemapNode$$.$_LINE_FUDGE_FACTOR$);
        ...
        this.$_selectionOuter$ = new $dvt$$15$$.Rect(this.$_view$.$getCtx$(), $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$);
        ...
        this.$_selectionInner$ = new $dvt$$15$$.Rect(this.$_view$.$getCtx$(), $DvtSunburstNode$$ + 1, $DvtTreemapDefaults$$ + 1, $DvtTreemapEventManager$$ - 2, $DvtTreemapKeyboardHandler$$ - 2);
        ...
        $dvt$$15$$.$Agent$.$isTouchDevice$() && (this.$_isolateButton$ = this.$_createIsolateRestoreButton$(this.$_shape$))) : (this.$_selectionOuter$.$setSolidStroke$($DvtSunburstDefaults$$.selectedOuterColor), this.$_selectionInner$.$setSolidStroke$($DvtSunburstDefaults$$.selectedInnerColor), $dvt$$15$$.$Agent$.$isBrowserSafari$() || $dvt$$15$$.$Agent$.$isPlatformGecko$() || this.$_shape$.$addDrawEffect$($DvtTreeNode$$.$__NODE_SELECTED_SHADOW$), this.$_view$.$__moveToSelectedLayer$(this.$_shape$));
      } else {
        this.$_removeChildShape$(this.$_selectionInner$), this.$_selectionInner$ = null, $dvt$$15$$.$Agent$.$isTouchDevice$() && this.$_removeIsolateRestoreButton$(), this.$_textStyle$ == $DvtTreemapNode$$.$TEXT_STYLE_HEADER$ ? (this.$IsHover$ || this.$isShowingKeyboardFocusEffect$() ? this.$_innerShape$.$setSolidFill$($DvtSunburstEventManager$$.hoverBackgroundColor) : (this.$ApplyHeaderStyle$(this.$_shape$, this.$_innerShape$), this.$_text$ && (this.$isDrillReplaceEnabled$() ? this.$ApplyHeaderTextStyle$(this.$_text$, 
  ...
  $DvtTreemapNode$$.prototype.$hideHoverEffect$ = function $$DvtTreemapNode$$$$$hideHoverEffect$$() {
    if (this.$_shape$ && this.$_hasLayout$) {
      var $dvt$$15$$ = this.$_view$.$getOptions$().nodeDefaults.header;
      this.$_textStyle$ == $DvtTreemapNode$$.$TEXT_STYLE_HEADER$ && (this.$isSelected$() ? (this.$_innerShape$.$setSolidFill$($dvt$$15$$.selectedBackgroundColor), this.$_selectionOuter$.$setSolidStroke$($dvt$$15$$.selectedOuterColor), this.$_text$ && (this.$isDrillReplaceEnabled$() ? this.$ApplyHeaderTextStyle$(this.$_text$, "_drillableSelectedLabelStyle") : this.$ApplyHeaderTextStyle$(this.$_text$, "_selectedLabelStyle"))) : (this.$ApplyHeaderStyle$(this.$_shape$, this.$_innerShape$), this.$_selectionOuter$ && 
  ...
  $DvtTreemapNode$$.prototype.$highlight$ = function $$DvtTreemapNode$$$$$highlight$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    this.$hasChildren$() ? (this.$_text$ && this.$_text$.$setAlpha$($DvtSunburstDefaults$$), this.$_textStyle$ == $DvtTreemapNode$$.$TEXT_STYLE_HEADER$ && this.$_bHeaderUseNodeColor$ && this.$_innerShape$ && this.$_innerShape$.$setAlpha$($DvtSunburstDefaults$$)) : $DvtTreemapNode$$.$superclass$.$highlight$.call(this, $dvt$$15$$, $DvtSunburstDefaults$$);
  };
  ...
  $DvtTreemapNode$$.prototype.$getPopupBounds$ = function $$DvtTreemapNode$$$$$getPopupBounds$$($DvtSunburstDefaults$$) {
    return $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$.$getAlign$() ? new $dvt$$15$$.$Rectangle$(this.$_x$, this.$_y$, this.$_width$, this.$_height$) : $DvtTreemapNode$$.$superclass$.$getPopupBounds$.call(this, $DvtSunburstDefaults$$);
  };
  $DvtTreemapNode$$.prototype.$getNextNavigable$ = function $$DvtTreemapNode$$$$$getNextNavigable$$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$;
    if ($DvtSunburstDefaults$$.type == $dvt$$15$$.MouseEvent.$CLICK$) {
    ...
    if ($DvtSunburstEventManager$$ == $dvt$$15$$.KeyboardEvent.$SPACE$ && $DvtSunburstDefaults$$.ctrlKey) {
      return this;
    }
    if ($DvtSunburstEventManager$$ == $dvt$$15$$.KeyboardEvent.$UP_ARROW$ && $DvtSunburstDefaults$$.altKey || $DvtSunburstEventManager$$ == $dvt$$15$$.KeyboardEvent.$CLOSE_BRACKET$) {
      ...
      if ($DvtSunburstEventManager$$ == $dvt$$15$$.KeyboardEvent.$DOWN_ARROW$ && $DvtSunburstDefaults$$.altKey || $DvtSunburstEventManager$$ == $dvt$$15$$.KeyboardEvent.$OPEN_BRACKET$) {
        ...
        $DvtSunburstDefaults$$ = $dvt$$15$$.$KeyboardHandler$.$getNextNavigable$(this, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$);
      }
    }
  ...
  $DvtTreemapNode$$.prototype.$getKeyboardBoundingBox$ = function $$DvtTreemapNode$$$$$getKeyboardBoundingBox$$() {
    return new $dvt$$15$$.$Rectangle$(this.$_x$, this.$_y$, this.$_width$, this.$_height$);
  };
  $DvtTreemapNode$$.prototype.$getTargetElem$ = function $$DvtTreemapNode$$$$$getTargetElem$$() {
    return this.$_shape$ ? this.$_shape$.$getElem$() : null;
  };
  $DvtTreemapNode$$.prototype.$setZIndex$ = function $$DvtTreemapNode$$$$$setZIndex$$($dvt$$15$$) {
    this.$_zIndex$ = $dvt$$15$$;
  };
  $DvtTreemapNode$$.prototype.$setLayoutParams$ = function $$DvtTreemapNode$$$$$setLayoutParams$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$) {
    if (!(0 >= $DvtSunburstNode$$ || 0 >= $DvtTreemapDefaults$$)) {
      ...
      if (this.$_textStyle$ == $DvtTreemapNode$$.$TEXT_STYLE_HEADER$) {
        ...
        $DvtSunburstDefaults$$ = new $dvt$$15$$.$OutputText$(this.$_view$.$getCtx$(), this.$_textStr$);
        $DvtSunburstDefaults$$.$setFontSize$(this.$GetTextSize$());
        this.$ApplyHeaderTextStyle$($DvtSunburstDefaults$$, "labelStyle");
        $DvtSunburstDefaults$$ = $dvt$$15$$.$TextUtils$.$guessTextDimensions$($DvtSunburstDefaults$$).$h$;
        ...
        if (0 <= $DvtSunburstNode$$ && 0 <= $DvtTreemapDefaults$$) {
          return new $dvt$$15$$.$Rectangle$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$);
        }
  ...
  $DvtTreemapNode$$.prototype.contains = function $$DvtTreemapNode$$$$contains$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return $dvt$$15$$ >= this.$_x$ && $dvt$$15$$ <= this.$_x$ + this.$_width$ && $DvtSunburstDefaults$$ >= this.$_y$ && $DvtSunburstDefaults$$ <= this.$_y$ + this.$_height$;
  };
  $DvtTreemapNode$$.prototype.$GetAnimationParams$ = function $$DvtTreemapNode$$$$$GetAnimationParams$$() {
    var $DvtSunburstDefaults$$ = $dvt$$15$$.$ColorUtils$.$getRed$(this.$_color$), $DvtSunburstEventManager$$ = $dvt$$15$$.$ColorUtils$.$getGreen$(this.$_color$), $DvtSunburstNode$$ = $dvt$$15$$.$ColorUtils$.$getBlue$(this.$_color$);
  ...
  $DvtTreemapNode$$.prototype.$SetAnimationParams$ = function $$DvtTreemapNode$$$$$SetAnimationParams$$($DvtSunburstDefaults$$) {
    ...
    this.$_color$ = $dvt$$15$$.$ColorUtils$.$makeRGB$(Math.round($DvtSunburstDefaults$$[4]), Math.round($DvtSunburstDefaults$$[5]), Math.round($DvtSunburstDefaults$$[6]));
    this.$_updateShapes$();
  };
  $DvtTreemapNode$$.prototype.$getIsolateAnimation$ = function $$DvtTreemapNode$$$$$getIsolateAnimation$$() {
    for (var $dvt$$15$$ = [this.$_getIsolateAnimation$()], $DvtSunburstDefaults$$ = this.$getDescendantNodes$(), $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $DvtSunburstDefaults$$.length;$DvtSunburstEventManager$$++) {
      $dvt$$15$$.push($DvtSunburstDefaults$$[$DvtSunburstEventManager$$].$_getIsolateAnimation$());
    }
    return $dvt$$15$$;
  };
  $DvtTreemapNode$$.prototype.$_getIsolateAnimation$ = function $$DvtTreemapNode$$$$$_getIsolateAnimation$$() {
    if (this.$_oldState$) {
      var $DvtSunburstDefaults$$ = new $dvt$$15$$.$CustomAnimation$(this.$_view$.$getCtx$(), this, $DvtTreemapNode$$.$_ANIMATION_ISOLATE_DURATION$);
      $DvtSunburstDefaults$$.$_animator$.$addProp$($dvt$$15$$.$Animator$.$TYPE_NUMBER_ARRAY$, this, this.$GetAnimationParams$, this.$SetAnimationParams$, this.$GetAnimationParams$());
      this.$SetAnimationParams$(this.$_oldState$);
      return $DvtSunburstDefaults$$;
    }
    return null;
  };
  $DvtTreemapNode$$.prototype.$animateUpdate$ = function $$DvtTreemapNode$$$$$animateUpdate$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return 0 == this.$GetDepth$() || $DvtSunburstDefaults$$.$_hasLayout$ && 0 < $DvtSunburstDefaults$$.$_width$ && 0 < $DvtSunburstDefaults$$.$_height$ ? $DvtTreemapNode$$.$superclass$.$animateUpdate$.call(this, $dvt$$15$$, $DvtSunburstDefaults$$) : this.$animateInsert$($dvt$$15$$);
  };
  $DvtTreemapNode$$.prototype.$_createShapeNode$ = function $$DvtTreemapNode$$$$$_createShapeNode$$() {
    ...
    if (this.$_textStyle$ == $DvtTreemapNode$$.$TEXT_STYLE_HEADER$) {
      if ($DvtSunburstEventManager$$) {
        var $DvtSunburstNode$$ = this.$_getGeometriesWithGaps$(), $DvtSunburstEventManager$$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, $DvtSunburstNode$$.$_shape$.x, $DvtSunburstNode$$.$_shape$.y, $DvtSunburstNode$$.$_shape$.$w$, $DvtSunburstNode$$.$_shape$.$h$);
        this.$_innerShape$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, $DvtSunburstNode$$.$_innerShape$.x, $DvtSunburstNode$$.$_innerShape$.y, $DvtSunburstNode$$.$_innerShape$.$w$, $DvtSunburstNode$$.$_innerShape$.$h$);
        this.$_backgroundShape$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, $DvtSunburstNode$$.$_backgroundShape$.x, $DvtSunburstNode$$.$_backgroundShape$.y, $DvtSunburstNode$$.$_backgroundShape$.$w$, $DvtSunburstNode$$.$_backgroundShape$.$h$);
        this.$_backgroundShape$.$setSolidFill$("#FFFFFF");
        $DvtSunburstEventManager$$.$addChild$(this.$_backgroundShape$);
      } else {
        $DvtSunburstEventManager$$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, this.$_x$, this.$_y$, this.$_width$, this.$_height$), this.$_innerShape$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, this.$_x$ + 1, this.$_y$ + 1, this.$_width$ - 2, this.$_height$ - 2);
      }
      ...
      if ($DvtSunburstEventManager$$) {
        $DvtSunburstNode$$ = this.$_getGeometriesWithGaps$(), $DvtSunburstEventManager$$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, $DvtSunburstNode$$.$_shape$.x, $DvtSunburstNode$$.$_shape$.y, $DvtSunburstNode$$.$_shape$.$w$, $DvtSunburstNode$$.$_shape$.$h$), $DvtSunburstEventManager$$.$setFill$(this.$hasChildren$() ? $dvt$$15$$.$SolidFill$.$invisibleFill$() : $DvtTreemapDefaults$$);
      } else {
        if ($DvtSunburstEventManager$$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, this.$_x$, this.$_y$, this.$_width$, this.$_height$), (1E3 > this.$_view$.$_nodeCount$ || !$dvt$$15$$.$Agent$.$isTouchDevice$()) && this.$_width$ >= $DvtTreemapNode$$.$MIN_SIZE_FOR_BORDER$ && this.$_height$ >= $DvtTreemapNode$$.$MIN_SIZE_FOR_BORDER$) {
          new $dvt$$15$$.$SolidStroke$($DvtTreemapNode$$.$DEFAULT_NODE_TOP_BORDER_COLOR$);
          new $dvt$$15$$.$SolidStroke$($DvtTreemapNode$$.$DEFAULT_NODE_BOTTOM_BORDER_COLOR$, $DvtTreemapNode$$.$DEFAULT_NODE_BORDER_OPACITY$);
          this.$_pattern$ && new $dvt$$15$$.$SolidStroke$(this.$_color$, $DvtTreemapNode$$.$DEFAULT_NODE_PATTERN_BORDER_OPACITY$);
          var $DvtTreemapEventManager$$ = this.$getColor$(), $DvtSunburstNode$$ = $dvt$$15$$.$ColorUtils$.$interpolateColor$($DvtTreemapNode$$.$DEFAULT_NODE_TOP_BORDER_COLOR$, $DvtTreemapEventManager$$, 1 - $DvtTreemapNode$$.$DEFAULT_NODE_BORDER_OPACITY$), $DvtTreemapEventManager$$ = $dvt$$15$$.$ColorUtils$.$interpolateColor$($DvtTreemapNode$$.$DEFAULT_NODE_BOTTOM_BORDER_COLOR$, $DvtTreemapEventManager$$, 1 - $DvtTreemapNode$$.$DEFAULT_NODE_BORDER_OPACITY$), $DvtTreemapKeyboardHandler$$ = Math.min(this.$_width$, 
          this.$_height$);
          4 <= $DvtTreemapKeyboardHandler$$ ? ($DvtSunburstEventManager$$.$setSolidFill$($DvtTreemapEventManager$$), this.$_topLeftShape$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, this.$_x$, this.$_y$, this.$_width$ - 1, this.$_height$ - 1), this.$_topLeftShape$.$setSolidFill$($DvtSunburstNode$$), this.$_topLeftShape$.$setMouseEnabled$(!1), $DvtSunburstEventManager$$.$addChild$(this.$_topLeftShape$), this.$_fillShape$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$, this.$_x$ + 1, this.$_y$ + 1, 
  ...
  $DvtTreemapNode$$.prototype.$_createIsolateRestoreButton$ = function $$DvtTreemapNode$$$$$_createIsolateRestoreButton$$($DvtSunburstDefaults$$) {
    ...
    $DvtTreemapDefaults$$ - $DvtSunburstNode$$ - 2 * $DvtTreemapNode$$.$_ISOLATE_GAP_SIZE$ > $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$ && ($DvtSunburstEventManager$$ = this.$_bIsolated$ ? this.$_getRestoreButton$() : this.$_getIsolateButton$(), $DvtSunburstNode$$ = $dvt$$15$$.$Agent$.$isRightToLeft$($DvtSunburstDefaults$$.$getCtx$()) ? $DvtSunburstNode$$ + $DvtTreemapNode$$.$_ISOLATE_GAP_SIZE$ : $DvtTreemapDefaults$$ - $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$ - $DvtTreemapNode$$.$_ISOLATE_GAP_SIZE$, $DvtSunburstEventManager$$.$setTranslate$($DvtSunburstNode$$, 
    ($DvtTreemapKeyboardHandler$$ + $DvtTreemapEventManager$$ - $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$) / 2), $DvtSunburstDefaults$$.$addChild$($DvtSunburstEventManager$$), $dvt$$15$$.$Agent$.$isTouchDevice$() && ($DvtSunburstDefaults$$ = new $dvt$$15$$.Rect($DvtSunburstDefaults$$.$getCtx$(), -$DvtTreemapNode$$.$_ISOLATE_TOUCH_BUFFER$, -$DvtTreemapNode$$.$_ISOLATE_TOUCH_BUFFER$, $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$ + 2 * $DvtTreemapNode$$.$_ISOLATE_TOUCH_BUFFER$, $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$ + 
    2 * $DvtTreemapNode$$.$_ISOLATE_TOUCH_BUFFER$), $DvtSunburstDefaults$$.$setInvisibleFill$(), $DvtSunburstEventManager$$.$addChild$($DvtSunburstDefaults$$)), $dvt$$15$$.$CSSStyle$.$afterSkinAlta$(this.$_view$.$getOptions$().skin) ? this.$_view$.$getEventManager$().$associate$($DvtSunburstEventManager$$, this) : ($DvtSunburstDefaults$$ = $dvt$$15$$.$Bundle$.$getTranslation$(this.$_view$.$getOptions$(), this.$_bIsolated$ ? "tooltipRestore" : "tooltipIsolate", $dvt$$15$$.$Bundle$.$TREEMAP_PREFIX$, 
  ...
  $DvtTreemapNode$$.prototype.$_createTextNode$ = function $$DvtTreemapNode$$$$$_createTextNode$$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $dvt$$15$$.$Agent$.$isRightToLeft$($DvtSunburstDefaults$$.$getCtx$());
    ...
    var $DvtTreemapLayoutSliceAndDice$$ = new $dvt$$15$$.$OutputText$(this.$_view$.$getCtx$(), this.$_textStr$);
    ...
    if (null != $DvtTreemapLayoutSliceAndDice$$) {
      ...
      $DvtTreemapLayoutSliceAndDice$$.$setMouseEnabled$(!1), $dvt$$15$$.$TextUtils$.$fitText$($DvtTreemapLayoutSliceAndDice$$, $DvtTreemapEventManager$$, $DvtSunburstNode$$, $DvtSunburstDefaults$$) ? $DvtTreemapLayoutSliceAndDice$$ : null;
    }
  };
  $DvtTreemapNode$$.prototype.$ApplyHeaderStyle$ = function $$DvtTreemapNode$$$$$ApplyHeaderStyle$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    ...
    if (this.$_bHeaderUseNodeColor$) {
      ...
      $DvtSunburstNode$$ = $dvt$$15$$.$ColorUtils$.$interpolateColor$($DvtSunburstNode$$.borderColor, $DvtTreemapDefaults$$, 1 - $DvtTreemapNode$$.$DEFAULT_HEADER_WITH_NODE_COLOR_ALPHA$);
  ...
  $DvtTreemapNode$$.prototype.$ApplyHeaderTextStyle$ = function $$DvtTreemapNode$$$$$ApplyHeaderTextStyle$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    var $DvtSunburstNode$$ = [];
    1 >= this.$GetDepth$() && $DvtSunburstNode$$.push(new $dvt$$15$$.$CSSStyle$("font-weight:bold;"));
    $DvtSunburstNode$$.push(this.$_view$.$getOptions$().nodeDefaults.header[$DvtSunburstEventManager$$]);
    !this.$_bHeaderUseNodeColor$ || "labelStyle" != $DvtSunburstEventManager$$ && "_drillableLabelStyle" != $DvtSunburstEventManager$$ || $DvtSunburstNode$$.push(new $dvt$$15$$.$CSSStyle$("color: " + $DvtTreeNode$$.$GetNodeTextColor$(this)));
  ...
  $DvtTreemapNode$$.prototype.$handleMouseOver$ = function $$DvtTreemapNode$$$$$handleMouseOver$$() {
    this.$_isolateButton$ || $dvt$$15$$.$Agent$.$isTouchDevice$() || (this.$_isolateButton$ = this.$_createIsolateRestoreButton$(this.$_shape$));
  ...
  $DvtTreemapNode$$.prototype.$handleMouseOut$ = function $$DvtTreemapNode$$$$$handleMouseOut$$() {
    !0 === this.$_bIsolated$ || $dvt$$15$$.$Agent$.$isTouchDevice$() || this.$_removeIsolateRestoreButton$();
  ...
  $DvtTreemapNode$$.prototype.$_getGeometriesWithGaps$ = function $$DvtTreemapNode$$$$$_getGeometriesWithGaps$$() {
    var $DvtSunburstDefaults$$ = {};
    this.$_textStyle$ == $DvtTreemapNode$$.$TEXT_STYLE_HEADER$ ? ($DvtSunburstDefaults$$.$_shape$ = new $dvt$$15$$.$Rectangle$(this.$_x$, this.$_y$, this.$_width$ - 1, this.$_titleBarHeight$), $DvtSunburstDefaults$$.$_innerShape$ = new $dvt$$15$$.$Rectangle$(this.$_x$ + 1, this.$_y$ + 1, this.$_width$ - 3, this.$_titleBarHeight$ - 1), $DvtSunburstDefaults$$.$_backgroundShape$ = new $dvt$$15$$.$Rectangle$(this.$_x$, this.$_y$ + this.$_titleBarHeight$, this.$_width$ - 1, this.$_height$ - this.$_titleBarHeight$ - 
    1)) : $DvtSunburstDefaults$$.$_shape$ = this.$hasChildren$() ? new $dvt$$15$$.$Rectangle$(this.$_x$, this.$_y$, 0, 0) : new $dvt$$15$$.$Rectangle$(this.$_x$, this.$_y$, Math.max(this.$_width$ - 1, 0), Math.max(this.$_height$ - 1, 0));
    return $DvtSunburstDefaults$$;
  };
  $DvtTreemapNode$$.prototype.$_updateShapes$ = function $$DvtTreemapNode$$$$$_updateShapes$$() {
    if (this.$_shape$) {
      if ("gaps" == this.$_view$.$getOptions$().nodeSeparators) {
        var $dvt$$15$$ = this.$_getGeometriesWithGaps$();
        this.$_shape$.$setRect$($dvt$$15$$.$_shape$);
        this.$_innerShape$ && this.$_innerShape$.$setRect$($dvt$$15$$.$_innerShape$);
        this.$_backgroundShape$ && this.$_backgroundShape$.$setRect$($dvt$$15$$.$_backgroundShape$);
      } else {
  ...
  $DvtTreemapNode$$.prototype.$_addChildText$ = function $$DvtTreemapNode$$$$$_addChildText$$($dvt$$15$$) {
    this.$_textStyle$ == $DvtTreemapNode$$.$TEXT_STYLE_NODE$ && this.$hasChildren$() ? this.$_view$.$_groupTextLayer$.$addChild$($dvt$$15$$) : this.$_shape$.$addChild$($dvt$$15$$);
  };
  $DvtTreemapNode$$.prototype.$_removeChildShape$ = function $$DvtTreemapNode$$$$$_removeChildShape$$($dvt$$15$$) {
    $dvt$$15$$ && this.$_shape$.removeChild($dvt$$15$$);
  };
  $DvtTreemapNode$$.prototype.$_getIsolateButton$ = function $$DvtTreemapNode$$$$$_getIsolateButton$$() {
    var $DvtSunburstDefaults$$ = this.$_view$.$getCtx$(), $DvtSunburstEventManager$$ = $dvt$$15$$.$Agent$.$isRightToLeft$(this.$_context$), $DvtSunburstNode$$ = this.$_view$.$getOptions$()._resources, $DvtTreemapDefaults$$ = $DvtSunburstEventManager$$ && $DvtSunburstNode$$.isolateDownRtl ? $DvtSunburstNode$$.isolateDownRtl : $DvtSunburstNode$$.isolateDown, $DvtTreemapEventManager$$ = $DvtSunburstEventManager$$ && $DvtSunburstNode$$.isolateOverRtl ? $DvtSunburstNode$$.isolateOverRtl : $DvtSunburstNode$$.isolateOver, 
    $DvtSunburstEventManager$$ = new $dvt$$15$$.Image($DvtSunburstDefaults$$, $DvtSunburstEventManager$$ && $DvtSunburstNode$$.isolateRtl ? $DvtSunburstNode$$.isolateRtl : $DvtSunburstNode$$.isolate, 0, 0, $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$, $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$), $DvtTreemapDefaults$$ = new $dvt$$15$$.Image($DvtSunburstDefaults$$, $DvtTreemapDefaults$$, 0, 0, $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$, $DvtTreemapNode$$.$_ISOLATE_ICON_SIZE$), $DvtTreemapEventManager$$ = new $dvt$$15$$.Image($DvtSunburstDefaults$$, 
    ...
    $DvtSunburstDefaults$$ = new $dvt$$15$$.$Button$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$);
    $DvtSunburstDefaults$$.$addEvtListener$($dvt$$15$$.MouseEvent.$CLICK$, this.$__isolateNode$, !1, this);
    return $DvtSunburstDefaults$$;
  };
  $DvtTreemapNode$$.prototype.$_getRestoreButton$ = function $$DvtTreemapNode$$$$$_getRestoreButton$$() {
    ...
    $DvtTreemapEventManager$$.$setInvisibleFill$();
    $DvtSunburstDefaults$$ = new $dvt$$15$$.$Button$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$);
    $DvtSunburstDefaults$$.$addEvtListener$($dvt$$15$$.MouseEvent.$CLICK$, this.$__restoreNode$, !1, this);
    return $DvtSunburstDefaults$$;
  };
  $DvtTreemapNode$$.prototype.$__isolateNode$ = function $$DvtTreemapNode$$$$$__isolateNode$$($dvt$$15$$) {
    this.$_bIsolated$ = !0;
    this.$hideHoverEffect$();
    this.$_view$.$__isolate$(this);
    this.$_removeIsolateRestoreButton$();
    this.$UpdateAriaLabel$();
    $dvt$$15$$ && $dvt$$15$$.stopPropagation();
  };
  $DvtTreemapNode$$.prototype.$__restoreNode$ = function $$DvtTreemapNode$$$$$__restoreNode$$($dvt$$15$$) {
    this.$_bIsolated$ = !1;
    this.$hideHoverEffect$();
  ...
  $DvtTreemapNode$$.prototype.$getDatatip$ = function $$DvtTreemapNode$$$$$getDatatip$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    return $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$ instanceof $dvt$$15$$.$Button$ ? null : $DvtTreemapNode$$.$superclass$.$getDatatip$.call(this, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
  };
  $DvtTreemapNode$$.prototype.$getDatatipColor$ = function $$DvtTreemapNode$$$$$getDatatipColor$$($DvtSunburstDefaults$$) {
    return $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$ instanceof $dvt$$15$$.$Button$ ? null : $DvtTreemapNode$$.$superclass$.$getDatatipColor$.call(this, $DvtSunburstDefaults$$);
  };
  $DvtTreemapNode$$.prototype.$getTooltip$ = function $$DvtTreemapNode$$$$$getTooltip$$($DvtSunburstDefaults$$) {
    return $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$ instanceof $dvt$$15$$.$Button$ ? $dvt$$15$$.$Bundle$.$getTranslation$(this.$_view$.$getOptions$(), this.$_bIsolated$ ? "tooltipRestore" : "tooltipIsolate", $dvt$$15$$.$Bundle$.$TREEMAP_PREFIX$, this.$_bIsolated$ ? "RESTORE" : "ISOLATE") : null;
  };
  $DvtTreemapNode$$.prototype.$getAriaLabel$ = function $$DvtTreemapNode$$$$$getAriaLabel$$() {
    ...
    this.$isSelectable$() && $DvtSunburstEventManager$$.push($dvt$$15$$.$Bundle$.$getTranslation$($DvtSunburstDefaults$$, this.$isSelected$() ? "stateSelected" : "stateUnselected", $dvt$$15$$.$Bundle$.$UTIL_PREFIX$, this.$isSelected$() ? "STATE_SELECTED" : "STATE_UNSELECTED"));
    this.$_bIsolated$ && $DvtSunburstEventManager$$.push($dvt$$15$$.$Bundle$.$getTranslation$($DvtSunburstDefaults$$, "stateIsolated", $dvt$$15$$.$Bundle$.$UTIL_PREFIX$, "STATE_ISOLATED"));
    this.$isDrillReplaceEnabled$() && $DvtSunburstEventManager$$.push($dvt$$15$$.$Bundle$.$getTranslation$($DvtSunburstDefaults$$, "stateDrillable", $dvt$$15$$.$Bundle$.$UTIL_PREFIX$, "STATE_DRILLABLE"));
    return $dvt$$15$$.$Displayable$.$generateAriaLabel$(this.$getShortDesc$(), $DvtSunburstEventManager$$);
  };
  $DvtTreemapNode$$.prototype.$UpdateAriaLabel$ = function $$DvtTreemapNode$$$$$UpdateAriaLabel$$() {
    !$dvt$$15$$.$Agent$.$deferAriaCreation$() && this.$_shape$ && this.$_shape$.$setAriaProperty$("label", this.$getAriaLabel$());
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreemapLayoutBase$$, $dvt$$15$$.$Obj$);
  ...
  $DvtTreemapLayoutBase$$.prototype.$setNodeBounds$ = function $$DvtTreemapLayoutBase$$$$$setNodeBounds$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$) {
    ...
    return new $dvt$$15$$.$Rectangle$($DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$);
  };
  $DvtTreemapLayoutBase$$.prototype.$getGapSize$ = function $$DvtTreemapLayoutBase$$$$$getGapSize$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $dvt$$15$$.$getOptions$().groupGaps;
    return "outer" == $DvtSunburstEventManager$$ ? 1 == $DvtSunburstDefaults$$ && 2 <= $dvt$$15$$.$_maxDepth$ ? $DvtTreemapLayoutBase$$.$_GROUP_GAP$ : 0 : "all" == $DvtSunburstEventManager$$ ? $DvtSunburstDefaults$$ < $dvt$$15$$.$_maxDepth$ ? $DvtTreemapLayoutBase$$.$_GROUP_GAP$ : 0 : 0;
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreemapLayoutSquarifying$$, $DvtTreemapLayoutBase$$);
  $DvtTreemapLayoutSquarifying$$.prototype.$layout$ = function $$DvtTreemapLayoutSquarifying$$$$$layout$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$) {
  ...
  $DvtTreemapLayoutSquarifying$$.prototype.$_layout$ = function $$DvtTreemapLayoutSquarifying$$$$$_layout$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$) {
    ...
    null != $DvtSunburstDefaults$$ && 0 < $DvtSunburstDefaults$$.length && (this.$_calcPixelSize$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$.$w$ * $DvtSunburstEventManager$$.$h$), $DvtSunburstDefaults$$ = $DvtSunburstDefaults$$.slice(0).sort(function($dvt$$15$$, $DvtSunburstDefaults$$) {
      return $dvt$$15$$.$getSize$() - $DvtSunburstDefaults$$.$getSize$();
    }), this.$_squarify$($DvtSunburstDefaults$$, Math.min($DvtSunburstEventManager$$.$w$, $DvtSunburstEventManager$$.$h$), new $dvt$$15$$.$Rectangle$($DvtSunburstEventManager$$.x, $DvtSunburstEventManager$$.y, $DvtSunburstEventManager$$.$w$, $DvtSunburstEventManager$$.$h$)));
  };
  $DvtTreemapLayoutSquarifying$$.prototype.$_calcPixelSize$ = function $$DvtTreemapLayoutSquarifying$$$$$_calcPixelSize$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    for (var $DvtSunburstEventManager$$ = 0, $DvtSunburstNode$$ = 0, $DvtSunburstNode$$ = 0;$DvtSunburstNode$$ < $dvt$$15$$.length;$DvtSunburstNode$$++) {
      $DvtSunburstEventManager$$ += 0 < $dvt$$15$$[$DvtSunburstNode$$].$getSize$() ? $dvt$$15$$[$DvtSunburstNode$$].$getSize$() : 0;
    }
    $DvtSunburstEventManager$$ = 0 == $DvtSunburstDefaults$$ ? 0 : $DvtSunburstDefaults$$ / $DvtSunburstEventManager$$;
    for ($DvtSunburstNode$$ = 0;$DvtSunburstNode$$ < $dvt$$15$$.length;$DvtSunburstNode$$++) {
      var $DvtTreemapDefaults$$ = $dvt$$15$$[$DvtSunburstNode$$];
      $DvtTreemapDefaults$$.$__pxSize$ = $DvtTreemapDefaults$$.$getSize$() * $DvtSunburstEventManager$$;
    }
  };
  $DvtTreemapLayoutSquarifying$$.prototype.$_squarify$ = function $$DvtTreemapLayoutSquarifying$$$$$_squarify$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    var $DvtSunburstNode$$ = [], $DvtTreemapDefaults$$ = Infinity;
    if (null == $dvt$$15$$ || 0 == $dvt$$15$$.length) {
      this.$_layoutRow$($DvtSunburstNode$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$);
    } else {
      for (;0 < $dvt$$15$$.length;) {
        var $DvtTreemapEventManager$$ = $dvt$$15$$.pop();
        ...
        if ($DvtTreemapKeyboardHandler$$ > $DvtTreemapDefaults$$) {
          $dvt$$15$$.push($DvtTreemapEventManager$$);
          $DvtSunburstNode$$.pop();
          $DvtSunburstEventManager$$ = this.$_layoutRow$($DvtSunburstNode$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$);
          this.$_squarify$($dvt$$15$$, Math.min($DvtSunburstEventManager$$.$w$, $DvtSunburstEventManager$$.$h$), $DvtSunburstEventManager$$);
          break;
        } else {
          if (0 == $dvt$$15$$.length) {
            this.$_layoutRow$($DvtSunburstNode$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$);
  ...
  $DvtTreemapLayoutSquarifying$$.prototype.$_getWorst$ = function $$DvtTreemapLayoutSquarifying$$$$$_getWorst$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    for (var $DvtSunburstEventManager$$ = 0, $DvtSunburstNode$$ = Infinity, $DvtTreemapDefaults$$ = -Infinity, $DvtTreemapEventManager$$ = 0;$DvtTreemapEventManager$$ < $dvt$$15$$.length;$DvtTreemapEventManager$$++) {
      $DvtSunburstEventManager$$ += $dvt$$15$$[$DvtTreemapEventManager$$].$__pxSize$, $DvtSunburstNode$$ = Math.min($DvtSunburstNode$$, $dvt$$15$$[$DvtTreemapEventManager$$].$__pxSize$), $DvtTreemapDefaults$$ = Math.max($DvtTreemapDefaults$$, $dvt$$15$$[$DvtTreemapEventManager$$].$__pxSize$);
    }
  ...
  $DvtTreemapLayoutSquarifying$$.prototype.$_layoutRow$ = function $$DvtTreemapLayoutSquarifying$$$$$_layoutRow$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    ...
    if ($DvtSunburstEventManager$$ == $DvtSunburstNode$$.$w$) {
      ...
      return new $dvt$$15$$.$Rectangle$($DvtSunburstNode$$.x, $DvtSunburstNode$$.y + $DvtTreemapDefaults$$, $DvtSunburstNode$$.$w$, $DvtSunburstNode$$.$h$ - $DvtTreemapDefaults$$);
    }
    ...
    return new $dvt$$15$$.$Rectangle$($DvtSunburstNode$$.x + $DvtSunburstEventManager$$, $DvtSunburstNode$$.y, $DvtSunburstNode$$.$w$ - $DvtSunburstEventManager$$, $DvtSunburstNode$$.$h$);
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreemapLayoutSliceAndDice$$, $DvtTreemapLayoutBase$$);
  $DvtTreemapLayoutSliceAndDice$$.prototype.$layout$ = function $$DvtTreemapLayoutSliceAndDice$$$$$layout$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$) {
    this.$_layout$(this.$_isHoriz$, $dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$ ? !1 : !0);
  };
  $DvtTreemapLayoutSliceAndDice$$.prototype.$_layout$ = function $$DvtTreemapLayoutSliceAndDice$$$$$_layout$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$, $DvtTreemapLayoutSliceAndDice$$, $DvtTreemapLayoutSquarifying$$) {
    ...
    if (null != $DvtSunburstNode$$) {
      ...
      "on" == $DvtTreemapNode$$.sorting && ($DvtSunburstNode$$ = $DvtSunburstNode$$.slice(0), $DvtSunburstNode$$.sort(function($dvt$$15$$, $DvtSunburstDefaults$$) {
        return $DvtSunburstDefaults$$.$getSize$() - $dvt$$15$$.$getSize$();
      }));
      $DvtSunburstDefaults$$ && $dvt$$15$$.$Agent$.$isRightToLeft$($DvtSunburstEventManager$$.$getCtx$()) && ($DvtSunburstNode$$ = $DvtSunburstNode$$.slice(0).reverse());
      for ($DvtTreeAutomation$$ = 0;$DvtTreeAutomation$$ < $DvtSunburstNode$$.length;$DvtTreeAutomation$$++) {
  ...
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreemapKeyboardHandler$$, $DvtTreeKeyboardHandler$$);
  $DvtTreemapKeyboardHandler$$.prototype.$isNavigationEvent$ = function $$DvtTreemapKeyboardHandler$$$$$isNavigationEvent$$($DvtSunburstDefaults$$) {
    ...
    $DvtSunburstEventManager$$ || ($DvtSunburstDefaults$$ = $DvtSunburstDefaults$$.keyCode, $DvtSunburstDefaults$$ != $dvt$$15$$.KeyboardEvent.$OPEN_BRACKET$ && $DvtSunburstDefaults$$ != $dvt$$15$$.KeyboardEvent.$CLOSE_BRACKET$) || ($DvtSunburstEventManager$$ = !0);
    return $DvtSunburstEventManager$$;
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreemapEventManager$$, $DvtTreeEventManager$$);
  $DvtTreemapEventManager$$.prototype.$ProcessKeyboardEvent$ = function $$DvtTreemapEventManager$$$$$ProcessKeyboardEvent$$($DvtSunburstDefaults$$) {
    ...
    if ($DvtSunburstDefaults$$.keyCode == $dvt$$15$$.KeyboardEvent.$ENTER$ && $DvtSunburstDefaults$$.ctrlKey) {
      ...
      $dvt$$15$$.$EventManager$.$consumeEvent$($DvtSunburstDefaults$$);
    } else {
  ...
  $dvt$$15$$.$Bundle$.$addDefaultStrings$($dvt$$15$$.$Bundle$.$TREEMAP_PREFIX$, {COLOR:"Color", ISOLATE:"Isolate", OTHER:"Other", RESTORE:"Restore", SIZE:"Size"});
  $dvt$$15$$.$Obj$.$createSubclass$($DvtTreemapDefaults$$, $DvtTreeDefaults$$);
  $DvtTreemapDefaults$$.$SKIN_NEXT$ = {skin:$dvt$$15$$.$CSSStyle$.$SKIN_NEXT$, nodeSeparators:"gaps"};
  $DvtTreemapDefaults$$.$VERSION_1$ = {groupGaps:"outer", nodeDefaults:{header:{backgroundColor:"#FFFFFF", borderColor:"#d6dfe6", hoverBackgroundColor:"#ebeced", hoverOuterColor:"#ebeced", hoverInnerColor:"#d6d7d8", isolate:"auto", labelHalign:"start", labelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$ + "color:#252525;"), selectedBackgroundColor:"#dae9f5", selectedInnerColor:"#FFFFFF", selectedOuterColor:"#000000", useNodeColor:"off", _hoverLabelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$ + 
  "color:#252525;"), _selectedLabelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$ + "color:#252525;"), _drillableLabelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$ + "color:#145c9e;"), _drillableHoverLabelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$ + "color:#145c9e;"), _drillableSelectedLabelStyle:new $dvt$$15$$.$CSSStyle$($dvt$$15$$.$BaseComponentDefaults$.$FONT_FAMILY_ALTA_12$ + 
  ...
  $dvt$$15$$.$Sunburst$ = function $$dvt$$15$$$$Sunburst$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    this.Init($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$);
  };
  $dvt$$15$$.$Obj$.$createSubclass$($dvt$$15$$.$Sunburst$, $DvtTreeView$$);
  $dvt$$15$$.$Sunburst$.$_ROTATION_SHAPE_RADIUS$ = 15;
  $dvt$$15$$.$Sunburst$.$_ROTATION_SHAPE_RADIUS_TOUCH$ = 60;
  $dvt$$15$$.$Sunburst$.$_ANIMATION_TYPE_FAN$ = "fan";
  $dvt$$15$$.$Sunburst$.$_BACKGROUND_INLINE_DEFAULT$ = "";
  $dvt$$15$$.$Sunburst$.$_BUFFER_SPACE$ = 3;
  $dvt$$15$$.$Sunburst$.$_MIN_BUFFER_SPACE$ = 2;
  $dvt$$15$$.$Sunburst$.newInstance = function $$dvt$$15$$$$Sunburst$$newInstance$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    return new $dvt$$15$$.$Sunburst$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$);
  };
  $dvt$$15$$.$Sunburst$.prototype.Init = function $$dvt$$15$$$$Sunburst$$$Init$($DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$) {
    $dvt$$15$$.$Sunburst$.$superclass$.Init.call(this, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$);
    this.$Defaults$ = new $DvtSunburstDefaults$$;
    this.$_angleExtent$ = 2 * Math.PI;
  };
  $dvt$$15$$.$Sunburst$.prototype.$ApplyParsedProperties$ = function $$dvt$$15$$$$Sunburst$$$$ApplyParsedProperties$$($DvtSunburstDefaults$$) {
    $dvt$$15$$.$Sunburst$.$superclass$.$ApplyParsedProperties$.call(this, $DvtSunburstDefaults$$);
    $DvtSunburstDefaults$$ = this.$getOptions$();
    $dvt$$15$$.$Agent$.$isPlatformIE$() ? this.$_rotateCursor$ = "url(" + $DvtSunburstDefaults$$._resources.rotateCursor + "), auto" : this.$_rotateCursor$ = "url(" + $DvtSunburstDefaults$$._resources.rotateCursor + ") 8 8, auto";
  ...
  $dvt$$15$$.$Sunburst$.prototype.$Layout$ = function $$dvt$$15$$$$Sunburst$$$$Layout$$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = Math.max(Math.ceil($dvt$$15$$.$Sunburst$.$_BUFFER_SPACE$ * Math.min($DvtSunburstDefaults$$.$w$, $DvtSunburstDefaults$$.$h$) / 400), $dvt$$15$$.$Sunburst$.$_MIN_BUFFER_SPACE$);
    $DvtSunburstDefaults$$.x += $DvtSunburstEventManager$$;
    $DvtSunburstDefaults$$.y += $DvtSunburstEventManager$$;
    $DvtSunburstDefaults$$.$w$ -= 2 * $DvtSunburstEventManager$$;
    $DvtSunburstDefaults$$.$h$ -= 2 * $DvtSunburstEventManager$$;
  ...
  $dvt$$15$$.$Sunburst$.prototype.$Render$ = function $$dvt$$15$$$$Sunburst$$$$Render$$($DvtSunburstDefaults$$, $DvtSunburstNode$$) {
    this.$RenderBackground$($DvtSunburstDefaults$$);
    this.$RenderBreadcrumbs$($DvtSunburstDefaults$$);
    this.$RenderLegend$($DvtSunburstDefaults$$);
    this.$_translatePt$ = new $dvt$$15$$.$Point$($DvtSunburstNode$$.x + $DvtSunburstNode$$.$w$ / 2, $DvtSunburstNode$$.y + $DvtSunburstNode$$.$h$ / 2);
    if (this.$__isRotationEnabled$() && this.$HasValidData$()) {
      var $DvtTreemapDefaults$$ = $dvt$$15$$.$Agent$.$isTouchDevice$() ? $dvt$$15$$.$Sunburst$.$_ROTATION_SHAPE_RADIUS_TOUCH$ : $dvt$$15$$.$Sunburst$.$_ROTATION_SHAPE_RADIUS$, $DvtTreemapDefaults$$ = new $dvt$$15$$.$Circle$(this.$getCtx$(), $DvtSunburstNode$$.x + $DvtSunburstNode$$.$w$ / 2, $DvtSunburstNode$$.y + $DvtSunburstNode$$.$h$ / 2, this.$_totalRadius$ + $DvtTreemapDefaults$$);
      $DvtTreemapDefaults$$.$setInvisibleFill$();
    ...
    $DvtTreemapDefaults$$ = new $dvt$$15$$.$Container$(this.$getCtx$());
    $DvtTreemapDefaults$$.$setTranslate$(this.$_translatePt$.x, this.$_translatePt$.y);
    $DvtSunburstDefaults$$.$addChild$($DvtTreemapDefaults$$);
    if (this.$HasValidData$()) {
      var $DvtTreemapEventManager$$ = new $dvt$$15$$.$Container$(this.$getCtx$());
      ...
      this.$_selectedLayer$ = new $dvt$$15$$.$Container$(this.$getCtx$());
      $DvtTreemapDefaults$$.$addChild$(this.$_selectedLayer$);
      this.$_hoverLayer$ = new $dvt$$15$$.$Container$(this.$getCtx$());
      $DvtTreemapDefaults$$.$addChild$(this.$_hoverLayer$);
    } else {
      this.$RenderEmptyText$($DvtSunburstDefaults$$);
    }
  };
  $dvt$$15$$.$Sunburst$.prototype.$CreateEventManager$ = function $$dvt$$15$$$$Sunburst$$$$CreateEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$) {
    return new $DvtSunburstEventManager$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$);
  };
  $dvt$$15$$.$Sunburst$.prototype.$GetDisplayAnimation$ = function $$dvt$$15$$$$Sunburst$$$$GetDisplayAnimation$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    if (this.$getOptions$().animationOnDisplay === $dvt$$15$$.$Sunburst$.$_ANIMATION_TYPE_FAN$ && this.$HasValidData$()) {
      this.$_animateAngleExtent$(0);
      var $DvtSunburstNode$$ = new $dvt$$15$$.$CustomAnimation$(this.$getCtx$(), this, this.$AnimationDuration$);
      $DvtSunburstNode$$.$_animator$.$addProp$($dvt$$15$$.$Animator$.$TYPE_NUMBER$, this, this.$__getAngleExtent$, this.$_animateAngleExtent$, 2 * Math.PI);
      return $DvtSunburstNode$$;
    }
    return $dvt$$15$$.$Sunburst$.$superclass$.$GetDisplayAnimation$.call(this, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$);
  };
  $dvt$$15$$.$Sunburst$.prototype.$GetDeleteContainer$ = function $$dvt$$15$$$$Sunburst$$$$GetDeleteContainer$$() {
    var $DvtSunburstDefaults$$ = $dvt$$15$$.$Sunburst$.$superclass$.$GetDeleteContainer$.call(this);
    $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$.$setTranslate$(this.$_translatePt$.x, this.$_translatePt$.y);
    return $DvtSunburstDefaults$$;
  };
  $dvt$$15$$.$Sunburst$.prototype.$OnAnimationEnd$ = function $$dvt$$15$$$$Sunburst$$$$OnAnimationEnd$$() {
    if (!this.$AnimationStopped$) {
      this.$_container$.$removeChildren$();
      var $DvtSunburstDefaults$$ = new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$);
    ...
    $dvt$$15$$.$Sunburst$.$superclass$.$OnAnimationEnd$.call(this);
  };
  $dvt$$15$$.$Sunburst$.prototype.$__moveToHoverLayer$ = function $$dvt$$15$$$$Sunburst$$$$__moveToHoverLayer$$($dvt$$15$$) {
    this.$_hoverLayer$.$addChild$($dvt$$15$$);
  };
  $dvt$$15$$.$Sunburst$.prototype.$__moveToSelectedLayer$ = function $$dvt$$15$$$$Sunburst$$$$__moveToSelectedLayer$$($DvtSunburstDefaults$$) {
    this.$_selectedLayer$.$addChild$($DvtSunburstDefaults$$);
    $dvt$$15$$.$Agent$.$isBrowserSafari$() || $dvt$$15$$.$Agent$.$isPlatformGecko$() || (this.$_selectedLayer$.$removeAllDrawEffects$(), this.$_selectedLayer$.$addDrawEffect$($DvtTreeNode$$.$__NODE_SELECTED_SHADOW$));
  };
  $dvt$$15$$.$Sunburst$.prototype.$__getAngleExtent$ = function $$dvt$$15$$$$Sunburst$$$$__getAngleExtent$$() {
    return this.$_angleExtent$;
  };
  $dvt$$15$$.$Sunburst$.prototype.$_animateAngleExtent$ = function $$dvt$$15$$$$Sunburst$$$$_animateAngleExtent$$($DvtSunburstDefaults$$) {
    this.$_angleExtent$ = $DvtSunburstDefaults$$;
    this.$Layout$(new $dvt$$15$$.$Rectangle$(0, 0, this.$Width$, this.$Height$));
    this.$_root$ && this.$_root$.$updateShapes$(!0);
  };
  $dvt$$15$$.$Sunburst$.prototype.$__startRotation$ = function $$dvt$$15$$$$Sunburst$$$$__startRotation$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    this.$__setRotationAnchor$(this.$_calcAngle$($dvt$$15$$, $DvtSunburstDefaults$$));
  };
  $dvt$$15$$.$Sunburst$.prototype.$__setRotationAnchor$ = function $$dvt$$15$$$$Sunburst$$$$__setRotationAnchor$$($DvtSunburstDefaults$$) {
    this.$_currentAngle$ = $DvtSunburstDefaults$$;
    this.$_rotationMask$ = new $dvt$$15$$.Rect(this.$getCtx$(), 0, 0, this.$Width$, this.$Height$);
  ...
  $dvt$$15$$.$Sunburst$.prototype.$__continueRotation$ = function $$dvt$$15$$$$Sunburst$$$$__continueRotation$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    this.$__rotate$(this.$_calcAngle$($dvt$$15$$, $DvtSunburstDefaults$$));
  };
  $dvt$$15$$.$Sunburst$.prototype.$__rotate$ = function $$dvt$$15$$$$Sunburst$$$$__rotate$$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $DvtSunburstDefaults$$ - this.$_currentAngle$;
    this.$_currentAngle$ = $DvtSunburstDefaults$$;
    this.$_updateStartAngle$($DvtSunburstEventManager$$);
    this.dispatchEvent($dvt$$15$$.$EventFactory$.$newSunburstRotationEvent$(360 - Math.round(180 * this.$_startAngle$ / Math.PI), !1));
  };
  $dvt$$15$$.$Sunburst$.prototype.$__endRotation$ = function $$dvt$$15$$$$Sunburst$$$$__endRotation$$() {
    ...
    this.dispatchEvent($dvt$$15$$.$EventFactory$.$newSunburstRotationEvent$($DvtSunburstDefaults$$, !1));
    this.dispatchEvent($dvt$$15$$.$EventFactory$.$newSunburstRotationEvent$($DvtSunburstDefaults$$, !0));
  };
  $dvt$$15$$.$Sunburst$.prototype.$__expandCollapseNode$ = function $$dvt$$15$$$$Sunburst$$$$__expandCollapseNode$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$) {
    this.$__setNavigableIdToFocus$($DvtSunburstDefaults$$.getId());
    if ($DvtSunburstEventManager$$) {
      ...
      this.dispatchEvent($dvt$$15$$.$EventFactory$.$newSunburstExpandEvent$($DvtSunburstDefaults$$.getId()));
    } else {
      this.$render$(this.$getOptions$()), this.dispatchEvent($dvt$$15$$.$EventFactory$.$newSunburstCollapseEvent$($DvtSunburstDefaults$$.getId()));
    }
  };
  $dvt$$15$$.$Sunburst$.prototype.$_calcAngle$ = function $$dvt$$15$$$$Sunburst$$$$_calcAngle$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return Math.atan2($DvtSunburstDefaults$$ - this.$_translatePt$.y, $dvt$$15$$ - this.$_translatePt$.x);
  };
  $dvt$$15$$.$Sunburst$.prototype.$_updateStartAngle$ = function $$dvt$$15$$$$Sunburst$$$$_updateStartAngle$$($DvtSunburstDefaults$$) {
  ...
  $dvt$$15$$.$Sunburst$.prototype.$__isRotationEnabled$ = function $$dvt$$15$$$$Sunburst$$$$__isRotationEnabled$$() {
    return "off" != this.$getOptions$().rotation;
  };
  $dvt$$15$$.$Sunburst$.prototype.$GetComponentDescription$ = function $$dvt$$15$$$$Sunburst$$$$GetComponentDescription$$() {
    return $dvt$$15$$.$Bundle$.$getTranslation$(this.$getOptions$(), "componentName", $dvt$$15$$.$Bundle$.$UTIL_PREFIX$, "SUNBURST");
  };
  $dvt$$15$$.$Sunburst$.prototype.$getBundlePrefix$ = function $$dvt$$15$$$$Sunburst$$$$getBundlePrefix$$() {
    return $dvt$$15$$.$Bundle$.$SUNBURST_PREFIX$;
  };
  $dvt$$15$$.$Sunburst$.prototype.$CreateNode$ = function $$dvt$$15$$$$Sunburst$$$$CreateNode$$($dvt$$15$$) {
    return new $DvtSunburstNode$$(this, $dvt$$15$$);
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtSunburstNode$$, $DvtTreeNode$$);
  ...
  $DvtSunburstNode$$.prototype.$render$ = function $$DvtSunburstNode$$$$$render$$($DvtSunburstDefaults$$) {
    if (this.$_hasLayout$) {
      ...
      if (this.$_showRootContent$() && $DvtSunburstEventManager$$) {
        ...
        this.$_text$ = this.$_createTextNode$(this.$_shape$), null != this.$_text$ && (this.$_shape$.$addChild$(this.$_text$), this.$_pattern$ && ($DvtTreemapDefaults$$ = this.$_text$.$measureDimensions$(), this.$_textBackground$ = new $dvt$$15$$.Rect(this.$_view$.$getCtx$(), $DvtTreemapDefaults$$.x, $DvtTreemapDefaults$$.y, $DvtTreemapDefaults$$.$w$, $DvtTreemapDefaults$$.$h$), this.$_textBackground$.$setSolidFill$("#FFFFFF"), this.$_textBackground$.$setMouseEnabled$(!1), this.$_shape$.$addChild$(this.$_textBackground$), 
  ...
  $DvtSunburstNode$$.prototype.$setSelected$ = function $$DvtSunburstNode$$$$$setSelected$$($dvt$$15$$) {
    $DvtSunburstNode$$.$superclass$.$setSelected$.call(this, $dvt$$15$$);
  ...
  $DvtSunburstNode$$.prototype.$getNextNavigable$ = function $$DvtSunburstNode$$$$$getNextNavigable$$($DvtSunburstDefaults$$) {
    ...
    switch($DvtSunburstEventManager$$) {
      case $dvt$$15$$.KeyboardEvent.$UP_ARROW$:
        if (this === $DvtTreemapKeyboardHandler$$ || 180 < $DvtTreemapLayoutSliceAndDice$$) {
          ...
          $DvtSunburstDefaults$$ = $dvt$$15$$.$KeyboardHandler$.$getNextAdjacentNavigable$(this, $DvtSunburstDefaults$$, this.$getDescendantNodes$());
        } else {
          $DvtSunburstDefaults$$ = this.$_navigateToParent$();
        }
        break;
      case $dvt$$15$$.KeyboardEvent.$DOWN_ARROW$:
        ...
        break;
      case $dvt$$15$$.KeyboardEvent.$LEFT_ARROW$:
        ...
        break;
      case $dvt$$15$$.KeyboardEvent.$RIGHT_ARROW$:
  ...
  $DvtSunburstNode$$.prototype.$_navigateToParent$ = function $$DvtSunburstNode$$$$$_navigateToParent$$() {
    var $dvt$$15$$ = this.$_parent$, $DvtSunburstDefaults$$;
    $dvt$$15$$ ? ($DvtSunburstDefaults$$ = $dvt$$15$$, $dvt$$15$$.$MarkAsLastVisitedChild$()) : $DvtSunburstDefaults$$ = this;
    $DvtSunburstDefaults$$.$MarkAsLastVisitedChild$();
    return $DvtSunburstDefaults$$;
  };
  $DvtSunburstNode$$.$_normalizedRadToDeg$ = function $$DvtSunburstNode$$$$_normalizedRadToDeg$$($DvtSunburstDefaults$$) {
    $DvtSunburstDefaults$$ = $dvt$$15$$.Math.$radsToDegrees$($DvtSunburstDefaults$$);
  ...
  $DvtSunburstNode$$.prototype.$getKeyboardBoundingBox$ = function $$DvtSunburstNode$$$$$getKeyboardBoundingBox$$() {
    if (this.$_shape$) {
      var $DvtSunburstDefaults$$ = this.$_shape$.$getDimensions$(), $DvtSunburstEventManager$$ = new $dvt$$15$$.$Point$($DvtSunburstDefaults$$.x, $DvtSunburstDefaults$$.y), $DvtSunburstEventManager$$ = this.$_shape$.$localToStage$($DvtSunburstEventManager$$);
  ...
  $DvtSunburstNode$$.prototype.$setLayoutParams$ = function $$DvtSunburstNode$$$$$setLayoutParams$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$) {
    this.$_innerRadius$ = $dvt$$15$$;
  ...
  $DvtSunburstNode$$.prototype.$GetFill$ = function $$DvtSunburstNode$$$$$GetFill$$() {
    return this.$_bArtificialRoot$ ? $dvt$$15$$.$SolidFill$.$invisibleFill$() : $DvtSunburstNode$$.$superclass$.$GetFill$.call(this);
  };
  $DvtSunburstNode$$.prototype.$GetAnimationParams$ = function $$DvtSunburstNode$$$$$GetAnimationParams$$($DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $dvt$$15$$.$ColorUtils$.$getRed$(this.$_color$), $DvtTreemapDefaults$$ = $dvt$$15$$.$ColorUtils$.$getGreen$(this.$_color$), $DvtTreemapEventManager$$ = $dvt$$15$$.$ColorUtils$.$getBlue$(this.$_color$), $DvtTreemapKeyboardHandler$$ = this.$_startAngle$;
  ...
  $DvtSunburstNode$$.prototype.$animateUpdate$ = function $$DvtSunburstNode$$$$$animateUpdate$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    $DvtSunburstDefaults$$.$_hasLayout$ && 0 < $DvtSunburstDefaults$$.$_angleExtent$ ? $DvtSunburstNode$$.$superclass$.$animateUpdate$.call(this, $dvt$$15$$, $DvtSunburstDefaults$$) : this.$animateInsert$($dvt$$15$$);
  };
  $DvtSunburstNode$$.prototype.contains = function $$DvtSunburstNode$$$$contains$($dvt$$15$$, $DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = $DvtSunburstNode$$.$_calcAngle$($dvt$$15$$, $DvtSunburstDefaults$$);
    return this.$ContainsRadius$($DvtSunburstNode$$.$_calcRadius$($dvt$$15$$, $DvtSunburstDefaults$$)) && this.$ContainsAngle$($DvtSunburstEventManager$$);
  };
  $DvtSunburstNode$$.prototype.$ContainsAngle$ = function $$DvtSunburstNode$$$$$ContainsAngle$$($dvt$$15$$) {
    for (;$dvt$$15$$ < this.$_startAngle$;) {
      $dvt$$15$$ += $DvtSunburstNode$$.$TWO_PI$;
    }
    for (;$dvt$$15$$ - this.$_startAngle$ > $DvtSunburstNode$$.$TWO_PI$;) {
      $dvt$$15$$ -= $DvtSunburstNode$$.$TWO_PI$;
    }
    return $dvt$$15$$ >= this.$_startAngle$ && $dvt$$15$$ <= this.$_startAngle$ + this.$_angleExtent$;
  };
  $DvtSunburstNode$$.prototype.$ContainsRadius$ = function $$DvtSunburstNode$$$$$ContainsRadius$$($dvt$$15$$) {
    return $dvt$$15$$ >= this.$_innerRadius$ && $dvt$$15$$ <= this.$_outerRadius$;
  };
  $DvtSunburstNode$$.$_calcPointOnArc$ = function $$DvtSunburstNode$$$$_calcPointOnArc$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return {x:Math.cos($DvtSunburstDefaults$$) * $dvt$$15$$, y:Math.sin($DvtSunburstDefaults$$) * $dvt$$15$$};
  };
  $DvtSunburstNode$$.$_containsRect$ = function $$DvtSunburstNode$$$$_containsRect$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return $DvtSunburstDefaults$$.contains($dvt$$15$$.x, $dvt$$15$$.y) && $DvtSunburstDefaults$$.contains($dvt$$15$$.x + $dvt$$15$$.$w$, $dvt$$15$$.y) && $DvtSunburstDefaults$$.contains($dvt$$15$$.x + $dvt$$15$$.$w$, $dvt$$15$$.y + $dvt$$15$$.$h$) && $DvtSunburstDefaults$$.contains($dvt$$15$$.x, $dvt$$15$$.y + $dvt$$15$$.$h$);
  };
  $DvtSunburstNode$$.$_calcAngle$ = function $$DvtSunburstNode$$$$_calcAngle$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    var $DvtSunburstEventManager$$ = Math.atan2($DvtSunburstDefaults$$, $dvt$$15$$);
  ...
  $DvtSunburstNode$$.$_calcRadius$ = function $$DvtSunburstNode$$$$_calcRadius$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    return Math.sqrt($dvt$$15$$ * $dvt$$15$$ + $DvtSunburstDefaults$$ * $DvtSunburstDefaults$$);
  };
  $DvtSunburstNode$$.prototype.$_createShapeNode$ = function $$DvtSunburstNode$$$$$_createShapeNode$$() {
    ...
    var $DvtSunburstDefaults$$ = this.$_createPathCmd$(), $DvtSunburstDefaults$$ = new $dvt$$15$$.$Path$(this.$_view$.$getCtx$(), $DvtSunburstDefaults$$);
    ...
    $DvtSunburstDefaults$$.$setStroke$(new $dvt$$15$$.$SolidStroke$($DvtSunburstNode$$.borderColor || $DvtSunburstEventManager$$.borderColor, 1, $DvtSunburstNode$$.borderWidth || $DvtSunburstEventManager$$.borderWidth));
    $DvtSunburstDefaults$$.$setHoverStroke$(new $dvt$$15$$.$SolidStroke$($DvtSunburstEventManager$$.hoverColor, 1, 3));
    $DvtSunburstDefaults$$.$setSelectedStroke$(new $dvt$$15$$.$SolidStroke$($DvtSunburstEventManager$$.selectedInnerColor, 1, 1.5), new $dvt$$15$$.$SolidStroke$($DvtSunburstEventManager$$.selectedOuterColor, 1, 3.5));
    $DvtSunburstDefaults$$.$setSelectedHoverStroke$(new $dvt$$15$$.$SolidStroke$($DvtSunburstEventManager$$.hoverColor, 1, 3));
  ...
  $DvtSunburstNode$$.prototype.$_createPathCmd$ = function $$DvtSunburstNode$$$$$_createPathCmd$$() {
    ...
    this.$_startAngle$), $DvtSunburstDefaults$$ = $dvt$$15$$.$PathUtils$.moveTo($DvtSunburstDefaults$$.x, $DvtSunburstDefaults$$.y) + $dvt$$15$$.$PathUtils$.arcTo(this.$_outerRadius$, this.$_outerRadius$, this.$_angleExtent$, 1, $DvtSunburstEventManager$$.x, $DvtSunburstEventManager$$.y) + $dvt$$15$$.$PathUtils$.lineTo($DvtTreemapDefaults$$.x, $DvtTreemapDefaults$$.y) + $dvt$$15$$.$PathUtils$.arcTo(this.$_innerRadius$, this.$_innerRadius$, this.$_angleExtent$, 0, $DvtTreemapEventManager$$.x, $DvtTreemapEventManager$$.y) + 
    $dvt$$15$$.$PathUtils$.closePath()) : ($DvtSunburstDefaults$$ = $DvtSunburstNode$$.$_calcPointOnArc$(this.$_outerRadius$, this.$_startAngle$), $DvtSunburstEventManager$$ = $DvtSunburstNode$$.$_calcPointOnArc$(this.$_outerRadius$, this.$_startAngle$ + this.$_angleExtent$ / 2), $DvtTreemapDefaults$$ = $DvtSunburstNode$$.$_calcPointOnArc$(this.$_innerRadius$, this.$_startAngle$), $DvtTreemapEventManager$$ = $DvtSunburstNode$$.$_calcPointOnArc$(this.$_innerRadius$, this.$_startAngle$ + this.$_angleExtent$ / 
    2), $DvtSunburstDefaults$$ = $dvt$$15$$.$PathUtils$.moveTo($DvtSunburstDefaults$$.x, $DvtSunburstDefaults$$.y) + $dvt$$15$$.$PathUtils$.arcTo(this.$_outerRadius$, this.$_outerRadius$, this.$_angleExtent$ / 2, 1, $DvtSunburstEventManager$$.x, $DvtSunburstEventManager$$.y) + $dvt$$15$$.$PathUtils$.arcTo(this.$_outerRadius$, this.$_outerRadius$, this.$_angleExtent$ / 2, 1, $DvtSunburstDefaults$$.x, $DvtSunburstDefaults$$.y), 0 < this.$_innerRadius$ && ($DvtSunburstDefaults$$ += $dvt$$15$$.$PathUtils$.moveTo($DvtTreemapEventManager$$.x, 
    $DvtTreemapEventManager$$.y) + $dvt$$15$$.$PathUtils$.arcTo(this.$_innerRadius$, this.$_innerRadius$, this.$_angleExtent$ / 2, 0, $DvtTreemapDefaults$$.x, $DvtTreemapDefaults$$.y) + $dvt$$15$$.$PathUtils$.arcTo(this.$_innerRadius$, this.$_innerRadius$, this.$_angleExtent$ / 2, 0, $DvtTreemapEventManager$$.x, $DvtTreemapEventManager$$.y)), $DvtSunburstDefaults$$ += $dvt$$15$$.$PathUtils$.closePath());
    return $DvtSunburstDefaults$$;
  };
  $DvtSunburstNode$$.prototype.$_createExpandCollapseButton$ = function $$DvtSunburstNode$$$$$_createExpandCollapseButton$$($DvtSunburstDefaults$$) {
    ...
    $DvtSunburstDefaults$$.$addChild$($DvtSunburstEventManager$$);
    $DvtSunburstDefaults$$ = $dvt$$15$$.$Bundle$.$getTranslatedString$($dvt$$15$$.$Bundle$.$UTIL_PREFIX$, this.$isDisclosed$() ? "COLLAPSE" : "EXPAND");
  ...
  $DvtSunburstNode$$.prototype.$_createTextNode$ = function $$DvtSunburstNode$$$$$_createTextNode$$($DvtSunburstDefaults$$) {
    ...
    "auto" == this.$_labelDisplay$ ? $DvtSunburstEventManager$$ = $dvt$$15$$.$Agent$.$isPlatformIE$() || $dvt$$15$$.$Agent$.$getOS$() != $dvt$$15$$.$Agent$.$WINDOWS_OS$ ? !0 : !1 : "rotated" == this.$_labelDisplay$ && ($DvtSunburstEventManager$$ = !0);
  ...
  $DvtSunburstNode$$.prototype.$_createTextHoriz$ = function $$DvtSunburstNode$$$$$_createTextHoriz$$($DvtSunburstDefaults$$) {
    ...
    if ($DvtSunburstEventManager$$) {
      $DvtTreemapDefaults$$ = new $dvt$$15$$.$OutputText$(this.$_view$.$getCtx$(), this.$_textStr$, $DvtSunburstEventManager$$.x, $DvtSunburstEventManager$$.y, null);
      ...
      return $dvt$$15$$.$TextUtils$.$fitText$($DvtTreemapDefaults$$, $DvtSunburstEventManager$$, $DvtTreemapEventManager$$.$h$, $DvtSunburstDefaults$$) ? $DvtTreemapDefaults$$ : null;
    }
  };
  $DvtSunburstNode$$.prototype.$_createTextRotated$ = function $$DvtSunburstNode$$$$$_createTextRotated$$($DvtSunburstDefaults$$) {
    ...
    var $DvtTreemapKeyboardHandler$$ = new $dvt$$15$$.$OutputText$(this.$_view$.$getCtx$(), this.$_textStr$, 0, 0);
    $DvtTreemapKeyboardHandler$$.$setFontSize$(this.$GetTextSize$());
    this.$ApplyLabelTextStyle$($DvtTreemapKeyboardHandler$$);
    if (!$dvt$$15$$.$TextUtils$.$fitText$($DvtTreemapKeyboardHandler$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtSunburstDefaults$$)) {
      return null;
    }
  ...
  $DvtSunburstNode$$.$_findNodeIndex$ = function $$DvtSunburstNode$$$$_findNodeIndex$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    for (var $DvtSunburstEventManager$$ = 0;$DvtSunburstEventManager$$ < $DvtSunburstDefaults$$.length;$DvtSunburstEventManager$$++) {
      if ($dvt$$15$$ === $DvtSunburstDefaults$$[$DvtSunburstEventManager$$]) {
        return $DvtSunburstEventManager$$;
      }
    }
    return -1;
  ...
  $DvtSunburstNode$$.prototype.$updateShapes$ = function $$DvtSunburstNode$$$$$updateShapes$$($dvt$$15$$) {
    if (this.$_shape$) {
      ...
      if ($dvt$$15$$) {
        for ($dvt$$15$$ = this.$getChildNodes$(), $DvtSunburstDefaults$$ = 0;$DvtSunburstDefaults$$ < $dvt$$15$$.length;$DvtSunburstDefaults$$++) {
          $dvt$$15$$[$DvtSunburstDefaults$$].$updateShapes$(!0);
        }
      }
    }
  };
  $DvtSunburstNode$$.prototype.$_getExpandButton$ = function $$DvtSunburstNode$$$$$_getExpandButton$$() {
    ...
    $DvtSunburstEventManager$$ = new $dvt$$15$$.Image($DvtSunburstDefaults$$, $DvtSunburstEventManager$$.expandDown, 0, 0, $DvtSunburstNode$$.$_EXPAND_ICON_SIZE$, $DvtSunburstNode$$.$_EXPAND_ICON_SIZE$);
    $DvtTreemapDefaults$$.$setInvisibleFill$();
    $DvtTreemapEventManager$$.$setInvisibleFill$();
    $DvtSunburstEventManager$$.$setInvisibleFill$();
    $DvtSunburstDefaults$$ = new $dvt$$15$$.$Button$($DvtSunburstDefaults$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtSunburstEventManager$$);
    $DvtSunburstDefaults$$.$addEvtListener$($dvt$$15$$.MouseEvent.$CLICK$, this.$expandCollapseNode$, !1, this);
    return $DvtSunburstDefaults$$;
  };
  $DvtSunburstNode$$.prototype.$_getCollapseButton$ = function $$DvtSunburstNode$$$$$_getCollapseButton$$() {
    ...
    $DvtSunburstEventManager$$ = new $dvt$$15$$.Image($DvtSunburstDefaults$$, $DvtSunburstEventManager$$.collapseDown, 0, 0, $DvtSunburstNode$$.$_EXPAND_ICON_SIZE$, $DvtSunburstNode$$.$_EXPAND_ICON_SIZE$);
    $DvtTreemapDefaults$$.$setInvisibleFill$();
    $DvtTreemapEventManager$$.$setInvisibleFill$();
    $DvtSunburstEventManager$$.$setInvisibleFill$();
    $DvtSunburstDefaults$$ = new $dvt$$15$$.$Button$($DvtSunburstDefaults$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtSunburstEventManager$$);
  ...
  $DvtSunburstNode$$.prototype.$expandCollapseNode$ = function $$DvtSunburstNode$$$$$expandCollapseNode$$($dvt$$15$$) {
    this.$setDisclosed$(!this.$isDisclosed$());
    this.$_view$.$__expandCollapseNode$(this, this.$isDisclosed$());
    this.$UpdateAriaLabel$();
    $dvt$$15$$.stopPropagation();
  };
  ...
  $DvtSunburstNode$$.prototype.$getAriaLabel$ = function $$DvtSunburstNode$$$$$getAriaLabel$$() {
    var $DvtSunburstDefaults$$ = this.$_view$.$getOptions$(), $DvtSunburstEventManager$$ = [];
    this.$isSelectable$() && $DvtSunburstEventManager$$.push($dvt$$15$$.$Bundle$.$getTranslatedString$($dvt$$15$$.$Bundle$.$UTIL_PREFIX$, this.$isSelected$() ? "STATE_SELECTED" : "STATE_UNSELECTED"));
    this.$isExpandCollapseEnabled$() && $DvtSunburstEventManager$$.push($dvt$$15$$.$Bundle$.$getTranslatedString$($dvt$$15$$.$Bundle$.$UTIL_PREFIX$, this.$isDisclosed$() ? "STATE_EXPANDED" : "STATE_COLLAPSED"));
    this.$isDrillReplaceEnabled$() && $DvtSunburstEventManager$$.push($dvt$$15$$.$Bundle$.$getTranslation$($DvtSunburstDefaults$$, "stateDrillable", $dvt$$15$$.$Bundle$.$UTIL_PREFIX$, "STATE_DRILLABLE"));
    return $dvt$$15$$.$Displayable$.$generateAriaLabel$(this.$getShortDesc$(), $DvtSunburstEventManager$$);
  };
  ...
  $DvtSunburstNode$$.prototype.$getDataContext$ = function $$DvtSunburstNode$$$$$getDataContext$$() {
    var $dvt$$15$$ = $DvtSunburstNode$$.$superclass$.$getDataContext$.call(this);
    $dvt$$15$$.radius = this.$__getRadius$();
    return $dvt$$15$$;
  };
  var $DvtSunburstLayout$$ = {};
  $dvt$$15$$.$Obj$.$createSubclass$($DvtSunburstLayout$$, $dvt$$15$$.$Obj$);
  $DvtSunburstLayout$$.$layout$ = function $$DvtSunburstLayout$$$$layout$$($dvt$$15$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$) {
    var $DvtTreemapEventManager$$ = $DvtSunburstLayout$$.$_calcLargestRadius$($DvtSunburstDefaults$$);
    $DvtSunburstLayout$$.$_layout$($dvt$$15$$ / $DvtTreemapEventManager$$, $DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, 0);
  };
  $DvtSunburstLayout$$.$_layout$ = function $$DvtSunburstLayout$$$$_layout$$($DvtSunburstDefaults$$, $DvtSunburstEventManager$$, $DvtSunburstNode$$, $DvtTreemapDefaults$$, $DvtTreemapEventManager$$, $DvtTreemapKeyboardHandler$$) {
    ...
    if (null != $DvtTreemapKeyboardHandler$$ && $DvtSunburstEventManager$$.$isDisclosed$()) {
      "on" == $DvtTreemapEventManager$$ && ($DvtTreemapKeyboardHandler$$ = $DvtTreemapKeyboardHandler$$.slice(0), $DvtTreemapKeyboardHandler$$.sort(function($dvt$$15$$, $DvtSunburstDefaults$$) {
        return $DvtSunburstDefaults$$.$getSize$() - $dvt$$15$$.$getSize$();
      }));
      $dvt$$15$$.$Agent$.$isRightToLeft$($DvtSunburstEventManager$$.$_view$.$getCtx$()) && ($DvtTreemapKeyboardHandler$$ = $DvtTreemapKeyboardHandler$$.slice(0).reverse());
  ...
  $DvtSunburstLayout$$.$_calcLargestRadius$ = function $$DvtSunburstLayout$$$$_calcLargestRadius$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = 0, $DvtSunburstEventManager$$ = $dvt$$15$$.$getChildNodes$();
    if ($DvtSunburstEventManager$$ && 0 < $DvtSunburstEventManager$$.length) {
      ...
      return $DvtSunburstDefaults$$ + $dvt$$15$$.$__getRadius$();
    }
    return $dvt$$15$$.$__getRadius$();
  };
  $dvt$$15$$.$Obj$.$createSubclass$($DvtSunburstEventManager$$, $DvtTreeEventManager$$);
  $DvtSunburstEventManager$$.$ROTATION_ID$ = "_rotationShape";
  $DvtSunburstEventManager$$.prototype.$OnMouseDown$ = function $$DvtSunburstEventManager$$$$$OnMouseDown$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = this.$GetLogicalObject$($dvt$$15$$.target);
    $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$.getId && $DvtSunburstDefaults$$.getId() == $DvtSunburstEventManager$$.$ROTATION_ID$ && !this.$_bRotating$ ? (this.$_bRotating$ = !0, $dvt$$15$$ = this.$_context$.$pageToStageCoords$($dvt$$15$$.pageX, $dvt$$15$$.pageY), this.$_view$.$__startRotation$($dvt$$15$$.x, $dvt$$15$$.y)) : $DvtSunburstEventManager$$.$superclass$.$OnMouseDown$.call(this, $dvt$$15$$);
  };
  $DvtSunburstEventManager$$.prototype.$OnMouseMove$ = function $$DvtSunburstEventManager$$$$$OnMouseMove$$($dvt$$15$$) {
    this.$_bRotating$ ? ($dvt$$15$$ = this.$_context$.$pageToStageCoords$($dvt$$15$$.pageX, $dvt$$15$$.pageY), this.$_view$.$__continueRotation$($dvt$$15$$.x, $dvt$$15$$.y)) : $DvtSunburstEventManager$$.$superclass$.$OnMouseMove$.call(this, $dvt$$15$$);
  };
  $DvtSunburstEventManager$$.prototype.$OnMouseUp$ = function $$DvtSunburstEventManager$$$$$OnMouseUp$$($dvt$$15$$) {
    this.$_bRotating$ ? (this.$_bRotating$ = !1, this.$_view$.$__endRotation$()) : $DvtSunburstEventManager$$.$superclass$.$OnMouseUp$.call(this, $dvt$$15$$);
  };
  $DvtSunburstEventManager$$.prototype.$ProcessKeyboardEvent$ = function $$DvtSunburstEventManager$$$$$ProcessKeyboardEvent$$($DvtSunburstDefaults$$) {
    ...
    $DvtTreemapEventManager$$.$isExpandCollapseEnabled$() && ($dvt$$15$$.KeyboardEvent.$isPlus$($DvtSunburstDefaults$$) && !$DvtTreemapEventManager$$.$isDisclosed$() || $dvt$$15$$.KeyboardEvent.$isMinus$($DvtSunburstDefaults$$) && $DvtTreemapEventManager$$.$isDisclosed$() || $DvtSunburstDefaults$$.ctrlKey && $DvtTreemapDefaults$$ == $dvt$$15$$.KeyboardEvent.$ENTER$) ? ($DvtTreemapEventManager$$.$expandCollapseNode$(), $dvt$$15$$.$EventManager$.$consumeEvent$($DvtSunburstDefaults$$)) : $DvtTreemapKeyboardHandler$$ && 
    $DvtTreemapKeyboardHandler$$.$__isRotationEnabled$() && ($DvtTreemapDefaults$$ == $dvt$$15$$.KeyboardEvent.$LEFT_ARROW$ || $DvtTreemapDefaults$$ == $dvt$$15$$.KeyboardEvent.$RIGHT_ARROW$) && !$DvtSunburstDefaults$$.ctrlKey && $DvtSunburstDefaults$$.altKey && $DvtSunburstDefaults$$.shiftKey ? ($DvtTreemapDefaults$$ = $DvtTreemapDefaults$$ == $dvt$$15$$.KeyboardEvent.$LEFT_ARROW$ ? Math.PI / 180 * -5 : Math.PI / 180 * 5, $DvtTreemapKeyboardHandler$$.$__setRotationAnchor$(0), $DvtTreemapKeyboardHandler$$.$__rotate$($DvtTreemapDefaults$$), 
    $DvtTreemapKeyboardHandler$$.$__endRotation$(), $dvt$$15$$.$EventManager$.$consumeEvent$($DvtSunburstDefaults$$)) : $DvtSunburstNode$$ = $DvtSunburstEventManager$$.$superclass$.$ProcessKeyboardEvent$.call(this, $DvtSunburstDefaults$$);
    return $DvtSunburstNode$$;
  };
  $DvtSunburstEventManager$$.$ROTATE_KEY$ = "rotateKey";
  $DvtSunburstEventManager$$.prototype.$HandleImmediateTouchStartInternal$ = function $$DvtSunburstEventManager$$$$$HandleImmediateTouchStartInternal$$($dvt$$15$$) {
    var $DvtSunburstDefaults$$ = this.$GetLogicalObject$($dvt$$15$$.target);
    $DvtSunburstDefaults$$ && $DvtSunburstDefaults$$.getId && $DvtSunburstDefaults$$.getId() == $DvtSunburstEventManager$$.$ROTATION_ID$ && this.$TouchManager$.$processAssociatedTouchAttempt$($dvt$$15$$, this.$RotateStartTouch$, this);
  };
  $DvtSunburstEventManager$$.prototype.$HandleImmediateTouchMoveInternal$ = function $$DvtSunburstEventManager$$$$$HandleImmediateTouchMoveInternal$$($dvt$$15$$) {
    this.$TouchManager$.$processAssociatedTouchMove$($dvt$$15$$, $DvtSunburstEventManager$$.$ROTATE_KEY$);
  };
  $DvtSunburstEventManager$$.prototype.$HandleImmediateTouchEndInternal$ = function $$DvtSunburstEventManager$$$$$HandleImmediateTouchEndInternal$$($dvt$$15$$) {
    this.$TouchManager$.$processAssociatedTouchEnd$($dvt$$15$$, $DvtSunburstEventManager$$.$ROTATE_KEY$);
  };
  $DvtSunburstEventManager$$.prototype.$RotateStartTouch$ = function $$DvtSunburstEventManager$$$$$RotateStartTouch$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    if (1 >= this.$TouchManager$.$getTouchIdsForObj$($DvtSunburstEventManager$$.$ROTATE_KEY$).length) {
      ...
      $dvt$$15$$.$blockTouchHold$();
    }
  };
  $DvtSunburstEventManager$$.prototype.$RotateMoveTouch$ = function $$DvtSunburstEventManager$$$$$RotateMoveTouch$$($dvt$$15$$, $DvtSunburstDefaults$$) {
    ...
    $dvt$$15$$.preventDefault();
  };
  $DvtSunburstEventManager$$.prototype.$RotateEndTouch$ = function $$DvtSunburstEventManager$$$$$RotateEndTouch$$() {
    this.$_view$.$__endRotation$();
  };
  $dvt$$15$$.$Bundle$.$addDefaultStrings$($dvt$$15$$.$Bundle$.$SUNBURST_PREFIX$, {COLOR:"Color", OTHER:"Other", SIZE:"Size"});
  $dvt$$15$$.$Obj$.$createSubclass$($DvtSunburstDefaults$$, $DvtTreeDefaults$$);
  ...
  $dvt$$15$$.$exportProperty$($dvt$$15$$, "Sunburst", $dvt$$15$$.$Sunburst$);
  $dvt$$15$$.$exportProperty$($dvt$$15$$, "Treemap", $dvt$$15$$.$Treemap$);
  $dvt$$15$$.$exportProperty$($dvt$$15$$.$Treemap$, "newInstance", $dvt$$15$$.$Treemap$.newInstance);
  $dvt$$15$$.$exportProperty$($dvt$$15$$.$Sunburst$, "newInstance", $dvt$$15$$.$Sunburst$.newInstance);
  $dvt$$15$$.$exportProperty$($DvtTreeView$$.prototype, "getAutomation", $DvtTreeView$$.prototype.$getAutomation$);
  $dvt$$15$$.$exportProperty$($DvtTreeView$$.prototype, "destroy", $DvtTreeView$$.prototype.$destroy$);
  $dvt$$15$$.$exportProperty$($DvtTreeView$$.prototype, "highlight", $DvtTreeView$$.prototype.$highlight$);
  $dvt$$15$$.$exportProperty$($DvtTreeView$$.prototype, "render", $DvtTreeView$$.prototype.$render$);
  $dvt$$15$$.$exportProperty$($DvtTreeView$$.prototype, "select", $DvtTreeView$$.prototype.select);
  $dvt$$15$$.$exportProperty$($DvtTreeAutomation$$.prototype, "getDomElementForSubId", $DvtTreeAutomation$$.prototype.$getDomElementForSubId$);
  $dvt$$15$$.$exportProperty$($DvtTreeAutomation$$.prototype, "getNode", $DvtTreeAutomation$$.prototype.$getNode$);
})(dvt);
