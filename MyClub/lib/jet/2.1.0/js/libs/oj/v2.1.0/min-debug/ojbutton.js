...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$24$$, $$$$22$$) {
  (function() {
    function $_getChromingDefault$$($componentName$$7$$, $element$$189_element$$inline_1007$$, $actualContainers$$1_containerConstructor$$) {
      a: {
        for (var $interestingContainers$$inline_1009$$ = $_interestingContainers$$[$componentName$$7$$], $i$$inline_1010$$ = 0;$i$$inline_1010$$ < $interestingContainers$$inline_1009$$.length;++$i$$inline_1010$$) {
          var $containerName$$inline_1011$$ = $interestingContainers$$inline_1009$$[$i$$inline_1010$$];
          if (0 <= $actualContainers$$1_containerConstructor$$.indexOf($containerName$$inline_1011$$)) {
            for (;;$element$$189_element$$inline_1007$$ = $element$$189_element$$inline_1007$$.parentNode) {
              var $func$$inline_1012$$ = $oj$$24$$.Components.$getWidgetConstructor$($element$$189_element$$inline_1007$$, $containerName$$inline_1011$$);
              if ($func$$inline_1012$$) {
                $actualContainers$$1_containerConstructor$$ = $func$$inline_1012$$;
                break a;
              }
            }
          }
      ...
      return $actualContainers$$1_containerConstructor$$ ? $actualContainers$$1_containerConstructor$$("option", "chroming") : ($oj$$24$$.$ThemeUtils$.$parseJSONFromFontFamily$("oj-" + $componentName$$7$$ + "-option-defaults") || {}).chroming;
    }
    function $_radioGroup$$($radio$$, $$elems$$) {
      var $name$$123_selector$$29$$ = $radio$$.name, $$radios_form$$1$$ = $radio$$.form;
      $name$$123_selector$$29$$ ? ($name$$123_selector$$29$$ = $name$$123_selector$$29$$.replace(/'/g, "\\'"), $name$$123_selector$$29$$ = ":radio[name\x3d'" + $name$$123_selector$$29$$ + "']:oj-button", $$radios_form$$1$$ = $$elems$$ ? $$elems$$.filter($name$$123_selector$$29$$) : $$radios_form$$1$$ ? $$$$22$$($$radios_form$$1$$).find($name$$123_selector$$29$$) : $$$$22$$($name$$123_selector$$29$$, $radio$$.ownerDocument).filter(function() {
        return!this.form;
    ...
    $oj$$24$$.$__registerWidget$("oj.ojButton", $$$$22$$.oj.baseComponent, {defaultElement:"\x3cbutton\x3e", widgetEventPrefix:"oj", options:{chroming:"full", disabled:!1, display:"all", label:null, icons:{start:null, end:null}, menu:null}, $_InitOptions$:function($originalDefaults$$10$$, $constructorOptions$$12$$) {
      ...
      function $endHandler$$() {
        $self$$161$$.$_lastTouch$ = Date.now();
        $self$$161$$.$rootElement$.removeClass($activeClass$$);
        $self$$161$$.$rootElement$.removeClass("oj-hover");
        $self$$161$$.$_toggleDefaultClasses$();
      }
      this._super();
      ...
      var $self$$161$$ = this, $tabIndex$$7_toggleButton$$ = this.$_isToggle$, $activeClass$$ = $tabIndex$$7_toggleButton$$ ? "" : "oj-active";
      ...
      this.$buttonElement$.bind("touchstart" + this.eventNamespace, function() {
        $self$$161$$.$_IsEffectivelyDisabled$() || ($$$$22$$(this).addClass($activeClass$$), $self$$161$$.$_toggleDefaultClasses$());
        ...
        $self$$161$$.$_IsEffectivelyDisabled$() || $self$$161$$.$_recentTouch$() || (this === $_lastActive$$ && $self$$161$$.$rootElement$.addClass("oj-active"), $self$$161$$.$rootElement$.addClass("oj-hover").removeClass("oj-default oj-focus-only"));
      }).bind("mouseleave" + this.eventNamespace, function() {
        $self$$161$$.$rootElement$.removeClass("oj-hover");
        $self$$161$$.$_IsEffectivelyDisabled$() || ($self$$161$$.$rootElement$.removeClass($activeClass$$), $self$$161$$.$_toggleDefaultClasses$());
      }).bind("click" + this.eventNamespace, function($event$$493$$) {
        $self$$161$$.$_IsEffectivelyDisabled$() && ($event$$493$$.preventDefault(), $event$$493$$.stopImmediatePropagation());
      });
      this._focusable({element:this.$rootElement$, applyHighlight:!0, afterToggle:function() {
        $self$$161$$.$_toggleDefaultClasses$();
      }});
      $tabIndex$$7_toggleButton$$ && (this.element.bind("change" + this.eventNamespace, function($event$$494$$) {
        $self$$161$$.$_applyCheckedStateFromDom$(!0);
        ...
        $buttonset$$ && void 0 !== $checkedState$$ && $buttonset$$.option("checked", $checkedState$$, {_context:{$writeback$:!0, originalEvent:$event$$494$$, $internalSet$:!0}});
      }), this.$buttonElement$.bind("mousedown" + this.eventNamespace, function() {
        $self$$161$$.$_IsEffectivelyDisabled$() || ($_lastToggleActive$$ = this, $self$$161$$.document.one("mouseup", function() {
          $_lastToggleActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        $self$$161$$.$_IsEffectivelyDisabled$() || this !== $_lastToggleActive$$ || $self$$161$$.element.focus();
      }));
      "checkbox" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$161$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$498$$) {
        $event$$498$$.keyCode === $$$$22$$.ui.keyCode.ENTER && ($self$$161$$.$_IsEffectivelyDisabled$() || $self$$161$$.element.click());
      })) : "radio" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$161$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$499$$) {
        $event$$499$$.keyCode !== $$$$22$$.ui.keyCode.ENTER || $self$$161$$.element[0].checked || $self$$161$$.$_IsEffectivelyDisabled$() || ($self$$161$$.element[0].checked = !0, $self$$161$$.element.change(), $self$$161$$.element.click());
      })) : (this.$buttonElement$.bind("mousedown" + this.eventNamespace, function($event$$500$$) {
        if ($self$$161$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        1 !== $event$$500$$.which || $self$$161$$.$_recentTouch$() || ($$$$22$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only"), $_lastActive$$ = this, $self$$161$$.document.one("mouseup", function() {
          $_lastActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        if ($self$$161$$.$_IsEffectivelyDisabled$()) {
        ...
        $self$$161$$.$_toggleDefaultClasses$();
      }).bind("keydown" + this.eventNamespace, function($event$$501$$) {
        if ($self$$161$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        var $isSpace$$ = $event$$501$$.keyCode === $$$$22$$.ui.keyCode.SPACE, $isAnchor$$ = "anchor" === $self$$161$$.type;
        $isAnchor$$ && $isSpace$$ && $event$$501$$.preventDefault();
        ($isSpace$$ && !$isAnchor$$ || $event$$501$$.keyCode === $$$$22$$.ui.keyCode.ENTER) && $$$$22$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only");
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$9$$, $event$$502$$, $eventType$$40$$) {
      this.$_OpenContextMenu$($event$$502$$, $eventType$$40$$, {position:{of:"keyboard" === $eventType$$40$$ ? this.$rootElement$ : $event$$502$$}});
      ...
      $effectivelyDisabled$$ ? (this.widget().removeClass("oj-active oj-default oj-focus-only oj-hover oj-focus oj-focus-highlight"), $_lastActive$$ = null, this.$_dismissMenu$()) : this.$_toggleDefaultClasses$();
    }, _setOption:function($key$$148$$, $value$$274$$, $flags$$33$$) {
      this._super($key$$148$$, $value$$274$$, $flags$$33$$);
      switch($key$$148$$) {
        case "chroming":
          $_setChromingClass$$(this.$rootElement$, $value$$274$$);
          break;
        case "disabled":
          this.$_updateEffectivelyDisabled$();
          break;
      ...
      var $buttonElement_contentContainer$$1$$ = this.$buttonElement$, $textSpan$$2$$ = $$$$22$$("\x3cspan class\x3d'oj-button-text'\x3e\x3c/span\x3e", this.document[0]);
      this.$keepDomLabel$ ? $textSpan$$2$$.append($buttonElement_contentContainer$$1$$.contents()) : ($buttonElement_contentContainer$$1$$.empty(), $textSpan$$2$$.text(this.options.label));
      "button" === this.type ? ($buttonElement_contentContainer$$1$$ = $$$$22$$("\x3cdiv\x3e\x3c/div\x3e").addClass("oj-button-label"), $buttonElement_contentContainer$$1$$.append($textSpan$$2$$), this.element.append($buttonElement_contentContainer$$1$$)) : $buttonElement_contentContainer$$1$$.append($textSpan$$2$$);
      ...
      var $contentContainer$$2$$ = this.$buttonElement$;
      "button" === this.type && ($contentContainer$$2$$ = this.element.children("div.oj-button-label"));
      ...
      $iconSpan_iconSpanSelector$$ = $contentContainer$$2$$.find($iconSpan_iconSpanSelector$$);
      $appIconClass$$ ? ($iconSpan_iconSpanSelector$$.length ? $iconSpan_iconSpanSelector$$.removeClass(this[$lastIvar$$]) : $iconSpan_iconSpanSelector$$ = $$$$22$$("\x3cspan\x3e\x3c/span\x3e").addClass($isStart_standardIconClasses$$)[$pendTo$$]($contentContainer$$2$$), $iconSpan_iconSpanSelector$$.addClass($appIconClass$$)) : $iconSpan_iconSpanSelector$$.remove();
      ...
      if (this.options.menu) {
        var $self$$162$$ = this;
        this.element.attr("aria-haspopup", !0).on("keydown" + this.$menuEventNamespace$, function($event$$503$$) {
          if ($event$$503$$.which === $$$$22$$.ui.keyCode.DOWN) {
            $self$$162$$.$_showMenu$($event$$503$$, "firstItem"), $event$$503$$.preventDefault();
          } else {
            if ($event$$503$$.which === $$$$22$$.ui.keyCode.ESCAPE) {
              var $bubbleEscUp$$ = $self$$162$$.$_checkMenuParent$($self$$162$$.$rootElement$);
              $self$$162$$.$_dismissMenu$($event$$503$$);
              return $bubbleEscUp$$;
            }
          }
          return!0;
        }).on("click" + this.$menuEventNamespace$, function($event$$504$$) {
          var $menu$$10$$ = $self$$162$$.$_getMenu$();
          $menu$$10$$.$__spaceEnterDownInMenu$ || $self$$162$$.$_showMenu$($event$$504$$, "firstItem");
          $menu$$10$$.$__spaceEnterDownInMenu$ = !1;
          $event$$504$$.preventDefault();
          return!0;
        });
      }
    }, $_checkMenuParent$:function($element$$187$$) {
      return!$element$$187$$.hasClass("oj-selected");
      ...
      if (!this.$_menu$) {
        ...
        var $self$$163$$ = this;
        this.$_menu$.widget().on("ojclose" + this.$menuEventNamespace$, function($event$$505$$) {
          $self$$163$$.$_menuDismissHandler$($event$$505$$);
        });
      }
      return this.$_menu$;
    }, $_showMenu$:function($event$$506$$, $focus$$) {
      if (!this.$_IsEffectivelyDisabled$()) {
        var $menu$$11$$ = this.$_getMenu$(), $menuElem$$ = $menu$$11$$.widget();
        $menu$$11$$.open($event$$506$$, {launcher:this.element, initialFocus:$focus$$});
        this.$_menuVisible$ = !0;
    ...
    }, $_dismissMenu$:function($event$$507$$) {
      this.$_menuVisible$ && (this.$_menu$.$__collapseAll$($event$$507$$, !0), this.$_menu$.$__dismiss$($event$$507$$));
      ...
      var $defaultState$$, $focused$$9_focusedOnly$$;
      this.$rootElement$.is(".oj-hover, .oj-active, .oj-selected, .oj-disabled") ? $focused$$9_focusedOnly$$ = $defaultState$$ = !1 : ($focused$$9_focusedOnly$$ = this.$rootElement$.is(".oj-focus"), $defaultState$$ = !$focused$$9_focusedOnly$$);
      this.$rootElement$.toggleClass("oj-default", $defaultState$$);
      this.$rootElement$.toggleClass("oj-focus-only", $focused$$9_focusedOnly$$);
    }});
    $oj$$24$$.$__registerWidget$("oj.ojButtonset", $$$$22$$.oj.baseComponent, {$_items$:"button, input[type\x3dbutton], input[type\x3dsubmit], input[type\x3dreset], input[type\x3dcheckbox], input[type\x3dradio], a", widgetEventPrefix:"oj", options:{checked:null, chroming:"full", focusManagement:"oneTabstop"}, $_setCheckedOnDom$:function($checked$$1$$, $$buttons$$1$$) {
      ...
      if ("string" === $name$$121_type$$89_valid$$10_validRadios$$ || "null" === $name$$121_type$$89_valid$$10_validRadios$$) {
        ...
        if ("array" === $name$$121_type$$89_valid$$10_validRadios$$) {
          var $last$$2$$;
          ($name$$121_type$$89_valid$$10_validRadios$$ = $allCheckboxes$$ && $checked$$1$$.concat().sort().every(function($elem$$107$$) {
            var $retVal$$15$$ = $elem$$107$$ !== $last$$2$$ && $$buttons$$1$$.filter("[value\x3d" + $elem$$107$$ + "]").length;
            $last$$2$$ = $elem$$107$$;
            return $retVal$$15$$;
      ...
      return $checked$$2$$;
    }, $_CompareOptionValues$:function($option$$34$$, $value1$$9$$, $value2$$8$$) {
      return "checked" === $option$$34$$ ? $value1$$9$$ === $value2$$8$$ ? !0 : "array" === $$$$22$$.type($value1$$9$$) && "array" === $$$$22$$.type($value2$$8$$) && !$$$$22$$($value1$$9$$).not($value2$$8$$).length && !$$$$22$$($value2$$8$$).not($value1$$9$$).length : this._superApply(arguments);
      ...
      this.$_setup$(!0);
    }, $_NotifyContextMenuGesture$:function($currentButton_menu$$12$$, $event$$509$$, $eventType$$41$$) {
      $currentButton_menu$$12$$ = this.element.find(":oj-button[tabindex\x3d0]");
      this.$_OpenContextMenu$($event$$509$$, $eventType$$41$$, {launcher:$currentButton_menu$$12$$, position:{of:"keyboard" === $eventType$$41$$ ? $currentButton_menu$$12$$.ojButton("widget") : $event$$509$$}});
    ...
    }, _setOption:function($key$$149$$, $value$$275$$, $flags$$34$$) {
      this._superApply(arguments);
      "disabled" === $key$$149$$ ? this.$_propagateDisabled$($value$$275$$) : "checked" === $key$$149$$ ? (this.$_setCheckedOnDom$($value$$275$$, this.$$buttons$), this.$$buttons$.each(function() {
        $$$$22$$(this).data("oj-ojButton").$_applyCheckedStateFromDom$(!1);
      })) : "focusManagement" === $key$$149$$ ? this.$_setRole$($value$$275$$) : "chroming" === $key$$149$$ && ($_setChromingClass$$(this.element, $value$$275$$), this.$$buttons$.ojButton("refresh"));
    }, refresh:function() {
      this._super();
      this.$_setup$(!1);
      ...
      "oneTabstop" === this.options.focusManagement && (this.$$buttons$.unbind("keydown" + this.eventNamespace).bind("keydown" + this.eventNamespace, function($event$$510$$) {
        $self$$164$$.$_handleKeyDown$($event$$510$$, $$$$22$$(this));
      }).unbind("click" + this.eventNamespace).bind("click" + this.eventNamespace, function() {
        $$$$22$$(this).data("oj-ojButton").$_IsEffectivelyDisabled$() || $self$$164$$.$_setTabStop$($$$$22$$(this));
      }).unbind("focus" + this.eventNamespace).bind("focus" + this.eventNamespace, function() {
        $self$$164$$.$_setTabStop$($$$$22$$(this));
      ...
      return $$button$$.map(function($index$$223$$, $elem$$108$$) {
        if ("radio" != $elem$$108$$.type || $elem$$108$$.checked || "" == $elem$$108$$.name) {
          return $elem$$108$$;
        }
        var $$checkedRadio$$ = $_radioGroup$$($elem$$108$$, $$enabledButtons$$).filter(":checked");
        return $$checkedRadio$$.length ? $$checkedRadio$$[0] : $elem$$108$$;
      });
    ...
    }, $_handleKeyDown$:function($event$$513$$, $$button$$2$$) {
      switch($event$$513$$.which) {
        ...
        case $$$$22$$.ui.keyCode.RIGHT:
          ...
          $$enabledButtons$$1$$.eq(($oldIndex$$1$$ + ($event$$513$$.which == $$$$22$$.ui.keyCode.RIGHT ^ this.$isRtl$ ? 1 : -1) + $length$$18$$) % $length$$18$$).focus();
          break;
        case $$$$22$$.ui.keyCode.UP:
        ;
        case $$$$22$$.ui.keyCode.DOWN:
          "radio" == $$button$$2$$.attr("type") && $event$$513$$.preventDefault();
      }
    }, _destroy:function() {
    ...
    $oj$$24$$.Components.$setDefaultOptions$({ojButton:{chroming:$oj$$24$$.Components.$createDynamicPropertyGetter$(function($context$$120$$) {
      return $_getChromingDefault$$("button", $context$$120$$.element, $context$$120$$.containers);
    })}, ojButtonset:{chroming:$oj$$24$$.Components.$createDynamicPropertyGetter$(function($context$$121$$) {
      return $_getChromingDefault$$("buttonset", $context$$121$$.element, $context$$121$$.containers);
    })}});
  })();
});
