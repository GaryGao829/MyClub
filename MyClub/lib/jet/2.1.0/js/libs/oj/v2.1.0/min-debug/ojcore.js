...
define(["require", "ojL10n!ojtranslations/nls/ojtranslations"], function($require$$2$$, $ojt$$1$$) {
  ...
  var $_oldVal$$ = $_scope$$.oj, $oj$$ = $_scope$$.oj = {version:"2.1.0", build:"2766", revision:"26246", noConflict:function $$_scope$$$oj$noConflict$() {
    $_scope$$.oj = $_oldVal$$;
  }};
  $oj$$.$Logger$ = {};
  ...
  $oj$$.$Config$.$setLocale$ = function $$oj$$$$Config$$$setLocale$$($locale$$, $callback$$56$$) {
    if ($oj$$.$__isAmdLoaderPresent$()) {
      var $requestedBundles$$ = ["ojL10n!ojtranslations/nls/" + $locale$$ + "/ojtranslations"], $timezoneBundleCount$$ = 0;
      if ($oj$$.$LocaleData$ && ($requestedBundles$$.push("ojL10n!ojtranslations/nls/" + $locale$$ + "/localeElements"), $oj$$.$TimezoneData$)) {
        var $tzBundles$$ = $oj$$.$TimezoneData$.$__getBundleNames$(), $timezoneBundleCount$$ = $tzBundles$$.length;
        $tzBundles$$.forEach(function($bundle$$) {
          $requestedBundles$$.push("ojL10n!ojtranslations/nls/" + $locale$$ + $bundle$$);
        });
      }
      $require$$2$$($requestedBundles$$, function($translations$$, $localeElements$$) {
        ...
        for (var $i$$14$$ = 0;$i$$14$$ < $timezoneBundleCount$$;$i$$14$$++) {
          $oj$$.$TimezoneData$.$__mergeIntoLocaleElements$(arguments[$i$$14$$ + 2]);
        }
  ...
  $oj$$.$ThemeUtils$ = function $$oj$$$$ThemeUtils$$() {
  };
  $goog$exportPath_$$("ThemeUtils", $oj$$.$ThemeUtils$, $oj$$);
  $oj$$.$ThemeUtils$.$getThemeName$ = function $$oj$$$$ThemeUtils$$$getThemeName$$() {
    return($oj$$.$ThemeUtils$.$parseJSONFromFontFamily$("oj-theme-json") || {}).name;
  };
  $goog$exportPath_$$("ThemeUtils.getThemeName", $oj$$.$ThemeUtils$.$getThemeName$, $oj$$);
  $oj$$.$ThemeUtils$.$getThemeTargetPlatform$ = function $$oj$$$$ThemeUtils$$$getThemeTargetPlatform$$() {
    return($oj$$.$ThemeUtils$.$parseJSONFromFontFamily$("oj-theme-json") || {}).targetPlatform;
  };
  $goog$exportPath_$$("ThemeUtils.getThemeTargetPlatform", $oj$$.$ThemeUtils$.$getThemeTargetPlatform$, $oj$$);
  $oj$$.$ThemeUtils$.$clearCache$ = function $$oj$$$$ThemeUtils$$$clearCache$$() {
    this.$_cache$ = null;
  };
  $goog$exportPath_$$("ThemeUtils.clearCache", $oj$$.$ThemeUtils$.$clearCache$, $oj$$);
  $oj$$.$ThemeUtils$.$parseJSONFromFontFamily$ = function $$oj$$$$ThemeUtils$$$parseJSONFromFontFamily$$($selector$$14$$) {
    null == this.$_cache$ && (this.$_cache$ = {}, this.$_null_cache_value$ = {}, this.$_headfontstring$ = window.getComputedStyle(document.head).getPropertyValue("font-family"));
    var $jsonval$$ = this.$_cache$[$selector$$14$$];
    ...
    var $elem$$12$$ = document.createElement("meta");
    $elem$$12$$.className = $selector$$14$$;
    document.head.appendChild($elem$$12$$);
    var $fontstring_rawfontstring$$ = window.getComputedStyle($elem$$12$$).getPropertyValue("font-family");
    if (null != $fontstring_rawfontstring$$) {
      if ($fontstring_rawfontstring$$ == this.$_headfontstring$) {
        $oj$$.$Logger$.warn("parseJSONFromFontFamily: When the selector ", $selector$$14$$, " is applied the font-family read off the dom element is ", $fontstring_rawfontstring$$, ". The parent dom elment has the same font-family value.", " This is interpreted to mean that no value was sent down for selector ", $selector$$14$$, ". Null will be returned.");
      } else {
        if ($fontstring_rawfontstring$$ = $fontstring_rawfontstring$$.replace(/^['"]+|\s+|\\|(;\s?})+|['"]$/g, "")) {
          try {
            $jsonval$$ = JSON.parse($fontstring_rawfontstring$$);
          } catch ($e$$12$$) {
            throw $oj$$.$Logger$.error("Error parsing json for selector " + $selector$$14$$ + ".\nString being parsed is " + $fontstring_rawfontstring$$ + ". Error is:\n", $e$$12$$), document.head.removeChild($elem$$12$$), $e$$12$$;
          }
        }
      }
    }
    document.head.removeChild($elem$$12$$);
    this.$_cache$[$selector$$14$$] = null == $jsonval$$ ? this.$_null_cache_value$ : $jsonval$$;
    return $jsonval$$;
  };
  $goog$exportPath_$$("ThemeUtils.parseJSONFromFontFamily", $oj$$.$ThemeUtils$.$parseJSONFromFontFamily$, $oj$$);
  ...
  $oj$$.$ResponsiveUtils$.$_getMediaQueryFromClass$ = function $$oj$$$$ResponsiveUtils$$$_getMediaQueryFromClass$$($selector$$15$$) {
    var $elem$$13$$ = document.getElementsByClassName($selector$$15$$).item(0);
    null === $elem$$13$$ && ($elem$$13$$ = document.createElement("meta"), $elem$$13$$.className = $selector$$15$$, document.head.appendChild($elem$$13$$));
  ...
  $oj$$.$CollectionUtils$.$_copyIntoImpl$ = function $$oj$$$$CollectionUtils$$$_copyIntoImpl$$($target$$71$$, $source$$5$$, $keyConverter$$1$$, $recurse$$1$$, $maxRecursionDepth$$1$$, $currentLevel$$) {
    ...
    if (void 0 === $maxRecursionDepth$$1$$ || null === $maxRecursionDepth$$1$$) {
      $maxRecursionDepth$$1$$ = Number.MAX_VALUE;
    }
    if ($target$$71$$ && $source$$5$$ && $target$$71$$ !== $source$$5$$) {
      $keys$$ = Object.keys($source$$5$$);
      for (var $i$$16$$ = 0;$i$$16$$ < $keys$$.length;$i$$16$$++) {
        $k$$1_sourceVal$$ = $keys$$[$i$$16$$];
  ...
  $oj$$.$Translations$.$setBundle$ = function $$oj$$$$Translations$$$setBundle$$($bundle$$1$$) {
    $oj$$.$Translations$.$_bundle$ = $bundle$$1$$;
  };
  ...
  $oj$$.$Translations$.$getComponentTranslations$ = function $$oj$$$$Translations$$$getComponentTranslations$$($bundle$$2_componentName$$) {
    $bundle$$2_componentName$$ = $oj$$.$Translations$.$_getBundle$()[$bundle$$2_componentName$$];
    var $translations$$1$$, $k$$2$$;
    if (null == $bundle$$2_componentName$$) {
      return{};
    }
    $translations$$1$$ = {};
    for ($k$$2$$ in $bundle$$2_componentName$$) {
      $bundle$$2_componentName$$.hasOwnProperty($k$$2$$) && ($translations$$1$$[$k$$2$$] = $bundle$$2_componentName$$[$k$$2$$]);
    }
  ...
  $oj$$.$Translations$.$_getResourceString$ = function $$oj$$$$Translations$$$_getResourceString$$($key$$24_keys$$1$$) {
    ...
    var $bundle$$3$$ = $oj$$.$Translations$.$_getBundle$(), $iteration$$ = $key$$24_keys$$1$$.length, $index$$46$$ = 0, $subkey$$ = $key$$24_keys$$1$$[$index$$46$$];
    for ($oj$$.$Assert$.$assertObject$($bundle$$3$$);0 < --$iteration$$ && $bundle$$3$$;) {
      $bundle$$3$$ = $bundle$$3$$[$subkey$$], $index$$46$$++, $subkey$$ = $key$$24_keys$$1$$[$index$$46$$];
    }
    return $bundle$$3$$ ? $bundle$$3$$[$subkey$$] || null : null;
  };
  $oj$$.$Translations$.$_format$ = function $$oj$$$$Translations$$$_format$$($formatString$$1$$, $parameters$$1$$) {
    var $formatLength$$ = $formatString$$1$$.length, $buffer$$8$$ = [], $token$$4$$ = null, $escaped$$1$$ = !1, $isToken_val$$13$$ = !1, $isGroup$$ = !1, $isExcluded$$ = !1, $tokenTerminated$$, $i$$17$$;
    for ($i$$17$$ = 0;$i$$17$$ < $formatLength$$;$i$$17$$++) {
      var $ch$$ = $formatString$$1$$.charAt($i$$17$$), $accumulate$$ = !1;
      if ($escaped$$1$$) {
  ...
  (function() {
    function $CustomEvent$$1$$($event$$3$$, $params$$3$$) {
      $params$$3$$ = $params$$3$$ || {bubbles:!1, cancelable:!1, detail:void 0};
      var $evt$$16$$ = document.createEvent("CustomEvent");
      $evt$$16$$.initCustomEvent($event$$3$$, $params$$3$$.bubbles, $params$$3$$.cancelable, $params$$3$$.detail);
      return $evt$$16$$;
    }
