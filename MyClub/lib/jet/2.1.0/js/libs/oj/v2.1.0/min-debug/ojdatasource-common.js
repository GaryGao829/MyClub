...
define(["ojs/ojcore", "jquery"], function($oj$$9$$) {
  ...
  $oj$$9$$.$TableDataSource$ = function $$oj$$9$$$$TableDataSource$$($data$$56$$, $options$$222$$) {
  ...
  $oj$$9$$.$TableDataSource$.prototype.sortCriteria = null;
  $oj$$9$$.$Object$.$exportPrototypeSymbol$("TableDataSource.prototype.sortCriteria", {sortCriteria:$oj$$9$$.$TableDataSource$.prototype.sortCriteria});
