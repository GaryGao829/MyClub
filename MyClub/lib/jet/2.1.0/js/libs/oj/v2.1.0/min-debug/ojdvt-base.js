 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/internal-deps/dvt/DvtToolkit", "ojdnd", "promise"], function($oj$$15$$, $$$$15$$, $comp$$5$$, $val$$45$$, $dvt$$1$$) {
  ...
  $oj$$15$$.$AttributeGroupHandler$.prototype.$getCategoryAssignments$ = function $$oj$$15$$$$AttributeGroupHandler$$$$getCategoryAssignments$$() {
    var $assignments$$ = [], $i$$300$$;
    for ($i$$300$$ in this.$_assignments$) {
      $assignments$$.push({category:$i$$300$$, value:this.$_assignments$[$i$$300$$]});
    }
    return $assignments$$;
  };
  ...
  $DvtJsonPath$$.prototype.$setValue$ = function $$DvtJsonPath$$$$$setValue$$($value$$236$$, $bOverride$$) {
    this.$_resolvePath$(!0);
    if ($bOverride$$ || !this.$_leaf$[this.$_param$]) {
      this.$_leaf$[this.$_param$] = $value$$236$$;
    }
  };
  $oj$$15$$.$ColorAttributeGroupHandler$ = function $$oj$$15$$$$ColorAttributeGroupHandler$$($matchRules$$3$$) {
    ...
    if ($$$$15$$(document.body).hasClass("oj-hicontrast")) {
      ...
      if (!$oj$$15$$.$ColorAttributeGroupHandler$.$_colors$) {
        ...
        for (var $i$$301$$ = 0;$i$$301$$ < $oj$$15$$.$ColorAttributeGroupHandler$.$_STYLE_CLASSES$.length;$i$$301$$++) {
          var $childDiv_color$$2$$ = $$$$15$$(document.createElement("div"));
          $childDiv_color$$2$$.addClass($oj$$15$$.$ColorAttributeGroupHandler$.$_STYLE_CLASSES$[$i$$301$$]);
  ...
  var $DvtStyleProcessor$$ = {CSS_TEXT_PROPERTIES:function($cssDiv$$) {
    ...
    var $cssObj$$1$$ = {}, $value$$237$$ = $cssDiv$$6$$.css("font-family");
    $value$$237$$ && $value$$237$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_FAMILY$ && ($cssObj$$1$$["font-family"] = $value$$237$$.replace(/"/g, "'"));
    $value$$237$$ = $cssDiv$$6$$.css("font-size");
    !$value$$237$$ || -1 < $value$$237$$.indexOf("px") && parseFloat($value$$237$$) < $DvtStyleProcessor$$.$_FONT_SIZE_BUFFER$ || $ignoreProperties$$1$$["font-size"] || ($cssObj$$1$$["font-size"] = $value$$237$$);
    ($value$$237$$ = $cssDiv$$6$$.css("font-weight")) && $value$$237$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_WEIGHT$ && !$ignoreProperties$$1$$["font-weight"] && ($cssObj$$1$$["font-weight"] = $value$$237$$);
    ($value$$237$$ = $cssDiv$$6$$.css("color")) && $value$$237$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_COLOR$ && !$ignoreProperties$$1$$.color && ($cssObj$$1$$.color = $value$$237$$);
    ($value$$237$$ = $cssDiv$$6$$.css("font-style")) && $value$$237$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_STYLE$ && ($cssObj$$1$$["font-style"] = $value$$237$$);
    return $cssObj$$1$$;
  }, $processStyles$:function($definitions_element$$174_styleClasses$$, $options$$261$$, $componentClasses_innerDummyDiv$$, $childClasses$$) {
    var $outerDummyDiv$$ = $$$$15$$(document.createElement("div"));
    $outerDummyDiv$$.attr("style", "display:none;");
    $definitions_element$$174_styleClasses$$.append($outerDummyDiv$$);
    $definitions_element$$174_styleClasses$$ = "";
    for (var $i$$302$$ = 0;$i$$302$$ < $componentClasses_innerDummyDiv$$.length;$i$$302$$++) {
      $definitions_element$$174_styleClasses$$ = $definitions_element$$174_styleClasses$$ + $componentClasses_innerDummyDiv$$[$i$$302$$] + " ";
    }
    $outerDummyDiv$$.attr("class", $definitions_element$$174_styleClasses$$);
    ...
    for (var $styleClass$$7$$ in $childClasses$$) {
      $definitions_element$$174_styleClasses$$ = $childClasses$$[$styleClass$$7$$], $definitions_element$$174_styleClasses$$ instanceof Array || ($definitions_element$$174_styleClasses$$ = [$definitions_element$$174_styleClasses$$]), $DvtStyleProcessor$$.$_processStyle$($componentClasses_innerDummyDiv$$, $options$$261$$, $styleClass$$7$$, $definitions_element$$174_styleClasses$$);
    }
    $outerDummyDiv$$.remove();
  }, $_processStyle$:function($element$$175$$, $options$$262$$, $styleClass$$8$$, $definitions$$1$$) {
    $DvtStyleProcessor$$.$_styleCache$[$styleClass$$8$$] || ($DvtStyleProcessor$$.$_styleCache$[$styleClass$$8$$] = {});
    for (var $cssDiv$$7$$ = null, $i$$303$$ = 0;$i$$303$$ < $definitions$$1$$.length;$i$$303$$++) {
      var $definition_path$$10$$ = $definitions$$1$$[$i$$303$$], $property$$24_strValue$$1$$ = $definition_path$$10$$.property;
      if ($property$$24_strValue$$1$$) {
        var $value$$238$$ = $DvtStyleProcessor$$.$_styleCache$[$styleClass$$8$$][$property$$24_strValue$$1$$];
        "undefined" == typeof $value$$238$$ && ($cssDiv$$7$$ || ($cssDiv$$7$$ = $$$$15$$(document.createElement("div")), $cssDiv$$7$$.addClass($styleClass$$8$$), $element$$175$$.append($cssDiv$$7$$)), $value$$238$$ = $DvtStyleProcessor$$.$_resolveStyle$($cssDiv$$7$$, $property$$24_strValue$$1$$), $DvtStyleProcessor$$.$_styleCache$[$styleClass$$8$$][$property$$24_strValue$$1$$] = $value$$238$$);
        if (null != $value$$238$$) {
          var $definition_path$$10$$ = new $DvtJsonPath$$($options$$262$$, $definition_path$$10$$.path), $handler$$49$$ = $DvtStyleProcessor$$[$property$$24_strValue$$1$$];
          if (null != $handler$$49$$) {
            var $optionsValue$$ = $definition_path$$10$$.$getValue$();
            if ("CSS_URL" !== $property$$24_strValue$$1$$) {
              $property$$24_strValue$$1$$ = "";
              if (null != $optionsValue$$) {
                for (var $attr$$19$$ in $value$$238$$) {
                  -1 === $optionsValue$$.indexOf($attr$$19$$) && ($property$$24_strValue$$1$$ += $attr$$19$$ + ":" + $value$$238$$[$attr$$19$$] + ";");
                }
                $property$$24_strValue$$1$$ += $optionsValue$$;
              } else {
                for ($attr$$19$$ in $value$$238$$) {
                  $property$$24_strValue$$1$$ += $attr$$19$$ + ":" + $value$$238$$[$attr$$19$$] + ";";
                }
              }
              $value$$238$$ = $property$$24_strValue$$1$$;
            }
          }
          $definition_path$$10$$.$setValue$($value$$238$$, null != $handler$$49$$);
        }
      }
    }
  }, $_resolveStyle$:function($cssDiv$$8$$, $property$$25$$) {
    var $handler$$50_value$$239$$ = $DvtStyleProcessor$$[$property$$25$$], $handler$$50_value$$239$$ = $handler$$50_value$$239$$ ? $handler$$50_value$$239$$($cssDiv$$8$$) : $DvtStyleProcessor$$.$defaultStyleProcessor$($cssDiv$$8$$, $property$$25$$);
    return null == $handler$$50_value$$239$$ || "string" == typeof $handler$$50_value$$239$$ && "" == $handler$$50_value$$239$$.replace(/^\s+/g, "") ? null : $handler$$50_value$$239$$;
  }};
  $oj$$15$$.$__registerWidget$("oj.dvtBaseComponent", $$$$15$$.oj.baseComponent, {_ComponentCreate:function() {
    ...
    for (var $componentStyles_parentElement$$4$$ = this.$_GetComponentStyleClasses$(), $i$$304$$ = 0;$i$$304$$ < $componentStyles_parentElement$$4$$.length;$i$$304$$++) {
      this.element.addClass($componentStyles_parentElement$$4$$[$i$$304$$]);
    }
  ...
  }, getSubIdByNode:function($node$$63_subId$$22$$) {
    var $automation$$1$$ = this.$_component$ && this.$_component$.getAutomation ? this.$_component$.getAutomation() : null;
    if ($automation$$1$$) {
      return($node$$63_subId$$22$$ = $automation$$1$$.getSubIdForDomElement($node$$63_subId$$22$$)) ? this.$_ConvertSubIdToLocator$($node$$63_subId$$22$$) : null;
    }
    ...
    var $ret$$31_translations$$10$$ = this.options.translations, $ret$$31_translations$$10$$ = {"DvtUtilBundle.CLEAR_SELECTION":$ret$$31_translations$$10$$.labelClearSelection, "DvtUtilBundle.COLON_SEP_LIST":$ret$$31_translations$$10$$.labelAndValue, "DvtUtilBundle.INVALID_DATA":$ret$$31_translations$$10$$.labelInvalidData, "DvtUtilBundle.NO_DATA":$ret$$31_translations$$10$$.labelNoData, "DvtUtilBundle.DATA_VISUALIZATION":$ret$$31_translations$$10$$.labelDataVisualization, "DvtUtilBundle.STATE_SELECTED":$ret$$31_translations$$10$$.stateSelected, 
    "DvtUtilBundle.STATE_UNSELECTED":$ret$$31_translations$$10$$.stateUnselected, "DvtUtilBundle.STATE_MAXIMIZED":$ret$$31_translations$$10$$.stateMaximized, "DvtUtilBundle.STATE_MINIMIZED":$ret$$31_translations$$10$$.stateMinimized, "DvtUtilBundle.STATE_EXPANDED":$ret$$31_translations$$10$$.stateExpanded, "DvtUtilBundle.STATE_COLLAPSED":$ret$$31_translations$$10$$.stateCollapsed, "DvtUtilBundle.STATE_ISOLATED":$ret$$31_translations$$10$$.stateIsolated, "DvtUtilBundle.STATE_HIDDEN":$ret$$31_translations$$10$$.stateHidden, 
    "DvtUtilBundle.STATE_VISIBLE":$ret$$31_translations$$10$$.stateVisible, "DvtUtilBundle.SCALING_SUFFIX_THOUSAND":$ret$$31_translations$$10$$.labelScalingSuffixThousand, "DvtUtilBundle.SCALING_SUFFIX_MILLION":$ret$$31_translations$$10$$.labelScalingSuffixMillion, "DvtUtilBundle.SCALING_SUFFIX_BILLION":$ret$$31_translations$$10$$.labelScalingSuffixBillion, "DvtUtilBundle.SCALING_SUFFIX_TRILLION":$ret$$31_translations$$10$$.labelScalingSuffixTrillion, "DvtUtilBundle.SCALING_SUFFIX_QUADRILLION":$ret$$31_translations$$10$$.labelScalingSuffixQuadrillion}, 
    $monthNames$$2$$ = $oj$$15$$.$LocaleData$.$getMonthNames$("abbreviated");
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_JANUARY"] = $monthNames$$2$$[0];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_FEBRUARY"] = $monthNames$$2$$[1];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_MARCH"] = $monthNames$$2$$[2];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_APRIL"] = $monthNames$$2$$[3];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_MAY"] = $monthNames$$2$$[4];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_JUNE"] = $monthNames$$2$$[5];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_JULY"] = $monthNames$$2$$[6];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_AUGUST"] = $monthNames$$2$$[7];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_SEPTEMBER"] = $monthNames$$2$$[8];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_OCTOBER"] = $monthNames$$2$$[9];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_NOVEMBER"] = $monthNames$$2$$[10];
    $ret$$31_translations$$10$$["DvtUtilBundle.MONTH_SHORT_DECEMBER"] = $monthNames$$2$$[11];
    return $ret$$31_translations$$10$$;
    ...
    for (var $componentStyles$$1_parentElement$$5$$ = this.$_GetComponentStyleClasses$(), $i$$305$$ = 0;$i$$305$$ < $componentStyles$$1_parentElement$$5$$.length;$i$$305$$++) {
      this.element.removeClass($componentStyles$$1_parentElement$$5$$[$i$$305$$]);
    }
    this._super();
  }, _setOptions:function($options$$263$$, $flags$$23$$) {
    ...
    if (!this.$_bUserDrivenChange$) {
      ...
      $$$$15$$.each($options$$263$$, function($key$$91$$) {
        if (0 > $eventTypes$$.indexOf($key$$91$$) && 0 > $optimizedOptions$$.indexOf($key$$91$$)) {
          return $bRenderNeeded$$ = !0, !1;
        }
      });
      $bRenderNeeded$$ ? this.$_Render$() : (void 0 !== $options$$263$$.highlightedCategories && this.$_component$.highlight($options$$263$$.highlightedCategories), void 0 !== $options$$263$$.selection && this.$_component$.select($options$$263$$.selection), void 0 !== $options$$263$$.dataCursorPosition && this.$_component$.positionDataCursor && this.$_component$.positionDataCursor($options$$263$$.dataCursorPosition));
    }
  }, $_CreateDvtComponent$:function() {
    return null;
  }, $_HandleEvent$:function($event$$374$$) {
    var $type$$81$$ = $event$$374$$.type;
    "selection" === $type$$81$$ ? this.$_UserOptionChange$("selection", $event$$374$$.selection) : "categoryHide" === $type$$81$$ || "categoryShow" === $type$$81$$ ? this.$_UserOptionChange$("hiddenCategories", $event$$374$$.hiddenCategories) : "categoryHighlight" === $type$$81$$ ? this.$_UserOptionChange$("highlightedCategories", $event$$374$$.categories) : "optionChange" === $type$$81$$ ? this.$_UserOptionChange$($event$$374$$.key, $event$$374$$.value, $event$$374$$.optionMetadata) : "touchHoldRelease" === 
    $type$$81$$ && this.options.contextMenu ? this.$_OpenContextMenu$($$$$15$$.Event($event$$374$$.nativeEvent), "touch") : "ready" === $type$$81$$ && 0 === this.$_numDeferredObjs$ && (this.$_promiseResolve$ && this.$_promiseResolve$(!0), this.$_ready$ = !0, this.$_promise$ = this.$_promiseResolve$ = null);
    ...
    this._super();
    this.$_context$.hideTooltips();
  }, $_UserOptionChange$:function($key$$92$$, $value$$241$$, $optionMetadata$$1$$) {
    this.$_bUserDrivenChange$ = !0;
    this.option($key$$92$$, $value$$241$$, {_context:{$writeback$:!0, $optionMetadata$:$optionMetadata$$1$$, $internalSet$:!0}});
    this.$_bUserDrivenChange$ = !1;
  }, $_NotifyContextMenuGesture$:function($menu$$5$$, $event$$375$$, $eventType$$35$$) {
    "touch" !== $eventType$$35$$ && ("keyboard" === $eventType$$35$$ ? this.$_OpenContextMenu$($event$$375$$, $eventType$$35$$, {position:{of:this.$_component$.getKeyboardFocus()}}) : this._super($menu$$5$$, $event$$375$$, $eventType$$35$$));
  }, $_GetDvtComponent$:function($element$$176_widget$$4$$) {
    return($element$$176_widget$$4$$ = $oj$$15$$.Components.$getWidgetConstructor$($element$$176_widget$$4$$)("instance")) ? $element$$176_widget$$4$$.$_component$ : null;
  }, $_AddAutomationGetters$:function($map$$1$$) {
    if ($map$$1$$) {
      var $props$$13$$ = {}, $key$$93$$;
      for ($key$$93$$ in $map$$1$$) {
        this.$_addGetter$($map$$1$$, $key$$93$$, $props$$13$$);
      }
      Object.defineProperties($map$$1$$, $props$$13$$);
    }
  }, $_addGetter$:function($map$$2$$, $key$$94$$, $props$$14$$) {
    var $getterName$$ = ("selected" == $key$$94$$ ? "is" : "get") + $key$$94$$.charAt(0).toUpperCase() + $key$$94$$.slice(1);
    $props$$14$$[$getterName$$] = {value:function $$props$$14$$$$getterName$$$value$() {
      return $map$$2$$[$key$$94$$];
    }};
  }, $_GetStringFromIndexPath$:function($indexPath$$) {
    for (var $ret$$32$$ = "", $i$$306$$ = 0;$i$$306$$ < $indexPath$$.length;$i$$306$$++) {
      $ret$$32$$ += "[" + $indexPath$$[$i$$306$$] + "]";
    }
    return $ret$$32$$;
  }, $_GetIndexPath$:function($subId$$24$$) {
    for (var $indexPath$$1$$ = [], $currentIndex_end$$11$$ = 0;0 < $subId$$24$$.indexOf("[", $currentIndex_end$$11$$);) {
      var $start$$40$$ = $subId$$24$$.indexOf("[", $currentIndex_end$$11$$) + 1, $currentIndex_end$$11$$ = $subId$$24$$.indexOf("]", $currentIndex_end$$11$$);
      $indexPath$$1$$.push(Number($subId$$24$$.substring($start$$40$$, $currentIndex_end$$11$$)));
    ...
    var $start$$41$$ = $subId$$26$$.indexOf("[") + 1, $end$$12$$ = $subId$$26$$.indexOf("]");
    return $subId$$26$$.substring($start$$41$$, $end$$12$$);
    ...
    for ($path$$11$$ in $paths$$) {
      for (var $subpaths$$ = $paths$$[$path$$11$$], $i$$307$$ = 0;$i$$307$$ < $subpaths$$.length;$i$$307$$++) {
        if ("root" === $path$$11$$) {
          if (this.$_copyOptions$(this.options, $subpaths$$[$i$$307$$])) {
            break;
          }
        } else {
          var $suboptions$$ = this.options[$path$$11$$];
          if ($suboptions$$) {
            for (var $j$$48$$ = 0;$j$$48$$ < $suboptions$$.length && !this.$_copyOptions$($suboptions$$[$j$$48$$], $subpaths$$[$i$$307$$]);$j$$48$$++) {
            }
          }
        }
      }
    ...
    if (this.$_optionsCopy$) {
      ...
      for ($path$$11$$ in $paths$$) {
        $subpaths$$ = $paths$$[$path$$11$$], $subpaths$$.forEach(function($subpath$$) {
          var $promise$$;
          if ("root" === $path$$11$$) {
            ($promise$$ = $self$$130$$.$_getPromise$($self$$130$$.$_optionsCopy$, $subpath$$)) && $deferredData$$1$$.push($promise$$);
          } else {
            var $suboptions$$1$$ = $self$$130$$.$_optionsCopy$[$path$$11$$];
            if ($suboptions$$1$$) {
              for (var $j$$49$$ = 0;$j$$49$$ < $suboptions$$1$$.length;$j$$49$$++) {
                ($promise$$ = $self$$130$$.$_getPromise$($suboptions$$1$$[$j$$49$$], $subpath$$)) && $deferredData$$1$$.push($promise$$);
              }
            }
          }
        });
  ...
  }, $_copyOptions$:function($options$$264$$, $path$$12$$) {
    if (!this.$_optionsCopy$) {
      var $optionValue$$2$$ = (new $DvtJsonPath$$($options$$264$$, $path$$12$$)).$getValue$();
  ...
  }, $_getPromise$:function($options$$265$$, $path$$13$$) {
    var $optionPath$$ = new $DvtJsonPath$$($options$$265$$, $path$$13$$), $optionValue$$3$$ = $optionPath$$.$getValue$();
    $optionValue$$3$$ instanceof Function && ($optionValue$$3$$ = Promise.resolve($optionValue$$3$$(this.$_GetDataContext$($options$$265$$))));
    if ($optionValue$$3$$ && $optionValue$$3$$ instanceof Promise) {
      this.$_numDeferredObjs$++;
      var $renderCount$$ = this.$_renderCount$, $self$$131$$ = this;
      $optionValue$$3$$.then(function($value$$242$$) {
        $self$$131$$.$_renderDeferredData$($renderCount$$, $optionPath$$, $value$$242$$);
      }, function() {
        $self$$131$$.$_renderDeferredData$($renderCount$$, $optionPath$$, []);
      });
      return $optionValue$$3$$;
    }
    return null;
  }, $_renderDeferredData$:function($renderCount$$1$$, $optionPath$$1$$, $value$$243$$) {
    $renderCount$$1$$ === this.$_renderCount$ && (this.$_numDeferredObjs$--, $optionPath$$1$$.$setValue$($value$$243$$, !0), 0 === this.$_numDeferredObjs$ && (this.$_renderComponent$(this.$_optionsCopy$), this.$_optionsCopy$ = null));
  }, $_renderComponent$:function($options$$266$$) {
    ...
    this.$_component$.render($options$$266$$, this.$_width$, this.$_height$);
    ...
    if (!this.$_promise$) {
      var $self$$132$$ = this;
      this.$_promise$ = new Promise(function($resolve$$29$$) {
        $self$$132$$.$_promiseResolve$ = $resolve$$29$$;
      });
    }
