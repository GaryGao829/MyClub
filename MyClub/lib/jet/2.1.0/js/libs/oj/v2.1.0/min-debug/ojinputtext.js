...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$5$$, $$$$5$$) {
  ...
  _INPUT_HELPER_KEY:"", $_BLUR_HANDLER_KEY$:"blur", $_KEYDOWN_HANDLER_KEY$:"keydown", $_INPUT_HANDLER_KEY$:"input", $_DROP_HANDLER_KEY$:"drop", options:{converter:void 0, placeholder:void 0, rawValue:void 0, readOnly:!1}, $_SaveAttributes$:function($element$$44$$) {
    ...
    var $ret$$5$$ = this._superApply(arguments), $self$$52$$ = this;
    this._CLASS_NAMES && this.element.addClass(this._CLASS_NAMES);
    this.$_attachDetachEventHandlers$();
    this.$_AppendInputHelper$();
    $$$$5$$.each(["disabled", "readOnly"], function($index$$90$$, $ele$$1$$) {
      $self$$52$$.options[$ele$$1$$] && $self$$52$$.$_processDisabledReadOnly$($ele$$1$$, $self$$52$$.options[$ele$$1$$]);
    });
    return $ret$$5$$;
  }, $_processDisabledReadOnly$:function __processDisabledReadOnly($key$$39$$, $value$$99$$) {
    "disabled" === $key$$39$$ && this.element.prop("disabled", $value$$99$$);
    "readOnly" === $key$$39$$ && (this.element.prop("readonly", $value$$99$$), this.$_refreshStateTheming$("readOnly", $value$$99$$));
    "disabled" !== $key$$39$$ && "readOnly" !== $key$$39$$ || this.$_attachDetachEventHandlers$();
  }, _setOption:function __setOption($key$$40$$, $value$$100$$) {
    var $retVal$$6$$ = this._superApply(arguments);
    "disabled" !== $key$$40$$ && "readOnly" !== $key$$40$$ || this.$_processDisabledReadOnly$($key$$40$$, $value$$100$$);
    "pattern" === $key$$40$$ && (this.$_defaultRegExpValidator$[$oj$$5$$.$ValidatorFactory$.VALIDATOR_TYPE_REGEXP] = this.$_getImplicitRegExpValidator$(), this.$_AfterSetOptionValidators$());
    return $retVal$$6$$;
    ...
    if (!this.options.readOnly && !this.options.disabled) {
      this.$_eventHandlers$ = {};
      var $blurHandler_eventEntries$$ = $$$$5$$.proxy(this.$_onBlurHandler$, this), $i$$112_keyDownHandler$$ = $$$$5$$.proxy(this.$_onKeyDownHandler$, this), $inputHandler_j$$10$$ = $$$$5$$.proxy(this.$_onInputHandler$, this), $dropHandler$$ = function $$dropHandler$$$() {
        this.focus();
      };
      this.element.on("blur", $blurHandler_eventEntries$$);
      this.element.on("keydown", $i$$112_keyDownHandler$$);
      ...
      this.$_eventHandlers$[this.$_KEYDOWN_HANDLER_KEY$] = $i$$112_keyDownHandler$$;
      this.$_eventHandlers$[this.$_INPUT_HANDLER_KEY$] = $inputHandler_j$$10$$;
      this.$_eventHandlers$[this.$_DROP_HANDLER_KEY$] = $dropHandler$$;
    } else {
      if (this.$_eventHandlers$) {
        for ($blurHandler_eventEntries$$ = [this.$_BLUR_HANDLER_KEY$, this.$_KEYDOWN_HANDLER_KEY$, this.$_INPUT_HANDLER_KEY$, this.$_DROP_HANDLER_KEY$], $i$$112_keyDownHandler$$ = 0, $inputHandler_j$$10$$ = $blurHandler_eventEntries$$.length;$i$$112_keyDownHandler$$ < $inputHandler_j$$10$$;$i$$112_keyDownHandler$$++) {
          this.$_eventHandlers$[$blurHandler_eventEntries$$[$i$$112_keyDownHandler$$]] && (this.element.off($blurHandler_eventEntries$$[$i$$112_keyDownHandler$$], this.$_eventHandlers$[$blurHandler_eventEntries$$[$i$$112_keyDownHandler$$]]), delete this.$_eventHandlers$[$blurHandler_eventEntries$$[$i$$112_keyDownHandler$$]]);
        }
      }
    }
  }, $_OPTION_TO_CSS_MAPPING$:{readOnly:"oj-read-only"}, $_processAttrCheck$:function __processAttrCheck() {
    for (var $attrCheck$$ = this._ATTR_CHECK, $i$$113$$ = 0, $j$$11$$ = $attrCheck$$.length;$i$$113$$ < $j$$11$$;$i$$113$$++) {
      var $attr$$12$$ = $attrCheck$$[$i$$113$$].attr;
      "setMandatory" in $attrCheck$$[$i$$113$$] && this.element.attr($attr$$12$$, $attrCheck$$[$i$$113$$].setMandatory);
    }
  }, $_onBlurHandler$:function __onBlurHandler($event$$64$$) {
    this.$_SetValue$(this.$_GetDisplayValue$(), $event$$64$$);
  }, $_onKeyDownHandler$:function __onKeyDownHandler($event$$65$$) {
    $event$$65$$.keyCode === $$$$5$$.ui.keyCode.ENTER && this.$_SetValue$(this.$_GetDisplayValue$(), $event$$65$$);
  }, $_onInputHandler$:function __onInputHandler($event$$66$$) {
    this.$_SetRawValue$(this.$_GetContentElement$().val(), $event$$66$$);
  ...
  }, $_refreshStateTheming$:function($option$$13$$, $value$$101$$) {
    -1 != Object.keys(this.$_OPTION_TO_CSS_MAPPING$).indexOf($option$$13$$) && this.widget().toggleClass(this.$_OPTION_TO_CSS_MAPPING$[$option$$13$$], !!$value$$101$$);
