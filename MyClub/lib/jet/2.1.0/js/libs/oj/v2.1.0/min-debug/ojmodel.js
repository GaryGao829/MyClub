...
define(["ojs/ojcore", "jquery", "promise"], function($oj$$1$$, $$$$1$$) {
  $oj$$1$$.$Events$ = window.oj.Events = {on:function $window$oj$Events$on$($eventType$$11$$, $callback$$57$$, $context$$5$$) {
    ...
    var $actualType_eventArray$$2$$, $eventMap$$2$$ = {}, $e$$16$$, $oneEvent$$, $oneAttr$$, $attrEqual_event$$6$$, $cb_objEqual$$, $eventEqual_len$$, $callbackEqual$$, $i$$18$$, $prop$$11$$;
    if (null == arguments || 1 >= arguments.length) {
      $eventEqual_len$$ = this._listeningTo ? this._listeningTo.length : 0;
      for ($i$$18$$ = 0;$i$$18$$ < $eventEqual_len$$;$i$$18$$++) {
        if ($attrEqual_event$$6$$ = this._listeningTo[$i$$18$$], $cb_objEqual$$ = $otherObj$$2$$ ? $otherObj$$2$$ === $attrEqual_event$$6$$.object : !0) {
    ...
    for ($prop$$11$$ in $eventMap$$2$$) {
      if ($eventMap$$2$$.hasOwnProperty($prop$$11$$)) {
        for ($actualType_eventArray$$2$$ = $oj$$1$$.$Events$.$_getEvents$($prop$$11$$), $e$$16$$ = 0;$e$$16$$ < $actualType_eventArray$$2$$.length;$e$$16$$ += 1) {
          for ($oneEvent$$ = $actualType_eventArray$$2$$[$e$$16$$].event, $oneAttr$$ = $actualType_eventArray$$2$$[$e$$16$$].$attribute$, $eventEqual_len$$ = this._listeningTo ? this._listeningTo.length : 0, $i$$18$$ = $eventEqual_len$$ - 1;0 <= $i$$18$$;$i$$18$$ -= 1) {
            $attrEqual_event$$6$$ = this._listeningTo[$i$$18$$], $cb_objEqual$$ = $otherObj$$2$$ ? $otherObj$$2$$ === $attrEqual_event$$6$$.object : !0, $eventEqual_len$$ = $oneEvent$$ ? $oneEvent$$ === $attrEqual_event$$6$$.event : !0, $callbackEqual$$ = $callback$$62$$ ? $eventMap$$2$$[$prop$$11$$] === $attrEqual_event$$6$$.$callback$ : !0, $attrEqual_event$$6$$ = $oneAttr$$ ? $oneAttr$$ === $attrEqual_event$$6$$.$attribute$ : !0, $cb_objEqual$$ && $eventEqual_len$$ && $callbackEqual$$ && $attrEqual_event$$6$$ && 
            ($cb_objEqual$$ = this._listeningTo[$i$$18$$].object.$_offInternal$, $cb_objEqual$$.apply(this._listeningTo[$i$$18$$].object, [this._listeningTo[$i$$18$$].event, this._listeningTo[$i$$18$$].$callback$, this._listeningTo[$i$$18$$].context, !0]), this._listeningTo.splice($i$$18$$, 1));
          }
        }
      }
    }
  ...
  $oj$$1$$.$Events$.$TriggerInternal$ = function $$oj$$1$$$$Events$$$TriggerInternal$$($silent$$, $eventType$$19$$) {
    var $eventArray$$4_handlers$$1$$ = this.$_getEvents$($eventType$$19$$), $e$$18$$, $event$$8_i$$19$$, $args$$13_attr$$3$$, $eventsToFire$$, $allHandlers$$, $callback$$64$$;
    $eventsToFire$$ = [];
    for ($e$$18$$ = 0;$e$$18$$ < $eventArray$$4_handlers$$1$$.length;$e$$18$$ += 1) {
      $event$$8_i$$19$$ = $eventArray$$4_handlers$$1$$[$e$$18$$].event, $args$$13_attr$$3$$ = $eventArray$$4_handlers$$1$$[$e$$18$$].$attribute$, $eventsToFire$$.push({event:$event$$8_i$$19$$, $attribute$:$args$$13_attr$$3$$});
    }
    for ($e$$18$$ = 0;$e$$18$$ < $eventsToFire$$.length;$e$$18$$ += 1) {
      ...
      for ($event$$8_i$$19$$ = 0;$event$$8_i$$19$$ < ($eventArray$$4_handlers$$1$$ ? $eventArray$$4_handlers$$1$$.length : 0);$event$$8_i$$19$$ += 1) {
        $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$attribute$ === $eventsToFire$$[$e$$18$$].$attribute$ && $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$callback$ && ($args$$13_attr$$3$$ = Array.prototype.slice.call(arguments), $eventArray$$4_handlers$$1$$ && $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$] && $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$once$ && (this.$_removeHandler$($oj$$1$$.$Events$.$_getHandlers$(this.$eventHandlers$, $eventsToFire$$[$e$$18$$].event, !0), $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$]), 
        $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$otherObj$ && $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$otherObj$.stopListening(this, $eventType$$19$$, $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$callback$)), $eventArray$$4_handlers$$1$$ && $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$] && this.$_shouldFire$($eventArray$$4_handlers$$1$$[$event$$8_i$$19$$]) && ($callback$$64$$ = $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$callback$, $silent$$ && !$eventArray$$4_handlers$$1$$[$event$$8_i$$19$$].$ignoreSilent$ || 
        $callback$$64$$.apply($oj$$1$$.$Events$.$_getContext$(this, $eventArray$$4_handlers$$1$$[$event$$8_i$$19$$]), $args$$13_attr$$3$$.slice(2))));
      }
      for ($event$$8_i$$19$$ = 0;$event$$8_i$$19$$ < ($allHandlers$$ ? $allHandlers$$.length : 0);$event$$8_i$$19$$ += 1) {
        $args$$13_attr$$3$$ = Array.prototype.slice.call(arguments), 0 < $args$$13_attr$$3$$.length && ($args$$13_attr$$3$$[1] = $eventsToFire$$[$e$$18$$].$attribute$ ? $eventsToFire$$[$e$$18$$].event + ":" + $eventsToFire$$[$e$$18$$].$attribute$ : $eventsToFire$$[$e$$18$$].event), $allHandlers$$ && $allHandlers$$[$event$$8_i$$19$$] && $allHandlers$$[$event$$8_i$$19$$].$callback$ && this.$_shouldFire$($allHandlers$$[$event$$8_i$$19$$]) && ($callback$$64$$ = $allHandlers$$[$event$$8_i$$19$$].$callback$, 
        $silent$$ && !$allHandlers$$[$event$$8_i$$19$$].$ignoreSilent$ || $callback$$64$$.apply($oj$$1$$.$Events$.$_getContext$(this, $allHandlers$$[$event$$8_i$$19$$]), $args$$13_attr$$3$$.slice(1))), $allHandlers$$ && $allHandlers$$[$event$$8_i$$19$$] && $allHandlers$$[$event$$8_i$$19$$].$once$ && (this.$_removeHandler$(this.$_getHandlers$(this.$eventHandlers$, $oj$$1$$.$Events$.$EventType$.ALL, !0), $allHandlers$$[$event$$8_i$$19$$]), $allHandlers$$[$event$$8_i$$19$$].$otherObj$ && $allHandlers$$[$event$$8_i$$19$$].$otherObj$.stopListening(this, 
        $oj$$1$$.$Events$.$EventType$.ALL, $allHandlers$$[$event$$8_i$$19$$].$callback$));
      }
    }
    return this;
  };
  $oj$$1$$.$Events$.$OnInternal$ = function $$oj$$1$$$$Events$$$OnInternal$$($eventMap$$4_eventType$$20$$, $callback$$65_eventArray$$5$$, $context$$9$$, $listenTo$$1$$, $ignoreSilent$$) {
    var $prop$$13$$, $i$$20$$, $event$$9$$, $attr$$4_eventObj$$;
    ...
    for ($prop$$13$$ in $eventMap$$4_eventType$$20$$) {
      if ($eventMap$$4_eventType$$20$$.hasOwnProperty($prop$$13$$)) {
        for ($callback$$65_eventArray$$5$$ = this.$_getEvents$($prop$$13$$), $i$$20$$ = 0;$i$$20$$ < $callback$$65_eventArray$$5$$.length;$i$$20$$ += 1) {
          $event$$9$$ = $callback$$65_eventArray$$5$$[$i$$20$$].event, $attr$$4_eventObj$$ = $callback$$65_eventArray$$5$$[$i$$20$$].$attribute$, void 0 === this.$eventHandlers$ && (this.$eventHandlers$ = []), void 0 === this.$eventHandlers$[$event$$9$$] && (this.$eventHandlers$[$event$$9$$] = []), $attr$$4_eventObj$$ = {$callback$:$eventMap$$4_eventType$$20$$[$prop$$13$$], context:$context$$9$$, $attribute$:$attr$$4_eventObj$$, $listen$:$listenTo$$1$$, $ignoreSilent$:$ignoreSilent$$}, -1 === this.$_checkForHandler$(this.$eventHandlers$[$event$$9$$], 
  ...
  $oj$$1$$.$Events$.$_removeEvent$ = function $$oj$$1$$$$Events$$$_removeEvent$$($e$$19_eventType$$23$$, $callback$$68$$, $context$$12$$, $listen$$1$$) {
    var $eventArray$$6$$ = [], $i$$21$$, $event$$10$$, $attr$$5$$, $handlers$$2$$, $callbacks$$2$$, $contexts$$, $attrs$$, $listenEq$$;
    ...
    for ($e$$19_eventType$$23$$ = 0;$e$$19_eventType$$23$$ < $eventArray$$6$$.length;$e$$19_eventType$$23$$ += 1) {
      if ($event$$10$$ = $eventArray$$6$$[$e$$19_eventType$$23$$].event, $attr$$5$$ = $eventArray$$6$$[$e$$19_eventType$$23$$].$attribute$, void 0 !== this.$eventHandlers$ && this.$eventHandlers$[$event$$10$$] instanceof Array) {
        ...
        for ($i$$21$$ = $handlers$$2$$.length - 1;0 <= $i$$21$$;$i$$21$$ -= 1) {
          $callbacks$$2$$ = void 0 === $callback$$68$$ || null === $callback$$68$$ || $handlers$$2$$[$i$$21$$].$callback$ == $callback$$68$$, $contexts$$ = void 0 === $context$$12$$ || null === $context$$12$$ || $handlers$$2$$[$i$$21$$].context == $context$$12$$, $attrs$$ = void 0 === $attr$$5$$ || null === $attr$$5$$ || $handlers$$2$$[$i$$21$$].$attribute$ == $attr$$5$$, $listenEq$$ = void 0 === $listen$$1$$ || null === $listen$$1$$ || $handlers$$2$$[$i$$21$$].$listen$ == $listen$$1$$, $callbacks$$2$$ && 
          $contexts$$ && $attrs$$ && $listenEq$$ && $handlers$$2$$.splice($i$$21$$, 1);
        }
  ...
  $oj$$1$$.$Events$.$_removeHandler$ = function $$oj$$1$$$$Events$$$_removeHandler$$($handlers$$3$$, $handler$$44$$) {
    var $i$$22$$, $callbacks$$3$$, $contexts$$1$$, $attrs$$1$$, $listenEq$$1$$, $onceEq$$;
    if ($handlers$$3$$) {
      for ($i$$22$$ = $handlers$$3$$.length - 1;0 <= $i$$22$$;$i$$22$$ -= 1) {
        $callbacks$$3$$ = void 0 === $handler$$44$$.$callback$ || null === $handler$$44$$.$callback$ || $handlers$$3$$[$i$$22$$].$callback$ == $handler$$44$$.$callback$, $contexts$$1$$ = void 0 === $handler$$44$$.context || null === $handler$$44$$.context || $handlers$$3$$[$i$$22$$].context == $handler$$44$$.context, $attrs$$1$$ = void 0 === $handler$$44$$.$attribute$ || null === $handler$$44$$.$attribute$ || $handlers$$3$$[$i$$22$$].$attribute$ == $handler$$44$$.$attribute$, $listenEq$$1$$ = void 0 === 
        $handler$$44$$.$listen$ || null === $handler$$44$$.$listen$ || $handlers$$3$$[$i$$22$$].$listen$ == $handler$$44$$.$listen$, $onceEq$$ = void 0 === $handler$$44$$.$once$ || null === $handler$$44$$.$once$ || $handlers$$3$$[$i$$22$$].$once$ == $handler$$44$$.$once$, $callbacks$$3$$ && $contexts$$1$$ && $attrs$$1$$ && $listenEq$$1$$ && $onceEq$$ && $handlers$$3$$.splice($i$$22$$, 1);
      }
    }
  };
  $oj$$1$$.$Events$.$_getEvents$ = function $$oj$$1$$$$Events$$$_getEvents$$($eventList_eventString$$2$$) {
    ...
    var $retList$$ = [], $i$$23$$, $attr$$6_eventWithAttr$$, $name$$64$$;
    for ($i$$23$$ = 0;$i$$23$$ < $eventList_eventString$$2$$.length;$i$$23$$ += 1) {
      $attr$$6_eventWithAttr$$ = $eventList_eventString$$2$$[$i$$23$$].split(":"), $name$$64$$ = $attr$$6_eventWithAttr$$[0], $attr$$6_eventWithAttr$$ = 1 < $attr$$6_eventWithAttr$$.length ? $attr$$6_eventWithAttr$$[1] : null, $retList$$.push({event:$name$$64$$, $attribute$:$attr$$6_eventWithAttr$$});
    }
    return $retList$$;
  };
  ...
  $oj$$1$$.$Events$.$_checkForHandler$ = function $$oj$$1$$$$Events$$$_checkForHandler$$($handlerList$$, $handler$$45$$, $handlerTest$$) {
    ...
    for ($i$$24$$ = 0;$i$$24$$ < $handlerList$$.length;$i$$24$$ += 1) {
      if ($handlerTest$$($handlerList$$[$i$$24$$], $handler$$45$$)) {
        return $i$$24$$;
      }
    }
    return-1;
  ...
  $oj$$1$$.$Events$.$_getHandlers$ = function $$oj$$1$$$$Events$$$_getHandlers$$($handlers$$4$$, $eventType$$24$$, $handlerReturn_original$$1$$) {
    if ($handlers$$4$$ && $handlers$$4$$[$eventType$$24$$] instanceof Array) {
      ...
      var $i$$25$$;
      for ($i$$25$$ = 0;$i$$25$$ < $handlers$$4$$[$eventType$$24$$].length;$i$$25$$++) {
        $handlerReturn_original$$1$$.push($handlers$$4$$[$eventType$$24$$][$i$$25$$]);
      }
  ...
  $oj$$1$$.$Model$.$_processArgs$ = function $$oj$$1$$$$Model$$$_processArgs$$($args$$14$$) {
    var $ignoreLastArg$$ = !1, $options$$31$$ = {}, $i$$28_prop$$31$$, $attributes$$4$$ = {};
    if ($args$$14$$ && 0 < $args$$14$$.length) {
      ...
      if ($oj$$1$$.$Model$.$_hasProperties$($args$$14$$[0]) || $oj$$1$$.$Object$.$isEmpty$($args$$14$$[0])) {
        for ($i$$28_prop$$31$$ in $args$$14$$[0]) {
          $args$$14$$[0].hasOwnProperty($i$$28_prop$$31$$) && ($attributes$$4$$[$i$$28_prop$$31$$] = $args$$14$$[0][$i$$28_prop$$31$$]);
        }
      } else {
        for ($i$$28_prop$$31$$ = 0;$i$$28_prop$$31$$ < $args$$14$$.length;$i$$28_prop$$31$$ += 2) {
          if (void 0 !== $args$$14$$[$i$$28_prop$$31$$] || $i$$28_prop$$31$$ < $args$$14$$.length - 1 || !$ignoreLastArg$$ && $i$$28_prop$$31$$ === $args$$14$$.length - 1) {
            $attributes$$4$$[$args$$14$$[$i$$28_prop$$31$$]] = $args$$14$$[$i$$28_prop$$31$$ + 1];
          }
        }
      }
    }
  ...
  $oj$$1$$.$Model$.prototype.$_hasAttrs$ = function $$oj$$1$$$$Model$$$$_hasAttrs$$($attrs$$7$$) {
    for (var $prop$$36$$ in $attrs$$7$$) {
      if ($attrs$$7$$.hasOwnProperty($prop$$36$$)) {
        ...
        for (var $val$$16$$ = Array.isArray($attrs$$7$$[$prop$$36$$]) ? $attrs$$7$$[$prop$$36$$] : [$attrs$$7$$[$prop$$36$$]], $i$$29$$ = 0;$i$$29$$ < $val$$16$$.length;$i$$29$$++) {
  ...
  $oj$$1$$.$Model$.prototype.matches = function $$oj$$1$$$$Model$$$matches$($JSCompiler_inline_result$$0_attrs$$8$$) {
    a: {
      for (var $prop$$inline_381$$ in $JSCompiler_inline_result$$0_attrs$$8$$) {
        if (this.get($prop$$inline_381$$) !== $JSCompiler_inline_result$$0_attrs$$8$$[$prop$$inline_381$$]) {
          $JSCompiler_inline_result$$0_attrs$$8$$ = !1;
          break a;
        }
      }
      $JSCompiler_inline_result$$0_attrs$$8$$ = !0;
    }
    return $JSCompiler_inline_result$$0_attrs$$8$$;
  };
  ...
  $oj$$1$$.$RestImpl$.prototype.$getRecords$ = function $$oj$$1$$$$RestImpl$$$$getRecords$$($ajaxOptions$$1_callback$$71$$, $errFunc$$, $options$$45$$, $context$$15$$) {
    ...
    $options$$45$$.xhr = this.ajax($ajaxOptions$$1_callback$$71$$, $context$$15$$);
  ...
  $oj$$1$$.$RestImpl$.prototype.$getRecord$ = function $$oj$$1$$$$RestImpl$$$$getRecord$$($ajaxOptions$$2_success$$11$$, $error$$4$$, $recordID$$1_urlInfo$$1$$, $options$$47$$, $context$$16$$) {
    ...
    $options$$47$$.xhr = this.ajax($ajaxOptions$$2_success$$11$$, $context$$16$$);
  ...
  $oj$$1$$.$RestImpl$.prototype.$updateRecord$ = function $$oj$$1$$$$RestImpl$$$$updateRecord$$($ajaxOptions$$3_callback$$72$$, $recordID$$2_urlInfo$$2$$, $record$$1$$, $error$$5$$, $options$$48$$, $context$$17$$, $emulateHTTP_patch$$1$$) {
    ...
    $options$$48$$.xhr = this.ajax($ajaxOptions$$3_callback$$72$$, $context$$17$$);
  ...
  $oj$$1$$.$RestImpl$.prototype.$deleteRecord$ = function $$oj$$1$$$$RestImpl$$$$deleteRecord$$($recordID$$4_urlInfo$$4$$, $ajaxOptions$$4_error$$6$$, $options$$55$$, $context$$19$$) {
    $options$$55$$ = $options$$55$$ || {};
    var $data$$35_isJsonp$$3$$ = "jsonp" === $options$$55$$.dataType;
    $recordID$$4_urlInfo$$4$$ = this.$_getURL$("delete", this.$rootURL$, this.$customURL$, $recordID$$4_urlInfo$$4$$, $context$$19$$, $options$$55$$);
    var $emulateHTTP$$2$$ = $oj$$1$$.$RestImpl$.$_emulateHTTP$($options$$55$$);
    $ajaxOptions$$4_error$$6$$ = {crossDomain:$options$$55$$.crossDomain || !$data$$35_isJsonp$$3$$, success:$options$$55$$.success, error:$ajaxOptions$$4_error$$6$$, context:null !== $context$$19$$ ? $context$$19$$ : this, emulateHTTP:$emulateHTTP$$2$$, emulateJSON:$oj$$1$$.$RestImpl$.$_emulateJSON$($options$$55$$)};
    ($data$$35_isJsonp$$3$$ = this.$_getData$(null, $options$$55$$, $recordID$$4_urlInfo$$4$$)) && ($ajaxOptions$$4_error$$6$$.data = $data$$35_isJsonp$$3$$);
    ...
    $options$$55$$.xhr = this.ajax($ajaxOptions$$4_error$$6$$, $context$$19$$);
  ...
  $oj$$1$$.$RestImpl$.prototype.$addRecord$ = function $$oj$$1$$$$RestImpl$$$$addRecord$$($record$$2_urlInfo$$5$$, $ajaxOptions$$5_error$$7$$, $options$$56$$, $context$$20$$) {
    ...
    $options$$56$$.xhr = this.ajax($ajaxOptions$$5_error$$7$$, $context$$20$$);
  ...
  $oj$$1$$.$RestImpl$.prototype.ajax = function $$oj$$1$$$$RestImpl$$$ajax$($settings$$3$$, $collection$$3$$) {
    if (null === $settings$$3$$.url || void 0 === $settings$$3$$.url) {
      throw new $oj$$1$$.$URLError$;
    }
    var $xhr$$10$$ = window.oj.ajax($settings$$3$$);
    $collection$$3$$.$_addxhr$ && $collection$$3$$.$_addxhr$($xhr$$10$$);
    return $xhr$$10$$;
  };
  ...
  $oj$$1$$.$Collection$._init = function $$oj$$1$$$$Collection$$_init$($collection$$4$$, $models$$2$$, $options$$61$$, $properties$$6$$) {
    var $i$$32_prop$$44$$, $modelList_optionlist$$;
    $collection$$4$$.Init();
    $oj$$1$$.$Events$.$Mixin$($collection$$4$$);
    if ($properties$$6$$) {
      for ($i$$32_prop$$44$$ in $properties$$6$$) {
        $properties$$6$$.hasOwnProperty($i$$32_prop$$44$$) && ($collection$$4$$[$i$$32_prop$$44$$] = $properties$$6$$[$i$$32_prop$$44$$]);
      }
    }
    ...
    for ($i$$32_prop$$44$$ = 0;$i$$32_prop$$44$$ < $modelList_optionlist$$.length;$i$$32_prop$$44$$++) {
      $options$$61$$.hasOwnProperty($modelList_optionlist$$[$i$$32_prop$$44$$]) && void 0 !== $options$$61$$[$modelList_optionlist$$[$i$$32_prop$$44$$]] && ($collection$$4$$[$modelList_optionlist$$[$i$$32_prop$$44$$]] = $options$$61$$[$modelList_optionlist$$[$i$$32_prop$$44$$]]);
    }
    void 0 === $collection$$4$$.$_getFetchSize$(null) && $collection$$4$$.$setFetchSize$(-1);
    void 0 === $collection$$4$$.modelLimit && $collection$$4$$.$setModelLimit$(-1);
    $collection$$4$$.hasMore = !1;
    $collection$$4$$.$lruCount$ = 0;
    $collection$$4$$.$_setModels$([], !0);
    $options$$61$$.parse && ($models$$2$$ = $collection$$4$$.parse($models$$2$$));
    if (null != $models$$2$$) {
      for ($options$$61$$.$noparse$ = !0, $modelList_optionlist$$ = $models$$2$$ instanceof Array ? $models$$2$$ : [$models$$2$$], $i$$32_prop$$44$$ = 0;$i$$32_prop$$44$$ < $modelList_optionlist$$.length;$i$$32_prop$$44$$ += 1) {
        $collection$$4$$.add($modelList_optionlist$$[$i$$32_prop$$44$$], $options$$61$$);
      }
    }
    $collection$$4$$.$_setLength$();
    $models$$2$$ || ($collection$$4$$.totalResults = void 0);
    $properties$$6$$ && $properties$$6$$.initialize && $properties$$6$$.initialize.call($collection$$4$$, $models$$2$$, $options$$61$$);
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_fireRequest$ = function $$oj$$1$$$$Collection$$$$_fireRequest$$($collection$$5$$, $xhr$$11$$, $options$$63$$, $silent$$13$$) {
    this.$TriggerInternal$($silent$$13$$, $oj$$1$$.$Events$.$EventType$.REQUEST, $collection$$5$$, $xhr$$11$$, $options$$63$$);
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_setChangeAt$ = function $$oj$$1$$$$Collection$$$$_setChangeAt$$($start$$6$$, $count$$8$$) {
    for (var $at$$ = $start$$6$$;$at$$ < $start$$6$$ + $count$$8$$;$at$$++) {
      -1 === this.changes.indexOf($at$$) && (this.changes.push($at$$), this.changes.sort(function($a$$91$$, $b$$45$$) {
        return $a$$91$$ - $b$$45$$;
      }));
    }
  };
  $oj$$1$$.$Collection$.prototype.$_setModels$ = function $$oj$$1$$$$Collection$$$$_setModels$$($models$$3$$, $clearing$$) {
    ...
    if ($clearing$$) {
      ...
      for (var $i$$33$$ = 0;$i$$33$$ < $models$$3$$.length;$i$$33$$++) {
        $models$$3$$[$i$$33$$] && this.$_modelIndices$.push($i$$33$$);
      }
    }
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_reduceLRU$ = function $$oj$$1$$$$Collection$$$$_reduceLRU$$($removed$$) {
    if ($removed$$) {
      for (var $i$$34$$ = 0;$i$$34$$ < $removed$$.length;$i$$34$$++) {
        $removed$$[$i$$34$$] && this.$lruCount$--;
      }
    }
  };
  $oj$$1$$.$Collection$.prototype.$_spliceModels$ = function $$oj$$1$$$$Collection$$$$_spliceModels$$($start$$7$$, $count$$9$$, $model$$15$$) {
    for (var $i$$35$$ = $start$$7$$;$i$$35$$ < $start$$7$$ + $count$$9$$;$i$$35$$++) {
      this.$_removePrevNext$(this.$_getModel$($i$$35$$));
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_realignModelIndices$ = function $$oj$$1$$$$Collection$$$$_realignModelIndices$$($start$$8$$) {
    for (var $index$$52$$, $i$$36$$ = 0;$i$$36$$ < this.$_modelIndices$.length;$i$$36$$++) {
      $index$$52$$ = this.$_modelIndices$[$i$$36$$], $index$$52$$ >= $start$$8$$ && this.$_getModel$($index$$52$$) && this.$_getModel$($index$$52$$).$SetIndex$($index$$52$$);
    }
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_insertModelIndex$ = function $$oj$$1$$$$Collection$$$$_insertModelIndex$$($start$$9$$) {
    for (var $i$$38$$ = 0;$i$$38$$ < this.$_modelIndices$.length;$i$$38$$++) {
      this.$_modelIndices$[$i$$38$$] >= $start$$9$$ && this.$_modelIndices$[$i$$38$$]++;
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_spliceModelIndices$ = function $$oj$$1$$$$Collection$$$$_spliceModelIndices$$($start$$10$$, $end$$3$$) {
    ...
    for (var $count$$11$$ = $end$$3$$ - $start$$10$$ + 1, $i$$39$$ = 0;$i$$39$$ < this.$_modelIndices$.length;$i$$39$$++) {
      this.$_modelIndices$[$i$$39$$] > $end$$3$$ && (this.$_modelIndices$[$i$$39$$] -= $count$$11$$);
    }
  };
  $oj$$1$$.$Collection$.prototype.$_clearModelIndices$ = function $$oj$$1$$$$Collection$$$$_clearModelIndices$$($start$$11$$, $end$$4$$) {
    ...
    for (var $i$$40$$ = $start$$11$$;$i$$40$$ <= $end$$4$$;$i$$40$$++) {
  ...
  $oj$$1$$.$Collection$.prototype.$_clearOutModels$ = function $$oj$$1$$$$Collection$$$$_clearOutModels$$($n$$2$$) {
    var $current$$ = this.tail, $index$$55$$, $model$$19$$, $i$$41$$ = 0;
    for (this.tail = null;$current$$ && $i$$41$$ < $n$$2$$;) {
      $index$$55$$ = $current$$.$GetIndex$(), ($model$$19$$ = this.$_getModel$($index$$55$$)) && $model$$19$$.$hasChanged$() ? (this.tail || (this.tail = $current$$), $current$$ = $current$$.$previousModel$) : (this.$lruCount$--, -1 < $index$$55$$ && (this.$_setModel$($index$$55$$, void 0), this.$_clearModelIndices$($index$$55$$, $index$$55$$)), $current$$.$SetNext$(null), $current$$ = $current$$.$SetPrevious$(null), $i$$41$$++);
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_cloneInternal$ = function $$oj$$1$$$$Collection$$$$_cloneInternal$$($i$$42_withProperties$$) {
    ...
    if ($i$$42_withProperties$$) {
      var $indices$$ = [];
      for ($i$$42_withProperties$$ = 0;$i$$42_withProperties$$ < this.$_modelIndices$.length;$i$$42_withProperties$$++) {
        $indices$$.push(this.$_modelIndices$[$i$$42_withProperties$$]);
      }
      $indices$$.sort(function($a$$92$$, $b$$46$$) {
        return $a$$92$$ - $b$$46$$;
      });
      var $index$$56$$;
      for ($i$$42_withProperties$$ = 0;$i$$42_withProperties$$ < $indices$$.length;$i$$42_withProperties$$++) {
        $index$$56$$ = $indices$$[$i$$42_withProperties$$], ($model$$20$$ = this.$_atInternal$($index$$56$$, null, !0, !1)) && $c$$28$$.$_addInternal$($model$$20$$.clone(), {at:$index$$56$$}, !0, !1);
      }
    }
    return $c$$28$$;
  };
  $oj$$1$$.$Collection$.prototype.$_copyProperties$ = function $$oj$$1$$$$Collection$$$$_copyProperties$$($collection$$6$$) {
    var $props$$2$$ = ["comparator", "model", "modelId"], $prop$$45$$, $i$$43$$;
    for ($i$$43$$ = 0;$i$$43$$ < $props$$2$$.length;$i$$43$$++) {
      $prop$$45$$ = $props$$2$$[$i$$43$$], $collection$$6$$[$prop$$45$$] = this[$prop$$45$$];
    }
    return $collection$$6$$;
  };
  $oj$$1$$.$Collection$.prototype.$_copyFetchProperties$ = function $$oj$$1$$$$Collection$$$$_copyFetchProperties$$($collection$$7$$) {
    var $props$$3$$ = ["totalResults", "hasMore", $oj$$1$$.$Collection$.$_FETCH_SIZE_PROP$], $prop$$46$$, $i$$44$$;
    for ($i$$44$$ = 0;$i$$44$$ < $props$$3$$.length;$i$$44$$++) {
      $prop$$46$$ = $props$$3$$[$i$$44$$], $collection$$7$$[$prop$$46$$] = this[$prop$$46$$];
    }
    return $collection$$7$$;
  };
  ...
  $oj$$1$$.$Collection$.$_createModel$ = function $$oj$$1$$$$Collection$$$_createModel$$($collection$$8$$, $attrs$$11$$, $options$$64$$) {
    return $collection$$8$$.model ? $$$$1$$.isFunction($collection$$8$$.model) ? new $collection$$8$$.model($attrs$$11$$, $options$$64$$) : new $collection$$8$$.model.constructor($attrs$$11$$, $options$$64$$) : null;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_addInternal$ = function $$oj$$1$$$$Collection$$$$_addInternal$$($m$$2$$, $options$$67$$, $fillIn$$, $deferred$$2$$) {
    function $mergeAttrs$$($collection$$11$$, $modelToTryAndMerge_sortOpt$$inline_415$$, $modelFoundInCollection$$1$$, $newModel$$3$$, $deferred$$4$$) {
      var $existingModel$$1$$, $modelAdded$$ = null;
      !$force$$ && $merge$$ && $modelFoundInCollection$$1$$ ? ($needSort$$1$$ = $modelFoundInCollection$$1$$.$Merge$($modelToTryAndMerge_sortOpt$$inline_415$$, $collection$$11$$.comparator, $silent$$14$$), $modelAdded$$ = $modelFoundInCollection$$1$$) : ($force$$ || ($existingModel$$1$$ = $collection$$11$$.$_getLocal$($newModel$$3$$)) && $fillIn$$ && $at$$1$$ !== $existingModel$$1$$.index && $oj$$1$$.$Logger$.warn("Duplicate ID fetched or added without merging, the id \x3d " + $existingModel$$1$$.$GetId$()), 
      void 0 === $existingModel$$1$$ ? (void 0 === $at$$1$$ ? ($collection$$11$$.$_pushModels$($newModel$$3$$), $index$$57$$ = $collection$$11$$.$_getModelsLength$() - 1, $collection$$11$$.$_getModel$($index$$57$$).$SetCid$()) : ($index$$57$$ = $at$$1$$, $collection$$11$$.$IsVirtual$() && $fillIn$$ ? $collection$$11$$.$_setModel$($index$$57$$, $newModel$$3$$) : $collection$$11$$.$_spliceModels$($index$$57$$, 0, $newModel$$3$$), $collection$$11$$.$_getModel$($index$$57$$).$SetCid$(), $at$$1$$ += 1), 
      void 0 === $newModel$$3$$.$GetCollection$() && $newModel$$3$$.$SetCollection$($collection$$11$$), $collection$$11$$.$_setLength$(), $collection$$11$$.$_listenToModel$($newModel$$3$$), $added$$ = !0, $modelAdded$$ = $newModel$$3$$) : $modelAdded$$ = $existingModel$$1$$);
      $fillIn$$ && ($options$$67$$ = $options$$67$$ || {}, $options$$67$$.fillIn = !0);
      $needSort$$1$$ && void 0 === $existingModel$$1$$ && !$sort$$ && void 0 === $at$$1$$ && 1 < $collection$$11$$.$_getLength$() && (-1 < $index$$57$$ && ($cid$$1$$ = $collection$$11$$.$_getModel$($index$$57$$).cid), $modelToTryAndMerge_sortOpt$$inline_415$$ = {}, $oj$$1$$.$CollectionUtils$.$copyInto$($modelToTryAndMerge_sortOpt$$inline_415$$, $options$$67$$), $modelToTryAndMerge_sortOpt$$inline_415$$.add = !0, $collection$$11$$.sort($modelToTryAndMerge_sortOpt$$inline_415$$), -1 < $index$$57$$ && 
      ($index$$57$$ = $collection$$11$$.$IsVirtual$() ? -1 : $collection$$11$$.indexOf($collection$$11$$.$getByCid$($cid$$1$$), $deferred$$4$$)));
      $added$$ && ($options$$67$$.at && ($options$$67$$.index = $index$$57$$), $newModel$$3$$ ? ($newModel$$3$$.$TriggerInternal$($silent$$14$$, $oj$$1$$.$Events$.$EventType$.ADD, $newModel$$3$$, $collection$$11$$, $options$$67$$), $addedModels$$.push($newModel$$3$$)) : ($modelFoundInCollection$$1$$.$TriggerInternal$($silent$$14$$, $oj$$1$$.$Events$.$EventType$.ADD, $modelFoundInCollection$$1$$, $collection$$11$$, $options$$67$$), $addedModels$$.push($modelFoundInCollection$$1$$)));
      return $modelAdded$$;
    }
    function $doAdd$$($collection$$12$$, $model$$21_modelAdded$$1$$, $deferred$$5$$) {
      $added$$ = !1;
      var $newModel$$4$$ = $collection$$12$$.$_newModel$($model$$21_modelAdded$$1$$, $options$$67$$, !1), $modelToTryAndMerge$$1$$ = null, $modelFoundInCollection$$2$$ = null;
      if (null != $newModel$$4$$) {
        $index$$57$$ = -1;
        $newModel$$4$$.$SetupId$();
        ...
        if ($deferred$$5$$) {
          return $force$$ ? new Promise(function($resolve$$) {
            var $model$$22$$ = $mergeAttrs$$($collection$$12$$, $modelToTryAndMerge$$1$$, void 0, $newModel$$4$$, $deferred$$5$$);
            $modelReturnList$$.push($model$$22$$);
            $resolve$$($model$$22$$);
          }) : $collection$$12$$.$_getInternal$($modelToTryAndMerge$$1$$, {silent:!0}, $deferred$$5$$, !0).then(function($mod_modInfo$$) {
            $modelFoundInCollection$$2$$ = $mod_modInfo$$.m;
            $mod_modInfo$$ = $mergeAttrs$$($collection$$12$$, $modelToTryAndMerge$$1$$, $modelFoundInCollection$$2$$, $newModel$$4$$, $deferred$$5$$);
            $modelReturnList$$.push($mod_modInfo$$);
          });
        }
        !$force$$ && $merge$$ && ($modelFoundInCollection$$2$$ = $fillIn$$ ? $collection$$12$$.$_getLocal$($modelToTryAndMerge$$1$$) : $collection$$12$$.get($modelToTryAndMerge$$1$$));
        ($model$$21_modelAdded$$1$$ = $mergeAttrs$$($collection$$12$$, $modelToTryAndMerge$$1$$, $modelFoundInCollection$$2$$, $newModel$$4$$, $deferred$$5$$)) && $modelReturnList$$.push($model$$21_modelAdded$$1$$);
      } else {
        $modelReturnList$$.push(!1);
      }
    }
    function $_parse$$($collection$$13$$, $array$$9$$) {
      return $collection$$13$$.parse && $options$$67$$.parse && !$options$$67$$.$noparse$ ? $collection$$13$$.parse($array$$9$$) : $array$$9$$;
    }
    $options$$67$$ = $options$$67$$ || {};
    var $modelArray$$ = [], $at$$1$$ = $options$$67$$.at, $silent$$14$$ = $options$$67$$.silent, $force$$ = $options$$67$$.force, $i$$45$$, $index$$57$$, $cid$$1$$, $merge$$ = $options$$67$$.merge || !1, $sort$$ = $options$$67$$.sort, $needSort$$1$$ = !0, $added$$ = !1, $addedModels$$ = [], $modelReturnList$$ = [];
    ...
    if (!$fillIn$$ && (this.$IsVirtual$() || $deferred$$2$$)) {
      ...
      return new Promise(function($allResolve$$, $allReject$$) {
        ...
        for ($i$$45$$ = 0;$i$$45$$ < $modelArray$$.length;$i$$45$$++) {
  ...
  $oj$$1$$.$Collection$.prototype.sort = function $$oj$$1$$$$Collection$$$sort$($options$$68$$) {
    ...
    $self$$7$$ = this;
    this.$_getModels$().sort(function($a$$93$$, $b$$47$$) {
      return $oj$$1$$.$Collection$.$SortFunc$($a$$93$$, $b$$47$$, $comparator$$2$$, $self$$7$$, $self$$7$$);
    });
  ...
  $oj$$1$$.$Collection$.$SortFunc$ = function $$oj$$1$$$$Collection$$$SortFunc$$($a$$94$$, $b$$48$$, $attrs$$12_comparator$$3$$, $collection$$14$$, $self$$8$$) {
    var $attrs1_keyA$$, $keyB_retVal$$2$$, $i$$46$$;
    if ($$$$1$$.isFunction($attrs$$12_comparator$$3$$)) {
      if (1 === $attrs$$12_comparator$$3$$.length) {
        $attrs1_keyA$$ = $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$94$$);
        ...
        for ($i$$46$$ = 0;$i$$46$$ < $attrs1_keyA$$.length;$i$$46$$++) {
          if ($keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$[$i$$46$$], $attrs2$$[$i$$46$$], $collection$$14$$.sortDirection), 0 !== $keyB_retVal$$2$$) {
            return $keyB_retVal$$2$$;
          }
        }
      }
      return $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$94$$, $b$$48$$);
    }
    if ($oj$$1$$.$StringUtils$.$isString$($attrs$$12_comparator$$3$$)) {
      for ($attrs$$12_comparator$$3$$ = $attrs$$12_comparator$$3$$.split(","), $i$$46$$ = 0;$i$$46$$ < $attrs$$12_comparator$$3$$.length;$i$$46$$++) {
        if ($attrs1_keyA$$ = $oj$$1$$.$Collection$.$_getKey$($a$$94$$, $attrs$$12_comparator$$3$$[$i$$46$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_getKey$($b$$48$$, $attrs$$12_comparator$$3$$[$i$$46$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$, $keyB_retVal$$2$$, $collection$$14$$.sortDirection), 0 !== $keyB_retVal$$2$$) {
          return $keyB_retVal$$2$$;
        }
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$sortedIndex$ = function $$oj$$1$$$$Collection$$$$sortedIndex$$($model$$23$$, $comparator$$4$$) {
    ...
    $self$$9$$ = this;
    return $oj$$1$$.$Collection$.$_find$(this.$_getModels$(), $model$$23$$, function($a$$95$$, $b$$49$$) {
      var $attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$;
      if ($$$$1$$.isFunction($comp$$)) {
        if (1 === $comp$$.length) {
          $attrs1$$1_keyA$$1$$ = $comp$$.call($self$$9$$, $a$$95$$);
          ...
          var $retVal$$3$$, $i$$47$$;
          for ($i$$47$$ = 0;$i$$47$$ < $attrs1$$1_keyA$$1$$.length;$i$$47$$++) {
            if ($retVal$$3$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1$$1_keyA$$1$$[$i$$47$$], $attrs2$$1_keyB$$1$$[$i$$47$$], $self$$9$$.sortDirection), 0 !== $retVal$$3$$) {
              return $retVal$$3$$;
            }
          }
        }
        return $comp$$.call($self$$9$$, $a$$95$$, $b$$49$$);
      }
      return $oj$$1$$.$StringUtils$.$isString$($comp$$) ? ($attrs1$$1_keyA$$1$$ = $a$$95$$.get($comp$$), $attrs2$$1_keyB$$1$$ = $b$$49$$.get($comp$$), $oj$$1$$.$Collection$.$_compareKeys$($attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$, $self$$9$$.sortDirection)) : 0;
    });
  };
  ...
  $oj$$1$$.$Collection$.prototype.$initial$ = function $$oj$$1$$$$Collection$$$$initial$$($n$$3$$) {
    ...
    var $array$$10$$ = [], $i$$48$$;
    for ($i$$48$$ = 0;$i$$48$$ < this.$_getLength$() - $n$$3$$;$i$$48$$ += 1) {
      $array$$10$$.push(this.at($i$$48$$));
    }
    return $array$$10$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.last = function $$oj$$1$$$$Collection$$$last$($n$$4$$, $options$$72$$) {
    var $deferred$$7_i$$49$$ = this.$_getDeferred$($options$$72$$);
    void 0 === $n$$4$$ && ($n$$4$$ = 1);
    if (1 === $n$$4$$) {
      var $len$$1$$ = this.$_getModelsLength$();
      0 === $len$$1$$ && ($len$$1$$ = $n$$4$$);
      return 0 < $len$$1$$ ? this.at($len$$1$$ - 1, $deferred$$7_i$$49$$) : null;
    }
    var $array$$11$$ = [], $len$$1$$ = this.$_getLength$();
    if ($deferred$$7_i$$49$$ || this.$IsVirtual$()) {
    ...
    for ($deferred$$7_i$$49$$ = $len$$1$$ - $n$$4$$;$deferred$$7_i$$49$$ < $len$$1$$;$deferred$$7_i$$49$$ += 1) {
      $array$$11$$.push(this.at($deferred$$7_i$$49$$));
    }
    return $array$$11$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$IterativeAt$ = function $$oj$$1$$$$Collection$$$$IterativeAt$$($start$$13$$, $end$$5$$) {
    var $array$$12$$ = [], $i$$50$$, $self$$12$$ = this;
    return new Promise(function($allResolve$$1$$, $allReject$$1$$) {
      function $doTask$$1$$($index$$59$$) {
        return $self$$12$$.$IsVirtual$() && $self$$12$$.$_hasTotalResults$() && $index$$59$$ >= $self$$12$$.totalResults ? Promise.resolve($index$$59$$ + 1) : new Promise(function($resolve$$2$$, $reject$$2$$) {
      ...
      for ($i$$50$$ = $start$$13$$;$i$$50$$ < $end$$5$$;$i$$50$$++) {
  ...
  $oj$$1$$.$Collection$.prototype.$rest$ = function $$oj$$1$$$$Collection$$$$rest$$($n$$11$$, $options$$75$$) {
    var $deferred$$8_i$$51$$ = this.$_getDeferred$($options$$75$$);
    void 0 === $n$$11$$ && ($n$$11$$ = 1);
    var $array$$13$$ = [];
    if (this.$IsVirtual$() || $deferred$$8_i$$51$$) {
      var $self$$15$$ = this;
      return this.$_addPromise$(function() {
        return $self$$15$$.$IterativeAt$($n$$11$$, $self$$15$$.$_getLength$());
      });
    }
    for ($deferred$$8_i$$51$$ = $n$$11$$;$deferred$$8_i$$51$$ < this.$_getLength$();$deferred$$8_i$$51$$ += 1) {
      $array$$13$$.push(this.at($deferred$$8_i$$51$$));
    }
    return $array$$13$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_modelEvent$ = function $$oj$$1$$$$Collection$$$$_modelEvent$$($event$$15$$, $model$$29$$, $collection$$15$$, $options$$78$$) {
    $event$$15$$ === $oj$$1$$.$Events$.$EventType$.DESTROY && this.remove($model$$29$$);
    void 0 !== $collection$$15$$ && $collection$$15$$ instanceof $oj$$1$$.$Collection$ && $collection$$15$$ !== this || (Array.prototype.slice.call(arguments), this.$TriggerInternal$($options$$78$$ && $options$$78$$.silent, $event$$15$$, $model$$29$$, $collection$$15$$, $options$$78$$));
  };
      ...
      return new Promise(function($resolve$$3$$, $reject$$3$$) {
        if (!$self$$16$$.$IsVirtual$()) {
          ...
          try {
            ...
            $opt$$7_startIndex$$1$$.success = function $$opt$$7_startIndex$$1$$$success$($collection$$16$$, $response$$1$$, $options$$80$$) {
              $self$$16$$.$TriggerInternal$($silent$$18$$, $oj$$1$$.$Events$.$EventType$.REFRESH, $self$$16$$, $options$$80$$, null);
              $resolve$$3$$({collection:$collection$$16$$, response:$response$$1$$, options:$options$$80$$});
            };
            $opt$$7_startIndex$$1$$.error = function $$opt$$7_startIndex$$1$$$error$($xhr$$12$$, $status$$6$$, $error$$8$$) {
              $reject$$3$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$12$$, $status$$6$$, $error$$8$$, $self$$16$$, $options$$79$$, !1));
            };
  ...
  $oj$$1$$.$Collection$.prototype.reset = function $$oj$$1$$$$Collection$$$reset$($data$$40$$, $options$$81$$) {
    ...
    for (var $index$$61_model$$30_retObj$$8$$, $i$$52_silent$$19$$ = 0;$i$$52_silent$$19$$ < this.$_modelIndices$.length;$i$$52_silent$$19$$++) {
      if ($index$$61_model$$30_retObj$$8$$ = this.$_modelIndices$[$i$$52_silent$$19$$], $index$$61_model$$30_retObj$$8$$ = this.$_getModel$($index$$61_model$$30_retObj$$8$$)) {
        this.$_unlistenToModel$($index$$61_model$$30_retObj$$8$$), $index$$61_model$$30_retObj$$8$$.$SetCollection$(null);
      }
    }
    this.$_setModels$([], !0);
    this.$_resetLRU$();
    $i$$52_silent$$19$$ = void 0 !== $opts$$5$$.silent && $opts$$5$$.silent;
    if (!$data$$40$$) {
      return this.$_setLength$(), this.totalResults = void 0, this.$TriggerInternal$($i$$52_silent$$19$$, $oj$$1$$.$Events$.$EventType$.RESET, this, $opts$$5$$, null), null;
    }
    ...
    this.$_setLength$();
    this.$TriggerInternal$($i$$52_silent$$19$$, $oj$$1$$.$Events$.$EventType$.RESET, this, $opts$$5$$, null);
  ...
  $oj$$1$$.$Collection$.prototype.$_addxhr$ = function $$oj$$1$$$$Collection$$$$_addxhr$$($xhr$$13$$) {
    $xhr$$13$$ && $xhr$$13$$.abort && (void 0 === this.$_xhrs$ && (this.$_xhrs$ = []), $xhr$$13$$.done(function() {
      var $loc$$1$$ = this.$_xhrs$ ? this.$_xhrs$.indexOf($xhr$$13$$) : -1;
      -1 < $loc$$1$$ && this.$_xhrs$.splice($loc$$1$$, 1);
    }), this.$_xhrs$.push($xhr$$13$$));
  };
  $oj$$1$$.$Collection$.prototype.abort = function $$oj$$1$$$$Collection$$$abort$() {
    var $self$$19$$ = this;
    return this.$_xhrs$ ? new Promise(function($resolve$$4$$) {
      for (var $i$$53$$ = $self$$19$$.$_xhrs$.length - 1;0 <= $i$$53$$;$i$$53$$--) {
        $self$$19$$.$_xhrs$[$i$$53$$].complete(function($xhr$$14$$, $status$$7$$) {
          "abort" === $status$$7$$ && ($self$$19$$.$_xhrs$.splice($i$$53$$, 1), 0 === $self$$19$$.$_xhrs$.length && $self$$19$$.whenReady().then(function() {
            $resolve$$4$$(null);
          }, function() {
            $resolve$$4$$(null);
          }));
        }), $self$$19$$.$_xhrs$[$i$$53$$].abort();
      }
    }) : Promise.resolve();
  };
  $oj$$1$$.$Object$.$exportPrototypeSymbol$("Collection.prototype.abort", {abort:$oj$$1$$.$Collection$.prototype.abort});
  $oj$$1$$.$Collection$.prototype.$_deferredAt$ = function $$oj$$1$$$$Collection$$$$_deferredAt$$($index$$64$$, $options$$84$$) {
    var $self$$20$$ = this, $model$$31$$ = $self$$20$$.$_getModel$($index$$64$$);
    return void 0 === $model$$31$$ ? new Promise(function($resolve$$5$$, $reject$$5$$) {
      var $opts$$6$$ = {};
      $oj$$1$$.$CollectionUtils$.$copyInto$($opts$$6$$, $options$$84$$ || {});
      $opts$$6$$.context = $self$$20$$;
      $opts$$6$$.startIndex = $index$$64$$;
      $opts$$6$$.error = function $$opts$$6$$$error$($xhr$$15$$, $status$$8$$, $error$$10$$) {
        $reject$$5$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$15$$, $status$$8$$, $error$$10$$, $self$$20$$, $options$$84$$, !1));
      };
      $opts$$6$$.success = function $$opts$$6$$$success$() {
        $resolve$$5$$($self$$20$$.$_getModel$($index$$64$$));
      };
      $self$$20$$.$_fetchInternal$($opts$$6$$, -1, !1);
    }) : new Promise(function($resolve$$6$$) {
      $resolve$$6$$($model$$31$$);
    });
  };
  $oj$$1$$.$Collection$.prototype.$getByCid$ = function $$oj$$1$$$$Collection$$$$getByCid$$($clientId$$) {
    for (var $models$$5$$ = this.$_getModels$(), $index$$65$$, $foundModel$$ = null, $i$$54$$ = 0;$i$$54$$ < this.$_modelIndices$.length;$i$$54$$++) {
      if ($index$$65$$ = this.$_modelIndices$[$i$$54$$], $models$$5$$[$index$$65$$] && $clientId$$ === $models$$5$$[$index$$65$$].cid) {
  ...
  $oj$$1$$.$Collection$.prototype.get = function $$oj$$1$$$$Collection$$$get$($id$$6$$, $options$$85$$) {
    ...
    if ($internalGet$$) {
      if ($$$$1$$.isFunction($internalGet$$.then)) {
        return this.$_addPromise$(function() {
          return new Promise(function($resolve$$7$$, $reject$$7$$) {
            $internalGet$$.then(function($modInfo$$2$$) {
              $resolve$$7$$($modInfo$$2$$.m);
            }, function($err$$5$$) {
              $reject$$7$$($err$$5$$);
            });
          });
      ...
      if (this.$IsVirtual$()) {
        return this.$_addPromise$(function() {
          return new Promise(function($resolve$$8$$) {
            $resolve$$8$$($internalGet$$.m);
          });
        });
      }
  ...
  $oj$$1$$.$Collection$.prototype.$_getLocalInternal$ = function $$oj$$1$$$$Collection$$$$_getLocalInternal$$($id$$8$$) {
    ...
    for (var $foundObj$$ = null, $len$$2$$ = this.$_modelIndices$.length, $model$$32$$, $models$$6$$ = this.$_getModels$(), $index$$66$$, $i$$55$$ = 0;$i$$55$$ < $len$$2$$;$i$$55$$++) {
      if ($index$$66$$ = this.$_modelIndices$[$i$$55$$], $model$$32$$ = $models$$6$$[$index$$66$$], void 0 !== $model$$32$$ && $model$$32$$.$Match$($id$$8$$, $cid$$3$$)) {
  ...
  $oj$$1$$.$Collection$.prototype.$_getInternal$ = function $$oj$$1$$$$Collection$$$$_getInternal$$($id$$9$$, $options$$86$$, $deferred$$12$$, $fillIn$$1$$) {
    ...
    for (var $foundObj$$1$$ = null, $models$$7$$ = this.$_getModels$(), $index$$67$$, $i$$56$$ = 0;$i$$56$$ < this.$_modelIndices$.length;$i$$56$$++) {
      if ($index$$67$$ = this.$_modelIndices$[$i$$56$$], $models$$7$$[$index$$67$$] && $models$$7$$[$index$$67$$].$Match$($id$$9$$, $cid$$4$$)) {
        $foundObj$$1$$ = $oj$$1$$.$Collection$.$_getModinfo$($index$$67$$, $models$$7$$[$index$$67$$]);
        break;
      }
    }
    if ($foundObj$$1$$) {
      return $deferred$$12$$ ? new Promise(function($resolve$$9$$) {
        $resolve$$9$$($foundObj$$1$$);
      }) : $foundObj$$1$$;
    }
    if (this.$IsVirtual$()) {
      if (void 0 === $id$$9$$ && void 0 !== $cid$$4$$) {
        return new Promise(function($resolve$$10$$) {
          $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
        });
      }
      var $self$$21$$ = this;
      return new Promise(function($resolve$$11$$, $reject$$11$$) {
        var $opts$$7$$ = {};
        $oj$$1$$.$CollectionUtils$.$copyInto$($opts$$7$$, $options$$86$$ || {});
        $opts$$7$$.context = $self$$21$$;
        $opts$$7$$.startID = $id$$9$$;
        $opts$$7$$.error = function $$opts$$7$$$error$($xhr$$16$$, $status$$9$$, $error$$11$$) {
          $reject$$11$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$16$$, $status$$9$$, $error$$11$$, $self$$21$$, $options$$86$$, !1));
        };
        $opts$$7$$.success = function $$opts$$7$$$success$($collection$$18$$, $response$$3$$) {
          if (null != $response$$3$$) {
            var $index$$inline_418$$ = $self$$21$$.$_getOffset$(), $model$$inline_419$$ = $self$$21$$.$_getModel$($index$$inline_418$$);
            void 0 !== $model$$inline_419$$ && $model$$inline_419$$.$Match$($id$$9$$, $cid$$4$$) ? $resolve$$11$$($oj$$1$$.$Collection$.$_getModinfo$($index$$inline_418$$, $model$$inline_419$$)) : $resolve$$11$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          } else {
            $resolve$$11$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          }
        };
        $self$$21$$.$_fetchInternal$($opts$$7$$, -1, $fillIn$$1$$);
      });
    }
    var $undefinedModInfo$$ = $oj$$1$$.$Collection$.$_getModinfo$(-1, void 0);
    return $deferred$$12$$ ? new Promise(function($resolve$$12$$) {
      $resolve$$12$$($undefinedModInfo$$);
    }) : $undefinedModInfo$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_checkActual$ = function $$oj$$1$$$$Collection$$$$_checkActual$$($start$$16$$, $count$$12$$, $actual$$1$$) {
    return this.$_hasTotalResults$() && $actual$$1$$.start + $actual$$1$$.count >= this.totalResults ? !0 : $actual$$1$$.start === $start$$16$$ && $actual$$1$$.count === $count$$12$$;
  };
  $oj$$1$$.$Collection$.prototype.$setRangeLocal$ = function $$oj$$1$$$$Collection$$$$setRangeLocal$$($start$$17$$, $count$$13$$) {
    var $self$$22$$ = this;
    return this.$_addPromise$(function() {
      return $self$$22$$.$_setRangeLocalInternal$($start$$17$$, $count$$13$$);
    });
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_setRangeLocalInternal$ = function $$oj$$1$$$$Collection$$$$_setRangeLocalInternal$$($start$$18$$, $count$$14$$) {
    ...
    var $actual$$2$$ = this.$_getLocalRange$($start$$18$$, $count$$14$$), $self$$23$$ = this;
    ...
    return new Promise(function($resolve$$14$$, $reject$$14$$) {
      $self$$23$$.$_setRangeLocalFetch$($start$$18$$, $count$$14$$, -1, {start:$start$$18$$, count:$count$$14$$}, $resolve$$14$$, $reject$$14$$, !0);
    });
  };
  $oj$$1$$.$Collection$.prototype.$_setRangeLocalFetch$ = function $$oj$$1$$$$Collection$$$$_setRangeLocalFetch$$($start$$19$$, $count$$15$$, $actual$$3_placement$$, $original$$2$$, $resolve$$15$$, $reject$$15$$, $fill$$) {
    var $self$$24$$ = this, $limit$$1$$ = $start$$19$$ + $count$$15$$;
    ...
    $newStart_opts$$8$$.error = function $$newStart_opts$$8$$$error$($xhr$$17$$, $status$$10$$, $error$$12$$) {
      $reject$$15$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$17$$, $status$$10$$, $error$$12$$, $self$$24$$, null, !1));
    };
    $newStart_opts$$8$$.success = function $$newStart_opts$$8$$$success$() {
      var $actual$$inline_421$$ = $self$$24$$.$_getLocalRange$($original$$2$$.start, $original$$2$$.count);
      if ($fill$$ && $self$$24$$.$_hasTotalResults$() && $actual$$inline_421$$.count < $original$$2$$.count) {
        var $newPlacement$$inline_422$$ = $actual$$inline_421$$.start + $actual$$inline_421$$.count, $newStart$$inline_423$$ = $start$$19$$ + $count$$15$$;
        $newStart$$inline_423$$ < $self$$24$$.totalResults ? $self$$24$$.$_setRangeLocalFetch$($newStart$$inline_423$$, $count$$15$$, $newPlacement$$inline_422$$, $original$$2$$, $resolve$$15$$, $reject$$15$$, $fill$$) : $resolve$$15$$($actual$$inline_421$$);
      } else {
        $resolve$$15$$($actual$$inline_421$$);
      }
    };
    try {
      this.$_fetchInternal$($newStart_opts$$8$$, $actual$$3_placement$$, -1 < $actual$$3_placement$$);
    } catch ($e$$22$$) {
      $e$$22$$ instanceof $oj$$1$$.$URLError$ && ($actual$$3_placement$$ = $self$$24$$.$_getLocalRange$($start$$19$$, $count$$15$$), $resolve$$15$$($actual$$3_placement$$));
    }
  };
  $oj$$1$$.$Collection$.$_createRejectionError$ = function $$oj$$1$$$$Collection$$$_createRejectionError$$($xhr$$18$$, $status$$11$$, $error$$13$$, $collection$$20$$, $err$$6_options$$87$$, $fireError$$) {
    var $silent$$20$$ = !1;
    $err$$6_options$$87$$ && $err$$6_options$$87$$.silent && ($silent$$20$$ = $err$$6_options$$87$$.silent);
    $fireError$$ && $oj$$1$$.$Model$.$_triggerError$($collection$$20$$, $silent$$20$$, $err$$6_options$$87$$, $status$$11$$, $error$$13$$, $xhr$$18$$);
    $err$$6_options$$87$$ = Error($status$$11$$);
    $err$$6_options$$87$$.xhr = $xhr$$18$$;
    $err$$6_options$$87$$.error = $error$$13$$;
    $err$$6_options$$87$$.collection = $collection$$20$$;
    $err$$6_options$$87$$.status = $status$$11$$;
  ...
  $oj$$1$$.$Collection$.prototype.$_getModelArray$ = function $$oj$$1$$$$Collection$$$$_getModelArray$$($start$$22$$, $count$$18$$) {
    for (var $retArr$$ = [], $models$$8$$ = this.$_getModels$(), $end$$6$$ = $start$$22$$ + $count$$18$$, $i$$57$$ = $start$$22$$;$i$$57$$ < $end$$6$$;$i$$57$$++) {
      $retArr$$.push($models$$8$$[$i$$57$$]);
    }
    return $retArr$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_getFirstMissingModel$ = function $$oj$$1$$$$Collection$$$$_getFirstMissingModel$$($start$$24$$, $limit$$3$$) {
    for (var $i$$58$$ = $start$$24$$;$i$$58$$ < $limit$$3$$;$i$$58$$++) {
      if (void 0 === this.$_getModel$($i$$58$$)) {
        return $i$$58$$;
      }
    }
    return-1;
  ...
  $oj$$1$$.$Collection$.prototype.fetch = function $$oj$$1$$$$Collection$$$fetch$($options$$88$$) {
    var $xhr$$19$$ = this.$_fetchInternal$($options$$88$$, -1, !1);
    this.$_addPromise$(function() {
      return Promise.resolve($xhr$$19$$);
    });
    return $xhr$$19$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_fetchInternal$ = function $$oj$$1$$$$Collection$$$$_fetchInternal$$($options$$89$$, $placement$$1$$, $fillIn$$2$$) {
    function $doReset$$($collection$$21$$, $opt$$9$$, $fillIn$$3$$) {
      $collection$$21$$.$IsVirtual$() ? $fillIn$$3$$ || $collection$$21$$.$_resetModelsToFullLength$() : $opt$$9$$.add || $opt$$9$$.$useset$ || $collection$$21$$.reset(null, {silent:!0});
    }
    var $opt$$8$$ = $options$$89$$ || {}, $success$$12$$ = $opt$$8$$.success, $self$$25$$, $errFunc$$1$$ = $opt$$8$$.error;
    $opt$$8$$.set && ($opt$$8$$.$useset$ = $opt$$8$$.set ? !0 : !1);
    void 0 === $opt$$8$$.parse && ($opt$$8$$.parse = !0);
    $self$$25$$ = this;
    $opt$$8$$.error = function $$opt$$8$$$error$($xhr$$20$$, $status$$12$$, $error$$14$$) {
      $oj$$1$$.$Model$.$_triggerError$($self$$25$$, !1, $options$$89$$, $status$$12$$, $error$$14$$, $xhr$$20$$);
      $errFunc$$1$$ && $errFunc$$1$$.call($oj$$1$$.$Model$.$GetContext$($options$$89$$, $self$$25$$), $xhr$$20$$, $status$$12$$, $error$$14$$);
    };
    $opt$$8$$.success = function $$opt$$8$$$success$($response$$6$$) {
      var $data$$41$$;
      try {
        $data$$41$$ = $self$$25$$.parse($response$$6$$, $options$$89$$);
      } catch ($e$$23$$) {
        $oj$$1$$.$Collection$.$_reportError$($self$$25$$, $e$$23$$, $opt$$8$$.error, $options$$89$$);
        return;
      }
      $self$$25$$.$_setPagingReturnValues$($response$$6$$, $options$$89$$, $data$$41$$, $fillIn$$2$$);
      var $dataList$$ = null;
      if ($opt$$8$$.add || $self$$25$$.model) {
        $doReset$$($self$$25$$, $opt$$8$$, $fillIn$$2$$);
        try {
          $manageLRU$$ = !1, -1 === $placement$$1$$ && ($manageLRU$$ = !0, $placement$$1$$ = $self$$25$$.$_getOffset$()), $dataList$$ = $self$$25$$.$_fillInCollectionWithParsedData$($data$$41$$, $placement$$1$$, $manageLRU$$, $opt$$8$$);
        } catch ($e$$24$$) {
          $oj$$1$$.$Collection$.$_reportError$($self$$25$$, $e$$24$$, $opt$$8$$.error, $options$$89$$);
          return;
        }
      } else {
        if (!$fillIn$$2$$) {
          if ($self$$25$$.$IsVirtual$()) {
            $doReset$$($self$$25$$, $opt$$8$$, $fillIn$$2$$);
            var $manageLRU$$ = !1;
            -1 === $placement$$1$$ && ($manageLRU$$ = !0, $placement$$1$$ = $self$$25$$.$_getOffset$());
            $dataList$$ = $self$$25$$.$_putDataIntoCollection$($data$$41$$, $placement$$1$$, $manageLRU$$);
          } else {
            $opt$$8$$.$useset$ ? $self$$25$$.$_setInternal$($data$$41$$, !1, $opt$$8$$, !1) : $self$$25$$.reset($data$$41$$, {silent:!0});
          }
        }
      }
      $self$$25$$.$IsVirtual$() && $dataList$$ && ($self$$25$$.lastFetchCount = $dataList$$.length);
      $self$$25$$.$TriggerInternal$($opt$$8$$.silent ? !0 : !1, $oj$$1$$.$Events$.$EventType$.SYNC, $self$$25$$, $response$$6$$, $opt$$8$$);
      $success$$12$$ && $success$$12$$.call($oj$$1$$.$Model$.$GetContext$($options$$89$$, $self$$25$$), $self$$25$$, $response$$6$$, $opt$$8$$);
    };
  ...
  $oj$$1$$.$Collection$.prototype.$_putDataIntoCollection$ = function $$oj$$1$$$$Collection$$$$_putDataIntoCollection$$($addOpt_data$$42$$, $insertPos_placement$$2$$, $manageLRU$$1_virtual$$) {
    ...
    if ($addOpt_data$$42$$) {
      ...
      for (var $prevItem$$ = null, $i$$59$$ = 0;$i$$59$$ < $dataList$$1$$.length;$i$$59$$ += 1) {
        $manageLRU$$1_virtual$$ && ($addOpt_data$$42$$ = {at:$insertPos_placement$$2$$}, $prevItem$$ = this.$_atInternal$($insertPos_placement$$2$$, null, !0, !1)), $addOpt_data$$42$$.silent = !0, this.$_addInternal$($dataList$$1$$[$i$$59$$], $addOpt_data$$42$$, !0, !1), this.$_atInternal$($insertPos_placement$$2$$, null, !0, !1) !== $prevItem$$ && $insertPos_placement$$2$$++;
      }
    }
    return $dataList$$1$$;
  };
  $oj$$1$$.$Collection$.prototype.$_fillInCollectionWithParsedData$ = function $$oj$$1$$$$Collection$$$$_fillInCollectionWithParsedData$$($addOpt$$1_data$$43$$, $parsedModel_placement$$3$$, $manageLRU$$2_virtual$$1$$, $opt$$10_prevItem$$1$$) {
    ...
    if ($addOpt$$1_data$$43$$) {
      ...
      if ($opt$$10_prevItem$$1$$.$useset$ && !$manageLRU$$2_virtual$$1$$) {
        for (var $i$$60$$ = 0;$i$$60$$ < $dataList$$2$$.length;$i$$60$$ += 1) {
          $parsedModel_placement$$3$$ = $modelInstance$$ && $parse$$2$$ ? $modelInstance$$.parse($dataList$$2$$[$i$$60$$]) : $dataList$$2$$[$i$$60$$], $dataList$$2$$[$i$$60$$] = $parsedModel_placement$$3$$;
        }
        this.$_setInternal$($dataList$$2$$, !1, $opt$$10_prevItem$$1$$, !1);
      } else {
        $opt$$10_prevItem$$1$$ = null;
        for (var $insertPos$$1$$ = $parsedModel_placement$$3$$, $i$$60$$ = 0;$i$$60$$ < $dataList$$2$$.length;$i$$60$$ += 1) {
          $parsedModel_placement$$3$$ = $modelInstance$$ && $parse$$2$$ ? $modelInstance$$.parse($dataList$$2$$[$i$$60$$]) : $dataList$$2$$[$i$$60$$], $manageLRU$$2_virtual$$1$$ && ($addOpt$$1_data$$43$$ = {at:$insertPos$$1$$}, $opt$$10_prevItem$$1$$ = this.$_atInternal$($insertPos$$1$$, $addOpt$$1_data$$43$$, !0, !1)), $addOpt$$1_data$$43$$.silent = !0, this.$_addInternal$($parsedModel_placement$$3$$, $addOpt$$1_data$$43$$, !0, !1), this.$_atInternal$($insertPos$$1$$, null, !0, !1) !== $opt$$10_prevItem$$1$$ && 
          $insertPos$$1$$++;
        }
      }
    }
  ...
  $oj$$1$$.$Collection$.$_reportError$ = function $$oj$$1$$$$Collection$$$_reportError$$($collection$$22$$, $e$$25$$, $errorFunc$$, $options$$90$$) {
    $oj$$1$$.$Logger$.error($e$$25$$.toString());
    $errorFunc$$ && $errorFunc$$.call($oj$$1$$.$Model$.$GetContext$($options$$90$$, $collection$$22$$), $collection$$22$$, $e$$25$$, $options$$90$$);
  };
  $oj$$1$$.$Collection$.prototype.$_fetchOnly$ = function $$oj$$1$$$$Collection$$$$_fetchOnly$$($options$$91$$) {
    var $opt$$11$$ = $options$$91$$ || {}, $success$$13$$ = $opt$$11$$.success, $parsedModel$$1$$, $self$$26$$;
    void 0 === $opt$$11$$.parse && ($opt$$11$$.parse = !0);
    $self$$26$$ = this;
    $opt$$11$$.success = function $$opt$$11$$$success$($response$$7$$) {
      var $data$$44_i$$61$$, $modelInstance$$1$$, $dataList$$3$$ = null, $fetchedModels$$ = [];
      try {
        $data$$44_i$$61$$ = $self$$26$$.parse($response$$7$$, $options$$91$$);
      } catch ($e$$26$$) {
        $oj$$1$$.$Collection$.$_reportError$($self$$26$$, $e$$26$$, $opt$$11$$.error, $options$$91$$);
        return;
      }
      if ($opt$$11$$.add || $self$$26$$.model) {
        if ($modelInstance$$1$$ = $oj$$1$$.$Collection$.$_createModel$($self$$26$$), $data$$44_i$$61$$) {
          for ($dataList$$3$$ = $data$$44_i$$61$$ instanceof Array ? $data$$44_i$$61$$ : [$data$$44_i$$61$$], $data$$44_i$$61$$ = 0;$data$$44_i$$61$$ < $dataList$$3$$.length;$data$$44_i$$61$$ += 1) {
            if ($modelInstance$$1$$ && $opt$$11$$.parse) {
              try {
                $parsedModel$$1$$ = $modelInstance$$1$$.parse($dataList$$3$$[$data$$44_i$$61$$]);
              } catch ($e$$27$$) {
                $oj$$1$$.$Collection$.$_reportError$($self$$26$$, $e$$27$$, $opt$$11$$.error, $options$$91$$);
                return;
              }
            } else {
              $parsedModel$$1$$ = $dataList$$3$$[$data$$44_i$$61$$];
            }
            $fetchedModels$$.push($self$$26$$.$_newModel$($parsedModel$$1$$));
          }
        }
      }
      $self$$26$$.$TriggerInternal$(!1, $oj$$1$$.$Events$.$EventType$.SYNC, $self$$26$$, $response$$7$$, $opt$$11$$);
      $success$$13$$ && $success$$13$$.call($oj$$1$$.$Model$.$GetContext$($options$$91$$, $self$$26$$), $self$$26$$, $fetchedModels$$, $opt$$11$$);
    };
  ...
  $oj$$1$$.$Collection$.prototype.create = function $$oj$$1$$$$Collection$$$create$($attributes$$9$$, $options$$94$$) {
    ...
    function $doAdd$$1$$($newModel$$7$$, $addOpts$$1$$) {
      if ($options$$94$$.wait) {
        if ($self$$27$$.$IsVirtual$() || $deferred$$13$$) {
          return $self$$27$$.$_addPromise$(function() {
            return Promise.resolve(void 0);
          });
        }
      } else {
        return $self$$27$$.add($newModel$$7$$, $addOpts$$1$$);
      }
    }
    var $self$$27$$ = this;
    ...
    $options$$94$$.success = function $$options$$94$$$success$($model$$36$$, $resp$$6$$, $successOpts$$) {
      ...
      $options$$94$$.wait && $self$$27$$.add($newModel$$5$$, $options$$94$$);
      $callback$$75$$ && $callback$$75$$.call(null != $context$$22$$ ? $context$$22$$ : $self$$27$$, $model$$36$$, $resp$$6$$, $options$$94$$);
    };
    if (null == $newModel$$5$$) {
      return!1;
    }
    ...
    if ($deferred$$13$$ || this.$IsVirtual$()) {
      return new Promise(function($resolve$$16$$) {
        $addOpts$$.merge = !0;
        $addOpts$$.deferred = !0;
        $doAdd$$1$$($newModel$$5$$, $addOpts$$).then(function() {
          $options$$94$$.success = function $$options$$94$$$success$($model$$38$$, $resp$$7$$, $successOpts$$1$$) {
            ...
            $options$$94$$.wait ? ($self$$27$$.$IsVirtual$() && ($addOpts$$.force = !0), $self$$27$$.add($newModel$$5$$, $addOpts$$).then(function() {
              $callback$$75$$ && $callback$$75$$.call(null != $context$$22$$ ? $context$$22$$ : $self$$27$$, $model$$38$$, $resp$$7$$, $options$$94$$);
              $resolve$$16$$($model$$38$$);
            })) : ($callback$$75$$ && $callback$$75$$.call(null != $context$$22$$ ? $context$$22$$ : $self$$27$$, $model$$38$$, $resp$$7$$, $options$$94$$), $resolve$$16$$($model$$38$$));
          };
          var $model$$37$$ = $doSave$$($newModel$$5$$, $options$$94$$);
          $model$$37$$ || $resolve$$16$$($model$$37$$);
        });
      });
    }
    $addOpts$$.merge = !0;
  ...
  $oj$$1$$.$Collection$.prototype.$pluck$ = function $$oj$$1$$$$Collection$$$$pluck$$($attr$$9$$) {
    ...
    for ($i$$62$$ = 0;$i$$62$$ < this.$_getLength$();$i$$62$$ += 1) {
      $arr$$16$$.push(this.at($i$$62$$).get($attr$$9$$));
    }
    return $arr$$16$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_whereInternal$ = function $$oj$$1$$$$Collection$$$$_whereInternal$$($attrs$$14$$, $options$$96$$) {
    ...
    var $deferred$$14$$ = this.$_getDeferred$($options$$96$$), $self$$28$$ = this;
    if (this.$IsVirtual$()) {
      return new Promise(function($resolve$$17$$, $reject$$17$$) {
        $self$$28$$.$_fetchOnly$({query:$attrs$$14$$, all:!0, success:function($collection$$24$$, $fetchedModels$$1$$) {
          $resolve$$17$$($fetchedModels$$1$$);
        }, error:function($xhr$$23$$, $status$$15$$, $error$$15$$) {
          $reject$$17$$($oj$$1$$.$Collection$.$_createRejectionError$($xhr$$23$$, $status$$15$$, $error$$15$$, $self$$28$$, $options$$96$$, !0));
        }});
      });
    }
    var $arr$$17$$ = [], $i$$63$$, $m$$7$$;
    for ($i$$63$$ = 0;$i$$63$$ < this.$_getLength$();$i$$63$$ += 1) {
      $m$$7$$ = this.at($i$$63$$), $m$$7$$.$Contains$($attrs$$14$$) && $arr$$17$$.push($m$$7$$);
    }
    return $deferred$$14$$ ? new Promise(function($resolve$$18$$) {
      $resolve$$18$$($arr$$17$$);
    }) : $arr$$17$$;
  };
  $oj$$1$$.$Collection$.prototype.$whereToCollection$ = function $$oj$$1$$$$Collection$$$$whereToCollection$$($attrs$$15$$, $options$$98$$) {
    ...
    var $deferred$$15_models$$9_newCollection$$ = this.$_getDeferred$($options$$98$$), $self$$29$$ = this;
    if (this.$IsVirtual$() || $deferred$$15_models$$9_newCollection$$) {
      return $self$$29$$.$_addPromise$(function() {
        return new Promise(function($resolve$$19$$, $reject$$19$$) {
          return $self$$29$$.$_whereInternal$($attrs$$15$$, $options$$98$$).then(function($collection$$25_models$$10$$) {
            $collection$$25_models$$10$$ = $self$$29$$.$_makeNewCollection$($collection$$25_models$$10$$);
            $resolve$$19$$($collection$$25_models$$10$$);
          }, function($err$$7$$) {
            $reject$$19$$($err$$7$$);
          });
        });
  ...
  $oj$$1$$.$Collection$.prototype.$_makeNewCollection$ = function $$oj$$1$$$$Collection$$$$_makeNewCollection$$($models$$11$$) {
    var $collection$$26$$ = this.$_cloneInternal$(!1);
    $collection$$26$$.$_setModels$($models$$11$$, !1);
    $collection$$26$$.$_resetLRU$();
    $collection$$26$$.$_setLength$();
    return $collection$$26$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$sortBy$ = function $$oj$$1$$$$Collection$$$$sortBy$$($iterator$$2$$, $context$$25$$) {
    var $retArr$$2$$ = [], $self$$30$$;
    this.$_throwErrIfVirtual$("sortBy");
    this.$_getModels$().forEach(function($model$$40$$) {
      $retArr$$2$$.push($model$$40$$);
    });
    $self$$30$$ = this;
    $retArr$$2$$.sort(function($a$$96$$, $b$$50$$) {
      var $keyA$$3$$, $keyB$$3$$;
      if ($$$$1$$.isFunction($iterator$$2$$)) {
        return $keyA$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$30$$, $a$$96$$), $keyB$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$30$$, $b$$50$$), $oj$$1$$.$Collection$.$_compareKeys$($keyA$$3$$, $keyB$$3$$, $self$$30$$.sortDirection);
      }
      $keyA$$3$$ = $a$$96$$.get($iterator$$2$$);
      $keyB$$3$$ = $b$$50$$.get($iterator$$2$$);
      return $oj$$1$$.$Collection$.$_compareKeys$($keyA$$3$$, $keyB$$3$$, $self$$30$$.sortDirection);
    });
    return $retArr$$2$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.min = function $$oj$$1$$$$Collection$$$min$($iterator$$5$$, $context$$28$$) {
    ...
    this.$_getModels$().forEach(function($model$$43$$, $i$$64$$) {
      1 <= $i$$64$$ && ($currValue$$ = $iterator$$5$$.call($context$$28$$ || this, $model$$43$$), $currValue$$ < $minModelValue$$ && ($minModel$$ = $model$$43$$, $minModelValue$$ = $currValue$$));
    }, this);
    return $minModel$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.max = function $$oj$$1$$$$Collection$$$max$($iterator$$6$$, $context$$29$$) {
    ...
    this.$_getModels$().forEach(function($model$$44$$, $i$$65$$) {
      1 <= $i$$65$$ && ($currValue$$1$$ = $iterator$$6$$.call($context$$29$$ || this, $model$$44$$), $currValue$$1$$ > $maxModelValue$$ && ($maxModel$$ = $model$$44$$, $maxModelValue$$ = $currValue$$1$$));
    }, this);
    return $maxModel$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$without$ = function $$oj$$1$$$$Collection$$$$without$$($var_args$$46$$) {
    ...
    for (var $model$$46$$, $i$$66$$ = 0;$i$$66$$ < this.$_getModels$().length;$i$$66$$++) {
      $add$$ = !0;
      $model$$46$$ = this.$_getModel$($i$$66$$);
  ...
  $oj$$1$$.$Collection$.prototype.$difference$ = function $$oj$$1$$$$Collection$$$$difference$$($var_args$$47$$) {
    ...
    for (var $model$$47$$, $i$$67$$ = 0;$i$$67$$ < this.$_getModels$().length;$i$$67$$++) {
      $add$$1$$ = !0;
      $model$$47$$ = this.$_getModel$($i$$67$$);
  ...
  $oj$$1$$.$Collection$.prototype.$any$ = function $$oj$$1$$$$Collection$$$$any$$($iterator$$8$$, $context$$31$$) {
    ...
    for (var $model$$48$$, $i$$68$$ = 0;$i$$68$$ < this.$_getModelsLength$();$i$$68$$ += 1) {
      if ($model$$48$$ = this.$_getModel$($i$$68$$), $iterator$$8$$.call($context$$31$$ || this, $model$$48$$)) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$1$$.$Collection$.prototype.$findWhere$ = function $$oj$$1$$$$Collection$$$$findWhere$$($attrs$$16$$, $options$$99$$) {
    var $arr$$18_deferred$$16$$ = this.$_getDeferred$($options$$99$$), $self$$31$$ = this;
    if (this.$IsVirtual$() || $arr$$18_deferred$$16$$) {
      return this.$_addPromise$(function() {
        return new Promise(function($resolve$$20$$) {
          $self$$31$$.$_whereInternal$($attrs$$16$$, $options$$99$$).then(function($modelList$$1$$) {
            $modelList$$1$$ && 0 < $modelList$$1$$.length && $resolve$$20$$($modelList$$1$$[0]);
            $resolve$$20$$(null);
          });
        });
      });
  ...
  $oj$$1$$.$Collection$.prototype.slice = function $$oj$$1$$$$Collection$$$slice$($start$$25$$, $end$$7$$, $options$$100_ret$$1$$) {
    var $deferred$$17_i$$69$$ = this.$_getDeferred$($options$$100_ret$$1$$);
    $options$$100_ret$$1$$ = [];
    if (void 0 === $end$$7$$) {
    ...
    if ($deferred$$17_i$$69$$ || this.$IsVirtual$()) {
      var $self$$32$$ = this;
      return this.$_addPromise$(function() {
        return $self$$32$$.$IterativeAt$($start$$25$$, $end$$7$$);
      });
    }
    for ($deferred$$17_i$$69$$ = $start$$25$$;$deferred$$17_i$$69$$ < $end$$7$$;$deferred$$17_i$$69$$ += 1) {
      $options$$100_ret$$1$$.push(this.$_getModel$($deferred$$17_i$$69$$));
    }
  ...
  $oj$$1$$.$Collection$.$_removeAfterSet$ = function $$oj$$1$$$$Collection$$$_removeAfterSet$$($collection$$27$$, $models$$13$$, $i$$70_remove$$, $foundModels$$, $options$$102$$) {
    if ($i$$70_remove$$) {
      for ($i$$70_remove$$ = $models$$13$$.length - 1;0 <= $i$$70_remove$$;$i$$70_remove$$ -= 1) {
        -1 == $foundModels$$.indexOf($i$$70_remove$$) && $collection$$27$$.$_removeInternal$($models$$13$$[$i$$70_remove$$], $i$$70_remove$$, $options$$102$$);
      }
    }
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_setInternal$ = function $$oj$$1$$$$Collection$$$$_setInternal$$($i$$71_models$$14$$, $parse$$3_swapped$$, $options$$103$$, $deferred$$19$$) {
    ...
    $parse$$3_swapped$$ && ($i$$71_models$$14$$ = this.parse($i$$71_models$$14$$));
    $modelList$$2$$ = Array.isArray($i$$71_models$$14$$) ? $i$$71_models$$14$$ : [$i$$71_models$$14$$];
    if ($deferred$$19$$) {
      var $self$$33$$ = this;
      return this.$_addPromise$(function() {
        return $self$$33$$.$_deferredSet$($modelList$$2$$, $self$$33$$.$_getModels$(), $options$$103$$, $remove$$2$$, $add$$3$$, $merge$$1$$);
      });
    }
    $parse$$3_swapped$$ = !1;
    for ($i$$71_models$$14$$ = 0;$i$$71_models$$14$$ < $modelList$$2$$.length;$i$$71_models$$14$$ += 1) {
      if ($currModel_obj$$48$$ = this.$_updateModel$(this.$_newModel$($modelList$$2$$[$i$$71_models$$14$$], $options$$103$$, !0), $add$$3$$, $merge$$1$$, $deferred$$19$$), -1 !== $currModel_obj$$48$$) {
        var $currModel_obj$$48$$ = this.$_swapModels$($currModel_obj$$48$$, $i$$71_models$$14$$, $remove$$2$$, $add$$3$$), $newLoc$$ = $currModel_obj$$48$$.index;
  ...
  $oj$$1$$.$Collection$.prototype.$_deferredSet$ = function $$oj$$1$$$$Collection$$$$_deferredSet$$($modelList$$3$$, $modelsCopy$$, $options$$104$$, $remove$$3$$, $add$$4$$, $merge$$2$$) {
    var $foundModels$$2$$ = [], $i$$72$$, $self$$34$$ = this;
    return new Promise(function($allResolve$$2$$, $allReject$$2$$) {
      function $doTask$$2$$($index$$71$$) {
        return new Promise(function($resolve$$21$$, $reject$$21$$) {
          $self$$34$$.$_updateModel$($self$$34$$.$_newModel$($modelList$$3$$[$index$$71$$], $options$$104$$, !0), $add$$4$$, $merge$$2$$, !0).then(function($currModel$$1$$) {
            -1 !== $currModel$$1$$ && $foundModels$$2$$.push($currModel$$1$$);
            $resolve$$21$$($index$$71$$ + 1);
          }, $reject$$21$$);
        });
      }
      var $currentStep$$2$$ = Promise.resolve(0);
      for ($i$$72$$ = 0;$i$$72$$ < $modelList$$3$$.length;$i$$72$$ += 1) {
        $currentStep$$2$$ = $currentStep$$2$$.then($doTask$$2$$);
      }
      $currentStep$$2$$.then(function() {
        $oj$$1$$.$Collection$.$_removeAfterSet$($self$$34$$, $modelsCopy$$, $remove$$3$$, $foundModels$$2$$, $options$$104$$);
        $allResolve$$2$$(void 0);
      }, $allReject$$2$$);
    });
  };
  $oj$$1$$.$Collection$.prototype.$_updateModel$ = function $$oj$$1$$$$Collection$$$$_updateModel$$($model$$49$$, $add$$5$$, $merge$$3$$, $deferred$$20$$) {
    function $update$$($collection$$28$$, $found$$2$$, $deferred$$21$$) {
        ...
        if ($merge$$3$$) {
          ...
          if ($deferred$$21$$) {
            return new Promise(function($resolve$$22$$) {
              $collection$$28$$.$_addInternal$($model$$49$$, $opt$$15$$, !1, !0).then(function() {
                $resolve$$22$$($index$$72$$);
              });
            });
          }
          $collection$$28$$.add($model$$49$$, $opt$$15$$);
        }
      } else {
        if ($add$$5$$) {
          if ($deferred$$21$$) {
            return new Promise(function($resolve$$23$$) {
              $collection$$28$$.$_addInternal$($model$$49$$, $opt$$15$$, !1, !0).then(function() {
                $resolve$$23$$($collection$$28$$.$_getLength$() - 1);
              });
            });
          }
          $collection$$28$$.add($model$$49$$);
          $index$$72$$ = $collection$$28$$.$_getLength$() - 1;
        }
      }
      return $index$$72$$;
    }
    if ($deferred$$20$$ || this.$IsVirtual$()) {
      ...
      return new Promise(function($resolve$$24$$) {
        $self$$35$$.$_getInternal$($model$$49$$, {silent:!0}, $deferred$$20$$).then(function($found$$3$$) {
          $update$$($self$$35$$, $found$$3$$, !0).then(function($index$$73$$) {
            $resolve$$24$$($index$$73$$);
          });
        });
      });
  ...
  $oj$$1$$.$Collection$.prototype.first = function $$oj$$1$$$$Collection$$$first$($n$$12$$, $options$$105$$) {
    var $deferred$$22_i$$73_virtual$$2$$ = this.$_getDeferred$($options$$105$$), $elementCount$$ = this.$_getLength$(), $retArray$$2$$ = [];
    $n$$12$$ ? $elementCount$$ = $n$$12$$ : $n$$12$$ = 1;
    $deferred$$22_i$$73_virtual$$2$$ = this.$IsVirtual$() || $deferred$$22_i$$73_virtual$$2$$;
    if (1 === $n$$12$$) {
      if ($deferred$$22_i$$73_virtual$$2$$) {
        var $self$$36$$ = this;
        return this.$_addPromise$(function() {
          return $self$$36$$.$_deferredAt$(0, null);
        });
      }
    ...
    if ($deferred$$22_i$$73_virtual$$2$$) {
      return $self$$36$$ = this, this.$_addPromise$(function() {
        return $self$$36$$.$IterativeAt$(0, $elementCount$$);
      });
    }
    for ($deferred$$22_i$$73_virtual$$2$$ = 0;$deferred$$22_i$$73_virtual$$2$$ < $elementCount$$;$deferred$$22_i$$73_virtual$$2$$ += 1) {
      $retArray$$2$$.push(this.$_getModel$($deferred$$22_i$$73_virtual$$2$$));
    }
    return $retArray$$2$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.indexOf = function $$oj$$1$$$$Collection$$$indexOf$($model$$51$$, $options$$106$$) {
    ...
    if (this.$IsVirtual$() || $deferred$$23$$) {
      var $self$$37$$ = this;
      return this.$_addPromise$(function() {
        return $self$$37$$.$_getInternal$($model$$51$$, null, !0).then(function($loc$$2$$) {
          return $loc$$2$$.index;
        });
      });
    }
  ...
  $oj$$1$$.$Collection$.prototype.contains = function $$oj$$1$$$$Collection$$$contains$($model$$52$$, $options$$107$$) {
    ...
    if (this.$IsVirtual$() || $deferred$$24$$) {
      var $self$$38$$ = this;
      return this.$_addPromise$(function() {
        return $self$$38$$.$_getInternal$($model$$52$$, null, !0).then(function($loc$$3$$) {
          return-1 < $loc$$3$$.index;
        });
      });
    }
  ...
  $oj$$1$$.$Collection$.prototype.pop = function $$oj$$1$$$$Collection$$$pop$($options$$108$$) {
    ...
    if (this.$IsVirtual$() || $deferred$$25_m$$8$$) {
      ...
      return this.at(this.$_getLength$() - 1, {deferred:$deferred$$25_m$$8$$}).then(function($model$$54$$) {
        $self$$39$$.remove($model$$54$$, $options$$108$$);
        return $model$$54$$;
      });
    }
  ...
  $oj$$1$$.$Collection$.prototype.lastIndexOf = function $$oj$$1$$$$Collection$$$lastIndexOf$($model$$55$$, $fromIndex$$2$$) {
    ...
    for ($i$$74$$ = this.$_getLength$() - 1;$i$$74$$ >= $fromIndex$$2$$;$i$$74$$ -= 1) {
      if ($oj$$1$$.$Object$.$__innerEquals$($model$$55$$, this.at($i$$74$$))) {
        return $i$$74$$;
      }
    }
    return-1;
  ...
  $oj$$1$$.$Collection$.$_getQueryString$ = function $$oj$$1$$$$Collection$$$_getQueryString$$($q_queries$$) {
    ...
    var $str$$12$$ = "", $query$$3$$, $exp_value$$66$$, $i$$75$$, $prop$$50$$;
    for ($i$$75$$ = 0;$i$$75$$ < $q_queries$$.length;$i$$75$$++) {
      $query$$3$$ = $q_queries$$[$i$$75$$];
  ...
  $oj$$1$$.$Collection$.prototype.$ModifyOptionsForCustomURL$ = function $$oj$$1$$$$Collection$$$$ModifyOptionsForCustomURL$$($attrs$$17_comparator$$7_options$$110$$) {
    var $opt$$16$$ = {}, $i$$76_prop$$51$$;
    for ($i$$76_prop$$51$$ in $attrs$$17_comparator$$7_options$$110$$) {
      $attrs$$17_comparator$$7_options$$110$$.hasOwnProperty($i$$76_prop$$51$$) && ($opt$$16$$[$i$$76_prop$$51$$] = $attrs$$17_comparator$$7_options$$110$$[$i$$76_prop$$51$$]);
    }
    if (($attrs$$17_comparator$$7_options$$110$$ = this.comparator) && $oj$$1$$.$StringUtils$.$isString$($attrs$$17_comparator$$7_options$$110$$)) {
      ...
      for ($i$$76_prop$$51$$ = 0;$i$$76_prop$$51$$ < $attrs$$17_comparator$$7_options$$110$$.length;$i$$76_prop$$51$$++) {
        $opt$$16$$.sort = 0 === $i$$76_prop$$51$$ ? $attrs$$17_comparator$$7_options$$110$$[$i$$76_prop$$51$$] : $opt$$16$$.sort + ("," + $attrs$$17_comparator$$7_options$$110$$[$i$$76_prop$$51$$]);
      }
  ...
  $oj$$1$$.$Collection$.prototype.$GetCollectionFetchUrl$ = function $$oj$$1$$$$Collection$$$$GetCollectionFetchUrl$$($attrs$$18_comparator$$8_options$$112_queryString$$) {
    ...
    if (this.$IsVirtual$()) {
      var $all_sortDirStr$$ = $attrs$$18_comparator$$8_options$$112_queryString$$.all, $i$$77_limit$$4_totalResults$$4$$ = null;
      $i$$77_limit$$4_totalResults$$4$$ = $all_sortDirStr$$ ? ($i$$77_limit$$4_totalResults$$4$$ = this.totalResults) ? $i$$77_limit$$4_totalResults$$4$$ : this.$_getFetchSize$($attrs$$18_comparator$$8_options$$112_queryString$$) : this.$_getFetchSize$($attrs$$18_comparator$$8_options$$112_queryString$$);
      $url$$19$$ = $url$$19$$ && -1 < $url$$19$$.indexOf("?") ? $url$$19$$ + "\x26" : $url$$19$$ + "?";
      $url$$19$$ += "limit\x3d" + $i$$77_limit$$4_totalResults$$4$$;
      ...
      if (($attrs$$18_comparator$$8_options$$112_queryString$$ = this.comparator) && $oj$$1$$.$StringUtils$.$isString$($attrs$$18_comparator$$8_options$$112_queryString$$)) {
        for ($attrs$$18_comparator$$8_options$$112_queryString$$ = this.$_getSortAttrs$($attrs$$18_comparator$$8_options$$112_queryString$$), $all_sortDirStr$$ = this.$_getSortDirStr$(), $i$$77_limit$$4_totalResults$$4$$ = 0;$i$$77_limit$$4_totalResults$$4$$ < $attrs$$18_comparator$$8_options$$112_queryString$$.length;$i$$77_limit$$4_totalResults$$4$$++) {
          $url$$19$$ = 0 === $i$$77_limit$$4_totalResults$$4$$ ? $url$$19$$ + ("\x26orderBy\x3d" + $attrs$$18_comparator$$8_options$$112_queryString$$[$i$$77_limit$$4_totalResults$$4$$] + ":" + $all_sortDirStr$$) : $url$$19$$ + ("," + $attrs$$18_comparator$$8_options$$112_queryString$$[$i$$77_limit$$4_totalResults$$4$$] + ":" + $all_sortDirStr$$);
        }
      }
  ...
  $oj$$1$$.$Collection$.prototype.sync = function $$oj$$1$$$$Collection$$$sync$($method$$6$$, $collection$$29$$, $options$$113$$) {
    return window.oj.sync($method$$6$$, $collection$$29$$, $options$$113$$);
  };
