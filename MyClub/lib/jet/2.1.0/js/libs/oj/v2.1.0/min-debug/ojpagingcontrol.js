...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "hammerjs", "ojs/ojpagingtabledatasource", "ojs/ojinputtext", "ojs/ojjquery-hammer"], function($oj$$10$$, $$$$10$$, $compCore$$, $Hammer$$2$$) {
  (function() {
    ...
    $_DATA_ATTR_PAGE_NUM$:"data-oj-pagenum", $_OPTION_ENABLED$:"enabled", $_OPTION_DISABLED$:"disabled", $_TAB_INDEX$:"tabindex", $_MODE$:{$_LOAD_MORE$:"loadMore", $_PAGE$:"page"}, $_PAGE_OPTION_LAYOUT$:{$_AUTO$:"auto", $_ALL$:"all", $_INPUT$:"input", $_RANGE_TEXT$:"rangeText", $_PAGES$:"pages", $_NAV$:"nav"}, $_PAGE_OPTION_DEFAULT_MAX_PAGE_LINKS$:6, $_TYPE$:{$_NUMBERS$:"numbers", $_DOTS$:"dots"}, firstPage:function() {
      ...
      this._super();
      this.$_refresh$();
    }, getNodeBySubId:function($index$$98_locator$$10$$) {
      if (null == $index$$98_locator$$10$$) {
        return this.element ? this.element[0] : null;
      }
      var $subId$$5$$ = $index$$98_locator$$10$$.subId, $retval$$ = null;
      ...
      "oj-pagingcontrol-nav-page" === $subId$$5$$ ? ($index$$98_locator$$10$$ = $index$$98_locator$$10$$.index, $retval$$ = this.$_getPagingControlContainer$().find("[" + this.$_DATA_ATTR_PAGE_NUM$ + "\x3d" + $index$$98_locator$$10$$ + "]")[0]) : "oj-pagingcontrol-load-more-link" === $subId$$5$$ ? $retval$$ = this.$_getPagingControlContainer$().find("." + this.$_CSS_CLASSES$.$_PAGING_CONTROL_LOAD_MORE_LINK_CLASS$)[0] : "oj-pagingcontrol-load-more-range" === $subId$$5$$ ? $retval$$ = this.$_getPagingControlContainer$().find("." + 
      ...
      this.$_mode$ = $options$$223$$.mode;
      $options$$223$$.mode == this.$_MODE$.$_LOAD_MORE$ ? (this.$_createPagingControlLoadMore$(), this.$_createPagingControlLoadMoreLink$(), this.$_createPagingControlLoadMoreRange$()) : this.$_createPagingControlNav$();
    }, $_events$:{"mouseup .oj-pagingcontrol-loadmore-link":function($event$$78$$) {
      this.loadNext();
      $$$$10$$($event$$78$$.target).data("_mouseup", !0);
      $event$$78$$.preventDefault();
    }, "click .oj-pagingcontrol-loadmore-link":function($event$$79$$) {
      $$$$10$$($event$$79$$.target).data("_mouseup") ? $$$$10$$($event$$79$$.target).data("_mouseup", !1) : this.loadNext();
      $event$$79$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-dot":function($event$$80$$) {
      if (!$$$$10$$($event$$80$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $pageNum$$ = $$$$10$$($event$$80$$.currentTarget).attr("data-oj-pagenum"), $self$$56$$ = this;
        this.page($pageNum$$).then(function() {
          $self$$56$$ = null;
        }, function($err$$8$$) {
          var $errSummary$$1$$ = $self$$56$$.$getTranslatedString$($self$$56$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$1$$ + "\n" + $err$$8$$);
          $self$$56$$ = null;
        });
      }
      $event$$80$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-page":function($event$$81$$) {
      if (!$$$$10$$($event$$81$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $pageNum$$1$$ = $$$$10$$($event$$81$$.currentTarget).attr("data-oj-pagenum"), $self$$57$$ = this;
        this.page($pageNum$$1$$).then(function() {
          $self$$57$$ = null;
        }, function($err$$9$$) {
          var $errSummary$$2$$ = $self$$57$$.$getTranslatedString$($self$$57$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$2$$ + "\n" + $err$$9$$);
          $self$$57$$ = null;
        });
      }
      $event$$81$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-first":function($event$$82$$) {
      if (!$$$$10$$($event$$82$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$58$$ = this;
        this.firstPage().then(function() {
          $self$$58$$ = null;
        }, function($err$$10$$) {
          var $errSummary$$3$$ = $self$$58$$.$getTranslatedString$($self$$58$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$3$$ + "\n" + $err$$10$$);
          $self$$58$$ = null;
        });
      }
      $event$$82$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-previous":function($event$$83$$) {
      if (!$$$$10$$($event$$83$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$59$$ = this;
        this.previousPage().then(function() {
          $self$$59$$ = null;
        }, function($err$$11$$) {
          var $errSummary$$4$$ = $self$$59$$.$getTranslatedString$($self$$59$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$4$$ + "\n" + $err$$11$$);
          $self$$59$$ = null;
        });
      }
      $event$$83$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-next":function($event$$84$$) {
      if (!$$$$10$$($event$$84$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$60$$ = this;
        this.nextPage().then(function() {
          $self$$60$$ = null;
        }, function($err$$12$$) {
          var $errSummary$$5$$ = $self$$60$$.$getTranslatedString$($self$$60$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$5$$ + "\n" + $err$$12$$);
          $self$$60$$ = null;
        });
      }
      $event$$84$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-last":function($event$$85$$) {
      if (!$$$$10$$($event$$85$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$61$$ = this;
        this.lastPage().then(function() {
          $self$$61$$ = null;
        }, function($err$$13$$) {
          var $errSummary$$6$$ = $self$$61$$.$getTranslatedString$($self$$61$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$6$$ + "\n" + $err$$13$$);
          $self$$61$$ = null;
        });
      }
      $event$$85$$.preventDefault();
    }, "keypress .oj-pagingcontrol-nav-input":function($event$$86$$) {
      13 == $event$$86$$.which && $event$$86$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-first":function($event$$87$$) {
      $$$$10$$($event$$87$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$87$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$87$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-previous":function($event$$88$$) {
    ...
    }, "mousedown .oj-pagingcontrol-nav-next":function($event$$89$$) {
    ...
    }, "mousedown .oj-pagingcontrol-nav-last":function($event$$90$$) {
    ...
    }, _setOption:function($key$$49$$, $value$$193$$) {
      this._superApply(arguments);
      this.$_invokeDataPage$(0, !0);
      if (this.options.mode != this.$_MODE$.$_LOAD_MORE$ && "pageOptions" == $key$$49$$) {
      ...
      if ($activeElement$$.hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_PAGE_CLASS$)) {
        var $pageNum$$2$$ = $activeElement$$.attr("data-oj-pagenum"), $self$$62$$ = this;
        setTimeout(function() {
          0 <= $pageNum$$2$$ && $self$$62$$.$_getPagingControlContent$().find("div[data-oj-pagenum\x3d" + $pageNum$$2$$ + "]").focus();
          $self$$62$$ = $pageNum$$2$$ = null;
        }, 100);
      } else {
        $activeElement$$.hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_FIRST_CLASS$) ? ($self$$62$$ = this, setTimeout(function() {
          $self$$62$$.$_getPagingControlContent$().find("." + $self$$62$$.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_FIRST_CLASS$).focus();
          $self$$62$$ = null;
        }, 100)) : $activeElement$$.hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_PREVIOUS_CLASS$) ? ($self$$62$$ = this, setTimeout(function() {
          $self$$62$$.$_getPagingControlContent$().find("." + $self$$62$$.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_PREVIOUS_CLASS$).focus();
          $self$$62$$ = null;
        }, 100)) : $activeElement$$.hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_NEXT_CLASS$) ? ($self$$62$$ = this, setTimeout(function() {
          $self$$62$$.$_getPagingControlContent$().find("." + $self$$62$$.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_NEXT_CLASS$).focus();
          $self$$62$$ = null;
        }, 100)) : $activeElement$$.hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_LAST_CLASS$) ? ($self$$62$$ = this, setTimeout(function() {
          $self$$62$$.$_getPagingControlContent$().find("." + $self$$62$$.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_LAST_CLASS$).focus();
          $self$$62$$ = null;
        }, 100)) : $activeElement$$.hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_CLASS$) && ($self$$62$$ = this, setTimeout(function() {
          $self$$62$$.$_getPagingControlContent$().find("." + $self$$62$$.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_CLASS$).focus();
          $self$$62$$ = null;
        }, 100));
      }
      this.$_queueRefresh$();
    }, $_handleDataPage$:function($event$$100$$) {
      $event$$100$$.page != $event$$100$$.previousPage && this.$_queueRefresh$();
    }, $_handleDataReset$:function() {
      this.$_invokeDataPage$(0, !1);
    }, $_handleDataRefresh$:function() {
      this.$_queueRefresh$();
    }, $_handleDataSort$:function($event$$103$$) {
      this.options.mode == this.$_MODE$.$_LOAD_MORE$ && this.$_handleDataReset$($event$$103$$);
    }, $_handleDataRowAdd$:function($event$$104$$) {
      this.options.mode == this.$_MODE$.$_PAGE$ && this.$_isOperationOnCurrentPage$($event$$104$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handleDataRowRemove$:function($event$$105$$) {
      0 < this.$_getTotalPages$() && this.$_getCurrentPage$() > this.$_getTotalPages$() - 1 ? this.$_invokeDataPage$(this.$_getTotalPages$() - 1, !0) : this.$_isOperationOnCurrentPage$($event$$105$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handlePageChange$:function($event$$106$$, $data$$69$$) {
      if ("value" == $data$$69$$.option) {
        var $page$$5$$ = $data$$69$$.value;
        if ($page$$5$$ != this.$_getCurrentPage$() + 1 && !isNaN($page$$5$$) && 0 < $page$$5$$) {
          var $page$$5$$ = Math.round($page$$5$$), $self$$63$$ = this;
          this.page($page$$5$$ - 1).then(function() {
            $self$$63$$ = null;
          }, function($err$$14$$) {
            var $errSummary$$7$$ = $self$$63$$.$getTranslatedString$($self$$63$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
      ...
      var $data$$70$$ = this.$_getData$(), $self$$64$$ = this;
      return new Promise(function($resolve$$25$$, $reject$$25$$) {
        null != $data$$70$$ ? ($data$$70$$.setPage($page$$6$$, {pageSize:$self$$64$$.options.pageSize}).then(function() {
          $resolve$$25$$(null);
        }, function($error$$24$$) {
          $reject$$25$$($error$$24$$);
        }), $self$$64$$ = $data$$70$$ = null) : ($self$$64$$ = null, $resolve$$25$$(null));
      });
      ...
      if (!this.$_isTotalSizeConfidenceActual$() || $data$$71$$.totalSize() > this.$_currentStartIndex$ && this.$_isTotalSizeConfidenceActual$()) {
        ...
        return new Promise(function($resolve$$26$$, $reject$$26$$) {
          $data$$71$$.fetch({startIndex:$self$$65$$.$_currentStartIndex$, pageSize:$pageSize$$}).then(function($result$$28$$) {
            $resolve$$26$$($result$$28$$);
          }, function() {
            $reject$$26$$(null);
          });
          $self$$65$$ = $data$$71$$ = null;
        });
      }
      return Promise.resolve();
    }, $_isOperationOnCurrentPage$:function($event$$107$$) {
      if (null == $event$$107$$) {
        return!1;
      }
      ...
      if (null != $event$$107$$.index) {
        if ($rowIdx$$ = $event$$107$$.index, this.options.mode == this.$_MODE$.$_LOAD_MORE$ && ($data$$72_startIndex$$4$$ = 0), $rowIdx$$ >= $data$$72_startIndex$$4$$ && $rowIdx$$ < $endIndex_pageSize$$1$$) {
          return!0;
        }
      } else {
        if (null != $event$$107$$.indexes) {
          var $i$$140$$;
          for ($i$$140$$ = 0;$i$$140$$ < $event$$107$$.indexes.length;$i$$140$$++) {
            if ($rowIdx$$ = $event$$107$$.indexes[$i$$140$$], this.options.mode == this.$_MODE$.$_LOAD_MORE$ && ($data$$72_startIndex$$4$$ = 0), $rowIdx$$ >= $data$$72_startIndex$$4$$ && $rowIdx$$ < $endIndex_pageSize$$1$$) {
              return!0;
            }
          }
        }
      ...
      this.$_pendingPageFetch$ = this.$_pendingPageFetch$.then(function() {
        $self$$66$$.$_pageFetchCount$--;
        if (0 == $self$$66$$.$_pageFetchCount$ && !$self$$66$$.$_componentDestroyed$) {
          $self$$66$$.$_pendingPageFetch$ = void 0;
          var $data$$74$$ = $self$$66$$.$_getData$();
          null != $data$$74$$ && $data$$74$$.setPage($self$$66$$.$_pageFetchLatestPage$, {pageSize:$self$$66$$.options.pageSize}).then(function() {
            $self$$66$$ = $data$$74$$ = null;
          }, function($error$$26$$) {
            $self$$66$$.$_pageFetchCount$--;
            0 >= $self$$66$$.$_pageFetchCount$ && ($self$$66$$.$_pendingPageFetch$ = void 0, $oj$$10$$.$Logger$.error($error$$26$$), $self$$66$$ = null);
          });
        }
      }, function($error$$27$$) {
        $self$$66$$.$_pageFetchCount$--;
        0 >= $self$$66$$.$_pageFetchCount$ && ($self$$66$$.$_pendingPageFetch$ = void 0, $oj$$10$$.$Logger$.error($error$$27$$), $self$$66$$ = null);
      });
      ...
      this.$_pendingRefreshes$ = this.$_pendingRefreshes$.then(function() {
        $self$$67$$.$_refreshCount$--;
        0 != $self$$67$$.$_refreshCount$ || $self$$67$$.$_componentDestroyed$ || ($self$$67$$.$_pendingRefreshes$ = void 0, $self$$67$$.$_refresh$(), $self$$67$$._trigger("ready"), $self$$67$$ = null);
      }, function($error$$28$$) {
        $self$$67$$.$_refreshCount$--;
        0 == $self$$67$$.$_refreshCount$ && ($self$$67$$.$_pendingRefreshes$ = void 0, $oj$$10$$.$Logger$.error($error$$28$$), $self$$67$$ = null);
      });
      ...
      null != $pagingControlNavInput$$1_pagingControlNavMaxLabel$$ && 0 < $pagingControlNavInput$$1_pagingControlNavMaxLabel$$.length && ($pagingControlNavInput$$1_pagingControlNavMaxLabel$$ = $$$$10$$($pagingControlNavInput$$1_pagingControlNavMaxLabel$$.get(0)), $pagingControlNavInput$$1_pagingControlNavMaxLabel$$.ojInputText("option", "validators", [{type:"numberRange", options:{min:1, max:$maxPageVal$$1_size$$19$$}}]), $pagingControlNavInput$$1_pagingControlNavMaxLabel$$.ojInputText("option", 
      "value", this.$_getCurrentPage$() + 1));
      ...
      if (null != $data$$75$$) {
        ...
        for ($i$$141$$ = 0;$i$$141$$ < this.$_dataSourceEventHandlers$.length;$i$$141$$++) {
          ($ev$$ = $data$$75$$.on(this.$_dataSourceEventHandlers$[$i$$141$$].eventType, this.$_dataSourceEventHandlers$[$i$$141$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$141$$].eventHandler = $ev$$);
        }
      }
    }, $_registerResizeListener$:function($element$$72$$) {
      if (!this.$_isResizeListenerAdded$) {
        var $self$$68$$ = this;
        $oj$$10$$.$DomUtils$.$addResizeListener$($element$$72$$[0], function() {
          $self$$68$$.$_queueRefresh$();
        }, 50);
      ...
      if ($oj$$10$$.$DomUtils$.$isTouchSupported$() && this.options.mode == this.$_MODE$.$_PAGE$) {
        ...
        if (null != $pagingControlNavArrowSection$$2$$) {
          ...
          if ("vertical" == this.options.pageOptions.orientation) {
            var $options$$224$$ = {recognizers:[[$Hammer$$2$$.Swipe, {direction:$Hammer$$2$$.DIRECTION_VERTICAL}]]};
            this.$_hammerSwipeUp$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$224$$).on("swipeup", function($event$$108$$) {
              $event$$108$$.preventDefault();
              $self$$69$$.nextPage();
            });
            this.$_hammerSwipeDown$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$224$$).on("swipedown", function($event$$109$$) {
              $event$$109$$.preventDefault();
              $self$$69$$.previousPage();
            });
          } else {
            $options$$224$$ = {recognizers:[[$Hammer$$2$$.Swipe, {direction:$Hammer$$2$$.DIRECTION_HORIZONTAL}]]}, this.$_hammerSwipeLeft$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$224$$).on("swipeleft", function($event$$110$$) {
              $event$$110$$.preventDefault();
              $self$$69$$.nextPage();
            }), this.$_hammerSwipeRight$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$224$$).on("swiperight", function($event$$111$$) {
      ...
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$76$$) {
        var $i$$142$$;
        for ($i$$142$$ = 0;$i$$142$$ < this.$_dataSourceEventHandlers$.length;$i$$142$$++) {
          $data$$76$$.off(this.$_dataSourceEventHandlers$[$i$$142$$].eventType, this.$_dataSourceEventHandlers$[$i$$142$$].eventHandler);
        }
      }
    }, $_unregisterChildStateListeners$:function($parent$$7$$) {
      var $self$$70$$ = this;
      $parent$$7$$.find("*").each(function() {
        $self$$70$$.$_UnregisterChildNode$(this);
      });
      $self$$70$$ = null;
    ...
    }, $_createAccLabelSpan$:function($text$$9$$, $className$$5$$) {
      ...
      var $pageNum$$3_totalPages$$ = this.$_getTotalPages$(), $currentPage$$1_i$$143_pageAfterCurrent$$ = this.$_getCurrentPage$();
      $pageSize$$3_parentDiv$$ = this.options.pageSize;
      var $numPagesToAdd$$ = $numLinks_pageList$$;
      $numLinks_pageList$$ = [];
      if (0 <= $currentPage$$1_i$$143_pageAfterCurrent$$) {
        if (this.$_isTotalSizeConfidenceActual$() && $pageNum$$3_totalPages$$ <= $numPagesToAdd$$) {
          for ($numLinks_pageList$$[0] = 0, $currentPage$$1_i$$143_pageAfterCurrent$$ = 1;$currentPage$$1_i$$143_pageAfterCurrent$$ < $pageNum$$3_totalPages$$;$currentPage$$1_i$$143_pageAfterCurrent$$++) {
            $numLinks_pageList$$[$currentPage$$1_i$$143_pageAfterCurrent$$] = $currentPage$$1_i$$143_pageAfterCurrent$$;
          }
        } else {
          $numLinks_pageList$$.push(0);
          0 != $currentPage$$1_i$$143_pageAfterCurrent$$ && $numLinks_pageList$$.push($currentPage$$1_i$$143_pageAfterCurrent$$);
          $currentPage$$1_i$$143_pageAfterCurrent$$ != $pageNum$$3_totalPages$$ - 1 && this.$_isTotalSizeConfidenceActual$() && $numLinks_pageList$$.push($pageNum$$3_totalPages$$ - 1);
          var $numPagesToAdd$$ = $numPagesToAdd$$ - $numLinks_pageList$$.length, $pageBeforeCurrent$$ = $currentPage$$1_i$$143_pageAfterCurrent$$ - 1, $numPagesAfterCurrent$$ = 1;
          for (!this.$_isTotalSizeConfidenceActual$() || $currentPage$$1_i$$143_pageAfterCurrent$$ != $pageNum$$3_totalPages$$ - 1 && $currentPage$$1_i$$143_pageAfterCurrent$$ != $pageNum$$3_totalPages$$ - 2 || ($numPagesAfterCurrent$$ = 0);$numPagesToAdd$$ > $numPagesAfterCurrent$$ && 1 <= $pageBeforeCurrent$$;) {
            $numLinks_pageList$$.push($pageBeforeCurrent$$), $pageBeforeCurrent$$--, $numPagesToAdd$$--;
          }
          $currentPage$$1_i$$143_pageAfterCurrent$$ += 1;
          for (-1 == $pageNum$$3_totalPages$$ && ($numPagesToAdd$$ = 0 < $errSummary$$8_size$$22$$ && $errSummary$$8_size$$22$$ >= $pageSize$$3_parentDiv$$ ? 1 : 0);0 < $numPagesToAdd$$ && ($currentPage$$1_i$$143_pageAfterCurrent$$ <= $pageNum$$3_totalPages$$ || -1 == $pageNum$$3_totalPages$$);) {
            $numLinks_pageList$$.push($currentPage$$1_i$$143_pageAfterCurrent$$), $currentPage$$1_i$$143_pageAfterCurrent$$++, $numPagesToAdd$$--;
          }
        }
        $numLinks_pageList$$.sort(function($a$$100$$, $b$$57$$) {
          return $a$$100$$ - $b$$57$$;
        });
        for ($currentPage$$1_i$$143_pageAfterCurrent$$ = 0;$currentPage$$1_i$$143_pageAfterCurrent$$ < $numLinks_pageList$$.length;$currentPage$$1_i$$143_pageAfterCurrent$$++) {
          $pageNum$$3_totalPages$$ = $numLinks_pageList$$[$currentPage$$1_i$$143_pageAfterCurrent$$], this.$_createPagingControlNavPage$($errDetail$$1_pagingControlNavPagesLinks$$, $pageNum$$3_totalPages$$), $currentPage$$1_i$$143_pageAfterCurrent$$ != $numLinks_pageList$$.length - 1 && $pageNum$$3_totalPages$$ != $numLinks_pageList$$[$currentPage$$1_i$$143_pageAfterCurrent$$ + 1] - 1 && this.$_createPagingControlNavPage$($errDetail$$1_pagingControlNavPagesLinks$$, -1);
        }
