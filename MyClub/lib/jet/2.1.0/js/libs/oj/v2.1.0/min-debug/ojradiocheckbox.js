 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$55$$, $$$$49$$) {
  $oj$$55$$.$__registerWidget$("oj._ojRadioCheckbox", $$$$49$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:null, checked:null, type:null}, label:function() {
  ...
  }, setSelectedClass:function($checked$$5$$) {
    this.element.toggleClass("oj-selected", $checked$$5$$);
    this.$$label$.toggleClass("oj-selected", $checked$$5$$);
    this.$$choiceRow$ && this.$$choiceRow$.toggleClass("oj-selected", $checked$$5$$);
  }, widget:function() {
    ...
    this.$$choiceRow$ && (this.$_AddHoverAndActiveListeners$({element:this.$$choiceRow$}), this._focusable({element:this.$$choiceRow$, applyHighlight:!0}));
    this.$_AddHoverAndActiveListeners$({element:this.$$label$});
    $$$$49$$.each(this.$$label$, function() {
      $$$$49$$(this.childNodes).wrapAll("\x3cspan class\x3d'oj-radiocheckbox-label-text'\x3e\x3c/span\x3e");
      var $iElem$$ = document.createElement("span");
      $iElem$$.setAttribute("class", "oj-radiocheckbox-icon");
      this.appendChild($iElem$$);
    });
    this.$_setup$();
  }, $_SaveAttributes$:function($element$$233$$) {
    this.$_savedClasses$ = $element$$233$$.attr("class");
    ...
    this.options.checked && this.setSelectedClass(this.options.checked);
  }, $_setCheckedOnDom$:function($checked$$6$$) {
    this.element.prop("checked", !!$checked$$6$$);
  ...
  }, _setOption:function($key$$172$$, $value$$304$$) {
    this._superApply(arguments);
    "disabled" === $key$$172$$ && ($value$$304$$ = !!$value$$304$$, this.$_renderDisabled$($value$$304$$));
    "checked" === $key$$172$$ && (this.$_setCheckedOnDom$($value$$304$$), this.setSelectedClass($value$$304$$));
  }, $_getLabelsForElement$:function() {
    var $$allLabels_$labelClosestParent$$ = this.element.closest("label"), $$labelSibling_labelForQuery$$ = "label[for\x3d'" + this.element.prop("id") + "']", $$labelForElems$$ = $$$$49$$($$labelSibling_labelForQuery$$), $$allLabels_$labelClosestParent$$ = $$allLabels_$labelClosestParent$$.add($$labelForElems$$);
    0 === $$labelForElems$$.length && ($$labelSibling_labelForQuery$$ = this.element.siblings($$labelSibling_labelForQuery$$), $$allLabels_$labelClosestParent$$.add($$labelSibling_labelForQuery$$));
    0 === $$allLabels_$labelClosestParent$$.length && $oj$$55$$.$Logger$.warn("Could not find a label associated to the input element.");
    return $$allLabels_$labelClosestParent$$;
    ...
    $oj$$55$$.$Logger$.warn("The radioset/checkboxset's input and label dom should be wrapped in a dom node with class 'oj-choice-row' or 'oj-choice-row-inline'");
    return null;
  }, getNodeBySubId:function($locator$$54_subId$$59$$) {
    var $node$$109$$ = this._super($locator$$54_subId$$59$$);
    $node$$109$$ || ($locator$$54_subId$$59$$ = $locator$$54_subId$$59$$.subId, "oj-radiocheckbox-input" === $locator$$54_subId$$59$$ && ($node$$109$$ = this.element[0]), "oj-radiocheckbox-label" === $locator$$54_subId$$59$$ && ($node$$109$$ = this.label()[0]));
    return $node$$109$$ || null;
  }, _destroy:function() {
    var $ret$$56$$ = this._super();
    ...
    $$$$49$$.each(this.$$label$, function() {
      ...
      var $text$$24$$ = this.getElementsByClassName("oj-radiocheckbox-label-text");
      void 0 !== $text$$24$$ && $$$$49$$($text$$24$$[0].childNodes[0]).unwrap();
    });
    return $ret$$56$$;
  }});
});
