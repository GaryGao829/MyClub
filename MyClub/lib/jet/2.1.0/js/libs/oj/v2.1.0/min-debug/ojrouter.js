...
define(["ojs/ojcore", "knockout", "signals", "promise"], function($oj$$17$$, $ko$$3$$, $signals$$1$$) {
  (function() {
    ...
    function $parseQueryParam$$($keyValPairs_queryString$$2$$) {
      var $params$$18$$ = {};
      $keyValPairs_queryString$$2$$ && ($keyValPairs_queryString$$2$$ = $keyValPairs_queryString$$2$$.split("\x26"), $keyValPairs_queryString$$2$$.forEach(function($key$$97_pair$$) {
        var $parts$$9_value$$246$$ = $key$$97_pair$$.split(/\=(.+)?/);
        $key$$97_pair$$ = $parts$$9_value$$246$$[0];
        $key$$97_pair$$.length && ($params$$18$$[$key$$97_pair$$] || ($params$$18$$[$key$$97_pair$$] = []), $parts$$9_value$$246$$ = $parts$$9_value$$246$$[1] && decodeURIComponent($parts$$9_value$$246$$[1].replace(/\+/g, " ")), $params$$18$$[$key$$97_pair$$].push($parts$$9_value$$246$$));
      }));
      return $params$$18$$;
    }
    ...
    function $getCurrentPath$$($router$$2_sId$$) {
      var $path$$14$$;
      if ($router$$2_sId$$) {
        if ($path$$14$$ = $getCurrentPath$$($router$$2_sId$$.$_parentRouter$)) {
          $path$$14$$ = ($router$$2_sId$$ = $router$$2_sId$$.$_stateId$()) ? $path$$14$$ + ($router$$2_sId$$ + "/") : void 0;
        }
      } else {
        $path$$14$$ = "/";
      }
    ...
    function $_getChildRouter$$($router$$3$$, $value$$247$$) {
      var $subRouter$$;
      $router$$3$$.$_childRouters$.every(function($sr$$) {
        return $sr$$.$_parentState$ && $sr$$.$_parentState$ !== $value$$247$$ ? !0 : ($subRouter$$ = $sr$$, !1);
      });
      return $subRouter$$;
    }
    ...
    function $addStateParam$$($url$$22$$, $extraState$$1$$) {
      if ($extraState$$1$$ && 0 < Object.getOwnPropertyNames($extraState$$1$$).length) {
        ...
        var $JSCompiler_temp_const$$7$$ = $url$$22$$, $compressedState$$inline_892_jsonState$$inline_890$$ = JSON.stringify($extraState$$1$$), $encodedState$$inline_891$$ = encodeURIComponent($compressedState$$inline_892_jsonState$$inline_890$$), $compressedState$$inline_892_jsonState$$inline_890$$ = $oj$$17$$.$LZString$.$compressToEncodedURIComponent$($compressedState$$inline_892_jsonState$$inline_890$$), $useCompressed$$inline_893$$ = !1, $param$$inline_894$$ = "oj_Router\x3d";
        $compressedState$$inline_892_jsonState$$inline_890$$.length <= $encodedState$$inline_891$$.length && ($useCompressed$$inline_893$$ = !0);
        $param$$inline_894$$ = $useCompressed$$inline_893$$ ? $param$$inline_894$$ + ("1" + $compressedState$$inline_892_jsonState$$inline_890$$) : $param$$inline_894$$ + ("0" + $encodedState$$inline_891$$);
        if (1024 < $param$$inline_894$$.length) {
          throw Error("Size of bookmarkable data is too big.");
        }
        $url$$22$$ = $JSCompiler_temp_const$$7$$ + ($sep$$1$$ + $param$$inline_894$$);
      }
      return $url$$22$$;
    }
    function $_findRouterForStateId$$($router$$4$$, $sId$$1$$, $parentStateId$$) {
      var $result$$43$$;
      $router$$4$$.$_childRouters$.every(function($child$$5$$) {
        return $child$$5$$.$_parentState$ && $child$$5$$.$_parentState$ !== $parentStateId$$ || !$child$$5$$.$stateFromIdCallback$($sId$$1$$) ? !0 : ($result$$43$$ = $child$$5$$, !1);
      });
      return $result$$43$$;
    }
    function $_buildState$$($router$$6$$, $path$$15$$) {
      var $newStates$$ = [], $i$$308_routers$$ = [], $canDefault_rt$$ = $router$$6$$, $parts$$10$$ = $path$$15$$.split("/"), $sId$$2$$, $parent$$12$$, $parentStateId$$1$$;
      for ($parts$$10$$.splice(0, 1);$canDefault_rt$$;) {
        $i$$308_routers$$.unshift($canDefault_rt$$), $canDefault_rt$$ = $canDefault_rt$$.$_parentRouter$;
      }
      for (;$sId$$2$$ = $parts$$10$$.shift();) {
        $canDefault_rt$$ = $i$$308_routers$$.shift();
        if (!$canDefault_rt$$) {
          if ($canDefault_rt$$ = $_findRouterForStateId$$($parent$$12$$, $sId$$2$$, $parentStateId$$1$$), !$canDefault_rt$$) {
            $_deferredPath$$ = $path$$15$$;
            break;
          }
        } else {
          if (!$canDefault_rt$$.$stateFromIdCallback$($sId$$2$$)) {
            throw Error('Invalid path "' + $path$$15$$ + '". State id "' + $sId$$2$$ + '" does not exist on router "' + $canDefault_rt$$.$_name$ + '".');
          }
        }
        $newStates$$.push({$router$:$canDefault_rt$$, $stateId$:$sId$$2$$});
        $parent$$12$$ = $canDefault_rt$$;
        $parentStateId$$1$$ = $sId$$2$$;
      }
      $canDefault_rt$$ = !0;
      for ($i$$308_routers$$ = $newStates$$.length - 1;0 <= $i$$308_routers$$ && $canDefault_rt$$;$i$$308_routers$$--) {
        $newStates$$[$i$$308_routers$$].$stateId$ === $newStates$$[$i$$308_routers$$].$router$.$_defaultStateId$ ? $newStates$$[$i$$308_routers$$].$stateId$ = null : $canDefault_rt$$ = !1;
      }
      return $newStates$$;
    }
    function $_executeCallback$$($callback$$109_result$$44$$, $type$$83$$, $stateId$$1$$) {
      ($callback$$109_result$$44$$ = $callback$$109_result$$44$$()) || $oj$$17$$.$Logger$.info("%s is false for state: %s", $type$$83$$, $stateId$$1$$);
      return $callback$$109_result$$44$$;
    }
    function $_chainCallback$$($callback$$110$$, $sequence$$, $type$$84$$, $stateId$$2$$) {
      "function" === typeof $callback$$110$$ && ($sequence$$ = $sequence$$ ? $sequence$$.then(function($result$$45$$) {
        $result$$45$$ && ($result$$45$$ = $_executeCallback$$($callback$$110$$, $type$$84$$, $stateId$$2$$));
        return $result$$45$$;
      }) : new Promise(function($resolve$$30$$) {
        $resolve$$30$$($_executeCallback$$($callback$$110$$, $type$$84$$, $stateId$$2$$));
      }));
      return $sequence$$;
    }
    function $_buildCanExitSequence$$($router$$7$$, $sequence$$1$$) {
      var $currentState$$ = $router$$7$$.$_currentState$(), $canExitCallback_i$$309$$;
      if ($currentState$$) {
        for ($canExitCallback_i$$309$$ = 0;$canExitCallback_i$$309$$ < $router$$7$$.$_childRouters$.length;$canExitCallback_i$$309$$++) {
          $sequence$$1$$ = $_buildCanExitSequence$$($router$$7$$.$_childRouters$[$canExitCallback_i$$309$$], $sequence$$1$$);
        }
        $canExitCallback_i$$309$$ = $currentState$$.$viewModel$ && $currentState$$.$viewModel$.canExit ? $currentState$$.$viewModel$.canExit : $currentState$$.$_canExit$;
        $sequence$$1$$ = $_chainCallback$$($canExitCallback_i$$309$$, $sequence$$1$$, "canExit", $currentState$$.$_id$);
      }
      return $sequence$$1$$;
    }
    function $_canExit$$($router$$8_sequence$$2$$) {
      ...
      $router$$8_sequence$$2$$ ? ($router$$8_sequence$$2$$ = $_buildCanExitSequence$$($router$$8_sequence$$2$$, null), $router$$8_sequence$$2$$ = null === $router$$8_sequence$$2$$ ? Promise.resolve(!0) : $router$$8_sequence$$2$$.then(function($result$$46$$) {
        return $result$$46$$ && !$isTransitionCancelled$$();
    ...
    function $_canEnter$$($allChanges$$, $origin$$) {
      ...
      return $sequence$$3$$ = null === $sequence$$3$$ ? Promise.resolve({$allChanges$:$allChanges$$, origin:$origin$$}) : $sequence$$3$$.then(function($result$$47$$) {
        var $returnObj$$1$$;
        $result$$47$$ && !$isTransitionCancelled$$() && ($returnObj$$1$$ = {$allChanges$:$allChanges$$, origin:$origin$$});
        return $returnObj$$1$$;
      });
    }
    function $_update$$($change$$1$$, $origin$$1$$) {
      ...
      return Promise.resolve().then(function() {
        ...
        var $rt$$1$$ = $change$$1$$.$router$, $i$$310$$, $length$$15$$, $goingBackward$$;
        if ("popState" === $origin$$1$$) {
          $length$$15$$ = $rt$$1$$.$_navHistory$.length;
          for ($i$$310$$ = $length$$15$$ - 1;0 <= $i$$310$$;$i$$310$$--) {
            if ($rt$$1$$.$_navHistory$[$i$$310$$] === $change$$1$$.value) {
              $goingBackward$$ = !0;
              $rt$$1$$.$_navHistory$.splice($i$$310$$, $length$$15$$ - $i$$310$$);
              break;
            }
          }
          1 === $length$$15$$ - $i$$310$$ && ($rt$$1$$.$_navigationType$ = "back");
        }
    ...
    function $parseAndUpdate$$($url$$24$$, $origin$$2$$) {
      ...
      try {
        ...
        return Promise.reject($error$$36$$);
      }
    ...
    function $_resolveTransition$$() {
      ...
      return $promise$$1_transition$$1$$.then(function($params$$19$$) {
        ...
        $_transitionQueue$$ = [];
        $oj$$17$$.$Logger$.error("Error when executing transition: %s", $error$$37$$.message);
    ...
    function $_queueTransition$$($lastTransition_transition$$2$$) {
      var $length$$16$$;
      $length$$16$$ = $_transitionQueue$$.push($lastTransition_transition$$2$$);
      ...
      1 === $length$$16$$ ? $_queuePromise$$ = $_resolveTransition$$() : ($lastTransition_transition$$2$$ = $_transitionQueue$$[$length$$16$$ - 2], $lastTransition_transition$$2$$.url || $lastTransition_transition$$2$$.$deferredHandling$ || ($oj$$17$$.$Logger$.info("\x3e\x3e Cancelling: path\x3d%s", $lastTransition_transition$$2$$.path), $lastTransition_transition$$2$$.cancel = !0), $_queuePromise$$ = $_queuePromise$$.then($_resolveTransition$$));
      return $_queuePromise$$;
    }
    function $handlePopState$$() {
      var $i$$311$$, $sr$$1$$, $subRouter$$1$$ = null;
      $oj$$17$$.$Logger$.info("Handling popState event with URL: %s", window.location.href);
      for ($i$$311$$ = 0;$i$$311$$ < $rootRouter$$.$_childRouters$.length;$i$$311$$++) {
        if ($sr$$1$$ = $rootRouter$$.$_childRouters$[$i$$311$$], $rootRouter$$.$_stateId$() && $rootRouter$$.$_stateId$() === $sr$$1$$.$_parentState$) {
          $subRouter$$1$$ = $sr$$1$$;
          break;
        }
      }
      $_queueTransition$$({$router$:$subRouter$$1$$, url:$getShortUrl$$(), origin:"popState"}).then(null, function($error$$38$$) {
        $oj$$17$$.$Logger$.error("Error while changing state in handlePopState: %s", $error$$38$$.message);
      });
    }
    ...
    var $_ojBaseUrl$$, $_thisPage$$ = function() {
      var $result$$48$$ = "", $url$$25$$ = window.location.pathname;
      -1 !== $url$$25$$.indexOf(".html", $url$$25$$.length - 5) && ($result$$48$$ = $url$$25$$.split("/").pop());
      return $result$$48$$;
    }(), $_urlAdapter$$, $_initialized$$ = !1, $_deferredPath$$, $_transitionQueue$$ = [], $_queuePromise$$;
    $oj$$17$$.$Router$ = function $$oj$$17$$$$Router$$($key$$98$$, $parentRouter$$, $parentState$$) {
      var $router$$9$$ = this;
      this.$_name$ = $key$$98$$;
      ...
      }, write:function($value$$248$$) {
        this.go($value$$248$$).then(null, function($error$$39$$) {
          throw $error$$39$$;
        });
      }, owner:$router$$9$$});
      this.$_states$ = null;
      ...
      this.$_moduleConfig$ = Object.create(null, {name:{value:$ko$$3$$.pureComputed(function() {
        ...
        var $state$$5$$ = $ko$$3$$.unwrap($params$$20$$.valueAccessor()).params.ojRouter.parentRouter.$_currentState$();
        $state$$5$$ && ($state$$5$$.$viewModel$ = $params$$20$$.viewModel);
    ...
    Object.defineProperties($oj$$17$$.$Router$.prototype, {name:{get:function() {
      ...
      this.$_defaultStateId$ = $newValue$$13$$;
    ...
    $oj$$17$$.$Router$.prototype.$createChildRouter$ = function $$oj$$17$$$$Router$$$$createChildRouter$$($name$$117$$, $parentStateId$$2$$) {
      var $childRouter$$1_i$$312$$, $sr$$3$$;
      $oj$$17$$.$Assert$.$assertString$($name$$117$$);
      $parentStateId$$2$$ = $parentStateId$$2$$ || this.$_stateId$();
      $name$$117$$ = encodeURIComponent($name$$117$$.trim());
      for ($childRouter$$1_i$$312$$ = 0;$childRouter$$1_i$$312$$ < this.$_childRouters$.length;$childRouter$$1_i$$312$$++) {
        $sr$$3$$ = this.$_childRouters$[$childRouter$$1_i$$312$$];
      ...
      $childRouter$$1_i$$312$$ = new $oj$$17$$.$Router$($name$$117$$, this, $parentStateId$$2$$);
      this.$_childRouters$.push($childRouter$$1_i$$312$$);
      return $childRouter$$1_i$$312$$;
    };
    ...
    $oj$$17$$.$Router$.prototype.$configure$ = function $$oj$$17$$$$Router$$$$configure$$($option$$31$$) {
      this.$_stateId$(void 0);
      delete this.$_defaultStateId$;
      this.$_navigationType$ = void 0;
      this.$_navHistory$ = [];
      "function" === typeof $option$$31$$ ? (this.$_states$ = null, this.$stateFromIdCallback$ = $option$$31$$) : (this.$_states$ = [], delete this.$stateFromIdCallback$, Object.keys($option$$31$$).forEach(function($key$$99$$) {
        var $rsOptions$$ = $option$$31$$[$key$$99$$];
        this.$_states$.push(new $oj$$17$$.$RouterState$($key$$99$$, $rsOptions$$, this));
        "boolean" === typeof $rsOptions$$.isDefault && $rsOptions$$.isDefault && (this.$_defaultStateId$ = $key$$99$$);
      }, this));
      return this;
    };
    ...
    $oj$$17$$.$Router$.prototype.$_go$ = function $$oj$$17$$$$Router$$$$_go$$($stateIdPath$$1$$, $replace$$) {
      ...
      if ("/" === $stateIdPath$$1$$.charAt(0)) {
        $path$$16_useDefault$$ = $stateIdPath$$1$$;
      } else {
        $path$$16_useDefault$$ = $getCurrentPath$$(this.$_parentRouter$);
        if (!$path$$16_useDefault$$) {
          return Promise.reject(Error('Invalid path "' + $stateIdPath$$1$$ + '". The parent router does not have a current state.'));
        }
        $path$$16_useDefault$$ += $stateIdPath$$1$$;
      }
    ...
    $oj$$17$$.$Router$.prototype.$store$ = function $$oj$$17$$$$Router$$$$store$$($data$$124_extraState$$2$$) {
      this.$_extra$ = $data$$124_extraState$$2$$;
      $data$$124_extraState$$2$$ = {};
      for (var $router$$10$$ = this;$router$$10$$;) {
        $router$$10$$.$_extra$ && ($data$$124_extraState$$2$$[$router$$10$$.$_name$] = $router$$10$$.$_extra$), $router$$10$$ = $router$$10$$.$_parentRouter$;
      }
      for (var $router$$10$$ = this, $nextLevel_url$$26$$, $i$$313$$, $sr$$4$$;$router$$10$$;) {
        for ($i$$313$$ = 0;$i$$313$$ < $router$$10$$.$_childRouters$.length;$i$$313$$++) {
          if ($sr$$4$$ = $router$$10$$.$_childRouters$[$i$$313$$], $router$$10$$.$_stateId$() && $router$$10$$.$_stateId$() === $sr$$4$$.$_parentState$) {
            $sr$$4$$.$_extra$ && ($data$$124_extraState$$2$$[$sr$$4$$.$_name$] = $sr$$4$$.$_extra$);
      ...
      $nextLevel_url$$26$$ = $addStateParam$$($nextLevel_url$$26$$, $data$$124_extraState$$2$$);
    ...
    $oj$$17$$.$Router$.prototype.$dispose$ = function $$oj$$17$$$$Router$$$$dispose$$() {
      for (var $parentChildren$$, $i$$314$$;0 < this.$_childRouters$.length;) {
        this.$_childRouters$[0].$dispose$();
      }
      if (this.$_parentRouter$) {
        $parentChildren$$ = this.$_parentRouter$.$_childRouters$;
        for ($i$$314$$ = 0;$i$$314$$ < $parentChildren$$.length;$i$$314$$++) {
          if ($parentChildren$$[$i$$314$$].$_name$ === this.$_name$) {
            $parentChildren$$.splice($i$$314$$, 1);
            break;
          }
        }
    ...
    $oj$$17$$.$Router$.$sync$ = function $$oj$$17$$$$Router$$$sync$$() {
      ...
      if ($oj$$17$$.$Router$.$_updating$) {
        return $oj$$17$$.$Logger$.info("Sync called while updating, waiting for updates to end."), new Promise(function($resolve$$31$$) {
          $oj$$17$$.$Router$.$_transitionedToState$.addOnce(function($result$$49$$) {
            $oj$$17$$.$Logger$.info("Sync updates done.");
            $resolve$$31$$($result$$49$$);
          });
        });
      }
    ...
    $oj$$17$$.$Router$.$urlPathAdapter$ = function $$oj$$17$$$$Router$$$urlPathAdapter$$() {
      this.parse = function $this$parse$($segments_url$$27$$) {
        ...
        var $changes$$3$$ = [], $value$$249$$;
        $segments_url$$27$$.shift();
        do {
          ($value$$249$$ = $segments_url$$27$$.shift()) && (0 === $value$$249$$.length || /\.html$/i.test($value$$249$$)) && ($value$$249$$ = void 0), $value$$249$$ = $value$$249$$ || $router$$11$$.$_defaultStateId$, $changes$$3$$.push({value:$value$$249$$, $router$:$router$$11$$}), $router$$11$$ = $_getChildRouter$$($router$$11$$, $value$$249$$);
        } while ($router$$11$$);
        return $changes$$3$$;
      };
    ...
    $oj$$17$$.$Router$.$urlParamAdapter$ = function $$oj$$17$$$$Router$$$urlParamAdapter$$() {
      this.parse = function $this$parse$($params$$22_url$$30$$) {
        ...
        var $router$$12$$ = $rootRouter$$, $changes$$4$$ = [], $value$$250$$;
        do {
          if ($value$$250$$ = $params$$22_url$$30$$[$router$$12$$.$_name$]) {
            $value$$250$$ = $value$$250$$[0], delete $params$$22_url$$30$$[$router$$12$$.$_name$];
          }
          $value$$250$$ = $value$$250$$ || $router$$12$$.$_defaultStateId$;
          $changes$$4$$.push({value:$value$$250$$, $router$:$router$$12$$});
          $router$$12$$ = $_getChildRouter$$($router$$12$$, $value$$250$$);
        } while ($router$$12$$);
        return $changes$$4$$;
      };
      ...
      this.$cleanUrl$ = function $this$$cleanUrl$$($url$$31$$) {
        var $index$$154$$ = $url$$31$$.indexOf("oj_Router\x3d");
        return-1 !== $index$$154$$ ? $url$$31$$.substr(0, $index$$154$$ - 1) : $url$$31$$;
      };
  ...
  (function() {
    $oj$$17$$.$RouterState$ = function $$oj$$17$$$$RouterState$$($id$$34$$, $options$$268$$, $router$$13$$) {
      $options$$268$$ = $options$$268$$ || {};
      $oj$$17$$.$Assert$.$assertString$($id$$34$$);
      this.$_id$ = encodeURIComponent($id$$34$$.trim());
      (this.$_canEnter$ = $options$$268$$.canEnter) && $oj$$17$$.$Assert$.$assertFunctionOrNull$(this.$_canEnter$);
      (this.$_enter$ = $options$$268$$.enter) && $oj$$17$$.$Assert$.$assertFunctionOrNull$(this.$_enter$);
      (this.$_canExit$ = $options$$268$$.canExit) && $oj$$17$$.$Assert$.$assertFunctionOrNull$(this.$_canExit$);
      (this.$_exit$ = $options$$268$$.exit) && $oj$$17$$.$Assert$.$assertFunctionOrNull$(this.$_exit$);
      this.$_value$ = $options$$268$$.value;
      this.$_label$ = $options$$268$$.label;
  ...
  (function() {
    function $_compress$$($uncompressed$$, $getCharFromInt$$) {
      ...
      var $i$$316$$, $value$$251$$, $context_dictionary$$ = {}, $context_dictionaryToCreate$$ = {}, $context_w$$ = "", $context_enlargeIn$$ = 2, $context_dictSize$$ = 3, $context_numBits$$ = 2, $context_data_string$$ = "", $context_data_val$$ = 0, $context_data_position$$ = 0, $context_c$$, $context_wc$$, $ii$$, $len$$17$$ = $uncompressed$$.length;
        ...
        if ($context_c$$ = $uncompressed$$[$ii$$], Object.prototype.hasOwnProperty.call($context_dictionary$$, $context_c$$) || ($context_dictionary$$[$context_c$$] = $context_dictSize$$++, $context_dictionaryToCreate$$[$context_c$$] = !0), $context_wc$$ = $context_w$$ + $context_c$$, Object.prototype.hasOwnProperty.call($context_dictionary$$, $context_wc$$)) {
          ...
          if (Object.prototype.hasOwnProperty.call($context_dictionaryToCreate$$, $context_w$$)) {
            if (256 > $context_w$$.charCodeAt(0)) {
              for ($i$$316$$ = $context_numBits$$;$i$$316$$--;) {
              ...
              $value$$251$$ = $context_w$$.charCodeAt(0);
              $i$$316$$ = 8;
            } else {
              $value$$251$$ = 1;
              for ($i$$316$$ = $context_numBits$$;$i$$316$$--;) {
                $context_data_val$$ = $context_data_val$$ << 1 | $value$$251$$, 5 == $context_data_position$$ ? ($context_data_position$$ = 0, $context_data_string$$ += $getCharFromInt$$($context_data_val$$), $context_data_val$$ = 0) : $context_data_position$$++, $value$$251$$ = 0;
              }
              $value$$251$$ = $context_w$$.charCodeAt(0);
              $i$$316$$ = 16;
            }
            for (;$i$$316$$--;) {
              $context_data_val$$ = $context_data_val$$ << 1 | $value$$251$$ & 1, 5 == $context_data_position$$ ? ($context_data_position$$ = 0, $context_data_string$$ += $getCharFromInt$$($context_data_val$$), $context_data_val$$ = 0) : $context_data_position$$++, $value$$251$$ >>= 1;
            }
            $context_enlargeIn$$--;
            0 == $context_enlargeIn$$ && ($context_enlargeIn$$ = Math.pow(2, $context_numBits$$), $context_numBits$$++);
            delete $context_dictionaryToCreate$$[$context_w$$];
          } else {
            for ($value$$251$$ = $context_dictionary$$[$context_w$$], $i$$316$$ = $context_numBits$$;$i$$316$$--;) {
              $context_data_val$$ = $context_data_val$$ << 1 | $value$$251$$ & 1, 5 == $context_data_position$$ ? ($context_data_position$$ = 0, $context_data_string$$ += $getCharFromInt$$($context_data_val$$), $context_data_val$$ = 0) : $context_data_position$$++, $value$$251$$ >>= 1;
            }
          }
          $context_enlargeIn$$--;
    ...
    function $_decompress$$($length$$17$$, $getNextValue$$) {
      for (var $dictionary$$ = [], $enlargeIn$$ = 4, $dictSize$$ = 4, $numBits$$ = 3, $bits_entry$$4$$ = "", $i$$317_result$$50$$ = "", $w$$5$$, $resb$$, $maxpower$$, $power$$, $c$$44$$, $data$$125$$ = {val:$getNextValue$$(0), position:32, index:1}, $i$$317_result$$50$$ = 0;3 > $i$$317_result$$50$$;$i$$317_result$$50$$ += 1) {
        $dictionary$$[$i$$317_result$$50$$] = $i$$317_result$$50$$;
      }
      $bits_entry$$4$$ = 0;
      $maxpower$$ = Math.pow(2, 2);
      for ($power$$ = 1;$power$$ != $maxpower$$;) {
        $resb$$ = $data$$125$$.val & $data$$125$$.position, $data$$125$$.position >>= 1, 0 == $data$$125$$.position && ($data$$125$$.position = 32, $data$$125$$.val = $getNextValue$$($data$$125$$.index++)), $bits_entry$$4$$ |= (0 < $resb$$ ? 1 : 0) * $power$$, $power$$ <<= 1;
      }
      switch($bits_entry$$4$$) {
        case 0:
          $bits_entry$$4$$ = 0;
      ...
      for ($w$$5$$ = $i$$317_result$$50$$ = $dictionary$$[3] = $c$$44$$;;) {
        if ($data$$125$$.index > $length$$17$$) {
          return "";
        }
        $bits_entry$$4$$ = 0;
        ...
        switch($c$$44$$ = $bits_entry$$4$$) {
          ...
          case 1:
            ...
            break;
          case 2:
            return $i$$317_result$$50$$;
        }
        0 == $enlargeIn$$ && ($enlargeIn$$ = Math.pow(2, $numBits$$), $numBits$$++);
        if ($dictionary$$[$c$$44$$]) {
          $bits_entry$$4$$ = $dictionary$$[$c$$44$$];
        } else {
          if ($c$$44$$ === $dictSize$$) {
    ...
    $oj$$17$$.$LZString$ = {$compressToEncodedURIComponent$:function $$oj$$17$$$$LZString$$$compressToEncodedURIComponent$$($input$$6$$) {
      return null === $input$$6$$ ? "" : $_compress$$($input$$6$$, function($a$$102$$) {
        return $_keyStrUriSafe$$.charAt($a$$102$$);
      });
    }, $decompressFromEncodedURIComponent$:function $$oj$$17$$$$LZString$$$decompressFromEncodedURIComponent$$($input$$7$$) {
      return null === $input$$7$$ ? "" : "" === $input$$7$$ ? null : $_decompress$$($input$$7$$.length, function($character$$inline_925_index$$155$$) {
        var $alphabet$$inline_924$$ = $_keyStrUriSafe$$;
        $character$$inline_925_index$$155$$ = $input$$7$$.charAt($character$$inline_925_index$$155$$);
        var $i$$inline_926$$;
        $_baseReverseDic$$ || ($_baseReverseDic$$ = {});
        if (!$_baseReverseDic$$[$alphabet$$inline_924$$]) {
          for ($_baseReverseDic$$[$alphabet$$inline_924$$] = {}, $i$$inline_926$$ = 0;$i$$inline_926$$ < $alphabet$$inline_924$$.length;$i$$inline_926$$++) {
            $_baseReverseDic$$[$alphabet$$inline_924$$][$alphabet$$inline_924$$[$i$$inline_926$$]] = $i$$inline_926$$;
          }
        }
        return $_baseReverseDic$$[$alphabet$$inline_924$$][$character$$inline_925_index$$155$$];
      });
    }};
